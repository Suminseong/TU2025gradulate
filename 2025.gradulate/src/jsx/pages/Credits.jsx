...
export default function Credit() {
  ...
  const speeches = [
    ...
    { title: '웹사이트팀 제작 후기', body: '2025년 졸업전시 잔향의 웹사이트 기획부터 디자인, 그리고 구현까지 담당한 웹사이트 팀 성수민, 김예준 입니다. 25년 5월부터 컨셉이 정해진 이래 150일에 걸쳐 개발한 사이트가 이렇게 완성되어 무척 감격스럽습니다. 이하생략 이이 졸려 이제 잘테다 히히 아무도 나를 막을 수 업다!!' },
  ];
