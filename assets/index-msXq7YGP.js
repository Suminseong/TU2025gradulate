...
`;function Hp({path:i="student",isActive:t=!1,onClick:r}){return v.jsxs(ZA,{onClick:r,children:[v.jsx(P_,{$active:t,children:"교수"}),v.jsx(t4,{$active:t,children:"학생"}),v.jsx(JA,{$active:t})]})}Hp.propTypes={path:Z.oneOf(["student","professor"]),isActive:Z.bool,onClick:Z.func};const pv=A.a`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  font-size: 24px;
  line-height: 28.8px;
  letter-spacing: 0.24px;
  ...
  outline: none;
  transition: opacity 120ms ease;
`;function th({label:i,href:t,active:r=!1,onClick:a,style:o,target:u,rel:f}){const p={"aria-current":r?"page":void 0,"data-active":r?"true":"false",onKeyDown:g=>{a&&(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),a(g))},onClick:a,style:o,$active:r};return t?v.jsx(pv,{href:t,target:u,rel:f,...p,children:i}):v.jsx(pv,{as:"button",type:"button",...p,style:{background:"none",border:0,...o},children:i})}th.propTypes={label:Z.string.isRequired,href:Z.string,active:Z.bool,onClick:Z.func,style:Z.object,target:Z.string,rel:Z.string};const mv=A.div`
  display: flex;
  width: 120px;
  height: 40px;
  flex-direction: row;
...
`;function z_({options:i,onSelect:t,style:r,isOpen:a,position:o,selected:u}){return v.jsx(n4,{style:r,$open:a,children:i.map((f,m)=>v.jsx(i4,{onClick:()=>t(f),children:v.jsx(r4,{$selected:f===u,children:f})},m))})}z_.propTypes={options:Z.arrayOf(Z.string).isRequired,onSelect:Z.func.isRequired,style:Z.object,isOpen:Z.bool,position:Z.any,selected:Z.string};const a4=A.div`
  position: relative;
`;function Vm({label:i,options:t,onSelect:r,style:a,filter:o,mode:u}){const[f,m]=kt.useState(!1),[p,g]=kt.useState({top:0,left:0}),_=kt.useRef(null),b=()=>{if(_.current){const I=_.current.getBoundingClientRect();g({top:I.bottom+window.scrollY,left:I.left+window.scrollX})}m(I=>!I)},S=I=>{r&&r(I),m(!1)};return v.jsxs(a4,{ref:_,style:a,children:[v.jsx("div",{onClick:b,children:v.jsx(Om,{label:i,options:t,onSelect:r,style:{},filter:o,mode:u})}),f&&v.jsx(z_,{options:t,onSelect:S,style:{},isOpen:f,position:p,selected:i})]})}Vm.propTypes={label:Z.string.isRequired,options:Z.arrayOf(Z.string).isRequired,onSelect:Z.func.isRequired,style:Z.object,filter:Z.string};Vm.defaultProps={style:{},filter:""};const s4=A.div`
    display: ${i=>i.$open?"flex":"none"};
    flex-direction: column;
    justify-content: flex-start;
    position: absolute;
...
`;function $_({onCategoryChange:i,onToggleChange:t,type:r,onSortChange:a,sortLabel:o}){const u={type:r},[f,m]=kt.useState(!1),p=()=>m(W=>{const ot=!W;return t&&t(ot),ot}),[g,_]=kt.useState("전체"),[b,S]=kt.useState("All Projects"),I=["전체","산업디자인공학","미디어디자인공학"],U=["장영주","권오재","김 억","김한종","조남주","한민섭","홍성수","김태균"],F=["All Projects","AI & Robot","Edu & Kids","Health Care","IT & Tech","Living","Mobility"],P=["이름순","좋아요순","조회수순","팀작우선","개인작우선"],[X,Q]=kt.useState("이름순"),J=o||X,lt=W=>{Q(W),a&&a(W)};return H.useEffect(()=>{_(f?U[0]:I[0])},[f]),u.type==="project"?v.jsxs(mp,{children:[v.jsx(gp,{}),v.jsx(yp,{children:F.map(W=>v.jsx(th,{label:W,href:`#${W.replace(/\s+/g,"-").toLowerCase()}`,active:b===W,onClick:()=>{S(W),i&&i(W)}},W))}),v.jsx(vp,{children:v.jsx(Ul,{mode:"category",label:b,options:F,onSelect:W=>{S(W),i&&i(W)}})}),v.jsx(Vm,{label:J,options:P,onSelect:lt})]}):f?v.jsxs(mp,{children:[v.jsx(gp,{}),v.jsx(yp,{children:U.map(W=>v.jsx(th,{label:W,href:`#${W.replace(/\s+/g,"-").toLowerCase()}`,active:g===W,onClick:()=>{_(W),i&&i(W)}},W))}),v.jsx(vp,{children:v.jsx(Ul,{mode:"category",label:g,options:U,onSelect:W=>{_(W),i&&i(W)}})}),v.jsx(Hp,{path:f?"professor":"student",isActive:f,onClick:p})]}):v.jsxs(mp,{children:[v.jsx(gp,{}),v.jsx(yp,{children:I.map(W=>v.jsx(th,{label:W,href:`#${W.replace(/\s+/g,"-").toLowerCase()}`,active:g===W,onClick:()=>{_(W),i&&i(W)}},W))}),v.jsx(vp,{children:v.jsx(Ul,{mode:"category",label:g,options:I,onSelect:W=>{_(W),i&&i(W)}})}),v.jsx(Hp,{path:f?"professor":"student",isActive:f,onClick:p})]})}const c4=A.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  justify-content: center;
...
`;function vg({titleKor:i,titleEng:t,nameKor:r,view:a,like:o,href:u,src:f,profileImgs:m,docId:p,collection:g="works"}){const[_,b]=H.useState(typeof o=="number"?o:0),[S,I]=H.useState(typeof a=="number"?a:0);H.useEffect(()=>{let J=!0;return(async()=>{if(p!=null)try{const lt=Fl(Zs,g,String(p)),W=await Kl(lt);if(!J)return;if(W.exists()){const ot=W.data();b(typeof ot.like=="number"?ot.like:0),I(typeof ot.view=="number"?ot.view:0)}}catch(lt){console.error("ProjectCard Firestore read error:",lt)}})(),()=>{J=!1}},[p,g]);const U=J=>{const lt=J.currentTarget.querySelector(".card-hover");lt&&(lt.style.opacity=1)},F=J=>{const lt=J.currentTarget.querySelector(".card-hover");lt&&(lt.style.opacity=0)},P="/TU2025gradulate/",X=/^https?:\/\//i.test(u),Q=v.jsxs(v.Fragment,{children:[v.jsx(CI,{children:v.jsxs(jI,{onMouseEnter:U,onMouseLeave:F,children:[v.jsx(DI,{className:"card-hover",children:v.jsxs(NI,{children:[v.jsx(OI,{children:i}),v.jsx(MI,{children:t})]})}),v.jsx(II,{src:f,alt:"Project"})]})}),v.jsxs(VI,{children:[v.jsxs(kI,{children:[v.jsx(PI,{children:m.map((J,lt)=>v.jsx(LI,{src:J,alt:`Profile${lt+1}`,$z:3-lt,$ml:lt>0},lt))}),v.jsx(UI,{children:r})]}),v.jsxs(zI,{children:[v.jsxs(Ix,{children:[v.jsx(Dx,{src:`${P}icons/likeIcon.svg`}),v.jsx(Nx,{children:_})]}),v.jsxs(Ix,{children:[v.jsx(Dx,{src:`${P}icons/viewIcon.svg`}),v.jsx(Nx,{children:S})]})]})]})]});return X?v.jsx(jx,{as:"a",href:u,style:{textDecoration:"none"},children:Q}):v.jsx(jx,{as:mo,to:u.startsWith("/")?u:`/${u}`,style:{textDecoration:"none"},children:Q})}vg.propTypes={titleKor:Z.string.isRequired,titleEng:Z.string.isRequired,nameKor:Z.string.isRequired,view:Z.number,like:Z.number,src:Z.string.isRequired,href:Z.string.isRequired,profileImgs:Z.arrayOf(Z.string).isRequired,docId:Z.oneOfType([Z.string,Z.number]),collection:Z.string};vg.defaultProps={titleKor:"프로젝트 제목",titleEng:"Project Title",nameKor:"Author Name",view:0,like:0,collection:"works"};const Mx=40;function V2(i){if(!i)return i;const t="/TU2025gradulate/";if(/^https?:\/\//i.test(i))return i;const r=i.replace(/^\.\.\//,"").replace(/^\//,"");return t+r}const BI=A.div`
  position: relative; background: #fff;
`,$I=A.div`
...
`,Kx=A.div`
  ...
  position: relative;
  width: 100%;
`,sN={A:"c0",E:"c1",H:"c2",I:"c3",L:"c4",M:"c5"};function oN(){const{pid:i}=GT(),t=(i||"").toUpperCase().match(/^([A-Z])(\d{3})$/),[r,a]=H.useState(!0),[o,u]=H.useState(!0),f=()=>{a(!1),setTimeout(()=>{u(!1)},500)},m=()=>{u(!0),setTimeout(()=>{a(!0)},0)};let p=null;if(t){const[,X,Q]=t,J=sN[X]||null,lt=Math.max(0,parseInt(Q,10)-1);p=Gl.find(W=>W.projectNum===lt&&(!J||W.category===J)),p||(p=Gl.find(W=>W.projectNum==lt))}if(!p)return v.jsx(Kx,{children:v.jsxs(PageContainer,{children:[v.jsx(gm,{titleKor:"작품 제목(한글)",titleEng:"Work Title (English)",context:"이곳은 작품 설명이 들어가는 영역입니다. 작품에 대한 상세한 설명이나 배경, 제작 과정 등을 기술할 수 있습니다. 이 텍스트는 예시로 작성된 내용이며, 실제 작품 설명으로 대체되어야 합니다.",isOpen:r,onClose:()=>a(!1),docId:0}),v.jsx(Dp,{src:"https://placehold.co/1530x4000",alt:"featured"}),v.jsx($x,{children:"  "})]})});const g=(p.members||[]).map(X=>{const Q=Um.find(J=>J.num===X);return Q?{nameKor:Q.nameKor,nameEng:Q.nameEng,role:Q.role||"Designer",sns:Q.sns||"-",eMail:Q.eMail||"",imgUrl:qc(Q.imgUrl||"/김예준.jpg")}:null}).filter(Boolean),b={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"}[p.category]||"A",S=p.projectNum??p.num,I=String(S).padStart(3,"0"),U=`/projects/${S}`,F=Number(p.galleryCount||0),P=Array.from({length:F},(X,Q)=>qc(`${U}/gallery/${Q}.jpg`));return H.useEffect(()=>{const X=p?.projectNum??p?.num;if(X==null)return;const J=Fl(Zs,"works",String(X));(async()=>{try{await Ah(J,{view:Rh(1)})}catch(lt){if(lt.code==="not-found"||/No document/i.test(String(lt)))try{(await Kl(J)).exists()?await Ah(J,{view:Rh(1)}):await M2(J,{view:1},{merge:!0})}catch(W){console.error("Firestore view fallback error:",W)}else console.error("Firestore view error:",lt)}})()},[p?.projectNum,p?.num]),v.jsx(Kx,{children:v.jsxs(iN,{children:[v.jsx(eN,{isOpen:r,onClick:m}),v.jsx(aN,{$visible:o,children:v.jsx(gm,{titleKor:p.titleKor,titleEng:p.titleEng,context:p.description||"null",isOpen:r,onClose:f,src:qc(`/projects/${S}/thumb.jpg`),docId:S})}),v.jsxs(rN,{$isInfoOpen:r,children:[P.length>0?P.map((X,Q)=>v.jsx(Dp,{src:X,alt:`project-${b}${I}-img-${Q+1}`},Q)):v.jsx(Dp,{src:qc("/thumbnailExample.png"),alt:`project-${b}${I}-placeholder`}),v.jsx(Z5,{videoId:p.videoId}),v.jsx($x,{designers:g})]})]})})}var Np={exports:{}},Il={},Mp={exports:{}},Op={};/**
 * @license React
