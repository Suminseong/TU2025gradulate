 ...
 */var Z1;function Mw(){if(Z1)return Dl;Z1=1;var n=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(a,o,u){var f=null;if(u!==void 0&&(f=""+u),o.key!==void 0&&(f=""+o.key),"key"in o){u={};for(var m in o)m!=="key"&&(u[m]=o[m])}else u=o;return o=u.ref,{$$typeof:n,type:a,key:f,ref:o!==void 0?o:null,props:u}}return Dl.Fragment=t,Dl.jsx=i,Dl.jsxs=i,Dl}var J1;function Ow(){return J1||(J1=1,sp.exports=Mw()),sp.exports}var x=Ow(),op={exports:{}},jt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 *
 * @license MIT
 */var nx="popstate";function kw(n={}){function t(a,o){let{pathname:u,search:f,hash:m}=a.location;return zp("",{pathname:u,search:f,hash:m},o.state&&o.state.usr||null,o.state&&o.state.key||"default")}function i(a,o){return typeof o=="string"?o:Yl(o)}return Pw(t,i,null,n)}function he(n,t){if(n===!1||n===null||typeof n>"u")throw new Error(t)}function ri(n,t){if(!n){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function Uw(){return Math.random().toString(36).substring(2,10)}function ix(n,t){return{usr:n.state,key:n.key,idx:t}}function zp(n,t,i=null,a){return{pathname:typeof n=="string"?n:n.pathname,search:"",hash:"",...typeof t=="string"?po(t):t,state:i,key:t&&t.key||a||Uw()}}function Yl({pathname:n="/",search:t="",hash:i=""}){return t&&t!=="?"&&(n+=t.charAt(0)==="?"?t:"?"+t),i&&i!=="#"&&(n+=i.charAt(0)==="#"?i:"#"+i),n}function po(n){let t={};if(n){let i=n.indexOf("#");i>=0&&(t.hash=n.substring(i),n=n.substring(0,i));let a=n.indexOf("?");a>=0&&(t.search=n.substring(a),n=n.substring(0,a)),n&&(t.pathname=n)}return t}function Pw(n,t,i,a={}){let{window:o=document.defaultView,v5Compat:u=!1}=a,f=o.history,m="POP",p=null,g=v();g==null&&(g=0,f.replaceState({...f.state,idx:g},""));function v(){return(f.state||{idx:null}).idx}function w(){m="POP";let P=v(),X=P==null?null:P-g;g=P,p&&p({action:m,location:B.location,delta:X})}function S(P,X){m="PUSH";let Y=zp(B.location,P,X);g=v()+1;let J=ix(Y,g),ot=B.createHref(Y);try{f.pushState(J,"",ot)}catch(Z){if(Z instanceof DOMException&&Z.name==="DataCloneError")throw Z;o.location.assign(ot)}u&&p&&p({action:m,location:B.location,delta:1})}function R(P,X){m="REPLACE";let Y=zp(B.location,P,X);g=v();let J=ix(Y,g),ot=B.createHref(Y);f.replaceState(J,"",ot),u&&p&&p({action:m,location:B.location,delta:0})}function V(P){return Lw(P)}let B={get action(){return m},get location(){return n(o,f)},listen(P){if(p)throw new Error("A history only accepts one active listener");return o.addEventListener(nx,w),p=P,()=>{o.removeEventListener(nx,w),p=null}},createHref(P){return t(o,P)},createURL:V,encodeLocation(P){let X=V(P);return{pathname:X.pathname,search:X.search,hash:X.hash}},push:S,replace:R,go(P){return f.go(P)}};return B}function Lw(n,t=!1){let i="http://localhost";typeof window<"u"&&(i=window.location.origin!=="null"?window.location.origin:window.location.href),he(i,"No window.location.(origin|href) available to create URL");let a=typeof n=="string"?n:Yl(n);return a=a.replace(/ $/,"%20"),!t&&a.startsWith("//")&&(a=i+a),new URL(a,i)}function E_(n,t,i="/"){return zw(n,t,i,!1)}function zw(n,t,i,a){let o=typeof t=="string"?po(t):t,u=ar(o.pathname||"/",i);if(u==null)return null;let f=b_(n);Bw(f);let m=null;for(let p=0;m==null&&p<f.length;++p){let g=Zw(u);m=Xw(f[p],g,a)}return m}function b_(n,t=[],i=[],a="",o=!1){let u=(f,m,p=o,g)=>{let v={relativePath:g===void 0?f.path||"":g,caseSensitive:f.caseSensitive===!0,childrenIndex:m,route:f};if(v.relativePath.startsWith("/")){if(!v.relativePath.startsWith(a)&&p)return;he(v.relativePath.startsWith(a),`Absolute route path "${v.relativePath}" nested under path "${a}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),v.relativePath=v.relativePath.slice(a.length)}let w=nr([a,v.relativePath]),S=i.concat(v);f.children&&f.children.length>0&&(he(f.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${w}".`),b_(f.children,t,S,w,p)),!(f.path==null&&!f.index)&&t.push({path:w,score:Yw(w,f.index),routesMeta:S})};return n.forEach((f,m)=>{if(f.path===""||!f.path?.includes("?"))u(f,m);else for(let p of w_(f.path))u(f,m,!0,p)}),t}function w_(n){let t=n.split("/");if(t.length===0)return[];let[i,...a]=t,o=i.endsWith("?"),u=i.replace(/\?$/,"");if(a.length===0)return o?[u,""]:[u];let f=w_(a.join("/")),m=[];return m.push(...f.map(p=>p===""?u:[u,p].join("/"))),o&&m.push(...f),m.map(p=>n.startsWith("/")&&p===""?"/":p)}function Bw(n){n.sort((t,i)=>t.score!==i.score?i.score-t.score:Qw(t.routesMeta.map(a=>a.childrenIndex),i.routesMeta.map(a=>a.childrenIndex)))}var $w=/^:[\w-]+$/,Fw=3,qw=2,Kw=1,Hw=10,Gw=-2,rx=n=>n==="*";function Yw(n,t){let i=n.split("/"),a=i.length;return i.some(rx)&&(a+=Gw),t&&(a+=qw),i.filter(o=>!rx(o)).reduce((o,u)=>o+($w.test(u)?Fw:u===""?Kw:Hw),a)}function Qw(n,t){return n.length===t.length&&n.slice(0,-1).every((a,o)=>a===t[o])?n[n.length-1]-t[t.length-1]:0}function Xw(n,t,i=!1){let{routesMeta:a}=n,o={},u="/",f=[];for(let m=0;m<a.length;++m){let p=a[m],g=m===a.length-1,v=u==="/"?t:t.slice(u.length)||"/",w=hh({path:p.relativePath,caseSensitive:p.caseSensitive,end:g},v),S=p.route;if(!w&&g&&i&&!a[a.length-1].route.index&&(w=hh({path:p.relativePath,caseSensitive:p.caseSensitive,end:!1},v)),!w)return null;Object.assign(o,w.params),f.push({params:o,pathname:nr([u,w.pathname]),pathnameBase:nT(nr([u,w.pathnameBase])),route:S}),w.pathnameBase!=="/"&&(u=nr([u,w.pathnameBase]))}return f}function hh(n,t){typeof n=="string"&&(n={path:n,caseSensitive:!1,end:!0});let[i,a]=Ww(n.path,n.caseSensitive,n.end),o=t.match(i);if(!o)return null;let u=o[0],f=u.replace(/(.)\/+$/,"$1"),m=o.slice(1);return{params:a.reduce((g,{paramName:v,isOptional:w},S)=>{if(v==="*"){let V=m[S]||"";f=u.slice(0,u.length-V.length).replace(/(.)\/+$/,"$1")}const R=m[S];return w&&!R?g[v]=void 0:g[v]=(R||"").replace(/%2F/g,"/"),g},{}),pathname:u,pathnameBase:f,pattern:n}}function Ww(n,t=!1,i=!0){ri(n==="*"||!n.endsWith("*")||n.endsWith("/*"),`Route path "${n}" will be treated as if it were "${n.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${n.replace(/\*$/,"/*")}".`);let a=[],o="^"+n.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(f,m,p)=>(a.push({paramName:m,isOptional:p!=null}),p?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return n.endsWith("*")?(a.push({paramName:"*"}),o+=n==="*"||n==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):i?o+="\\/*$":n!==""&&n!=="/"&&(o+="(?:(?=\\/|$))"),[new RegExp(o,t?void 0:"i"),a]}function Zw(n){try{return n.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return ri(!1,`The URL path "${n}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${t}).`),n}}function ar(n,t){if(t==="/")return n;if(!n.toLowerCase().startsWith(t.toLowerCase()))return null;let i=t.endsWith("/")?t.length-1:t.length,a=n.charAt(i);return a&&a!=="/"?null:n.slice(i)||"/"}function Jw(n,t="/"){let{pathname:i,search:a="",hash:o=""}=typeof n=="string"?po(n):n;return{pathname:i?i.startsWith("/")?i:tT(i,t):t,search:iT(a),hash:rT(o)}}function tT(n,t){let i=t.replace(/\/+$/,"").split("/");return n.split("/").forEach(o=>{o===".."?i.length>1&&i.pop():o!=="."&&i.push(o)}),i.length>1?i.join("/"):"/"}function lp(n,t,i,a){return`Cannot include a '${n}' character in a manually specified \`to.${t}\` field [${JSON.stringify(a)}].  Please separate it out to the \`to.${i}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function eT(n){return n.filter((t,i)=>i===0||t.route.path&&t.route.path.length>0)}function Am(n){let t=eT(n);return t.map((i,a)=>a===t.length-1?i.pathname:i.pathnameBase)}function Rm(n,t,i,a=!1){let o;typeof n=="string"?o=po(n):(o={...n},he(!o.pathname||!o.pathname.includes("?"),lp("?","pathname","search",o)),he(!o.pathname||!o.pathname.includes("#"),lp("#","pathname","hash",o)),he(!o.search||!o.search.includes("#"),lp("#","search","hash",o)));let u=n===""||o.pathname==="",f=u?"/":o.pathname,m;if(f==null)m=i;else{let w=t.length-1;if(!a&&f.startsWith("..")){let S=f.split("/");for(;S[0]==="..";)S.shift(),w-=1;o.pathname=S.join("/")}m=w>=0?t[w]:"/"}let p=Jw(o,m),g=f&&f!=="/"&&f.endsWith("/"),v=(u||f===".")&&i.endsWith("/");return!p.pathname.endsWith("/")&&(g||v)&&(p.pathname+="/"),p}var nr=n=>n.join("/").replace(/\/\/+/g,"/"),nT=n=>n.replace(/\/+$/,"").replace(/^\/*/,"/"),iT=n=>!n||n==="?"?"":n.startsWith("?")?n:"?"+n,rT=n=>!n||n==="#"?"":n.startsWith("#")?n:"#"+n;function aT(n){return n!=null&&typeof n.status=="number"&&typeof n.statusText=="string"&&typeof n.internal=="boolean"&&"data"in n}var T_=["POST","PUT","PATCH","DELETE"];new Set(T_);var sT=["GET",...T_];new Set(sT);var mo=K.createContext(null);mo.displayName="DataRouter";var Nh=K.createContext(null);Nh.displayName="DataRouterState";K.createContext(!1);var S_=K.createContext({isTransitioning:!1});S_.displayName="ViewTransition";var oT=K.createContext(new Map);oT.displayName="Fetchers";var lT=K.createContext(null);lT.displayName="Await";var si=K.createContext(null);si.displayName="Navigation";var go=K.createContext(null);go.displayName="Location";var Kn=K.createContext({outlet:null,matches:[],isDataRoute:!1});Kn.displayName="Route";var Cm=K.createContext(null);Cm.displayName="RouteError";function uT(n,{relative:t}={}){he(yo(),"useHref() may be used only in the context of a <Router> component.");let{basename:i,navigator:a}=K.useContext(si),{hash:o,pathname:u,search:f}=lu(n,{relative:t}),m=u;return i!=="/"&&(m=u==="/"?i:nr([i,u])),a.createHref({pathname:m,search:f,hash:o})}function yo(){return K.useContext(go)!=null}function ji(){return he(yo(),"useLocation() may be used only in the context of a <Router> component."),K.useContext(go).location}function cT(){return K.useContext(go).navigationType}var A_="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function R_(n){K.useContext(si).static||K.useLayoutEffect(n)}function Im(){let{isDataRoute:n}=K.useContext(Kn);return n?AT():hT()}function hT(){he(yo(),"useNavigate() may be used only in the context of a <Router> component.");let n=K.useContext(mo),{basename:t,navigator:i}=K.useContext(si),{matches:a}=K.useContext(Kn),{pathname:o}=ji(),u=JSON.stringify(Am(a)),f=K.useRef(!1);return R_(()=>{f.current=!0}),K.useCallback((p,g={})=>{if(ri(f.current,A_),!f.current)return;if(typeof p=="number"){i.go(p);return}let v=Rm(p,JSON.parse(u),o,g.relative==="path");n==null&&t!=="/"&&(v.pathname=v.pathname==="/"?t:nr([t,v.pathname])),(g.replace?i.replace:i.push)(v,g.state,g)},[t,i,u,o,n])}var fT=K.createContext(null);function dT(n){let t=K.useContext(Kn).outlet;return t&&K.createElement(fT.Provider,{value:n},t)}function pT(){let{matches:n}=K.useContext(Kn),t=n[n.length-1];return t?t.params:{}}function lu(n,{relative:t}={}){let{matches:i}=K.useContext(Kn),{pathname:a}=ji(),o=JSON.stringify(Am(i));return K.useMemo(()=>Rm(n,JSON.parse(o),a,t==="path"),[n,o,a,t])}function mT(n,t){return C_(n,t)}function C_(n,t,i,a,o){he(yo(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:u}=K.useContext(si),{matches:f}=K.useContext(Kn),m=f[f.length-1],p=m?m.params:{},g=m?m.pathname:"/",v=m?m.pathnameBase:"/",w=m&&m.route;{let Y=w&&w.path||"";I_(g,!w||Y.endsWith("*")||Y.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${g}" (under <Route path="${Y}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${Y}"> to <Route path="${Y==="/"?"*":`${Y}/*`}">.`)}let S=ji(),R;if(t){let Y=typeof t=="string"?po(t):t;he(v==="/"||Y.pathname?.startsWith(v),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${v}" but pathname "${Y.pathname}" was given in the \`location\` prop.`),R=Y}else R=S;let V=R.pathname||"/",B=V;if(v!=="/"){let Y=v.replace(/^\//,"").split("/");B="/"+V.replace(/^\//,"").split("/").slice(Y.length).join("/")}let P=E_(n,{pathname:B});ri(w||P!=null,`No routes matched location "${R.pathname}${R.search}${R.hash}" `),ri(P==null||P[P.length-1].route.element!==void 0||P[P.length-1].route.Component!==void 0||P[P.length-1].route.lazy!==void 0,`Matched leaf route at location "${R.pathname}${R.search}${R.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let X=_T(P&&P.map(Y=>Object.assign({},Y,{params:Object.assign({},p,Y.params),pathname:nr([v,u.encodeLocation?u.encodeLocation(Y.pathname).pathname:Y.pathname]),pathnameBase:Y.pathnameBase==="/"?v:nr([v,u.encodeLocation?u.encodeLocation(Y.pathnameBase).pathname:Y.pathnameBase])})),f,i,a,o);return t&&X?K.createElement(go.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...R},navigationType:"POP"}},X):X}function gT(){let n=ST(),t=aT(n)?`${n.status} ${n.statusText}`:n instanceof Error?n.message:JSON.stringify(n),i=n instanceof Error?n.stack:null,a="rgba(200,200,200, 0.5)",o={padding:"0.5rem",backgroundColor:a},u={padding:"2px 4px",backgroundColor:a},f=null;return console.error("Error handled by React Router default ErrorBoundary:",n),f=K.createElement(K.Fragment,null,K.createElement("p",null,"💿 Hey developer 👋"),K.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",K.createElement("code",{style:u},"ErrorBoundary")," or"," ",K.createElement("code",{style:u},"errorElement")," prop on your route.")),K.createElement(K.Fragment,null,K.createElement("h2",null,"Unexpected Application Error!"),K.createElement("h3",{style:{fontStyle:"italic"}},t),i?K.createElement("pre",{style:o},i):null,f)}var yT=K.createElement(gT,null),xT=class extends K.Component{constructor(n){super(n),this.state={location:n.location,revalidation:n.revalidation,error:n.error}}static getDerivedStateFromError(n){return{error:n}}static getDerivedStateFromProps(n,t){return t.location!==n.location||t.revalidation!=="idle"&&n.revalidation==="idle"?{error:n.error,location:n.location,revalidation:n.revalidation}:{error:n.error!==void 0?n.error:t.error,location:t.location,revalidation:n.revalidation||t.revalidation}}componentDidCatch(n,t){this.props.unstable_onError?this.props.unstable_onError(n,t):console.error("React Router caught the following error during render",n)}render(){return this.state.error!==void 0?K.createElement(Kn.Provider,{value:this.props.routeContext},K.createElement(Cm.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function vT({routeContext:n,match:t,children:i}){let a=K.useContext(mo);return a&&a.static&&a.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(a.staticContext._deepestRenderedBoundaryId=t.route.id),K.createElement(Kn.Provider,{value:n},i)}function _T(n,t=[],i=null,a=null,o=null){if(n==null){if(!i)return null;if(i.errors)n=i.matches;else if(t.length===0&&!i.initialized&&i.matches.length>0)n=i.matches;else return null}let u=n,f=i?.errors;if(f!=null){let g=u.findIndex(v=>v.route.id&&f?.[v.route.id]!==void 0);he(g>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(f).join(",")}`),u=u.slice(0,Math.min(u.length,g+1))}let m=!1,p=-1;if(i)for(let g=0;g<u.length;g++){let v=u[g];if((v.route.HydrateFallback||v.route.hydrateFallbackElement)&&(p=g),v.route.id){let{loaderData:w,errors:S}=i,R=v.route.loader&&!w.hasOwnProperty(v.route.id)&&(!S||S[v.route.id]===void 0);if(v.route.lazy||R){m=!0,p>=0?u=u.slice(0,p+1):u=[u[0]];break}}}return u.reduceRight((g,v,w)=>{let S,R=!1,V=null,B=null;i&&(S=f&&v.route.id?f[v.route.id]:void 0,V=v.route.errorElement||yT,m&&(p<0&&w===0?(I_("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),R=!0,B=null):p===w&&(R=!0,B=v.route.hydrateFallbackElement||null)));let P=t.concat(u.slice(0,w+1)),X=()=>{let Y;return S?Y=V:R?Y=B:v.route.Component?Y=K.createElement(v.route.Component,null):v.route.element?Y=v.route.element:Y=g,K.createElement(vT,{match:v,routeContext:{outlet:g,matches:P,isDataRoute:i!=null},children:Y})};return i&&(v.route.ErrorBoundary||v.route.errorElement||w===0)?K.createElement(xT,{location:i.location,revalidation:i.revalidation,component:V,error:S,children:X(),routeContext:{outlet:null,matches:P,isDataRoute:!0},unstable_onError:a}):X()},null)}function jm(n){return`${n} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function ET(n){let t=K.useContext(mo);return he(t,jm(n)),t}function bT(n){let t=K.useContext(Nh);return he(t,jm(n)),t}function wT(n){let t=K.useContext(Kn);return he(t,jm(n)),t}function Dm(n){let t=wT(n),i=t.matches[t.matches.length-1];return he(i.route.id,`${n} can only be used on routes that contain a unique "id"`),i.route.id}function TT(){return Dm("useRouteId")}function ST(){let n=K.useContext(Cm),t=bT("useRouteError"),i=Dm("useRouteError");return n!==void 0?n:t.errors?.[i]}function AT(){let{router:n}=ET("useNavigate"),t=Dm("useNavigate"),i=K.useRef(!1);return R_(()=>{i.current=!0}),K.useCallback(async(o,u={})=>{ri(i.current,A_),i.current&&(typeof o=="number"?n.navigate(o):await n.navigate(o,{fromRouteId:t,...u}))},[n,t])}var ax={};function I_(n,t,i){!t&&!ax[n]&&(ax[n]=!0,ri(!1,i))}K.memo(RT);function RT({routes:n,future:t,state:i,unstable_onError:a}){return C_(n,void 0,i,a,t)}function CT({to:n,replace:t,state:i,relative:a}){he(yo(),"<Navigate> may be used only in the context of a <Router> component.");let{static:o}=K.useContext(si);ri(!o,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:u}=K.useContext(Kn),{pathname:f}=ji(),m=Im(),p=Rm(n,Am(u),f,a==="path"),g=JSON.stringify(p);return K.useEffect(()=>{m(JSON.parse(g),{replace:t,state:i,relative:a})},[m,g,a,t,i]),null}function IT(n){return dT(n.context)}function tr(n){he(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function jT({basename:n="/",children:t=null,location:i,navigationType:a="POP",navigator:o,static:u=!1}){he(!yo(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let f=n.replace(/^\/*/,"/"),m=K.useMemo(()=>({basename:f,navigator:o,static:u,future:{}}),[f,o,u]);typeof i=="string"&&(i=po(i));let{pathname:p="/",search:g="",hash:v="",state:w=null,key:S="default"}=i,R=K.useMemo(()=>{let V=ar(p,f);return V==null?null:{location:{pathname:V,search:g,hash:v,state:w,key:S},navigationType:a}},[f,p,g,v,w,S,a]);return ri(R!=null,`<Router basename="${f}"> is not able to match the URL "${p}${g}${v}" because it does not start with the basename, so the <Router> won't render anything.`),R==null?null:K.createElement(si.Provider,{value:m},K.createElement(go.Provider,{children:t,value:R}))}function DT({children:n,location:t}){return mT(Bp(n),t)}function Bp(n,t=[]){let i=[];return K.Children.forEach(n,(a,o)=>{if(!K.isValidElement(a))return;let u=[...t,o];if(a.type===K.Fragment){i.push.apply(i,Bp(a.props.children,u));return}he(a.type===tr,`[${typeof a.type=="string"?a.type:a.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),he(!a.props.index||!a.props.children,"An index route cannot have child routes.");let f={id:a.props.id||u.join("-"),caseSensitive:a.props.caseSensitive,element:a.props.element,Component:a.props.Component,index:a.props.index,path:a.props.path,loader:a.props.loader,action:a.props.action,hydrateFallbackElement:a.props.hydrateFallbackElement,HydrateFallback:a.props.HydrateFallback,errorElement:a.props.errorElement,ErrorBoundary:a.props.ErrorBoundary,hasErrorBoundary:a.props.hasErrorBoundary===!0||a.props.ErrorBoundary!=null||a.props.errorElement!=null,shouldRevalidate:a.props.shouldRevalidate,handle:a.props.handle,lazy:a.props.lazy};a.props.children&&(f.children=Bp(a.props.children,u)),i.push(f)}),i}var Wc="get",Zc="application/x-www-form-urlencoded";function Mh(n){return n!=null&&typeof n.tagName=="string"}function NT(n){return Mh(n)&&n.tagName.toLowerCase()==="button"}function MT(n){return Mh(n)&&n.tagName.toLowerCase()==="form"}function OT(n){return Mh(n)&&n.tagName.toLowerCase()==="input"}function VT(n){return!!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)}function kT(n,t){return n.button===0&&(!t||t==="_self")&&!VT(n)}var Pc=null;function UT(){if(Pc===null)try{new FormData(document.createElement("form"),0),Pc=!1}catch{Pc=!0}return Pc}var PT=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function up(n){return n!=null&&!PT.has(n)?(ri(!1,`"${n}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Zc}"`),null):n}function LT(n,t){let i,a,o,u,f;if(MT(n)){let m=n.getAttribute("action");a=m?ar(m,t):null,i=n.getAttribute("method")||Wc,o=up(n.getAttribute("enctype"))||Zc,u=new FormData(n)}else if(NT(n)||OT(n)&&(n.type==="submit"||n.type==="image")){let m=n.form;if(m==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let p=n.getAttribute("formaction")||m.getAttribute("action");if(a=p?ar(p,t):null,i=n.getAttribute("formmethod")||m.getAttribute("method")||Wc,o=up(n.getAttribute("formenctype"))||up(m.getAttribute("enctype"))||Zc,u=new FormData(m,n),!UT()){let{name:g,type:v,value:w}=n;if(v==="image"){let S=g?`${g}.`:"";u.append(`${S}x`,"0"),u.append(`${S}y`,"0")}else g&&u.append(g,w)}}else{if(Mh(n))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');i=Wc,a=null,o=Zc,f=n}return u&&o==="text/plain"&&(f=u,u=void 0),{action:a,method:i.toLowerCase(),encType:o,formData:u,body:f}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Nm(n,t){if(n===!1||n===null||typeof n>"u")throw new Error(t)}function zT(n,t,i){let a=typeof n=="string"?new URL(n,typeof window>"u"?"server://singlefetch/":window.location.origin):n;return a.pathname==="/"?a.pathname=`_root.${i}`:t&&ar(a.pathname,t)==="/"?a.pathname=`${t.replace(/\/$/,"")}/_root.${i}`:a.pathname=`${a.pathname.replace(/\/$/,"")}.${i}`,a}async function BT(n,t){if(n.id in t)return t[n.id];try{let i=await import(n.module);return t[n.id]=i,i}catch(i){return console.error(`Error loading route module \`${n.module}\`, reloading page...`),console.error(i),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function $T(n){return n==null?!1:n.href==null?n.rel==="preload"&&typeof n.imageSrcSet=="string"&&typeof n.imageSizes=="string":typeof n.rel=="string"&&typeof n.href=="string"}async function FT(n,t,i){let a=await Promise.all(n.map(async o=>{let u=t.routes[o.route.id];if(u){let f=await BT(u,i);return f.links?f.links():[]}return[]}));return GT(a.flat(1).filter($T).filter(o=>o.rel==="stylesheet"||o.rel==="preload").map(o=>o.rel==="stylesheet"?{...o,rel:"prefetch",as:"style"}:{...o,rel:"prefetch"}))}function sx(n,t,i,a,o,u){let f=(p,g)=>i[g]?p.route.id!==i[g].route.id:!0,m=(p,g)=>i[g].pathname!==p.pathname||i[g].route.path?.endsWith("*")&&i[g].params["*"]!==p.params["*"];return u==="assets"?t.filter((p,g)=>f(p,g)||m(p,g)):u==="data"?t.filter((p,g)=>{let v=a.routes[p.route.id];if(!v||!v.hasLoader)return!1;if(f(p,g)||m(p,g))return!0;if(p.route.shouldRevalidate){let w=p.route.shouldRevalidate({currentUrl:new URL(o.pathname+o.search+o.hash,window.origin),currentParams:i[0]?.params||{},nextUrl:new URL(n,window.origin),nextParams:p.params,defaultShouldRevalidate:!0});if(typeof w=="boolean")return w}return!0}):[]}function qT(n,t,{includeHydrateFallback:i}={}){return KT(n.map(a=>{let o=t.routes[a.route.id];if(!o)return[];let u=[o.module];return o.clientActionModule&&(u=u.concat(o.clientActionModule)),o.clientLoaderModule&&(u=u.concat(o.clientLoaderModule)),i&&o.hydrateFallbackModule&&(u=u.concat(o.hydrateFallbackModule)),o.imports&&(u=u.concat(o.imports)),u}).flat(1))}function KT(n){return[...new Set(n)]}function HT(n){let t={},i=Object.keys(n).sort();for(let a of i)t[a]=n[a];return t}function GT(n,t){let i=new Set;return new Set(t),n.reduce((a,o)=>{let u=JSON.stringify(HT(o));return i.has(u)||(i.add(u),a.push({key:u,link:o})),a},[])}function j_(){let n=K.useContext(mo);return Nm(n,"You must render this element inside a <DataRouterContext.Provider> element"),n}function YT(){let n=K.useContext(Nh);return Nm(n,"You must render this element inside a <DataRouterStateContext.Provider> element"),n}var Mm=K.createContext(void 0);Mm.displayName="FrameworkContext";function D_(){let n=K.useContext(Mm);return Nm(n,"You must render this element inside a <HydratedRouter> element"),n}function QT(n,t){let i=K.useContext(Mm),[a,o]=K.useState(!1),[u,f]=K.useState(!1),{onFocus:m,onBlur:p,onMouseEnter:g,onMouseLeave:v,onTouchStart:w}=t,S=K.useRef(null);K.useEffect(()=>{if(n==="render"&&f(!0),n==="viewport"){let B=X=>{X.forEach(Y=>{f(Y.isIntersecting)})},P=new IntersectionObserver(B,{threshold:.5});return S.current&&P.observe(S.current),()=>{P.disconnect()}}},[n]),K.useEffect(()=>{if(a){let B=setTimeout(()=>{f(!0)},100);return()=>{clearTimeout(B)}}},[a]);let R=()=>{o(!0)},V=()=>{o(!1),f(!1)};return i?n!=="intent"?[u,S,{}]:[u,S,{onFocus:Nl(m,R),onBlur:Nl(p,V),onMouseEnter:Nl(g,R),onMouseLeave:Nl(v,V),onTouchStart:Nl(w,R)}]:[!1,S,{}]}function Nl(n,t){return i=>{n&&n(i),i.defaultPrevented||t(i)}}function XT({page:n,...t}){let{router:i}=j_(),a=K.useMemo(()=>E_(i.routes,n,i.basename),[i.routes,n,i.basename]);return a?K.createElement(ZT,{page:n,matches:a,...t}):null}function WT(n){let{manifest:t,routeModules:i}=D_(),[a,o]=K.useState([]);return K.useEffect(()=>{let u=!1;return FT(n,t,i).then(f=>{u||o(f)}),()=>{u=!0}},[n,t,i]),a}function ZT({page:n,matches:t,...i}){let a=ji(),{manifest:o,routeModules:u}=D_(),{basename:f}=j_(),{loaderData:m,matches:p}=YT(),g=K.useMemo(()=>sx(n,t,p,o,a,"data"),[n,t,p,o,a]),v=K.useMemo(()=>sx(n,t,p,o,a,"assets"),[n,t,p,o,a]),w=K.useMemo(()=>{if(n===a.pathname+a.search+a.hash)return[];let V=new Set,B=!1;if(t.forEach(X=>{let Y=o.routes[X.route.id];!Y||!Y.hasLoader||(!g.some(J=>J.route.id===X.route.id)&&X.route.id in m&&u[X.route.id]?.shouldRevalidate||Y.hasClientLoader?B=!0:V.add(X.route.id))}),V.size===0)return[];let P=zT(n,f,"data");return B&&V.size>0&&P.searchParams.set("_routes",t.filter(X=>V.has(X.route.id)).map(X=>X.route.id).join(",")),[P.pathname+P.search]},[f,m,a,o,g,t,n,u]),S=K.useMemo(()=>qT(v,o),[v,o]),R=WT(v);return K.createElement(K.Fragment,null,w.map(V=>K.createElement("link",{key:V,rel:"prefetch",as:"fetch",href:V,...i})),S.map(V=>K.createElement("link",{key:V,rel:"modulepreload",href:V,...i})),R.map(({key:V,link:B})=>K.createElement("link",{key:V,nonce:i.nonce,...B})))}function JT(...n){return t=>{n.forEach(i=>{typeof i=="function"?i(t):i!=null&&(i.current=t)})}}var N_=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{N_&&(window.__reactRouterVersion="7.9.1")}catch{}function tS({basename:n,children:t,window:i}){let a=K.useRef();a.current==null&&(a.current=kw({window:i,v5Compat:!0}));let o=a.current,[u,f]=K.useState({action:o.action,location:o.location}),m=K.useCallback(p=>{K.startTransition(()=>f(p))},[f]);return K.useLayoutEffect(()=>o.listen(m),[o,m]),K.createElement(jT,{basename:n,children:t,location:u.location,navigationType:u.action,navigator:o})}var M_=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,xo=K.forwardRef(function({onClick:t,discover:i="render",prefetch:a="none",relative:o,reloadDocument:u,replace:f,state:m,target:p,to:g,preventScrollReset:v,viewTransition:w,...S},R){let{basename:V}=K.useContext(si),B=typeof g=="string"&&M_.test(g),P,X=!1;if(typeof g=="string"&&B&&(P=g,N_))try{let I=new URL(window.location.href),M=g.startsWith("//")?new URL(I.protocol+g):new URL(g),k=ar(M.pathname,V);M.origin===I.origin&&k!=null?g=k+M.search+M.hash:X=!0}catch{ri(!1,`<Link to="${g}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let Y=uT(g,{relative:o}),[J,ot,Z]=QT(a,S),ft=rS(g,{replace:f,state:m,target:p,preventScrollReset:v,relative:o,viewTransition:w});function j(I){t&&t(I),I.defaultPrevented||ft(I)}let C=K.createElement("a",{...S,...Z,href:P||Y,onClick:X||u?t:j,ref:JT(R,ot),target:p,"data-discover":!B&&i==="render"?"true":void 0});return J&&!B?K.createElement(K.Fragment,null,C,K.createElement(XT,{page:Y})):C});xo.displayName="Link";var eS=K.forwardRef(function({"aria-current":t="page",caseSensitive:i=!1,className:a="",end:o=!1,style:u,to:f,viewTransition:m,children:p,...g},v){let w=lu(f,{relative:g.relative}),S=ji(),R=K.useContext(Nh),{navigator:V,basename:B}=K.useContext(si),P=R!=null&&uS(w)&&m===!0,X=V.encodeLocation?V.encodeLocation(w).pathname:w.pathname,Y=S.pathname,J=R&&R.navigation&&R.navigation.location?R.navigation.location.pathname:null;i||(Y=Y.toLowerCase(),J=J?J.toLowerCase():null,X=X.toLowerCase()),J&&B&&(J=ar(J,B)||J);const ot=X!=="/"&&X.endsWith("/")?X.length-1:X.length;let Z=Y===X||!o&&Y.startsWith(X)&&Y.charAt(ot)==="/",ft=J!=null&&(J===X||!o&&J.startsWith(X)&&J.charAt(X.length)==="/"),j={isActive:Z,isPending:ft,isTransitioning:P},C=Z?t:void 0,I;typeof a=="function"?I=a(j):I=[a,Z?"active":null,ft?"pending":null,P?"transitioning":null].filter(Boolean).join(" ");let M=typeof u=="function"?u(j):u;return K.createElement(xo,{...g,"aria-current":C,className:I,ref:v,style:M,to:f,viewTransition:m},typeof p=="function"?p(j):p)});eS.displayName="NavLink";var nS=K.forwardRef(({discover:n="render",fetcherKey:t,navigate:i,reloadDocument:a,replace:o,state:u,method:f=Wc,action:m,onSubmit:p,relative:g,preventScrollReset:v,viewTransition:w,...S},R)=>{let V=oS(),B=lS(m,{relative:g}),P=f.toLowerCase()==="get"?"get":"post",X=typeof m=="string"&&M_.test(m),Y=J=>{if(p&&p(J),J.defaultPrevented)return;J.preventDefault();let ot=J.nativeEvent.submitter,Z=ot?.getAttribute("formmethod")||f;V(ot||J.currentTarget,{fetcherKey:t,method:Z,navigate:i,replace:o,state:u,relative:g,preventScrollReset:v,viewTransition:w})};return K.createElement("form",{ref:R,method:P,action:B,onSubmit:a?p:Y,...S,"data-discover":!X&&n==="render"?"true":void 0})});nS.displayName="Form";function iS(n){return`${n} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function O_(n){let t=K.useContext(mo);return he(t,iS(n)),t}function rS(n,{target:t,replace:i,state:a,preventScrollReset:o,relative:u,viewTransition:f}={}){let m=Im(),p=ji(),g=lu(n,{relative:u});return K.useCallback(v=>{if(kT(v,t)){v.preventDefault();let w=i!==void 0?i:Yl(p)===Yl(g);m(n,{replace:w,state:a,preventScrollReset:o,relative:u,viewTransition:f})}},[p,m,g,i,a,t,n,o,u,f])}var aS=0,sS=()=>`__${String(++aS)}__`;function oS(){let{router:n}=O_("useSubmit"),{basename:t}=K.useContext(si),i=TT();return K.useCallback(async(a,o={})=>{let{action:u,method:f,encType:m,formData:p,body:g}=LT(a,t);if(o.navigate===!1){let v=o.fetcherKey||sS();await n.fetch(v,i,o.action||u,{preventScrollReset:o.preventScrollReset,formData:p,body:g,formMethod:o.method||f,formEncType:o.encType||m,flushSync:o.flushSync})}else await n.navigate(o.action||u,{preventScrollReset:o.preventScrollReset,formData:p,body:g,formMethod:o.method||f,formEncType:o.encType||m,replace:o.replace,state:o.state,fromRouteId:i,flushSync:o.flushSync,viewTransition:o.viewTransition})},[n,t,i])}function lS(n,{relative:t}={}){let{basename:i}=K.useContext(si),a=K.useContext(Kn);he(a,"useFormAction must be used inside a RouteContext");let[o]=a.matches.slice(-1),u={...lu(n||".",{relative:t})},f=ji();if(n==null){u.search=f.search;let m=new URLSearchParams(u.search),p=m.getAll("index");if(p.some(v=>v==="")){m.delete("index"),p.filter(w=>w).forEach(w=>m.append("index",w));let v=m.toString();u.search=v?`?${v}`:""}}return(!n||n===".")&&o.route.index&&(u.search=u.search?u.search.replace(/^\?/,"?index&"):"?index"),i!=="/"&&(u.pathname=u.pathname==="/"?i:nr([i,u.pathname])),Yl(u)}function uS(n,{relative:t}={}){let i=K.useContext(S_);he(i!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:a}=O_("useViewTransitionState"),o=lu(n,{relative:t});if(!i.isTransitioning)return!1;let u=ar(i.currentLocation.pathname,a)||i.currentLocation.pathname,f=ar(i.nextLocation.pathname,a)||i.nextLocation.pathname;return hh(o.pathname,f)!=null||hh(o.pathname,u)!=null}var cp={exports:{}},nn={};/**
 * @license React
...
`;function i4({title:n,rows:t,last:i=!1}){return x.jsxs(JA,{$last:i,children:[x.jsx(t4,{children:x.jsx(e4,{children:n})}),x.jsx(n4,{children:t.map((a,o)=>x.jsx(u4,{ko:a.ko,en:a.en,divider:t.length>1&&o!==t.length-1},a.ko+a.en+o))})]})}const r4=A.div`
...
`,v4=A(Qp)`
 @media (max-width: 640px) {
    display: none;
 }`;function Bm({nameKor:n,nameEng:t,role:i,sns:a,eMail:o,imgSrc:u,imgAlt:f}){return x.jsxs(d4,{children:[x.jsxs(p4,{children:[x.jsx(m4,{src:u,alt:f}),x.jsx(g4,{})]}),x.jsxs(y4,{children:[x.jsxs(Dx,{style:{top:"50px"},children:[x.jsx(x4,{children:n}),x.jsx(Qp,{children:t})]}),x.jsxs(Dx,{children:[x.jsx(Qp,{children:i}),Array.isArray(a)&&a.length>0?x.jsx("div",{style:{display:"flex",gap:"8px",flexWrap:"wrap",margin:"4px 0 0 0"},children:a.map((m,p)=>x.jsx("a",{href:m.url,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",color:"inherit",wordBreak:"break-all"},"aria-label":`${n} ${m.platform}`,children:m.url},`${m.platform}-${p}`))}):null,x.jsx(v4,{children:o?x.jsx("a",{style:{textDecoration:"none",color:"inherit"},href:`mailto:${o}`,children:o}):null})]})]})]})}Bm.defaultProps={sns:[]};Bm.propTypes={nameKor:W.string.isRequired,nameEng:W.string,role:W.string,sns:W.arrayOf(W.shape({platform:W.string.isRequired,url:W.string.isRequired})),eMail:W.string,imgSrc:W.string.isRequired,imgAlt:W.string.isRequired};const _4=A.div`
  display: flex;
  align-items: center;
  justify-content: flex-start;
  flex-direction: row;
...
`;function Xp({path:n="student",isActive:t=!1,onClick:i}){return x.jsxs(_4,{onClick:i,children:[x.jsx(oE,{$active:t,children:"교수"}),x.jsx(b4,{$active:t,children:"학생"}),x.jsx(E4,{$active:t})]})}Xp.propTypes={path:W.oneOf(["student","professor"]),isActive:W.bool,onClick:W.func};const Nx=A.a`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  font-size: 24px;
  line-height: 28.8px;
  letter-spacing: 0.24px;
...
`,H4=A.div`position: relative;`;function G4({people:n}){const t=Im();return x.jsx(F4,{children:n.map((i,a)=>{const o=i.id??i.studentId??`${i.nameKor}-${a}`,u=typeof i.projectNum=="number"&&i.category,f=u?i.projectNum+1:null,m=u?`${P4[i.category]||"A"}${String(f).padStart(3,"0")}`:null,p=x.jsx(Bm,{nameKor:i.nameKor,nameEng:i.nameEng,role:i.role,sns:i.sns||"-",eMail:i.eMail,imgSrc:fE(i.imgUrl),imgAlt:`${i.nameKor} profile`},o);return u?x.jsx(K4,{role:"link",tabIndex:0,onClick:()=>t(`/work/${m}`),onKeyDown:g=>{(g.key==="Enter"||g.key===" ")&&t(`/work/${m}`)},"aria-label":`${i.nameKor} 작품 보기 (${m})`,children:p},`link-${o}`):p})})}function Y4(){const[n,t]=Ot.useState(!1),[i,a]=Ot.useState(Ux[0]),o=Ot.useMemo(()=>{const m=new Map;return(Xl||[]).forEach(p=>{(p.members||[]).forEach(g=>{m.has(g)||m.set(g,p)})}),m},[]);Ot.useEffect(()=>{a(n?Ml[0]?.id||"":Ux[0])},[n]);const u=Ot.useMemo(()=>{if(!n){if(i==="전체")return wp;let p=L4[i];return p===void 0&&(p=Px(i)),wp.filter(g=>Px(g.department)===p)}const m=Ml.some(p=>p.id===i)?i:Ml.find(p=>p.nameKor===i)?.id||"";return wp.filter(p=>p.professorId===m).map(p=>{let g=o.get(p.num);g||(g=(Xl||[]).find(w=>w.category===p.category&&w.projectNum===p.projectNum)||null);const v=g?`/projects/${g.projectNum}/thumb.jpg`:"/thumbnailExample.png";return{...p,imgUrl:v}})},[i,n,o]),f=Ot.useMemo(()=>n&&(Ml.find(p=>p.id===i)||Ml.find(p=>p.nameKor===i))||null,[n,i]);return x.jsxs(H4,{children:[x.jsx(q4,{children:"Peoples"}),x.jsx(hE,{type:"people",onCategoryChange:a,onToggleChange:t}),x.jsxs($4,{children:[n&&f&&x.jsx(qm,{nameKor:f.nameKor,rank:f.rank||"교수",eMail:f.email,education:f.education,field:f.field,imgSrc:fE(f.imgUrl),imgAlt:`${f.nameKor} profile`}),x.jsx(G4,{people:u})]})]})}const Q4=()=>{};var Lx={};/**
 * @license
 ...
 */const dE=function(n){const t=[];let i=0;for(let a=0;a<n.length;a++){let o=n.charCodeAt(a);o<128?t[i++]=o:o<2048?(t[i++]=o>>6|192,t[i++]=o&63|128):(o&64512)===55296&&a+1<n.length&&(n.charCodeAt(a+1)&64512)===56320?(o=65536+((o&1023)<<10)+(n.charCodeAt(++a)&1023),t[i++]=o>>18|240,t[i++]=o>>12&63|128,t[i++]=o>>6&63|128,t[i++]=o&63|128):(t[i++]=o>>12|224,t[i++]=o>>6&63|128,t[i++]=o&63|128)}return t},X4=function(n){const t=[];let i=0,a=0;for(;i<n.length;){const o=n[i++];if(o<128)t[a++]=String.fromCharCode(o);else if(o>191&&o<224){const u=n[i++];t[a++]=String.fromCharCode((o&31)<<6|u&63)}else if(o>239&&o<365){const u=n[i++],f=n[i++],m=n[i++],p=((o&7)<<18|(u&63)<<12|(f&63)<<6|m&63)-65536;t[a++]=String.fromCharCode(55296+(p>>10)),t[a++]=String.fromCharCode(56320+(p&1023))}else{const u=n[i++],f=n[i++];t[a++]=String.fromCharCode((o&15)<<12|(u&63)<<6|f&63)}}return t.join("")},pE={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,t){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const i=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,a=[];for(let o=0;o<n.length;o+=3){const u=n[o],f=o+1<n.length,m=f?n[o+1]:0,p=o+2<n.length,g=p?n[o+2]:0,v=u>>2,w=(u&3)<<4|m>>4;let S=(m&15)<<2|g>>6,R=g&63;p||(R=64,f||(S=64)),a.push(i[v],i[w],i[S],i[R])}return a.join("")},encodeString(n,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(n):this.encodeByteArray(dE(n),t)},decodeString(n,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(n):X4(this.decodeStringToByteArray(n,t))},decodeStringToByteArray(n,t){this.init_();const i=t?this.charToByteMapWebSafe_:this.charToByteMap_,a=[];for(let o=0;o<n.length;){const u=i[n.charAt(o++)],m=o<n.length?i[n.charAt(o)]:0;++o;const g=o<n.length?i[n.charAt(o)]:64;++o;const w=o<n.length?i[n.charAt(o)]:64;if(++o,u==null||m==null||g==null||w==null)throw new W4;const S=u<<2|m>>4;if(a.push(S),g!==64){const R=m<<4&240|g>>2;if(a.push(R),w!==64){const V=g<<6&192|w;a.push(V)}}}return a},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class W4 extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Z4=function(n){const t=dE(n);return pE.encodeByteArray(t,!0)},gh=function(n){return Z4(n).replace(/\./g,"")},J4=function(n){try{return pE.decodeString(n,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eR=()=>tR().__FIREBASE_DEFAULTS__,nR=()=>{if(typeof process>"u"||typeof Lx>"u")return;const n=Lx.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},iR=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=n&&J4(n[1]);return t&&JSON.parse(t)},Hm=()=>{try{return Q4()||eR()||nR()||iR()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},rR=n=>Hm()?.emulatorHosts?.[n],aR=n=>{const t=rR(n);if(!t)return;const i=t.lastIndexOf(":");if(i<=0||i+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const a=parseInt(t.substring(i+1),10);return t[0]==="["?[t.substring(1,i-1),a]:[t.substring(0,i),a]},mE=()=>Hm()?.config;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gm(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function oR(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fR(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function dR(){const n=Hm()?.forceEnvironment;if(n==="node")return!0;if(n==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function pR(){return!dR()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function mR(){try{return typeof indexedDB=="object"}catch{return!1}}function gR(){return new Promise((n,t)=>{try{let i=!0;const a="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(a);o.onsuccess=()=>{o.result.close(),i||self.indexedDB.deleteDatabase(a),n(!0)},o.onupgradeneeded=()=>{i=!1},o.onerror=()=>{t(o.error?.message||"")}}catch(i){t(i)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yR="FirebaseError";class _o extends Error{constructor(t,i,a){super(i),this.code=t,this.customData=a,this.name=yR,Object.setPrototypeOf(this,_o.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,gE.prototype.create)}}class gE{constructor(t,i,a){this.service=t,this.serviceName=i,this.errors=a}create(t,...i){const a=i[0]||{},o=`${this.service}/${t}`,u=this.errors[t],f=u?xR(u,a):"Error",m=`${this.serviceName}: ${f} (${o}).`;return new _o(o,m,a)}}function xR(n,t){return n.replace(vR,(i,a)=>{const o=t[a];return o!=null?String(o):`<${a}?>`})}const vR=/\{\$([^}]+)}/g;function yh(n,t){if(n===t)return!0;const i=Object.keys(n),a=Object.keys(t);for(const o of i){if(!a.includes(o))return!1;const u=n[o],f=t[o];if(Bx(u)&&Bx(f)){if(!yh(u,f))return!1}else if(u!==f)return!1}for(const o of a)if(!i.includes(o))return!1;return!0}function Bx(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _R{constructor(t,i){this.name=t,this.container=i,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const i=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(i)){const a=new sR;if(this.instancesDeferred.set(i,a),this.isInitialized(i)||this.shouldAutoInitialize())try{const o=this.getOrInitializeService({instanceIdentifier:i});o&&a.resolve(o)}catch{}}return this.instancesDeferred.get(i).promise}getImmediate(t){const i=this.normalizeInstanceIdentifier(t?.identifier),a=t?.optional??!1;if(this.isInitialized(i)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:i})}catch(o){if(a)return null;throw o}else{if(a)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(bR(t))try{this.getOrInitializeService({instanceIdentifier:Ka})}catch{}for(const[i,a]of this.instancesDeferred.entries()){const o=this.normalizeInstanceIdentifier(i);try{const u=this.getOrInitializeService({instanceIdentifier:o});a.resolve(u)}catch{}}}}clearInstance(t=Ka){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(i=>"INTERNAL"in i).map(i=>i.INTERNAL.delete()),...t.filter(i=>"_delete"in i).map(i=>i._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=Ka){return this.instances.has(t)}getOptions(t=Ka){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:i={}}=t,a=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(a))throw Error(`${this.name}(${a}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const o=this.getOrInitializeService({instanceIdentifier:a,options:i});for(const[u,f]of this.instancesDeferred.entries()){const m=this.normalizeInstanceIdentifier(u);a===m&&f.resolve(o)}return o}onInit(t,i){const a=this.normalizeInstanceIdentifier(i),o=this.onInitCallbacks.get(a)??new Set;o.add(t),this.onInitCallbacks.set(a,o);const u=this.instances.get(a);return u&&t(u,a),()=>{o.delete(t)}}invokeOnInitCallbacks(t,i){const a=this.onInitCallbacks.get(i);if(a)for(const o of a)try{o(t,i)}catch{}}getOrInitializeService({instanceIdentifier:t,options:i={}}){let a=this.instances.get(t);if(!a&&this.component&&(a=this.component.instanceFactory(this.container,{instanceIdentifier:ER(t),options:i}),this.instances.set(t,a),this.instancesOptions.set(t,i),this.invokeOnInitCallbacks(a,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,a)}catch{}return a||null}normalizeInstanceIdentifier(t=Ka){return this.component?this.component.multipleInstances?t:Ka:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function ER(n){return n===Ka?void 0:n}function bR(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wR{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const i=this.getProvider(t.name);if(i.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);i.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const i=new _R(t,this);return this.providers.set(t,i),i}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $t;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})($t||($t={}));const TR={debug:$t.DEBUG,verbose:$t.VERBOSE,info:$t.INFO,warn:$t.WARN,error:$t.ERROR,silent:$t.SILENT},SR=$t.INFO,AR={[$t.DEBUG]:"log",[$t.VERBOSE]:"log",[$t.INFO]:"info",[$t.WARN]:"warn",[$t.ERROR]:"error"},RR=(n,t,...i)=>{if(t<n.logLevel)return;const a=new Date().toISOString(),o=AR[t];if(o)console[o](`[${a}]  ${n.name}:`,...i);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class yE{constructor(t){this.name=t,this._logLevel=SR,this._logHandler=RR,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in $t))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?TR[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,$t.DEBUG,...t),this._logHandler(this,$t.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,$t.VERBOSE,...t),this._logHandler(this,$t.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,$t.INFO,...t),this._logHandler(this,$t.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,$t.WARN,...t),this._logHandler(this,$t.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,$t.ERROR,...t),this._logHandler(this,$t.ERROR,...t)}}const CR=(n,t)=>t.some(i=>n instanceof i);let $x,Fx;function IR(){return $x||($x=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function jR(){return Fx||(Fx=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const xE=new WeakMap,Wp=new WeakMap,vE=new WeakMap,Tp=new WeakMap,Ym=new WeakMap;function DR(n){const t=new Promise((i,a)=>{const o=()=>{n.removeEventListener("success",u),n.removeEventListener("error",f)},u=()=>{i(Qr(n.result)),o()},f=()=>{a(n.error),o()};n.addEventListener("success",u),n.addEventListener("error",f)});return t.then(i=>{i instanceof IDBCursor&&xE.set(i,n)}).catch(()=>{}),Ym.set(t,n),t}function NR(n){if(Wp.has(n))return;const t=new Promise((i,a)=>{const o=()=>{n.removeEventListener("complete",u),n.removeEventListener("error",f),n.removeEventListener("abort",f)},u=()=>{i(),o()},f=()=>{a(n.error||new DOMException("AbortError","AbortError")),o()};n.addEventListener("complete",u),n.addEventListener("error",f),n.addEventListener("abort",f)});Wp.set(n,t)}let Zp={get(n,t,i){if(n instanceof IDBTransaction){if(t==="done")return Wp.get(n);if(t==="objectStoreNames")return n.objectStoreNames||vE.get(n);if(t==="store")return i.objectStoreNames[1]?void 0:i.objectStore(i.objectStoreNames[0])}return Qr(n[t])},set(n,t,i){return n[t]=i,!0},has(n,t){return n instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in n}};function MR(n){Zp=n(Zp)}function OR(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...i){const a=n.call(Sp(this),t,...i);return vE.set(a,t.sort?t.sort():[t]),Qr(a)}:jR().includes(n)?function(...t){return n.apply(Sp(this),t),Qr(xE.get(this))}:function(...t){return Qr(n.apply(Sp(this),t))}}function VR(n){return typeof n=="function"?OR(n):(n instanceof IDBTransaction&&NR(n),CR(n,IR())?new Proxy(n,Zp):n)}function Qr(n){if(n instanceof IDBRequest)return DR(n);if(Tp.has(n))return Tp.get(n);const t=VR(n);return t!==n&&(Tp.set(n,t),Ym.set(t,n)),t}const Sp=n=>Ym.get(n);function kR(n,t,{blocked:i,upgrade:a,blocking:o,terminated:u}={}){const f=indexedDB.open(n,t),m=Qr(f);return a&&f.addEventListener("upgradeneeded",p=>{a(Qr(f.result),p.oldVersion,p.newVersion,Qr(f.transaction),p)}),i&&f.addEventListener("blocked",p=>i(p.oldVersion,p.newVersion,p)),m.then(p=>{u&&p.addEventListener("close",()=>u()),o&&p.addEventListener("versionchange",g=>o(g.oldVersion,g.newVersion,g))}).catch(()=>{}),m}const UR=["get","getKey","getAll","getAllKeys","count"],PR=["put","add","delete","clear"],Ap=new Map;function qx(n,t){if(!(n instanceof IDBDatabase&&!(t in n)&&typeof t=="string"))return;if(Ap.get(t))return Ap.get(t);const i=t.replace(/FromIndex$/,""),a=t!==i,o=PR.includes(i);if(!(i in(a?IDBIndex:IDBObjectStore).prototype)||!(o||UR.includes(i)))return;const u=async function(f,...m){const p=this.transaction(f,o?"readwrite":"readonly");let g=p.store;return a&&(g=g.index(m.shift())),(await Promise.all([g[i](...m),o&&p.done]))[0]};return Ap.set(t,u),u}MR(n=>({...n,get:(t,i,a)=>qx(t,i)||n.get(t,i,a),has:(t,i)=>!!qx(t,i)||n.has(t,i)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LR{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(i=>{if(zR(i)){const a=i.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(i=>i).join(" ")}}function zR(n){return n.getComponent()?.type==="VERSION"}const Jp="@firebase/app",Kx="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sr=new yE("@firebase/app"),BR="@firebase/app-compat",$R="@firebase/analytics-compat",FR="@firebase/analytics",qR="@firebase/app-check-compat",KR="@firebase/app-check",HR="@firebase/auth",GR="@firebase/auth-compat",YR="@firebase/database",QR="@firebase/data-connect",XR="@firebase/database-compat",WR="@firebase/functions",ZR="@firebase/functions-compat",JR="@firebase/installations",t6="@firebase/installations-compat",e6="@firebase/messaging",n6="@firebase/messaging-compat",i6="@firebase/performance",r6="@firebase/performance-compat",a6="@firebase/remote-config",s6="@firebase/remote-config-compat",o6="@firebase/storage",l6="@firebase/storage-compat",u6="@firebase/firestore",c6="@firebase/ai",h6="@firebase/firestore-compat",f6="firebase",d6="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tm="[DEFAULT]",p6={[Jp]:"fire-core",[BR]:"fire-core-compat",[FR]:"fire-analytics",[$R]:"fire-analytics-compat",[KR]:"fire-app-check",[qR]:"fire-app-check-compat",[HR]:"fire-auth",[GR]:"fire-auth-compat",[YR]:"fire-rtdb",[QR]:"fire-data-connect",[XR]:"fire-rtdb-compat",[WR]:"fire-fn",[ZR]:"fire-fn-compat",[JR]:"fire-iid",[t6]:"fire-iid-compat",[e6]:"fire-fcm",[n6]:"fire-fcm-compat",[i6]:"fire-perf",[r6]:"fire-perf-compat",[a6]:"fire-rc",[s6]:"fire-rc-compat",[o6]:"fire-gcs",[l6]:"fire-gcs-compat",[u6]:"fire-fst",[h6]:"fire-fst-compat",[c6]:"fire-vertex","fire-js":"fire-js",[f6]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zl=new Map,m6=new Map,em=new Map;function Hx(n,t){try{n.container.addComponent(t)}catch(i){sr.debug(`Component ${t.name} failed to register with FirebaseApp ${n.name}`,i)}}function xh(n){const t=n.name;if(em.has(t))return sr.debug(`There were multiple attempts to register component ${t}.`),!1;em.set(t,n);for(const i of Zl.values())Hx(i,n);for(const i of m6.values())Hx(i,n);return!0}function g6(n,t){const i=n.container.getProvider("heartbeat").getImmediate({optional:!0});return i&&i.triggerHeartbeat(),n.container.getProvider(t)}function y6(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _6=d6;function Qm(n,t={}){let i=n;typeof t!="object"&&(t={name:t});const a={name:tm,automaticDataCollectionEnabled:!0,...t},o=a.name;if(typeof o!="string"||!o)throw Xr.create("bad-app-name",{appName:String(o)});if(i||(i=mE()),!i)throw Xr.create("no-options");const u=Zl.get(o);if(u){if(yh(i,u.options)&&yh(a,u.config))return u;throw Xr.create("duplicate-app",{appName:o})}const f=new wR(o);for(const p of em.values())f.addComponent(p);const m=new v6(i,a,f);return Zl.set(o,m),m}function E6(n=tm){const t=Zl.get(n);if(!t&&n===tm&&mE())return Qm();if(!t)throw Xr.create("no-app",{appName:n});return t}function Gx(){return Array.from(Zl.values())}function Zs(n,t,i){let a=p6[n]??n;i&&(a+=`-${i}`);const o=a.match(/\s|\//),u=t.match(/\s|\//);if(o||u){const f=[`Unable to register library "${a}" with version "${t}":`];o&&f.push(`library name "${a}" contains illegal characters (whitespace or "/")`),o&&u&&f.push("and"),u&&f.push(`version name "${t}" contains illegal characters (whitespace or "/")`),sr.warn(f.join(" "));return}xh(new Wl(`${a}-version`,()=>({library:a,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b6="firebase-heartbeat-database",w6=1,Jl="firebase-heartbeat-store";let Rp=null;function _E(){return Rp||(Rp=kR(b6,w6,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(Jl)}catch(i){console.warn(i)}}}}).catch(n=>{throw Xr.create("idb-open",{originalErrorMessage:n.message})})),Rp}async function T6(n){try{const i=(await _E()).transaction(Jl),a=await i.objectStore(Jl).get(EE(n));return await i.done,a}catch(t){if(t instanceof _o)sr.warn(t.message);else{const i=Xr.create("idb-get",{originalErrorMessage:t?.message});sr.warn(i.message)}}}async function Yx(n,t){try{const a=(await _E()).transaction(Jl,"readwrite");await a.objectStore(Jl).put(t,EE(n)),await a.done}catch(i){if(i instanceof _o)sr.warn(i.message);else{const a=Xr.create("idb-set",{originalErrorMessage:i?.message});sr.warn(a.message)}}}function EE(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S6=1024,A6=30;class R6{constructor(t){this.container=t,this._heartbeatsCache=null;const i=this.container.getProvider("app").getImmediate();this._storage=new I6(i),this._heartbeatsCachePromise=this._storage.read().then(a=>(this._heartbeatsCache=a,a))}async triggerHeartbeat(){try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),a=Qx();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===a||this._heartbeatsCache.heartbeats.some(o=>o.date===a))return;if(this._heartbeatsCache.heartbeats.push({date:a,agent:i}),this._heartbeatsCache.heartbeats.length>A6){const o=j6(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(t){sr.warn(t)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Qx(),{heartbeatsToSend:i,unsentEntries:a}=C6(this._heartbeatsCache.heartbeats),o=gh(JSON.stringify({version:2,heartbeats:i}));return this._heartbeatsCache.lastSentHeartbeatDate=t,a.length>0?(this._heartbeatsCache.heartbeats=a,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(t){return sr.warn(t),""}}}function Qx(){return new Date().toISOString().substring(0,10)}function C6(n,t=S6){const i=[];let a=n.slice();for(const o of n){const u=i.find(f=>f.agent===o.agent);if(u){if(u.dates.push(o.date),Xx(i)>t){u.dates.pop();break}}else if(i.push({agent:o.agent,dates:[o.date]}),Xx(i)>t){i.pop();break}a=a.slice(1)}return{heartbeatsToSend:i,unsentEntries:a}}class I6{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return mR()?gR().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const i=await T6(this.app);return i?.heartbeats?i:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){if(await this._canUseIndexedDBPromise){const a=await this.read();return Yx(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??a.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){if(await this._canUseIndexedDBPromise){const a=await this.read();return Yx(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??a.lastSentHeartbeatDate,heartbeats:[...a.heartbeats,...t.heartbeats]})}else return}}function Xx(n){return gh(JSON.stringify({version:2,heartbeats:n})).length}function j6(n){if(n.length===0)return-1;let t=0,i=n[0].date;for(let a=1;a<n.length;a++)n[a].date<i&&(i=n[a].date,t=a);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D6(n){xh(new Wl("platform-logger",t=>new LR(t),"PRIVATE")),xh(new Wl("heartbeat",t=>new R6(t),"PRIVATE")),Zs(Jp,Kx,n),Zs(Jp,Kx,"esm2020"),Zs("fire-js","")}D6("");var N6="firebase",M6="12.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Zs(N6,M6,"app");var Wx=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IE{constructor(t,i){this.user=i,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class O6{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,i){t.enqueueRetryable((()=>i(an.UNAUTHENTICATED)))}shutdown(){}}class V6{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,i){this.changeListener=i,t.enqueueRetryable((()=>i(this.token.user)))}shutdown(){this.changeListener=null}}class k6{constructor(t){this.t=t,this.currentUser=an.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,i){Gt(this.o===void 0,42304);let a=this.i;const o=p=>this.i!==a?(a=this.i,i(p)):Promise.resolve();let u=new ir;this.o=()=>{this.i++,this.currentUser=this.u(),u.resolve(),u=new ir,t.enqueueRetryable((()=>o(this.currentUser)))};const f=()=>{const p=u;t.enqueueRetryable((async()=>{await p.promise,await o(this.currentUser)}))},m=p=>{pt("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=p,this.o&&(this.auth.addAuthTokenListener(this.o),f())};this.t.onInit((p=>m(p))),setTimeout((()=>{if(!this.auth){const p=this.t.getImmediate({optional:!0});p?m(p):(pt("FirebaseAuthCredentialsProvider","Auth not yet detected"),u.resolve(),u=new ir)}}),0),f()}getToken(){const t=this.i,i=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(i).then((a=>this.i!==t?(pt("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):a?(Gt(typeof a.accessToken=="string",31837,{l:a}),new IE(a.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return Gt(t===null||typeof t=="string",2055,{h:t}),new an(t)}}class U6{constructor(t,i,a){this.P=t,this.T=i,this.I=a,this.type="FirstParty",this.user=an.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const t=this.R();return t&&this.A.set("Authorization",t),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class P6{constructor(t,i,a){this.P=t,this.T=i,this.I=a}getToken(){return Promise.resolve(new U6(this.P,this.T,this.I))}start(t,i){t.enqueueRetryable((()=>i(an.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class tv{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class L6{constructor(t,i){this.V=i,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,y6(t)&&t.settings.appCheckToken&&(this.p=t.settings.appCheckToken)}start(t,i){Gt(this.o===void 0,3512);const a=u=>{u.error!=null&&pt("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${u.error.message}`);const f=u.token!==this.m;return this.m=u.token,pt("FirebaseAppCheckTokenProvider",`Received ${f?"new":"existing"} token.`),f?i(u.token):Promise.resolve()};this.o=u=>{t.enqueueRetryable((()=>a(u)))};const o=u=>{pt("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=u,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((u=>o(u))),setTimeout((()=>{if(!this.appCheck){const u=this.V.getImmediate({optional:!0});u?o(u):pt("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new tv(this.p));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then((i=>i?(Gt(typeof i.token=="string",44558,{tokenResult:i}),this.m=i.token,new tv(i.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z6(n){const t=typeof self<"u"&&(self.crypto||self.msCrypto),i=new Uint8Array(n);if(t&&typeof t.getRandomValues=="function")t.getRandomValues(i);else for(let a=0;a<n;a++)i[a]=Math.floor(256*Math.random());return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wm{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",i=62*Math.floor(4.129032258064516);let a="";for(;a.length<20;){const o=z6(40);for(let u=0;u<o.length;++u)a.length<20&&o[u]<i&&(a+=t.charAt(o[u]%62))}return a}}function Ut(n,t){return n<t?-1:n>t?1:0}function im(n,t){const i=Math.min(n.length,t.length);for(let a=0;a<i;a++){const o=n.charAt(a),u=t.charAt(a);if(o!==u)return Cp(o)===Cp(u)?Ut(o,u):Cp(o)?1:-1}return Ut(n.length,t.length)}const B6=55296,$6=57343;function Cp(n){const t=n.charCodeAt(0);return t>=B6&&t<=$6}function lo(n,t,i){return n.length===t.length&&n.every(((a,o)=>i(a,t[o])))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tu=-1;function K6(n,t){const i=n.toTimestamp().seconds,a=n.toTimestamp().nanoseconds+1,o=St.fromTimestamp(a===1e9?new le(i+1,0):new le(i,a));return new Jr(o,vt.empty(),t)}function H6(n){return new Jr(n.readTime,n.key,tu)}class Jr{constructor(t,i,a){this.readTime=t,this.documentKey=i,this.largestBatchId=a}static min(){return new Jr(St.min(),vt.empty(),tu)}static max(){return new Jr(St.max(),vt.empty(),tu)}}function G6(n,t){let i=n.readTime.compareTo(t.readTime);return i!==0?i:(i=vt.comparator(n.documentKey,t.documentKey),i!==0?i:Ut(n.largestBatchId,t.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y6="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class Q6{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(t){this.onCommittedListeners.push(t)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((t=>t()))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bo(n){if(n.code!==it.FAILED_PRECONDITION||n.message!==Y6)throw n;pt("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zm=-1;function $h(n){return n==null}function vh(n){return n===0&&1/n==-1/0}function W6(n){return typeof n=="number"&&Number.isInteger(n)&&!vh(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const NE="";function Z6(n){let t="";for(let i=0;i<n.length;i++)t.length>0&&(t=sv(t)),t=J6(n.get(i),t);return sv(t)}function J6(n,t){let i=t;const a=n.length;for(let o=0;o<a;o++){const u=n.charAt(o);switch(u){case"\0":i+="";break;case NE:i+="";break;default:i+=u}}return i}function sv(n){return n+NE+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ov(n){let t=0;for(const i in n)Object.prototype.hasOwnProperty.call(n,i)&&t++;return t}function aa(n,t){for(const i in n)Object.prototype.hasOwnProperty.call(n,i)&&t(i,n[i])}function ME(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VE="server_timestamp",kE="__type__",UE="__previous_value__",PE="__local_write_time__";function Jm(n){return(n?.mapValue?.fields||{})[kE]?.stringValue===VE}function Fh(n){const t=n.mapValue.fields[UE];return Jm(t)?Fh(t):t}function eu(n){const t=ta(n.mapValue.fields[PE].timestampValue);return new le(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ru{constructor(t,i="asc"){this.field=t,this.dir=i}}function aC(n,t){return n.dir===t.dir&&n.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $E{}class De extends $E{constructor(t,i,a){super(),this.field=t,this.op=i,this.value=a}static create(t,i,a){return t.isKeyField()?i==="in"||i==="not-in"?this.createKeyFieldInFilter(t,i,a):new oC(t,i,a):i==="array-contains"?new cC(t,a):i==="in"?new hC(t,a):i==="not-in"?new fC(t,a):i==="array-contains-any"?new dC(t,a):new De(t,i,a)}static createKeyFieldInFilter(t,i,a){return i==="in"?new lC(t,a):new uC(t,a)}matches(t){const i=t.data.field(this.field);return this.op==="!="?i!==null&&i.nullValue===void 0&&this.matchesComparison(uo(i,this.value)):i!==null&&na(this.value)===na(i)&&this.matchesComparison(uo(i,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return wt(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class ai extends $E{constructor(t,i){super(),this.filters=t,this.op=i,this.Pe=null}static create(t,i){return new ai(t,i)}matches(t){return FE(this)?this.filters.find((i=>!i.matches(t)))===void 0:this.filters.find((i=>i.matches(t)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((t,i)=>t.concat(i.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function FE(n){return n.op==="and"}function qE(n){return sC(n)&&FE(n)}function sC(n){for(const t of n.filters)if(t instanceof ai)return!1;return!0}function sm(n){if(n instanceof De)return n.field.canonicalString()+n.op.toString()+co(n.value);if(qE(n))return n.filters.map((t=>sm(t))).join(",");{const t=n.filters.map((i=>sm(i))).join(",");return`${n.op}(${t})`}}function KE(n,t){return n instanceof De?(function(a,o){return o instanceof De&&a.op===o.op&&a.field.isEqual(o.field)&&Ii(a.value,o.value)})(n,t):n instanceof ai?(function(a,o){return o instanceof ai&&a.op===o.op&&a.filters.length===o.filters.length?a.filters.reduce(((u,f,m)=>u&&KE(f,o.filters[m])),!0):!1})(n,t):void wt(19439)}function HE(n){return n instanceof De?(function(i){return`${i.field.canonicalString()} ${i.op} ${co(i.value)}`})(n):n instanceof ai?(function(i){return i.op.toString()+" {"+i.getFilters().map(HE).join(" ,")+"}"})(n):"Filter"}class oC extends De{constructor(t,i,a){super(t,i,a),this.key=vt.fromName(a.referenceValue)}matches(t){const i=vt.comparator(t.key,this.key);return this.matchesComparison(i)}}class lC extends De{constructor(t,i){super(t,"in",i),this.keys=GE("in",i)}matches(t){return this.keys.some((i=>i.isEqual(t.key)))}}class uC extends De{constructor(t,i){super(t,"not-in",i),this.keys=GE("not-in",i)}matches(t){return!this.keys.some((i=>i.isEqual(t.key)))}}function GE(n,t){return(t.arrayValue?.values||[]).map((i=>vt.fromName(i.referenceValue)))}class cC extends De{constructor(t,i){super(t,"array-contains",i)}matches(t){const i=t.data.field(this.field);return tg(i)&&iu(i.arrayValue,this.value)}}class hC extends De{constructor(t,i){super(t,"in",i)}matches(t){const i=t.data.field(this.field);return i!==null&&iu(this.value.arrayValue,i)}}class fC extends De{constructor(t,i){super(t,"not-in",i)}matches(t){if(iu(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const i=t.data.field(this.field);return i!==null&&i.nullValue===void 0&&!iu(this.value.arrayValue,i)}}class dC extends De{constructor(t,i){super(t,"array-contains-any",i)}matches(t){const i=t.data.field(this.field);return!(!tg(i)||!i.arrayValue.values)&&i.arrayValue.values.some((a=>iu(this.value.arrayValue,a)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(t,i){this.mapKeyFn=t,this.equalsFn=i,this.inner={},this.innerSize=0}get(t){const i=this.mapKeyFn(t),a=this.inner[i];if(a!==void 0){for(const[o,u]of a)if(this.equalsFn(o,t))return u}}has(t){return this.get(t)!==void 0}set(t,i){const a=this.mapKeyFn(t),o=this.inner[a];if(o===void 0)return this.inner[a]=[[t,i]],void this.innerSize++;for(let u=0;u<o.length;u++)if(this.equalsFn(o[u][0],t))return void(o[u]=[t,i]);o.push([t,i]),this.innerSize++}delete(t){const i=this.mapKeyFn(t),a=this.inner[i];if(a===void 0)return!1;for(let o=0;o<a.length;o++)if(this.equalsFn(a[o][0],t))return a.length===1?delete this.inner[i]:a.splice(o,1),this.innerSize--,!0;return!1}forEach(t){aa(this.inner,((i,a)=>{for(const[o,u]of a)t(o,u)}))}isEmpty(){return ME(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vC=new me(vt.comparator);function lr(){return vC}const WE=new me(vt.comparator);function Ul(...n){let t=WE;for(const i of n)t=t.insert(i.key,i);return t}function ZE(n){let t=WE;return n.forEach(((i,a)=>t=t.insert(i,a.overlayedDocument))),t}function Ga(){return Kl()}function JE(){return Kl()}function Kl(){return new es((n=>n.toString()),((n,t)=>n.isEqual(t)))}const _C=new me(vt.comparator),EC=new Pe(vt.comparator);function Pt(...n){let t=EC;for(const i of n)t=t.add(i);return t}const bC=new Pe(Ut);function wC(){return bC}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ig(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:vh(t)?"-0":t}}function t2(n){return{integerValue:""+n}}function e2(n,t){return W6(t)?t2(t):ig(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let MC=class{constructor(t,i){this.largestBatchId=t,this.mutation=i}getKey(){return this.mutation.key}isEqual(t){return t!==null&&this.mutation===t.mutation}toString(){return`Overlay{
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OC{constructor(t,i){this.count=t,this.unchangedNames=i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nI{constructor(t){this.yt=t}}function iI(n){const t=XC({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?um(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hI{constructor(){this.changes=new es((t=>t.toString()),((t,i)=>t.isEqual(i))),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,i){this.assertNotApplied(),this.changes.set(t,sn.newInvalidDocument(t).setReadTime(i))}getEntry(t,i){this.assertNotApplied();const a=this.changes.get(i);return a!==void 0?st.resolve(a):this.getFromCache(t,i)}getEntries(t,i){return this.getAllFromCache(t,i)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gI{constructor(){this.sessionToken=Ze.EMPTY_BYTE_STRING}getSessionToken(t){return st.resolve(this.sessionToken)}setSessionToken(t,i){return this.sessionToken=i,st.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xh(n){return new $C(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ov="PersistentStream";class T2{constructor(t,i,a,o,u,f,m,p){this.Mi=t,this.S_=a,this.b_=o,this.connection=u,this.authCredentialsProvider=f,this.appCheckCredentialsProvider=m,this.listener=p,this.state=0,this.D_=0,this.C_=null,this.v_=null,this.stream=null,this.F_=0,this.M_=new w2(t,i)}x_(){return this.state===1||this.state===5||this.O_()}O_(){return this.state===2||this.state===3}start(){this.F_=0,this.state!==4?this.auth():this.N_()}async stop(){this.x_()&&await this.close(0)}B_(){this.state=0,this.M_.reset()}L_(){this.O_()&&this.C_===null&&(this.C_=this.Mi.enqueueAfterDelay(this.S_,6e4,(()=>this.k_())))}q_(t){this.Q_(),this.stream.send(t)}async k_(){if(this.O_())return this.close(0)}Q_(){this.C_&&(this.C_.cancel(),this.C_=null)}U_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(t,i){this.Q_(),this.U_(),this.M_.cancel(),this.D_++,t!==4?this.M_.reset():i&&i.code===it.RESOURCE_EXHAUSTED?(or(i.toString()),or("Using maximum backoff delay to prevent overloading the backend."),this.M_.g_()):i&&i.code===it.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.K_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.r_(i)}K_(){}auth(){this.state=1;const t=this.W_(this.D_),i=this.D_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([a,o])=>{this.D_===i&&this.G_(a,o)}),(a=>{t((()=>{const o=new dt(it.UNKNOWN,"Fetching auth token failed: "+a.message);return this.z_(o)}))}))}G_(t,i){const a=this.W_(this.D_);this.stream=this.j_(t,i),this.stream.Xo((()=>{a((()=>this.listener.Xo()))})),this.stream.t_((()=>{a((()=>(this.state=2,this.v_=this.Mi.enqueueAfterDelay(this.b_,1e4,(()=>(this.O_()&&(this.state=3),Promise.resolve()))),this.listener.t_())))})),this.stream.r_((o=>{a((()=>this.z_(o)))})),this.stream.onMessage((o=>{a((()=>++this.F_==1?this.J_(o):this.onNext(o)))}))}N_(){this.state=5,this.M_.p_((async()=>{this.state=0,this.start()}))}z_(t){return pt(Ov,`close with error: ${t}`),this.stream=null,this.close(4,t)}W_(t){return i=>{this.Mi.enqueueAndForget((()=>this.D_===t?i():(pt(Ov,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class LI extends T2{constructor(t,i,a,o,u,f){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",i,a,o,f),this.serializer=u}j_(t,i){return this.connection.T_("Listen",t,i)}J_(t){return this.onNext(t)}onNext(t){this.M_.reset();const i=KC(this.serializer,t),a=(function(u){if(!("targetChange"in u))return St.min();const f=u.targetChange;return f.targetIds&&f.targetIds.length?St.min():f.readTime?Si(f.readTime):St.min()})(t);return this.listener.H_(i,a)}Y_(t){const i={};i.database=dm(this.serializer),i.addTarget=(function(u,f){let m;const p=f.target;if(m=om(p)?{documents:YC(u,p)}:{query:QC(u,p).ft},m.targetId=f.targetId,f.resumeToken.approximateByteSize()>0){m.resumeToken=f2(u,f.resumeToken);const g=cm(u,f.expectedCount);g!==null&&(m.expectedCount=g)}else if(f.snapshotVersion.compareTo(St.min())>0){m.readTime=Th(u,f.snapshotVersion.toTimestamp());const g=cm(u,f.expectedCount);g!==null&&(m.expectedCount=g)}return m})(this.serializer,t);const a=WC(this.serializer,t);a&&(i.labels=a),this.q_(i)}Z_(t){const i={};i.database=dm(this.serializer),i.removeTarget=t,this.q_(i)}}class zI extends T2{constructor(t,i,a,o,u,f){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",i,a,o,f),this.serializer=u}get X_(){return this.F_>0}start(){this.lastStreamToken=void 0,super.start()}K_(){this.X_&&this.ea([])}j_(t,i){return this.connection.T_("Write",t,i)}J_(t){return Gt(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,Gt(!t.writeResults||t.writeResults.length===0,55816),this.listener.ta()}onNext(t){Gt(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.M_.reset();const i=GC(t.writeResults,t.commitTime),a=Si(t.commitTime);return this.listener.na(a,i)}ra(){const t={};t.database=dm(this.serializer),this.q_(t)}ea(t){const i={streamToken:this.lastStreamToken,writes:t.map((a=>HC(this.serializer,a)))};this.q_(i)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ja="RemoteStore";class qI{constructor(t,i,a,o,u){this.localStore=t,this.datastore=i,this.asyncQueue=a,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=u,this.Aa.Oo((f=>{a.enqueueAndForget((async()=>{ns(this)&&(pt(Ja,"Restarting streams for network reachability change."),await(async function(p){const g=Rt(p);g.Ea.add(4),await du(g),g.Ra.set("Unknown"),g.Ea.delete(4),await Wh(g)})(this))}))})),this.Ra=new FI(a,o)}}async function Wh(n){if(ns(n))for(const t of n.da)await t(!0)}async function du(n){for(const t of n.da)await t(!1)}function S2(n,t){const i=Rt(n);i.Ia.has(t.targetId)||(i.Ia.set(t.targetId,t),pg(i)?dg(i):So(i).O_()&&fg(i,t))}function hg(n,t){const i=Rt(n),a=So(i);i.Ia.delete(t),a.O_()&&A2(i,t),i.Ia.size===0&&(a.O_()?a.L_():ns(i)&&i.Ra.set("Unknown"))}function fg(n,t){if(n.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(St.min())>0){const i=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(i)}So(n).Y_(t)}function A2(n,t){n.Va.Ue(t),So(n).Z_(t)}function dg(n){n.Va=new PC({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),At:t=>n.Ia.get(t)||null,ht:()=>n.datastore.serializer.databaseId}),So(n).start(),n.Ra.ua()}function pg(n){return ns(n)&&!So(n).x_()&&n.Ia.size>0}function ns(n){return Rt(n).Ea.size===0}function R2(n){n.Va=void 0}async function KI(n){n.Ra.set("Online")}async function HI(n){n.Ia.forEach(((t,i)=>{fg(n,t)}))}async function GI(n,t){R2(n),pg(n)?(n.Ra.ha(t),dg(n)):n.Ra.set("Unknown")}async function YI(n,t,i){if(n.Ra.set("Online"),t instanceof h2&&t.state===2&&t.cause)try{await(async function(o,u){const f=u.cause;for(const m of u.targetIds)o.Ia.has(m)&&(await o.remoteSyncer.rejectListen(m,f),o.Ia.delete(m),o.Va.removeTarget(m))})(n,t)}catch(a){pt(Ja,"Failed to remove targets %s: %s ",t.targetIds.join(","),a),await Ah(n,a)}else if(t instanceof uh?n.Va.Ze(t):t instanceof c2?n.Va.st(t):n.Va.tt(t),!i.isEqual(St.min()))try{const a=await b2(n.localStore);i.compareTo(a)>=0&&await(function(u,f){const m=u.Va.Tt(f);return m.targetChanges.forEach(((p,g)=>{if(p.resumeToken.approximateByteSize()>0){const v=u.Ia.get(g);v&&u.Ia.set(g,v.withResumeToken(p.resumeToken,f))}})),m.targetMismatches.forEach(((p,g)=>{const v=u.Ia.get(p);if(!v)return;u.Ia.set(p,v.withResumeToken(Ze.EMPTY_BYTE_STRING,v.snapshotVersion)),A2(u,p);const w=new Yr(v.target,p,g,v.sequenceNumber);fg(u,w)})),u.remoteSyncer.applyRemoteEvent(m)})(n,i)}catch(a){pt(Ja,"Failed to raise snapshot:",a),await Ah(n,a)}}async function Ah(n,t,i){if(!wo(t))throw t;n.Ea.add(1),await du(n),n.Ra.set("Offline"),i||(i=()=>b2(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{pt(Ja,"Retrying IndexedDB access"),await i(),n.Ea.delete(1),await Wh(n)}))}function C2(n,t){return t().catch((i=>Ah(n,i,t)))}async function Zh(n){const t=Rt(n),i=ia(t);let a=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:Zm;for(;QI(t);)try{const o=await jI(t.localStore,a);if(o===null){t.Ta.length===0&&i.L_();break}a=o.batchId,XI(t,o)}catch(o){await Ah(t,o)}I2(t)&&j2(t)}function QI(n){return ns(n)&&n.Ta.length<10}function XI(n,t){n.Ta.push(t);const i=ia(n);i.O_()&&i.X_&&i.ea(t.mutations)}function I2(n){return ns(n)&&!ia(n).x_()&&n.Ta.length>0}function j2(n){ia(n).start()}async function WI(n){ia(n).ra()}async function ZI(n){const t=ia(n);for(const i of n.Ta)t.ea(i.mutations)}async function JI(n,t,i){const a=n.Ta.shift(),o=rg.from(a,t,i);await C2(n,(()=>n.remoteSyncer.applySuccessfulWrite(o))),await Zh(n)}async function tj(n,t){t&&ia(n).X_&&await(async function(a,o){if((function(f){return VC(f)&&f!==it.ABORTED})(o.code)){const u=a.Ta.shift();ia(a).B_(),await C2(a,(()=>a.remoteSyncer.rejectFailedWrite(u.batchId,o))),await Zh(a)}})(n,t),I2(n)&&j2(n)}async function Vv(n,t){const i=Rt(n);i.asyncQueue.verifyOperationInProgress(),pt(Ja,"RemoteStore received new credentials");const a=ns(i);i.Ea.add(3),await du(i),a&&i.Ra.set("Unknown"),await i.remoteSyncer.handleCredentialChange(t),i.Ea.delete(3),await Wh(i)}async function ej(n,t){const i=Rt(n);t?(i.Ea.delete(2),await Wh(i)):t||(i.Ea.add(2),await du(i),i.Ra.set("Unknown"))}function So(n){return n.ma||(n.ma=(function(i,a,o){const u=Rt(i);return u.sa(),new LI(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:KI.bind(null,n),t_:HI.bind(null,n),r_:GI.bind(null,n),H_:YI.bind(null,n)}),n.da.push((async t=>{t?(n.ma.B_(),pg(n)?dg(n):n.Ra.set("Unknown")):(await n.ma.stop(),R2(n))}))),n.ma}function ia(n){return n.fa||(n.fa=(function(i,a,o){const u=Rt(i);return u.sa(),new zI(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:WI.bind(null,n),r_:tj.bind(null,n),ta:ZI.bind(null,n),na:JI.bind(null,n)}),n.da.push((async t=>{t?(n.fa.B_(),await Zh(n)):(await n.fa.stop(),n.Ta.length>0&&(pt(Ja,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class D2{constructor(t){this.key=t}}class N2{constructor(t){this.key=t}}class sj{constructor(t,i){this.query=t,this.Ya=i,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=Pt(),this.mutatedKeys=Pt(),this.eu=XE(t),this.tu=new Js(this.eu)}get nu(){return this.Ya}ru(t,i){const a=i?i.iu:new kv,o=i?i.tu:this.tu;let u=i?i.mutatedKeys:this.mutatedKeys,f=o,m=!1;const p=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,g=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(t.inorderTraversal(((v,w)=>{const S=o.get(v),R=Hh(this.query,w)?w:null,V=!!S&&this.mutatedKeys.has(S.key),B=!!R&&(R.hasLocalMutations||this.mutatedKeys.has(R.key)&&R.hasCommittedMutations);let P=!1;S&&R?S.data.isEqual(R.data)?V!==B&&(a.track({type:3,doc:R}),P=!0):this.su(S,R)||(a.track({type:2,doc:R}),P=!0,(p&&this.eu(R,p)>0||g&&this.eu(R,g)<0)&&(m=!0)):!S&&R?(a.track({type:0,doc:R}),P=!0):S&&!R&&(a.track({type:1,doc:S}),P=!0,(p||g)&&(m=!0)),P&&(R?(f=f.add(R),u=B?u.add(v):u.delete(v)):(f=f.delete(v),u=u.delete(v)))})),this.query.limit!==null)for(;f.size>this.query.limit;){const v=this.query.limitType==="F"?f.last():f.first();f=f.delete(v.key),u=u.delete(v.key),a.track({type:1,doc:v})}return{tu:f,iu:a,Cs:m,mutatedKeys:u}}su(t,i){return t.hasLocalMutations&&i.hasCommittedMutations&&!i.hasLocalMutations}applyChanges(t,i,a,o){const u=this.tu;this.tu=t.tu,this.mutatedKeys=t.mutatedKeys;const f=t.iu.ya();f.sort(((v,w)=>(function(R,V){const B=P=>{switch(P){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return wt(20277,{Rt:P})}};return B(R)-B(V)})(v.type,w.type)||this.eu(v.doc,w.doc))),this.ou(a),o=o??!1;const m=i&&!o?this._u():[],p=this.Xa.size===0&&this.current&&!o?1:0,g=p!==this.Za;return this.Za=p,f.length!==0||g?{snapshot:new fo(this.query,t.tu,u,f,t.mutatedKeys,p===0,g,!1,!!a&&a.resumeToken.approximateByteSize()>0),au:m}:{au:m}}va(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new kv,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(t){return!this.Ya.has(t)&&!!this.tu.has(t)&&!this.tu.get(t).hasLocalMutations}ou(t){t&&(t.addedDocuments.forEach((i=>this.Ya=this.Ya.add(i))),t.modifiedDocuments.forEach((i=>{})),t.removedDocuments.forEach((i=>this.Ya=this.Ya.delete(i))),this.current=t.current)}_u(){if(!this.current)return[];const t=this.Xa;this.Xa=Pt(),this.tu.forEach((a=>{this.uu(a.key)&&(this.Xa=this.Xa.add(a.key))}));const i=[];return t.forEach((a=>{this.Xa.has(a)||i.push(new N2(a))})),this.Xa.forEach((a=>{t.has(a)||i.push(new D2(a))})),i}cu(t){this.Ya=t.Qs,this.Xa=Pt();const i=this.ru(t.documents);return this.applyChanges(i,!0)}lu(){return fo.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const Eg="SyncEngine";class oj{constructor(t,i,a){this.query=t,this.targetId=i,this.view=a}}class lj{constructor(t){this.key=t,this.hu=!1}}class uj{constructor(t,i,a,o,u,f){this.localStore=t,this.remoteStore=i,this.eventManager=a,this.sharedClientState=o,this.currentUser=u,this.maxConcurrentLimboResolutions=f,this.Pu={},this.Tu=new es((m=>QE(m)),Kh),this.Iu=new Map,this.Eu=new Set,this.du=new me(vt.comparator),this.Au=new Map,this.Ru=new og,this.Vu={},this.mu=new Map,this.fu=ho.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function cj(n,t,i=!0){const a=P2(n);let o;const u=a.Tu.get(t);return u?(a.sharedClientState.addLocalQueryTarget(u.targetId),o=u.view.lu()):o=await M2(a,t,i,!0),o}async function hj(n,t){const i=P2(n);await M2(i,t,!0,!1)}async function M2(n,t,i,a){const o=await DI(n.localStore,wi(t)),u=o.targetId,f=n.sharedClientState.addLocalQueryTarget(u,i);let m;return a&&(m=await fj(n,t,u,f==="current",o.resumeToken)),n.isPrimaryClient&&i&&S2(n.remoteStore,o),m}async function fj(n,t,i,a,o){n.pu=(w,S,R)=>(async function(B,P,X,Y){let J=P.view.ru(X);J.Cs&&(J=await jv(B.localStore,P.query,!1).then((({documents:j})=>P.view.ru(j,J))));const ot=Y&&Y.targetChanges.get(P.targetId),Z=Y&&Y.targetMismatches.get(P.targetId)!=null,ft=P.view.applyChanges(J,B.isPrimaryClient,ot,Z);return zv(B,P.targetId,ft.au),ft.snapshot})(n,w,S,R);const u=await jv(n.localStore,t,!0),f=new sj(t,u.Qs),m=f.ru(u.documents),p=fu.createSynthesizedTargetChangeForCurrentChange(i,a&&n.onlineState!=="Offline",o),g=f.applyChanges(m,n.isPrimaryClient,p);zv(n,i,g.au);const v=new oj(t,i,f);return n.Tu.set(t,v),n.Iu.has(i)?n.Iu.get(i).push(t):n.Iu.set(i,[t]),g.snapshot}async function dj(n,t,i){const a=Rt(n),o=a.Tu.get(t),u=a.Iu.get(o.targetId);if(u.length>1)return a.Iu.set(o.targetId,u.filter((f=>!Kh(f,t)))),void a.Tu.delete(t);a.isPrimaryClient?(a.sharedClientState.removeLocalQueryTarget(o.targetId),a.sharedClientState.isActiveQueryTarget(o.targetId)||await pm(a.localStore,o.targetId,!1).then((()=>{a.sharedClientState.clearQueryState(o.targetId),i&&hg(a.remoteStore,o.targetId),ym(a,o.targetId)})).catch(bo)):(ym(a,o.targetId),await pm(a.localStore,o.targetId,!0))}async function pj(n,t){const i=Rt(n),a=i.Tu.get(t),o=i.Iu.get(a.targetId);i.isPrimaryClient&&o.length===1&&(i.sharedClientState.removeLocalQueryTarget(a.targetId),hg(i.remoteStore,a.targetId))}async function mj(n,t,i){const a=bj(n);try{const o=await(function(f,m){const p=Rt(f),g=le.now(),v=m.reduce(((R,V)=>R.add(V.key)),Pt());let w,S;return p.persistence.runTransaction("Locally write mutations","readwrite",(R=>{let V=lr(),B=Pt();return p.Ns.getEntries(R,v).next((P=>{V=P,V.forEach(((X,Y)=>{Y.isValidDocument()||(B=B.add(X))}))})).next((()=>p.localDocuments.getOverlayedDocuments(R,V))).next((P=>{w=P;const X=[];for(const Y of m){const J=jC(Y,w.get(Y.key).overlayedDocument);J!=null&&X.push(new sa(Y.key,J,BE(J.value.mapValue),Ti.exists(!0)))}return p.mutationQueue.addMutationBatch(R,g,X,m)})).next((P=>{S=P;const X=P.applyToLocalDocumentSet(w,B);return p.documentOverlayCache.saveOverlays(R,P.batchId,X)}))})).then((()=>({batchId:S.batchId,changes:ZE(w)})))})(a.localStore,t);a.sharedClientState.addPendingMutation(o.batchId),(function(f,m,p){let g=f.Vu[f.currentUser.toKey()];g||(g=new me(Ut)),g=g.insert(m,p),f.Vu[f.currentUser.toKey()]=g})(a,o.batchId,i),await pu(a,o.changes),await Zh(a.remoteStore)}catch(o){const u=gg(o,"Failed to persist write");i.reject(u)}}async function O2(n,t){const i=Rt(n);try{const a=await CI(i.localStore,t);t.targetChanges.forEach(((o,u)=>{const f=i.Au.get(u);f&&(Gt(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1,22616),o.addedDocuments.size>0?f.hu=!0:o.modifiedDocuments.size>0?Gt(f.hu,14607):o.removedDocuments.size>0&&(Gt(f.hu,42227),f.hu=!1))})),await pu(i,a,t)}catch(a){await bo(a)}}function Lv(n,t,i){const a=Rt(n);if(a.isPrimaryClient&&i===0||!a.isPrimaryClient&&i===1){const o=[];a.Tu.forEach(((u,f)=>{const m=f.view.va(t);m.snapshot&&o.push(m.snapshot)})),(function(f,m){const p=Rt(f);p.onlineState=m;let g=!1;p.queries.forEach(((v,w)=>{for(const S of w.Sa)S.va(m)&&(g=!0)})),g&&vg(p)})(a.eventManager,t),o.length&&a.Pu.H_(o),a.onlineState=t,a.isPrimaryClient&&a.sharedClientState.setOnlineState(t)}}async function gj(n,t,i){const a=Rt(n);a.sharedClientState.updateQueryState(t,"rejected",i);const o=a.Au.get(t),u=o&&o.key;if(u){let f=new me(vt.comparator);f=f.insert(u,sn.newNoDocument(u,St.min()));const m=Pt().add(u),p=new Qh(St.min(),new Map,new me(Ut),f,m);await O2(a,p),a.du=a.du.remove(u),a.Au.delete(t),bg(a)}else await pm(a.localStore,t,!1).then((()=>ym(a,t,i))).catch(bo)}async function yj(n,t){const i=Rt(n),a=t.batch.batchId;try{const o=await RI(i.localStore,t);k2(i,a,null),V2(i,a),i.sharedClientState.updateMutationState(a,"acknowledged"),await pu(i,o)}catch(o){await bo(o)}}async function xj(n,t,i){const a=Rt(n);try{const o=await(function(f,m){const p=Rt(f);return p.persistence.runTransaction("Reject batch","readwrite-primary",(g=>{let v;return p.mutationQueue.lookupMutationBatch(g,m).next((w=>(Gt(w!==null,37113),v=w.keys(),p.mutationQueue.removeMutationBatch(g,w)))).next((()=>p.mutationQueue.performConsistencyCheck(g))).next((()=>p.documentOverlayCache.removeOverlaysForBatchId(g,v,m))).next((()=>p.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(g,v))).next((()=>p.localDocuments.getDocuments(g,v)))}))})(a.localStore,t);k2(a,t,i),V2(a,t),a.sharedClientState.updateMutationState(t,"rejected",i),await pu(a,o)}catch(o){await bo(o)}}function V2(n,t){(n.mu.get(t)||[]).forEach((i=>{i.resolve()})),n.mu.delete(t)}function k2(n,t,i){const a=Rt(n);let o=a.Vu[a.currentUser.toKey()];if(o){const u=o.get(t);u&&(i?u.reject(i):u.resolve(),o=o.remove(t)),a.Vu[a.currentUser.toKey()]=o}}function ym(n,t,i=null){n.sharedClientState.removeLocalQueryTarget(t);for(const a of n.Iu.get(t))n.Tu.delete(a),i&&n.Pu.yu(a,i);n.Iu.delete(t),n.isPrimaryClient&&n.Ru.jr(t).forEach((a=>{n.Ru.containsKey(a)||U2(n,a)}))}function U2(n,t){n.Eu.delete(t.path.canonicalString());const i=n.du.get(t);i!==null&&(hg(n.remoteStore,i),n.du=n.du.remove(t),n.Au.delete(i),bg(n))}function zv(n,t,i){for(const a of i)a instanceof D2?(n.Ru.addReference(a.key,t),vj(n,a)):a instanceof N2?(pt(Eg,"Document no longer in limbo: "+a.key),n.Ru.removeReference(a.key,t),n.Ru.containsKey(a.key)||U2(n,a.key)):wt(19791,{wu:a})}function vj(n,t){const i=t.key,a=i.path.canonicalString();n.du.get(i)||n.Eu.has(a)||(pt(Eg,"New document in limbo: "+i),n.Eu.add(a),bg(n))}function bg(n){for(;n.Eu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const t=n.Eu.values().next().value;n.Eu.delete(t);const i=new vt(ae.fromString(t)),a=n.fu.next();n.Au.set(a,new lj(i)),n.du=n.du.insert(i,a),S2(n.remoteStore,new Yr(wi(qh(i.path)),a,"TargetPurposeLimboResolution",Bh.ce))}}async function pu(n,t,i){const a=Rt(n),o=[],u=[],f=[];a.Tu.isEmpty()||(a.Tu.forEach(((m,p)=>{f.push(a.pu(p,t,i).then((g=>{if((g||i)&&a.isPrimaryClient){const v=g?!g.fromCache:i?.targetChanges.get(p.targetId)?.current;a.sharedClientState.updateQueryState(p.targetId,v?"current":"not-current")}if(g){o.push(g);const v=ug.As(p.targetId,g);u.push(v)}})))})),await Promise.all(f),a.Pu.H_(o),await(async function(p,g){const v=Rt(p);try{await v.persistence.runTransaction("notifyLocalViewChanges","readwrite",(w=>st.forEach(g,(S=>st.forEach(S.Es,(R=>v.persistence.referenceDelegate.addReference(w,S.targetId,R))).next((()=>st.forEach(S.ds,(R=>v.persistence.referenceDelegate.removeReference(w,S.targetId,R)))))))))}catch(w){if(!wo(w))throw w;pt(cg,"Failed to update sequence numbers: "+w)}for(const w of g){const S=w.targetId;if(!w.fromCache){const R=v.Ms.get(S),V=R.snapshotVersion,B=R.withLastLimboFreeSnapshotVersion(V);v.Ms=v.Ms.insert(S,B)}}})(a.localStore,u))}async function _j(n,t){const i=Rt(n);if(!i.currentUser.isEqual(t)){pt(Eg,"User change. New user:",t.toKey());const a=await E2(i.localStore,t);i.currentUser=t,(function(u,f){u.mu.forEach((m=>{m.forEach((p=>{p.reject(new dt(it.CANCELLED,f))}))})),u.mu.clear()})(i,"'waitForPendingWrites' promise is rejected due to a user change."),i.sharedClientState.handleUserChange(t,a.removedBatchIds,a.addedBatchIds),await pu(i,a.Ls)}}function Ej(n,t){const i=Rt(n),a=i.Au.get(t);if(a&&a.hu)return Pt().add(a.key);{let o=Pt();const u=i.Iu.get(t);if(!u)return o;for(const f of u){const m=i.Tu.get(f);o=o.unionWith(m.view.nu)}return o}}function P2(n){const t=Rt(n);return t.remoteStore.remoteSyncer.applyRemoteEvent=O2.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=Ej.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=gj.bind(null,t),t.Pu.H_=rj.bind(null,t.eventManager),t.Pu.yu=aj.bind(null,t.eventManager),t}function bj(n){const t=Rt(n);return t.remoteStore.remoteSyncer.applySuccessfulWrite=yj.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=xj.bind(null,t),t}class Rh{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=Xh(t.databaseInfo.databaseId),this.sharedClientState=this.Du(t),this.persistence=this.Cu(t),await this.persistence.start(),this.localStore=this.vu(t),this.gcScheduler=this.Fu(t,this.localStore),this.indexBackfillerScheduler=this.Mu(t,this.localStore)}Fu(t,i){return null}Mu(t,i){return null}vu(t){return AI(this.persistence,new wI,t.initialUser,this.serializer)}Cu(t){return new _2(lg.mi,this.serializer)}Du(t){return new MI}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Rh.provider={build:()=>new Rh};class wj extends Rh{constructor(t){super(),this.cacheSizeBytes=t}Fu(t,i){Gt(this.persistence.referenceDelegate instanceof Sh,46915);const a=this.persistence.referenceDelegate.garbageCollector;return new lI(a,t.asyncQueue,i)}Cu(t){const i=this.cacheSizeBytes!==void 0?yn.withCacheSize(this.cacheSizeBytes):yn.DEFAULT;return new _2((a=>Sh.mi(a,i)),this.serializer)}}class xm{async initialize(t,i){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(i),this.remoteStore=this.createRemoteStore(i),this.eventManager=this.createEventManager(i),this.syncEngine=this.createSyncEngine(i,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=a=>Lv(this.syncEngine,a,1),this.remoteStore.remoteSyncer.handleCredentialChange=_j.bind(null,this.syncEngine),await ej(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return(function(){return new ij})()}createDatastore(t){const i=Xh(t.databaseInfo.databaseId),a=(function(u){return new PI(u)})(t.databaseInfo);return(function(u,f,m,p){return new $I(u,f,m,p)})(t.authCredentials,t.appCheckCredentials,a,i)}createRemoteStore(t){return(function(a,o,u,f,m){return new qI(a,o,u,f,m)})(this.localStore,this.datastore,t.asyncQueue,(i=>Lv(this.syncEngine,i,0)),(function(){return Mv.v()?new Mv:new OI})())}createSyncEngine(t,i){return(function(o,u,f,m,p,g,v){const w=new uj(o,u,f,m,p,g);return v&&(w.gu=!0),w})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,i)}async terminate(){await(async function(i){const a=Rt(i);pt(Ja,"RemoteStore shutting down."),a.Ea.add(5),await du(a),a.Aa.shutdown(),a.Ra.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}xm.provider={build:()=>new xm};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yv(n){return(function(i,a){if(typeof i!="object"||i===null)return!1;const o=i;for(const u of a)if(u in o&&typeof o[u]=="function")return!0;return!1})(n,["next","error","complete"])}class ts extends Jh{constructor(t,i,a,o){super(t,i,a,o),this.type="firestore",this._queue=new Hv,this._persistenceKey=o?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new Hv(t),this._firestoreClient=void 0,await t}}}function $2(n,t){const i=typeof n=="object"?n:E6(),a=typeof n=="string"?n:_h,o=g6(i,"firestore").getImmediate({identifier:a});if(!o._initialized){const u=aR("firestore");u&&Ij(o,...u)}return o}function tf(n){if(n._terminated)throw new dt(it.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||jj(n),n._firestoreClient}function jj(n){const t=n._freezeSettings(),i=(function(o,u,f,m){return new eC(o,u,f,m.host,m.ssl,m.experimentalForceLongPolling,m.experimentalAutoDetectLongPolling,z2(m.experimentalLongPollingOptions),m.useFetchStreams,m.isUsingEmulator)})(n._databaseId,n._app?.options.appId||"",n._persistenceKey,t);n._componentsProvider||t.localCache?._offlineComponentProvider&&t.localCache?._onlineComponentProvider&&(n._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),n._firestoreClient=new Tj(n._authCredentials,n._appCheckCredentials,n._queue,i,n._componentsProvider&&(function(o){const u=o?._online.build();return{_offline:o?._offline.build(u),_online:u}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dj=/^__.*__$/;class Nj{constructor(t,i,a){this.data=t,this.fieldMask=i,this.fieldTransforms=a}toMutation(t,i){return this.fieldMask!==null?new sa(t,this.data,this.fieldMask,i,this.fieldTransforms):new hu(t,this.data,i,this.fieldTransforms)}}class F2{constructor(t,i,a){this.data=t,this.fieldMask=i,this.fieldTransforms=a}toMutation(t,i){return new sa(t,this.data,this.fieldMask,i,this.fieldTransforms)}}function q2(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw wt(40011,{Ac:n})}}class Tg{constructor(t,i,a,o,u,f){this.settings=t,this.databaseId=i,this.serializer=a,this.ignoreUndefinedProperties=o,u===void 0&&this.Rc(),this.fieldTransforms=u||[],this.fieldMask=f||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(t){return new Tg({...this.settings,...t},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(t){const i=this.path?.child(t),a=this.Vc({path:i,fc:!1});return a.gc(t),a}yc(t){const i=this.path?.child(t),a=this.Vc({path:i,fc:!1});return a.Rc(),a}wc(t){return this.Vc({path:void 0,fc:!0})}Sc(t){return Ih(t,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(t){return this.fieldMask.find((i=>t.isPrefixOf(i)))!==void 0||this.fieldTransforms.find((i=>t.isPrefixOf(i.field)))!==void 0}Rc(){if(this.path)for(let t=0;t<this.path.length;t++)this.gc(this.path.get(t))}gc(t){if(t.length===0)throw this.Sc("Document fields must not be empty");if(q2(this.Ac)&&Dj.test(t))throw this.Sc('Document fields cannot begin and end with "__"')}}class Mj{constructor(t,i,a){this.databaseId=t,this.ignoreUndefinedProperties=i,this.serializer=a||Xh(t)}Cc(t,i,a,o=!1){return new Tg({Ac:t,methodName:i,Dc:a,path:We.emptyPath(),fc:!1,bc:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Sg(n){const t=n._freezeSettings(),i=Xh(n._databaseId);return new Mj(n._databaseId,!!t.ignoreUndefinedProperties,i)}function Oj(n,t,i,a,o,u={}){const f=n.Cc(u.merge||u.mergeFields?2:0,t,i,o);Rg("Data must be an object, but it was:",f,a);const m=K2(a,f);let p,g;if(u.merge)p=new In(f.fieldMask),g=f.fieldTransforms;else if(u.mergeFields){const v=[];for(const w of u.mergeFields){const S=_m(t,w,i);if(!f.contains(S))throw new dt(it.INVALID_ARGUMENT,`Field '${S}' is specified in your field mask but missing from your input data.`);G2(v,S)||v.push(S)}p=new In(v),g=f.fieldTransforms.filter((w=>p.covers(w.field)))}else p=null,g=f.fieldTransforms;return new Nj(new xn(m),p,g)}class rf extends nf{_toFieldTransform(t){if(t.Ac!==2)throw t.Ac===1?t.Sc(`${this._methodName}() can only appear at the top level of your update data`):t.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof rf}}class Ag extends nf{constructor(t,i){super(t),this.Fc=i}_toFieldTransform(t){const i=new ou(t.serializer,e2(t.serializer,this.Fc));return new AC(t.path,i)}isEqual(t){return t instanceof Ag&&this.Fc===t.Fc}}function Vj(n,t,i,a){const o=n.Cc(1,t,i);Rg("Data must be an object, but it was:",o,a);const u=[],f=xn.empty();aa(a,((p,g)=>{const v=Cg(t,p,i);g=Ci(g);const w=o.yc(v);if(g instanceof rf)u.push(v);else{const S=mu(g,w);S!=null&&(u.push(v),f.set(v,S))}}));const m=new In(u);return new F2(f,m,o.fieldTransforms)}function kj(n,t,i,a,o,u){const f=n.Cc(1,t,i),m=[_m(t,a,i)],p=[o];if(u.length%2!=0)throw new dt(it.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let S=0;S<u.length;S+=2)m.push(_m(t,u[S])),p.push(u[S+1]);const g=[],v=xn.empty();for(let S=m.length-1;S>=0;--S)if(!G2(g,m[S])){const R=m[S];let V=p[S];V=Ci(V);const B=f.yc(R);if(V instanceof rf)g.push(R);else{const P=mu(V,B);P!=null&&(g.push(R),v.set(R,P))}}const w=new In(g);return new F2(v,w,f.fieldTransforms)}function Uj(n,t,i,a=!1){return mu(i,n.Cc(a?4:3,t))}function mu(n,t){if(H2(n=Ci(n)))return Rg("Unsupported field value:",t,n),K2(n,t);if(n instanceof nf)return(function(a,o){if(!q2(o.Ac))throw o.Sc(`${a._methodName}() can only be used with update() and set()`);if(!o.path)throw o.Sc(`${a._methodName}() is not currently supported inside arrays`);const u=a._toFieldTransform(o);u&&o.fieldTransforms.push(u)})(n,t),null;if(n===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),n instanceof Array){if(t.settings.fc&&t.Ac!==4)throw t.Sc("Nested arrays are not supported");return(function(a,o){const u=[];let f=0;for(const m of a){let p=mu(m,o.wc(f));p==null&&(p={nullValue:"NULL_VALUE"}),u.push(p),f++}return{arrayValue:{values:u}}})(n,t)}return(function(a,o){if((a=Ci(a))===null)return{nullValue:"NULL_VALUE"};if(typeof a=="number")return e2(o.serializer,a);if(typeof a=="boolean")return{booleanValue:a};if(typeof a=="string")return{stringValue:a};if(a instanceof Date){const u=le.fromDate(a);return{timestampValue:Th(o.serializer,u)}}if(a instanceof le){const u=new le(a.seconds,1e3*Math.floor(a.nanoseconds/1e3));return{timestampValue:Th(o.serializer,u)}}if(a instanceof Ai)return{geoPointValue:{latitude:a.latitude,longitude:a.longitude}};if(a instanceof $n)return{bytesValue:f2(o.serializer,a._byteString)};if(a instanceof ve){const u=o.databaseId,f=a.firestore._databaseId;if(!f.isEqual(u))throw o.Sc(`Document reference is for database ${f.projectId}/${f.database} but should be for database ${u.projectId}/${u.database}`);return{referenceValue:sg(a.firestore._databaseId||o.databaseId,a._key.path)}}if(a instanceof Ri)return(function(f,m){return{mapValue:{fields:{[LE]:{stringValue:zE},[Eh]:{arrayValue:{values:f.toArray().map((g=>{if(typeof g!="number")throw m.Sc("VectorValues must only contain numeric values.");return ig(m.serializer,g)}))}}}}}})(a,o);throw o.Sc(`Unsupported field value: ${zh(a)}`)})(n,t)}function K2(n,t){const i={};return ME(n)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):aa(n,((a,o)=>{const u=mu(o,t.mc(a));u!=null&&(i[a]=u)})),{mapValue:{fields:i}}}function H2(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof le||n instanceof Ai||n instanceof $n||n instanceof ve||n instanceof nf||n instanceof Ri)}function Rg(n,t,i){if(!H2(i)||!DE(i)){const a=zh(i);throw a==="an object"?t.Sc(n+" a custom object"):t.Sc(n+" "+a)}}function _m(n,t,i){if((t=Ci(t))instanceof ef)return t._internalPath;if(typeof t=="string")return Cg(n,t);throw Ih("Field path arguments must be of type string or ",n,!1,void 0,i)}const Pj=new RegExp("[~\\*/\\[\\]]");function Cg(n,t,i){if(t.search(Pj)>=0)throw Ih(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,i);try{return new ef(...t.split("."))._internalPath}catch{throw Ih(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,i)}}function Ih(n,t,i,a,o){const u=a&&!a.isEmpty(),f=o!==void 0;let m=`Function ${t}() called with invalid data`;i&&(m+=" (via `toFirestore()`)"),m+=". ";let p="";return(u||f)&&(p+=" (found",u&&(p+=` in field ${a}`),f&&(p+=` in document ${o}`),p+=")"),new dt(it.INVALID_ARGUMENT,m+n+p)}function G2(n,t){return n.some((i=>i.isEqual(t)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y2{constructor(t,i,a,o,u){this._firestore=t,this._userDataWriter=i,this._key=a,this._document=o,this._converter=u}get id(){return this._key.path.lastSegment()}get ref(){return new ve(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const t=new Lj(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const i=this._document.data.field(Ig("DocumentSnapshot.get",t));if(i!==null)return this._userDataWriter.convertValue(i)}}}class Lj extends Y2{data(){return super.data()}}function Ig(n,t){return typeof t=="string"?Cg(n,t):t instanceof ef?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gl(n){n=Fn(n,ve);const t=Fn(n.firestore,ts);return Rj(tf(t),n._key).then((i=>J2(t,n,i)))}Wa._jsonSchemaVersion="firestore/querySnapshot/1.0",Wa._jsonSchema={type:Ne("string",Wa._jsonSchemaVersion),bundleSource:Ne("string","QuerySnapshot"),bundleName:Ne("string"),bundle:Ne("string")};class Og extends $j{constructor(t){super(),this.firestore=t}convertBytes(t){return new $n(t)}convertReference(t){const i=this.convertDocumentKey(t,this.firestore._databaseId);return new ve(this.firestore,null,i)}}function Kj(n){n=Fn(n,oa);const t=Fn(n.firestore,ts),i=tf(t),a=new Og(t);return Q2(n._query),Cj(i,n._query).then((o=>new Wa(t,a,n,o)))}function Vg(n,t,i){n=Fn(n,ve);const a=Fn(n.firestore,ts),o=Fj(n.converter,t,i);return Z2(a,[Oj(Sg(a),"setDoc",n._key,o,n.converter!==null,i).toMutation(n._key,Ti.none())])}function jh(n,t,i,...a){n=Fn(n,ve);const o=Fn(n.firestore,ts),u=Sg(o);let f;return f=typeof(t=Ci(t))=="string"||t instanceof ef?kj(u,"updateDoc",n._key,t,i,a):Vj(u,"updateDoc",n._key,t),Z2(o,[f.toMutation(n._key,Ti.exists(!0))])}function Hj(n,...t){n=Ci(n);let i={includeMetadataChanges:!1,source:"default"},a=0;typeof t[a]!="object"||Yv(t[a])||(i=t[a++]);const o={includeMetadataChanges:i.includeMetadataChanges,source:i.source};if(Yv(t[a])){const p=t[a];t[a]=p.next?.bind(p),t[a+1]=p.error?.bind(p),t[a+2]=p.complete?.bind(p)}let u,f,m;if(n instanceof ve)f=Fn(n.firestore,ts),m=qh(n._key.path),u={next:p=>{t[a]&&t[a](J2(f,n,p))},error:t[a+1],complete:t[a+2]};else{const p=Fn(n,oa);f=Fn(p.firestore,ts),m=p._query;const g=new Og(f);u={next:v=>{t[a]&&t[a](new Wa(f,g,p,v))},error:t[a+1],complete:t[a+2]},Q2(n._query)}return(function(g,v,w,S){const R=new wg(S),V=new _g(v,R,w);return g.asyncQueue.enqueueAndForget((async()=>yg(await Ch(g),V))),()=>{R.Nu(),g.asyncQueue.enqueueAndForget((async()=>xg(await Ch(g),V)))}})(tf(f),m,o,u)}function Z2(n,t){return(function(a,o){const u=new ir;return a.asyncQueue.enqueueAndForget((async()=>mj(await Aj(a),o,u))),u.promise})(tf(n),t)}function J2(n,t,i){const a=i.docs.get(t._key),o=new Og(n);return new Xa(n,o,t._key,a,new Ll(i.hasPendingWrites,i.fromCache),t.converter)}function Dh(n){return new Ag("increment",n)}(function(t,i=!0){(function(o){Eo=o})(_6),xh(new Wl("firestore",((a,{instanceIdentifier:o,options:u})=>{const f=a.getProvider("app").getImmediate(),m=new ts(new k6(a.getProvider("auth-internal")),new L6(f,a.getProvider("app-check-internal")),(function(g,v){if(!Object.prototype.hasOwnProperty.apply(g.options,["projectId"]))throw new dt(it.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new nu(g.options.projectId,v)})(f,o),f);return u={useFetchStreams:i,...u},m._setSettings(u),m}),"PUBLIC").setMultipleInstances(!0)),Zs(Zx,Jx,t),Zs(Zx,Jx,"esm2020")})();const Gj={apiKey:"AIzaSyAEFzPwTADLzuxWuyk889Jz1cHPsEgLOkQ",authDomain:"tu2025grad.firebaseapp.com",projectId:"tu2025grad",storageBucket:"tu2025grad.firebasestorage.app",messagingSenderId:"553768466639",appId:"1:553768466639:web:7c16f5d6432da7ebc05fba"},Yj=Gx().length?Gx()[0]:Qm(Gj),eo=$2(Yj),Qj=A.div`
  position: relative;
  width: 445px;
  height: 353px;
  border-radius: 16px;
...
`;function e_(n){return typeof n=="number"&&n>999?"999+":n}function kg({titleKor:n,titleEng:t,nameKor:i,view:a,like:o,href:u,src:f,profileImgs:m,docId:p,collection:g="works"}){const[v,w]=K.useState(typeof o=="number"?o:0),[S,R]=K.useState(typeof a=="number"?a:0);K.useEffect(()=>{let J=!0;return(async()=>{if(p!=null)try{const ot=to(eo,g,String(p)),Z=await Gl(ot);if(!J)return;if(Z.exists()){const ft=Z.data();w(typeof ft.like=="number"?ft.like:0),R(typeof ft.view=="number"?ft.view:0)}}catch(ot){console.error("ProjectCard Firestore read error:",ot)}})(),()=>{J=!1}},[p,g]);const V=J=>{const ot=J.currentTarget.querySelector(".card-hover");ot&&(ot.style.opacity=1)},B=J=>{const ot=J.currentTarget.querySelector(".card-hover");ot&&(ot.style.opacity=0)},P="/TU2025gradulate/",X=/^https?:\/\//i.test(u),Y=x.jsxs(x.Fragment,{children:[x.jsx(Qj,{children:x.jsxs(Xj,{onMouseEnter:V,onMouseLeave:B,children:[x.jsx(Zj,{className:"card-hover",children:x.jsxs(Jj,{children:[x.jsx(e3,{children:n}),x.jsx(t3,{children:t})]})}),x.jsx(Wj,{src:f,alt:"Project"})]})}),x.jsxs(n3,{children:[x.jsxs(i3,{children:[x.jsx(a3,{children:m.map((J,ot)=>x.jsx(s3,{src:J,alt:`Profile${ot+1}`,$z:3-ot,$ml:ot>0},ot))}),x.jsx(r3,{children:i})]}),x.jsxs(o3,{children:[x.jsxs(Zv,{children:[x.jsx(Jv,{src:`${P}icons/likeIcon.svg`}),x.jsx(t_,{children:e_(v)})]}),x.jsxs(Zv,{children:[x.jsx(Jv,{src:`${P}icons/viewIcon.svg`}),x.jsx(t_,{children:e_(S)})]})]})]})]});return X?x.jsx(Wv,{as:"a",href:u,style:{textDecoration:"none"},children:Y}):x.jsx(Wv,{as:xo,to:u.startsWith("/")?u:`/${u}`,style:{textDecoration:"none"},children:Y})}kg.propTypes={titleKor:W.string.isRequired,titleEng:W.string.isRequired,nameKor:W.string.isRequired,view:W.number,like:W.number,src:W.string.isRequired,href:W.string.isRequired,profileImgs:W.arrayOf(W.string).isRequired,docId:W.oneOfType([W.string,W.number]),collection:W.string};kg.defaultProps={titleKor:"프로젝트 제목",titleEng:"Project Title",nameKor:"Author Name",view:0,like:0,collection:"works"};const n_=40;function tb(n){if(!n)return n;const t="/TU2025gradulate/";if(/^https?:\/\//i.test(n))return n;const i=n.replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const l3=A.div`
  position: relative; background: #fff;
`,u3=A.div`
...
`,i_=Xl,eb=Km,p3={"All Projects":null,"AI & Robot":"c0","Edu & Kids":"c1","Health Care":"c2","IT & Tech":"c3",Living:"c4",Mobility:"c5"};function Em(n){return n.members.map(t=>{const i=eb.find(a=>a.num===t);return i?i.nameKor:""}).filter(Boolean).join(", ")}function m3(n){return n.members.map(t=>{const i=eb.find(a=>a.num===t);return i?tb(i.imgUrl):""}).filter(Boolean)}function g3({list:n}){const t={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"};return x.jsx(f3,{children:n.map((i,a)=>{const o=Em(i),u=m3(i),f=String(i.projectNum+1).padStart(3,"0"),p=`${t[i.category]||"A"}${f}`,g=i.projectNum??i.num;return x.jsx(kg,{titleKor:i.titleKor,titleEng:i.titleEng,src:tb(`/projects/${i.projectNum}/thumb.jpg`),nameKor:o,profileImgs:u,docId:g,href:`/work/${p}`},a)})})}function y3(){const[n,t]=Ot.useState("All Projects"),[i,a]=Ot.useState("이름순"),[o,u]=Ot.useState({});Ot.useEffect(()=>{let p=!0;return(async()=>{try{const g=await Kj(vm(eo,"works"));if(!p)return;const v={};g.forEach(w=>{const S=w.data()||{};v[String(w.id)]={like:typeof S.like=="number"?S.like:0,view:typeof S.view=="number"?S.view:0}}),u(v)}catch(g){console.error("Failed to load works stats:",g)}})(),()=>{p=!1}},[]);const f=Ot.useMemo(()=>{const p=p3[n]||null;return p?i_.filter(g=>g.category===p):i_},[n]),m=Ot.useMemo(()=>{const p=[...f];switch(i){case"이름순":p.sort((g,v)=>Em(g).localeCompare(Em(v),"ko"));break;case"좋아요순":p.sort((g,v)=>{const w=String(g.projectNum??g.num),S=String(v.projectNum??v.num),R=o[w]?.like??0;return(o[S]?.like??0)-R});break;case"조회수순":p.sort((g,v)=>{const w=String(g.projectNum??g.num),S=String(v.projectNum??v.num),R=o[w]?.view??0;return(o[S]?.view??0)-R});break;case"팀작우선":p.sort((g,v)=>(v.members.length>1)-(g.members.length>1));break;case"개인작우선":p.sort((g,v)=>(g.members.length>1)-(v.members.length>1));break}return p},[f,i,o]);return x.jsxs(h3,{children:[x.jsx(d3,{children:"Projects"}),x.jsx(hE,{type:"project",onCategoryChange:t,onSortChange:a,sortLabel:i}),x.jsx(c3,{children:x.jsx(g3,{list:m})})]})}const x3=A.div(({height:n,from:t,to:i,position:a,z:o})=>({position:"absolute",left:0,right:0,[a]:-1,height:n,pointerEvents:"none",zIndex:o??0,background:`linear-gradient(180deg, ${t} 0%, ${i} 100%)`}));function Ug({position:n="bottom",from:t,to:i,height:a=240,z:o=0,style:u}){return x.jsx(x3,{position:n,from:t,to:i,height:a,z:o,style:u})}const rr={heroToWhite:{from:"rgba(18,18,18,0)",to:"#FFFFFF",h:80},whiteToBlack:{from:"rgba(255,255,255,0)",to:"#121212",h:160},blackToBlackSoft:{from:"rgba(18,18,18,0)",to:"#121212",h:180}},r_="/TU2025gradulate/",v3=A.section`
...
`;function X3(){const n=[{src:"https://placehold.co/910x512",cap:""},{src:"https://placehold.co/727x445",cap:"뭐"},{src:"https://placehold.co/727x445",cap:"뭐"},{src:"https://placehold.co/727x445",cap:"뭐"},{src:"https://placehold.co/727x445",cap:"뭐"},{src:"https://placehold.co/910x517",cap:""},{src:"https://placehold.co/987x555",cap:""},{src:"https://placehold.co/727x445",cap:"뭐"},{src:"https://placehold.co/727x445",cap:"뭐"}];return x.jsxs($3,{"aria-label":"Gallery",children:[x.jsx(Ug,{position:"top",from:rr.blackToBlackSoft.from,to:rr.blackToBlackSoft.to,height:rr.blackToBlackSoft.h,z:0}),x.jsxs(F3,{children:[x.jsxs(q3,{children:[x.jsx(K3,{src:"https://placehold.co/1840x1000",alt:"featured"}),x.jsx(H3,{"aria-hidden":!0,children:x.jsx(G3,{})})]}),x.jsx(Y3,{className:"gallery-desktop"}),x.jsx("div",{className:"gallery-mobile",style:{display:"none"},children:x.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:8,marginTop:12},children:n.map((t,i)=>x.jsxs("div",{style:{width:"46vw",height:"46vw",minWidth:140,minHeight:140,maxWidth:"100vw",maxHeight:"100vw",borderRadius:4,overflow:"hidden",background:"#151515",position:"relative",marginBottom:8},children:[x.jsx("img",{src:t.src,alt:"",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}),t.cap&&x.jsx(Q3,{children:t.cap})]},i))})}),x.jsx("div",{style:{paddingTop:40,display:"flex",justifyContent:"center"},children:x.jsx(af,{label:"View More"})})]})]})}const W3=A.section`
  padding: 0;
`,Z3=A.div`
...
`;function Hr({k:n,children:t,divider:i=!0}){return x.jsxs(jD,{$divider:i,children:[x.jsx(DD,{children:x.jsx(ND,{children:n})}),x.jsx(MD,{children:t})]})}const OD=A.div`
  width: 900px; display: flex; flex-direction: column;
  @media (max-width: 640px) {
    width: 100%;
    padding: 0;
...
`;function l_({title:n,children:t,last:i=!1}){return x.jsxs(ID,{$last:i,children:[x.jsx(CD,{title:n}),x.jsx(OD,{children:t})]})}const VD=A.div`
...
`;function YD({to:n,from:t,message:i}){return x.jsxs($D,{$w:sf,$h:xu,children:[x.jsx(FD,{}),x.jsx(qD,{}),x.jsx(KD,{children:`To. ${n}`}),x.jsx(HD,{children:i}),x.jsx(GD,{children:`From. ${t}`})]})}const QD=A.div`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
  overflow: hidden;
...
`,XD=A.img`
  ...
  object-fit: cover;
  display: block;
`;function WD({src:n}){return x.jsx(QD,{$w:sf,$h:xu,children:x.jsx(XD,{src:n,alt:"포토 카드"})})}const ZD=A.button`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
...
`;function i5({onClick:n}){return x.jsx(ZD,{onClick:n,"aria-label":"방명록 작성",$w:sf,$h:xu,children:x.jsx(JD,{children:x.jsxs(t5,{children:[x.jsx(e5,{}),x.jsx(n5,{})]})})})}const sf=270,xu=337,r5=30,nb=20,a5=210,s5=60,ib=173,rb=216,o5=16,l5=16,bm=16,u5=A.div`
  padding: 0 0 12px 0;
  @media (max-width: 640px) {
    display: none;
  }
...
`;function $5({open:n,onClose:t,onSubmit:i,defaultTo:a="",defaultFrom:o=""}){const[u,f]=K.useState(a),[m,p]=K.useState(o),[g,v]=K.useState(""),w=K.useRef(null);if(K.useEffect(()=>{const V=B=>{B.key==="Escape"&&t?.()};return n&&document.addEventListener("keydown",V),()=>document.removeEventListener("keydown",V)},[n,t]),!n)return null;const S=V=>{V.target===w.current&&t?.()},R=()=>{const V={to:(u||"").trim(),from:(m||"").trim(),message:(g||"").trim()};V.message&&i?.(V)};return x.jsx(E5,{ref:w,onMouseDown:S,children:x.jsxs(b5,{onMouseDown:V=>V.stopPropagation(),children:[x.jsx(w5,{children:x.jsxs(T5,{children:[x.jsxs(S5,{children:[x.jsx(A5,{}),x.jsx(R5,{}),x.jsxs(C5,{children:[x.jsx(I5,{children:"To."}),x.jsx(j5,{value:u,onChange:V=>f(V.target.value),placeholder:"받는 사람"})]}),x.jsx(D5,{children:x.jsx(N5,{placeholder:"내용을 입력해 주세요.",value:g,onChange:V=>v(V.target.value)})}),x.jsxs(M5,{children:[x.jsx(O5,{children:"From."}),x.jsx(V5,{value:m,onChange:V=>p(V.target.value),placeholder:"보내는 사람"})]})]}),x.jsx(k5,{children:x.jsx(U5,{type:"button",onClick:R,"aria-label":"send",children:x.jsx(P5,{})})})]})}),x.jsx(L5,{children:x.jsx(z5,{type:"button",onClick:t,"aria-label":"close",children:x.jsxs(B5,{children:[x.jsx(c_,{$deg:45}),x.jsx(c_,{$deg:-45})]})})})]})})}const F5={apiKey:"AIzaSyAEFzPwTADLzuxWuyk889Jz1cHPsEgLOkQ",authDomain:"tu2025grad.firebaseapp.com",projectId:"tu2025grad",storageBucket:"tu2025grad.firebasestorage.app",messagingSenderId:"553768466639",appId:"1:553768466639:web:7c16f5d6432da7ebc05fba"},q5=Qm(F5),h_=$2(q5),K5='Pretendard, system-ui, -apple-system, Segoe UI, Roboto, "Noto Sans KR", Arial, sans-serif',H5=A.div`
...
`;function W5(){const[n,t]=Ot.useState(!1),[i,a]=Ot.useState([]);Ot.useEffect(()=>{const f=zj(vm(h_,"guest"),Bj("time","desc")),m=Hj(f,p=>{const g=[];p.forEach(v=>{const w=v.data();g.push({id:v.id,to:w.to||"",from:w.from||"",message:w.message||"",type:"text"})}),a(g)});return()=>m()},[]);const o=async({to:f,from:m,message:p})=>{try{const g=String(Date.now());await Vg(to(vm(h_,"guest"),g),{to:f||"",from:m||"",message:p||"",time:g}),t(!1)}catch(g){console.error("Failed to submit guest message:",g)}};return x.jsxs(H5,{children:[x.jsxs(G5,{children:[x.jsx(Y5,{children:"Guest Book"}),x.jsx(Q5,{children:x.jsxs(X5,{className:"gb-wrap",children:[x.jsx("style",{children:`
  ...
  `}),x.jsx(_5,{onOpenModal:()=>t(!0),items:i})]})})]}),x.jsx($5,{open:n,onClose:()=>t(!1),onSubmit:o})]})}const wm="/TU2025gradulate/",Z5=A.div`
  display: flex;
  position: sticky;
  top: 80px;
  bottom: 0px;
...
`;function Lg({nameKor:n,nameEng:t,part:i,sns:a,eMail:o,imgUrl:u,imgAlt:f}){return x.jsxs(pN,{children:[x.jsx(mN,{children:x.jsx(gN,{src:u,alt:f})}),x.jsxs(yN,{children:[x.jsxs(xN,{children:[x.jsx(vN,{children:n}),x.jsx(_N,{children:t})]}),x.jsxs(EN,{children:[x.jsxs(bN,{children:[x.jsx(Op,{children:"Part"}),x.jsx(Op,{children:"SNS"}),x.jsx(Op,{children:"E-mail"})]}),x.jsxs(wN,{children:[x.jsx(Vp,{children:i}),x.jsx(Vp,{children:a}),x.jsx(Vp,{children:o})]})]})]})]})}Lg.propTypes={nameKor:W.string.isRequired,nameEng:W.string.isRequired,part:W.string,sns:W.string,eMail:W.string,imgUrl:W.string.isRequired,imgAlt:W.string.isRequired};Lg.defaultProps={sns:"N/A",eMail:"N/A"};const TN=A.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  width: 775px;
...
`;function f_({designers:n}){return x.jsxs(TN,{children:[x.jsx(AN,{children:"Designer"}),x.jsx(SN,{children:n.map((t,i)=>x.jsx(Lg,{nameKor:t.nameKor,nameEn:t.nameEn,part:t.role,sns:t.sns,eMail:t.eMail,imgUrl:t.imgUrl},i))})]})}const RN=A.div`
    width: 100%; // 임시값
    margin-top: 50px;
@media (max-width: 640px) {
    margin-top: 20px;
...
`,MN=A.div`
    ...
    width: 40px;
    height: 40px;
`;function ON({isOpen:n=!1,onClick:t}){const[i,a]=K.useState(!1);return K.useEffect(()=>{let o;return n?a(!1):(a(!1),o=setTimeout(()=>{a(!0)},500)),()=>clearTimeout(o)},[n]),x.jsx(NN,{$visible:!n,$active:i,onClick:()=>{typeof t=="function"&&t()},children:x.jsx(MN,{children:x.jsx("img",{src:`${DN}icons/infoOpenIcon.svg`,alt:"작품 정보 열기"})})})}const d_=40;function Xc(n){if(!n)return n;const t="/TU2025gradulate/";if(/^https?:\/\//i.test(n))return n;const i=String(n).replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const VN=A.img`
  width: 100%;
  height: auto;
  object-fit: cover;
  display: block;
