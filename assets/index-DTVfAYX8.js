...
`;function MA({text:n}){return y.jsxs(CA,{children:[y.jsx(L2,{}),y.jsx(jA,{}),y.jsx(IA,{dangerouslySetInnerHTML:{__html:n}})]})}const OA=S.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  gap: 46px;
...
`,UA=S.div`
  ...
  background-image: url('${z2}icons/play_btn.svg');
...
`;function zA({children:n}){return y.jsxs(kA,{children:[y.jsx(UA,{}),y.jsx(PA,{}),y.jsx(VA,{children:n})]})}const LA=S.div`
...
`;function KA({blocks:n}){return y.jsxs(LA,{children:[y.jsx(L2,{}),n.map(t=>y.jsxs($A,{children:[y.jsx(BA,{children:t.title}),y.jsx(FA,{dangerouslySetInnerHTML:{__html:t.body}})]},t.title))]})}const HA=S.div`
...
`;function dm({path:n="student",isActive:t=!1,onClick:i}){return y.jsxs(dR,{onClick:i,children:[y.jsx($2,{$active:t,children:"교수"}),y.jsx(pR,{$active:t,children:"학생"}),y.jsx(fR,{$active:t})]})}dm.propTypes={path:J.oneOf(["student","professor"]),isActive:J.bool,onClick:J.func};const K1=S.a`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  font-size: 24px;
  line-height: 28.8px;
  letter-spacing: 0.24px;
...
`,zR=S.div`position: relative;`;function LR({people:n}){const t=Fh();return y.jsx(VR,{children:n.map((i,a)=>{const o=i.id??i.studentId??`${i.nameKor}-${a}`,u=typeof i.projectNum=="number"&&i.category,d=u?i.projectNum+1:null,p=u?`${DR[i.category]||"A"}${String(d).padStart(3,"0")}`:null,m=y.jsx(rg,{nameKor:i.nameKor,nameEng:i.nameEng,role:i.role,sns:i.sns||"-",eMail:i.eMail,imgSrc:G2(i.imgUrl),imgAlt:`${i.nameKor} profile`},o);return u?y.jsx(UR,{role:"link",tabIndex:0,onClick:()=>t(`/work/${p}`),onKeyDown:g=>{(g.key==="Enter"||g.key===" ")&&t(`/work/${p}`)},"aria-label":`${i.nameKor} 작품 보기 (${p})`,children:m},`link-${o}`):m})})}function $R(){const[n,t]=bt.useState(!1),[i,a]=bt.useState(Q1[0]),o=bt.useMemo(()=>{const p=new Map;return(eu||[]).forEach(m=>{(m.members||[]).forEach(g=>{p.has(g)||p.set(g,m)})}),p},[]);bt.useEffect(()=>{a(n?kl[0]?.id||"":Q1[0])},[n]);const u=bt.useMemo(()=>{if(!n){if(i==="전체")return jp;let m=NR[i];return m===void 0&&(m=X1(i)),jp.filter(g=>X1(g.department)===m)}const p=kl.some(m=>m.id===i)?i:kl.find(m=>m.nameKor===i)?.id||"";return jp.filter(m=>m.professorId===p).map(m=>{let g=o.get(m.num);g||(g=(eu||[]).find(E=>E.category===m.category&&E.projectNum===m.projectNum)||null);const v=g?`/projects/${g.projectNum}/thumb.jpg`:"/thumbnailExample.png";return{...m,imgUrl:v}})},[i,n,o]),d=bt.useMemo(()=>n&&(kl.find(m=>m.id===i)||kl.find(m=>m.nameKor===i))||null,[n,i]);return y.jsxs(zR,{children:[y.jsx(PR,{children:"Peoples"}),y.jsx(q2,{type:"people",onCategoryChange:a,onToggleChange:t}),y.jsxs(kR,{children:[n&&d&&y.jsx(og,{nameKor:d.nameKor,rank:d.rank||"교수",eMail:d.email,education:d.education,field:d.field,imgSrc:G2(d.imgUrl),imgAlt:`${d.nameKor} profile`}),y.jsx(LR,{people:u})]})]})}const W1=S.div`
  @media (max-width: 393px) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sr=new Z2("@firebase/app"),G6="@firebase/app-compat",Y6="@firebase/analytics-compat",Q6="@firebase/analytics",X6="@firebase/app-check-compat",W6="@firebase/app-check",Z6="@firebase/auth",J6="@firebase/auth-compat",tI="@firebase/database",eI="@firebase/data-connect",nI="@firebase/database-compat",iI="@firebase/functions",rI="@firebase/functions-compat",aI="@firebase/installations",sI="@firebase/installations-compat",oI="@firebase/messaging",lI="@firebase/messaging-compat",uI="@firebase/performance",cI="@firebase/performance-compat",hI="@firebase/remote-config",dI="@firebase/remote-config-compat",fI="@firebase/storage",pI="@firebase/storage-compat",mI="@firebase/firestore",gI="@firebase/ai",yI="@firebase/firestore-compat",xI="firebase",vI="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AI=vI;function fg(n,t={}){let i=n;typeof t!="object"&&(t={name:t});const a={name:gm,automaticDataCollectionEnabled:!0,...t},o=a.name;if(typeof o!="string"||!o)throw Wr.create("bad-app-name",{appName:String(o)});if(i||(i=X2()),!i)throw Wr.create("no-options");const u=iu.get(o);if(u){if(Ih(i,u.options)&&Ih(a,u.config))return u;throw Wr.create("duplicate-app",{appName:o})}const d=new C6(o);for(const m of ym.values())d.addComponent(m);const p=new SI(i,a,d);return iu.set(o,p),p}function RI(n=gm){const t=iu.get(n);if(!t&&n===gm&&X2())return fg();if(!t)throw Wr.create("no-app",{appName:n});return t}function hv(){return Array.from(iu.values())}function eo(n,t,i){let a=_I[n]??n;i&&(a+=`-${i}`);const o=a.match(/\s|\//),u=t.match(/\s|\//);if(o||u){const d=[`Unable to register library "${a}" with version "${t}":`];o&&d.push(`library name "${a}" contains illegal characters (whitespace or "/")`),o&&u&&d.push("and"),u&&d.push(`version name "${t}" contains illegal characters (whitespace or "/")`),sr.warn(d.join(" "));return}Ch(new nu(`${a}-version`,()=>({library:a,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PI(n){Ch(new nu("platform-logger",t=>new H6(t),"PRIVATE")),Ch(new nu("heartbeat",t=>new MI(t),"PRIVATE")),eo(mm,uv,n),eo(mm,uv,"esm2020"),eo("fire-js","")}PI("");var UI="firebase",zI="12.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */eo(UI,zI,"app");var mv=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let z3=class{constructor(t,i){this.largestBatchId=t,this.mutation=i}getKey(){return this.mutation.key}isEqual(t){return t!==null&&this.mutation===t.mutation}toString(){return`Overlay{
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class L3{constructor(t,i){this.count=t,this.unchangedNames=i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,y_=eu,LE=lg,a5={"All Projects":null,"AI & Robot":"c0","Edu & Kids":"c1","Health Care":"c2","IT & Tech":"c3",Living:"c4",Mobility:"c5"};function Pm(n){return n.members.map(t=>{const i=LE.find(a=>a.num===t);return i?i.nameKor:""}).filter(Boolean).join(", ")}function s5(n){return n.members.map(t=>{const i=LE.find(a=>a.num===t);return i?zE(i.imgUrl):""}).filter(Boolean)}function o5({list:n,statsById:t}){const i={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"};return y.jsx(i5,{children:n.map((a,o)=>{const u=Pm(a),d=s5(a),p=String(a.projectNum+1).padStart(3,"0"),g=`${i[a.category]||"A"}${p}`,v=a.projectNum??a.num;return y.jsx(ug,{titleKor:a.titleKor,titleEng:a.titleEng,src:zE(`/projects/${a.projectNum}/thumb.jpg`||`/projects/${a.projectNum}/thumb.png`),nameKor:u,profileImgs:d,docId:v,href:`/work/${g}`,like:t[String(v)]?.like??0,view:t[String(v)]?.view??0},o)})})}function l5(){const[n,t]=bt.useState("All Projects"),[i,a]=bt.useState("이름순"),[o,u]=bt.useState({});bt.useEffect(()=>{let m=!0;return(async()=>{try{const g=await Vm(xh(Wl,"works"));if(!m)return;const v={};g.forEach(E=>{const T=E.data()||{};v[String(E.id)]={like:typeof T.like=="number"?T.like:0,view:typeof T.view=="number"?T.view:0}}),u(v)}catch(g){console.error("Failed to load works stats:",g)}})(),()=>{m=!1}},[]);const d=bt.useMemo(()=>{const m=a5[n]||null;return m?y_.filter(g=>g.category===m):y_},[n]),p=bt.useMemo(()=>{const m=[...d];switch(i){case"이름순":m.sort((g,v)=>Pm(g).localeCompare(Pm(v),"ko"));break;case"좋아요순":m.sort((g,v)=>{const E=String(g.projectNum??g.num),T=String(v.projectNum??v.num),A=o[E]?.like??0;return(o[T]?.like??0)-A});break;case"조회수순":m.sort((g,v)=>{const E=String(g.projectNum??g.num),T=String(v.projectNum??v.num),A=o[E]?.view??0;return(o[T]?.view??0)-A});break;case"팀작우선":m.sort((g,v)=>(v.members.length>1)-(g.members.length>1));break;case"개인작우선":m.sort((g,v)=>(g.members.length>1)-(v.members.length>1));break}return m},[d,i,o]);return y.jsxs(n5,{children:[y.jsx(r5,{children:"Projects"}),y.jsx(q2,{type:"project",onCategoryChange:t,onSortChange:a,sortLabel:i}),y.jsx(e5,{children:y.jsx(o5,{list:p,statsById:o})})]})}const u5=S.div(({height:n,from:t,to:i,position:a,z:o})=>({position:"absolute",left:0,right:0,[a]:-1,height:n,pointerEvents:"none",zIndex:o??0,background:`linear-gradient(180deg, ${t} 0%, ${i} 100%)`}));function $E({position:n="bottom",from:t,to:i,height:a=240,z:o=0,style:u}){return y.jsx(u5,{position:n,from:t,to:i,height:a,z:o,style:u})}const ro={heroToWhite:{from:"rgba(18,18,18,0)",to:"#FFFFFF",h:80},whiteToBlack:{from:"rgba(255,255,255,0)",to:"#121212",h:160}},c5=S.section`
...
`,Z5=(n,t=0,i=1)=>Math.max(t,Math.min(i,n)),Qs=(n,t,i)=>n+(t-n)*i,J5=n=>n<.5?2*n*n:1-Math.pow(-2*n+2,2)/2;function tD({work:n,progress:t,videoId:i}){String(i||"").trim();const a=`https://player.vimeo.com/video/${n.image}?muted=1&autoplay=1&loop=1&badge=0&controls=0&autopause=0&title=0&byline=0&portrait=0&app_id=58479`,o=J5(Z5(t,0,1)),u=Qs(0,-120,o),d=Qs(0,-360,o),p=Qs(0,-280,o),m=Qs(0,-220,o),g=Qs(0,-260,o),v=Qs(0,-180,o),E=.55,A=o<E?1:1-Math.max(0,Math.min(1,(o-E)/(.9-E))),M={transform:`translate3d(0, ${u}px, 0)`,willChange:"transform"},k=B=>({transform:`translate3d(0, ${B}px, 0)`,opacity:A,willChange:"transform, opacity"}),V={transform:`translate3d(0, ${v}px, 0)`,opacity:A,willChange:"transform, opacity"};return y.jsx(y.Fragment,{children:y.jsx(P5,{children:y.jsxs($5,{children:[y.jsx(B5,{style:M,children:y.jsx(X5,{src:a,frameBorder:"0"})}),y.jsx(F5,{style:k(d),children:n.artistKr}),y.jsx(K5,{style:k(p),children:n.dept}),y.jsx(H5,{style:k(m),children:n.rightMeta1}),y.jsx(q5,{style:k(g),children:n.rightMeta2}),y.jsxs(G5,{style:V,children:[y.jsx(Y5,{children:n.titleSmall}),y.jsx(Q5,{children:n.titleStrong})]})]})})})}function eD(){return y.jsxs(y.Fragment,{children:[y.jsx("style",{children:`
      ...
      `}),y.jsx("div",{className:"expo-works-desktop",children:__.slice(0,3).map(n=>y.jsx(V5,{durationVh:320,center:!0,centerOffsetPx:-40,children:t=>y.jsx(tD,{work:n,progress:t})},n.id))}),y.jsx(U5,{className:"expo-works-mobile",children:__.map(n=>y.jsxs(z5,{to:`work/${n.index}`,children:[y.jsx(W5,{src:`https://player.vimeo.com/video/${n.image}?badge=0&controls=0&autopause=0&title=0&byline=0&portrait=0&app_id=58479`}),y.jsxs(L5,{children:[y.jsx("div",{style:{fontWeight:700,fontSize:16},children:n.titleStrong}),y.jsxs("div",{style:{fontSize:13,color:"#D9D9D9"},children:[n.artistKr," | ",n.dept]}),y.jsx("div",{style:{fontSize:12,color:"#A1A1A1",marginTop:2},children:n.rightMeta1}),y.jsx("div",{style:{fontSize:12,color:"#A1A1A1"},children:n.rightMeta2})]})]},n.id))})]})}const nD="/",iD=S.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: flex-start;
...
`;function $D({}){const[n,t]=L.useState(!1),i=L.useRef(null),[a,o]=L.useState(0);L.useEffect(()=>{if(!i.current)return;const d=i.current.querySelectorAll("div")[0].scrollHeight/2.7;if(n){const p=d*3.5;o(p)}else o(d)},[n]);const u=[{title:"잔향 : 기억의 향기",context:`우리는 살아가며 수많은 순간들을 스쳐 지나간다.
...
`;function lN({onClick:n}){return y.jsxs(nN,{onClick:n,"aria-label":"방명록 작성",$w:yo,$h:Ja,children:[y.jsx(iN,{$w:yo,$h:Ja}),y.jsx(rN,{children:y.jsxs(aN,{children:[y.jsx(sN,{}),y.jsx(oN,{})]})})]})}const yo=270,Ja=337,uN=30,BE=20,cN=210,hN=60,FE=173,KE=216,dN=16,fN=16,zm=16,pN=S.div`
  padding: 0 0 12px 0;
  @media (max-width: 640px) {
    display: none;
  }
...
`;function z_({designers:n}){return y.jsxs(b9,{children:[y.jsx(S9,{children:"Designer"}),y.jsx(T9,{children:n.map((t,i)=>y.jsx(Jg,{nameKor:t.nameKor,nameEng:t.nameEng,part:t.role,sns:t.sns,eMail:t.eMail,imgUrl:t.imgUrl},i))})]})}const A9=S.div`
    width: 100%; // 임시값
    margin-top: 50px;
