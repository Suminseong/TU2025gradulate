 ...
 */var d1;function _T(){if(d1)return Ml;d1=1;var n=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(a,o,u){var d=null;if(u!==void 0&&(d=""+u),o.key!==void 0&&(d=""+o.key),"key"in o){u={};for(var p in o)p!=="key"&&(u[p]=o[p])}else u=o;return o=u.ref,{$$typeof:n,type:a,key:d,ref:o!==void 0?o:null,props:u}}return Ml.Fragment=t,Ml.jsx=i,Ml.jsxs=i,Ml}var f1;function wT(){return f1||(f1=1,fp.exports=_T()),fp.exports}var y=wT(),pp={exports:{}},Dt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 *
 * @license MIT
 */var g1="popstate";function bT(n={}){function t(a,o){let{pathname:u,search:d,hash:p}=a.location;return nm("",{pathname:u,search:d,hash:p},o.state&&o.state.usr||null,o.state&&o.state.key||"default")}function i(a,o){return typeof o=="string"?o:Zl(o)}return ST(t,i,null,n)}function de(n,t){if(n===!1||n===null||typeof n>"u")throw new Error(t)}function ri(n,t){if(!n){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function TT(){return Math.random().toString(36).substring(2,10)}function y1(n,t){return{usr:n.state,key:n.key,idx:t}}function nm(n,t,i=null,a){return{pathname:typeof n=="string"?n:n.pathname,search:"",hash:"",...typeof t=="string"?xo(t):t,state:i,key:t&&t.key||a||TT()}}function Zl({pathname:n="/",search:t="",hash:i=""}){return t&&t!=="?"&&(n+=t.charAt(0)==="?"?t:"?"+t),i&&i!=="#"&&(n+=i.charAt(0)==="#"?i:"#"+i),n}function xo(n){let t={};if(n){let i=n.indexOf("#");i>=0&&(t.hash=n.substring(i),n=n.substring(0,i));let a=n.indexOf("?");a>=0&&(t.search=n.substring(a),n=n.substring(0,a)),n&&(t.pathname=n)}return t}function ST(n,t,i,a={}){let{window:o=document.defaultView,v5Compat:u=!1}=a,d=o.history,p="POP",m=null,g=v();g==null&&(g=0,d.replaceState({...d.state,idx:g},""));function v(){return(d.state||{idx:null}).idx}function E(){p="POP";let V=v(),B=V==null?null:V-g;g=V,m&&m({action:p,location:k.location,delta:B})}function T(V,B){p="PUSH";let q=nm(k.location,V,B);g=v()+1;let Z=y1(q,g),lt=k.createHref(q);try{d.pushState(Z,"",lt)}catch(K){if(K instanceof DOMException&&K.name==="DataCloneError")throw K;o.location.assign(lt)}u&&m&&m({action:p,location:k.location,delta:1})}function A(V,B){p="REPLACE";let q=nm(k.location,V,B);g=v();let Z=y1(q,g),lt=k.createHref(q);d.replaceState(Z,"",lt),u&&m&&m({action:p,location:k.location,delta:0})}function M(V){return AT(V)}let k={get action(){return p},get location(){return n(o,d)},listen(V){if(m)throw new Error("A history only accepts one active listener");return o.addEventListener(g1,E),m=V,()=>{o.removeEventListener(g1,E),m=null}},createHref(V){return t(o,V)},createURL:M,encodeLocation(V){let B=M(V);return{pathname:B.pathname,search:B.search,hash:B.hash}},push:T,replace:A,go(V){return d.go(V)}};return k}function AT(n,t=!1){let i="http://localhost";typeof window<"u"&&(i=window.location.origin!=="null"?window.location.origin:window.location.href),de(i,"No window.location.(origin|href) available to create URL");let a=typeof n=="string"?n:Zl(n);return a=a.replace(/ $/,"%20"),!t&&a.startsWith("//")&&(a=i+a),new URL(a,i)}function W2(n,t,i="/"){return RT(n,t,i,!1)}function RT(n,t,i,a){let o=typeof t=="string"?xo(t):t,u=rr(o.pathname||"/",i);if(u==null)return null;let d=Z2(n);IT(d);let p=null;for(let m=0;p==null&&m<d.length;++m){let g=LT(u);p=PT(d[m],g,a)}return p}function Z2(n,t=[],i=[],a="",o=!1){let u=(d,p,m=o,g)=>{let v={relativePath:g===void 0?d.path||"":g,caseSensitive:d.caseSensitive===!0,childrenIndex:p,route:d};if(v.relativePath.startsWith("/")){if(!v.relativePath.startsWith(a)&&m)return;de(v.relativePath.startsWith(a),`Absolute route path "${v.relativePath}" nested under path "${a}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),v.relativePath=v.relativePath.slice(a.length)}let E=nr([a,v.relativePath]),T=i.concat(v);d.children&&d.children.length>0&&(de(d.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${E}".`),Z2(d.children,t,T,E,m)),!(d.path==null&&!d.index)&&t.push({path:E,score:kT(E,d.index),routesMeta:T})};return n.forEach((d,p)=>{if(d.path===""||!d.path?.includes("?"))u(d,p);else for(let m of J2(d.path))u(d,p,!0,m)}),t}function J2(n){let t=n.split("/");if(t.length===0)return[];let[i,...a]=t,o=i.endsWith("?"),u=i.replace(/\?$/,"");if(a.length===0)return o?[u,""]:[u];let d=J2(a.join("/")),p=[];return p.push(...d.map(m=>m===""?u:[u,m].join("/"))),o&&p.push(...d),p.map(m=>n.startsWith("/")&&m===""?"/":m)}function IT(n){n.sort((t,i)=>t.score!==i.score?i.score-t.score:VT(t.routesMeta.map(a=>a.childrenIndex),i.routesMeta.map(a=>a.childrenIndex)))}var CT=/^:[\w-]+$/,jT=3,DT=2,NT=1,MT=10,OT=-2,x1=n=>n==="*";function kT(n,t){let i=n.split("/"),a=i.length;return i.some(x1)&&(a+=OT),t&&(a+=DT),i.filter(o=>!x1(o)).reduce((o,u)=>o+(CT.test(u)?jT:u===""?NT:MT),a)}function VT(n,t){return n.length===t.length&&n.slice(0,-1).every((a,o)=>a===t[o])?n[n.length-1]-t[t.length-1]:0}function PT(n,t,i=!1){let{routesMeta:a}=n,o={},u="/",d=[];for(let p=0;p<a.length;++p){let m=a[p],g=p===a.length-1,v=u==="/"?t:t.slice(u.length)||"/",E=Eh({path:m.relativePath,caseSensitive:m.caseSensitive,end:g},v),T=m.route;if(!E&&g&&i&&!a[a.length-1].route.index&&(E=Eh({path:m.relativePath,caseSensitive:m.caseSensitive,end:!1},v)),!E)return null;Object.assign(o,E.params),d.push({params:o,pathname:nr([u,E.pathname]),pathnameBase:FT(nr([u,E.pathnameBase])),route:T}),E.pathnameBase!=="/"&&(u=nr([u,E.pathnameBase]))}return d}function Eh(n,t){typeof n=="string"&&(n={path:n,caseSensitive:!1,end:!0});let[i,a]=UT(n.path,n.caseSensitive,n.end),o=t.match(i);if(!o)return null;let u=o[0],d=u.replace(/(.)\/+$/,"$1"),p=o.slice(1);return{params:a.reduce((g,{paramName:v,isOptional:E},T)=>{if(v==="*"){let M=p[T]||"";d=u.slice(0,u.length-M.length).replace(/(.)\/+$/,"$1")}const A=p[T];return E&&!A?g[v]=void 0:g[v]=(A||"").replace(/%2F/g,"/"),g},{}),pathname:u,pathnameBase:d,pattern:n}}function UT(n,t=!1,i=!0){ri(n==="*"||!n.endsWith("*")||n.endsWith("/*"),`Route path "${n}" will be treated as if it were "${n.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${n.replace(/\*$/,"/*")}".`);let a=[],o="^"+n.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(d,p,m)=>(a.push({paramName:p,isOptional:m!=null}),m?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return n.endsWith("*")?(a.push({paramName:"*"}),o+=n==="*"||n==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):i?o+="\\/*$":n!==""&&n!=="/"&&(o+="(?:(?=\\/|$))"),[new RegExp(o,t?void 0:"i"),a]}function LT(n){try{return n.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return ri(!1,`The URL path "${n}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${t}).`),n}}function rr(n,t){if(t==="/")return n;if(!n.toLowerCase().startsWith(t.toLowerCase()))return null;let i=t.endsWith("/")?t.length-1:t.length,a=n.charAt(i);return a&&a!=="/"?null:n.slice(i)||"/"}function zT(n,t="/"){let{pathname:i,search:a="",hash:o=""}=typeof n=="string"?xo(n):n;return{pathname:i?i.startsWith("/")?i:$T(i,t):t,search:KT(a),hash:HT(o)}}function $T(n,t){let i=t.replace(/\/+$/,"").split("/");return n.split("/").forEach(o=>{o===".."?i.length>1&&i.pop():o!=="."&&i.push(o)}),i.length>1?i.join("/"):"/"}function mp(n,t,i,a){return`Cannot include a '${n}' character in a manually specified \`to.${t}\` field [${JSON.stringify(a)}].  Please separate it out to the \`to.${i}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function BT(n){return n.filter((t,i)=>i===0||t.route.path&&t.route.path.length>0)}function Fm(n){let t=BT(n);return t.map((i,a)=>a===t.length-1?i.pathname:i.pathnameBase)}function Km(n,t,i,a=!1){let o;typeof n=="string"?o=xo(n):(o={...n},de(!o.pathname||!o.pathname.includes("?"),mp("?","pathname","search",o)),de(!o.pathname||!o.pathname.includes("#"),mp("#","pathname","hash",o)),de(!o.search||!o.search.includes("#"),mp("#","search","hash",o)));let u=n===""||o.pathname==="",d=u?"/":o.pathname,p;if(d==null)p=i;else{let E=t.length-1;if(!a&&d.startsWith("..")){let T=d.split("/");for(;T[0]==="..";)T.shift(),E-=1;o.pathname=T.join("/")}p=E>=0?t[E]:"/"}let m=zT(o,p),g=d&&d!=="/"&&d.endsWith("/"),v=(u||d===".")&&i.endsWith("/");return!m.pathname.endsWith("/")&&(g||v)&&(m.pathname+="/"),m}var nr=n=>n.join("/").replace(/\/\/+/g,"/"),FT=n=>n.replace(/\/+$/,"").replace(/^\/*/,"/"),KT=n=>!n||n==="?"?"":n.startsWith("?")?n:"?"+n,HT=n=>!n||n==="#"?"":n.startsWith("#")?n:"#"+n;function qT(n){return n!=null&&typeof n.status=="number"&&typeof n.statusText=="string"&&typeof n.internal=="boolean"&&"data"in n}var t_=["POST","PUT","PATCH","DELETE"];new Set(t_);var GT=["GET",...t_];new Set(GT);var vo=z.createContext(null);vo.displayName="DataRouter";var Bh=z.createContext(null);Bh.displayName="DataRouterState";z.createContext(!1);var e_=z.createContext({isTransitioning:!1});e_.displayName="ViewTransition";var YT=z.createContext(new Map);YT.displayName="Fetchers";var QT=z.createContext(null);QT.displayName="Await";var si=z.createContext(null);si.displayName="Navigation";var fu=z.createContext(null);fu.displayName="Location";var Hn=z.createContext({outlet:null,matches:[],isDataRoute:!1});Hn.displayName="Route";var Hm=z.createContext(null);Hm.displayName="RouteError";function XT(n,{relative:t}={}){de(_o(),"useHref() may be used only in the context of a <Router> component.");let{basename:i,navigator:a}=z.useContext(si),{hash:o,pathname:u,search:d}=pu(n,{relative:t}),p=u;return i!=="/"&&(p=u==="/"?i:nr([i,u])),a.createHref({pathname:p,search:d,hash:o})}function _o(){return z.useContext(fu)!=null}function ji(){return de(_o(),"useLocation() may be used only in the context of a <Router> component."),z.useContext(fu).location}var n_="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function i_(n){z.useContext(si).static||z.useLayoutEffect(n)}function Fh(){let{isDataRoute:n}=z.useContext(Hn);return n?d4():WT()}function WT(){de(_o(),"useNavigate() may be used only in the context of a <Router> component.");let n=z.useContext(vo),{basename:t,navigator:i}=z.useContext(si),{matches:a}=z.useContext(Hn),{pathname:o}=ji(),u=JSON.stringify(Fm(a)),d=z.useRef(!1);return i_(()=>{d.current=!0}),z.useCallback((m,g={})=>{if(ri(d.current,n_),!d.current)return;if(typeof m=="number"){i.go(m);return}let v=Km(m,JSON.parse(u),o,g.relative==="path");n==null&&t!=="/"&&(v.pathname=v.pathname==="/"?t:nr([t,v.pathname])),(g.replace?i.replace:i.push)(v,g.state,g)},[t,i,u,o,n])}var ZT=z.createContext(null);function JT(n){let t=z.useContext(Hn).outlet;return t&&z.createElement(ZT.Provider,{value:n},t)}function t4(){let{matches:n}=z.useContext(Hn),t=n[n.length-1];return t?t.params:{}}function pu(n,{relative:t}={}){let{matches:i}=z.useContext(Hn),{pathname:a}=ji(),o=JSON.stringify(Fm(i));return z.useMemo(()=>Km(n,JSON.parse(o),a,t==="path"),[n,o,a,t])}function e4(n,t){return r_(n,t)}function r_(n,t,i,a,o){de(_o(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:u}=z.useContext(si),{matches:d}=z.useContext(Hn),p=d[d.length-1],m=p?p.params:{},g=p?p.pathname:"/",v=p?p.pathnameBase:"/",E=p&&p.route;{let q=E&&E.path||"";a_(g,!E||q.endsWith("*")||q.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${g}" (under <Route path="${q}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${q}"> to <Route path="${q==="/"?"*":`${q}/*`}">.`)}let T=ji(),A;if(t){let q=typeof t=="string"?xo(t):t;de(v==="/"||q.pathname?.startsWith(v),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${v}" but pathname "${q.pathname}" was given in the \`location\` prop.`),A=q}else A=T;let M=A.pathname||"/",k=M;if(v!=="/"){let q=v.replace(/^\//,"").split("/");k="/"+M.replace(/^\//,"").split("/").slice(q.length).join("/")}let V=W2(n,{pathname:k});ri(E||V!=null,`No routes matched location "${A.pathname}${A.search}${A.hash}" `),ri(V==null||V[V.length-1].route.element!==void 0||V[V.length-1].route.Component!==void 0||V[V.length-1].route.lazy!==void 0,`Matched leaf route at location "${A.pathname}${A.search}${A.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let B=s4(V&&V.map(q=>Object.assign({},q,{params:Object.assign({},m,q.params),pathname:nr([v,u.encodeLocation?u.encodeLocation(q.pathname).pathname:q.pathname]),pathnameBase:q.pathnameBase==="/"?v:nr([v,u.encodeLocation?u.encodeLocation(q.pathnameBase).pathname:q.pathnameBase])})),d,i,a,o);return t&&B?z.createElement(fu.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...A},navigationType:"POP"}},B):B}function n4(){let n=h4(),t=qT(n)?`${n.status} ${n.statusText}`:n instanceof Error?n.message:JSON.stringify(n),i=n instanceof Error?n.stack:null,a="rgba(200,200,200, 0.5)",o={padding:"0.5rem",backgroundColor:a},u={padding:"2px 4px",backgroundColor:a},d=null;return console.error("Error handled by React Router default ErrorBoundary:",n),d=z.createElement(z.Fragment,null,z.createElement("p",null,"💿 Hey developer 👋"),z.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",z.createElement("code",{style:u},"ErrorBoundary")," or"," ",z.createElement("code",{style:u},"errorElement")," prop on your route.")),z.createElement(z.Fragment,null,z.createElement("h2",null,"Unexpected Application Error!"),z.createElement("h3",{style:{fontStyle:"italic"}},t),i?z.createElement("pre",{style:o},i):null,d)}var i4=z.createElement(n4,null),r4=class extends z.Component{constructor(n){super(n),this.state={location:n.location,revalidation:n.revalidation,error:n.error}}static getDerivedStateFromError(n){return{error:n}}static getDerivedStateFromProps(n,t){return t.location!==n.location||t.revalidation!=="idle"&&n.revalidation==="idle"?{error:n.error,location:n.location,revalidation:n.revalidation}:{error:n.error!==void 0?n.error:t.error,location:t.location,revalidation:n.revalidation||t.revalidation}}componentDidCatch(n,t){this.props.unstable_onError?this.props.unstable_onError(n,t):console.error("React Router caught the following error during render",n)}render(){return this.state.error!==void 0?z.createElement(Hn.Provider,{value:this.props.routeContext},z.createElement(Hm.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function a4({routeContext:n,match:t,children:i}){let a=z.useContext(vo);return a&&a.static&&a.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(a.staticContext._deepestRenderedBoundaryId=t.route.id),z.createElement(Hn.Provider,{value:n},i)}function s4(n,t=[],i=null,a=null,o=null){if(n==null){if(!i)return null;if(i.errors)n=i.matches;else if(t.length===0&&!i.initialized&&i.matches.length>0)n=i.matches;else return null}let u=n,d=i?.errors;if(d!=null){let g=u.findIndex(v=>v.route.id&&d?.[v.route.id]!==void 0);de(g>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(d).join(",")}`),u=u.slice(0,Math.min(u.length,g+1))}let p=!1,m=-1;if(i)for(let g=0;g<u.length;g++){let v=u[g];if((v.route.HydrateFallback||v.route.hydrateFallbackElement)&&(m=g),v.route.id){let{loaderData:E,errors:T}=i,A=v.route.loader&&!E.hasOwnProperty(v.route.id)&&(!T||T[v.route.id]===void 0);if(v.route.lazy||A){p=!0,m>=0?u=u.slice(0,m+1):u=[u[0]];break}}}return u.reduceRight((g,v,E)=>{let T,A=!1,M=null,k=null;i&&(T=d&&v.route.id?d[v.route.id]:void 0,M=v.route.errorElement||i4,p&&(m<0&&E===0?(a_("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),A=!0,k=null):m===E&&(A=!0,k=v.route.hydrateFallbackElement||null)));let V=t.concat(u.slice(0,E+1)),B=()=>{let q;return T?q=M:A?q=k:v.route.Component?q=z.createElement(v.route.Component,null):v.route.element?q=v.route.element:q=g,z.createElement(a4,{match:v,routeContext:{outlet:g,matches:V,isDataRoute:i!=null},children:q})};return i&&(v.route.ErrorBoundary||v.route.errorElement||E===0)?z.createElement(r4,{location:i.location,revalidation:i.revalidation,component:M,error:T,children:B(),routeContext:{outlet:null,matches:V,isDataRoute:!0},unstable_onError:a}):B()},null)}function qm(n){return`${n} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function o4(n){let t=z.useContext(vo);return de(t,qm(n)),t}function l4(n){let t=z.useContext(Bh);return de(t,qm(n)),t}function u4(n){let t=z.useContext(Hn);return de(t,qm(n)),t}function Gm(n){let t=u4(n),i=t.matches[t.matches.length-1];return de(i.route.id,`${n} can only be used on routes that contain a unique "id"`),i.route.id}function c4(){return Gm("useRouteId")}function h4(){let n=z.useContext(Hm),t=l4("useRouteError"),i=Gm("useRouteError");return n!==void 0?n:t.errors?.[i]}function d4(){let{router:n}=o4("useNavigate"),t=Gm("useNavigate"),i=z.useRef(!1);return i_(()=>{i.current=!0}),z.useCallback(async(o,u={})=>{ri(i.current,n_),i.current&&(typeof o=="number"?n.navigate(o):await n.navigate(o,{fromRouteId:t,...u}))},[n,t])}var v1={};function a_(n,t,i){!t&&!v1[n]&&(v1[n]=!0,ri(!1,i))}z.memo(f4);function f4({routes:n,future:t,state:i,unstable_onError:a}){return r_(n,void 0,i,a,t)}function p4({to:n,replace:t,state:i,relative:a}){de(_o(),"<Navigate> may be used only in the context of a <Router> component.");let{static:o}=z.useContext(si);ri(!o,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:u}=z.useContext(Hn),{pathname:d}=ji(),p=Fh(),m=Km(n,Fm(u),d,a==="path"),g=JSON.stringify(m);return z.useEffect(()=>{p(JSON.parse(g),{replace:t,state:i,relative:a})},[p,g,a,t,i]),null}function m4(n){return JT(n.context)}function wi(n){de(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function g4({basename:n="/",children:t=null,location:i,navigationType:a="POP",navigator:o,static:u=!1}){de(!_o(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let d=n.replace(/^\/*/,"/"),p=z.useMemo(()=>({basename:d,navigator:o,static:u,future:{}}),[d,o,u]);typeof i=="string"&&(i=xo(i));let{pathname:m="/",search:g="",hash:v="",state:E=null,key:T="default"}=i,A=z.useMemo(()=>{let M=rr(m,d);return M==null?null:{location:{pathname:M,search:g,hash:v,state:E,key:T},navigationType:a}},[d,m,g,v,E,T,a]);return ri(A!=null,`<Router basename="${d}"> is not able to match the URL "${m}${g}${v}" because it does not start with the basename, so the <Router> won't render anything.`),A==null?null:z.createElement(si.Provider,{value:p},z.createElement(fu.Provider,{children:t,value:A}))}function y4({children:n,location:t}){return e4(im(n),t)}function im(n,t=[]){let i=[];return z.Children.forEach(n,(a,o)=>{if(!z.isValidElement(a))return;let u=[...t,o];if(a.type===z.Fragment){i.push.apply(i,im(a.props.children,u));return}de(a.type===wi,`[${typeof a.type=="string"?a.type:a.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),de(!a.props.index||!a.props.children,"An index route cannot have child routes.");let d={id:a.props.id||u.join("-"),caseSensitive:a.props.caseSensitive,element:a.props.element,Component:a.props.Component,index:a.props.index,path:a.props.path,loader:a.props.loader,action:a.props.action,hydrateFallbackElement:a.props.hydrateFallbackElement,HydrateFallback:a.props.HydrateFallback,errorElement:a.props.errorElement,ErrorBoundary:a.props.ErrorBoundary,hasErrorBoundary:a.props.hasErrorBoundary===!0||a.props.ErrorBoundary!=null||a.props.errorElement!=null,shouldRevalidate:a.props.shouldRevalidate,handle:a.props.handle,lazy:a.props.lazy};a.props.children&&(d.children=im(a.props.children,u)),i.push(d)}),i}var rh="get",ah="application/x-www-form-urlencoded";function Kh(n){return n!=null&&typeof n.tagName=="string"}function x4(n){return Kh(n)&&n.tagName.toLowerCase()==="button"}function v4(n){return Kh(n)&&n.tagName.toLowerCase()==="form"}function _4(n){return Kh(n)&&n.tagName.toLowerCase()==="input"}function w4(n){return!!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)}function E4(n,t){return n.button===0&&(!t||t==="_self")&&!w4(n)}var Kc=null;function b4(){if(Kc===null)try{new FormData(document.createElement("form"),0),Kc=!1}catch{Kc=!0}return Kc}var T4=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function gp(n){return n!=null&&!T4.has(n)?(ri(!1,`"${n}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${ah}"`),null):n}function S4(n,t){let i,a,o,u,d;if(v4(n)){let p=n.getAttribute("action");a=p?rr(p,t):null,i=n.getAttribute("method")||rh,o=gp(n.getAttribute("enctype"))||ah,u=new FormData(n)}else if(x4(n)||_4(n)&&(n.type==="submit"||n.type==="image")){let p=n.form;if(p==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let m=n.getAttribute("formaction")||p.getAttribute("action");if(a=m?rr(m,t):null,i=n.getAttribute("formmethod")||p.getAttribute("method")||rh,o=gp(n.getAttribute("formenctype"))||gp(p.getAttribute("enctype"))||ah,u=new FormData(p,n),!b4()){let{name:g,type:v,value:E}=n;if(v==="image"){let T=g?`${g}.`:"";u.append(`${T}x`,"0"),u.append(`${T}y`,"0")}else g&&u.append(g,E)}}else{if(Kh(n))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');i=rh,a=null,o=ah,d=n}return u&&o==="text/plain"&&(d=u,u=void 0),{action:a,method:i.toLowerCase(),encType:o,formData:u,body:d}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Ym(n,t){if(n===!1||n===null||typeof n>"u")throw new Error(t)}function A4(n,t,i){let a=typeof n=="string"?new URL(n,typeof window>"u"?"server://singlefetch/":window.location.origin):n;return a.pathname==="/"?a.pathname=`_root.${i}`:t&&rr(a.pathname,t)==="/"?a.pathname=`${t.replace(/\/$/,"")}/_root.${i}`:a.pathname=`${a.pathname.replace(/\/$/,"")}.${i}`,a}async function R4(n,t){if(n.id in t)return t[n.id];try{let i=await import(n.module);return t[n.id]=i,i}catch(i){return console.error(`Error loading route module \`${n.module}\`, reloading page...`),console.error(i),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function I4(n){return n==null?!1:n.href==null?n.rel==="preload"&&typeof n.imageSrcSet=="string"&&typeof n.imageSizes=="string":typeof n.rel=="string"&&typeof n.href=="string"}async function C4(n,t,i){let a=await Promise.all(n.map(async o=>{let u=t.routes[o.route.id];if(u){let d=await R4(u,i);return d.links?d.links():[]}return[]}));return M4(a.flat(1).filter(I4).filter(o=>o.rel==="stylesheet"||o.rel==="preload").map(o=>o.rel==="stylesheet"?{...o,rel:"prefetch",as:"style"}:{...o,rel:"prefetch"}))}function _1(n,t,i,a,o,u){let d=(m,g)=>i[g]?m.route.id!==i[g].route.id:!0,p=(m,g)=>i[g].pathname!==m.pathname||i[g].route.path?.endsWith("*")&&i[g].params["*"]!==m.params["*"];return u==="assets"?t.filter((m,g)=>d(m,g)||p(m,g)):u==="data"?t.filter((m,g)=>{let v=a.routes[m.route.id];if(!v||!v.hasLoader)return!1;if(d(m,g)||p(m,g))return!0;if(m.route.shouldRevalidate){let E=m.route.shouldRevalidate({currentUrl:new URL(o.pathname+o.search+o.hash,window.origin),currentParams:i[0]?.params||{},nextUrl:new URL(n,window.origin),nextParams:m.params,defaultShouldRevalidate:!0});if(typeof E=="boolean")return E}return!0}):[]}function j4(n,t,{includeHydrateFallback:i}={}){return D4(n.map(a=>{let o=t.routes[a.route.id];if(!o)return[];let u=[o.module];return o.clientActionModule&&(u=u.concat(o.clientActionModule)),o.clientLoaderModule&&(u=u.concat(o.clientLoaderModule)),i&&o.hydrateFallbackModule&&(u=u.concat(o.hydrateFallbackModule)),o.imports&&(u=u.concat(o.imports)),u}).flat(1))}function D4(n){return[...new Set(n)]}function N4(n){let t={},i=Object.keys(n).sort();for(let a of i)t[a]=n[a];return t}function M4(n,t){let i=new Set;return new Set(t),n.reduce((a,o)=>{let u=JSON.stringify(N4(o));return i.has(u)||(i.add(u),a.push({key:u,link:o})),a},[])}function s_(){let n=z.useContext(vo);return Ym(n,"You must render this element inside a <DataRouterContext.Provider> element"),n}function O4(){let n=z.useContext(Bh);return Ym(n,"You must render this element inside a <DataRouterStateContext.Provider> element"),n}var Qm=z.createContext(void 0);Qm.displayName="FrameworkContext";function o_(){let n=z.useContext(Qm);return Ym(n,"You must render this element inside a <HydratedRouter> element"),n}function k4(n,t){let i=z.useContext(Qm),[a,o]=z.useState(!1),[u,d]=z.useState(!1),{onFocus:p,onBlur:m,onMouseEnter:g,onMouseLeave:v,onTouchStart:E}=t,T=z.useRef(null);z.useEffect(()=>{if(n==="render"&&d(!0),n==="viewport"){let k=B=>{B.forEach(q=>{d(q.isIntersecting)})},V=new IntersectionObserver(k,{threshold:.5});return T.current&&V.observe(T.current),()=>{V.disconnect()}}},[n]),z.useEffect(()=>{if(a){let k=setTimeout(()=>{d(!0)},100);return()=>{clearTimeout(k)}}},[a]);let A=()=>{o(!0)},M=()=>{o(!1),d(!1)};return i?n!=="intent"?[u,T,{}]:[u,T,{onFocus:Ol(p,A),onBlur:Ol(m,M),onMouseEnter:Ol(g,A),onMouseLeave:Ol(v,M),onTouchStart:Ol(E,A)}]:[!1,T,{}]}function Ol(n,t){return i=>{n&&n(i),i.defaultPrevented||t(i)}}function V4({page:n,...t}){let{router:i}=s_(),a=z.useMemo(()=>W2(i.routes,n,i.basename),[i.routes,n,i.basename]);return a?z.createElement(U4,{page:n,matches:a,...t}):null}function P4(n){let{manifest:t,routeModules:i}=o_(),[a,o]=z.useState([]);return z.useEffect(()=>{let u=!1;return C4(n,t,i).then(d=>{u||o(d)}),()=>{u=!0}},[n,t,i]),a}function U4({page:n,matches:t,...i}){let a=ji(),{manifest:o,routeModules:u}=o_(),{basename:d}=s_(),{loaderData:p,matches:m}=O4(),g=z.useMemo(()=>_1(n,t,m,o,a,"data"),[n,t,m,o,a]),v=z.useMemo(()=>_1(n,t,m,o,a,"assets"),[n,t,m,o,a]),E=z.useMemo(()=>{if(n===a.pathname+a.search+a.hash)return[];let M=new Set,k=!1;if(t.forEach(B=>{let q=o.routes[B.route.id];!q||!q.hasLoader||(!g.some(Z=>Z.route.id===B.route.id)&&B.route.id in p&&u[B.route.id]?.shouldRevalidate||q.hasClientLoader?k=!0:M.add(B.route.id))}),M.size===0)return[];let V=A4(n,d,"data");return k&&M.size>0&&V.searchParams.set("_routes",t.filter(B=>M.has(B.route.id)).map(B=>B.route.id).join(",")),[V.pathname+V.search]},[d,p,a,o,g,t,n,u]),T=z.useMemo(()=>j4(v,o),[v,o]),A=P4(v);return z.createElement(z.Fragment,null,E.map(M=>z.createElement("link",{key:M,rel:"prefetch",as:"fetch",href:M,...i})),T.map(M=>z.createElement("link",{key:M,rel:"modulepreload",href:M,...i})),A.map(({key:M,link:k})=>z.createElement("link",{key:M,nonce:i.nonce,...k})))}function L4(...n){return t=>{n.forEach(i=>{typeof i=="function"?i(t):i!=null&&(i.current=t)})}}var l_=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{l_&&(window.__reactRouterVersion="7.9.1")}catch{}function z4({basename:n,children:t,window:i}){let a=z.useRef();a.current==null&&(a.current=bT({window:i,v5Compat:!0}));let o=a.current,[u,d]=z.useState({action:o.action,location:o.location}),p=z.useCallback(m=>{z.startTransition(()=>d(m))},[d]);return z.useLayoutEffect(()=>o.listen(p),[o,p]),z.createElement(g4,{basename:n,children:t,location:u.location,navigationType:u.action,navigator:o})}var u_=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,ts=z.forwardRef(function({onClick:t,discover:i="render",prefetch:a="none",relative:o,reloadDocument:u,replace:d,state:p,target:m,to:g,preventScrollReset:v,viewTransition:E,...T},A){let{basename:M}=z.useContext(si),k=typeof g=="string"&&u_.test(g),V,B=!1;if(typeof g=="string"&&k&&(V=g,l_))try{let j=new URL(window.location.href),O=g.startsWith("//")?new URL(j.protocol+g):new URL(g),U=rr(O.pathname,M);O.origin===j.origin&&U!=null?g=U+O.search+O.hash:B=!0}catch{ri(!1,`<Link to="${g}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let q=XT(g,{relative:o}),[Z,lt,K]=k4(a,T),ot=K4(g,{replace:d,state:p,target:m,preventScrollReset:v,relative:o,viewTransition:E});function I(j){t&&t(j),j.defaultPrevented||ot(j)}let C=z.createElement("a",{...T,...K,href:V||q,onClick:B||u?t:I,ref:L4(A,lt),target:m,"data-discover":!k&&i==="render"?"true":void 0});return Z&&!k?z.createElement(z.Fragment,null,C,z.createElement(V4,{page:q})):C});ts.displayName="Link";var $4=z.forwardRef(function({"aria-current":t="page",caseSensitive:i=!1,className:a="",end:o=!1,style:u,to:d,viewTransition:p,children:m,...g},v){let E=pu(d,{relative:g.relative}),T=ji(),A=z.useContext(Bh),{navigator:M,basename:k}=z.useContext(si),V=A!=null&&Q4(E)&&p===!0,B=M.encodeLocation?M.encodeLocation(E).pathname:E.pathname,q=T.pathname,Z=A&&A.navigation&&A.navigation.location?A.navigation.location.pathname:null;i||(q=q.toLowerCase(),Z=Z?Z.toLowerCase():null,B=B.toLowerCase()),Z&&k&&(Z=rr(Z,k)||Z);const lt=B!=="/"&&B.endsWith("/")?B.length-1:B.length;let K=q===B||!o&&q.startsWith(B)&&q.charAt(lt)==="/",ot=Z!=null&&(Z===B||!o&&Z.startsWith(B)&&Z.charAt(B.length)==="/"),I={isActive:K,isPending:ot,isTransitioning:V},C=K?t:void 0,j;typeof a=="function"?j=a(I):j=[a,K?"active":null,ot?"pending":null,V?"transitioning":null].filter(Boolean).join(" ");let O=typeof u=="function"?u(I):u;return z.createElement(ts,{...g,"aria-current":C,className:j,ref:v,style:O,to:d,viewTransition:p},typeof m=="function"?m(I):m)});$4.displayName="NavLink";var B4=z.forwardRef(({discover:n="render",fetcherKey:t,navigate:i,reloadDocument:a,replace:o,state:u,method:d=rh,action:p,onSubmit:m,relative:g,preventScrollReset:v,viewTransition:E,...T},A)=>{let M=G4(),k=Y4(p,{relative:g}),V=d.toLowerCase()==="get"?"get":"post",B=typeof p=="string"&&u_.test(p),q=Z=>{if(m&&m(Z),Z.defaultPrevented)return;Z.preventDefault();let lt=Z.nativeEvent.submitter,K=lt?.getAttribute("formmethod")||d;M(lt||Z.currentTarget,{fetcherKey:t,method:K,navigate:i,replace:o,state:u,relative:g,preventScrollReset:v,viewTransition:E})};return z.createElement("form",{ref:A,method:V,action:k,onSubmit:a?m:q,...T,"data-discover":!B&&n==="render"?"true":void 0})});B4.displayName="Form";function F4(n){return`${n} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function c_(n){let t=z.useContext(vo);return de(t,F4(n)),t}function K4(n,{target:t,replace:i,state:a,preventScrollReset:o,relative:u,viewTransition:d}={}){let p=Fh(),m=ji(),g=pu(n,{relative:u});return z.useCallback(v=>{if(E4(v,t)){v.preventDefault();let E=i!==void 0?i:Zl(m)===Zl(g);p(n,{replace:E,state:a,preventScrollReset:o,relative:u,viewTransition:d})}},[m,p,g,i,a,t,n,o,u,d])}var H4=0,q4=()=>`__${String(++H4)}__`;function G4(){let{router:n}=c_("useSubmit"),{basename:t}=z.useContext(si),i=c4();return z.useCallback(async(a,o={})=>{let{action:u,method:d,encType:p,formData:m,body:g}=S4(a,t);if(o.navigate===!1){let v=o.fetcherKey||q4();await n.fetch(v,i,o.action||u,{preventScrollReset:o.preventScrollReset,formData:m,body:g,formMethod:o.method||d,formEncType:o.encType||p,flushSync:o.flushSync})}else await n.navigate(o.action||u,{preventScrollReset:o.preventScrollReset,formData:m,body:g,formMethod:o.method||d,formEncType:o.encType||p,replace:o.replace,state:o.state,fromRouteId:i,flushSync:o.flushSync,viewTransition:o.viewTransition})},[n,t,i])}function Y4(n,{relative:t}={}){let{basename:i}=z.useContext(si),a=z.useContext(Hn);de(a,"useFormAction must be used inside a RouteContext");let[o]=a.matches.slice(-1),u={...pu(n||".",{relative:t})},d=ji();if(n==null){u.search=d.search;let p=new URLSearchParams(u.search),m=p.getAll("index");if(m.some(v=>v==="")){p.delete("index"),m.filter(E=>E).forEach(E=>p.append("index",E));let v=p.toString();u.search=v?`?${v}`:""}}return(!n||n===".")&&o.route.index&&(u.search=u.search?u.search.replace(/^\?/,"?index&"):"?index"),i!=="/"&&(u.pathname=u.pathname==="/"?i:nr([i,u.pathname])),Zl(u)}function Q4(n,{relative:t}={}){let i=z.useContext(e_);de(i!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:a}=c_("useViewTransitionState"),o=pu(n,{relative:t});if(!i.isTransitioning)return!1;let u=rr(i.currentLocation.pathname,a)||i.currentLocation.pathname,d=rr(i.nextLocation.pathname,a)||i.nextLocation.pathname;return Eh(o.pathname,d)!=null||Eh(o.pathname,u)!=null}var yp={exports:{}},rn={};/**
 * @license React
...
`;function P_({items:n=[],activeKey:t,mode:i,onModeChange:a,autoOnScroll:o=!1,scrollThreshold:u=8,sticky:d=!0,maxWidth:p,overlay:m=!1}){const[g,v]=z.useState(!1),[E,T]=z.useState(he.GRADIENT),A=typeof i=="string",M=A?i:E,k=z.useRef(A?i:E);z.useEffect(()=>{if(!A)return;(window.scrollY||document.documentElement.scrollTop||0)<=u&&(k.current=i)},[i,A,u]),z.useEffect(()=>{if(!o)return;const O=()=>{const U=window.scrollY||document.documentElement.scrollTop||0,$=k.current||he.GRADIENT_DARK,D=U>u?he.DARK:$;A||T(D),a&&a(D)};return O(),window.addEventListener("scroll",O,{passive:!0}),()=>window.removeEventListener("scroll",O)},[o,A,a,u]);const{baseColor:V,gradient:B,textColor:q,boxShadow:Z,showGradient:lt}=z.useMemo(()=>{switch(M){case he.LIGHT:return{baseColor:"linear-gradient(180deg, rgba(255,255,255,0.8) 60%, rgba(255,255,255,0) 100%)",gradient:"rgba(255,255,255,1)",textColor:"#000",showGradient:!0};case he.DARK:return{baseColor:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,0) 100%)",gradient:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,1) 100%)",textColor:"#fff",showGradient:!0};case he.GRADIENT_DARK:return{baseColor:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,0) 100%)",gradient:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,1) 100%)",textColor:"#fff",showGradient:!1};default:return{baseColor:"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0) 100%)",gradient:"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0) 100%)",textColor:"#000",showGradient:!1}}},[M]),I=M===he.DARK||M===he.GRADIENT_DARK||g,C=I?"/icons/logoLight.svg":"/icons/logoDark.svg",j=n.filter(O=>O.label!=="SHOWROOM");return z.useEffect(()=>(g?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[g]),y.jsxs(nA,{role:"banner",$sticky:d,$overlay:m,$baseColor:V,$gradient:B,$showGradient:lt,$textColor:q,$boxShadow:Z,children:[y.jsx(iA,{$maxWidth:p,children:y.jsxs(rA,{children:[y.jsxs(aA,{children:[y.jsx(ts,{to:"/","aria-label":"홈으로",style:{color:"inherit",textDecoration:"none"},children:y.jsx(hA,{"aria-hidden":!0,children:y.jsx(dA,{children:y.jsx("div",{style:{backgroundImage:`url(${C})`,width:"100%",height:"100%",backgroundSize:"contain",backgroundRepeat:"no-repeat"}})})})}),y.jsx(sA,{"aria-label":"주 메뉴",children:n.map(O=>y.jsx(ng,{label:O.label,href:O.href,active:O.key===t},O.key))})]}),y.jsx(oA,{"aria-label":g?"메뉴 닫기":"메뉴 열기",onClick:()=>v(O=>!O),children:y.jsx(eA,{isOpen:g,size:24,color:I?"#fff":"#000"})})]})}),y.jsx(lA,{$open:g,onClick:()=>v(!1),children:y.jsx(uA,{onClick:O=>O.stopPropagation(),children:j.map(O=>y.jsx(cA,{label:O.label,href:O.href,active:O.key===t,style:{fontSize:18,fontWeight:500,color:"#fff",textAlign:"center"},onClick:()=>v(!1)},O.key))})})]})}P_.propTypes={items:J.arrayOf(J.shape({key:J.string.isRequired,label:J.string.isRequired,href:J.string})),activeKey:J.string,mode:J.oneOf([he.GRADIENT,he.LIGHT,he.DARK,he.GRADIENT_DARK]),onModeChange:J.func,autoOnScroll:J.bool,scrollThreshold:J.number,sticky:J.bool,overlay:J.bool,maxWidth:J.oneOfType([J.string,J.number])};const ig="Pretendard, system-ui, -apple-system, Segoe UI, Roboto, 'Noto Sans KR', Arial, sans-serif",fA=S.footer`
  width: 100vw;
  background: #0E0E0E;
...
`;function MA({text:n}){return y.jsxs(CA,{children:[y.jsx(z_,{}),y.jsx(jA,{}),y.jsx(IA,{dangerouslySetInnerHTML:{__html:n}})]})}const OA=S.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  gap: 46px;
...
`,kA=S.div`
  width: 800px; height: 450px; background: url('${L_}credits/interviewThumb.png'); background-size:cover; position: relative; z-index: 30;
  cursor: not-allowed;
  @media (max-width: 640px) {
    width: 100vw;
...
`,UA=S.div`
  ...
  background-image: url('${L_}icons/play_btn.svg');
...
`;function LA({children:n}){return y.jsxs(kA,{children:[y.jsx(UA,{}),y.jsx(PA,{}),y.jsx(VA,{children:n})]})}const zA=S.div`
...
`;function KA({blocks:n}){return y.jsxs(zA,{children:[y.jsx(z_,{}),n.map(t=>y.jsxs($A,{children:[y.jsx(BA,{children:t.title}),y.jsx(FA,{dangerouslySetInnerHTML:{__html:t.body}})]},t.title))]})}const HA=S.div`
...
`;function dm({path:n="student",isActive:t=!1,onClick:i}){return y.jsxs(dR,{onClick:i,children:[y.jsx($_,{$active:t,children:"교수"}),y.jsx(pR,{$active:t,children:"학생"}),y.jsx(fR,{$active:t})]})}dm.propTypes={path:J.oneOf(["student","professor"]),isActive:J.bool,onClick:J.func};const K1=S.a`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  font-size: 24px;
  line-height: 28.8px;
  letter-spacing: 0.24px;
...
`;function q_({onCategoryChange:n,onToggleChange:t,type:i,onSortChange:a,sortLabel:o}){const u={type:i},[d,p]=bt.useState(!1),m=()=>p(K=>{const ot=!K;return t&&t(ot),ot}),[g,v]=bt.useState("전체"),[E,T]=bt.useState("All Projects"),A=["전체","산업디자인공학","미디어디자인공학"],M=["장영주","권오재","김 억","김한종","조남주","한민섭","홍성수","김태균"],k=["All Projects","AI & Robot","Edu & Kids","Health Care","IT & Tech","Living","Mobility"],V=["이름순","좋아요순","조회수순","팀작우선","개인작우선"],[B,q]=bt.useState("이름순"),Z=o||B,lt=K=>{q(K),a&&a(K)};return z.useEffect(()=>{v(d?M[0]:A[0])},[d]),u.type==="project"?y.jsxs(Ap,{children:[y.jsx(Rp,{}),y.jsx(Ip,{children:k.map(K=>y.jsx(dh,{label:K,active:E===K,onClick:()=>{T(K),n&&n(K)}},K))}),y.jsx(Cp,{children:y.jsx(Kl,{mode:"category",label:E,options:k,onSelect:K=>{T(K),n&&n(K)}})}),y.jsx(sg,{label:Z,options:V,onSelect:lt})]}):d?y.jsxs(Ap,{children:[y.jsx(Rp,{}),y.jsx(Ip,{children:M.map(K=>y.jsx(dh,{label:K,active:g===K,onClick:()=>{v(K),n&&n(K)}},K))}),y.jsx(Cp,{children:y.jsx(Kl,{mode:"category",label:g,options:M,onSelect:K=>{v(K),n&&n(K)}})}),y.jsx(dm,{path:d?"professor":"student",isActive:d,onClick:m})]}):y.jsxs(Ap,{children:[y.jsx(Rp,{}),y.jsx(Ip,{children:A.map(K=>y.jsx(dh,{label:K,active:g===K,onClick:()=>{v(K),n&&n(K)}},K))}),y.jsx(Cp,{children:y.jsx(Kl,{mode:"category",label:g,options:A,onSelect:K=>{v(K),n&&n(K)}})}),y.jsx(dm,{path:d?"professor":"student",isActive:d,onClick:m})]})}const SR=S.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  justify-content: center;
...
`,LR=S.div`position: relative;`;function zR({people:n}){const t=Fh();return y.jsx(VR,{children:n.map((i,a)=>{const o=i.id??i.studentId??`${i.nameKor}-${a}`,u=typeof i.projectNum=="number"&&i.category,d=u?i.projectNum+1:null,p=u?`${DR[i.category]||"A"}${String(d).padStart(3,"0")}`:null,m=y.jsx(rg,{nameKor:i.nameKor,nameEng:i.nameEng,role:i.role,sns:i.sns||"-",eMail:i.eMail,imgSrc:G_(i.imgUrl),imgAlt:`${i.nameKor} profile`},o);return u?y.jsx(UR,{role:"link",tabIndex:0,onClick:()=>t(`/work/${p}`),onKeyDown:g=>{(g.key==="Enter"||g.key===" ")&&t(`/work/${p}`)},"aria-label":`${i.nameKor} 작품 보기 (${p})`,children:m},`link-${o}`):m})})}function $R(){const[n,t]=bt.useState(!1),[i,a]=bt.useState(Q1[0]),o=bt.useMemo(()=>{const p=new Map;return(eu||[]).forEach(m=>{(m.members||[]).forEach(g=>{p.has(g)||p.set(g,m)})}),p},[]);bt.useEffect(()=>{a(n?kl[0]?.id||"":Q1[0])},[n]);const u=bt.useMemo(()=>{if(!n){if(i==="전체")return jp;let m=NR[i];return m===void 0&&(m=X1(i)),jp.filter(g=>X1(g.department)===m)}const p=kl.some(m=>m.id===i)?i:kl.find(m=>m.nameKor===i)?.id||"";return jp.filter(m=>m.professorId===p).map(m=>{let g=o.get(m.num);g||(g=(eu||[]).find(E=>E.category===m.category&&E.projectNum===m.projectNum)||null);const v=g?`/projects/${g.projectNum}/thumb.jpg`:"/thumbnailExample.png";return{...m,imgUrl:v}})},[i,n,o]),d=bt.useMemo(()=>n&&(kl.find(m=>m.id===i)||kl.find(m=>m.nameKor===i))||null,[n,i]);return y.jsxs(LR,{children:[y.jsx(PR,{children:"Peoples"}),y.jsx(q_,{type:"people",onCategoryChange:a,onToggleChange:t}),y.jsxs(kR,{children:[n&&d&&y.jsx(og,{nameKor:d.nameKor,rank:d.rank||"교수",eMail:d.email,education:d.education,field:d.field,imgSrc:G_(d.imgUrl),imgAlt:`${d.nameKor} profile`}),y.jsx(zR,{people:u})]})]})}const W1=S.div`
  @media (max-width: 393px) {
 ...
 */const Y_=function(n){const t=[];let i=0;for(let a=0;a<n.length;a++){let o=n.charCodeAt(a);o<128?t[i++]=o:o<2048?(t[i++]=o>>6|192,t[i++]=o&63|128):(o&64512)===55296&&a+1<n.length&&(n.charCodeAt(a+1)&64512)===56320?(o=65536+((o&1023)<<10)+(n.charCodeAt(++a)&1023),t[i++]=o>>18|240,t[i++]=o>>12&63|128,t[i++]=o>>6&63|128,t[i++]=o&63|128):(t[i++]=o>>12|224,t[i++]=o>>6&63|128,t[i++]=o&63|128)}return t},n6=function(n){const t=[];let i=0,a=0;for(;i<n.length;){const o=n[i++];if(o<128)t[a++]=String.fromCharCode(o);else if(o>191&&o<224){const u=n[i++];t[a++]=String.fromCharCode((o&31)<<6|u&63)}else if(o>239&&o<365){const u=n[i++],d=n[i++],p=n[i++],m=((o&7)<<18|(u&63)<<12|(d&63)<<6|p&63)-65536;t[a++]=String.fromCharCode(55296+(m>>10)),t[a++]=String.fromCharCode(56320+(m&1023))}else{const u=n[i++],d=n[i++];t[a++]=String.fromCharCode((o&15)<<12|(u&63)<<6|d&63)}}return t.join("")},Q_={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,t){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const i=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,a=[];for(let o=0;o<n.length;o+=3){const u=n[o],d=o+1<n.length,p=d?n[o+1]:0,m=o+2<n.length,g=m?n[o+2]:0,v=u>>2,E=(u&3)<<4|p>>4;let T=(p&15)<<2|g>>6,A=g&63;m||(A=64,d||(T=64)),a.push(i[v],i[E],i[T],i[A])}return a.join("")},encodeString(n,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(n):this.encodeByteArray(Y_(n),t)},decodeString(n,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(n):n6(this.decodeStringToByteArray(n,t))},decodeStringToByteArray(n,t){this.init_();const i=t?this.charToByteMapWebSafe_:this.charToByteMap_,a=[];for(let o=0;o<n.length;){const u=i[n.charAt(o++)],p=o<n.length?i[n.charAt(o)]:0;++o;const g=o<n.length?i[n.charAt(o)]:64;++o;const E=o<n.length?i[n.charAt(o)]:64;if(++o,u==null||p==null||g==null||E==null)throw new i6;const T=u<<2|p>>4;if(a.push(T),g!==64){const A=p<<4&240|g>>2;if(a.push(A),E!==64){const M=g<<6&192|E;a.push(M)}}}return a},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class i6 extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const r6=function(n){const t=Y_(n);return Q_.encodeByteArray(t,!0)},Rh=function(n){return r6(n).replace(/\./g,"")},a6=function(n){try{return Q_.decodeString(n,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b6="FirebaseError";class Eo extends Error{constructor(t,i,a){super(i),this.code=t,this.customData=a,this.name=b6,Object.setPrototypeOf(this,Eo.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,W_.prototype.create)}}class W_{constructor(t,i,a){this.service=t,this.serviceName=i,this.errors=a}create(t,...i){const a=i[0]||{},o=`${this.service}/${t}`,u=this.errors[t],d=u?T6(u,a):"Error",p=`${this.serviceName}: ${d} (${o}).`;return new Eo(o,p,a)}}function T6(n,t){return n.replace(S6,(i,a)=>{const o=t[a];return o!=null?String(o):`<${a}?>`})}const S6=/\{\$([^}]+)}/g;function Ih(n,t){if(n===t)return!0;const i=Object.keys(n),a=Object.keys(t);for(const o of i){if(!a.includes(o))return!1;const u=n[o],d=t[o];if(av(u)&&av(d)){if(!Ih(u,d))return!1}else if(u!==d)return!1}for(const o of a)if(!i.includes(o))return!1;return!0}function av(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Bt;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(Bt||(Bt={}));const j6={debug:Bt.DEBUG,verbose:Bt.VERBOSE,info:Bt.INFO,warn:Bt.WARN,error:Bt.ERROR,silent:Bt.SILENT},D6=Bt.INFO,N6={[Bt.DEBUG]:"log",[Bt.VERBOSE]:"log",[Bt.INFO]:"info",[Bt.WARN]:"warn",[Bt.ERROR]:"error"},M6=(n,t,...i)=>{if(t<n.logLevel)return;const a=new Date().toISOString(),o=N6[t];if(o)console[o](`[${a}]  ${n.name}:`,...i);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class Z_{constructor(t){this.name=t,this._logLevel=D6,this._logHandler=M6,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in Bt))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?j6[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,Bt.DEBUG,...t),this._logHandler(this,Bt.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,Bt.VERBOSE,...t),this._logHandler(this,Bt.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,Bt.INFO,...t),this._logHandler(this,Bt.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,Bt.WARN,...t),this._logHandler(this,Bt.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,Bt.ERROR,...t),this._logHandler(this,Bt.ERROR,...t)}}const O6=(n,t)=>t.some(i=>n instanceof i);let sv,ov;function k6(){return sv||(sv=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function V6(){return ov||(ov=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const J_=new WeakMap,fm=new WeakMap,tw=new WeakMap,Dp=new WeakMap,dg=new WeakMap;function P6(n){const t=new Promise((i,a)=>{const o=()=>{n.removeEventListener("success",u),n.removeEventListener("error",d)},u=()=>{i(Xr(n.result)),o()},d=()=>{a(n.error),o()};n.addEventListener("success",u),n.addEventListener("error",d)});return t.then(i=>{i instanceof IDBCursor&&J_.set(i,n)}).catch(()=>{}),dg.set(t,n),t}function U6(n){if(fm.has(n))return;const t=new Promise((i,a)=>{const o=()=>{n.removeEventListener("complete",u),n.removeEventListener("error",d),n.removeEventListener("abort",d)},u=()=>{i(),o()},d=()=>{a(n.error||new DOMException("AbortError","AbortError")),o()};n.addEventListener("complete",u),n.addEventListener("error",d),n.addEventListener("abort",d)});fm.set(n,t)}let pm={get(n,t,i){if(n instanceof IDBTransaction){if(t==="done")return fm.get(n);if(t==="objectStoreNames")return n.objectStoreNames||tw.get(n);if(t==="store")return i.objectStoreNames[1]?void 0:i.objectStore(i.objectStoreNames[0])}return Xr(n[t])},set(n,t,i){return n[t]=i,!0},has(n,t){return n instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in n}};function L6(n){pm=n(pm)}function z6(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...i){const a=n.call(Np(this),t,...i);return tw.set(a,t.sort?t.sort():[t]),Xr(a)}:V6().includes(n)?function(...t){return n.apply(Np(this),t),Xr(J_.get(this))}:function(...t){return Xr(n.apply(Np(this),t))}}function $6(n){return typeof n=="function"?z6(n):(n instanceof IDBTransaction&&U6(n),O6(n,k6())?new Proxy(n,pm):n)}function Xr(n){if(n instanceof IDBRequest)return P6(n);if(Dp.has(n))return Dp.get(n);const t=$6(n);return t!==n&&(Dp.set(n,t),dg.set(t,n)),t}const Np=n=>dg.get(n);function B6(n,t,{blocked:i,upgrade:a,blocking:o,terminated:u}={}){const d=indexedDB.open(n,t),p=Xr(d);return a&&d.addEventListener("upgradeneeded",m=>{a(Xr(d.result),m.oldVersion,m.newVersion,Xr(d.transaction),m)}),i&&d.addEventListener("blocked",m=>i(m.oldVersion,m.newVersion,m)),p.then(m=>{u&&m.addEventListener("close",()=>u()),o&&m.addEventListener("versionchange",g=>o(g.oldVersion,g.newVersion,g))}).catch(()=>{}),p}const F6=["get","getKey","getAll","getAllKeys","count"],K6=["put","add","delete","clear"],Mp=new Map;function lv(n,t){if(!(n instanceof IDBDatabase&&!(t in n)&&typeof t=="string"))return;if(Mp.get(t))return Mp.get(t);const i=t.replace(/FromIndex$/,""),a=t!==i,o=K6.includes(i);if(!(i in(a?IDBIndex:IDBObjectStore).prototype)||!(o||F6.includes(i)))return;const u=async function(d,...p){const m=this.transaction(d,o?"readwrite":"readonly");let g=m.store;return a&&(g=g.index(p.shift())),(await Promise.all([g[i](...p),o&&m.done]))[0]};return Mp.set(t,u),u}L6(n=>({...n,get:(t,i,a)=>lv(t,i)||n.get(t,i,a),has:(t,i)=>!!lv(t,i)||n.has(t,i)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H6{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(i=>{if(q6(i)){const a=i.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(i=>i).join(" ")}}function q6(n){return n.getComponent()?.type==="VERSION"}const mm="@firebase/app",uv="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sr=new Z_("@firebase/app"),G6="@firebase/app-compat",Y6="@firebase/analytics-compat",Q6="@firebase/analytics",X6="@firebase/app-check-compat",W6="@firebase/app-check",Z6="@firebase/auth",J6="@firebase/auth-compat",tI="@firebase/database",eI="@firebase/data-connect",nI="@firebase/database-compat",iI="@firebase/functions",rI="@firebase/functions-compat",aI="@firebase/installations",sI="@firebase/installations-compat",oI="@firebase/messaging",lI="@firebase/messaging-compat",uI="@firebase/performance",cI="@firebase/performance-compat",hI="@firebase/remote-config",dI="@firebase/remote-config-compat",fI="@firebase/storage",pI="@firebase/storage-compat",mI="@firebase/firestore",gI="@firebase/ai",yI="@firebase/firestore-compat",xI="firebase",vI="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AI=vI;function fg(n,t={}){let i=n;typeof t!="object"&&(t={name:t});const a={name:gm,automaticDataCollectionEnabled:!0,...t},o=a.name;if(typeof o!="string"||!o)throw Wr.create("bad-app-name",{appName:String(o)});if(i||(i=X_()),!i)throw Wr.create("no-options");const u=iu.get(o);if(u){if(Ih(i,u.options)&&Ih(a,u.config))return u;throw Wr.create("duplicate-app",{appName:o})}const d=new C6(o);for(const m of ym.values())d.addComponent(m);const p=new SI(i,a,d);return iu.set(o,p),p}function RI(n=gm){const t=iu.get(n);if(!t&&n===gm&&X_())return fg();if(!t)throw Wr.create("no-app",{appName:n});return t}function hv(){return Array.from(iu.values())}function eo(n,t,i){let a=_I[n]??n;i&&(a+=`-${i}`);const o=a.match(/\s|\//),u=t.match(/\s|\//);if(o||u){const d=[`Unable to register library "${a}" with version "${t}":`];o&&d.push(`library name "${a}" contains illegal characters (whitespace or "/")`),o&&u&&d.push("and"),u&&d.push(`version name "${t}" contains illegal characters (whitespace or "/")`),sr.warn(d.join(" "));return}Ch(new nu(`${a}-version`,()=>({library:a,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const II="firebase-heartbeat-database",CI=1,ru="firebase-heartbeat-store";let Op=null;function ew(){return Op||(Op=B6(II,CI,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(ru)}catch(i){console.warn(i)}}}}).catch(n=>{throw Wr.create("idb-open",{originalErrorMessage:n.message})})),Op}async function jI(n){try{const i=(await ew()).transaction(ru),a=await i.objectStore(ru).get(nw(n));return await i.done,a}catch(t){if(t instanceof Eo)sr.warn(t.message);else{const i=Wr.create("idb-get",{originalErrorMessage:t?.message});sr.warn(i.message)}}}async function dv(n,t){try{const a=(await ew()).transaction(ru,"readwrite");await a.objectStore(ru).put(t,nw(n)),await a.done}catch(i){if(i instanceof Eo)sr.warn(i.message);else{const a=Wr.create("idb-set",{originalErrorMessage:i?.message});sr.warn(a.message)}}}function nw(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PI(n){Ch(new nu("platform-logger",t=>new H6(t),"PRIVATE")),Ch(new nu("heartbeat",t=>new MI(t),"PRIVATE")),eo(mm,uv,n),eo(mm,uv,"esm2020"),eo("fire-js","")}PI("");var UI="firebase",LI="12.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gg=-1;function Jh(n){return n==null}function jh(n){return n===0&&1/n==-1/0}function i3(n){return typeof n=="number"&&Number.isInteger(n)&&!jh(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fw="";function r3(n){let t="";for(let i=0;i<n.length;i++)t.length>0&&(t=Tv(t)),t=a3(n.get(i),t);return Tv(t)}function a3(n,t){let i=t;const a=n.length;for(let o=0;o<a;o++){const u=n.charAt(o);switch(u){case"\0":i+="";break;case fw:i+="";break;default:i+=u}}return i}function Tv(n){return n+fw+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sv(n){let t=0;for(const i in n)Object.prototype.hasOwnProperty.call(n,i)&&t++;return t}function sa(n,t){for(const i in n)Object.prototype.hasOwnProperty.call(n,i)&&t(i,n[i])}function pw(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gw="server_timestamp",yw="__type__",xw="__previous_value__",vw="__local_write_time__";function yg(n){return(n?.mapValue?.fields||{})[yw]?.stringValue===gw}function td(n){const t=n.mapValue.fields[xw];return yg(t)?td(t):t}function su(n){const t=ea(n.mapValue.fields[vw].timestampValue);return new ue(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uu{constructor(t,i="asc"){this.field=t,this.dir=i}}function h3(n,t){return n.dir===t.dir&&n.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bw{}class De extends bw{constructor(t,i,a){super(),this.field=t,this.op=i,this.value=a}static create(t,i,a){return t.isKeyField()?i==="in"||i==="not-in"?this.createKeyFieldInFilter(t,i,a):new f3(t,i,a):i==="array-contains"?new g3(t,a):i==="in"?new y3(t,a):i==="not-in"?new x3(t,a):i==="array-contains-any"?new v3(t,a):new De(t,i,a)}static createKeyFieldInFilter(t,i,a){return i==="in"?new p3(t,a):new m3(t,a)}matches(t){const i=t.data.field(this.field);return this.op==="!="?i!==null&&i.nullValue===void 0&&this.matchesComparison(fo(i,this.value)):i!==null&&ia(this.value)===ia(i)&&this.matchesComparison(fo(i,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return Tt(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class ai extends bw{constructor(t,i){super(),this.filters=t,this.op=i,this.Pe=null}static create(t,i){return new ai(t,i)}matches(t){return Tw(this)?this.filters.find((i=>!i.matches(t)))===void 0:this.filters.find((i=>i.matches(t)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((t,i)=>t.concat(i.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function Tw(n){return n.op==="and"}function Sw(n){return d3(n)&&Tw(n)}function d3(n){for(const t of n.filters)if(t instanceof ai)return!1;return!0}function Em(n){if(n instanceof De)return n.field.canonicalString()+n.op.toString()+po(n.value);if(Sw(n))return n.filters.map((t=>Em(t))).join(",");{const t=n.filters.map((i=>Em(i))).join(",");return`${n.op}(${t})`}}function Aw(n,t){return n instanceof De?(function(a,o){return o instanceof De&&a.op===o.op&&a.field.isEqual(o.field)&&Ci(a.value,o.value)})(n,t):n instanceof ai?(function(a,o){return o instanceof ai&&a.op===o.op&&a.filters.length===o.filters.length?a.filters.reduce(((u,d,p)=>u&&Aw(d,o.filters[p])),!0):!1})(n,t):void Tt(19439)}function Rw(n){return n instanceof De?(function(i){return`${i.field.canonicalString()} ${i.op} ${po(i.value)}`})(n):n instanceof ai?(function(i){return i.op.toString()+" {"+i.getFilters().map(Rw).join(" ,")+"}"})(n):"Filter"}class f3 extends De{constructor(t,i,a){super(t,i,a),this.key=vt.fromName(a.referenceValue)}matches(t){const i=vt.comparator(t.key,this.key);return this.matchesComparison(i)}}class p3 extends De{constructor(t,i){super(t,"in",i),this.keys=Iw("in",i)}matches(t){return this.keys.some((i=>i.isEqual(t.key)))}}class m3 extends De{constructor(t,i){super(t,"not-in",i),this.keys=Iw("not-in",i)}matches(t){return!this.keys.some((i=>i.isEqual(t.key)))}}function Iw(n,t){return(t.arrayValue?.values||[]).map((i=>vt.fromName(i.referenceValue)))}class g3 extends De{constructor(t,i){super(t,"array-contains",i)}matches(t){const i=t.data.field(this.field);return xg(i)&&lu(i.arrayValue,this.value)}}class y3 extends De{constructor(t,i){super(t,"in",i)}matches(t){const i=t.data.field(this.field);return i!==null&&lu(this.value.arrayValue,i)}}class x3 extends De{constructor(t,i){super(t,"not-in",i)}matches(t){if(lu(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const i=t.data.field(this.field);return i!==null&&i.nullValue===void 0&&!lu(this.value.arrayValue,i)}}class v3 extends De{constructor(t,i){super(t,"array-contains-any",i)}matches(t){const i=t.data.field(this.field);return!(!xg(i)||!i.arrayValue.values)&&i.arrayValue.values.some((a=>lu(this.value.arrayValue,a)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(t,i){this.mapKeyFn=t,this.equalsFn=i,this.inner={},this.innerSize=0}get(t){const i=this.mapKeyFn(t),a=this.inner[i];if(a!==void 0){for(const[o,u]of a)if(this.equalsFn(o,t))return u}}has(t){return this.get(t)!==void 0}set(t,i){const a=this.mapKeyFn(t),o=this.inner[a];if(o===void 0)return this.inner[a]=[[t,i]],void this.innerSize++;for(let u=0;u<o.length;u++)if(this.equalsFn(o[u][0],t))return void(o[u]=[t,i]);o.push([t,i]),this.innerSize++}delete(t){const i=this.mapKeyFn(t),a=this.inner[i];if(a===void 0)return!1;for(let o=0;o<a.length;o++)if(this.equalsFn(a[o][0],t))return a.length===1?delete this.inner[i]:a.splice(o,1),this.innerSize--,!0;return!1}forEach(t){sa(this.inner,((i,a)=>{for(const[o,u]of a)t(o,u)}))}isEmpty(){return pw(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S3=new me(vt.comparator);function ur(){return S3}const Nw=new me(vt.comparator);function zl(...n){let t=Nw;for(const i of n)t=t.insert(i.key,i);return t}function Mw(n){let t=Nw;return n.forEach(((i,a)=>t=t.insert(i,a.overlayedDocument))),t}function Ga(){return Yl()}function Ow(){return Yl()}function Yl(){return new es((n=>n.toString()),((n,t)=>n.isEqual(t)))}const A3=new me(vt.comparator),R3=new Le(vt.comparator);function Ut(...n){let t=R3;for(const i of n)t=t.add(i);return t}const I3=new Le(Pt);function C3(){return I3}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eg(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:jh(t)?"-0":t}}function kw(n){return{integerValue:""+n}}function Vw(n,t){return i3(t)?kw(t):Eg(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class id{constructor(){this._=void 0}}function j3(n,t,i){return n instanceof Oh?(function(o,u){const d={fields:{[yw]:{stringValue:gw},[vw]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return u&&yg(u)&&(u=td(u)),u&&(d.fields[xw]=u),{mapValue:d}})(i,t):n instanceof cu?Uw(n,t):n instanceof hu?Lw(n,t):(function(o,u){const d=Pw(o,u),p=Vv(d)+Vv(o.Ae);return wm(d)&&wm(o.Ae)?kw(p):Eg(o.serializer,p)})(n,t)}function D3(n,t,i){return n instanceof cu?Uw(n,t):n instanceof hu?Lw(n,t):i}function Pw(n,t){return n instanceof du?(function(a){return wm(a)||(function(u){return!!u&&"doubleValue"in u})(a)})(t)?t:{integerValue:0}:null}class Oh extends id{}class cu extends id{constructor(t){super(),this.elements=t}}function Uw(n,t){const i=zw(t);for(const a of n.elements)i.some((o=>Ci(o,a)))||i.push(a);return{arrayValue:{values:i}}}class hu extends id{constructor(t){super(),this.elements=t}}function Lw(n,t){let i=zw(t);for(const a of n.elements)i=i.filter((o=>!Ci(o,a)));return{arrayValue:{values:i}}}class du extends id{constructor(t,i){super(),this.serializer=t,this.Ae=i}}function Vv(n){return Se(n.integerValue||n.doubleValue)}function zw(n){return xg(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lC{constructor(t){this.yt=t}}function uC(n){const t=nC({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Sm(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */xn.DEFAULT_COLLECTION_PERCENTILE=10,xn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,xn.DEFAULT=new xn(tE,xn.DEFAULT_COLLECTION_PERCENTILE,xn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),xn.DISABLED=new xn(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sd(n){return new Y3(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Za="RemoteStore";class XC{constructor(t,i,a,o,u){this.localStore=t,this.datastore=i,this.asyncQueue=a,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=u,this.Aa.Oo((d=>{a.enqueueAndForget((async()=>{ns(this)&&(pt(Za,"Restarting streams for network reachability change."),await(async function(m){const g=It(m);g.Ea.add(4),await vu(g),g.Ra.set("Unknown"),g.Ea.delete(4),await od(g)})(this))}))})),this.Ra=new QC(a,o)}}async function od(n){if(ns(n))for(const t of n.da)await t(!0)}async function vu(n){for(const t of n.da)await t(!1)}function sE(n,t){const i=It(n);i.Ia.has(t.targetId)||(i.Ia.set(t.targetId,t),Mg(i)?Ng(i):Ro(i).O_()&&Dg(i,t))}function jg(n,t){const i=It(n),a=Ro(i);i.Ia.delete(t),a.O_()&&oE(i,t),i.Ia.size===0&&(a.O_()?a.L_():ns(i)&&i.Ra.set("Unknown"))}function Dg(n,t){if(n.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(At.min())>0){const i=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(i)}Ro(n).Y_(t)}function oE(n,t){n.Va.Ue(t),Ro(n).Z_(t)}function Ng(n){n.Va=new K3({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),At:t=>n.Ia.get(t)||null,ht:()=>n.datastore.serializer.databaseId}),Ro(n).start(),n.Ra.ua()}function Mg(n){return ns(n)&&!Ro(n).x_()&&n.Ia.size>0}function ns(n){return It(n).Ea.size===0}function lE(n){n.Va=void 0}async function WC(n){n.Ra.set("Online")}async function ZC(n){n.Ia.forEach(((t,i)=>{Dg(n,t)}))}async function JC(n,t){lE(n),Mg(n)?(n.Ra.ha(t),Ng(n)):n.Ra.set("Unknown")}async function tj(n,t,i){if(n.Ra.set("Online"),t instanceof qw&&t.state===2&&t.cause)try{await(async function(o,u){const d=u.cause;for(const p of u.targetIds)o.Ia.has(p)&&(await o.remoteSyncer.rejectListen(p,d),o.Ia.delete(p),o.Va.removeTarget(p))})(n,t)}catch(a){pt(Za,"Failed to remove targets %s: %s ",t.targetIds.join(","),a),await Ph(n,a)}else if(t instanceof yh?n.Va.Ze(t):t instanceof Hw?n.Va.st(t):n.Va.tt(t),!i.isEqual(At.min()))try{const a=await iE(n.localStore);i.compareTo(a)>=0&&await(function(u,d){const p=u.Va.Tt(d);return p.targetChanges.forEach(((m,g)=>{if(m.resumeToken.approximateByteSize()>0){const v=u.Ia.get(g);v&&u.Ia.set(g,v.withResumeToken(m.resumeToken,d))}})),p.targetMismatches.forEach(((m,g)=>{const v=u.Ia.get(m);if(!v)return;u.Ia.set(m,v.withResumeToken(Je.EMPTY_BYTE_STRING,v.snapshotVersion)),oE(u,m);const E=new Qr(v.target,m,g,v.sequenceNumber);Dg(u,E)})),u.remoteSyncer.applyRemoteEvent(p)})(n,i)}catch(a){pt(Za,"Failed to raise snapshot:",a),await Ph(n,a)}}async function Ph(n,t,i){if(!So(t))throw t;n.Ea.add(1),await vu(n),n.Ra.set("Offline"),i||(i=()=>iE(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{pt(Za,"Retrying IndexedDB access"),await i(),n.Ea.delete(1),await od(n)}))}function uE(n,t){return t().catch((i=>Ph(n,i,t)))}async function ld(n){const t=It(n),i=ra(t);let a=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:gg;for(;ej(t);)try{const o=await VC(t.localStore,a);if(o===null){t.Ta.length===0&&i.L_();break}a=o.batchId,nj(t,o)}catch(o){await Ph(t,o)}cE(t)&&hE(t)}function ej(n){return ns(n)&&n.Ta.length<10}function nj(n,t){n.Ta.push(t);const i=ra(n);i.O_()&&i.X_&&i.ea(t.mutations)}function cE(n){return ns(n)&&!ra(n).x_()&&n.Ta.length>0}function hE(n){ra(n).start()}async function ij(n){ra(n).ra()}async function rj(n){const t=ra(n);for(const i of n.Ta)t.ea(i.mutations)}async function aj(n,t,i){const a=n.Ta.shift(),o=bg.from(a,t,i);await uE(n,(()=>n.remoteSyncer.applySuccessfulWrite(o))),await ld(n)}async function sj(n,t){t&&ra(n).X_&&await(async function(a,o){if((function(d){return $3(d)&&d!==it.ABORTED})(o.code)){const u=a.Ta.shift();ra(a).B_(),await uE(a,(()=>a.remoteSyncer.rejectFailedWrite(u.batchId,o))),await ld(a)}})(n,t),cE(n)&&hE(n)}async function Jv(n,t){const i=It(n);i.asyncQueue.verifyOperationInProgress(),pt(Za,"RemoteStore received new credentials");const a=ns(i);i.Ea.add(3),await vu(i),a&&i.Ra.set("Unknown"),await i.remoteSyncer.handleCredentialChange(t),i.Ea.delete(3),await od(i)}async function oj(n,t){const i=It(n);t?(i.Ea.delete(2),await od(i)):t||(i.Ea.add(2),await vu(i),i.Ra.set("Unknown"))}function Ro(n){return n.ma||(n.ma=(function(i,a,o){const u=It(i);return u.sa(),new HC(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:WC.bind(null,n),t_:ZC.bind(null,n),r_:JC.bind(null,n),H_:tj.bind(null,n)}),n.da.push((async t=>{t?(n.ma.B_(),Mg(n)?Ng(n):n.Ra.set("Unknown")):(await n.ma.stop(),lE(n))}))),n.ma}function ra(n){return n.fa||(n.fa=(function(i,a,o){const u=It(i);return u.sa(),new qC(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:ij.bind(null,n),r_:sj.bind(null,n),ta:rj.bind(null,n),na:aj.bind(null,n)}),n.da.push((async t=>{t?(n.fa.B_(),await ld(n)):(await n.fa.stop(),n.Ta.length>0&&(pt(Za,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mE{constructor(t){this.key=t}}class gE{constructor(t){this.key=t}}class dj{constructor(t,i){this.query=t,this.Ya=i,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=Ut(),this.mutatedKeys=Ut(),this.eu=Dw(t),this.tu=new no(this.eu)}get nu(){return this.Ya}ru(t,i){const a=i?i.iu:new t2,o=i?i.tu:this.tu;let u=i?i.mutatedKeys:this.mutatedKeys,d=o,p=!1;const m=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,g=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(t.inorderTraversal(((v,E)=>{const T=o.get(v),A=nd(this.query,E)?E:null,M=!!T&&this.mutatedKeys.has(T.key),k=!!A&&(A.hasLocalMutations||this.mutatedKeys.has(A.key)&&A.hasCommittedMutations);let V=!1;T&&A?T.data.isEqual(A.data)?M!==k&&(a.track({type:3,doc:A}),V=!0):this.su(T,A)||(a.track({type:2,doc:A}),V=!0,(m&&this.eu(A,m)>0||g&&this.eu(A,g)<0)&&(p=!0)):!T&&A?(a.track({type:0,doc:A}),V=!0):T&&!A&&(a.track({type:1,doc:T}),V=!0,(m||g)&&(p=!0)),V&&(A?(d=d.add(A),u=k?u.add(v):u.delete(v)):(d=d.delete(v),u=u.delete(v)))})),this.query.limit!==null)for(;d.size>this.query.limit;){const v=this.query.limitType==="F"?d.last():d.first();d=d.delete(v.key),u=u.delete(v.key),a.track({type:1,doc:v})}return{tu:d,iu:a,Cs:p,mutatedKeys:u}}su(t,i){return t.hasLocalMutations&&i.hasCommittedMutations&&!i.hasLocalMutations}applyChanges(t,i,a,o){const u=this.tu;this.tu=t.tu,this.mutatedKeys=t.mutatedKeys;const d=t.iu.ya();d.sort(((v,E)=>(function(A,M){const k=V=>{switch(V){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return Tt(20277,{Rt:V})}};return k(A)-k(M)})(v.type,E.type)||this.eu(v.doc,E.doc))),this.ou(a),o=o??!1;const p=i&&!o?this._u():[],m=this.Xa.size===0&&this.current&&!o?1:0,g=m!==this.Za;return this.Za=m,d.length!==0||g?{snapshot:new go(this.query,t.tu,u,d,t.mutatedKeys,m===0,g,!1,!!a&&a.resumeToken.approximateByteSize()>0),au:p}:{au:p}}va(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new t2,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(t){return!this.Ya.has(t)&&!!this.tu.has(t)&&!this.tu.get(t).hasLocalMutations}ou(t){t&&(t.addedDocuments.forEach((i=>this.Ya=this.Ya.add(i))),t.modifiedDocuments.forEach((i=>{})),t.removedDocuments.forEach((i=>this.Ya=this.Ya.delete(i))),this.current=t.current)}_u(){if(!this.current)return[];const t=this.Xa;this.Xa=Ut(),this.tu.forEach((a=>{this.uu(a.key)&&(this.Xa=this.Xa.add(a.key))}));const i=[];return t.forEach((a=>{this.Xa.has(a)||i.push(new gE(a))})),this.Xa.forEach((a=>{t.has(a)||i.push(new mE(a))})),i}cu(t){this.Ya=t.Qs,this.Xa=Ut();const i=this.ru(t.documents);return this.applyChanges(i,!0)}lu(){return go.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const Pg="SyncEngine";class fj{constructor(t,i,a){this.query=t,this.targetId=i,this.view=a}}class pj{constructor(t){this.key=t,this.hu=!1}}class mj{constructor(t,i,a,o,u,d){this.localStore=t,this.remoteStore=i,this.eventManager=a,this.sharedClientState=o,this.currentUser=u,this.maxConcurrentLimboResolutions=d,this.Pu={},this.Tu=new es((p=>jw(p)),ed),this.Iu=new Map,this.Eu=new Set,this.du=new me(vt.comparator),this.Au=new Map,this.Ru=new Ag,this.Vu={},this.mu=new Map,this.fu=mo.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function gj(n,t,i=!0){const a=EE(n);let o;const u=a.Tu.get(t);return u?(a.sharedClientState.addLocalQueryTarget(u.targetId),o=u.view.lu()):o=await yE(a,t,i,!0),o}async function yj(n,t){const i=EE(n);await yE(i,t,!0,!1)}async function yE(n,t,i,a){const o=await PC(n.localStore,Ti(t)),u=o.targetId,d=n.sharedClientState.addLocalQueryTarget(u,i);let p;return a&&(p=await xj(n,t,u,d==="current",o.resumeToken)),n.isPrimaryClient&&i&&sE(n.remoteStore,o),p}async function xj(n,t,i,a,o){n.pu=(E,T,A)=>(async function(k,V,B,q){let Z=V.view.ru(B);Z.Cs&&(Z=await Yv(k.localStore,V.query,!1).then((({documents:I})=>V.view.ru(I,Z))));const lt=q&&q.targetChanges.get(V.targetId),K=q&&q.targetMismatches.get(V.targetId)!=null,ot=V.view.applyChanges(Z,k.isPrimaryClient,lt,K);return r2(k,V.targetId,ot.au),ot.snapshot})(n,E,T,A);const u=await Yv(n.localStore,t,!0),d=new dj(t,u.Qs),p=d.ru(u.documents),m=xu.createSynthesizedTargetChangeForCurrentChange(i,a&&n.onlineState!=="Offline",o),g=d.applyChanges(p,n.isPrimaryClient,m);r2(n,i,g.au);const v=new fj(t,i,d);return n.Tu.set(t,v),n.Iu.has(i)?n.Iu.get(i).push(t):n.Iu.set(i,[t]),g.snapshot}async function vj(n,t,i){const a=It(n),o=a.Tu.get(t),u=a.Iu.get(o.targetId);if(u.length>1)return a.Iu.set(o.targetId,u.filter((d=>!ed(d,t)))),void a.Tu.delete(t);a.isPrimaryClient?(a.sharedClientState.removeLocalQueryTarget(o.targetId),a.sharedClientState.isActiveQueryTarget(o.targetId)||await jm(a.localStore,o.targetId,!1).then((()=>{a.sharedClientState.clearQueryState(o.targetId),i&&jg(a.remoteStore,o.targetId),Mm(a,o.targetId)})).catch(To)):(Mm(a,o.targetId),await jm(a.localStore,o.targetId,!0))}async function _j(n,t){const i=It(n),a=i.Tu.get(t),o=i.Iu.get(a.targetId);i.isPrimaryClient&&o.length===1&&(i.sharedClientState.removeLocalQueryTarget(a.targetId),jg(i.remoteStore,a.targetId))}async function wj(n,t,i){const a=Ij(n);try{const o=await(function(d,p){const m=It(d),g=ue.now(),v=p.reduce(((A,M)=>A.add(M.key)),Ut());let E,T;return m.persistence.runTransaction("Locally write mutations","readwrite",(A=>{let M=ur(),k=Ut();return m.Ns.getEntries(A,v).next((V=>{M=V,M.forEach(((B,q)=>{q.isValidDocument()||(k=k.add(B))}))})).next((()=>m.localDocuments.getOverlayedDocuments(A,M))).next((V=>{E=V;const B=[];for(const q of p){const Z=V3(q,E.get(q.key).overlayedDocument);Z!=null&&B.push(new oa(q.key,Z,Ew(Z.value.mapValue),Si.exists(!0)))}return m.mutationQueue.addMutationBatch(A,g,B,p)})).next((V=>{T=V;const B=V.applyToLocalDocumentSet(E,k);return m.documentOverlayCache.saveOverlays(A,V.batchId,B)}))})).then((()=>({batchId:T.batchId,changes:Mw(E)})))})(a.localStore,t);a.sharedClientState.addPendingMutation(o.batchId),(function(d,p,m){let g=d.Vu[d.currentUser.toKey()];g||(g=new me(Pt)),g=g.insert(p,m),d.Vu[d.currentUser.toKey()]=g})(a,o.batchId,i),await _u(a,o.changes),await ld(a.remoteStore)}catch(o){const u=kg(o,"Failed to persist write");i.reject(u)}}async function xE(n,t){const i=It(n);try{const a=await OC(i.localStore,t);t.targetChanges.forEach(((o,u)=>{const d=i.Au.get(u);d&&(Yt(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1,22616),o.addedDocuments.size>0?d.hu=!0:o.modifiedDocuments.size>0?Yt(d.hu,14607):o.removedDocuments.size>0&&(Yt(d.hu,42227),d.hu=!1))})),await _u(i,a,t)}catch(a){await To(a)}}function i2(n,t,i){const a=It(n);if(a.isPrimaryClient&&i===0||!a.isPrimaryClient&&i===1){const o=[];a.Tu.forEach(((u,d)=>{const p=d.view.va(t);p.snapshot&&o.push(p.snapshot)})),(function(d,p){const m=It(d);m.onlineState=p;let g=!1;m.queries.forEach(((v,E)=>{for(const T of E.Sa)T.va(p)&&(g=!0)})),g&&Vg(m)})(a.eventManager,t),o.length&&a.Pu.H_(o),a.onlineState=t,a.isPrimaryClient&&a.sharedClientState.setOnlineState(t)}}async function Ej(n,t,i){const a=It(n);a.sharedClientState.updateQueryState(t,"rejected",i);const o=a.Au.get(t),u=o&&o.key;if(u){let d=new me(vt.comparator);d=d.insert(u,on.newNoDocument(u,At.min()));const p=Ut().add(u),m=new ad(At.min(),new Map,new me(Pt),d,p);await xE(a,m),a.du=a.du.remove(u),a.Au.delete(t),Ug(a)}else await jm(a.localStore,t,!1).then((()=>Mm(a,t,i))).catch(To)}async function bj(n,t){const i=It(n),a=t.batch.batchId;try{const o=await MC(i.localStore,t);_E(i,a,null),vE(i,a),i.sharedClientState.updateMutationState(a,"acknowledged"),await _u(i,o)}catch(o){await To(o)}}async function Tj(n,t,i){const a=It(n);try{const o=await(function(d,p){const m=It(d);return m.persistence.runTransaction("Reject batch","readwrite-primary",(g=>{let v;return m.mutationQueue.lookupMutationBatch(g,p).next((E=>(Yt(E!==null,37113),v=E.keys(),m.mutationQueue.removeMutationBatch(g,E)))).next((()=>m.mutationQueue.performConsistencyCheck(g))).next((()=>m.documentOverlayCache.removeOverlaysForBatchId(g,v,p))).next((()=>m.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(g,v))).next((()=>m.localDocuments.getDocuments(g,v)))}))})(a.localStore,t);_E(a,t,i),vE(a,t),a.sharedClientState.updateMutationState(t,"rejected",i),await _u(a,o)}catch(o){await To(o)}}function vE(n,t){(n.mu.get(t)||[]).forEach((i=>{i.resolve()})),n.mu.delete(t)}function _E(n,t,i){const a=It(n);let o=a.Vu[a.currentUser.toKey()];if(o){const u=o.get(t);u&&(i?u.reject(i):u.resolve(),o=o.remove(t)),a.Vu[a.currentUser.toKey()]=o}}function Mm(n,t,i=null){n.sharedClientState.removeLocalQueryTarget(t);for(const a of n.Iu.get(t))n.Tu.delete(a),i&&n.Pu.yu(a,i);n.Iu.delete(t),n.isPrimaryClient&&n.Ru.jr(t).forEach((a=>{n.Ru.containsKey(a)||wE(n,a)}))}function wE(n,t){n.Eu.delete(t.path.canonicalString());const i=n.du.get(t);i!==null&&(jg(n.remoteStore,i),n.du=n.du.remove(t),n.Au.delete(i),Ug(n))}function r2(n,t,i){for(const a of i)a instanceof mE?(n.Ru.addReference(a.key,t),Sj(n,a)):a instanceof gE?(pt(Pg,"Document no longer in limbo: "+a.key),n.Ru.removeReference(a.key,t),n.Ru.containsKey(a.key)||wE(n,a.key)):Tt(19791,{wu:a})}function Sj(n,t){const i=t.key,a=i.path.canonicalString();n.du.get(i)||n.Eu.has(a)||(pt(Pg,"New document in limbo: "+i),n.Eu.add(a),Ug(n))}function Ug(n){for(;n.Eu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const t=n.Eu.values().next().value;n.Eu.delete(t);const i=new vt(ae.fromString(t)),a=n.fu.next();n.Au.set(a,new pj(i)),n.du=n.du.insert(i,a),sE(n.remoteStore,new Qr(Ti(wg(i.path)),a,"TargetPurposeLimboResolution",Zh.ce))}}async function _u(n,t,i){const a=It(n),o=[],u=[],d=[];a.Tu.isEmpty()||(a.Tu.forEach(((p,m)=>{d.push(a.pu(m,t,i).then((g=>{if((g||i)&&a.isPrimaryClient){const v=g?!g.fromCache:i?.targetChanges.get(m.targetId)?.current;a.sharedClientState.updateQueryState(m.targetId,v?"current":"not-current")}if(g){o.push(g);const v=Ig.As(m.targetId,g);u.push(v)}})))})),await Promise.all(d),a.Pu.H_(o),await(async function(m,g){const v=It(m);try{await v.persistence.runTransaction("notifyLocalViewChanges","readwrite",(E=>st.forEach(g,(T=>st.forEach(T.Es,(A=>v.persistence.referenceDelegate.addReference(E,T.targetId,A))).next((()=>st.forEach(T.ds,(A=>v.persistence.referenceDelegate.removeReference(E,T.targetId,A)))))))))}catch(E){if(!So(E))throw E;pt(Cg,"Failed to update sequence numbers: "+E)}for(const E of g){const T=E.targetId;if(!E.fromCache){const A=v.Ms.get(T),M=A.snapshotVersion,k=A.withLastLimboFreeSnapshotVersion(M);v.Ms=v.Ms.insert(T,k)}}})(a.localStore,u))}async function Aj(n,t){const i=It(n);if(!i.currentUser.isEqual(t)){pt(Pg,"User change. New user:",t.toKey());const a=await nE(i.localStore,t);i.currentUser=t,(function(u,d){u.mu.forEach((p=>{p.forEach((m=>{m.reject(new ft(it.CANCELLED,d))}))})),u.mu.clear()})(i,"'waitForPendingWrites' promise is rejected due to a user change."),i.sharedClientState.handleUserChange(t,a.removedBatchIds,a.addedBatchIds),await _u(i,a.Ls)}}function Rj(n,t){const i=It(n),a=i.Au.get(t);if(a&&a.hu)return Ut().add(a.key);{let o=Ut();const u=i.Iu.get(t);if(!u)return o;for(const d of u){const p=i.Tu.get(d);o=o.unionWith(p.view.nu)}return o}}function EE(n){const t=It(n);return t.remoteStore.remoteSyncer.applyRemoteEvent=xE.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=Rj.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=Ej.bind(null,t),t.Pu.H_=cj.bind(null,t.eventManager),t.Pu.yu=hj.bind(null,t.eventManager),t}function Ij(n){const t=It(n);return t.remoteStore.remoteSyncer.applySuccessfulWrite=bj.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=Tj.bind(null,t),t}class Uh{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=sd(t.databaseInfo.databaseId),this.sharedClientState=this.Du(t),this.persistence=this.Cu(t),await this.persistence.start(),this.localStore=this.vu(t),this.gcScheduler=this.Fu(t,this.localStore),this.indexBackfillerScheduler=this.Mu(t,this.localStore)}Fu(t,i){return null}Mu(t,i){return null}vu(t){return NC(this.persistence,new CC,t.initialUser,this.serializer)}Cu(t){return new eE(Rg.mi,this.serializer)}Du(t){return new LC}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Uh.provider={build:()=>new Uh};class Cj extends Uh{constructor(t){super(),this.cacheSizeBytes=t}Fu(t,i){Yt(this.persistence.referenceDelegate instanceof Vh,46915);const a=this.persistence.referenceDelegate.garbageCollector;return new pC(a,t.asyncQueue,i)}Cu(t){const i=this.cacheSizeBytes!==void 0?xn.withCacheSize(this.cacheSizeBytes):xn.DEFAULT;return new eE((a=>Vh.mi(a,i)),this.serializer)}}class Om{async initialize(t,i){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(i),this.remoteStore=this.createRemoteStore(i),this.eventManager=this.createEventManager(i),this.syncEngine=this.createSyncEngine(i,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=a=>i2(this.syncEngine,a,1),this.remoteStore.remoteSyncer.handleCredentialChange=Aj.bind(null,this.syncEngine),await oj(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return(function(){return new uj})()}createDatastore(t){const i=sd(t.databaseInfo.databaseId),a=(function(u){return new KC(u)})(t.databaseInfo);return(function(u,d,p,m){return new YC(u,d,p,m)})(t.authCredentials,t.appCheckCredentials,a,i)}createRemoteStore(t){return(function(a,o,u,d,p){return new XC(a,o,u,d,p)})(this.localStore,this.datastore,t.asyncQueue,(i=>i2(this.syncEngine,i,0)),(function(){return Wv.v()?new Wv:new zC})())}createSyncEngine(t,i){return(function(o,u,d,p,m,g,v){const E=new mj(o,u,d,p,m,g);return v&&(E.gu=!0),E})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,i)}async terminate(){await(async function(i){const a=It(i);pt(Za,"RemoteStore shutting down."),a.Ea.add(5),await vu(a),a.Aa.shutdown(),a.Ra.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}Om.provider={build:()=>new Om};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bE{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Ou(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Ou(this.observer.error,t):or("Uncaught Error in snapshot listener:",t.toString()))}Nu(){this.muted=!0}Ou(t,i){setTimeout((()=>{this.muted||t(i)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function AE(n){const t={};return n.timeoutSeconds!==void 0&&(t.timeoutSeconds=n.timeoutSeconds),t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const RE="firestore.googleapis.com",o2=!0;class l2{constructor(t){if(t.host===void 0){if(t.ssl!==void 0)throw new ft(it.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=RE,this.ssl=o2}else this.host=t.host,this.ssl=t.ssl??o2;if(this.isUsingEmulator=t.emulatorOptions!==void 0,this.credentials=t.credentials,this.ignoreUndefinedProperties=!!t.ignoreUndefinedProperties,this.localCache=t.localCache,t.cacheSizeBytes===void 0)this.cacheSizeBytes=tE;else{if(t.cacheSizeBytes!==-1&&t.cacheSizeBytes<dC)throw new ft(it.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=t.cacheSizeBytes}XI("experimentalForceLongPolling",t.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",t.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!t.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:t.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!t.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=AE(t.experimentalLongPollingOptions??{}),(function(a){if(a.timeoutSeconds!==void 0){if(isNaN(a.timeoutSeconds))throw new ft(it.INVALID_ARGUMENT,`invalid long polling timeout: ${a.timeoutSeconds} (must not be NaN)`);if(a.timeoutSeconds<5)throw new ft(it.INVALID_ARGUMENT,`invalid long polling timeout: ${a.timeoutSeconds} (minimum allowed value is 5)`);if(a.timeoutSeconds>30)throw new ft(it.INVALID_ARGUMENT,`invalid long polling timeout: ${a.timeoutSeconds} (maximum allowed value is 30)`)}})(this.experimentalLongPollingOptions),this.useFetchStreams=!!t.useFetchStreams}isEqual(t){return this.host===t.host&&this.ssl===t.ssl&&this.credentials===t.credentials&&this.cacheSizeBytes===t.cacheSizeBytes&&this.experimentalForceLongPolling===t.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===t.experimentalAutoDetectLongPolling&&(function(a,o){return a.timeoutSeconds===o.timeoutSeconds})(this.experimentalLongPollingOptions,t.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===t.ignoreUndefinedProperties&&this.useFetchStreams===t.useFetchStreams}}class ud{constructor(t,i,a,o){this._authCredentials=t,this._appCheckCredentials=i,this._databaseId=a,this._app=o,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new l2({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new ft(it.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(t){if(this._settingsFrozen)throw new ft(it.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new l2(t),this._emulatorOptions=t.emulatorOptions||{},t.credentials!==void 0&&(this._authCredentials=(function(a){if(!a)return new zI;switch(a.type){case"firstParty":return new KI(a.sessionIndex||"0",a.iamToken||null,a.authTokenFactory||null);case"provider":return a.client;default:throw new ft(it.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}})(t.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return(function(i){const a=s2.get(i);a&&(pt("ComponentProvider","Removing Datastore"),s2.delete(i),a.terminate())})(this),Promise.resolve()}}function kj(n,t,i,a={}){n=lr(n,ud);const o=hg(t),u=n._getSettings(),d={...u,emulatorOptions:n._getEmulatorOptions()},p=`${t}:${i}`;o&&(f6(`https://${p}`),y6("Firestore",!0)),u.host!==RE&&u.host!==p&&co("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");const m={...u,host:p,ssl:o,emulatorOptions:a};if(!Ih(m,d)&&(n._setSettings(m),a.mockUserToken)){let g,v;if(typeof a.mockUserToken=="string")g=a.mockUserToken,v=sn.MOCK_USER;else{g=p6(a.mockUserToken,n._app?.options.projectId);const E=a.mockUserToken.sub||a.mockUserToken.user_id;if(!E)throw new ft(it.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");v=new sn(E)}n._authCredentials=new $I(new cw(g,v))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u2="AsyncQueue";class c2{constructor(t=Promise.resolve()){this.Xu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new rE(this,"async_queue_retry"),this._c=()=>{const a=Up();a&&pt(u2,"Visibility state changed to "+a.visibilityState),this.M_.w_()},this.ac=t;const i=Up();i&&typeof i.addEventListener=="function"&&i.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.uc(),this.cc(t)}enterRestrictedMode(t){if(!this.ec){this.ec=!0,this.sc=t||!1;const i=Up();i&&typeof i.removeEventListener=="function"&&i.removeEventListener("visibilitychange",this._c)}}enqueue(t){if(this.uc(),this.ec)return new Promise((()=>{}));const i=new ir;return this.cc((()=>this.ec&&this.sc?Promise.resolve():(t().then(i.resolve,i.reject),i.promise))).then((()=>i.promise))}enqueueRetryable(t){this.enqueueAndForget((()=>(this.Xu.push(t),this.lc())))}async lc(){if(this.Xu.length!==0){try{await this.Xu[0](),this.Xu.shift(),this.M_.reset()}catch(t){if(!So(t))throw t;pt(u2,"Operation failed with retryable error: "+t)}this.Xu.length>0&&this.M_.p_((()=>this.lc()))}}cc(t){const i=this.ac.then((()=>(this.rc=!0,t().catch((a=>{throw this.nc=a,this.rc=!1,or("INTERNAL UNHANDLED ERROR: ",h2(a)),a})).then((a=>(this.rc=!1,a))))));return this.ac=i,i}enqueueAfterDelay(t,i,a){this.uc(),this.oc.indexOf(t)>-1&&(i=0);const o=Og.createAndSchedule(this,t,i,a,(u=>this.hc(u)));return this.tc.push(o),o}uc(){this.nc&&Tt(47125,{Pc:h2(this.nc)})}verifyOperationInProgress(){}async Tc(){let t;do t=this.ac,await t;while(t!==this.ac)}Ic(t){for(const i of this.tc)if(i.timerId===t)return!0;return!1}Ec(t){return this.Tc().then((()=>{this.tc.sort(((i,a)=>i.targetTimeMs-a.targetTimeMs));for(const i of this.tc)if(i.skipDelay(),t!=="all"&&i.timerId===t)break;return this.Tc()}))}dc(t){this.oc.push(t)}hc(t){const i=this.tc.indexOf(t);this.tc.splice(i,1)}}function h2(n){let t=n.message||"";return n.stack&&(t=n.stack.includes(n.message)?n.stack:n.message+`
`+n.stack),t}class wu extends ud{constructor(t,i,a,o){super(t,i,a,o),this.type="firestore",this._queue=new c2,this._persistenceKey=o?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new c2(t),this._firestoreClient=void 0,await t}}}function IE(n,t){const i=typeof n=="object"?n:RI(),a=typeof n=="string"?n:Dh,o=EI(i,"firestore").getImmediate({identifier:a});if(!o._initialized){const u=h6("firestore");u&&kj(o,...u)}return o}function Lg(n){if(n._terminated)throw new ft(it.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||Vj(n),n._firestoreClient}function Vj(n){const t=n._freezeSettings(),i=(function(o,u,d,p){return new o3(o,u,d,p.host,p.ssl,p.experimentalForceLongPolling,p.experimentalAutoDetectLongPolling,AE(p.experimentalLongPollingOptions),p.useFetchStreams,p.isUsingEmulator)})(n._databaseId,n._app?.options.appId||"",n._persistenceKey,t);n._componentsProvider||t.localCache?._offlineComponentProvider&&t.localCache?._onlineComponentProvider&&(n._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),n._firestoreClient=new jj(n._authCredentials,n._appCheckCredentials,n._queue,i,n._componentsProvider&&(function(o){const u=o?._online.build();return{_offline:o?._offline.build(u),_online:u}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pj=/^__.*__$/;class Uj{constructor(t,i,a){this.data=t,this.fieldMask=i,this.fieldTransforms=a}toMutation(t,i){return this.fieldMask!==null?new oa(t,this.data,this.fieldMask,i,this.fieldTransforms):new yu(t,this.data,i,this.fieldTransforms)}}class CE{constructor(t,i,a){this.data=t,this.fieldMask=i,this.fieldTransforms=a}toMutation(t,i){return new oa(t,this.data,this.fieldMask,i,this.fieldTransforms)}}function jE(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Tt(40011,{Ac:n})}}class zg{constructor(t,i,a,o,u,d){this.settings=t,this.databaseId=i,this.serializer=a,this.ignoreUndefinedProperties=o,u===void 0&&this.Rc(),this.fieldTransforms=u||[],this.fieldMask=d||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(t){return new zg({...this.settings,...t},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(t){const i=this.path?.child(t),a=this.Vc({path:i,fc:!1});return a.gc(t),a}yc(t){const i=this.path?.child(t),a=this.Vc({path:i,fc:!1});return a.Rc(),a}wc(t){return this.Vc({path:void 0,fc:!0})}Sc(t){return Lh(t,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(t){return this.fieldMask.find((i=>t.isPrefixOf(i)))!==void 0||this.fieldTransforms.find((i=>t.isPrefixOf(i.field)))!==void 0}Rc(){if(this.path)for(let t=0;t<this.path.length;t++)this.gc(this.path.get(t))}gc(t){if(t.length===0)throw this.Sc("Document fields must not be empty");if(jE(this.Ac)&&Pj.test(t))throw this.Sc('Document fields cannot begin and end with "__"')}}class Lj{constructor(t,i,a){this.databaseId=t,this.ignoreUndefinedProperties=i,this.serializer=a||sd(t)}Cc(t,i,a,o=!1){return new zg({Ac:t,methodName:i,Dc:a,path:Ze.emptyPath(),fc:!1,bc:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function $g(n){const t=n._freezeSettings(),i=sd(n._databaseId);return new Lj(n._databaseId,!!t.ignoreUndefinedProperties,i)}function zj(n,t,i,a,o,u={}){const d=n.Cc(u.merge||u.mergeFields?2:0,t,i,o);Fg("Data must be an object, but it was:",d,a);const p=DE(a,d);let m,g;if(u.merge)m=new jn(d.fieldMask),g=d.fieldTransforms;else if(u.mergeFields){const v=[];for(const E of u.mergeFields){const T=km(t,E,i);if(!d.contains(T))throw new ft(it.INVALID_ARGUMENT,`Field '${T}' is specified in your field mask but missing from your input data.`);ME(v,T)||v.push(T)}m=new jn(v),g=d.fieldTransforms.filter((E=>m.covers(E.field)))}else m=null,g=d.fieldTransforms;return new Uj(new vn(p),m,g)}class dd extends hd{_toFieldTransform(t){if(t.Ac!==2)throw t.Ac===1?t.Sc(`${this._methodName}() can only appear at the top level of your update data`):t.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof dd}}class Bg extends hd{constructor(t,i){super(t),this.Fc=i}_toFieldTransform(t){const i=new du(t.serializer,Vw(t.serializer,this.Fc));return new N3(t.path,i)}isEqual(t){return t instanceof Bg&&this.Fc===t.Fc}}function $j(n,t,i,a){const o=n.Cc(1,t,i);Fg("Data must be an object, but it was:",o,a);const u=[],d=vn.empty();sa(a,((m,g)=>{const v=Kg(t,m,i);g=ar(g);const E=o.yc(v);if(g instanceof dd)u.push(v);else{const T=Eu(g,E);T!=null&&(u.push(v),d.set(v,T))}}));const p=new jn(u);return new CE(d,p,o.fieldTransforms)}function Bj(n,t,i,a,o,u){const d=n.Cc(1,t,i),p=[km(t,a,i)],m=[o];if(u.length%2!=0)throw new ft(it.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let T=0;T<u.length;T+=2)p.push(km(t,u[T])),m.push(u[T+1]);const g=[],v=vn.empty();for(let T=p.length-1;T>=0;--T)if(!ME(g,p[T])){const A=p[T];let M=m[T];M=ar(M);const k=d.yc(A);if(M instanceof dd)g.push(A);else{const V=Eu(M,k);V!=null&&(g.push(A),v.set(A,V))}}const E=new jn(g);return new CE(v,E,d.fieldTransforms)}function Fj(n,t,i,a=!1){return Eu(i,n.Cc(a?4:3,t))}function Eu(n,t){if(NE(n=ar(n)))return Fg("Unsupported field value:",t,n),DE(n,t);if(n instanceof hd)return(function(a,o){if(!jE(o.Ac))throw o.Sc(`${a._methodName}() can only be used with update() and set()`);if(!o.path)throw o.Sc(`${a._methodName}() is not currently supported inside arrays`);const u=a._toFieldTransform(o);u&&o.fieldTransforms.push(u)})(n,t),null;if(n===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),n instanceof Array){if(t.settings.fc&&t.Ac!==4)throw t.Sc("Nested arrays are not supported");return(function(a,o){const u=[];let d=0;for(const p of a){let m=Eu(p,o.wc(d));m==null&&(m={nullValue:"NULL_VALUE"}),u.push(m),d++}return{arrayValue:{values:u}}})(n,t)}return(function(a,o){if((a=ar(a))===null)return{nullValue:"NULL_VALUE"};if(typeof a=="number")return Vw(o.serializer,a);if(typeof a=="boolean")return{booleanValue:a};if(typeof a=="string")return{stringValue:a};if(a instanceof Date){const u=ue.fromDate(a);return{timestampValue:kh(o.serializer,u)}}if(a instanceof ue){const u=new ue(a.seconds,1e3*Math.floor(a.nanoseconds/1e3));return{timestampValue:kh(o.serializer,u)}}if(a instanceof Ri)return{geoPointValue:{latitude:a.latitude,longitude:a.longitude}};if(a instanceof Fn)return{bytesValue:Gw(o.serializer,a._byteString)};if(a instanceof Ae){const u=o.databaseId,d=a.firestore._databaseId;if(!d.isEqual(u))throw o.Sc(`Document reference is for database ${d.projectId}/${d.database} but should be for database ${u.projectId}/${u.database}`);return{referenceValue:Sg(a.firestore._databaseId||o.databaseId,a._key.path)}}if(a instanceof Ii)return(function(d,p){return{mapValue:{fields:{[_w]:{stringValue:ww},[Nh]:{arrayValue:{values:d.toArray().map((g=>{if(typeof g!="number")throw p.Sc("VectorValues must only contain numeric values.");return Eg(p.serializer,g)}))}}}}}})(a,o);throw o.Sc(`Unsupported field value: ${Wh(a)}`)})(n,t)}function DE(n,t){const i={};return pw(n)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):sa(n,((a,o)=>{const u=Eu(o,t.mc(a));u!=null&&(i[a]=u)})),{mapValue:{fields:i}}}function NE(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ue||n instanceof Ri||n instanceof Fn||n instanceof Ae||n instanceof hd||n instanceof Ii)}function Fg(n,t,i){if(!NE(i)||!dw(i)){const a=Wh(i);throw a==="an object"?t.Sc(n+" a custom object"):t.Sc(n+" "+a)}}function km(n,t,i){if((t=ar(t))instanceof cd)return t._internalPath;if(typeof t=="string")return Kg(n,t);throw Lh("Field path arguments must be of type string or ",n,!1,void 0,i)}const Kj=new RegExp("[~\\*/\\[\\]]");function Kg(n,t,i){if(t.search(Kj)>=0)throw Lh(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,i);try{return new cd(...t.split("."))._internalPath}catch{throw Lh(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,i)}}function Lh(n,t,i,a,o){const u=a&&!a.isEmpty(),d=o!==void 0;let p=`Function ${t}() called with invalid data`;i&&(p+=" (via `toFirestore()`)"),p+=". ";let m="";return(u||d)&&(m+=" (found",u&&(m+=` in field ${a}`),d&&(m+=` in document ${o}`),m+=")"),new ft(it.INVALID_ARGUMENT,p+n+m)}function ME(n,t){return n.some((i=>i.isEqual(t)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OE{constructor(t,i,a,o,u){this._firestore=t,this._userDataWriter=i,this._key=a,this._document=o,this._converter=u}get id(){return this._key.path.lastSegment()}get ref(){return new Ae(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const t=new Hj(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const i=this._document.data.field(Hg("DocumentSnapshot.get",t));if(i!==null)return this._userDataWriter.convertValue(i)}}}class Hj extends OE{data(){return super.data()}}function Hg(n,t){return typeof t=="string"?Kg(n,t):t instanceof cd?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _h(n){n=lr(n,Ae);const t=lr(n.firestore,wu);return Mj(Lg(t),n._key).then((i=>Xj(t,n,i)))}io._jsonSchemaVersion="firestore/querySnapshot/1.0",io._jsonSchema={type:Ne("string",io._jsonSchemaVersion),bundleSource:Ne("string","QuerySnapshot"),bundleName:Ne("string"),bundle:Ne("string")};class PE extends Gj{constructor(t){super(),this.firestore=t}convertBytes(t){return new Fn(t)}convertReference(t){const i=this.convertDocumentKey(t,this.firestore._databaseId);return new Ae(this.firestore,null,i)}}function Vm(n){n=lr(n,is);const t=lr(n.firestore,wu),i=Lg(t),a=new PE(t);return qj(n._query),Oj(i,n._query).then((o=>new io(t,a,n,o)))}function Xg(n,t,i){n=lr(n,Ae);const a=lr(n.firestore,wu),o=Yj(n.converter,t,i);return UE(a,[zj($g(a),"setDoc",n._key,o,n.converter!==null,i).toMutation(n._key,Si.none())])}function zh(n,t,i,...a){n=lr(n,Ae);const o=lr(n.firestore,wu),u=$g(o);let d;return d=typeof(t=ar(t))=="string"||t instanceof cd?Bj(u,"updateDoc",n._key,t,i,a):$j(u,"updateDoc",n._key,t),UE(o,[d.toMutation(n._key,Si.exists(!0))])}function UE(n,t){return(function(a,o){const u=new ir;return a.asyncQueue.enqueueAndForget((async()=>wj(await Nj(a),o,u))),u.promise})(Lg(n),t)}function Xj(n,t,i){const a=i.docs.get(t._key),o=new PE(n);return new Xa(n,o,t._key,a,new Bl(i.hasPendingWrites,i.fromCache),t.converter)}function $h(n){return new Bg("increment",n)}(function(t,i=!0){(function(o){bo=o})(AI),Ch(new nu("firestore",((a,{instanceIdentifier:o,options:u})=>{const d=a.getProvider("app").getImmediate(),p=new wu(new BI(a.getProvider("auth-internal")),new HI(d,a.getProvider("app-check-internal")),(function(g,v){if(!Object.prototype.hasOwnProperty.apply(g.options,["projectId"]))throw new ft(it.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ou(g.options.projectId,v)})(d,o),d);return u={useFetchStreams:i,...u},p._setSettings(u),p}),"PUBLIC").setMultipleInstances(!0)),eo(gv,yv,t),eo(gv,yv,"esm2020")})();const Wj={apiKey:"AIzaSyDNeoxp-PIOVG14sQdfk-vstE4LYfh6I1Y",authDomain:"tu2025grad-ae6fd.firebaseapp.com",projectId:"tu2025grad-ae6fd",storageBucket:"tu2025grad-ae6fd.firebasestorage.app",messagingSenderId:"485747297627",appId:"1:485747297627:web:b33c732ec5ccd5c4859e7e"},Zj=hv().length?hv()[0]:fg(Wj),Wl=IE(Zj),g2=40;function LE(n){if(!n)return n;const t="/";if(/^https?:\/\//i.test(n))return n;const i=n.replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const Jj=S.div`
  position: relative; background: #fff;
`,t5=S.div`
...
`,y2=eu,zE=lg,a5={"All Projects":null,"AI & Robot":"c0","Edu & Kids":"c1","Health Care":"c2","IT & Tech":"c3",Living:"c4",Mobility:"c5"};function Pm(n){return n.members.map(t=>{const i=zE.find(a=>a.num===t);return i?i.nameKor:""}).filter(Boolean).join(", ")}function s5(n){return n.members.map(t=>{const i=zE.find(a=>a.num===t);return i?LE(i.imgUrl):""}).filter(Boolean)}function o5({list:n,statsById:t}){const i={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"};return y.jsx(i5,{children:n.map((a,o)=>{const u=Pm(a),d=s5(a),p=String(a.projectNum+1).padStart(3,"0"),g=`${i[a.category]||"A"}${p}`,v=a.projectNum??a.num;return y.jsx(ug,{titleKor:a.titleKor,titleEng:a.titleEng,src:LE(`/projects/${a.projectNum}/thumb.jpg`||`/projects/${a.projectNum}/thumb.png`),nameKor:u,profileImgs:d,docId:v,href:`/work/${g}`,like:t[String(v)]?.like??0,view:t[String(v)]?.view??0},o)})})}function l5(){const[n,t]=bt.useState("All Projects"),[i,a]=bt.useState("이름순"),[o,u]=bt.useState({});bt.useEffect(()=>{let m=!0;return(async()=>{try{const g=await Vm(xh(Wl,"works")),v=g.docs.map(T=>({id:T.id,...T.data()}));if(console.log(JSON.stringify(v,null,2)),!m)return;const E={};g.forEach(T=>{const A=T.data()||{};E[String(T.id)]={like:typeof A.like=="number"?A.like:0,view:typeof A.view=="number"?A.view:0}}),u(E)}catch(g){console.error("Failed to load works stats:",g)}})(),()=>{m=!1}},[]);const d=bt.useMemo(()=>{const m=a5[n]||null;return m?y2.filter(g=>g.category===m):y2},[n]),p=bt.useMemo(()=>{const m=[...d];switch(i){case"이름순":m.sort((g,v)=>Pm(g).localeCompare(Pm(v),"ko"));break;case"좋아요순":m.sort((g,v)=>{const E=String(g.projectNum??g.num),T=String(v.projectNum??v.num),A=o[E]?.like??0;return(o[T]?.like??0)-A});break;case"조회수순":m.sort((g,v)=>{const E=String(g.projectNum??g.num),T=String(v.projectNum??v.num),A=o[E]?.view??0;return(o[T]?.view??0)-A});break;case"팀작우선":m.sort((g,v)=>(v.members.length>1)-(g.members.length>1));break;case"개인작우선":m.sort((g,v)=>(g.members.length>1)-(v.members.length>1));break}return m},[d,i,o]);return y.jsxs(n5,{children:[y.jsx(r5,{children:"Projects"}),y.jsx(q_,{type:"project",onCategoryChange:t,onSortChange:a,sortLabel:i}),y.jsx(e5,{children:y.jsx(o5,{list:p,statsById:o})})]})}const u5=S.div(({height:n,from:t,to:i,position:a,z:o})=>({position:"absolute",left:0,right:0,[a]:-1,height:n,pointerEvents:"none",zIndex:o??0,background:`linear-gradient(180deg, ${t} 0%, ${i} 100%)`}));function $E({position:n="bottom",from:t,to:i,height:a=240,z:o=0,style:u}){return y.jsx(u5,{position:n,from:t,to:i,height:a,z:o,style:u})}const ro={heroToWhite:{from:"rgba(18,18,18,0)",to:"#FFFFFF",h:80},whiteToBlack:{from:"rgba(255,255,255,0)",to:"#121212",h:160}},c5=S.section`
...
`;const w5='Pretendard, system-ui, -apple-system, Segoe UI, Roboto, "Noto Sans KR", Arial, sans-serif',E5=S.a`
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;function V5({durationVh:n=300,center:t=!0,centerOffsetPx:i=0,children:a,style:o}){const u=bt.useRef(null),[d,p]=bt.useState(0);return bt.useEffect(()=>{const m=u.current;if(!m)return;let g=0,v=!0;const E=()=>{if(!v)return;const T=m.getBoundingClientRect(),A=window.innerHeight,M=n/100*A-A,k=Math.min(Math.max(-T.top,0),M);p(M>0?k/M:0),g=requestAnimationFrame(E)};return g=requestAnimationFrame(E),()=>{v=!1,cancelAnimationFrame(g)}},[n]),y.jsx(M5,{ref:u,style:o,$durationVh:n,children:y.jsx(O5,{$center:t,children:y.jsx(k5,{$offset:i,children:typeof a=="function"?a(d):a})})})}const _2=[{id:"w1",index:"A010",artistKr:"송지원, 허지유",dept:"Industrial Design Engineering",titleSmall:"한국산업기술진흥원장상 수상",titleStrong:"BIND",rightMeta1:"Precision and efficency beyond human limits.",rightMeta2:"BIND, 흩어진 시간을 하나로 잇다.",image:"1127032149"},{id:"w2",index:"A017",artistKr:"이채연",dept:"Media Design Engineering",titleSmall:"총동문회장상 수상",titleStrong:"MUSE",rightMeta1:"디자인 논문을 쉽게 활용할 수 있도록 돕는",rightMeta2:"AI 인사이트 제공 서비스",image:"1127403683"},{id:"w3",index:"A011",artistKr:"정혜원, 신주혜",dept:"Industrial Design Engineering",titleSmall:"한국공학대학교총장상 수상",titleStrong:"ENDY",rightMeta1:"감정을 이해하고 반응하는 학습 파트너,",rightMeta2:"자기주도학습의 새로운 동반자 ENDY",image:"1126889031"}],P5=S.div`
  position: relative;
  background: #121212;
  @media (max-width: 640px) {
    background: #121212;
...
`;function cD(){return y.jsx(iD,{"aria-labelledby":"insta-title",children:y.jsx(rD,{children:y.jsxs(aD,{children:[y.jsx(sD,{children:y.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"#FFFFFF",children:[y.jsx("path",{d:"M12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 8.2A3.2 3.2 0 1 1 12 8a3.2 3.2 0 0 1 0 6.4z"}),y.jsx("circle",{cx:"17.5",cy:"6.5",r:"1.2"}),y.jsx("path",{d:"M17.8 2H6.2A4.2 4.2 0 0 0 2 6.2v11.6A4.2 4.2 0 0 0 6.2 22h11.6A4.2 4.2 0 0 0 22 17.8V6.2A4.2 4.2 0 0 0 17.8 2zm2.6 15.8a2.6 2.6 0 0 1-2.6 2.6H6.2a2.6 2.6 0 0 1-2.6-2.6V6.2A2.6 2.6 0 0 1 6.2 3.6h11.6a2.6 2.6 0 0 1 2.6 2.6v11.6z"})]})}),y.jsx(oD,{id:"insta-title",children:"@tukd_grad"}),y.jsxs(lD,{children:[y.jsx(uD,{children:y.jsx("img",{src:`${nD}insta-qr.png`,alt:"Instagram preview"})}),y.jsx(Wg,{as:"a",href:"https://www.instagram.com/tukd_grad?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",label:"View Instagram",size:"sm"})]})]})})})}const Tu=`'Pretendard', system-ui, -apple-system, Segoe UI, Roboto, "Noto Sans KR", Arial, sans-serif`,w2=350,hD=S.section`
...
`;function E2({title:n,children:t,last:i=!1}){return y.jsxs(xD,{$last:i,children:[y.jsx(yD,{title:n}),y.jsx(bD,{children:t})]})}const TD=S.div`
...
`;function ID(){return y.jsx(hD,{"aria-label":"Venue & Access",children:y.jsxs(pD,{children:[y.jsxs(E2,{title:"Venew Details",children:[y.jsx(TD,{children:y.jsx(SD,{children:"잔향 : 기억의 향기"})}),y.jsx(Gr,{k:"Term",children:y.jsx(qt,{children:"2025. 10. 24. FRI - 10. 26. SUN"})}),y.jsxs(Gr,{k:"Hours",children:[y.jsx(qt,{children:"10.24.FRI   13:00 ~ 17:30 (OPENING 16:00~)"}),y.jsx(qt,{children:"10.25.SAT ~ 10.26.SUN    10:00 ~ 17:30"})]}),y.jsxs(Gr,{k:"Schedule",children:[y.jsx(eh,{children:"10.24.FRI"}),y.jsx(qt,{children:"13:00    자유관람"}),y.jsx(qt,{children:"15:00    졸업생 홈커밍 행사"}),y.jsx(qt,{children:"16:00    개회식"}),y.jsx(qt,{children:"16:20    졸업작품 우수작 시상"}),y.jsx(qt,{children:"16:30    자유관람"}),y.jsxs(eh,{children:[y.jsx("br",{}),"10.25.SAT"]}),y.jsx(qt,{children:"10:00    자유관람"}),y.jsx(qt,{children:"13:00    취·창업 커리어 캠프"}),y.jsxs(eh,{children:[y.jsx("br",{}),"10.26.SUN"]}),y.jsx(qt,{children:"10:00    자유관람"})]}),y.jsxs(Gr,{k:"Website",divider:!1,children:[y.jsx(qt,{children:"Hongik Art Center"}),y.jsx(RD,{href:"https://artscenter.hongik.ac.kr/artcenter/index.do",target:"_blank",rel:"noreferrer",children:"https://artscenter.hongik.ac.kr/artcenter/index.do"})]})]}),y.jsxs(E2,{title:"Access",children:[y.jsxs(Gr,{k:"Address",children:[y.jsxs(qt,{children:["홍대 아트센터 지하 2층 전시관 3",y.jsx("br",{}),"서울시 종로구 대학로 57"]}),y.jsxs(qt,{children:["Hongik Art Center B2 Gallery 3",y.jsx("br",{}),"57, Daehak-ro, Jongno-gu, Seoul"]}),y.jsx("div",{style:{marginTop:24},children:y.jsx(Wg,{as:"a",href:"https://maps.app.goo.gl/qc99M9bDqyBTcmx79",label:"Map",size:"sm",showArrow:!0})})]}),y.jsxs(Gr,{k:"Parking",children:[y.jsx(qt,{children:"B3F ~ B6F"}),y.jsxs(qt,{children:[y.jsx("br",{}),"기본 30분 3,000원 / 이후 20분당 2,000원"]}),y.jsx(qt,{children:"이용객 주차권 지참 시 50% 할인 및 1시간 무료이용권 제공"}),y.jsx(eh,{children:"(주차권으로만 정산 가능, 티켓정산 불가)"}),y.jsx(AD,{children:"주차권 배부 장소: B2 갤러리 3, 전시장 입구 인포데스크"})]}),y.jsxs(Gr,{k:"By Subway",children:[y.jsx(qt,{children:"[1호선 종로5가역]"}),y.jsx(qt,{children:"2번 출구 방면으로 이동 → 이화사거리 방면으로 약 800m 직진 (도보7분)"}),y.jsxs(qt,{children:[y.jsx("br",{}),"[4호선 혜화역]"]}),y.jsx(qt,{children:"3번 출구 방면으로 이동 → 이화사거리 방면으로 약 800m 직진 (도보7분)"}),y.jsx(qt,{children:"또는 08번 마을버스 탑승 후 이화사거리 앞 하차"})]}),y.jsxs(Gr,{k:"By Bus",divider:!1,children:[y.jsx(qt,{children:"[이화사거리(01-572) 하차]"}),y.jsx(qt,{children:"마을버스 종로 08번"}),y.jsxs(qt,{children:[y.jsx("br",{}),"[현대그룹빌딩(01-218) 하차]"]}),y.jsx(qt,{children:"102, 107, 108, 109, 162, 301, 7025"}),y.jsxs(qt,{children:[y.jsx("br",{}),"[이화장(01-223) 하차]"]}),y.jsx(qt,{children:"109, 273, 601, 2112, 7025"})]})]})]})})}const wh="/",CD=S.div`
    position: relative;
    width: 100vw;
...
`;function $D({}){const[n,t]=z.useState(!1),i=z.useRef(null),[a,o]=z.useState(0);z.useEffect(()=>{if(!i.current)return;const d=i.current.querySelectorAll("div")[0].scrollHeight/2.7;if(n){const p=d*3.5;o(p)}else o(d)},[n]);const u=[{title:"잔향 : 기억의 향기",context:`우리는 살아가며 수많은 순간들을 스쳐 지나간다.
                ...
                학생들이 쌓아온 고민과 탐구의 시간, 하나의 작품을 완성하기 위한 노력한 과정은 AI&ROBOT, EDUCATION&KIDS, HEALTH CARE, IT& TECH, LIVING, MOBILITY라는 여섯 가지 향으로 드러납니다. 각각 독립된 향은 노트처럼 뚜렷한 개성을 지니면서도 함께 어우러져 전체적인 조화를 완성합니다.`},{title:"잔향의 형",context:"세 갈래로 뻗어 나가는 유기적인 곡선은 꽃잎의 형상을 닮아, 작품 속에서 향이 피어오르고 퍼져나가는 순간을 담았습니다. 곡선들이 서로 교차하며 만들어내는 흐름은 창작의 과정에서 이어지는 영감과 감정을 나타내고, 그 중심에 놓인 물방울은 남겨진 향과 기억의 매개체를 의미합니다. 이는 전시를 통해 스며든 감각과 감정이 시간이 지나도 서서히 피어오르는 잔향으로 남기를 바라는 의지를 담고 있습니다."}];return y.jsxs(CD,{ref:i,$height:a,children:[y.jsxs(jD,{children:[y.jsxs(Bp,{children:[y.jsx(b2,{children:y.jsx(Fp,{children:y.jsx("span",{children:u[0].title})})}),y.jsxs(T2,{children:[y.jsx(Um,{children:u[0].context}),y.jsx(ND,{src:`${wh}brand-concept-logo.png`})]})]}),y.jsxs(Bp,{children:[y.jsx(b2,{children:y.jsx(Fp,{children:u[1].title})}),y.jsxs(T2,{children:[y.jsx(Um,{children:u[1].context}),y.jsx(MD,{src:`${wh}brand-category.png`})]})]}),y.jsxs(Bp,{children:[y.jsxs(kD,{children:[y.jsx(Fp,{children:u[2].title}),y.jsx(DD,{children:u[2].context})]}),y.jsx(OD,{src:`${wh}brand-variation.png`})]})]}),y.jsx($E,{position:"bottom",from:ro.whiteToBlack.from,to:ro.whiteToBlack.to,height:ro.whiteToBlack.h,z:0}),y.jsxs(zD,{children:[y.jsx(PD,{onClick:()=>t(d=>!d),children:y.jsx(UD,{$flipped:n})}),y.jsx(LD,{children:n?"접기":"더보기"})]})]})}S.div`
  @media (max-width: 640px) {
...
`;function lN({onClick:n}){return y.jsxs(nN,{onClick:n,"aria-label":"방명록 작성",$w:yo,$h:Ja,children:[y.jsx(iN,{$w:yo,$h:Ja}),y.jsx(rN,{children:y.jsxs(aN,{children:[y.jsx(sN,{}),y.jsx(oN,{})]})})]})}const yo=270,Ja=337,uN=30,BE=20,cN=210,hN=60,FE=173,KE=216,dN=16,fN=16,Lm=16,pN=S.div`
  padding: 0 0 12px 0;
  @media (max-width: 640px) {
    display: none;
  }
...
`,TN=S.div`
  display: block;
  cursor: pointer;
`,S2=n=>{const t=[{type:"add",id:"add"},...n],i=[{min:6,max:10},{min:16,max:20},{min:26,max:30}];let a=0;const o="/";return i.forEach((u,d)=>{if(t.length>u.min+a){const p=Math.min(Math.floor(Math.random()*(u.max-u.min+1))+u.min,t.length)+a;let m;do m=Math.floor(Math.random()*7)+1;while(t[t.length-1]?.id===`ph-${Date.now()}-${t.length-1}`&&m===t[t.length-1]?.id);t.splice(p,0,{type:"photo",id:`ph-${Date.now()}-${d}`,src:`${o}sq${m}.png`}),a++}}),t},SN=n=>{const t=[];for(let i=0;i<n.length;i+=2)t.push([n[i],n[i+1]||null]);return t};function AN({onOpenModal:n,items:t}){const i=z.useRef(null),[a,o]=z.useState({width:0,trackW:0}),[u,d]=z.useState(()=>S2(t)),[p,m]=z.useState(()=>window.matchMedia&&window.matchMedia("(max-width: 640px)").matches);z.useEffect(()=>{d(S2(t))},[t]);const g=SN(u);z.useEffect(()=>{if(!window.matchMedia)return;const A=window.matchMedia("(max-width: 640px)"),M=k=>m(k.matches);return A.addEventListener?A.addEventListener("change",M):A.addListener(M),()=>{A.removeEventListener?A.removeEventListener("change",M):A.removeListener(M)}},[]),z.useEffect(()=>{if(p)return;const A=i.current;if(!A)return;const M=k=>{Math.abs(k.deltaY)>Math.abs(k.deltaX)&&(A.scrollLeft+=k.deltaY,k.preventDefault())};return A.addEventListener("wheel",M,{passive:!1}),()=>A.removeEventListener("wheel",M)},[p]);const v=z.useRef({on:!1,moved:!1,startX:0,startScroll:0}),E=A=>!!A?.closest?.('button, a, input, textarea, select, label, [role="button"], [data-nodrag]');z.useEffect(()=>{if(p)return;const A=i.current;if(!A)return;const M=B=>{B.button===0&&(E(B.target)||(v.current.on=!0,v.current.moved=!1,v.current.startX=B.clientX,v.current.startScroll=A.scrollLeft,A.setPointerCapture?.(B.pointerId),document.body.style.userSelect="none",A.style.cursor="grabbing"))},k=B=>{if(!v.current.on)return;const q=B.clientX-v.current.startX;Math.abs(q)>2&&(v.current.moved=!0),A.scrollLeft=v.current.startScroll-q},V=B=>{v.current.on&&(A.releasePointerCapture?.(B.pointerId),document.body.style.userSelect="",A.style.cursor="grab",v.current.moved&&(B.preventDefault(),B.stopPropagation()),v.current.on=!1)};return A.addEventListener("pointerdown",M),window.addEventListener("pointermove",k),window.addEventListener("pointerup",V),A.addEventListener("pointercancel",V),()=>{A.removeEventListener("pointerdown",M),window.removeEventListener("pointermove",k),window.removeEventListener("pointerup",V),A.removeEventListener("pointercancel",V)}},[p]);const T=z.useCallback(()=>{const A=i.current;if(!A)return;const M=A.clientWidth,k=A.scrollWidth,V=A.scrollLeft,q=A.parentElement?.clientWidth||M,Z=Math.max(1,k-M),lt=Math.min(1,Math.max(0,V/Z)),K=Math.round(q*lt);o({width:K,trackW:q})},[]);return z.useEffect(()=>{if(p)return;T();const A=i.current;if(!A)return;const M=()=>requestAnimationFrame(T),k=()=>requestAnimationFrame(T);return A.addEventListener("scroll",M,{passive:!0}),window.addEventListener("resize",k),()=>{A.removeEventListener("scroll",M),window.removeEventListener("resize",k)}},[T,p]),y.jsxs(y.Fragment,{children:[y.jsxs(wN,{children:[y.jsx(pN,{children:y.jsx(mN,{children:y.jsx(gN,{$w:a.width})})}),y.jsx(yN,{ref:i,children:y.jsx(xN,{children:g.map((A,M)=>y.jsxs(bN,{children:[y.jsx(Kp,{data:A[0],onOpenModal:n}),A[1]?y.jsx(Kp,{data:A[1],onOpenModal:n}):y.jsx(HE,{})]},`col-${M}`))})})]}),y.jsx(EN,{children:y.jsx(vN,{children:u.map(A=>y.jsx(_N,{children:y.jsx(Kp,{data:A,onOpenModal:n})},A.id))})})]})}function Kp({data:n,onOpenModal:t}){return n?n.type==="add"?y.jsx(lN,{onClick:()=>t?.({type:"add"}),style:{pointerEvents:"auto"}}):n.type==="photo"?y.jsx(eN,{src:n.src}):y.jsx(TN,{role:"button",tabIndex:0,"aria-label":`open guestbook card ${n.from?`from ${n.from}`:""}`,onClick:()=>t?.({type:"guestbook",item:n}),onKeyDown:i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),t?.({type:"guestbook",item:n}))},"data-nodrag":!0,children:y.jsx(ZD,{to:n.to,from:n.from,message:n.message})}):y.jsx(HE,{})}const qE="/",RN=eg`
  from { opacity: 0; }
  to { opacity: 1; }
`,IN=eg`
  from { opacity: 1; }
...
`,j2=S.div`
  ...
  width: 302px;
  height: 246px;
  background-image: url(${qE}guestbook-card.svg);
  background-size: cover;
  background-repeat: no-repeat;
  @media (max-width: 640px) {
    left: 4px;
...
`,UN=S.div`
  ...
  background-image: url(${qE}icons/guestbook-send.svg);
  background-repeat: no-repeat;
  background-size: contain;
...
`;function LN({open:n,onClose:t,onSubmit:i,defaultTo:a="",defaultFrom:o="",defaultMessage:u="",type:d}){const[p,m]=z.useState(n),[g,v]=z.useState(!1),[E,T]=z.useState(a),[A,M]=z.useState(o),[k,V]=z.useState(""),B=z.useRef(null),q=z.useCallback(()=>{v(!0),T(""),M(""),V(""),t?.()},[t]);if(z.useEffect(()=>{const K=ot=>{ot.key==="Escape"&&q()};return n&&document.addEventListener("keydown",K),()=>document.removeEventListener("keydown",K)},[n,q]),z.useEffect(()=>{n&&(m(!0),v(!1),T((a??"").toString()),M((o??"").toString()),V((u??"").toString()))},[n,a,o,u]),z.useEffect(()=>{if(!n&&p){v(!0);const K=setTimeout(()=>{v(!1),m(!1)},220);return()=>clearTimeout(K)}},[n,p]),!p)return null;const Z=K=>{K.target===B.current&&q()},lt=()=>{const K={to:(E||"").trim(),from:(A||"").trim(),message:(k||"").trim()};K.message&&i?.(K)};if(console.log(d),d==="add")return y.jsx(A2,{ref:B,onMouseDown:Z,$closing:g,children:y.jsxs(R2,{onMouseDown:K=>K.stopPropagation(),children:[y.jsx(I2,{children:y.jsxs(CN,{children:[y.jsxs(C2,{children:[y.jsx(j2,{}),y.jsxs(D2,{children:[y.jsx(N2,{children:"To."}),y.jsx(jN,{value:E,onChange:K=>T(K.target.value),placeholder:"받는 사람"})]}),y.jsx(M2,{children:y.jsx(NN,{placeholder:"내용을 입력해 주세요.",value:k,onChange:K=>V(K.target.value)})}),y.jsxs(O2,{children:[y.jsx(k2,{children:"From."}),y.jsx(ON,{value:A,onChange:K=>M(K.target.value),placeholder:"보내는 사람"})]})]}),y.jsx(VN,{children:y.jsx(PN,{type:"button",onClick:lt,"aria-label":"send",children:y.jsx(UN,{})})})]})}),y.jsx(V2,{children:y.jsx(P2,{type:"button",onClick:q,"aria-label":"close",children:y.jsxs(U2,{children:[y.jsx(nh,{$deg:45}),y.jsx(nh,{$deg:-45})]})})})]})});if(d==="guestbook")return y.jsx(A2,{ref:B,onMouseDown:Z,$closing:g,children:y.jsxs(R2,{onMouseDown:K=>K.stopPropagation(),children:[y.jsx(I2,{children:y.jsxs(C2,{children:[y.jsx(j2,{}),y.jsxs(D2,{children:[y.jsx(N2,{children:"To."}),y.jsx(DN,{children:a})]}),y.jsx(M2,{children:y.jsx(MN,{children:u})}),y.jsxs(O2,{children:[y.jsx(k2,{children:"From."}),y.jsx(kN,{children:o})]})]})}),y.jsx(V2,{children:y.jsx(P2,{type:"button",onClick:q,"aria-label":"close",children:y.jsxs(U2,{children:[y.jsx(nh,{$deg:45}),y.jsx(nh,{$deg:-45})]})})})]})})}const zN={apiKey:"AIzaSyDNeoxp-PIOVG14sQdfk-vstE4LYfh6I1Y",authDomain:"tu2025grad-ae6fd.firebaseapp.com",projectId:"tu2025grad-ae6fd",storageBucket:"tu2025grad-ae6fd.firebasestorage.app",messagingSenderId:"485747297627",appId:"1:485747297627:web:b33c732ec5ccd5c4859e7e"},$N=fg(zN),Hp=IE($N),BN='Pretendard, system-ui, -apple-system, Segoe UI, Roboto, "Noto Sans KR", Arial, sans-serif',FN=S.div`
...
`;function Jg({nameKor:n,nameEng:t,part:i,sns:a,eMail:o,imgUrl:u,imgAlt:d}){return y.jsxs(f9,{children:[y.jsx(p9,{children:y.jsx(m9,{src:u,alt:d})}),y.jsxs(g9,{children:[y.jsxs(y9,{children:[y.jsx(x9,{children:n}),y.jsx(v9,{children:t})]}),y.jsxs(_9,{children:[y.jsxs(w9,{children:[y.jsx(qp,{children:"Part"}),y.jsx(qp,{children:"SNS"}),y.jsx(qp,{children:"E-mail"})]}),y.jsxs(E9,{children:[y.jsx(Gp,{children:i}),y.jsx(Gp,{children:a}),y.jsx(Gp,{children:o})]})]})]})]})}Jg.propTypes={nameKor:J.string.isRequired,nameEng:J.string.isRequired,part:J.string,sns:J.string,eMail:J.string,imgUrl:J.string.isRequired,imgAlt:J.string.isRequired};Jg.defaultProps={sns:"N/A",eMail:"N/A"};const b9=S.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  width: 775px;
...
`;function L2({designers:n}){return y.jsxs(b9,{children:[y.jsx(S9,{children:"Designer"}),y.jsx(T9,{children:n.map((t,i)=>y.jsx(Jg,{nameKor:t.nameKor,nameEng:t.nameEng,part:t.role,sns:t.sns,eMail:t.eMail,imgUrl:t.imgUrl},i))})]})}const A9=S.div`
    width: 100%; // 임시값
    margin-top: 50px;
...
`,Yp=n=>y.jsx(O9,{loading:"lazy",...n}),k9=S.div`
  display: flex;
  position: relative;
  background: #fff;
  width: 100%;
...
`,U9=S.div`
  ...
  height: auto;
  /* max-width: 1800px; */
`,L9={A:"c0",E:"c1",H:"c2",I:"c3",L:"c4",M:"c5"};function z9(){const{pid:n}=t4(),t=(n||"").toUpperCase().match(/^([A-Z])(\d{3})$/),[i,a]=z.useState(!0),[o,u]=z.useState(!0),d=()=>{a(!1),setTimeout(()=>{u(!1)},500)},p=()=>{u(!0),setTimeout(()=>{a(!0)},0)};let m=null;if(t){const[,B,q]=t,Z=L9[B]||null,lt=Math.max(0,parseInt(q,10)-1);m=eu.find(K=>K.projectNum===lt&&(!Z||K.category===Z)),m||(m=eu.find(K=>K.projectNum==lt))}if(!m)return y.jsx(z2,{children:y.jsxs(PageContainer,{children:[y.jsx($m,{titleKor:"작품 제목(한글)",titleEng:"Work Title (English)",context:"이곳은 작품 설명이 들어가는 영역입니다. 작품에 대한 상세한 설명이나 배경, 제작 과정 등을 기술할 수 있습니다. 이 텍스트는 예시로 작성된 내용이며, 실제 작품 설명으로 대체되어야 합니다.",isOpen:i,onClose:()=>a(!1),docId:0}),y.jsx(Yp,{src:"https://placehold.co/1530x4000",alt:"featured"}),y.jsx(L2,{children:"  "})]})});const g=(m.members||[]).map(B=>{const q=lg.find(Z=>Z.num===B);return q?{nameKor:q.nameKor,nameEng:q.nameEng,role:q.role||"Designer",sns:q.sns||"-",eMail:q.eMail||"",imgUrl:ih(q.imgUrl||"/김예준.jpg")}:null}).filter(Boolean),E={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"}[m.category]||"A",T=m.projectNum??m.num,A=String(T).padStart(3,"0"),M=`/projects/${T}`,[k,V]=z.useState([]);return z.useEffect(()=>{let B=!1;const q=["jpg"],Z=30,lt=2,K=I=>!I||!I.ok?!1:(I.headers.get("content-type")||"").startsWith("image/"),ot=async I=>{try{const C=await fetch(I,{method:"GET",cache:"no-store"});return K(C)}catch{return!1}};return(async()=>{const I=[];let C=0;for(let j=0;j<Z;j++){let O=!1;for(const U of q){const $=ih(`${M}/gallery/${j}.${U}`);if(await ot($)){I.push($),O=!0,C=0;break}}if(!O&&(I.length===0||(C+=1,C>=lt)))break}B||V(I)})(),()=>{B=!0}},[M]),z.useEffect(()=>{const B=m?.projectNum??m?.num;if(B==null)return;const Z=Xl(Wl,"works",String(B));(async()=>{try{await zh(Z,{view:$h(1)})}catch(lt){if(lt.code==="not-found"||/No document/i.test(String(lt)))try{(await _h(Z)).exists()?await zh(Z,{view:$h(1)}):await Xg(Z,{view:1},{merge:!0})}catch(K){console.error("Firestore view fallback error:",K)}else console.error("Firestore view error:",lt)}})()},[m?.projectNum,m?.num]),y.jsx(z2,{children:y.jsxs(k9,{children:[y.jsx(M9,{isOpen:i,onClick:p}),y.jsx(P9,{$visible:o,children:y.jsx($m,{titleKor:m.titleKor,titleEng:m.titleEng,context:m.description||"null",isOpen:i,onClose:d,src:ih(`/projects/${T}/thumb.jpg`),docId:T})}),y.jsxs(V9,{$isInfoOpen:i,children:[k.length>0?k.map((B,q)=>y.jsx(Yp,{src:B,alt:`project-${E}${A}-img-${q+1}`},q)):y.jsx(Yp,{src:ih("/thumbnailExample.gif"),alt:`project-${E}${A}-placeholder`}),y.jsx(C9,{videoId:m.videoId,isInfoOpen:i}),y.jsx(U9,{children:y.jsx(L2,{designers:g})})]})]})})}const $9=S.div`
    position: fixed;
    right: 18px;
    top: 50%;
    transform: translateY(-50%);
...
`,B9=S.div`
    ...
    `}
`;function F9({visible:n=!0,fadeMs:t=400,activeIndex:i=0,total:a=5}={}){const o=new Array(a).fill(0);return y.jsx($9,{$visible:n,$fadeMs:t,"aria-hidden":!n,children:o.map((u,d)=>y.jsx(B9,{$active:d===(i??0)},d))})}const Qp=S.div`
    z-index: 5;
    display: flex;
    position: absolute;
    flex-direction: row;
...
`,H9=S.p`
    ...
    text-align: justify;
    margin: 0;
`;function Xp({children:n,textWidth:t,textHeight:i,shown:a,tDur:o,tDelay:u,ease:d}){return y.jsx(K9,{$textWidth:t,$textHeight:i,$shown:a,$tDur:o,$tDelay:u,$ease:d,children:y.jsx(H9,{children:n})})}function q9({top:n,left:t,right:i="auto",bottom:a,lineWidth:o,textWidth:u,textHeight:d,children:p,position:m="left",isActive:g,section:v,currentSection:E,anim:T}){const[A,M]=z.useState(!1),k=T?.circle?.easing||T?.line?.easing||T?.text?.easing||"cubic-bezier(0.22,1,0.36,1)",V=T?.circle?.duration??250,B=T?.circle?.delay??120,q=T?.line?.duration??500,Z=B+V+(T?.line?.delay??120),lt=T?.text?.duration??280,K=Z+q+(T?.text?.delay??80),I=g||A&&E===v;if(z.useEffect(()=>{g&&!A&&M(!0)},[g,A]),m==="right")return y.jsxs(Qp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsx(Xp,{textWidth:u,textHeight:d,shown:I,tDur:lt,tDelay:K,ease:k,children:p}),y.jsxs(K2,{children:[y.jsx(F2,{$lineWidth:o,$shown:I,$lDur:q,$lDelay:Z,$ease:k}),y.jsx($2,{$shown:I,$cDur:V,$cDelay:B,$ease:k,children:y.jsx(B2,{$shown:I,$cDur:V,$cDelay:B,$ease:k})})]})]});if(m==="left")return y.jsxs(Qp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsxs(K2,{children:[y.jsx($2,{$shown:I,$cDur:V,$cDelay:B,$ease:k,children:y.jsx(B2,{$shown:I,$cDur:V,$cDelay:B,$ease:k})}),y.jsx(F2,{$lineWidth:o,$shown:I,$lDur:q,$lDelay:Z,$ease:k})]}),y.jsx(Xp,{textWidth:u,textHeight:d,shown:I,tDur:lt,tDelay:K,ease:k,children:p})]});if(m==="no-line")return y.jsx(Qp,{$top:n,$left:t,$right:i,$bottom:a,children:y.jsx(Xp,{textWidth:u,textHeight:d,shown:I,tDur:lt,tDelay:K,ease:k,children:p})})}const Wp="/",G9=S.div`
    display: flex;
    position: relative;
    margin-top: 80px;
    width: 100vw;
