...
`;function MA({text:n}){return y.jsxs(CA,{children:[y.jsx(z2,{}),y.jsx(jA,{}),y.jsx(IA,{dangerouslySetInnerHTML:{__html:n}})]})}const OA=S.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  gap: 46px;
...
`;function KA({blocks:n}){return y.jsxs(LA,{children:[y.jsx(z2,{}),n.map(t=>y.jsxs($A,{children:[y.jsx(BA,{children:t.title}),y.jsx(FA,{dangerouslySetInnerHTML:{__html:t.body}})]},t.title))]})}const HA=S.div`
...
`;function dm({path:n="student",isActive:t=!1,onClick:i}){return y.jsxs(dR,{onClick:i,children:[y.jsx(L2,{$active:t,children:"교수"}),y.jsx(pR,{$active:t,children:"학생"}),y.jsx(fR,{$active:t})]})}dm.propTypes={path:J.oneOf(["student","professor"]),isActive:J.bool,onClick:J.func};const K1=S.a`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  font-size: 24px;
  line-height: 28.8px;
  letter-spacing: 0.24px;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b6="FirebaseError";class Eo extends Error{constructor(t,i,a){super(i),this.code=t,this.customData=a,this.name=b6,Object.setPrototypeOf(this,Eo.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,X2.prototype.create)}}class X2{constructor(t,i,a){this.service=t,this.serviceName=i,this.errors=a}create(t,...i){const a=i[0]||{},o=`${this.service}/${t}`,u=this.errors[t],d=u?T6(u,a):"Error",p=`${this.serviceName}: ${d} (${o}).`;return new Eo(o,p,a)}}function T6(n,t){return n.replace(S6,(i,a)=>{const o=t[a];return o!=null?String(o):`<${a}?>`})}const S6=/\{\$([^}]+)}/g;function Ih(n,t){if(n===t)return!0;const i=Object.keys(n),a=Object.keys(t);for(const o of i){if(!a.includes(o))return!1;const u=n[o],d=t[o];if(av(u)&&av(d)){if(!Ih(u,d))return!1}else if(u!==d)return!1}for(const o of a)if(!i.includes(o))return!1;return!0}function av(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sr=new W2("@firebase/app"),G6="@firebase/app-compat",Y6="@firebase/analytics-compat",Q6="@firebase/analytics",X6="@firebase/app-check-compat",W6="@firebase/app-check",Z6="@firebase/auth",J6="@firebase/auth-compat",tI="@firebase/database",eI="@firebase/data-connect",nI="@firebase/database-compat",iI="@firebase/functions",rI="@firebase/functions-compat",aI="@firebase/installations",sI="@firebase/installations-compat",oI="@firebase/messaging",lI="@firebase/messaging-compat",uI="@firebase/performance",cI="@firebase/performance-compat",hI="@firebase/remote-config",dI="@firebase/remote-config-compat",fI="@firebase/storage",pI="@firebase/storage-compat",mI="@firebase/firestore",gI="@firebase/ai",yI="@firebase/firestore-compat",xI="firebase",vI="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AI=vI;function fg(n,t={}){let i=n;typeof t!="object"&&(t={name:t});const a={name:gm,automaticDataCollectionEnabled:!0,...t},o=a.name;if(typeof o!="string"||!o)throw Wr.create("bad-app-name",{appName:String(o)});if(i||(i=Q2()),!i)throw Wr.create("no-options");const u=iu.get(o);if(u){if(Ih(i,u.options)&&Ih(a,u.config))return u;throw Wr.create("duplicate-app",{appName:o})}const d=new C6(o);for(const m of ym.values())d.addComponent(m);const p=new SI(i,a,d);return iu.set(o,p),p}function RI(n=gm){const t=iu.get(n);if(!t&&n===gm&&Q2())return fg();if(!t)throw Wr.create("no-app",{appName:n});return t}function hv(){return Array.from(iu.values())}function eo(n,t,i){let a=_I[n]??n;i&&(a+=`-${i}`);const o=a.match(/\s|\//),u=t.match(/\s|\//);if(o||u){const d=[`Unable to register library "${a}" with version "${t}":`];o&&d.push(`library name "${a}" contains illegal characters (whitespace or "/")`),o&&u&&d.push("and"),u&&d.push(`version name "${t}" contains illegal characters (whitespace or "/")`),sr.warn(d.join(" "));return}Ch(new nu(`${a}-version`,()=>({library:a,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dw="";function r3(n){let t="";for(let i=0;i<n.length;i++)t.length>0&&(t=Tv(t)),t=a3(n.get(i),t);return Tv(t)}function a3(n,t){let i=t;const a=n.length;for(let o=0;o<a;o++){const u=n.charAt(o);switch(u){case"\0":i+="";break;case dw:i+="";break;default:i+=u}}return i}function Tv(n){return n+dw+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eg(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:jh(t)?"-0":t}}function Ow(n){return{integerValue:""+n}}function kw(n,t){return i3(t)?Ow(t):Eg(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+n.stack),t}class wu extends ud{constructor(t,i,a,o){super(t,i,a,o),this.type="firestore",this._queue=new c_,this._persistenceKey=o?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new c_(t),this._firestoreClient=void 0,await t}}}function RE(n,t){const i=typeof n=="object"?n:RI(),a=typeof n=="string"?n:Dh,o=EI(i,"firestore").getImmediate({identifier:a});if(!o._initialized){const u=h6("firestore");u&&kj(o,...u)}return o}function zg(n){if(n._terminated)throw new ft(it.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||Vj(n),n._firestoreClient}function Vj(n){const t=n._freezeSettings(),i=(function(o,u,d,p){return new o3(o,u,d,p.host,p.ssl,p.experimentalForceLongPolling,p.experimentalAutoDetectLongPolling,SE(p.experimentalLongPollingOptions),p.useFetchStreams,p.isUsingEmulator)})(n._databaseId,n._app?.options.appId||"",n._persistenceKey,t);n._componentsProvider||t.localCache?._offlineComponentProvider&&t.localCache?._onlineComponentProvider&&(n._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),n._firestoreClient=new jj(n._authCredentials,n._appCheckCredentials,n._queue,i,n._componentsProvider&&(function(o){const u=o?._online.build();return{_offline:o?._offline.build(u),_online:u}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,y_=eu,zE=lg,a5={"All Projects":null,"AI & Robot":"c0","Edu & Kids":"c1","Health Care":"c2","IT & Tech":"c3",Living:"c4",Mobility:"c5"};function Pm(n){return n.members.map(t=>{const i=zE.find(a=>a.num===t);return i?i.nameKor:""}).filter(Boolean).join(", ")}function s5(n){return n.members.map(t=>{const i=zE.find(a=>a.num===t);return i?UE(i.imgUrl):""}).filter(Boolean)}function o5({list:n,statsById:t}){const i={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"};return y.jsx(i5,{children:n.map((a,o)=>{const u=Pm(a),d=s5(a),p=String(a.projectNum+1).padStart(3,"0"),g=`${i[a.category]||"A"}${p}`,v=a.projectNum??a.num;return y.jsx(ug,{titleKor:a.titleKor,titleEng:a.titleEng,src:UE(`/projects/${a.projectNum}/thumb.jpg`||`/projects/${a.projectNum}/thumb.png`),nameKor:u,profileImgs:d,docId:v,href:`/work/${g}`,like:t[String(v)]?.like??0,view:t[String(v)]?.view??0},o)})})}function l5(){const[n,t]=bt.useState("All Projects"),[i,a]=bt.useState("이름순"),[o,u]=bt.useState({});bt.useEffect(()=>{let m=!0;return(async()=>{try{const g=await Vm(xh(Wl,"works"));if(!m)return;const v={};g.forEach(E=>{const T=E.data()||{};v[String(E.id)]={like:typeof T.like=="number"?T.like:0,view:typeof T.view=="number"?T.view:0}}),u(v)}catch(g){console.error("Failed to load works stats:",g)}})(),()=>{m=!1}},[]);const d=bt.useMemo(()=>{const m=a5[n]||null;return m?y_.filter(g=>g.category===m):y_},[n]),p=bt.useMemo(()=>{const m=[...d];switch(i){case"이름순":m.sort((g,v)=>Pm(g).localeCompare(Pm(v),"ko"));break;case"좋아요순":m.sort((g,v)=>{const E=String(g.projectNum??g.num),T=String(v.projectNum??v.num),A=o[E]?.like??0;return(o[T]?.like??0)-A});break;case"조회수순":m.sort((g,v)=>{const E=String(g.projectNum??g.num),T=String(v.projectNum??v.num),A=o[E]?.view??0;return(o[T]?.view??0)-A});break;case"팀작우선":m.sort((g,v)=>(v.members.length>1)-(g.members.length>1));break;case"개인작우선":m.sort((g,v)=>(g.members.length>1)-(v.members.length>1));break}return m},[d,i,o]);return y.jsxs(n5,{children:[y.jsx(r5,{children:"Projects"}),y.jsx(H2,{type:"project",onCategoryChange:t,onSortChange:a,sortLabel:i}),y.jsx(e5,{children:y.jsx(o5,{list:p,statsById:o})})]})}const u5=S.div(({height:n,from:t,to:i,position:a,z:o})=>({position:"absolute",left:0,right:0,[a]:-1,height:n,pointerEvents:"none",zIndex:o??0,background:`linear-gradient(180deg, ${t} 0%, ${i} 100%)`}));function LE({position:n="bottom",from:t,to:i,height:a=240,z:o=0,style:u}){return y.jsx(u5,{position:n,from:t,to:i,height:a,z:o,style:u})}const ro={heroToWhite:{from:"rgba(18,18,18,0)",to:"#FFFFFF",h:80},whiteToBlack:{from:"rgba(255,255,255,0)",to:"#121212",h:160}},c5=S.section`
...
`;function lN({onClick:n}){return y.jsxs(nN,{onClick:n,"aria-label":"방명록 작성",$w:yo,$h:Ja,children:[y.jsx(iN,{$w:yo,$h:Ja}),y.jsx(rN,{children:y.jsxs(aN,{children:[y.jsx(sN,{}),y.jsx(oN,{})]})})]})}const yo=270,Ja=337,uN=30,$E=20,cN=210,hN=60,BE=173,FE=216,dN=16,fN=16,zm=16,pN=S.div`
  padding: 0 0 12px 0;
  @media (max-width: 640px) {
    display: none;
  }
