 ...
 */var sx;function tT(){if(sx)return Ol;sx=1;var n=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(a,o,u){var d=null;if(u!==void 0&&(d=""+u),o.key!==void 0&&(d=""+o.key),"key"in o){u={};for(var m in o)m!=="key"&&(u[m]=o[m])}else u=o;return o=u.ref,{$$typeof:n,type:a,key:d,ref:o!==void 0?o:null,props:u}}return Ol.Fragment=t,Ol.jsx=i,Ol.jsxs=i,Ol}var ox;function eT(){return ox||(ox=1,up.exports=tT()),up.exports}var y=eT(),cp={exports:{}},Dt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 *
 * @license MIT
 */var cx="popstate";function iT(n={}){function t(a,o){let{pathname:u,search:d,hash:m}=a.location;return Xp("",{pathname:u,search:d,hash:m},o.state&&o.state.usr||null,o.state&&o.state.key||"default")}function i(a,o){return typeof o=="string"?o:Zl(o)}return aT(t,i,null,n)}function de(n,t){if(n===!1||n===null||typeof n>"u")throw new Error(t)}function ri(n,t){if(!n){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function rT(){return Math.random().toString(36).substring(2,10)}function hx(n,t){return{usr:n.state,key:n.key,idx:t}}function Xp(n,t,i=null,a){return{pathname:typeof n=="string"?n:n.pathname,search:"",hash:"",...typeof t=="string"?xo(t):t,state:i,key:t&&t.key||a||rT()}}function Zl({pathname:n="/",search:t="",hash:i=""}){return t&&t!=="?"&&(n+=t.charAt(0)==="?"?t:"?"+t),i&&i!=="#"&&(n+=i.charAt(0)==="#"?i:"#"+i),n}function xo(n){let t={};if(n){let i=n.indexOf("#");i>=0&&(t.hash=n.substring(i),n=n.substring(0,i));let a=n.indexOf("?");a>=0&&(t.search=n.substring(a),n=n.substring(0,a)),n&&(t.pathname=n)}return t}function aT(n,t,i,a={}){let{window:o=document.defaultView,v5Compat:u=!1}=a,d=o.history,m="POP",p=null,g=v();g==null&&(g=0,d.replaceState({...d.state,idx:g},""));function v(){return(d.state||{idx:null}).idx}function w(){m="POP";let U=v(),K=U==null?null:U-g;g=U,p&&p({action:m,location:L.location,delta:K})}function T(U,K){m="PUSH";let X=Xp(L.location,U,K);g=v()+1;let tt=hx(X,g),lt=L.createHref(X);try{d.pushState(tt,"",lt)}catch(Y){if(Y instanceof DOMException&&Y.name==="DataCloneError")throw Y;o.location.assign(lt)}u&&p&&p({action:m,location:L.location,delta:1})}function R(U,K){m="REPLACE";let X=Xp(L.location,U,K);g=v();let tt=hx(X,g),lt=L.createHref(X);d.replaceState(tt,"",lt),u&&p&&p({action:m,location:L.location,delta:0})}function M(U){return sT(U)}let L={get action(){return m},get location(){return n(o,d)},listen(U){if(p)throw new Error("A history only accepts one active listener");return o.addEventListener(cx,w),p=U,()=>{o.removeEventListener(cx,w),p=null}},createHref(U){return t(o,U)},createURL:M,encodeLocation(U){let K=M(U);return{pathname:K.pathname,search:K.search,hash:K.hash}},push:T,replace:R,go(U){return d.go(U)}};return L}function sT(n,t=!1){let i="http://localhost";typeof window<"u"&&(i=window.location.origin!=="null"?window.location.origin:window.location.href),de(i,"No window.location.(origin|href) available to create URL");let a=typeof n=="string"?n:Zl(n);return a=a.replace(/ $/,"%20"),!t&&a.startsWith("//")&&(a=i+a),new URL(a,i)}function O_(n,t,i="/"){return oT(n,t,i,!1)}function oT(n,t,i,a){let o=typeof t=="string"?xo(t):t,u=sr(o.pathname||"/",i);if(u==null)return null;let d=V_(n);lT(d);let m=null;for(let p=0;m==null&&p<d.length;++p){let g=vT(u);m=yT(d[p],g,a)}return m}function V_(n,t=[],i=[],a="",o=!1){let u=(d,m,p=o,g)=>{let v={relativePath:g===void 0?d.path||"":g,caseSensitive:d.caseSensitive===!0,childrenIndex:m,route:d};if(v.relativePath.startsWith("/")){if(!v.relativePath.startsWith(a)&&p)return;de(v.relativePath.startsWith(a),`Absolute route path "${v.relativePath}" nested under path "${a}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),v.relativePath=v.relativePath.slice(a.length)}let w=ir([a,v.relativePath]),T=i.concat(v);d.children&&d.children.length>0&&(de(d.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${w}".`),V_(d.children,t,T,w,p)),!(d.path==null&&!d.index)&&t.push({path:w,score:mT(w,d.index),routesMeta:T})};return n.forEach((d,m)=>{if(d.path===""||!d.path?.includes("?"))u(d,m);else for(let p of k_(d.path))u(d,m,!0,p)}),t}function k_(n){let t=n.split("/");if(t.length===0)return[];let[i,...a]=t,o=i.endsWith("?"),u=i.replace(/\?$/,"");if(a.length===0)return o?[u,""]:[u];let d=k_(a.join("/")),m=[];return m.push(...d.map(p=>p===""?u:[u,p].join("/"))),o&&m.push(...d),m.map(p=>n.startsWith("/")&&p===""?"/":p)}function lT(n){n.sort((t,i)=>t.score!==i.score?i.score-t.score:gT(t.routesMeta.map(a=>a.childrenIndex),i.routesMeta.map(a=>a.childrenIndex)))}var uT=/^:[\w-]+$/,cT=3,hT=2,dT=1,fT=10,pT=-2,dx=n=>n==="*";function mT(n,t){let i=n.split("/"),a=i.length;return i.some(dx)&&(a+=pT),t&&(a+=hT),i.filter(o=>!dx(o)).reduce((o,u)=>o+(uT.test(u)?cT:u===""?dT:fT),a)}function gT(n,t){return n.length===t.length&&n.slice(0,-1).every((a,o)=>a===t[o])?n[n.length-1]-t[t.length-1]:0}function yT(n,t,i=!1){let{routesMeta:a}=n,o={},u="/",d=[];for(let m=0;m<a.length;++m){let p=a[m],g=m===a.length-1,v=u==="/"?t:t.slice(u.length)||"/",w=vh({path:p.relativePath,caseSensitive:p.caseSensitive,end:g},v),T=p.route;if(!w&&g&&i&&!a[a.length-1].route.index&&(w=vh({path:p.relativePath,caseSensitive:p.caseSensitive,end:!1},v)),!w)return null;Object.assign(o,w.params),d.push({params:o,pathname:ir([u,w.pathname]),pathnameBase:bT(ir([u,w.pathnameBase])),route:T}),w.pathnameBase!=="/"&&(u=ir([u,w.pathnameBase]))}return d}function vh(n,t){typeof n=="string"&&(n={path:n,caseSensitive:!1,end:!0});let[i,a]=xT(n.path,n.caseSensitive,n.end),o=t.match(i);if(!o)return null;let u=o[0],d=u.replace(/(.)\/+$/,"$1"),m=o.slice(1);return{params:a.reduce((g,{paramName:v,isOptional:w},T)=>{if(v==="*"){let M=m[T]||"";d=u.slice(0,u.length-M.length).replace(/(.)\/+$/,"$1")}const R=m[T];return w&&!R?g[v]=void 0:g[v]=(R||"").replace(/%2F/g,"/"),g},{}),pathname:u,pathnameBase:d,pattern:n}}function xT(n,t=!1,i=!0){ri(n==="*"||!n.endsWith("*")||n.endsWith("/*"),`Route path "${n}" will be treated as if it were "${n.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${n.replace(/\*$/,"/*")}".`);let a=[],o="^"+n.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(d,m,p)=>(a.push({paramName:m,isOptional:p!=null}),p?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return n.endsWith("*")?(a.push({paramName:"*"}),o+=n==="*"||n==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):i?o+="\\/*$":n!==""&&n!=="/"&&(o+="(?:(?=\\/|$))"),[new RegExp(o,t?void 0:"i"),a]}function vT(n){try{return n.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return ri(!1,`The URL path "${n}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${t}).`),n}}function sr(n,t){if(t==="/")return n;if(!n.toLowerCase().startsWith(t.toLowerCase()))return null;let i=t.endsWith("/")?t.length-1:t.length,a=n.charAt(i);return a&&a!=="/"?null:n.slice(i)||"/"}function _T(n,t="/"){let{pathname:i,search:a="",hash:o=""}=typeof n=="string"?xo(n):n;return{pathname:i?i.startsWith("/")?i:ET(i,t):t,search:TT(a),hash:ST(o)}}function ET(n,t){let i=t.replace(/\/+$/,"").split("/");return n.split("/").forEach(o=>{o===".."?i.length>1&&i.pop():o!=="."&&i.push(o)}),i.length>1?i.join("/"):"/"}function hp(n,t,i,a){return`Cannot include a '${n}' character in a manually specified \`to.${t}\` field [${JSON.stringify(a)}].  Please separate it out to the \`to.${i}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function wT(n){return n.filter((t,i)=>i===0||t.route.path&&t.route.path.length>0)}function km(n){let t=wT(n);return t.map((i,a)=>a===t.length-1?i.pathname:i.pathnameBase)}function Pm(n,t,i,a=!1){let o;typeof n=="string"?o=xo(n):(o={...n},de(!o.pathname||!o.pathname.includes("?"),hp("?","pathname","search",o)),de(!o.pathname||!o.pathname.includes("#"),hp("#","pathname","hash",o)),de(!o.search||!o.search.includes("#"),hp("#","search","hash",o)));let u=n===""||o.pathname==="",d=u?"/":o.pathname,m;if(d==null)m=i;else{let w=t.length-1;if(!a&&d.startsWith("..")){let T=d.split("/");for(;T[0]==="..";)T.shift(),w-=1;o.pathname=T.join("/")}m=w>=0?t[w]:"/"}let p=_T(o,m),g=d&&d!=="/"&&d.endsWith("/"),v=(u||d===".")&&i.endsWith("/");return!p.pathname.endsWith("/")&&(g||v)&&(p.pathname+="/"),p}var ir=n=>n.join("/").replace(/\/\/+/g,"/"),bT=n=>n.replace(/\/+$/,"").replace(/^\/*/,"/"),TT=n=>!n||n==="?"?"":n.startsWith("?")?n:"?"+n,ST=n=>!n||n==="#"?"":n.startsWith("#")?n:"#"+n;function AT(n){return n!=null&&typeof n.status=="number"&&typeof n.statusText=="string"&&typeof n.internal=="boolean"&&"data"in n}var P_=["POST","PUT","PATCH","DELETE"];new Set(P_);var RT=["GET",...P_];new Set(RT);var vo=B.createContext(null);vo.displayName="DataRouter";var Uh=B.createContext(null);Uh.displayName="DataRouterState";B.createContext(!1);var U_=B.createContext({isTransitioning:!1});U_.displayName="ViewTransition";var IT=B.createContext(new Map);IT.displayName="Fetchers";var jT=B.createContext(null);jT.displayName="Await";var si=B.createContext(null);si.displayName="Navigation";var _o=B.createContext(null);_o.displayName="Location";var Kn=B.createContext({outlet:null,matches:[],isDataRoute:!1});Kn.displayName="Route";var Um=B.createContext(null);Um.displayName="RouteError";function CT(n,{relative:t}={}){de(Eo(),"useHref() may be used only in the context of a <Router> component.");let{basename:i,navigator:a}=B.useContext(si),{hash:o,pathname:u,search:d}=fu(n,{relative:t}),m=u;return i!=="/"&&(m=u==="/"?i:ir([i,u])),a.createHref({pathname:m,search:d,hash:o})}function Eo(){return B.useContext(_o)!=null}function Di(){return de(Eo(),"useLocation() may be used only in the context of a <Router> component."),B.useContext(_o).location}function DT(){return B.useContext(_o).navigationType}var L_="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function z_(n){B.useContext(si).static||B.useLayoutEffect(n)}function Lh(){let{isDataRoute:n}=B.useContext(Kn);return n?GT():NT()}function NT(){de(Eo(),"useNavigate() may be used only in the context of a <Router> component.");let n=B.useContext(vo),{basename:t,navigator:i}=B.useContext(si),{matches:a}=B.useContext(Kn),{pathname:o}=Di(),u=JSON.stringify(km(a)),d=B.useRef(!1);return z_(()=>{d.current=!0}),B.useCallback((p,g={})=>{if(ri(d.current,L_),!d.current)return;if(typeof p=="number"){i.go(p);return}let v=Pm(p,JSON.parse(u),o,g.relative==="path");n==null&&t!=="/"&&(v.pathname=v.pathname==="/"?t:ir([t,v.pathname])),(g.replace?i.replace:i.push)(v,g.state,g)},[t,i,u,o,n])}var MT=B.createContext(null);function OT(n){let t=B.useContext(Kn).outlet;return t&&B.createElement(MT.Provider,{value:n},t)}function VT(){let{matches:n}=B.useContext(Kn),t=n[n.length-1];return t?t.params:{}}function fu(n,{relative:t}={}){let{matches:i}=B.useContext(Kn),{pathname:a}=Di(),o=JSON.stringify(km(i));return B.useMemo(()=>Pm(n,JSON.parse(o),a,t==="path"),[n,o,a,t])}function kT(n,t){return $_(n,t)}function $_(n,t,i,a,o){de(Eo(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:u}=B.useContext(si),{matches:d}=B.useContext(Kn),m=d[d.length-1],p=m?m.params:{},g=m?m.pathname:"/",v=m?m.pathnameBase:"/",w=m&&m.route;{let X=w&&w.path||"";B_(g,!w||X.endsWith("*")||X.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${g}" (under <Route path="${X}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${X}"> to <Route path="${X==="/"?"*":`${X}/*`}">.`)}let T=Di(),R;if(t){let X=typeof t=="string"?xo(t):t;de(v==="/"||X.pathname?.startsWith(v),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${v}" but pathname "${X.pathname}" was given in the \`location\` prop.`),R=X}else R=T;let M=R.pathname||"/",L=M;if(v!=="/"){let X=v.replace(/^\//,"").split("/");L="/"+M.replace(/^\//,"").split("/").slice(X.length).join("/")}let U=O_(n,{pathname:L});ri(w||U!=null,`No routes matched location "${R.pathname}${R.search}${R.hash}" `),ri(U==null||U[U.length-1].route.element!==void 0||U[U.length-1].route.Component!==void 0||U[U.length-1].route.lazy!==void 0,`Matched leaf route at location "${R.pathname}${R.search}${R.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let K=$T(U&&U.map(X=>Object.assign({},X,{params:Object.assign({},p,X.params),pathname:ir([v,u.encodeLocation?u.encodeLocation(X.pathname).pathname:X.pathname]),pathnameBase:X.pathnameBase==="/"?v:ir([v,u.encodeLocation?u.encodeLocation(X.pathnameBase).pathname:X.pathnameBase])})),d,i,a,o);return t&&K?B.createElement(_o.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...R},navigationType:"POP"}},K):K}function PT(){let n=HT(),t=AT(n)?`${n.status} ${n.statusText}`:n instanceof Error?n.message:JSON.stringify(n),i=n instanceof Error?n.stack:null,a="rgba(200,200,200, 0.5)",o={padding:"0.5rem",backgroundColor:a},u={padding:"2px 4px",backgroundColor:a},d=null;return console.error("Error handled by React Router default ErrorBoundary:",n),d=B.createElement(B.Fragment,null,B.createElement("p",null,"💿 Hey developer 👋"),B.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",B.createElement("code",{style:u},"ErrorBoundary")," or"," ",B.createElement("code",{style:u},"errorElement")," prop on your route.")),B.createElement(B.Fragment,null,B.createElement("h2",null,"Unexpected Application Error!"),B.createElement("h3",{style:{fontStyle:"italic"}},t),i?B.createElement("pre",{style:o},i):null,d)}var UT=B.createElement(PT,null),LT=class extends B.Component{constructor(n){super(n),this.state={location:n.location,revalidation:n.revalidation,error:n.error}}static getDerivedStateFromError(n){return{error:n}}static getDerivedStateFromProps(n,t){return t.location!==n.location||t.revalidation!=="idle"&&n.revalidation==="idle"?{error:n.error,location:n.location,revalidation:n.revalidation}:{error:n.error!==void 0?n.error:t.error,location:t.location,revalidation:n.revalidation||t.revalidation}}componentDidCatch(n,t){this.props.unstable_onError?this.props.unstable_onError(n,t):console.error("React Router caught the following error during render",n)}render(){return this.state.error!==void 0?B.createElement(Kn.Provider,{value:this.props.routeContext},B.createElement(Um.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function zT({routeContext:n,match:t,children:i}){let a=B.useContext(vo);return a&&a.static&&a.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(a.staticContext._deepestRenderedBoundaryId=t.route.id),B.createElement(Kn.Provider,{value:n},i)}function $T(n,t=[],i=null,a=null,o=null){if(n==null){if(!i)return null;if(i.errors)n=i.matches;else if(t.length===0&&!i.initialized&&i.matches.length>0)n=i.matches;else return null}let u=n,d=i?.errors;if(d!=null){let g=u.findIndex(v=>v.route.id&&d?.[v.route.id]!==void 0);de(g>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(d).join(",")}`),u=u.slice(0,Math.min(u.length,g+1))}let m=!1,p=-1;if(i)for(let g=0;g<u.length;g++){let v=u[g];if((v.route.HydrateFallback||v.route.hydrateFallbackElement)&&(p=g),v.route.id){let{loaderData:w,errors:T}=i,R=v.route.loader&&!w.hasOwnProperty(v.route.id)&&(!T||T[v.route.id]===void 0);if(v.route.lazy||R){m=!0,p>=0?u=u.slice(0,p+1):u=[u[0]];break}}}return u.reduceRight((g,v,w)=>{let T,R=!1,M=null,L=null;i&&(T=d&&v.route.id?d[v.route.id]:void 0,M=v.route.errorElement||UT,m&&(p<0&&w===0?(B_("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),R=!0,L=null):p===w&&(R=!0,L=v.route.hydrateFallbackElement||null)));let U=t.concat(u.slice(0,w+1)),K=()=>{let X;return T?X=M:R?X=L:v.route.Component?X=B.createElement(v.route.Component,null):v.route.element?X=v.route.element:X=g,B.createElement(zT,{match:v,routeContext:{outlet:g,matches:U,isDataRoute:i!=null},children:X})};return i&&(v.route.ErrorBoundary||v.route.errorElement||w===0)?B.createElement(LT,{location:i.location,revalidation:i.revalidation,component:M,error:T,children:K(),routeContext:{outlet:null,matches:U,isDataRoute:!0},unstable_onError:a}):K()},null)}function Lm(n){return`${n} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function BT(n){let t=B.useContext(vo);return de(t,Lm(n)),t}function FT(n){let t=B.useContext(Uh);return de(t,Lm(n)),t}function qT(n){let t=B.useContext(Kn);return de(t,Lm(n)),t}function zm(n){let t=qT(n),i=t.matches[t.matches.length-1];return de(i.route.id,`${n} can only be used on routes that contain a unique "id"`),i.route.id}function KT(){return zm("useRouteId")}function HT(){let n=B.useContext(Um),t=FT("useRouteError"),i=zm("useRouteError");return n!==void 0?n:t.errors?.[i]}function GT(){let{router:n}=BT("useNavigate"),t=zm("useNavigate"),i=B.useRef(!1);return z_(()=>{i.current=!0}),B.useCallback(async(o,u={})=>{ri(i.current,L_),i.current&&(typeof o=="number"?n.navigate(o):await n.navigate(o,{fromRouteId:t,...u}))},[n,t])}var fx={};function B_(n,t,i){!t&&!fx[n]&&(fx[n]=!0,ri(!1,i))}B.memo(YT);function YT({routes:n,future:t,state:i,unstable_onError:a}){return $_(n,void 0,i,a,t)}function QT({to:n,replace:t,state:i,relative:a}){de(Eo(),"<Navigate> may be used only in the context of a <Router> component.");let{static:o}=B.useContext(si);ri(!o,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:u}=B.useContext(Kn),{pathname:d}=Di(),m=Lh(),p=Pm(n,km(u),d,a==="path"),g=JSON.stringify(p);return B.useEffect(()=>{m(JSON.parse(g),{replace:t,state:i,relative:a})},[m,g,a,t,i]),null}function XT(n){return OT(n.context)}function wi(n){de(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function WT({basename:n="/",children:t=null,location:i,navigationType:a="POP",navigator:o,static:u=!1}){de(!Eo(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let d=n.replace(/^\/*/,"/"),m=B.useMemo(()=>({basename:d,navigator:o,static:u,future:{}}),[d,o,u]);typeof i=="string"&&(i=xo(i));let{pathname:p="/",search:g="",hash:v="",state:w=null,key:T="default"}=i,R=B.useMemo(()=>{let M=sr(p,d);return M==null?null:{location:{pathname:M,search:g,hash:v,state:w,key:T},navigationType:a}},[d,p,g,v,w,T,a]);return ri(R!=null,`<Router basename="${d}"> is not able to match the URL "${p}${g}${v}" because it does not start with the basename, so the <Router> won't render anything.`),R==null?null:B.createElement(si.Provider,{value:m},B.createElement(_o.Provider,{children:t,value:R}))}function ZT({children:n,location:t}){return kT(Wp(n),t)}function Wp(n,t=[]){let i=[];return B.Children.forEach(n,(a,o)=>{if(!B.isValidElement(a))return;let u=[...t,o];if(a.type===B.Fragment){i.push.apply(i,Wp(a.props.children,u));return}de(a.type===wi,`[${typeof a.type=="string"?a.type:a.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),de(!a.props.index||!a.props.children,"An index route cannot have child routes.");let d={id:a.props.id||u.join("-"),caseSensitive:a.props.caseSensitive,element:a.props.element,Component:a.props.Component,index:a.props.index,path:a.props.path,loader:a.props.loader,action:a.props.action,hydrateFallbackElement:a.props.hydrateFallbackElement,HydrateFallback:a.props.HydrateFallback,errorElement:a.props.errorElement,ErrorBoundary:a.props.ErrorBoundary,hasErrorBoundary:a.props.hasErrorBoundary===!0||a.props.ErrorBoundary!=null||a.props.errorElement!=null,shouldRevalidate:a.props.shouldRevalidate,handle:a.props.handle,lazy:a.props.lazy};a.props.children&&(d.children=Wp(a.props.children,u)),i.push(d)}),i}var nh="get",ih="application/x-www-form-urlencoded";function zh(n){return n!=null&&typeof n.tagName=="string"}function JT(n){return zh(n)&&n.tagName.toLowerCase()==="button"}function tS(n){return zh(n)&&n.tagName.toLowerCase()==="form"}function eS(n){return zh(n)&&n.tagName.toLowerCase()==="input"}function nS(n){return!!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)}function iS(n,t){return n.button===0&&(!t||t==="_self")&&!nS(n)}var Fc=null;function rS(){if(Fc===null)try{new FormData(document.createElement("form"),0),Fc=!1}catch{Fc=!0}return Fc}var aS=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function dp(n){return n!=null&&!aS.has(n)?(ri(!1,`"${n}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${ih}"`),null):n}function sS(n,t){let i,a,o,u,d;if(tS(n)){let m=n.getAttribute("action");a=m?sr(m,t):null,i=n.getAttribute("method")||nh,o=dp(n.getAttribute("enctype"))||ih,u=new FormData(n)}else if(JT(n)||eS(n)&&(n.type==="submit"||n.type==="image")){let m=n.form;if(m==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let p=n.getAttribute("formaction")||m.getAttribute("action");if(a=p?sr(p,t):null,i=n.getAttribute("formmethod")||m.getAttribute("method")||nh,o=dp(n.getAttribute("formenctype"))||dp(m.getAttribute("enctype"))||ih,u=new FormData(m,n),!rS()){let{name:g,type:v,value:w}=n;if(v==="image"){let T=g?`${g}.`:"";u.append(`${T}x`,"0"),u.append(`${T}y`,"0")}else g&&u.append(g,w)}}else{if(zh(n))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');i=nh,a=null,o=ih,d=n}return u&&o==="text/plain"&&(d=u,u=void 0),{action:a,method:i.toLowerCase(),encType:o,formData:u,body:d}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function $m(n,t){if(n===!1||n===null||typeof n>"u")throw new Error(t)}function oS(n,t,i){let a=typeof n=="string"?new URL(n,typeof window>"u"?"server://singlefetch/":window.location.origin):n;return a.pathname==="/"?a.pathname=`_root.${i}`:t&&sr(a.pathname,t)==="/"?a.pathname=`${t.replace(/\/$/,"")}/_root.${i}`:a.pathname=`${a.pathname.replace(/\/$/,"")}.${i}`,a}async function lS(n,t){if(n.id in t)return t[n.id];try{let i=await import(n.module);return t[n.id]=i,i}catch(i){return console.error(`Error loading route module \`${n.module}\`, reloading page...`),console.error(i),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function uS(n){return n==null?!1:n.href==null?n.rel==="preload"&&typeof n.imageSrcSet=="string"&&typeof n.imageSizes=="string":typeof n.rel=="string"&&typeof n.href=="string"}async function cS(n,t,i){let a=await Promise.all(n.map(async o=>{let u=t.routes[o.route.id];if(u){let d=await lS(u,i);return d.links?d.links():[]}return[]}));return pS(a.flat(1).filter(uS).filter(o=>o.rel==="stylesheet"||o.rel==="preload").map(o=>o.rel==="stylesheet"?{...o,rel:"prefetch",as:"style"}:{...o,rel:"prefetch"}))}function px(n,t,i,a,o,u){let d=(p,g)=>i[g]?p.route.id!==i[g].route.id:!0,m=(p,g)=>i[g].pathname!==p.pathname||i[g].route.path?.endsWith("*")&&i[g].params["*"]!==p.params["*"];return u==="assets"?t.filter((p,g)=>d(p,g)||m(p,g)):u==="data"?t.filter((p,g)=>{let v=a.routes[p.route.id];if(!v||!v.hasLoader)return!1;if(d(p,g)||m(p,g))return!0;if(p.route.shouldRevalidate){let w=p.route.shouldRevalidate({currentUrl:new URL(o.pathname+o.search+o.hash,window.origin),currentParams:i[0]?.params||{},nextUrl:new URL(n,window.origin),nextParams:p.params,defaultShouldRevalidate:!0});if(typeof w=="boolean")return w}return!0}):[]}function hS(n,t,{includeHydrateFallback:i}={}){return dS(n.map(a=>{let o=t.routes[a.route.id];if(!o)return[];let u=[o.module];return o.clientActionModule&&(u=u.concat(o.clientActionModule)),o.clientLoaderModule&&(u=u.concat(o.clientLoaderModule)),i&&o.hydrateFallbackModule&&(u=u.concat(o.hydrateFallbackModule)),o.imports&&(u=u.concat(o.imports)),u}).flat(1))}function dS(n){return[...new Set(n)]}function fS(n){let t={},i=Object.keys(n).sort();for(let a of i)t[a]=n[a];return t}function pS(n,t){let i=new Set;return new Set(t),n.reduce((a,o)=>{let u=JSON.stringify(fS(o));return i.has(u)||(i.add(u),a.push({key:u,link:o})),a},[])}function F_(){let n=B.useContext(vo);return $m(n,"You must render this element inside a <DataRouterContext.Provider> element"),n}function mS(){let n=B.useContext(Uh);return $m(n,"You must render this element inside a <DataRouterStateContext.Provider> element"),n}var Bm=B.createContext(void 0);Bm.displayName="FrameworkContext";function q_(){let n=B.useContext(Bm);return $m(n,"You must render this element inside a <HydratedRouter> element"),n}function gS(n,t){let i=B.useContext(Bm),[a,o]=B.useState(!1),[u,d]=B.useState(!1),{onFocus:m,onBlur:p,onMouseEnter:g,onMouseLeave:v,onTouchStart:w}=t,T=B.useRef(null);B.useEffect(()=>{if(n==="render"&&d(!0),n==="viewport"){let L=K=>{K.forEach(X=>{d(X.isIntersecting)})},U=new IntersectionObserver(L,{threshold:.5});return T.current&&U.observe(T.current),()=>{U.disconnect()}}},[n]),B.useEffect(()=>{if(a){let L=setTimeout(()=>{d(!0)},100);return()=>{clearTimeout(L)}}},[a]);let R=()=>{o(!0)},M=()=>{o(!1),d(!1)};return i?n!=="intent"?[u,T,{}]:[u,T,{onFocus:Vl(m,R),onBlur:Vl(p,M),onMouseEnter:Vl(g,R),onMouseLeave:Vl(v,M),onTouchStart:Vl(w,R)}]:[!1,T,{}]}function Vl(n,t){return i=>{n&&n(i),i.defaultPrevented||t(i)}}function yS({page:n,...t}){let{router:i}=F_(),a=B.useMemo(()=>O_(i.routes,n,i.basename),[i.routes,n,i.basename]);return a?B.createElement(vS,{page:n,matches:a,...t}):null}function xS(n){let{manifest:t,routeModules:i}=q_(),[a,o]=B.useState([]);return B.useEffect(()=>{let u=!1;return cS(n,t,i).then(d=>{u||o(d)}),()=>{u=!0}},[n,t,i]),a}function vS({page:n,matches:t,...i}){let a=Di(),{manifest:o,routeModules:u}=q_(),{basename:d}=F_(),{loaderData:m,matches:p}=mS(),g=B.useMemo(()=>px(n,t,p,o,a,"data"),[n,t,p,o,a]),v=B.useMemo(()=>px(n,t,p,o,a,"assets"),[n,t,p,o,a]),w=B.useMemo(()=>{if(n===a.pathname+a.search+a.hash)return[];let M=new Set,L=!1;if(t.forEach(K=>{let X=o.routes[K.route.id];!X||!X.hasLoader||(!g.some(tt=>tt.route.id===K.route.id)&&K.route.id in m&&u[K.route.id]?.shouldRevalidate||X.hasClientLoader?L=!0:M.add(K.route.id))}),M.size===0)return[];let U=oS(n,d,"data");return L&&M.size>0&&U.searchParams.set("_routes",t.filter(K=>M.has(K.route.id)).map(K=>K.route.id).join(",")),[U.pathname+U.search]},[d,m,a,o,g,t,n,u]),T=B.useMemo(()=>hS(v,o),[v,o]),R=xS(v);return B.createElement(B.Fragment,null,w.map(M=>B.createElement("link",{key:M,rel:"prefetch",as:"fetch",href:M,...i})),T.map(M=>B.createElement("link",{key:M,rel:"modulepreload",href:M,...i})),R.map(({key:M,link:L})=>B.createElement("link",{key:M,nonce:i.nonce,...L})))}function _S(...n){return t=>{n.forEach(i=>{typeof i=="function"?i(t):i!=null&&(i.current=t)})}}var K_=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{K_&&(window.__reactRouterVersion="7.9.1")}catch{}function ES({basename:n,children:t,window:i}){let a=B.useRef();a.current==null&&(a.current=iT({window:i,v5Compat:!0}));let o=a.current,[u,d]=B.useState({action:o.action,location:o.location}),m=B.useCallback(p=>{B.startTransition(()=>d(p))},[d]);return B.useLayoutEffect(()=>o.listen(m),[o,m]),B.createElement(WT,{basename:n,children:t,location:u.location,navigationType:u.action,navigator:o})}var H_=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,ns=B.forwardRef(function({onClick:t,discover:i="render",prefetch:a="none",relative:o,reloadDocument:u,replace:d,state:m,target:p,to:g,preventScrollReset:v,viewTransition:w,...T},R){let{basename:M}=B.useContext(si),L=typeof g=="string"&&H_.test(g),U,K=!1;if(typeof g=="string"&&L&&(U=g,K_))try{let C=new URL(window.location.href),O=g.startsWith("//")?new URL(C.protocol+g):new URL(g),k=sr(O.pathname,M);O.origin===C.origin&&k!=null?g=k+O.search+O.hash:K=!0}catch{ri(!1,`<Link to="${g}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let X=CT(g,{relative:o}),[tt,lt,Y]=gS(a,T),ot=SS(g,{replace:d,state:m,target:p,preventScrollReset:v,relative:o,viewTransition:w});function j(C){t&&t(C),C.defaultPrevented||ot(C)}let I=B.createElement("a",{...T,...Y,href:U||X,onClick:K||u?t:j,ref:_S(R,lt),target:p,"data-discover":!L&&i==="render"?"true":void 0});return tt&&!L?B.createElement(B.Fragment,null,I,B.createElement(yS,{page:X})):I});ns.displayName="Link";var wS=B.forwardRef(function({"aria-current":t="page",caseSensitive:i=!1,className:a="",end:o=!1,style:u,to:d,viewTransition:m,children:p,...g},v){let w=fu(d,{relative:g.relative}),T=Di(),R=B.useContext(Uh),{navigator:M,basename:L}=B.useContext(si),U=R!=null&&CS(w)&&m===!0,K=M.encodeLocation?M.encodeLocation(w).pathname:w.pathname,X=T.pathname,tt=R&&R.navigation&&R.navigation.location?R.navigation.location.pathname:null;i||(X=X.toLowerCase(),tt=tt?tt.toLowerCase():null,K=K.toLowerCase()),tt&&L&&(tt=sr(tt,L)||tt);const lt=K!=="/"&&K.endsWith("/")?K.length-1:K.length;let Y=X===K||!o&&X.startsWith(K)&&X.charAt(lt)==="/",ot=tt!=null&&(tt===K||!o&&tt.startsWith(K)&&tt.charAt(K.length)==="/"),j={isActive:Y,isPending:ot,isTransitioning:U},I=Y?t:void 0,C;typeof a=="function"?C=a(j):C=[a,Y?"active":null,ot?"pending":null,U?"transitioning":null].filter(Boolean).join(" ");let O=typeof u=="function"?u(j):u;return B.createElement(ns,{...g,"aria-current":I,className:C,ref:v,style:O,to:d,viewTransition:m},typeof p=="function"?p(j):p)});wS.displayName="NavLink";var bS=B.forwardRef(({discover:n="render",fetcherKey:t,navigate:i,reloadDocument:a,replace:o,state:u,method:d=nh,action:m,onSubmit:p,relative:g,preventScrollReset:v,viewTransition:w,...T},R)=>{let M=IS(),L=jS(m,{relative:g}),U=d.toLowerCase()==="get"?"get":"post",K=typeof m=="string"&&H_.test(m),X=tt=>{if(p&&p(tt),tt.defaultPrevented)return;tt.preventDefault();let lt=tt.nativeEvent.submitter,Y=lt?.getAttribute("formmethod")||d;M(lt||tt.currentTarget,{fetcherKey:t,method:Y,navigate:i,replace:o,state:u,relative:g,preventScrollReset:v,viewTransition:w})};return B.createElement("form",{ref:R,method:U,action:L,onSubmit:a?p:X,...T,"data-discover":!K&&n==="render"?"true":void 0})});bS.displayName="Form";function TS(n){return`${n} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function G_(n){let t=B.useContext(vo);return de(t,TS(n)),t}function SS(n,{target:t,replace:i,state:a,preventScrollReset:o,relative:u,viewTransition:d}={}){let m=Lh(),p=Di(),g=fu(n,{relative:u});return B.useCallback(v=>{if(iS(v,t)){v.preventDefault();let w=i!==void 0?i:Zl(p)===Zl(g);m(n,{replace:w,state:a,preventScrollReset:o,relative:u,viewTransition:d})}},[p,m,g,i,a,t,n,o,u,d])}var AS=0,RS=()=>`__${String(++AS)}__`;function IS(){let{router:n}=G_("useSubmit"),{basename:t}=B.useContext(si),i=KT();return B.useCallback(async(a,o={})=>{let{action:u,method:d,encType:m,formData:p,body:g}=sS(a,t);if(o.navigate===!1){let v=o.fetcherKey||RS();await n.fetch(v,i,o.action||u,{preventScrollReset:o.preventScrollReset,formData:p,body:g,formMethod:o.method||d,formEncType:o.encType||m,flushSync:o.flushSync})}else await n.navigate(o.action||u,{preventScrollReset:o.preventScrollReset,formData:p,body:g,formMethod:o.method||d,formEncType:o.encType||m,replace:o.replace,state:o.state,fromRouteId:i,flushSync:o.flushSync,viewTransition:o.viewTransition})},[n,t,i])}function jS(n,{relative:t}={}){let{basename:i}=B.useContext(si),a=B.useContext(Kn);de(a,"useFormAction must be used inside a RouteContext");let[o]=a.matches.slice(-1),u={...fu(n||".",{relative:t})},d=Di();if(n==null){u.search=d.search;let m=new URLSearchParams(u.search),p=m.getAll("index");if(p.some(v=>v==="")){m.delete("index"),p.filter(w=>w).forEach(w=>m.append("index",w));let v=m.toString();u.search=v?`?${v}`:""}}return(!n||n===".")&&o.route.index&&(u.search=u.search?u.search.replace(/^\?/,"?index&"):"?index"),i!=="/"&&(u.pathname=u.pathname==="/"?i:ir([i,u.pathname])),Zl(u)}function CS(n,{relative:t}={}){let i=B.useContext(U_);de(i!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:a}=G_("useViewTransitionState"),o=fu(n,{relative:t});if(!i.isTransitioning)return!1;let u=sr(i.currentLocation.pathname,a)||i.currentLocation.pathname,d=sr(i.nextLocation.pathname,a)||i.nextLocation.pathname;return vh(o.pathname,d)!=null||vh(o.pathname,u)!=null}var fp={exports:{}},nn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var mx;function DS(){if(mx)return nn;mx=1;var n=Vm();function t(p){var g="https://react.dev/errors/"+p;if(1<arguments.length){g+="?args[]="+encodeURIComponent(arguments[1]);for(var v=2;v<arguments.length;v++)g+="&args[]="+encodeURIComponent(arguments[v])}return"Minified React error #"+p+"; visit "+g+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var a={d:{f:i,r:function(){throw Error(t(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},o=Symbol.for("react.portal");function u(p,g,v){var w=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:o,key:w==null?null:""+w,children:p,containerInfo:g,implementation:v}}var d=n.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function m(p,g){if(p==="font")return"";if(typeof g=="string")return g==="use-credentials"?g:""}return nn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=a,nn.createPortal=function(p,g){var v=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!g||g.nodeType!==1&&g.nodeType!==9&&g.nodeType!==11)throw Error(t(299));return u(p,g,null,v)},nn.flushSync=function(p){var g=d.T,v=a.p;try{if(d.T=null,a.p=2,p)return p()}finally{d.T=g,a.p=v,a.d.f()}},nn.preconnect=function(p,g){typeof p=="string"&&(g?(g=g.crossOrigin,g=typeof g=="string"?g==="use-credentials"?g:"":void 0):g=null,a.d.C(p,g))},nn.prefetchDNS=function(p){typeof p=="string"&&a.d.D(p)},nn.preinit=function(p,g){if(typeof p=="string"&&g&&typeof g.as=="string"){var v=g.as,w=m(v,g.crossOrigin),T=typeof g.integrity=="string"?g.integrity:void 0,R=typeof g.fetchPriority=="string"?g.fetchPriority:void 0;v==="style"?a.d.S(p,typeof g.precedence=="string"?g.precedence:void 0,{crossOrigin:w,integrity:T,fetchPriority:R}):v==="script"&&a.d.X(p,{crossOrigin:w,integrity:T,fetchPriority:R,nonce:typeof g.nonce=="string"?g.nonce:void 0})}},nn.preinitModule=function(p,g){if(typeof p=="string")if(typeof g=="object"&&g!==null){if(g.as==null||g.as==="script"){var v=m(g.as,g.crossOrigin);a.d.M(p,{crossOrigin:v,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0})}}else g==null&&a.d.M(p)},nn.preload=function(p,g){if(typeof p=="string"&&typeof g=="object"&&g!==null&&typeof g.as=="string"){var v=g.as,w=m(v,g.crossOrigin);a.d.L(p,v,{crossOrigin:w,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0,type:typeof g.type=="string"?g.type:void 0,fetchPriority:typeof g.fetchPriority=="string"?g.fetchPriority:void 0,referrerPolicy:typeof g.referrerPolicy=="string"?g.referrerPolicy:void 0,imageSrcSet:typeof g.imageSrcSet=="string"?g.imageSrcSet:void 0,imageSizes:typeof g.imageSizes=="string"?g.imageSizes:void 0,media:typeof g.media=="string"?g.media:void 0})}},nn.preloadModule=function(p,g){if(typeof p=="string")if(g){var v=m(g.as,g.crossOrigin);a.d.m(p,{as:typeof g.as=="string"&&g.as!=="script"?g.as:void 0,crossOrigin:v,integrity:typeof g.integrity=="string"?g.integrity:void 0})}else a.d.m(p)},nn.requestFormReset=function(p){a.d.r(p)},nn.unstable_batchedUpdates=function(p,g){return p(g)},nn.useFormState=function(p,g,v){return d.H.useFormState(p,g,v)},nn.useFormStatus=function(){return d.H.useHostTransitionStatus()},nn.version="19.1.1",nn}var gx;function NS(){if(gx)return fp.exports;gx=1;function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(t){console.error(t)}}return n(),fp.exports=DS(),fp.exports}var pp={exports:{}},mp,yx;function MS(){if(yx)return mp;yx=1;var n="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return mp=n,mp}var gp,xx;function OS(){if(xx)return gp;xx=1;var n=MS();function t(){}function i(){}return i.resetWarningCache=t,gp=function(){function a(d,m,p,g,v,w){if(w!==n){var T=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw T.name="Invariant Violation",T}}a.isRequired=a;function o(){return a}var u={array:a,bigint:a,bool:a,func:a,number:a,object:a,string:a,symbol:a,any:a,arrayOf:o,element:a,elementType:a,instanceOf:o,node:a,objectOf:o,oneOf:o,oneOfType:o,shape:o,exact:o,checkPropTypes:i,resetWarningCache:t};return u.PropTypes=u,u},gp}var vx;function VS(){return vx||(vx=1,pp.exports=OS()()),pp.exports}var kS=VS();const Z=M_(kS);var _n=function(){return _n=Object.assign||function(t){for(var i,a=1,o=arguments.length;a<o;a++){i=arguments[a];for(var u in i)Object.prototype.hasOwnProperty.call(i,u)&&(t[u]=i[u])}return t},_n.apply(this,arguments)};function Jl(n,t,i){if(i||arguments.length===2)for(var a=0,o=t.length,u;a<o;a++)(u||!(a in t))&&(u||(u=Array.prototype.slice.call(t,0,a)),u[a]=t[a]);return n.concat(u||Array.prototype.slice.call(t))}var le="-ms-",Fl="-moz-",Gt="-webkit-",Y_="comm",$h="rule",Fm="decl",PS="@import",Q_="@keyframes",US="@layer",X_=Math.abs,qm=String.fromCharCode,Zp=Object.assign;function LS(n,t){return Ke(n,0)^45?(((t<<2^Ke(n,0))<<2^Ke(n,1))<<2^Ke(n,2))<<2^Ke(n,3):0}function W_(n){return n.trim()}function nr(n,t){return(n=t.exec(n))?n[0]:n}function Nt(n,t,i){return n.replace(t,i)}function rh(n,t,i){return n.indexOf(t,i)}function Ke(n,t){return n.charCodeAt(t)|0}function ao(n,t,i){return n.slice(t,i)}function Ti(n){return n.length}function Z_(n){return n.length}function Ul(n,t){return t.push(n),n}function zS(n,t){return n.map(t).join("")}function _x(n,t){return n.filter(function(i){return!nr(i,t)})}var Bh=1,so=1,J_=0,qn=0,Ce=0,wo="";function Fh(n,t,i,a,o,u,d,m){return{value:n,root:t,parent:i,type:a,props:o,children:u,line:Bh,column:so,length:d,return:"",siblings:m}}function Xr(n,t){return Zp(Fh("",null,null,"",null,null,0,n.siblings),n,{length:-n.length},t)}function Qs(n){for(;n.root;)n=Xr(n.root,{children:[n]});Ul(n,n.siblings)}function $S(){return Ce}function BS(){return Ce=qn>0?Ke(wo,--qn):0,so--,Ce===10&&(so=1,Bh--),Ce}function ii(){return Ce=qn<J_?Ke(wo,qn++):0,so++,Ce===10&&(so=1,Bh++),Ce}function Xa(){return Ke(wo,qn)}function ah(){return qn}function qh(n,t){return ao(wo,n,t)}function Jp(n){switch(n){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function FS(n){return Bh=so=1,J_=Ti(wo=n),qn=0,[]}function qS(n){return wo="",n}function yp(n){return W_(qh(qn-1,tm(n===91?n+2:n===40?n+1:n)))}function KS(n){for(;(Ce=Xa())&&Ce<33;)ii();return Jp(n)>2||Jp(Ce)>3?"":" "}function HS(n,t){for(;--t&&ii()&&!(Ce<48||Ce>102||Ce>57&&Ce<65||Ce>70&&Ce<97););return qh(n,ah()+(t<6&&Xa()==32&&ii()==32))}function tm(n){for(;ii();)switch(Ce){case n:return qn;case 34:case 39:n!==34&&n!==39&&tm(Ce);break;case 40:n===41&&tm(n);break;case 92:ii();break}return qn}function GS(n,t){for(;ii()&&n+Ce!==57;)if(n+Ce===84&&Xa()===47)break;return"/*"+qh(t,qn-1)+"*"+qm(n===47?n:ii())}function YS(n){for(;!Jp(Xa());)ii();return qh(n,qn)}function QS(n){return qS(sh("",null,null,null,[""],n=FS(n),0,[0],n))}function sh(n,t,i,a,o,u,d,m,p){for(var g=0,v=0,w=d,T=0,R=0,M=0,L=1,U=1,K=1,X=0,tt="",lt=o,Y=u,ot=a,j=tt;U;)switch(M=X,X=ii()){case 40:if(M!=108&&Ke(j,w-1)==58){rh(j+=Nt(yp(X),"&","&\f"),"&\f",X_(g?m[g-1]:0))!=-1&&(K=-1);break}case 34:case 39:case 91:j+=yp(X);break;case 9:case 10:case 13:case 32:j+=KS(M);break;case 92:j+=HS(ah()-1,7);continue;case 47:switch(Xa()){case 42:case 47:Ul(XS(GS(ii(),ah()),t,i,p),p);break;default:j+="/"}break;case 123*L:m[g++]=Ti(j)*K;case 125*L:case 59:case 0:switch(X){case 0:case 125:U=0;case 59+v:K==-1&&(j=Nt(j,/\f/g,"")),R>0&&Ti(j)-w&&Ul(R>32?wx(j+";",a,i,w-1,p):wx(Nt(j," ","")+";",a,i,w-2,p),p);break;case 59:j+=";";default:if(Ul(ot=Ex(j,t,i,g,v,o,m,tt,lt=[],Y=[],w,u),u),X===123)if(v===0)sh(j,t,ot,ot,lt,u,w,m,Y);else switch(T===99&&Ke(j,3)===110?100:T){case 100:case 108:case 109:case 115:sh(n,ot,ot,a&&Ul(Ex(n,ot,ot,0,0,o,m,tt,o,lt=[],w,Y),Y),o,Y,w,m,a?lt:Y);break;default:sh(j,ot,ot,ot,[""],Y,0,m,Y)}}g=v=R=0,L=K=1,tt=j="",w=d;break;case 58:w=1+Ti(j),R=M;default:if(L<1){if(X==123)--L;else if(X==125&&L++==0&&BS()==125)continue}switch(j+=qm(X),X*L){case 38:K=v>0?1:(j+="\f",-1);break;case 44:m[g++]=(Ti(j)-1)*K,K=1;break;case 64:Xa()===45&&(j+=yp(ii())),T=Xa(),v=w=Ti(tt=j+=YS(ah())),X++;break;case 45:M===45&&Ti(j)==2&&(L=0)}}return u}function Ex(n,t,i,a,o,u,d,m,p,g,v,w){for(var T=o-1,R=o===0?u:[""],M=Z_(R),L=0,U=0,K=0;L<a;++L)for(var X=0,tt=ao(n,T+1,T=X_(U=d[L])),lt=n;X<M;++X)(lt=W_(U>0?R[X]+" "+tt:Nt(tt,/&\f/g,R[X])))&&(p[K++]=lt);return Fh(n,t,i,o===0?$h:m,p,g,v,w)}function XS(n,t,i,a){return Fh(n,t,i,Y_,qm($S()),ao(n,2,-2),0,a)}function wx(n,t,i,a,o){return Fh(n,t,i,Fm,ao(n,0,a),ao(n,a+1,-1),a,o)}function t2(n,t,i){switch(LS(n,t)){case 5103:return Gt+"print-"+n+n;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return Gt+n+n;case 4789:return Fl+n+n;case 5349:case 4246:case 4810:case 6968:case 2756:return Gt+n+Fl+n+le+n+n;case 5936:switch(Ke(n,t+11)){case 114:return Gt+n+le+Nt(n,/[svh]\w+-[tblr]{2}/,"tb")+n;case 108:return Gt+n+le+Nt(n,/[svh]\w+-[tblr]{2}/,"tb-rl")+n;case 45:return Gt+n+le+Nt(n,/[svh]\w+-[tblr]{2}/,"lr")+n}case 6828:case 4268:case 2903:return Gt+n+le+n+n;case 6165:return Gt+n+le+"flex-"+n+n;case 5187:return Gt+n+Nt(n,/(\w+).+(:[^]+)/,Gt+"box-$1$2"+le+"flex-$1$2")+n;case 5443:return Gt+n+le+"flex-item-"+Nt(n,/flex-|-self/g,"")+(nr(n,/flex-|baseline/)?"":le+"grid-row-"+Nt(n,/flex-|-self/g,""))+n;case 4675:return Gt+n+le+"flex-line-pack"+Nt(n,/align-content|flex-|-self/g,"")+n;case 5548:return Gt+n+le+Nt(n,"shrink","negative")+n;case 5292:return Gt+n+le+Nt(n,"basis","preferred-size")+n;case 6060:return Gt+"box-"+Nt(n,"-grow","")+Gt+n+le+Nt(n,"grow","positive")+n;case 4554:return Gt+Nt(n,/([^-])(transform)/g,"$1"+Gt+"$2")+n;case 6187:return Nt(Nt(Nt(n,/(zoom-|grab)/,Gt+"$1"),/(image-set)/,Gt+"$1"),n,"")+n;case 5495:case 3959:return Nt(n,/(image-set\([^]*)/,Gt+"$1$`$1");case 4968:return Nt(Nt(n,/(.+:)(flex-)?(.*)/,Gt+"box-pack:$3"+le+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+Gt+n+n;case 4200:if(!nr(n,/flex-|baseline/))return le+"grid-column-align"+ao(n,t)+n;break;case 2592:case 3360:return le+Nt(n,"template-","")+n;case 4384:case 3616:return i&&i.some(function(a,o){return t=o,nr(a.props,/grid-\w+-end/)})?~rh(n+(i=i[t].value),"span",0)?n:le+Nt(n,"-start","")+n+le+"grid-row-span:"+(~rh(i,"span",0)?nr(i,/\d+/):+nr(i,/\d+/)-+nr(n,/\d+/))+";":le+Nt(n,"-start","")+n;case 4896:case 4128:return i&&i.some(function(a){return nr(a.props,/grid-\w+-start/)})?n:le+Nt(Nt(n,"-end","-span"),"span ","")+n;case 4095:case 3583:case 4068:case 2532:return Nt(n,/(.+)-inline(.+)/,Gt+"$1$2")+n;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(Ti(n)-1-t>6)switch(Ke(n,t+1)){case 109:if(Ke(n,t+4)!==45)break;case 102:return Nt(n,/(.+:)(.+)-([^]+)/,"$1"+Gt+"$2-$3$1"+Fl+(Ke(n,t+3)==108?"$3":"$2-$3"))+n;case 115:return~rh(n,"stretch",0)?t2(Nt(n,"stretch","fill-available"),t,i)+n:n}break;case 5152:case 5920:return Nt(n,/(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/,function(a,o,u,d,m,p,g){return le+o+":"+u+g+(d?le+o+"-span:"+(m?p:+p-+u)+g:"")+n});case 4949:if(Ke(n,t+6)===121)return Nt(n,":",":"+Gt)+n;break;case 6444:switch(Ke(n,Ke(n,14)===45?18:11)){case 120:return Nt(n,/(.+:)([^;\s!]+)(;|(\s+)?!.+)?/,"$1"+Gt+(Ke(n,14)===45?"inline-":"")+"box$3$1"+Gt+"$2$3$1"+le+"$2box$3")+n;case 100:return Nt(n,":",":"+le)+n}break;case 5719:case 2647:case 2135:case 3927:case 2391:return Nt(n,"scroll-","scroll-snap-")+n}return n}function _h(n,t){for(var i="",a=0;a<n.length;a++)i+=t(n[a],a,n,t)||"";return i}function WS(n,t,i,a){switch(n.type){case US:if(n.children.length)break;case PS:case Fm:return n.return=n.return||n.value;case Y_:return"";case Q_:return n.return=n.value+"{"+_h(n.children,a)+"}";case $h:if(!Ti(n.value=n.props.join(",")))return""}return Ti(i=_h(n.children,a))?n.return=n.value+"{"+i+"}":""}function ZS(n){var t=Z_(n);return function(i,a,o,u){for(var d="",m=0;m<t;m++)d+=n[m](i,a,o,u)||"";return d}}function JS(n){return function(t){t.root||(t=t.return)&&n(t)}}function t4(n,t,i,a){if(n.length>-1&&!n.return)switch(n.type){case Fm:n.return=t2(n.value,n.length,i);return;case Q_:return _h([Xr(n,{value:Nt(n.value,"@","@"+Gt)})],a);case $h:if(n.length)return zS(i=n.props,function(o){switch(nr(o,a=/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":Qs(Xr(n,{props:[Nt(o,/:(read-\w+)/,":"+Fl+"$1")]})),Qs(Xr(n,{props:[o]})),Zp(n,{props:_x(i,a)});break;case"::placeholder":Qs(Xr(n,{props:[Nt(o,/:(plac\w+)/,":"+Gt+"input-$1")]})),Qs(Xr(n,{props:[Nt(o,/:(plac\w+)/,":"+Fl+"$1")]})),Qs(Xr(n,{props:[Nt(o,/:(plac\w+)/,le+"input-$1")]})),Qs(Xr(n,{props:[o]})),Zp(n,{props:_x(i,a)});break}return""})}}var e4={animationIterationCount:1,aspectRatio:1,borderImageOutset:1,borderImageSlice:1,borderImageWidth:1,boxFlex:1,boxFlexGroup:1,boxOrdinalGroup:1,columnCount:1,columns:1,flex:1,flexGrow:1,flexPositive:1,flexShrink:1,flexNegative:1,flexOrder:1,gridRow:1,gridRowEnd:1,gridRowSpan:1,gridRowStart:1,gridColumn:1,gridColumnEnd:1,gridColumnSpan:1,gridColumnStart:1,msGridRow:1,msGridRowSpan:1,msGridColumn:1,msGridColumnSpan:1,fontWeight:1,lineHeight:1,opacity:1,order:1,orphans:1,tabSize:1,widows:1,zIndex:1,zoom:1,WebkitLineClamp:1,fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},jn={},oo=typeof process<"u"&&jn!==void 0&&(jn.REACT_APP_SC_ATTR||jn.SC_ATTR)||"data-styled",e2="active",n2="data-styled-version",Kh="6.1.19",Km=`/*!sc*/
`,Eh=typeof window<"u"&&typeof document<"u",n4=!!(typeof SC_DISABLE_SPEEDY=="boolean"?SC_DISABLE_SPEEDY:typeof process<"u"&&jn!==void 0&&jn.REACT_APP_SC_DISABLE_SPEEDY!==void 0&&jn.REACT_APP_SC_DISABLE_SPEEDY!==""?jn.REACT_APP_SC_DISABLE_SPEEDY!=="false"&&jn.REACT_APP_SC_DISABLE_SPEEDY:typeof process<"u"&&jn!==void 0&&jn.SC_DISABLE_SPEEDY!==void 0&&jn.SC_DISABLE_SPEEDY!==""&&jn.SC_DISABLE_SPEEDY!=="false"&&jn.SC_DISABLE_SPEEDY),Hh=Object.freeze([]),lo=Object.freeze({});function i4(n,t,i){return i===void 0&&(i=lo),n.theme!==i.theme&&n.theme||t||i.theme}var i2=new Set(["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","tr","track","u","ul","use","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"]),r4=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,a4=/(^-|-$)/g;function bx(n){return n.replace(r4,"-").replace(a4,"")}var s4=/(a)(d)/gi,qc=52,Tx=function(n){return String.fromCharCode(n+(n>25?39:97))};function em(n){var t,i="";for(t=Math.abs(n);t>qc;t=t/qc|0)i=Tx(t%qc)+i;return(Tx(t%qc)+i).replace(s4,"$1-$2")}var xp,r2=5381,eo=function(n,t){for(var i=t.length;i;)n=33*n^t.charCodeAt(--i);return n},a2=function(n){return eo(r2,n)};function s2(n){return em(a2(n)>>>0)}function o4(n){return n.displayName||n.name||"Component"}function vp(n){return typeof n=="string"&&!0}var o2=typeof Symbol=="function"&&Symbol.for,l2=o2?Symbol.for("react.memo"):60115,l4=o2?Symbol.for("react.forward_ref"):60112,u4={childContextTypes:!0,contextType:!0,contextTypes:!0,defaultProps:!0,displayName:!0,getDefaultProps:!0,getDerivedStateFromError:!0,getDerivedStateFromProps:!0,mixins:!0,propTypes:!0,type:!0},c4={name:!0,length:!0,prototype:!0,caller:!0,callee:!0,arguments:!0,arity:!0},u2={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},h4=((xp={})[l4]={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},xp[l2]=u2,xp);function Sx(n){return("type"in(t=n)&&t.type.$$typeof)===l2?u2:"$$typeof"in n?h4[n.$$typeof]:u4;var t}var d4=Object.defineProperty,f4=Object.getOwnPropertyNames,Ax=Object.getOwnPropertySymbols,p4=Object.getOwnPropertyDescriptor,m4=Object.getPrototypeOf,Rx=Object.prototype;function c2(n,t,i){if(typeof t!="string"){if(Rx){var a=m4(t);a&&a!==Rx&&c2(n,a,i)}var o=f4(t);Ax&&(o=o.concat(Ax(t)));for(var u=Sx(n),d=Sx(t),m=0;m<o.length;++m){var p=o[m];if(!(p in c4||i&&i[p]||d&&p in d||u&&p in u)){var g=p4(t,p);try{d4(n,p,g)}catch{}}}}return n}function uo(n){return typeof n=="function"}function Hm(n){return typeof n=="object"&&"styledComponentId"in n}function Ya(n,t){return n&&t?"".concat(n," ").concat(t):n||t||""}function nm(n,t){if(n.length===0)return"";for(var i=n[0],a=1;a<n.length;a++)i+=n[a];return i}function tu(n){return n!==null&&typeof n=="object"&&n.constructor.name===Object.name&&!("props"in n&&n.$$typeof)}function im(n,t,i){if(i===void 0&&(i=!1),!i&&!tu(n)&&!Array.isArray(n))return t;if(Array.isArray(t))for(var a=0;a<t.length;a++)n[a]=im(n[a],t[a]);else if(tu(t))for(var a in t)n[a]=im(n[a],t[a]);return n}function Gm(n,t){Object.defineProperty(n,"toString",{value:t})}function pu(n){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];return new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(n," for more information.").concat(t.length>0?" Args: ".concat(t.join(", ")):""))}var g4=(function(){function n(t){this.groupSizes=new Uint32Array(512),this.length=512,this.tag=t}return n.prototype.indexOfGroup=function(t){for(var i=0,a=0;a<t;a++)i+=this.groupSizes[a];return i},n.prototype.insertRules=function(t,i){if(t>=this.groupSizes.length){for(var a=this.groupSizes,o=a.length,u=o;t>=u;)if((u<<=1)<0)throw pu(16,"".concat(t));this.groupSizes=new Uint32Array(u),this.groupSizes.set(a),this.length=u;for(var d=o;d<u;d++)this.groupSizes[d]=0}for(var m=this.indexOfGroup(t+1),p=(d=0,i.length);d<p;d++)this.tag.insertRule(m,i[d])&&(this.groupSizes[t]++,m++)},n.prototype.clearGroup=function(t){if(t<this.length){var i=this.groupSizes[t],a=this.indexOfGroup(t),o=a+i;this.groupSizes[t]=0;for(var u=a;u<o;u++)this.tag.deleteRule(a)}},n.prototype.getGroup=function(t){var i="";if(t>=this.length||this.groupSizes[t]===0)return i;for(var a=this.groupSizes[t],o=this.indexOfGroup(t),u=o+a,d=o;d<u;d++)i+="".concat(this.tag.getRule(d)).concat(Km);return i},n})(),oh=new Map,wh=new Map,lh=1,Kc=function(n){if(oh.has(n))return oh.get(n);for(;wh.has(lh);)lh++;var t=lh++;return oh.set(n,t),wh.set(t,n),t},y4=function(n,t){lh=t+1,oh.set(n,t),wh.set(t,n)},x4="style[".concat(oo,"][").concat(n2,'="').concat(Kh,'"]'),v4=new RegExp("^".concat(oo,'\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')),_4=function(n,t,i){for(var a,o=i.split(","),u=0,d=o.length;u<d;u++)(a=o[u])&&n.registerName(t,a)},E4=function(n,t){for(var i,a=((i=t.textContent)!==null&&i!==void 0?i:"").split(Km),o=[],u=0,d=a.length;u<d;u++){var m=a[u].trim();if(m){var p=m.match(v4);if(p){var g=0|parseInt(p[1],10),v=p[2];g!==0&&(y4(v,g),_4(n,v,p[3]),n.getTag().insertRules(g,o)),o.length=0}else o.push(m)}}},Ix=function(n){for(var t=document.querySelectorAll(x4),i=0,a=t.length;i<a;i++){var o=t[i];o&&o.getAttribute(oo)!==e2&&(E4(n,o),o.parentNode&&o.parentNode.removeChild(o))}};function w4(){return typeof __webpack_nonce__<"u"?__webpack_nonce__:null}var h2=function(n){var t=document.head,i=n||t,a=document.createElement("style"),o=(function(m){var p=Array.from(m.querySelectorAll("style[".concat(oo,"]")));return p[p.length-1]})(i),u=o!==void 0?o.nextSibling:null;a.setAttribute(oo,e2),a.setAttribute(n2,Kh);var d=w4();return d&&a.setAttribute("nonce",d),i.insertBefore(a,u),a},b4=(function(){function n(t){this.element=h2(t),this.element.appendChild(document.createTextNode("")),this.sheet=(function(i){if(i.sheet)return i.sheet;for(var a=document.styleSheets,o=0,u=a.length;o<u;o++){var d=a[o];if(d.ownerNode===i)return d}throw pu(17)})(this.element),this.length=0}return n.prototype.insertRule=function(t,i){try{return this.sheet.insertRule(i,t),this.length++,!0}catch{return!1}},n.prototype.deleteRule=function(t){this.sheet.deleteRule(t),this.length--},n.prototype.getRule=function(t){var i=this.sheet.cssRules[t];return i&&i.cssText?i.cssText:""},n})(),T4=(function(){function n(t){this.element=h2(t),this.nodes=this.element.childNodes,this.length=0}return n.prototype.insertRule=function(t,i){if(t<=this.length&&t>=0){var a=document.createTextNode(i);return this.element.insertBefore(a,this.nodes[t]||null),this.length++,!0}return!1},n.prototype.deleteRule=function(t){this.element.removeChild(this.nodes[t]),this.length--},n.prototype.getRule=function(t){return t<this.length?this.nodes[t].textContent:""},n})(),S4=(function(){function n(t){this.rules=[],this.length=0}return n.prototype.insertRule=function(t,i){return t<=this.length&&(this.rules.splice(t,0,i),this.length++,!0)},n.prototype.deleteRule=function(t){this.rules.splice(t,1),this.length--},n.prototype.getRule=function(t){return t<this.length?this.rules[t]:""},n})(),jx=Eh,A4={isServer:!Eh,useCSSOMInjection:!n4},d2=(function(){function n(t,i,a){t===void 0&&(t=lo),i===void 0&&(i={});var o=this;this.options=_n(_n({},A4),t),this.gs=i,this.names=new Map(a),this.server=!!t.isServer,!this.server&&Eh&&jx&&(jx=!1,Ix(this)),Gm(this,function(){return(function(u){for(var d=u.getTag(),m=d.length,p="",g=function(w){var T=(function(K){return wh.get(K)})(w);if(T===void 0)return"continue";var R=u.names.get(T),M=d.getGroup(w);if(R===void 0||!R.size||M.length===0)return"continue";var L="".concat(oo,".g").concat(w,'[id="').concat(T,'"]'),U="";R!==void 0&&R.forEach(function(K){K.length>0&&(U+="".concat(K,","))}),p+="".concat(M).concat(L,'{content:"').concat(U,'"}').concat(Km)},v=0;v<m;v++)g(v);return p})(o)})}return n.registerId=function(t){return Kc(t)},n.prototype.rehydrate=function(){!this.server&&Eh&&Ix(this)},n.prototype.reconstructWithOptions=function(t,i){return i===void 0&&(i=!0),new n(_n(_n({},this.options),t),this.gs,i&&this.names||void 0)},n.prototype.allocateGSInstance=function(t){return this.gs[t]=(this.gs[t]||0)+1},n.prototype.getTag=function(){return this.tag||(this.tag=(t=(function(i){var a=i.useCSSOMInjection,o=i.target;return i.isServer?new S4(o):a?new b4(o):new T4(o)})(this.options),new g4(t)));var t},n.prototype.hasNameForId=function(t,i){return this.names.has(t)&&this.names.get(t).has(i)},n.prototype.registerName=function(t,i){if(Kc(t),this.names.has(t))this.names.get(t).add(i);else{var a=new Set;a.add(i),this.names.set(t,a)}},n.prototype.insertRules=function(t,i,a){this.registerName(t,i),this.getTag().insertRules(Kc(t),a)},n.prototype.clearNames=function(t){this.names.has(t)&&this.names.get(t).clear()},n.prototype.clearRules=function(t){this.getTag().clearGroup(Kc(t)),this.clearNames(t)},n.prototype.clearTag=function(){this.tag=void 0},n})(),R4=/&/g,I4=/^\s*\/\/.*$/gm;function f2(n,t){return n.map(function(i){return i.type==="rule"&&(i.value="".concat(t," ").concat(i.value),i.value=i.value.replaceAll(",",",".concat(t," ")),i.props=i.props.map(function(a){return"".concat(t," ").concat(a)})),Array.isArray(i.children)&&i.type!=="@keyframes"&&(i.children=f2(i.children,t)),i})}function j4(n){var t,i,a,o=lo,u=o.options,d=u===void 0?lo:u,m=o.plugins,p=m===void 0?Hh:m,g=function(T,R,M){return M.startsWith(i)&&M.endsWith(i)&&M.replaceAll(i,"").length>0?".".concat(t):T},v=p.slice();v.push(function(T){T.type===$h&&T.value.includes("&")&&(T.props[0]=T.props[0].replace(R4,i).replace(a,g))}),d.prefix&&v.push(t4),v.push(WS);var w=function(T,R,M,L){R===void 0&&(R=""),M===void 0&&(M=""),L===void 0&&(L="&"),t=L,i=R,a=new RegExp("\\".concat(i,"\\b"),"g");var U=T.replace(I4,""),K=QS(M||R?"".concat(M," ").concat(R," { ").concat(U," }"):U);d.namespace&&(K=f2(K,d.namespace));var X=[];return _h(K,ZS(v.concat(JS(function(tt){return X.push(tt)})))),X};return w.hash=p.length?p.reduce(function(T,R){return R.name||pu(15),eo(T,R.name)},r2).toString():"",w}var C4=new d2,rm=j4(),p2=St.createContext({shouldForwardProp:void 0,styleSheet:C4,stylis:rm});p2.Consumer;St.createContext(void 0);function Cx(){return B.useContext(p2)}var m2=(function(){function n(t,i){var a=this;this.inject=function(o,u){u===void 0&&(u=rm);var d=a.name+u.hash;o.hasNameForId(a.id,d)||o.insertRules(a.id,d,u(a.rules,d,"@keyframes"))},this.name=t,this.id="sc-keyframes-".concat(t),this.rules=i,Gm(this,function(){throw pu(12,String(a.name))})}return n.prototype.getName=function(t){return t===void 0&&(t=rm),this.name+t.hash},n})(),D4=function(n){return n>="A"&&n<="Z"};function Dx(n){for(var t="",i=0;i<n.length;i++){var a=n[i];if(i===1&&a==="-"&&n[0]==="-")return n;D4(a)?t+="-"+a.toLowerCase():t+=a}return t.startsWith("ms-")?"-"+t:t}var g2=function(n){return n==null||n===!1||n===""},y2=function(n){var t,i,a=[];for(var o in n){var u=n[o];n.hasOwnProperty(o)&&!g2(u)&&(Array.isArray(u)&&u.isCss||uo(u)?a.push("".concat(Dx(o),":"),u,";"):tu(u)?a.push.apply(a,Jl(Jl(["".concat(o," {")],y2(u),!1),["}"],!1)):a.push("".concat(Dx(o),": ").concat((t=o,(i=u)==null||typeof i=="boolean"||i===""?"":typeof i!="number"||i===0||t in e4||t.startsWith("--")?String(i).trim():"".concat(i,"px")),";")))}return a};function Wa(n,t,i,a){if(g2(n))return[];if(Hm(n))return[".".concat(n.styledComponentId)];if(uo(n)){if(!uo(u=n)||u.prototype&&u.prototype.isReactComponent||!t)return[n];var o=n(t);return Wa(o,t,i,a)}var u;return n instanceof m2?i?(n.inject(i,a),[n.getName(a)]):[n]:tu(n)?y2(n):Array.isArray(n)?Array.prototype.concat.apply(Hh,n.map(function(d){return Wa(d,t,i,a)})):[n.toString()]}function N4(n){for(var t=0;t<n.length;t+=1){var i=n[t];if(uo(i)&&!Hm(i))return!1}return!0}var M4=a2(Kh),O4=(function(){function n(t,i,a){this.rules=t,this.staticRulesId="",this.isStatic=(a===void 0||a.isStatic)&&N4(t),this.componentId=i,this.baseHash=eo(M4,i),this.baseStyle=a,d2.registerId(i)}return n.prototype.generateAndInjectStyles=function(t,i,a){var o=this.baseStyle?this.baseStyle.generateAndInjectStyles(t,i,a):"";if(this.isStatic&&!a.hash)if(this.staticRulesId&&i.hasNameForId(this.componentId,this.staticRulesId))o=Ya(o,this.staticRulesId);else{var u=nm(Wa(this.rules,t,i,a)),d=em(eo(this.baseHash,u)>>>0);if(!i.hasNameForId(this.componentId,d)){var m=a(u,".".concat(d),void 0,this.componentId);i.insertRules(this.componentId,d,m)}o=Ya(o,d),this.staticRulesId=d}else{for(var p=eo(this.baseHash,a.hash),g="",v=0;v<this.rules.length;v++){var w=this.rules[v];if(typeof w=="string")g+=w;else if(w){var T=nm(Wa(w,t,i,a));p=eo(p,T+v),g+=T}}if(g){var R=em(p>>>0);i.hasNameForId(this.componentId,R)||i.insertRules(this.componentId,R,a(g,".".concat(R),void 0,this.componentId)),o=Ya(o,R)}}return o},n})(),x2=St.createContext(void 0);x2.Consumer;var _p={};function V4(n,t,i){var a=Hm(n),o=n,u=!vp(n),d=t.attrs,m=d===void 0?Hh:d,p=t.componentId,g=p===void 0?(function(lt,Y){var ot=typeof lt!="string"?"sc":bx(lt);_p[ot]=(_p[ot]||0)+1;var j="".concat(ot,"-").concat(s2(Kh+ot+_p[ot]));return Y?"".concat(Y,"-").concat(j):j})(t.displayName,t.parentComponentId):p,v=t.displayName,w=v===void 0?(function(lt){return vp(lt)?"styled.".concat(lt):"Styled(".concat(o4(lt),")")})(n):v,T=t.displayName&&t.componentId?"".concat(bx(t.displayName),"-").concat(t.componentId):t.componentId||g,R=a&&o.attrs?o.attrs.concat(m).filter(Boolean):m,M=t.shouldForwardProp;if(a&&o.shouldForwardProp){var L=o.shouldForwardProp;if(t.shouldForwardProp){var U=t.shouldForwardProp;M=function(lt,Y){return L(lt,Y)&&U(lt,Y)}}else M=L}var K=new O4(i,T,a?o.componentStyle:void 0);function X(lt,Y){return(function(ot,j,I){var C=ot.attrs,O=ot.componentStyle,k=ot.defaultProps,z=ot.foldedComponentIds,D=ot.styledComponentId,se=ot.target,qt=St.useContext(x2),J=Cx(),dt=ot.shouldForwardProp||J.shouldForwardProp,yt=i4(j,qt,k)||lo,jt=(function(Ct,_t,ge){for(var Lt,Me=_n(_n({},_t),{className:void 0,theme:ge}),Mi=0;Mi<Ct.length;Mi+=1){var Hn=uo(Lt=Ct[Mi])?Lt(Me):Lt;for(var on in Hn)Me[on]=on==="className"?Ya(Me[on],Hn[on]):on==="style"?_n(_n({},Me[on]),Hn[on]):Hn[on]}return _t.className&&(Me.className=Ya(Me.className,_t.className)),Me})(C,j,yt),V=jt.as||se,at={};for(var ct in jt)jt[ct]===void 0||ct[0]==="$"||ct==="as"||ct==="theme"&&jt.theme===yt||(ct==="forwardedAs"?at.as=jt.forwardedAs:dt&&!dt(ct,V)||(at[ct]=jt[ct]));var ht=(function(Ct,_t){var ge=Cx(),Lt=Ct.generateAndInjectStyles(_t,ge.styleSheet,ge.stylis);return Lt})(O,jt),gt=Ya(z,D);return ht&&(gt+=" "+ht),jt.className&&(gt+=" "+jt.className),at[vp(V)&&!i2.has(V)?"class":"className"]=gt,I&&(at.ref=I),B.createElement(V,at)})(tt,lt,Y)}X.displayName=w;var tt=St.forwardRef(X);return tt.attrs=R,tt.componentStyle=K,tt.displayName=w,tt.shouldForwardProp=M,tt.foldedComponentIds=a?Ya(o.foldedComponentIds,o.styledComponentId):"",tt.styledComponentId=T,tt.target=a?o.target:n,Object.defineProperty(tt,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(lt){this._foldedDefaultProps=a?(function(Y){for(var ot=[],j=1;j<arguments.length;j++)ot[j-1]=arguments[j];for(var I=0,C=ot;I<C.length;I++)im(Y,C[I],!0);return Y})({},o.defaultProps,lt):lt}}),Gm(tt,function(){return".".concat(tt.styledComponentId)}),u&&c2(tt,n,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0}),tt}function Nx(n,t){for(var i=[n[0]],a=0,o=t.length;a<o;a+=1)i.push(t[a],n[a+1]);return i}var Mx=function(n){return Object.assign(n,{isCss:!0})};function Ym(n){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];if(uo(n)||tu(n))return Mx(Wa(Nx(Hh,Jl([n],t,!0))));var a=n;return t.length===0&&a.length===1&&typeof a[0]=="string"?Wa(a):Mx(Wa(Nx(a,t)))}function am(n,t,i){if(i===void 0&&(i=lo),!t)throw pu(1,t);var a=function(o){for(var u=[],d=1;d<arguments.length;d++)u[d-1]=arguments[d];return n(t,i,Ym.apply(void 0,Jl([o],u,!1)))};return a.attrs=function(o){return am(n,t,_n(_n({},i),{attrs:Array.prototype.concat(i.attrs,o).filter(Boolean)}))},a.withConfig=function(o){return am(n,t,_n(_n({},i),o))},a}var v2=function(n){return am(V4,n)},A=v2;i2.forEach(function(n){A[n]=v2(n)});function k4(n){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];var a=nm(Ym.apply(void 0,Jl([n],t,!1))),o=s2(a);return new m2(o,a)}const Ep=A.a`
...
`;function _2({items:n=[],activeKey:t,mode:i,onModeChange:a,autoOnScroll:o=!1,scrollThreshold:u=8,sticky:d=!0,maxWidth:m,overlay:p=!1}){const[g,v]=B.useState(!1),[w,T]=B.useState(he.GRADIENT),R=typeof i=="string",M=R?i:w,L=B.useRef(R?i:w);B.useEffect(()=>{if(!R)return;(window.scrollY||document.documentElement.scrollTop||0)<=u&&(L.current=i)},[i,R,u]),B.useEffect(()=>{if(!o)return;const O=()=>{const k=window.scrollY||document.documentElement.scrollTop||0,z=L.current||he.GRADIENT_DARK,D=k>u?he.DARK:z;R||T(D),a&&a(D)};return O(),window.addEventListener("scroll",O,{passive:!0}),()=>window.removeEventListener("scroll",O)},[o,R,a,u]);const{baseColor:U,gradient:K,textColor:X,boxShadow:tt,showGradient:lt}=B.useMemo(()=>{switch(M){case he.LIGHT:return{baseColor:"linear-gradient(180deg, rgba(255,255,255,0.8) 60%, rgba(255,255,255,0) 100%)",gradient:"rgba(255,255,255,1)",textColor:"#000",showGradient:!0};case he.DARK:return{baseColor:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,0) 100%)",gradient:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,1) 100%)",textColor:"#fff",showGradient:!0};case he.GRADIENT_DARK:return{baseColor:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,0) 100%)",gradient:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,1) 100%)",textColor:"#fff",showGradient:!1};default:return{baseColor:"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0) 100%)",gradient:"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0) 100%)",textColor:"#000",showGradient:!1}}},[M]),j=M===he.DARK||M===he.GRADIENT_DARK||g,I=j?"/icons/logoLight.svg":"/icons/logoDark.svg",C=n.filter(O=>O.label!=="SHOWROOM");return B.useEffect(()=>(g?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[g]),y.jsxs(U4,{role:"banner",$sticky:d,$overlay:p,$baseColor:U,$gradient:K,$showGradient:lt,$textColor:X,$boxShadow:tt,children:[y.jsx(L4,{$maxWidth:m,children:y.jsxs(z4,{children:[y.jsxs($4,{children:[y.jsx(ns,{to:"/","aria-label":"홈으로",style:{color:"inherit",textDecoration:"none"},children:y.jsx(G4,{"aria-hidden":!0,children:y.jsx(Y4,{children:y.jsx("div",{style:{backgroundImage:`url(${I})`,width:"100%",height:"100%",backgroundSize:"contain",backgroundRepeat:"no-repeat"}})})})}),y.jsx(B4,{"aria-label":"주 메뉴",children:n.map(O=>y.jsx(Qm,{label:O.label,href:O.href,active:O.key===t},O.key))})]}),y.jsx(F4,{"aria-label":g?"메뉴 닫기":"메뉴 열기",onClick:()=>v(O=>!O),children:y.jsx(P4,{isOpen:g,size:24,color:j?"#fff":"#000"})})]})}),y.jsx(q4,{$open:g,onClick:()=>v(!1),children:y.jsx(K4,{onClick:O=>O.stopPropagation(),children:C.map(O=>y.jsx(H4,{label:O.label,href:O.href,active:O.key===t,style:{fontSize:18,fontWeight:500,color:"#fff",textAlign:"center"},onClick:()=>v(!1)},O.key))})})]})}_2.propTypes={items:Z.arrayOf(Z.shape({key:Z.string.isRequired,label:Z.string.isRequired,href:Z.string})),activeKey:Z.string,mode:Z.oneOf([he.GRADIENT,he.LIGHT,he.DARK,he.GRADIENT_DARK]),onModeChange:Z.func,autoOnScroll:Z.bool,scrollThreshold:Z.number,sticky:Z.bool,overlay:Z.bool,maxWidth:Z.oneOfType([Z.string,Z.number])};const Xm="Pretendard, system-ui, -apple-system, Segoe UI, Roboto, 'Noto Sans KR', Arial, sans-serif",Q4=A.footer`
  width: 100vw;
  background: #0E0E0E;
...
`,nA=A.div`
  ...
  width: 100%;
  align-items: center;
`;function kx({children:n}){return y.jsx(eA,{children:y.jsx(nA,{children:n})})}const iA=A.div`
...
`;function aA(){return y.jsxs(y.Fragment,{children:[y.jsx(iA,{children:"CREDITS"}),y.jsx(rA,{children:"잔향 : 기억의 향기"})]})}const sA=A.p`
  max-width: 374px;
  font-family: ${Ni};
  font-size: 16px;
  font-weight: 300;
...
`;function hA({text:n}){return y.jsxs(oA,{children:[y.jsx(w2,{}),y.jsx(lA,{}),y.jsx(sA,{dangerouslySetInnerHTML:{__html:n}})]})}const dA=A.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  gap: 46px;
...
`;function mA({children:n}){return y.jsx(fA,{children:y.jsx(pA,{children:n})})}const gA=A.div`
...
`;function _A({blocks:n}){return y.jsxs(gA,{children:[y.jsx(w2,{}),n.map(t=>y.jsxs(yA,{children:[y.jsx(xA,{children:t.title}),y.jsx(vA,{dangerouslySetInnerHTML:{__html:t.body}})]},t.title))]})}const EA=A.div`
...
`;function SA({title:n,rows:t,last:i=!1}){return y.jsxs(EA,{$last:i,children:[y.jsx(wA,{children:y.jsx(bA,{children:n})}),y.jsx(TA,{children:t.map((a,o)=>y.jsx(DA,{ko:a.ko,en:a.en,divider:t.length>1&&o!==t.length-1},a.ko+a.en+o))})]})}const AA=A.div`
  padding-top: 22px;
  padding-bottom: 40px;
...
`;function DA({ko:n,en:t,divider:i=!1}){return y.jsxs(AA,{$divider:i,children:[y.jsx(RA,{children:y.jsx(IA,{children:n})}),y.jsx(jA,{children:y.jsx(CA,{children:t})})]})}const NA=A.div`
  display: flex;
  flex-direction: column;
  position: relative;
  margin-top: 60px;
...
`,$A=A(uh)`
 @media (max-width: 640px) {
    display: none;
 }`;function Wm({nameKor:n,nameEng:t,role:i,sns:a,eMail:o,imgSrc:u,imgAlt:d}){return y.jsxs(VA,{children:[y.jsxs(kA,{children:[y.jsx(PA,{src:u,alt:d}),y.jsx(UA,{})]}),y.jsxs(LA,{children:[y.jsxs(Px,{style:{top:"50px"},children:[y.jsx(zA,{children:n}),y.jsx(uh,{children:t})]}),y.jsxs(Px,{children:[y.jsx(uh,{children:i}),typeof a=="string"&&a.trim()&&a!=="-"?y.jsx(uh,{children:a}):Array.isArray(a)&&a.length>0?y.jsx("div",{style:{display:"flex",gap:"8px",flexWrap:"wrap",margin:"4px 0 0 0"},children:a.map((m,p)=>y.jsx("span",{style:{wordBreak:"break-all"},children:m.handle||m.url},`${m.platform}-${p}`))}):"-",y.jsx($A,{children:o?y.jsx("a",{style:{textDecoration:"none",color:"inherit"},href:`mailto:${o}`,children:o}):null})]})]})]})}Wm.defaultProps={sns:[]};Wm.propTypes={nameKor:Z.string.isRequired,nameEng:Z.string,role:Z.string,sns:Z.arrayOf(Z.shape({platform:Z.string.isRequired,url:Z.string.isRequired})),eMail:Z.string,imgSrc:Z.string.isRequired,imgAlt:Z.string.isRequired};const BA=A.div`
  display: flex;
  align-items: center;
  justify-content: flex-start;
  flex-direction: row;
...
`;function sm({path:n="student",isActive:t=!1,onClick:i}){return y.jsxs(BA,{onClick:i,children:[y.jsx(b2,{$active:t,children:"교수"}),y.jsx(qA,{$active:t,children:"학생"}),y.jsx(FA,{$active:t})]})}sm.propTypes={path:Z.oneOf(["student","professor"]),isActive:Z.bool,onClick:Z.func};const Ux=A.a`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  font-size: 24px;
  line-height: 28.8px;
  letter-spacing: 0.24px;
...
`,Lx=A.span`
    ...
    align-items: center;
    justify-content: flex-start;
`;function ch({label:n,href:t=null,active:i=!1,onClick:a,style:o,target:u,rel:d}){const p={"aria-current":i?"page":void 0,"data-active":i?"true":"false",onKeyDown:g=>{a&&(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),a(g))},"data-label":n,onClick:a,style:o,$active:i};return t?y.jsx(Ux,{href:t,target:u,rel:d,...p,children:y.jsx(Lx,{className:"navbtn-text",children:n})}):y.jsx(Ux,{as:"button",type:"button",...p,style:{background:"none",border:0,...o},children:y.jsx(Lx,{className:"navbtn-text",children:n})})}ch.propTypes={label:Z.string.isRequired,href:Z.string,active:Z.bool,onClick:Z.func,style:Z.object,target:Z.string,rel:Z.string};const T2=A.div`
  display: flex;
  width: 120px;
  height: 40px;
  flex-direction: row;
...
`;function Zm({label:n,style:t,mode:i}){const u=window.matchMedia("(max-width: 640px)").matches?"/icons/dropDownMobileIcon.svg":"/icons/arrowDropdownIcon.svg";return i==="category"?y.jsxs(KA,{style:t,children:[y.jsx(HA,{children:n}),y.jsx(zx,{children:y.jsx("img",{src:"/icons/arrowDropdownIcon.svg",alt:"dropdownIcon"})})]}):y.jsxs(T2,{style:t,children:[y.jsx(S2,{children:n}),y.jsx(zx,{children:y.jsx("img",{src:u,alt:"dropdownIcon"})})]})}Zm.propTypes={label:Z.string.isRequired,style:Z.object};const GA=A.div`
...
`;function A2({options:n,onSelect:t,style:i,isOpen:a,position:o,selected:u}){return y.jsx(GA,{style:i,$open:a,children:n.map((d,m)=>y.jsx(YA,{onClick:()=>t(d),children:y.jsx(QA,{$selected:d===u,children:d})},m))})}A2.propTypes={options:Z.arrayOf(Z.string).isRequired,onSelect:Z.func.isRequired,style:Z.object,isOpen:Z.bool,position:Z.any,selected:Z.string};const XA=A.div`
  position: relative;
`;function Jm({label:n,options:t,onSelect:i,style:a,filter:o,mode:u}){const[d,m]=St.useState(!1),[p,g]=St.useState({top:0,left:0}),v=St.useRef(null),w=()=>{if(v.current){const R=v.current.getBoundingClientRect();g({top:R.bottom+window.scrollY,left:R.left+window.scrollX})}m(R=>!R)},T=R=>{i&&i(R),m(!1)};return y.jsxs(XA,{ref:v,style:a,children:[y.jsx("div",{onClick:w,children:y.jsx(Zm,{label:n,options:t,onSelect:i,style:{},filter:o,mode:u})}),y.jsx(A2,{options:t,onSelect:T,style:{},isOpen:d,position:p,selected:n})]})}Jm.propTypes={label:Z.string.isRequired,options:Z.arrayOf(Z.string).isRequired,onSelect:Z.func.isRequired,style:Z.object,filter:Z.string};Jm.defaultProps={style:{},filter:""};const WA=A.div`
    /* display: ${n=>n.$open?"flex":"none"}; */
    display: flex;
    flex-direction: column;
    justify-content: flex-start;
...
`;function R2({options:n,isOpen:t,onSelect:i,selected:a}){return y.jsx(WA,{$open:t,children:y.jsx(ZA,{$open:t,children:n.map((o,u)=>y.jsx(JA,{$selected:a===o,onClick:()=>i(o),children:o},u))})})}R2.propTypes={options:Z.arrayOf(Z.string).isRequired,isOpen:Z.bool.isRequired,onSelect:Z.func.isRequired,selected:Z.oneOfType([Z.string,Z.number])};const tR=A.div`
    position: relative;
    // 안에 들어가는 요소들 왼쪽 정렬
    display: flex;
    flex-direction: row;
    justify-content: flex-start;
`;function ql({label:n,options:t,onSelect:i,style:a,mode:o}){const[u,d]=St.useState(!1),m=St.useRef(null),p=()=>{d(v=>!v)},g=v=>{i&&i(v),d(!1)};return y.jsxs(tR,{ref:m,style:a,children:[y.jsx("div",{onClick:p,children:y.jsx(Zm,{label:n,mode:o})}),y.jsx(R2,{options:t,onSelect:g,isOpen:u,selected:n})]})}ql.propTypes={label:Z.string.isRequired,options:Z.arrayOf(Z.string).isRequired,onSelect:Z.func.isRequired,style:Z.object,mode:Z.string};ql.defaultProps={style:{},mode:"category"};const wp=A.div`
  display: flex;
  justify-content: space-between;
  width: auto;
  padding-left: 40px;
...
`;function I2({onCategoryChange:n,onToggleChange:t,type:i,onSortChange:a,sortLabel:o}){const u={type:i},[d,m]=St.useState(!1),p=()=>m(Y=>{const ot=!Y;return t&&t(ot),ot}),[g,v]=St.useState("전체"),[w,T]=St.useState("All Projects"),R=["전체","산업디자인공학","미디어디자인공학"],M=["장영주","권오재","김 억","김한종","조남주","한민섭","홍성수","김태균"],L=["All Projects","AI & Robot","Edu & Kids","Health Care","IT & Tech","Living","Mobility"],U=["이름순","좋아요순","조회수순","팀작우선","개인작우선"],[K,X]=St.useState("이름순"),tt=o||K,lt=Y=>{X(Y),a&&a(Y)};return B.useEffect(()=>{v(d?M[0]:R[0])},[d]),u.type==="project"?y.jsxs(wp,{children:[y.jsx(bp,{}),y.jsx(Tp,{children:L.map(Y=>y.jsx(ch,{label:Y,active:w===Y,onClick:()=>{T(Y),n&&n(Y)}},Y))}),y.jsx(Sp,{children:y.jsx(ql,{mode:"category",label:w,options:L,onSelect:Y=>{T(Y),n&&n(Y)}})}),y.jsx(Jm,{label:tt,options:U,onSelect:lt})]}):d?y.jsxs(wp,{children:[y.jsx(bp,{}),y.jsx(Tp,{children:M.map(Y=>y.jsx(ch,{label:Y,active:g===Y,onClick:()=>{v(Y),n&&n(Y)}},Y))}),y.jsx(Sp,{children:y.jsx(ql,{mode:"category",label:g,options:M,onSelect:Y=>{v(Y),n&&n(Y)}})}),y.jsx(sm,{path:d?"professor":"student",isActive:d,onClick:p})]}):y.jsxs(wp,{children:[y.jsx(bp,{}),y.jsx(Tp,{children:R.map(Y=>y.jsx(ch,{label:Y,active:g===Y,onClick:()=>{v(Y),n&&n(Y)}},Y))}),y.jsx(Sp,{children:y.jsx(ql,{mode:"category",label:g,options:R,onSelect:Y=>{v(Y),n&&n(Y)}})}),y.jsx(sm,{path:d?"professor":"student",isActive:d,onClick:p})]})}const eR=A.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  justify-content: center;
...
`;function hR({children:n}){return y.jsx(uR,{children:y.jsx(cR,{children:n})})}const dR=A.div`
  display: flex; 
  flex-wrap: wrap; 
  justify-content: center; 
  margin-top: 100px; 
...
`,mR=A.div`position: relative;`;function gR({people:n}){const t=Lh();return y.jsx(dR,{children:n.map((i,a)=>{const o=i.id??i.studentId??`${i.nameKor}-${a}`,u=typeof i.projectNum=="number"&&i.category,d=u?i.projectNum+1:null,m=u?`${oR[i.category]||"A"}${String(d).padStart(3,"0")}`:null,p=y.jsx(Wm,{nameKor:i.nameKor,nameEng:i.nameEng,role:i.role,sns:i.sns||"-",eMail:i.eMail,imgSrc:j2(i.imgUrl),imgAlt:`${i.nameKor} profile`},o);return u?y.jsx(pR,{role:"link",tabIndex:0,onClick:()=>t(`/work/${m}`),onKeyDown:g=>{(g.key==="Enter"||g.key===" ")&&t(`/work/${m}`)},"aria-label":`${i.nameKor} 작품 보기 (${m})`,children:p},`link-${o}`):p})})}function yR(){const[n,t]=St.useState(!1),[i,a]=St.useState(Fx[0]),o=St.useMemo(()=>{const m=new Map;return(eu||[]).forEach(p=>{(p.members||[]).forEach(g=>{m.has(g)||m.set(g,p)})}),m},[]);St.useEffect(()=>{a(n?kl[0]?.id||"":Fx[0])},[n]);const u=St.useMemo(()=>{if(!n){if(i==="전체")return Ap;let p=lR[i];return p===void 0&&(p=qx(i)),Ap.filter(g=>qx(g.department)===p)}const m=kl.some(p=>p.id===i)?i:kl.find(p=>p.nameKor===i)?.id||"";return Ap.filter(p=>p.professorId===m).map(p=>{let g=o.get(p.num);g||(g=(eu||[]).find(w=>w.category===p.category&&w.projectNum===p.projectNum)||null);const v=g?`/projects/${g.projectNum}/thumb.jpg`:"/thumbnailExample.png";return{...p,imgUrl:v}})},[i,n,o]),d=St.useMemo(()=>n&&(kl.find(p=>p.id===i)||kl.find(p=>p.nameKor===i))||null,[n,i]);return y.jsxs(mR,{children:[y.jsx(fR,{children:"Peoples"}),y.jsx(I2,{type:"people",onCategoryChange:a,onToggleChange:t}),y.jsxs(hR,{children:[n&&d&&y.jsx(tg,{nameKor:d.nameKor,rank:d.rank||"교수",eMail:d.email,education:d.education,field:d.field,imgSrc:j2(d.imgUrl),imgAlt:`${d.nameKor} profile`}),y.jsx(gR,{people:u})]})]})}const Kx=A.div`
  @media (max-width: 393px) {
...
`;function Xx(n){return typeof n=="number"&&n>999?"999+":n}function ng({titleKor:n,titleEng:t,nameKor:i,view:a,like:o,href:u,src:d,profileImgs:m,docId:p}){const g=typeof o=="number"?o:0,v=typeof a=="number"?a:0,w=U=>{const K=U.currentTarget.querySelector(".card-hover");K&&(K.style.opacity=1)},T=U=>{const K=U.currentTarget.querySelector(".card-hover");K&&(K.style.opacity=0)},R="/",M=/^https?:\/\//i.test(u),L=y.jsxs(y.Fragment,{children:[y.jsx(xR,{children:y.jsxs(vR,{onMouseEnter:w,onMouseLeave:T,children:[y.jsx(ER,{className:"card-hover",children:y.jsxs(wR,{children:[y.jsx(TR,{children:n}),y.jsx(bR,{children:t})]})}),y.jsx(_R,{src:d,alt:"Project"})]})}),y.jsxs(SR,{children:[y.jsxs(AR,{children:[y.jsx(IR,{children:m.map((U,K)=>y.jsx(jR,{src:U,alt:`Profile${K+1}`,$z:3-K,$ml:K>0},K))}),y.jsx(RR,{children:i})]}),y.jsxs(CR,{children:[y.jsxs(Gx,{children:[y.jsx(Yx,{src:`${R}icons/likeIcon.svg`}),y.jsx(Qx,{children:Xx(g)||0})]}),y.jsxs(Gx,{children:[y.jsx(Yx,{src:`${R}icons/viewIcon.svg`}),y.jsx(Qx,{children:Xx(v)||0})]})]})]})]});return M?y.jsx(Kx,{children:y.jsx(Hx,{as:"a",href:u,style:{textDecoration:"none"},children:L})}):y.jsx(Kx,{children:y.jsx(Hx,{as:ns,to:u.startsWith("/")?u:`/${u}`,style:{textDecoration:"none"},children:L})})}ng.propTypes={titleKor:Z.string.isRequired,titleEng:Z.string.isRequired,nameKor:Z.string.isRequired,view:Z.number,like:Z.number,src:Z.string.isRequired,href:Z.string.isRequired,profileImgs:Z.arrayOf(Z.string).isRequired,docId:Z.oneOfType([Z.string,Z.number]),collection:Z.string};ng.defaultProps={titleKor:"프로젝트 제목",titleEng:"Project Title",nameKor:"Author Name",view:0,like:0,collection:"works"};const DR=()=>{};var Wx={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PR=()=>kR().__FIREBASE_DEFAULTS__,UR=()=>{if(typeof process>"u"||typeof Wx>"u")return;const n=Wx.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},LR=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=n&&VR(n[1]);return t&&JSON.parse(t)},ig=()=>{try{return DR()||PR()||UR()||LR()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},zR=n=>ig()?.emulatorHosts?.[n],$R=n=>{const t=zR(n);if(!t)return;const i=t.lastIndexOf(":");if(i<=0||i+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const a=parseInt(t.substring(i+1),10);return t[0]==="["?[t.substring(1,i-1),a]:[t.substring(0,i),a]},N2=()=>ig()?.config;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rg(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function FR(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lr=new O2("@firebase/app"),b6="@firebase/app-compat",T6="@firebase/analytics-compat",S6="@firebase/analytics",A6="@firebase/app-check-compat",R6="@firebase/app-check",I6="@firebase/auth",j6="@firebase/auth-compat",C6="@firebase/database",D6="@firebase/data-connect",N6="@firebase/database-compat",M6="@firebase/functions",O6="@firebase/functions-compat",V6="@firebase/installations",k6="@firebase/installations-compat",P6="@firebase/messaging",U6="@firebase/messaging-compat",L6="@firebase/performance",z6="@firebase/performance-compat",$6="@firebase/remote-config",B6="@firebase/remote-config-compat",F6="@firebase/storage",q6="@firebase/storage-compat",K6="@firebase/firestore",H6="@firebase/ai",G6="@firebase/firestore-compat",Y6="firebase",Q6="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cm="[DEFAULT]",X6={[um]:"fire-core",[b6]:"fire-core-compat",[S6]:"fire-analytics",[T6]:"fire-analytics-compat",[R6]:"fire-app-check",[A6]:"fire-app-check-compat",[I6]:"fire-auth",[j6]:"fire-auth-compat",[C6]:"fire-rtdb",[D6]:"fire-data-connect",[N6]:"fire-rtdb-compat",[M6]:"fire-fn",[O6]:"fire-fn-compat",[V6]:"fire-iid",[k6]:"fire-iid-compat",[P6]:"fire-fcm",[U6]:"fire-fcm-compat",[L6]:"fire-perf",[z6]:"fire-perf-compat",[$6]:"fire-rc",[B6]:"fire-rc-compat",[F6]:"fire-gcs",[q6]:"fire-gcs-compat",[K6]:"fire-fst",[G6]:"fire-fst-compat",[H6]:"fire-vertex","fire-js":"fire-js",[Y6]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nI=Q6;function sg(n,t={}){let i=n;typeof t!="object"&&(t={name:t});const a={name:cm,automaticDataCollectionEnabled:!0,...t},o=a.name;if(typeof o!="string"||!o)throw Jr.create("bad-app-name",{appName:String(o)});if(i||(i=N2()),!i)throw Jr.create("no-options");const u=iu.get(o);if(u){if(Th(i,u.options)&&Th(a,u.config))return u;throw Jr.create("duplicate-app",{appName:o})}const d=new a6(o);for(const p of hm.values())d.addComponent(p);const m=new eI(i,a,d);return iu.set(o,m),m}function iI(n=cm){const t=iu.get(n);if(!t&&n===cm&&N2())return sg();if(!t)throw Jr.create("no-app",{appName:n});return t}function av(){return Array.from(iu.values())}function no(n,t,i){let a=X6[n]??n;i&&(a+=`-${i}`);const o=a.match(/\s|\//),u=t.match(/\s|\//);if(o||u){const d=[`Unable to register library "${a}" with version "${t}":`];o&&d.push(`library name "${a}" contains illegal characters (whitespace or "/")`),o&&u&&d.push("and"),u&&d.push(`version name "${t}" contains illegal characters (whitespace or "/")`),lr.warn(d.join(" "));return}Sh(new nu(`${a}-version`,()=>({library:a,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rI="firebase-heartbeat-database",aI=1,ru="firebase-heartbeat-store";let Cp=null;function P2(){return Cp||(Cp=x6(rI,aI,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(ru)}catch(i){console.warn(i)}}}}).catch(n=>{throw Jr.create("idb-open",{originalErrorMessage:n.message})})),Cp}async function sI(n){try{const i=(await P2()).transaction(ru),a=await i.objectStore(ru).get(U2(n));return await i.done,a}catch(t){if(t instanceof bo)lr.warn(t.message);else{const i=Jr.create("idb-get",{originalErrorMessage:t?.message});lr.warn(i.message)}}}async function sv(n,t){try{const a=(await P2()).transaction(ru,"readwrite");await a.objectStore(ru).put(t,U2(n)),await a.done}catch(i){if(i instanceof bo)lr.warn(i.message);else{const a=Jr.create("idb-set",{originalErrorMessage:i?.message});lr.warn(a.message)}}}function U2(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var ta,L2;(function(){var n;/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(j,I){function C(){}C.prototype=I.prototype,j.F=I.prototype,j.prototype=new C,j.prototype.constructor=j,j.D=function(O,k,z){for(var D=Array(arguments.length-2),se=2;se<arguments.length;se++)D[se-2]=arguments[se];return I.prototype[k].apply(O,D)}}function i(){this.blockSize=-1}function a(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}t(a,i),a.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(j,I,C){C||(C=0);const O=Array(16);if(typeof I=="string")for(var k=0;k<16;++k)O[k]=I.charCodeAt(C++)|I.charCodeAt(C++)<<8|I.charCodeAt(C++)<<16|I.charCodeAt(C++)<<24;else for(k=0;k<16;++k)O[k]=I[C++]|I[C++]<<8|I[C++]<<16|I[C++]<<24;I=j.g[0],C=j.g[1],k=j.g[2];let z=j.g[3],D;D=I+(z^C&(k^z))+O[0]+3614090360&4294967295,I=C+(D<<7&4294967295|D>>>25),D=z+(k^I&(C^k))+O[1]+3905402710&4294967295,z=I+(D<<12&4294967295|D>>>20),D=k+(C^z&(I^C))+O[2]+606105819&4294967295,k=z+(D<<17&4294967295|D>>>15),D=C+(I^k&(z^I))+O[3]+3250441966&4294967295,C=k+(D<<22&4294967295|D>>>10),D=I+(z^C&(k^z))+O[4]+4118548399&4294967295,I=C+(D<<7&4294967295|D>>>25),D=z+(k^I&(C^k))+O[5]+1200080426&4294967295,z=I+(D<<12&4294967295|D>>>20),D=k+(C^z&(I^C))+O[6]+2821735955&4294967295,k=z+(D<<17&4294967295|D>>>15),D=C+(I^k&(z^I))+O[7]+4249261313&4294967295,C=k+(D<<22&4294967295|D>>>10),D=I+(z^C&(k^z))+O[8]+1770035416&4294967295,I=C+(D<<7&4294967295|D>>>25),D=z+(k^I&(C^k))+O[9]+2336552879&4294967295,z=I+(D<<12&4294967295|D>>>20),D=k+(C^z&(I^C))+O[10]+4294925233&4294967295,k=z+(D<<17&4294967295|D>>>15),D=C+(I^k&(z^I))+O[11]+2304563134&4294967295,C=k+(D<<22&4294967295|D>>>10),D=I+(z^C&(k^z))+O[12]+1804603682&4294967295,I=C+(D<<7&4294967295|D>>>25),D=z+(k^I&(C^k))+O[13]+4254626195&4294967295,z=I+(D<<12&4294967295|D>>>20),D=k+(C^z&(I^C))+O[14]+2792965006&4294967295,k=z+(D<<17&4294967295|D>>>15),D=C+(I^k&(z^I))+O[15]+1236535329&4294967295,C=k+(D<<22&4294967295|D>>>10),D=I+(k^z&(C^k))+O[1]+4129170786&4294967295,I=C+(D<<5&4294967295|D>>>27),D=z+(C^k&(I^C))+O[6]+3225465664&4294967295,z=I+(D<<9&4294967295|D>>>23),D=k+(I^C&(z^I))+O[11]+643717713&4294967295,k=z+(D<<14&4294967295|D>>>18),D=C+(z^I&(k^z))+O[0]+3921069994&4294967295,C=k+(D<<20&4294967295|D>>>12),D=I+(k^z&(C^k))+O[5]+3593408605&4294967295,I=C+(D<<5&4294967295|D>>>27),D=z+(C^k&(I^C))+O[10]+38016083&4294967295,z=I+(D<<9&4294967295|D>>>23),D=k+(I^C&(z^I))+O[15]+3634488961&4294967295,k=z+(D<<14&4294967295|D>>>18),D=C+(z^I&(k^z))+O[4]+3889429448&4294967295,C=k+(D<<20&4294967295|D>>>12),D=I+(k^z&(C^k))+O[9]+568446438&4294967295,I=C+(D<<5&4294967295|D>>>27),D=z+(C^k&(I^C))+O[14]+3275163606&4294967295,z=I+(D<<9&4294967295|D>>>23),D=k+(I^C&(z^I))+O[3]+4107603335&4294967295,k=z+(D<<14&4294967295|D>>>18),D=C+(z^I&(k^z))+O[8]+1163531501&4294967295,C=k+(D<<20&4294967295|D>>>12),D=I+(k^z&(C^k))+O[13]+2850285829&4294967295,I=C+(D<<5&4294967295|D>>>27),D=z+(C^k&(I^C))+O[2]+4243563512&4294967295,z=I+(D<<9&4294967295|D>>>23),D=k+(I^C&(z^I))+O[7]+1735328473&4294967295,k=z+(D<<14&4294967295|D>>>18),D=C+(z^I&(k^z))+O[12]+2368359562&4294967295,C=k+(D<<20&4294967295|D>>>12),D=I+(C^k^z)+O[5]+4294588738&4294967295,I=C+(D<<4&4294967295|D>>>28),D=z+(I^C^k)+O[8]+2272392833&4294967295,z=I+(D<<11&4294967295|D>>>21),D=k+(z^I^C)+O[11]+1839030562&4294967295,k=z+(D<<16&4294967295|D>>>16),D=C+(k^z^I)+O[14]+4259657740&4294967295,C=k+(D<<23&4294967295|D>>>9),D=I+(C^k^z)+O[1]+2763975236&4294967295,I=C+(D<<4&4294967295|D>>>28),D=z+(I^C^k)+O[4]+1272893353&4294967295,z=I+(D<<11&4294967295|D>>>21),D=k+(z^I^C)+O[7]+4139469664&4294967295,k=z+(D<<16&4294967295|D>>>16),D=C+(k^z^I)+O[10]+3200236656&4294967295,C=k+(D<<23&4294967295|D>>>9),D=I+(C^k^z)+O[13]+681279174&4294967295,I=C+(D<<4&4294967295|D>>>28),D=z+(I^C^k)+O[0]+3936430074&4294967295,z=I+(D<<11&4294967295|D>>>21),D=k+(z^I^C)+O[3]+3572445317&4294967295,k=z+(D<<16&4294967295|D>>>16),D=C+(k^z^I)+O[6]+76029189&4294967295,C=k+(D<<23&4294967295|D>>>9),D=I+(C^k^z)+O[9]+3654602809&4294967295,I=C+(D<<4&4294967295|D>>>28),D=z+(I^C^k)+O[12]+3873151461&4294967295,z=I+(D<<11&4294967295|D>>>21),D=k+(z^I^C)+O[15]+530742520&4294967295,k=z+(D<<16&4294967295|D>>>16),D=C+(k^z^I)+O[2]+3299628645&4294967295,C=k+(D<<23&4294967295|D>>>9),D=I+(k^(C|~z))+O[0]+4096336452&4294967295,I=C+(D<<6&4294967295|D>>>26),D=z+(C^(I|~k))+O[7]+1126891415&4294967295,z=I+(D<<10&4294967295|D>>>22),D=k+(I^(z|~C))+O[14]+2878612391&4294967295,k=z+(D<<15&4294967295|D>>>17),D=C+(z^(k|~I))+O[5]+4237533241&4294967295,C=k+(D<<21&4294967295|D>>>11),D=I+(k^(C|~z))+O[12]+1700485571&4294967295,I=C+(D<<6&4294967295|D>>>26),D=z+(C^(I|~k))+O[3]+2399980690&4294967295,z=I+(D<<10&4294967295|D>>>22),D=k+(I^(z|~C))+O[10]+4293915773&4294967295,k=z+(D<<15&4294967295|D>>>17),D=C+(z^(k|~I))+O[1]+2240044497&4294967295,C=k+(D<<21&4294967295|D>>>11),D=I+(k^(C|~z))+O[8]+1873313359&4294967295,I=C+(D<<6&4294967295|D>>>26),D=z+(C^(I|~k))+O[15]+4264355552&4294967295,z=I+(D<<10&4294967295|D>>>22),D=k+(I^(z|~C))+O[6]+2734768916&4294967295,k=z+(D<<15&4294967295|D>>>17),D=C+(z^(k|~I))+O[13]+1309151649&4294967295,C=k+(D<<21&4294967295|D>>>11),D=I+(k^(C|~z))+O[4]+4149444226&4294967295,I=C+(D<<6&4294967295|D>>>26),D=z+(C^(I|~k))+O[11]+3174756917&4294967295,z=I+(D<<10&4294967295|D>>>22),D=k+(I^(z|~C))+O[2]+718787259&4294967295,k=z+(D<<15&4294967295|D>>>17),D=C+(z^(k|~I))+O[9]+3951481745&4294967295,j.g[0]=j.g[0]+I&4294967295,j.g[1]=j.g[1]+(k+(D<<21&4294967295|D>>>11))&4294967295,j.g[2]=j.g[2]+k&4294967295,j.g[3]=j.g[3]+z&4294967295}a.prototype.v=function(j,I){I===void 0&&(I=j.length);const C=I-this.blockSize,O=this.C;let k=this.h,z=0;for(;z<I;){if(k==0)for(;z<=C;)o(this,j,z),z+=this.blockSize;if(typeof j=="string"){for(;z<I;)if(O[k++]=j.charCodeAt(z++),k==this.blockSize){o(this,O),k=0;break}}else for(;z<I;)if(O[k++]=j[z++],k==this.blockSize){o(this,O),k=0;break}}this.h=k,this.o+=I},a.prototype.A=function(){var j=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);j[0]=128;for(var I=1;I<j.length-8;++I)j[I]=0;I=this.o*8;for(var C=j.length-8;C<j.length;++C)j[C]=I&255,I/=256;for(this.v(j),j=Array(16),I=0,C=0;C<4;++C)for(let O=0;O<32;O+=8)j[I++]=this.g[C]>>>O&255;return j};function u(j,I){var C=m;return Object.prototype.hasOwnProperty.call(C,j)?C[j]:C[j]=I(j)}function d(j,I){this.h=I;const C=[];let O=!0;for(let k=j.length-1;k>=0;k--){const z=j[k]|0;O&&z==I||(C[k]=z,O=!1)}this.g=C}var m={};function p(j){return-128<=j&&j<128?u(j,function(I){return new d([I|0],I<0?-1:0)}):new d([j|0],j<0?-1:0)}function g(j){if(isNaN(j)||!isFinite(j))return w;if(j<0)return U(g(-j));const I=[];let C=1;for(let O=0;j>=C;O++)I[O]=j/C|0,C*=4294967296;return new d(I,0)}function v(j,I){if(j.length==0)throw Error("number format error: empty string");if(I=I||10,I<2||36<I)throw Error("radix out of range: "+I);if(j.charAt(0)=="-")return U(v(j.substring(1),I));if(j.indexOf("-")>=0)throw Error('number format error: interior "-" character');const C=g(Math.pow(I,8));let O=w;for(let z=0;z<j.length;z+=8){var k=Math.min(8,j.length-z);const D=parseInt(j.substring(z,z+k),I);k<8?(k=g(Math.pow(I,k)),O=O.j(k).add(g(D))):(O=O.j(C),O=O.add(g(D)))}return O}var w=p(0),T=p(1),R=p(16777216);n=d.prototype,n.m=function(){if(L(this))return-U(this).m();let j=0,I=1;for(let C=0;C<this.g.length;C++){const O=this.i(C);j+=(O>=0?O:4294967296+O)*I,I*=4294967296}return j},n.toString=function(j){if(j=j||10,j<2||36<j)throw Error("radix out of range: "+j);if(M(this))return"0";if(L(this))return"-"+U(this).toString(j);const I=g(Math.pow(j,6));var C=this;let O="";for(;;){const k=lt(C,I).g;C=K(C,k.j(I));let z=((C.g.length>0?C.g[0]:C.h)>>>0).toString(j);if(C=k,M(C))return z+O;for(;z.length<6;)z="0"+z;O=z+O}},n.i=function(j){return j<0?0:j<this.g.length?this.g[j]:this.h};function M(j){if(j.h!=0)return!1;for(let I=0;I<j.g.length;I++)if(j.g[I]!=0)return!1;return!0}function L(j){return j.h==-1}n.l=function(j){return j=K(this,j),L(j)?-1:M(j)?0:1};function U(j){const I=j.g.length,C=[];for(let O=0;O<I;O++)C[O]=~j.g[O];return new d(C,~j.h).add(T)}n.abs=function(){return L(this)?U(this):this},n.add=function(j){const I=Math.max(this.g.length,j.g.length),C=[];let O=0;for(let k=0;k<=I;k++){let z=O+(this.i(k)&65535)+(j.i(k)&65535),D=(z>>>16)+(this.i(k)>>>16)+(j.i(k)>>>16);O=D>>>16,z&=65535,D&=65535,C[k]=D<<16|z}return new d(C,C[C.length-1]&-2147483648?-1:0)};function K(j,I){return j.add(U(I))}n.j=function(j){if(M(this)||M(j))return w;if(L(this))return L(j)?U(this).j(U(j)):U(U(this).j(j));if(L(j))return U(this.j(U(j)));if(this.l(R)<0&&j.l(R)<0)return g(this.m()*j.m());const I=this.g.length+j.g.length,C=[];for(var O=0;O<2*I;O++)C[O]=0;for(O=0;O<this.g.length;O++)for(let k=0;k<j.g.length;k++){const z=this.i(O)>>>16,D=this.i(O)&65535,se=j.i(k)>>>16,qt=j.i(k)&65535;C[2*O+2*k]+=D*qt,X(C,2*O+2*k),C[2*O+2*k+1]+=z*qt,X(C,2*O+2*k+1),C[2*O+2*k+1]+=D*se,X(C,2*O+2*k+1),C[2*O+2*k+2]+=z*se,X(C,2*O+2*k+2)}for(j=0;j<I;j++)C[j]=C[2*j+1]<<16|C[2*j];for(j=I;j<2*I;j++)C[j]=0;return new d(C,0)};function X(j,I){for(;(j[I]&65535)!=j[I];)j[I+1]+=j[I]>>>16,j[I]&=65535,I++}function tt(j,I){this.g=j,this.h=I}function lt(j,I){if(M(I))throw Error("division by zero");if(M(j))return new tt(w,w);if(L(j))return I=lt(U(j),I),new tt(U(I.g),U(I.h));if(L(I))return I=lt(j,U(I)),new tt(U(I.g),I.h);if(j.g.length>30){if(L(j)||L(I))throw Error("slowDivide_ only works with positive integers.");for(var C=T,O=I;O.l(j)<=0;)C=Y(C),O=Y(O);var k=ot(C,1),z=ot(O,1);for(O=ot(O,2),C=ot(C,2);!M(O);){var D=z.add(O);D.l(j)<=0&&(k=k.add(C),z=D),O=ot(O,1),C=ot(C,1)}return I=K(j,k.j(I)),new tt(k,I)}for(k=w;j.l(I)>=0;){for(C=Math.max(1,Math.floor(j.m()/I.m())),O=Math.ceil(Math.log(C)/Math.LN2),O=O<=48?1:Math.pow(2,O-48),z=g(C),D=z.j(I);L(D)||D.l(j)>0;)C-=O,z=g(C),D=z.j(I);M(z)&&(z=T),k=k.add(z),j=K(j,D)}return new tt(k,j)}n.B=function(j){return lt(this,j).h},n.and=function(j){const I=Math.max(this.g.length,j.g.length),C=[];for(let O=0;O<I;O++)C[O]=this.i(O)&j.i(O);return new d(C,this.h&j.h)},n.or=function(j){const I=Math.max(this.g.length,j.g.length),C=[];for(let O=0;O<I;O++)C[O]=this.i(O)|j.i(O);return new d(C,this.h|j.h)},n.xor=function(j){const I=Math.max(this.g.length,j.g.length),C=[];for(let O=0;O<I;O++)C[O]=this.i(O)^j.i(O);return new d(C,this.h^j.h)};function Y(j){const I=j.g.length+1,C=[];for(let O=0;O<I;O++)C[O]=j.i(O)<<1|j.i(O-1)>>>31;return new d(C,j.h)}function ot(j,I){const C=I>>5;I%=32;const O=j.g.length-C,k=[];for(let z=0;z<O;z++)k[z]=I>0?j.i(z+C)>>>I|j.i(z+C+1)<<32-I:j.i(z+C);return new d(k,j.h)}a.prototype.digest=a.prototype.A,a.prototype.reset=a.prototype.u,a.prototype.update=a.prototype.v,L2=a,d.prototype.add=d.prototype.add,d.prototype.multiply=d.prototype.j,d.prototype.modulo=d.prototype.B,d.prototype.compare=d.prototype.l,d.prototype.toNumber=d.prototype.m,d.prototype.toString=d.prototype.toString,d.prototype.getBits=d.prototype.i,d.fromNumber=g,d.fromString=v,ta=d}).apply(typeof uv<"u"?uv:typeof self<"u"?self:typeof window<"u"?window:{});var Qc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var z2,Ll,$2,hh,dm,B2,F2,q2;(function(){var n,t=Object.defineProperty;function i(c){c=[typeof globalThis=="object"&&globalThis,c,typeof window=="object"&&window,typeof self=="object"&&self,typeof Qc=="object"&&Qc];for(var x=0;x<c.length;++x){var _=c[x];if(_&&_.Math==Math)return _}throw Error("Cannot find global object")}var a=i(this);function o(c,x){if(x)t:{var _=a;c=c.split(".");for(var S=0;S<c.length-1;S++){var q=c[S];if(!(q in _))break t;_=_[q]}c=c[c.length-1],S=_[c],x=x(S),x!=S&&x!=null&&t(_,c,{configurable:!0,writable:!0,value:x})}}o("Symbol.dispose",function(c){return c||Symbol("Symbol.dispose")}),o("Array.prototype.values",function(c){return c||function(){return this[Symbol.iterator]()}}),o("Object.entries",function(c){return c||function(x){var _=[],S;for(S in x)Object.prototype.hasOwnProperty.call(x,S)&&_.push([S,x[S]]);return _}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var u=u||{},d=this||self;function m(c){var x=typeof c;return x=="object"&&c!=null||x=="function"}function p(c,x,_){return c.call.apply(c.bind,arguments)}function g(c,x,_){return g=p,g.apply(null,arguments)}function v(c,x){var _=Array.prototype.slice.call(arguments,1);return function(){var S=_.slice();return S.push.apply(S,arguments),c.apply(this,S)}}function w(c,x){function _(){}_.prototype=x.prototype,c.Z=x.prototype,c.prototype=new _,c.prototype.constructor=c,c.Ob=function(S,q,W){for(var ut=Array(arguments.length-2),Rt=2;Rt<arguments.length;Rt++)ut[Rt-2]=arguments[Rt];return x.prototype[q].apply(S,ut)}}var T=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?c=>c&&AsyncContext.Snapshot.wrap(c):c=>c;function R(c){const x=c.length;if(x>0){const _=Array(x);for(let S=0;S<x;S++)_[S]=c[S];return _}return[]}function M(c,x){for(let S=1;S<arguments.length;S++){const q=arguments[S];var _=typeof q;if(_=_!="object"?_:q?Array.isArray(q)?"array":_:"null",_=="array"||_=="object"&&typeof q.length=="number"){_=c.length||0;const W=q.length||0;c.length=_+W;for(let ut=0;ut<W;ut++)c[_+ut]=q[ut]}else c.push(q)}}class L{constructor(x,_){this.i=x,this.j=_,this.h=0,this.g=null}get(){let x;return this.h>0?(this.h--,x=this.g,this.g=x.next,x.next=null):x=this.i(),x}}function U(c){d.setTimeout(()=>{throw c},0)}function K(){var c=j;let x=null;return c.g&&(x=c.g,c.g=c.g.next,c.g||(c.h=null),x.next=null),x}class X{constructor(){this.h=this.g=null}add(x,_){const S=tt.get();S.set(x,_),this.h?this.h.next=S:this.g=S,this.h=S}}var tt=new L(()=>new lt,c=>c.reset());class lt{constructor(){this.next=this.g=this.h=null}set(x,_){this.h=x,this.g=_,this.next=null}reset(){this.next=this.g=this.h=null}}let Y,ot=!1,j=new X,I=()=>{const c=Promise.resolve(void 0);Y=()=>{c.then(C)}};function C(){for(var c;c=K();){try{c.h.call(c.g)}catch(_){U(_)}var x=tt;x.j(c),x.h<100&&(x.h++,c.next=x.g,x.g=c)}ot=!1}function O(){this.u=this.u,this.C=this.C}O.prototype.u=!1,O.prototype.dispose=function(){this.u||(this.u=!0,this.N())},O.prototype[Symbol.dispose]=function(){this.dispose()},O.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function k(c,x){this.type=c,this.g=this.target=x,this.defaultPrevented=!1}k.prototype.h=function(){this.defaultPrevented=!0};var z=(function(){if(!d.addEventListener||!Object.defineProperty)return!1;var c=!1,x=Object.defineProperty({},"passive",{get:function(){c=!0}});try{const _=()=>{};d.addEventListener("test",_,x),d.removeEventListener("test",_,x)}catch{}return c})();function D(c){return/^[\s\xa0]*$/.test(c)}function se(c,x){k.call(this,c?c.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,c&&this.init(c,x)}w(se,k),se.prototype.init=function(c,x){const _=this.type=c.type,S=c.changedTouches&&c.changedTouches.length?c.changedTouches[0]:null;this.target=c.target||c.srcElement,this.g=x,x=c.relatedTarget,x||(_=="mouseover"?x=c.fromElement:_=="mouseout"&&(x=c.toElement)),this.relatedTarget=x,S?(this.clientX=S.clientX!==void 0?S.clientX:S.pageX,this.clientY=S.clientY!==void 0?S.clientY:S.pageY,this.screenX=S.screenX||0,this.screenY=S.screenY||0):(this.clientX=c.clientX!==void 0?c.clientX:c.pageX,this.clientY=c.clientY!==void 0?c.clientY:c.pageY,this.screenX=c.screenX||0,this.screenY=c.screenY||0),this.button=c.button,this.key=c.key||"",this.ctrlKey=c.ctrlKey,this.altKey=c.altKey,this.shiftKey=c.shiftKey,this.metaKey=c.metaKey,this.pointerId=c.pointerId||0,this.pointerType=c.pointerType,this.state=c.state,this.i=c,c.defaultPrevented&&se.Z.h.call(this)},se.prototype.h=function(){se.Z.h.call(this);const c=this.i;c.preventDefault?c.preventDefault():c.returnValue=!1};var qt="closure_listenable_"+(Math.random()*1e6|0),J=0;function dt(c,x,_,S,q){this.listener=c,this.proxy=null,this.src=x,this.type=_,this.capture=!!S,this.ha=q,this.key=++J,this.da=this.fa=!1}function yt(c){c.da=!0,c.listener=null,c.proxy=null,c.src=null,c.ha=null}function jt(c,x,_){for(const S in c)x.call(_,c[S],S,c)}function V(c,x){for(const _ in c)x.call(void 0,c[_],_,c)}function at(c){const x={};for(const _ in c)x[_]=c[_];return x}const ct="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function ht(c,x){let _,S;for(let q=1;q<arguments.length;q++){S=arguments[q];for(_ in S)c[_]=S[_];for(let W=0;W<ct.length;W++)_=ct[W],Object.prototype.hasOwnProperty.call(S,_)&&(c[_]=S[_])}}function gt(c){this.src=c,this.g={},this.h=0}gt.prototype.add=function(c,x,_,S,q){const W=c.toString();c=this.g[W],c||(c=this.g[W]=[],this.h++);const ut=_t(c,x,S,q);return ut>-1?(x=c[ut],_||(x.fa=!1)):(x=new dt(x,this.src,W,!!S,q),x.fa=_,c.push(x)),x};function Ct(c,x){const _=x.type;if(_ in c.g){var S=c.g[_],q=Array.prototype.indexOf.call(S,x,void 0),W;(W=q>=0)&&Array.prototype.splice.call(S,q,1),W&&(yt(x),c.g[_].length==0&&(delete c.g[_],c.h--))}}function _t(c,x,_,S){for(let q=0;q<c.length;++q){const W=c[q];if(!W.da&&W.listener==x&&W.capture==!!_&&W.ha==S)return q}return-1}var ge="closure_lm_"+(Math.random()*1e6|0),Lt={};function Me(c,x,_,S,q){if(Array.isArray(x)){for(let W=0;W<x.length;W++)Me(c,x[W],_,S,q);return null}return _=Tu(_),c&&c[qt]?c.J(x,_,m(S)?!!S.capture:!1,q):Mi(c,x,_,!1,S,q)}function Mi(c,x,_,S,q,W){if(!x)throw Error("Invalid event type");const ut=m(q)?!!q.capture:!!q;let Rt=jo(c);if(Rt||(c[ge]=Rt=new gt(c)),_=Rt.add(x,_,S,ut,W),_.proxy)return _;if(S=Hn(),_.proxy=S,S.src=c,S.listener=_,c.addEventListener)z||(q=ut),q===void 0&&(q=!1),c.addEventListener(x.toString(),S,q);else if(c.attachEvent)c.attachEvent(ss(x.toString()),S);else if(c.addListener&&c.removeListener)c.addListener(S);else throw Error("addEventListener and attachEvent are unavailable.");return _}function Hn(){function c(_){return x.call(c.src,c.listener,_)}const x=ud;return c}function on(c,x,_,S,q){if(Array.isArray(x))for(var W=0;W<x.length;W++)on(c,x[W],_,S,q);else S=m(S)?!!S.capture:!!S,_=Tu(_),c&&c[qt]?(c=c.i,W=String(x).toString(),W in c.g&&(x=c.g[W],_=_t(x,_,S,q),_>-1&&(yt(x[_]),Array.prototype.splice.call(x,_,1),x.length==0&&(delete c.g[W],c.h--)))):c&&(c=jo(c))&&(x=c.g[x.toString()],c=-1,x&&(c=_t(x,_,S,q)),(_=c>-1?x[c]:null)&&ca(_))}function ca(c){if(typeof c!="number"&&c&&!c.da){var x=c.src;if(x&&x[qt])Ct(x.i,c);else{var _=c.type,S=c.proxy;x.removeEventListener?x.removeEventListener(_,S,c.capture):x.detachEvent?x.detachEvent(ss(_),S):x.addListener&&x.removeListener&&x.removeListener(S),(_=jo(x))?(Ct(_,c),_.h==0&&(_.src=null,x[ge]=null)):yt(c)}}}function ss(c){return c in Lt?Lt[c]:Lt[c]="on"+c}function ud(c,x){if(c.da)c=!0;else{x=new se(x,this);const _=c.listener,S=c.ha||c.src;c.fa&&ca(c),c=_.call(S,x)}return c}function jo(c){return c=c[ge],c instanceof gt?c:null}var pn="__closure_events_fn_"+(Math.random()*1e9>>>0);function Tu(c){return typeof c=="function"?c:(c[pn]||(c[pn]=function(x){return c.handleEvent(x)}),c[pn])}function Oe(){O.call(this),this.i=new gt(this),this.M=this,this.G=null}w(Oe,O),Oe.prototype[qt]=!0,Oe.prototype.removeEventListener=function(c,x,_,S){on(this,c,x,_,S)};function Le(c,x){var _,S=c.G;if(S)for(_=[];S;S=S.G)_.push(S);if(c=c.M,S=x.type||x,typeof x=="string")x=new k(x,c);else if(x instanceof k)x.target=x.target||c;else{var q=x;x=new k(S,c),ht(x,q)}q=!0;let W,ut;if(_)for(ut=_.length-1;ut>=0;ut--)W=x.g=_[ut],q=Oi(W,S,!0,x)&&q;if(W=x.g=c,q=Oi(W,S,!0,x)&&q,q=Oi(W,S,!1,x)&&q,_)for(ut=0;ut<_.length;ut++)W=x.g=_[ut],q=Oi(W,S,!1,x)&&q}Oe.prototype.N=function(){if(Oe.Z.N.call(this),this.i){var c=this.i;for(const x in c.g){const _=c.g[x];for(let S=0;S<_.length;S++)yt(_[S]);delete c.g[x],c.h--}}this.G=null},Oe.prototype.J=function(c,x,_,S){return this.i.add(String(c),x,!1,_,S)},Oe.prototype.K=function(c,x,_,S){return this.i.add(String(c),x,!0,_,S)};function Oi(c,x,_,S){if(x=c.i.g[String(x)],!x)return!0;x=x.concat();let q=!0;for(let W=0;W<x.length;++W){const ut=x[W];if(ut&&!ut.da&&ut.capture==_){const Rt=ut.listener,oe=ut.ha||ut.src;ut.fa&&Ct(c.i,ut),q=Rt.call(oe,S)!==!1&&q}}return q&&!S.defaultPrevented}function cd(c,x){if(typeof c!="function")if(c&&typeof c.handleEvent=="function")c=g(c.handleEvent,c);else throw Error("Invalid listener argument");return Number(x)>2147483647?-1:d.setTimeout(c,x||0)}function Co(c){c.g=cd(()=>{c.g=null,c.i&&(c.i=!1,Co(c))},c.l);const x=c.h;c.h=null,c.m.apply(null,x)}class hd extends O{constructor(x,_){super(),this.m=x,this.l=_,this.h=null,this.i=!1,this.g=null}j(x){this.h=arguments,this.g?this.i=!0:Co(this)}N(){super.N(),this.g&&(d.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function ha(c){O.call(this),this.h=c,this.g={}}w(ha,O);var dr=[];function Je(c){jt(c.g,function(x,_){this.g.hasOwnProperty(_)&&ca(x)},c),c.g={}}ha.prototype.N=function(){ha.Z.N.call(this),Je(this)},ha.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Dn=d.JSON.stringify,ln=d.JSON.parse,dd=class{stringify(c){return d.JSON.stringify(c,void 0)}parse(c){return d.JSON.parse(c,void 0)}};function Su(){}function Au(){}var oi={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function fr(){k.call(this,"d")}w(fr,k);function Gn(){k.call(this,"c")}w(Gn,k);var Nn={},pr=null;function os(){return pr=pr||new Oe}Nn.Ia="serverreachability";function Do(c){k.call(this,Nn.Ia,c)}w(Do,k);function mr(c){const x=os();Le(x,new Do(x))}Nn.STAT_EVENT="statevent";function ls(c,x){k.call(this,Nn.STAT_EVENT,c),this.stat=x}w(ls,k);function ve(c){const x=os();Le(x,new ls(x,c))}Nn.Ja="timingevent";function Ru(c,x){k.call(this,Nn.Ja,c),this.size=x}w(Ru,k);function gr(c,x){if(typeof c!="function")throw Error("Fn must not be null and must be a function");return d.setTimeout(function(){c()},x)}function yr(){this.g=!0}yr.prototype.ua=function(){this.g=!1};function No(c,x,_,S,q,W){c.info(function(){if(c.g)if(W){var ut="",Rt=W.split("&");for(let Qt=0;Qt<Rt.length;Qt++){var oe=Rt[Qt].split("=");if(oe.length>1){const we=oe[0];oe=oe[1];const En=we.split("_");ut=En.length>=2&&En[1]=="type"?ut+(we+"="+oe+"&"):ut+(we+"=redacted&")}}}else ut=null;else ut=W;return"XMLHTTP REQ ("+S+") [attempt "+q+"]: "+x+`
`+_+`
`+ut})}function Mo(c,x,_,S,q,W,ut){c.info(function(){return"XMLHTTP RESP ("+S+") [ attempt "+q+"]: "+x+`
`+_+`
`+W+" "+ut})}function Vi(c,x,_,S){c.info(function(){return"XMLHTTP TEXT ("+x+"): "+li(c,_)+(S?" "+S:"")})}function fd(c,x){c.info(function(){return"TIMEOUT: "+x})}yr.prototype.info=function(){};function li(c,x){if(!c.g)return x;if(!x)return null;try{const W=JSON.parse(x);if(W){for(c=0;c<W.length;c++)if(Array.isArray(W[c])){var _=W[c];if(!(_.length<2)){var S=_[1];if(Array.isArray(S)&&!(S.length<1)){var q=S[0];if(q!="noop"&&q!="stop"&&q!="close")for(let ut=1;ut<S.length;ut++)S[ut]=""}}}}return Dn(W)}catch{return x}}var _e={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},He={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},ki;function da(){}w(da,Su),da.prototype.g=function(){return new XMLHttpRequest},ki=new da;function fa(c){return encodeURIComponent(String(c))}function pd(c){var x=1;c=c.split(":");const _=[];for(;x>0&&c.length;)_.push(c.shift()),x--;return c.length&&_.push(c.join(":")),_}function Yn(c,x,_,S){this.j=c,this.i=x,this.l=_,this.S=S||1,this.V=new ha(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new xr}function xr(){this.i=null,this.g="",this.h=!1}var us={},ui={};function ci(c,x,_){c.M=1,c.A=Ui(fe(x)),c.u=_,c.R=!0,vr(c,null)}function vr(c,x){c.F=Date.now(),pa(c),c.B=fe(c.A);var _=c.B,S=c.S;Array.isArray(S)||(S=[String(S)]),Du(_.i,"t",S),c.C=0,_=c.j.L,c.h=new xr,c.g=vs(c.j,_?x:null,!c.u),c.P>0&&(c.O=new hd(g(c.Y,c,c.g),c.P)),x=c.V,_=c.g,S=c.ba;var q="readystatechange";Array.isArray(q)||(q&&(dr[0]=q.toString()),q=dr);for(let W=0;W<q.length;W++){const ut=Me(_,q[W],S||x.handleEvent,!1,x.h||x);if(!ut)break;x.g[ut.key]=ut}x=c.J?at(c.J):{},c.u?(c.v||(c.v="POST"),x["Content-Type"]="application/x-www-form-urlencoded",c.g.ea(c.B,c.v,c.u,x)):(c.v="GET",c.g.ea(c.B,c.v,null,x)),mr(),No(c.i,c.v,c.B,c.l,c.S,c.u)}Yn.prototype.ba=function(c){c=c.target;const x=this.O;x&&tn(c)==3?x.j():this.Y(c)},Yn.prototype.Y=function(c){try{if(c==this.g)t:{const Rt=tn(this.g),oe=this.g.ya(),Qt=this.g.ca();if(!(Rt<3)&&(Rt!=3||this.g&&(this.h.h||this.g.la()||Sa(this.g)))){this.K||Rt!=4||oe==7||(oe==8||Qt<=0?mr(3):mr(2)),di(this);var x=this.g.ca();this.X=x;var _=_r(this);if(this.o=x==200,Mo(this.i,this.v,this.B,this.l,this.S,Rt,x),this.o){if(this.U&&!this.L){e:{if(this.g){var S,q=this.g;if((S=q.g?q.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!D(S)){var W=S;break e}}W=null}if(c=W)Vi(this.i,this.l,c,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,cs(this,c);else{this.o=!1,this.m=3,ve(12),fi(this),ma(this);break t}}if(this.R){c=!0;let we;for(;!this.K&&this.C<_.length;)if(we=Iu(this,_),we==ui){Rt==4&&(this.m=4,ve(14),c=!1),Vi(this.i,this.l,null,"[Incomplete Response]");break}else if(we==us){this.m=4,ve(15),Vi(this.i,this.l,_,"[Invalid Chunk]"),c=!1;break}else Vi(this.i,this.l,we,null),cs(this,we);if(Ee(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Rt!=4||_.length!=0||this.h.h||(this.m=1,ve(16),c=!1),this.o=this.o&&c,!c)Vi(this.i,this.l,_,"[Invalid Chunked Response]"),fi(this),ma(this);else if(_.length>0&&!this.W){this.W=!0;var ut=this.j;ut.g==this&&ut.aa&&!ut.P&&(ut.j.info("Great, no buffering proxy detected. Bytes received: "+_.length),Fo(ut),ut.P=!0,ve(11))}}else Vi(this.i,this.l,_,null),cs(this,_);Rt==4&&fi(this),this.o&&!this.K&&(Rt==4?qo(this.j,this):(this.o=!1,pa(this)))}else Aa(this.g),x==400&&_.indexOf("Unknown SID")>0?(this.m=3,ve(12)):(this.m=0,ve(13)),fi(this),ma(this)}}}catch{}finally{}};function _r(c){if(!Ee(c))return c.g.la();const x=Sa(c.g);if(x==="")return"";let _="";const S=x.length,q=tn(c.g)==4;if(!c.h.i){if(typeof TextDecoder>"u")return fi(c),ma(c),"";c.h.i=new d.TextDecoder}for(let W=0;W<S;W++)c.h.h=!0,_+=c.h.i.decode(x[W],{stream:!(q&&W==S-1)});return x.length=0,c.h.g+=_,c.C=0,c.h.g}function Ee(c){return c.g?c.v=="GET"&&c.M!=2&&c.j.Aa:!1}function Iu(c,x){var _=c.C,S=x.indexOf(`
`,_);return S==-1?ui:(_=Number(x.substring(_,S)),isNaN(_)?us:(S+=1,S+_>x.length?ui:(x=x.slice(S,S+_),c.C=S+_,x)))}Yn.prototype.cancel=function(){this.K=!0,fi(this)};function pa(c){c.T=Date.now()+c.H,hi(c,c.H)}function hi(c,x){if(c.D!=null)throw Error("WatchDog timer not null");c.D=gr(g(c.aa,c),x)}function di(c){c.D&&(d.clearTimeout(c.D),c.D=null)}Yn.prototype.aa=function(){this.D=null;const c=Date.now();c-this.T>=0?(fd(this.i,this.B),this.M!=2&&(mr(),ve(17)),fi(this),this.m=2,ma(this)):hi(this,this.T-c)};function ma(c){c.j.I==0||c.K||qo(c.j,c)}function fi(c){di(c);var x=c.O;x&&typeof x.dispose=="function"&&x.dispose(),c.O=null,Je(c.V),c.g&&(x=c.g,c.g=null,x.abort(),x.dispose())}function cs(c,x){try{var _=c.j;if(_.I!=0&&(_.g==c||xa(_.h,c))){if(!c.L&&xa(_.h,c)&&_.I==3){try{var S=_.Ba.g.parse(x)}catch{S=null}if(Array.isArray(S)&&S.length==3){var q=S;if(q[0]==0){t:if(!_.v){if(_.g)if(_.g.F+3e3<c.F)xs(_),pi(_);else break t;Bo(_),ve(18)}}else _.xa=q[1],0<_.xa-_.K&&q[2]<37500&&_.F&&_.A==0&&!_.C&&(_.C=gr(g(_.Va,_),6e3));Mn(_.h)<=1&&_.ta&&(_.ta=void 0)}else $i(_,11)}else if((c.L||_.g==c)&&xs(_),!D(x))for(q=_.Ba.g.parse(x),x=0;x<q.length;x++){let Qt=q[x];const we=Qt[0];if(!(we<=_.K))if(_.K=we,Qt=Qt[1],_.I==2)if(Qt[0]=="c"){_.M=Qt[1],_.ba=Qt[2];const En=Qt[3];En!=null&&(_.ka=En,_.j.info("VER="+_.ka));const mi=Qt[4];mi!=null&&(_.za=mi,_.j.info("SVER="+_.za));const Wn=Qt[5];Wn!=null&&typeof Wn=="number"&&Wn>0&&(S=1.5*Wn,_.O=S,_.j.info("backChannelRequestTimeoutMs_="+S)),S=_;const Zn=c.g;if(Zn){const Jn=Zn.g?Zn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Jn){var W=S.h;W.g||Jn.indexOf("spdy")==-1&&Jn.indexOf("quic")==-1&&Jn.indexOf("h2")==-1||(W.j=W.l,W.g=new Set,W.h&&(hs(W,W.h),W.h=null))}if(S.G){const Ho=Zn.g?Zn.g.getResponseHeader("X-HTTP-Session-Id"):null;Ho&&(S.wa=Ho,Zt(S.J,S.G,Ho))}}_.I=3,_.l&&_.l.ra(),_.aa&&(_.T=Date.now()-c.F,_.j.info("Handshake RTT: "+_.T+"ms")),S=_;var ut=c;if(S.na=zu(S,S.L?S.ba:null,S.W),ut.L){Pi(S.h,ut);var Rt=ut,oe=S.O;oe&&(Rt.H=oe),Rt.D&&(di(Rt),pa(Rt)),S.g=ut}else ku(S);_.i.length>0&&Ca(_)}else Qt[0]!="stop"&&Qt[0]!="close"||$i(_,7);else _.I==3&&(Qt[0]=="stop"||Qt[0]=="close"?Qt[0]=="stop"?$i(_,7):Ia(_):Qt[0]!="noop"&&_.l&&_.l.qa(Qt),_.A=0)}}mr(4)}catch{}}var md=class{constructor(c,x){this.g=c,this.map=x}};function ga(c){this.l=c||10,d.PerformanceNavigationTiming?(c=d.performance.getEntriesByType("navigation"),c=c.length>0&&(c[0].nextHopProtocol=="hq"||c[0].nextHopProtocol=="h2")):c=!!(d.chrome&&d.chrome.loadTimes&&d.chrome.loadTimes()&&d.chrome.loadTimes().wasFetchedViaSpdy),this.j=c?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function ya(c){return c.h?!0:c.g?c.g.size>=c.j:!1}function Mn(c){return c.h?1:c.g?c.g.size:0}function xa(c,x){return c.h?c.h==x:c.g?c.g.has(x):!1}function hs(c,x){c.g?c.g.add(x):c.h=x}function Pi(c,x){c.h&&c.h==x?c.h=null:c.g&&c.g.has(x)&&c.g.delete(x)}ga.prototype.cancel=function(){if(this.i=ds(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const c of this.g.values())c.cancel();this.g.clear()}};function ds(c){if(c.h!=null)return c.i.concat(c.h.G);if(c.g!=null&&c.g.size!==0){let x=c.i;for(const _ of c.g.values())x=x.concat(_.G);return x}return R(c.i)}var fs=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function gd(c,x){if(c){c=c.split("&");for(let _=0;_<c.length;_++){const S=c[_].indexOf("=");let q,W=null;S>=0?(q=c[_].substring(0,S),W=c[_].substring(S+1)):q=c[_],x(q,W?decodeURIComponent(W.replace(/\+/g," ")):"")}}}function Qn(c){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let x;c instanceof Qn?(this.l=c.l,Er(this,c.j),this.o=c.o,this.g=c.g,va(this,c.u),this.h=c.h,wr(this,Nu(c.i)),this.m=c.m):c&&(x=String(c).match(fs))?(this.l=!1,Er(this,x[1]||"",!0),this.o=_a(x[2]||""),this.g=_a(x[3]||"",!0),va(this,x[4]),this.h=_a(x[5]||"",!0),wr(this,x[6]||"",!0),this.m=_a(x[7]||"")):(this.l=!1,this.i=new On(null,this.l))}Qn.prototype.toString=function(){const c=[];var x=this.j;x&&c.push(ze(x,Vo,!0),":");var _=this.g;return(_||x=="file")&&(c.push("//"),(x=this.o)&&c.push(ze(x,Vo,!0),"@"),c.push(fa(_).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),_=this.u,_!=null&&c.push(":",String(_))),(_=this.h)&&(this.g&&_.charAt(0)!="/"&&c.push("/"),c.push(ze(_,_.charAt(0)=="/"?br:ko,!0))),(_=this.i.toString())&&c.push("?",_),(_=this.m)&&c.push("#",ze(_,Cu)),c.join("")},Qn.prototype.resolve=function(c){const x=fe(this);let _=!!c.j;_?Er(x,c.j):_=!!c.o,_?x.o=c.o:_=!!c.g,_?x.g=c.g:_=c.u!=null;var S=c.h;if(_)va(x,c.u);else if(_=!!c.h){if(S.charAt(0)!="/")if(this.g&&!this.h)S="/"+S;else{var q=x.h.lastIndexOf("/");q!=-1&&(S=x.h.slice(0,q+1)+S)}if(q=S,q==".."||q==".")S="";else if(q.indexOf("./")!=-1||q.indexOf("/.")!=-1){S=q.lastIndexOf("/",0)==0,q=q.split("/");const W=[];for(let ut=0;ut<q.length;){const Rt=q[ut++];Rt=="."?S&&ut==q.length&&W.push(""):Rt==".."?((W.length>1||W.length==1&&W[0]!="")&&W.pop(),S&&ut==q.length&&W.push("")):(W.push(Rt),S=!0)}S=W.join("/")}else S=q}return _?x.h=S:_=c.i.toString()!=="",_?wr(x,Nu(c.i)):_=!!c.m,_&&(x.m=c.m),x};function fe(c){return new Qn(c)}function Er(c,x,_){c.j=_?_a(x,!0):x,c.j&&(c.j=c.j.replace(/:$/,""))}function va(c,x){if(x){if(x=Number(x),isNaN(x)||x<0)throw Error("Bad port number "+x);c.u=x}else c.u=null}function wr(c,x,_){x instanceof On?(c.i=x,Lo(c.i,c.l)):(_||(x=ze(x,ju)),c.i=new On(x,c.l))}function Zt(c,x,_){c.i.set(x,_)}function Ui(c){return Zt(c,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),c}function _a(c,x){return c?x?decodeURI(c.replace(/%25/g,"%2525")):decodeURIComponent(c):""}function ze(c,x,_){return typeof c=="string"?(c=encodeURI(c).replace(x,Oo),_&&(c=c.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),c):null}function Oo(c){return c=c.charCodeAt(0),"%"+(c>>4&15).toString(16)+(c&15).toString(16)}var Vo=/[#\/\?@]/g,ko=/[#\?:]/g,br=/[#\?]/g,ju=/[#\?@]/g,Cu=/#/g;function On(c,x){this.h=this.g=null,this.i=c||null,this.j=!!x}function Li(c){c.g||(c.g=new Map,c.h=0,c.i&&gd(c.i,function(x,_){c.add(decodeURIComponent(x.replace(/\+/g," ")),_)}))}n=On.prototype,n.add=function(c,x){Li(this),this.i=null,c=Xn(this,c);let _=this.g.get(c);return _||this.g.set(c,_=[]),_.push(x),this.h+=1,this};function Po(c,x){Li(c),x=Xn(c,x),c.g.has(x)&&(c.i=null,c.h-=c.g.get(x).length,c.g.delete(x))}function Uo(c,x){return Li(c),x=Xn(c,x),c.g.has(x)}n.forEach=function(c,x){Li(this),this.g.forEach(function(_,S){_.forEach(function(q){c.call(x,q,S,this)},this)},this)};function ps(c,x){Li(c);let _=[];if(typeof x=="string")Uo(c,x)&&(_=_.concat(c.g.get(Xn(c,x))));else for(c=Array.from(c.g.values()),x=0;x<c.length;x++)_=_.concat(c[x]);return _}n.set=function(c,x){return Li(this),this.i=null,c=Xn(this,c),Uo(this,c)&&(this.h-=this.g.get(c).length),this.g.set(c,[x]),this.h+=1,this},n.get=function(c,x){return c?(c=ps(this,c),c.length>0?String(c[0]):x):x};function Du(c,x,_){Po(c,x),_.length>0&&(c.i=null,c.g.set(Xn(c,x),R(_)),c.h+=_.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const c=[],x=Array.from(this.g.keys());for(let S=0;S<x.length;S++){var _=x[S];const q=fa(_);_=ps(this,_);for(let W=0;W<_.length;W++){let ut=q;_[W]!==""&&(ut+="="+fa(_[W])),c.push(ut)}}return this.i=c.join("&")};function Nu(c){const x=new On;return x.i=c.i,c.g&&(x.g=new Map(c.g),x.h=c.h),x}function Xn(c,x){return x=String(x),c.j&&(x=x.toLowerCase()),x}function Lo(c,x){x&&!c.j&&(Li(c),c.i=null,c.g.forEach(function(_,S){const q=S.toLowerCase();S!=q&&(Po(this,S),Du(this,q,_))},c)),c.j=x}function zo(c,x){const _=new yr;if(d.Image){const S=new Image;S.onload=v(un,_,"TestLoadImage: loaded",!0,x,S),S.onerror=v(un,_,"TestLoadImage: error",!1,x,S),S.onabort=v(un,_,"TestLoadImage: abort",!1,x,S),S.ontimeout=v(un,_,"TestLoadImage: timeout",!1,x,S),d.setTimeout(function(){S.ontimeout&&S.ontimeout()},1e4),S.src=c}else x(!1)}function Tr(c,x){const _=new yr,S=new AbortController,q=setTimeout(()=>{S.abort(),un(_,"TestPingServer: timeout",!1,x)},1e4);fetch(c,{signal:S.signal}).then(W=>{clearTimeout(q),W.ok?un(_,"TestPingServer: ok",!0,x):un(_,"TestPingServer: server error",!1,x)}).catch(()=>{clearTimeout(q),un(_,"TestPingServer: error",!1,x)})}function un(c,x,_,S,q){try{q&&(q.onload=null,q.onerror=null,q.onabort=null,q.ontimeout=null),S(_)}catch{}}function Mu(){this.g=new dd}function Ea(c){this.i=c.Sb||null,this.h=c.ab||!1}w(Ea,Su),Ea.prototype.g=function(){return new wa(this.i,this.h)};function wa(c,x){Oe.call(this),this.H=c,this.o=x,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}w(wa,Oe),n=wa.prototype,n.open=function(c,x){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=c,this.D=x,this.readyState=1,zi(this)},n.send=function(c){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const x={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};c&&(x.body=c),(this.H||d).fetch(new Request(this.D,x)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,cn(this)),this.readyState=0},n.Pa=function(c){if(this.g&&(this.l=c,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=c.headers,this.readyState=2,zi(this)),this.g&&(this.readyState=3,zi(this),this.g)))if(this.responseType==="arraybuffer")c.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof d.ReadableStream<"u"&&"body"in c){if(this.j=c.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Sr(this)}else c.text().then(this.Oa.bind(this),this.ga.bind(this))};function Sr(c){c.j.read().then(c.Ma.bind(c)).catch(c.ga.bind(c))}n.Ma=function(c){if(this.g){if(this.o&&c.value)this.response.push(c.value);else if(!this.o){var x=c.value?c.value:new Uint8Array(0);(x=this.B.decode(x,{stream:!c.done}))&&(this.response=this.responseText+=x)}c.done?cn(this):zi(this),this.readyState==3&&Sr(this)}},n.Oa=function(c){this.g&&(this.response=this.responseText=c,cn(this))},n.Na=function(c){this.g&&(this.response=c,cn(this))},n.ga=function(){this.g&&cn(this)};function cn(c){c.readyState=4,c.l=null,c.j=null,c.B=null,zi(c)}n.setRequestHeader=function(c,x){this.A.append(c,x)},n.getResponseHeader=function(c){return this.h&&this.h.get(c.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const c=[],x=this.h.entries();for(var _=x.next();!_.done;)_=_.value,c.push(_[0]+": "+_[1]),_=x.next();return c.join(`\r
`)};function zi(c){c.onreadystatechange&&c.onreadystatechange.call(c)}Object.defineProperty(wa.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(c){this.m=c?"include":"same-origin"}});function Ar(c){let x="";return jt(c,function(_,S){x+=S,x+=":",x+=_,x+=`\r
`}),x}function Vn(c,x,_){t:{for(S in _){var S=!1;break t}S=!0}S||(_=Ar(_),typeof c=="string"?_!=null&&fa(_):Zt(c,x,_))}function ie(c){Oe.call(this),this.headers=new Map,this.L=c||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}w(ie,Oe);var ms=/^https?$/i,Ou=["POST","PUT"];n=ie.prototype,n.Fa=function(c){this.H=c},n.ea=function(c,x,_,S){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+c);x=x?x.toUpperCase():"GET",this.D=c,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():ki.g(),this.g.onreadystatechange=T(g(this.Ca,this));try{this.B=!0,this.g.open(x,String(c),!0),this.B=!1}catch(W){ba(this,W);return}if(c=_||"",_=new Map(this.headers),S)if(Object.getPrototypeOf(S)===Object.prototype)for(var q in S)_.set(q,S[q]);else if(typeof S.keys=="function"&&typeof S.get=="function")for(const W of S.keys())_.set(W,S.get(W));else throw Error("Unknown input type for opt_headers: "+String(S));S=Array.from(_.keys()).find(W=>W.toLowerCase()=="content-type"),q=d.FormData&&c instanceof d.FormData,!(Array.prototype.indexOf.call(Ou,x,void 0)>=0)||S||q||_.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[W,ut]of _)this.g.setRequestHeader(W,ut);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(c),this.v=!1}catch(W){ba(this,W)}};function ba(c,x){c.h=!1,c.g&&(c.j=!0,c.g.abort(),c.j=!1),c.l=x,c.o=5,Ta(c),Ve(c)}function Ta(c){c.A||(c.A=!0,Le(c,"complete"),Le(c,"error"))}n.abort=function(c){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=c||7,Le(this,"complete"),Le(this,"abort"),Ve(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ve(this,!0)),ie.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?$o(this):this.Xa())},n.Xa=function(){$o(this)};function $o(c){if(c.h&&typeof u<"u"){if(c.v&&tn(c)==4)setTimeout(c.Ca.bind(c),0);else if(Le(c,"readystatechange"),tn(c)==4){c.h=!1;try{const W=c.ca();t:switch(W){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var x=!0;break t;default:x=!1}var _;if(!(_=x)){var S;if(S=W===0){let ut=String(c.D).match(fs)[1]||null;!ut&&d.self&&d.self.location&&(ut=d.self.location.protocol.slice(0,-1)),S=!ms.test(ut?ut.toLowerCase():"")}_=S}if(_)Le(c,"complete"),Le(c,"success");else{c.o=6;try{var q=tn(c)>2?c.g.statusText:""}catch{q=""}c.l=q+" ["+c.ca()+"]",Ta(c)}}finally{Ve(c)}}}}function Ve(c,x){if(c.g){c.m&&(clearTimeout(c.m),c.m=null);const _=c.g;c.g=null,x||Le(c,"ready");try{_.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function tn(c){return c.g?c.g.readyState:0}n.ca=function(){try{return tn(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(c){if(this.g){var x=this.g.responseText;return c&&x.indexOf(c)==0&&(x=x.substring(c.length)),ln(x)}};function Sa(c){try{if(!c.g)return null;if("response"in c.g)return c.g.response;switch(c.F){case"":case"text":return c.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in c.g)return c.g.mozResponseArrayBuffer}return null}catch{return null}}function Aa(c){const x={};c=(c.g&&tn(c)>=2&&c.g.getAllResponseHeaders()||"").split(`\r
`);for(let S=0;S<c.length;S++){if(D(c[S]))continue;var _=pd(c[S]);const q=_[0];if(_=_[1],typeof _!="string")continue;_=_.trim();const W=x[q]||[];x[q]=W,W.push(_)}V(x,function(S){return S.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Ra(c,x,_){return _&&_.internalChannelParams&&_.internalChannelParams[c]||x}function gs(c){this.za=0,this.i=[],this.j=new yr,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Ra("failFast",!1,c),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Ra("baseRetryDelayMs",5e3,c),this.Za=Ra("retryDelaySeedMs",1e4,c),this.Ta=Ra("forwardChannelMaxRetries",2,c),this.va=Ra("forwardChannelRequestTimeoutMs",2e4,c),this.ma=c&&c.xmlHttpFactory||void 0,this.Ua=c&&c.Rb||void 0,this.Aa=c&&c.useFetchStreams||!1,this.O=void 0,this.L=c&&c.supportsCrossDomainXhr||!1,this.M="",this.h=new ga(c&&c.concurrentRequestLimit),this.Ba=new Mu,this.S=c&&c.fastHandshake||!1,this.R=c&&c.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=c&&c.Pb||!1,c&&c.ua&&this.j.ua(),c&&c.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&c&&c.detectBufferingProxy||!1,this.ia=void 0,c&&c.longPollingTimeout&&c.longPollingTimeout>0&&(this.ia=c.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=gs.prototype,n.ka=8,n.I=1,n.connect=function(c,x,_,S){ve(0),this.W=c,this.H=x||{},_&&S!==void 0&&(this.H.OSID=_,this.H.OAID=S),this.F=this.X,this.J=zu(this,null,this.W),Ca(this)};function Ia(c){if(ja(c),c.I==3){var x=c.V++,_=fe(c.J);if(Zt(_,"SID",c.M),Zt(_,"RID",x),Zt(_,"TYPE","terminate"),Da(c,_),x=new Yn(c,c.j,x),x.M=2,x.A=Ui(fe(_)),_=!1,d.navigator&&d.navigator.sendBeacon)try{_=d.navigator.sendBeacon(x.A.toString(),"")}catch{}!_&&d.Image&&(new Image().src=x.A,_=!0),_||(x.g=vs(x.j,null),x.g.ea(x.A)),x.F=Date.now(),pa(x)}Lu(c)}function pi(c){c.g&&(Fo(c),c.g.cancel(),c.g=null)}function ja(c){pi(c),c.v&&(d.clearTimeout(c.v),c.v=null),xs(c),c.h.cancel(),c.m&&(typeof c.m=="number"&&d.clearTimeout(c.m),c.m=null)}function Ca(c){if(!ya(c.h)&&!c.m){c.m=!0;var x=c.Ea;Y||I(),ot||(Y(),ot=!0),j.add(x,c),c.D=0}}function yd(c,x){return Mn(c.h)>=c.h.j-(c.m?1:0)?!1:c.m?(c.i=x.G.concat(c.i),!0):c.I==1||c.I==2||c.D>=(c.Sa?0:c.Ta)?!1:(c.m=gr(g(c.Ea,c,x),Uu(c,c.D)),c.D++,!0)}n.Ea=function(c){if(this.m)if(this.m=null,this.I==1){if(!c){this.V=Math.floor(Math.random()*1e5),c=this.V++;const q=new Yn(this,this.j,c);let W=this.o;if(this.U&&(W?(W=at(W),ht(W,this.U)):W=this.U),this.u!==null||this.R||(q.J=W,W=null),this.S)t:{for(var x=0,_=0;_<this.i.length;_++){e:{var S=this.i[_];if("__data__"in S.map&&(S=S.map.__data__,typeof S=="string")){S=S.length;break e}S=void 0}if(S===void 0)break;if(x+=S,x>4096){x=_;break t}if(x===4096||_===this.i.length-1){x=_+1;break t}}x=1e3}else x=1e3;x=ys(this,q,x),_=fe(this.J),Zt(_,"RID",c),Zt(_,"CVER",22),this.G&&Zt(_,"X-HTTP-Session-Id",this.G),Da(this,_),W&&(this.R?x="headers="+fa(Ar(W))+"&"+x:this.u&&Vn(_,this.u,W)),hs(this.h,q),this.Ra&&Zt(_,"TYPE","init"),this.S?(Zt(_,"$req",x),Zt(_,"SID","null"),q.U=!0,ci(q,_,null)):ci(q,_,x),this.I=2}}else this.I==3&&(c?Vu(this,c):this.i.length==0||ya(this.h)||Vu(this))};function Vu(c,x){var _;x?_=x.l:_=c.V++;const S=fe(c.J);Zt(S,"SID",c.M),Zt(S,"RID",_),Zt(S,"AID",c.K),Da(c,S),c.u&&c.o&&Vn(S,c.u,c.o),_=new Yn(c,c.j,_,c.D+1),c.u===null&&(_.J=c.o),x&&(c.i=x.G.concat(c.i)),x=ys(c,_,1e3),_.H=Math.round(c.va*.5)+Math.round(c.va*.5*Math.random()),hs(c.h,_),ci(_,S,x)}function Da(c,x){c.H&&jt(c.H,function(_,S){Zt(x,S,_)}),c.l&&jt({},function(_,S){Zt(x,S,_)})}function ys(c,x,_){_=Math.min(c.i.length,_);const S=c.l?g(c.l.Ka,c.l,c):null;t:{var q=c.i;let Rt=-1;for(;;){const oe=["count="+_];Rt==-1?_>0?(Rt=q[0].g,oe.push("ofs="+Rt)):Rt=0:oe.push("ofs="+Rt);let Qt=!0;for(let we=0;we<_;we++){var W=q[we].g;const En=q[we].map;if(W-=Rt,W<0)Rt=Math.max(0,q[we].g-100),Qt=!1;else try{W="req"+W+"_"||"";try{var ut=En instanceof Map?En:Object.entries(En);for(const[mi,Wn]of ut){let Zn=Wn;m(Wn)&&(Zn=Dn(Wn)),oe.push(W+mi+"="+encodeURIComponent(Zn))}}catch(mi){throw oe.push(W+"type="+encodeURIComponent("_badmap")),mi}}catch{S&&S(En)}}if(Qt){ut=oe.join("&");break t}}ut=void 0}return c=c.i.splice(0,_),x.G=c,ut}function ku(c){if(!c.g&&!c.v){c.Y=1;var x=c.Da;Y||I(),ot||(Y(),ot=!0),j.add(x,c),c.A=0}}function Bo(c){return c.g||c.v||c.A>=3?!1:(c.Y++,c.v=gr(g(c.Da,c),Uu(c,c.A)),c.A++,!0)}n.Da=function(){if(this.v=null,Pu(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var c=4*this.T;this.j.info("BP detection timer enabled: "+c),this.B=gr(g(this.Wa,this),c)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ve(10),pi(this),Pu(this))};function Fo(c){c.B!=null&&(d.clearTimeout(c.B),c.B=null)}function Pu(c){c.g=new Yn(c,c.j,"rpc",c.Y),c.u===null&&(c.g.J=c.o),c.g.P=0;var x=fe(c.na);Zt(x,"RID","rpc"),Zt(x,"SID",c.M),Zt(x,"AID",c.K),Zt(x,"CI",c.F?"0":"1"),!c.F&&c.ia&&Zt(x,"TO",c.ia),Zt(x,"TYPE","xmlhttp"),Da(c,x),c.u&&c.o&&Vn(x,c.u,c.o),c.O&&(c.g.H=c.O);var _=c.g;c=c.ba,_.M=1,_.A=Ui(fe(x)),_.u=null,_.R=!0,vr(_,c)}n.Va=function(){this.C!=null&&(this.C=null,pi(this),Bo(this),ve(19))};function xs(c){c.C!=null&&(d.clearTimeout(c.C),c.C=null)}function qo(c,x){var _=null;if(c.g==x){xs(c),Fo(c),c.g=null;var S=2}else if(xa(c.h,x))_=x.G,Pi(c.h,x),S=1;else return;if(c.I!=0){if(x.o)if(S==1){_=x.u?x.u.length:0,x=Date.now()-x.F;var q=c.D;S=os(),Le(S,new Ru(S,_)),Ca(c)}else ku(c);else if(q=x.m,q==3||q==0&&x.X>0||!(S==1&&yd(c,x)||S==2&&Bo(c)))switch(_&&_.length>0&&(x=c.h,x.i=x.i.concat(_)),q){case 1:$i(c,5);break;case 4:$i(c,10);break;case 3:$i(c,6);break;default:$i(c,2)}}}function Uu(c,x){let _=c.Qa+Math.floor(Math.random()*c.Za);return c.isActive()||(_*=2),_*x}function $i(c,x){if(c.j.info("Error code "+x),x==2){var _=g(c.bb,c),S=c.Ua;const q=!S;S=new Qn(S||"//www.google.com/images/cleardot.gif"),d.location&&d.location.protocol=="http"||Er(S,"https"),Ui(S),q?zo(S.toString(),_):Tr(S.toString(),_)}else ve(2);c.I=0,c.l&&c.l.pa(x),Lu(c),ja(c)}n.bb=function(c){c?(this.j.info("Successfully pinged google.com"),ve(2)):(this.j.info("Failed to ping google.com"),ve(1))};function Lu(c){if(c.I=0,c.ja=[],c.l){const x=ds(c.h);(x.length!=0||c.i.length!=0)&&(M(c.ja,x),M(c.ja,c.i),c.h.i.length=0,R(c.i),c.i.length=0),c.l.oa()}}function zu(c,x,_){var S=_ instanceof Qn?fe(_):new Qn(_);if(S.g!="")x&&(S.g=x+"."+S.g),va(S,S.u);else{var q=d.location;S=q.protocol,x=x?x+"."+q.hostname:q.hostname,q=+q.port;const W=new Qn(null);S&&Er(W,S),x&&(W.g=x),q&&va(W,q),_&&(W.h=_),S=W}return _=c.G,x=c.wa,_&&x&&Zt(S,_,x),Zt(S,"VER",c.ka),Da(c,S),S}function vs(c,x,_){if(x&&!c.L)throw Error("Can't create secondary domain capable XhrIo object.");return x=c.Aa&&!c.ma?new ie(new Ea({ab:_})):new ie(c.ma),x.Fa(c.L),x}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function $u(){}n=$u.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function _s(){}_s.prototype.g=function(c,x){return new hn(c,x)};function hn(c,x){Oe.call(this),this.g=new gs(x),this.l=c,this.h=x&&x.messageUrlParams||null,c=x&&x.messageHeaders||null,x&&x.clientProtocolHeaderRequired&&(c?c["X-Client-Protocol"]="webchannel":c={"X-Client-Protocol":"webchannel"}),this.g.o=c,c=x&&x.initMessageHeaders||null,x&&x.messageContentType&&(c?c["X-WebChannel-Content-Type"]=x.messageContentType:c={"X-WebChannel-Content-Type":x.messageContentType}),x&&x.sa&&(c?c["X-WebChannel-Client-Profile"]=x.sa:c={"X-WebChannel-Client-Profile":x.sa}),this.g.U=c,(c=x&&x.Qb)&&!D(c)&&(this.g.u=c),this.A=x&&x.supportsCrossDomainXhr||!1,this.v=x&&x.sendRawJson||!1,(x=x&&x.httpSessionIdParam)&&!D(x)&&(this.g.G=x,c=this.h,c!==null&&x in c&&(c=this.h,x in c&&delete c[x])),this.j=new Rr(this)}w(hn,Oe),hn.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},hn.prototype.close=function(){Ia(this.g)},hn.prototype.o=function(c){var x=this.g;if(typeof c=="string"){var _={};_.__data__=c,c=_}else this.v&&(_={},_.__data__=Dn(c),c=_);x.i.push(new md(x.Ya++,c)),x.I==3&&Ca(x)},hn.prototype.N=function(){this.g.l=null,delete this.j,Ia(this.g),delete this.g,hn.Z.N.call(this)};function Ko(c){fr.call(this),c.__headers__&&(this.headers=c.__headers__,this.statusCode=c.__status__,delete c.__headers__,delete c.__status__);var x=c.__sm__;if(x){t:{for(const _ in x){c=_;break t}c=void 0}(this.i=c)&&(c=this.i,x=x!==null&&c in x?x[c]:void 0),this.data=x}else this.data=c}w(Ko,fr);function Bu(){Gn.call(this),this.status=1}w(Bu,Gn);function Rr(c){this.g=c}w(Rr,$u),Rr.prototype.ra=function(){Le(this.g,"a")},Rr.prototype.qa=function(c){Le(this.g,new Ko(c))},Rr.prototype.pa=function(c){Le(this.g,new Bu)},Rr.prototype.oa=function(){Le(this.g,"b")},_s.prototype.createWebChannel=_s.prototype.g,hn.prototype.send=hn.prototype.o,hn.prototype.open=hn.prototype.m,hn.prototype.close=hn.prototype.close,q2=function(){return new _s},F2=function(){return os()},B2=Nn,dm={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},_e.NO_ERROR=0,_e.TIMEOUT=8,_e.HTTP_ERROR=6,hh=_e,He.COMPLETE="complete",$2=He,Au.EventType=oi,oi.OPEN="a",oi.CLOSE="b",oi.ERROR="c",oi.MESSAGE="d",Oe.prototype.listen=Oe.prototype.J,Ll=Au,ie.prototype.listenOnce=ie.prototype.K,ie.prototype.getLastError=ie.prototype.Ha,ie.prototype.getLastErrorCode=ie.prototype.ya,ie.prototype.getStatus=ie.prototype.ca,ie.prototype.getResponseJson=ie.prototype.La,ie.prototype.getResponseText=ie.prototype.la,ie.prototype.send=ie.prototype.ea,ie.prototype.setWithCredentials=ie.prototype.Fa,z2=ie}).apply(typeof Qc<"u"?Qc:typeof self<"u"?self:typeof window<"u"?window:{});const cv="@firebase/firestore",hv="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ja=new O2("@firebase/firestore");function Ws(){return Ja.logLevel}function pt(n,...t){if(Ja.logLevel<=Bt.DEBUG){const i=t.map(og);Ja.debug(`Firestore (${To}): ${n}`,...i)}}function ur(n,...t){if(Ja.logLevel<=Bt.ERROR){const i=t.map(og);Ja.error(`Firestore (${To}): ${n}`,...i)}}function co(n,...t){if(Ja.logLevel<=Bt.WARN){const i=t.map(og);Ja.warn(`Firestore (${To}): ${n}`,...i)}}function og(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bt(n,t,i){let a="Unexpected state";typeof t=="string"?a=t:i=t,K2(n,a,i)}function K2(n,t,i){let a=`FIRESTORE (${To}) INTERNAL ASSERTION FAILED: ${t} (ID: ${n.toString(16)})`;if(i!==void 0)try{a+=" CONTEXT: "+JSON.stringify(i)}catch{a+=" CONTEXT: "+i}throw ur(a),new Error(a)}function Yt(n,t,i,a){let o="Unexpected state";typeof i=="string"?o=i:a=i,n||K2(t,o,a)}function It(n,t){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lg{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",i=62*Math.floor(4.129032258064516);let a="";for(;a.length<20;){const o=wI(40);for(let u=0;u<o.length;++u)a.length<20&&o[u]<i&&(a+=t.charAt(o[u]%62))}return a}}function Pt(n,t){return n<t?-1:n>t?1:0}function fm(n,t){const i=Math.min(n.length,t.length);for(let a=0;a<i;a++){const o=n.charAt(a),u=t.charAt(a);if(o!==u)return Dp(o)===Dp(u)?Pt(o,u):Dp(o)?1:-1}return Pt(n.length,t.length)}const bI=55296,TI=57343;function Dp(n){const t=n.charCodeAt(0);return t>=bI&&t<=TI}function ho(n,t,i){return n.length===t.length&&n.every(((a,o)=>i(a,t[o])))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ug=-1;function Qh(n){return n==null}function Ah(n){return n===0&&1/n==-1/0}function MI(n){return typeof n=="number"&&Number.isInteger(n)&&!Ah(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cn{constructor(t){this.fields=t,t.sort(We.comparator)}static empty(){return new Cn([])}unionWith(t){let i=new Ue(We.comparator);for(const a of this.fields)i=i.add(a);for(const a of t)i=i.add(a);return new Cn(i.toArray())}covers(t){for(const i of this.fields)if(i.isPrefixOf(t))return!0;return!1}isEqual(t){return ho(this.fields,t.fields,((i,a)=>i.isEqual(a)))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z2="server_timestamp",J2="__type__",tE="__previous_value__",eE="__local_write_time__";function cg(n){return(n?.mapValue?.fields||{})[J2]?.stringValue===Z2}function Xh(n){const t=n.mapValue.fields[tE];return cg(t)?Xh(t):t}function su(n){const t=ia(n.mapValue.fields[eE].timestampValue);return new ue(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn{constructor(t){this.value=t}static empty(){return new vn({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let i=this.value;for(let a=0;a<t.length-1;++a)if(i=(i.mapValue.fields||{})[t.get(a)],!fh(i))return null;return i=(i.mapValue.fields||{})[t.lastSegment()],i||null}}set(t,i){this.getFieldsMap(t.popLast())[t.lastSegment()]=Hl(i)}setAll(t){let i=We.emptyPath(),a={},o=[];t.forEach(((d,m)=>{if(!i.isImmediateParentOf(m)){const p=this.getFieldsMap(i);this.applyChanges(p,a,o),a={},o=[],i=m.popLast()}d?a[m.lastSegment()]=Hl(d):o.push(m.lastSegment())}));const u=this.getFieldsMap(i);this.applyChanges(u,a,o)}delete(t){const i=this.field(t.popLast());fh(i)&&i.mapValue.fields&&delete i.mapValue.fields[t.lastSegment()]}isEqual(t){return Ci(this.value,t.value)}getFieldsMap(t){let i=this.value;i.mapValue.fields||(i.mapValue={fields:{}});for(let a=0;a<t.length;++a){let o=i.mapValue.fields[t.get(a)];fh(o)&&o.mapValue.fields||(o={mapValue:{fields:{}}},i.mapValue.fields[t.get(a)]=o),i=o}return i.mapValue.fields}applyChanges(t,i,a){la(i,((o,u)=>t[o]=u));for(const o of a)delete t[o]}clone(){return new vn(Hl(this.value))}}function rE(n){const t=[];return la(n.fields,((i,a)=>{const o=new We([i]);if(fh(a)){const u=rE(a.mapValue).fields;if(u.length===0)t.push(o);else for(const d of u)t.push(o.child(d))}else t.push(o)})),new Cn(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(t,i,a,o,u,d,m){this.key=t,this.documentType=i,this.version=a,this.readTime=o,this.createTime=u,this.data=d,this.documentState=m}static newInvalidDocument(t){return new sn(t,0,At.min(),At.min(),At.min(),vn.empty(),0)}static newFoundDocument(t,i,a,o){return new sn(t,1,i,At.min(),a,o,0)}static newNoDocument(t,i){return new sn(t,2,i,At.min(),At.min(),vn.empty(),0)}static newUnknownDocument(t,i){return new sn(t,3,i,At.min(),At.min(),vn.empty(),2)}convertToFoundDocument(t,i){return!this.createTime.isEqual(At.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=t),this.version=t,this.documentType=1,this.data=i,this.documentState=0,this}convertToNoDocument(t){return this.version=t,this.documentType=2,this.data=vn.empty(),this.documentState=0,this}convertToUnknownDocument(t){return this.version=t,this.documentType=3,this.data=vn.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=At.min(),this}setReadTime(t){return this.readTime=t,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(t){return t instanceof sn&&this.key.isEqual(t.key)&&this.version.isEqual(t.version)&&this.documentType===t.documentType&&this.documentState===t.documentState&&this.data.isEqual(t.data)}mutableCopy(){return new sn(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mg(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ah(t)?"-0":t}}function yE(n){return{integerValue:""+n}}function xE(n,t){return MI(t)?yE(t):mg(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jh{constructor(){this._=void 0}}function s3(n,t,i){return n instanceof Ch?(function(o,u){const d={fields:{[J2]:{stringValue:Z2},[eE]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return u&&cg(u)&&(u=Xh(u)),u&&(d.fields[tE]=u),{mapValue:d}})(i,t):n instanceof cu?_E(n,t):n instanceof hu?EE(n,t):(function(o,u){const d=vE(o,u),m=Cv(d)+Cv(o.Ae);return mm(d)&&mm(o.Ae)?yE(m):mg(o.serializer,m)})(n,t)}function o3(n,t,i){return n instanceof cu?_E(n,t):n instanceof hu?EE(n,t):i}function vE(n,t){return n instanceof du?(function(a){return mm(a)||(function(u){return!!u&&"doubleValue"in u})(a)})(t)?t:{integerValue:0}:null}class Ch extends Jh{}class cu extends Jh{constructor(t){super(),this.elements=t}}function _E(n,t){const i=wE(t);for(const a of n.elements)i.some((o=>Ci(o,a)))||i.push(a);return{arrayValue:{values:i}}}class hu extends Jh{constructor(t){super(),this.elements=t}}function EE(n,t){let i=wE(t);for(const a of n.elements)i=i.filter((o=>!Ci(o,a)));return{arrayValue:{values:i}}}class du extends Jh{constructor(t,i){super(),this.serializer=t,this.Ae=i}}function Cv(n){return Se(n.integerValue||n.doubleValue)}function wE(n){return hg(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class l3{constructor(t,i){this.field=t,this.transform=i}}function u3(n,t){return n.field.isEqual(t.field)&&(function(a,o){return a instanceof cu&&o instanceof cu||a instanceof hu&&o instanceof hu?ho(a.elements,o.elements,Ci):a instanceof du&&o instanceof du?Ci(a.Ae,o.Ae):a instanceof Ch&&o instanceof Ch})(n.transform,t.transform)}class c3{constructor(t,i){this.version=t,this.transformResults=i}}class Ai{constructor(t,i){this.updateTime=t,this.exists=i}static none(){return new Ai}static exists(t){return new Ai(void 0,t)}static updateTime(t){return new Ai(t)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}}function ph(n,t){return n.updateTime!==void 0?t.isFoundDocument()&&t.version.isEqual(n.updateTime):n.exists===void 0||n.exists===t.isFoundDocument()}class td{}function bE(n,t){if(!n.hasLocalMutations||t&&t.fields.length===0)return null;if(t===null)return n.isNoDocument()?new SE(n.key,Ai.none()):new gu(n.key,n.data,Ai.none());{const i=n.data,a=vn.empty();let o=new Ue(We.comparator);for(let u of t.fields)if(!o.has(u)){let d=i.field(u);d===null&&u.length>1&&(u=u.popLast(),d=i.field(u)),d===null?a.delete(u):a.set(u,d),o=o.add(u)}return new ua(n.key,a,new Cn(o.toArray()),Ai.none())}}function h3(n,t,i){n instanceof gu?(function(o,u,d){const m=o.value.clone(),p=Nv(o.fieldTransforms,u,d.transformResults);m.setAll(p),u.convertToFoundDocument(d.version,m).setHasCommittedMutations()})(n,t,i):n instanceof ua?(function(o,u,d){if(!ph(o.precondition,u))return void u.convertToUnknownDocument(d.version);const m=Nv(o.fieldTransforms,u,d.transformResults),p=u.data;p.setAll(TE(o)),p.setAll(m),u.convertToFoundDocument(d.version,p).setHasCommittedMutations()})(n,t,i):(function(o,u,d){u.convertToNoDocument(d.version).setHasCommittedMutations()})(0,t,i)}function Ql(n,t,i,a){return n instanceof gu?(function(u,d,m,p){if(!ph(u.precondition,d))return m;const g=u.value.clone(),v=Mv(u.fieldTransforms,p,d);return g.setAll(v),d.convertToFoundDocument(d.version,g).setHasLocalMutations(),null})(n,t,i,a):n instanceof ua?(function(u,d,m,p){if(!ph(u.precondition,d))return m;const g=Mv(u.fieldTransforms,p,d),v=d.data;return v.setAll(TE(u)),v.setAll(g),d.convertToFoundDocument(d.version,v).setHasLocalMutations(),m===null?null:m.unionWith(u.fieldMask.fields).unionWith(u.fieldTransforms.map((w=>w.field)))})(n,t,i,a):(function(u,d,m){return ph(u.precondition,d)?(d.convertToNoDocument(d.version).setHasLocalMutations(),null):m})(n,t,i)}function d3(n,t){let i=null;for(const a of n.fieldTransforms){const o=t.data.field(a.field),u=vE(a.transform,o||null);u!=null&&(i===null&&(i=vn.empty()),i.set(a.field,u))}return i||null}function Dv(n,t){return n.type===t.type&&!!n.key.isEqual(t.key)&&!!n.precondition.isEqual(t.precondition)&&!!(function(a,o){return a===void 0&&o===void 0||!(!a||!o)&&ho(a,o,((u,d)=>u3(u,d)))})(n.fieldTransforms,t.fieldTransforms)&&(n.type===0?n.value.isEqual(t.value):n.type!==1||n.data.isEqual(t.data)&&n.fieldMask.isEqual(t.fieldMask))}class gu extends td{constructor(t,i,a,o=[]){super(),this.key=t,this.value=i,this.precondition=a,this.fieldTransforms=o,this.type=0}getFieldMask(){return null}}class ua extends td{constructor(t,i,a,o,u=[]){super(),this.key=t,this.data=i,this.fieldMask=a,this.precondition=o,this.fieldTransforms=u,this.type=1}getFieldMask(){return this.fieldMask}}function TE(n){const t=new Map;return n.fieldMask.fields.forEach((i=>{if(!i.isEmpty()){const a=n.data.field(i);t.set(i,a)}})),t}function Nv(n,t,i){const a=new Map;Yt(n.length===i.length,32656,{Re:i.length,Ve:n.length});for(let o=0;o<i.length;o++){const u=n[o],d=u.transform,m=t.data.field(u.field);a.set(u.field,o3(d,m,i[o]))}return a}function Mv(n,t,i){const a=new Map;for(const o of n){const u=o.transform,d=i.data.field(o.field);a.set(o.field,s3(u,d,t))}return a}class SE extends td{constructor(t,i){super(),this.key=t,this.precondition=i,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class f3 extends td{constructor(t,i){super(),this.key=t,this.precondition=i,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ed{constructor(t,i,a,o,u){this.snapshotVersion=t,this.targetChanges=i,this.targetMismatches=a,this.documentUpdates=o,this.resolvedLimboDocuments=u}static createSynthesizedRemoteEventForCurrentChange(t,i,a){const o=new Map;return o.set(t,yu.createSynthesizedTargetChangeForCurrentChange(t,i,a)),new ed(At.min(),o,new me(Pt),hr(),Ut())}}class yu{constructor(t,i,a,o,u){this.resumeToken=t,this.current=i,this.addedDocuments=a,this.modifiedDocuments=o,this.removedDocuments=u}static createSynthesizedTargetChangeForCurrentChange(t,i,a){return new yu(a,i,Ut(),Ut(),Ut())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U3{constructor(t){this.yt=t}}function L3(n){const t=N3({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?vm(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */xn.DEFAULT_COLLECTION_PERCENTILE=10,xn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,xn.DEFAULT=new xn(kE,xn.DEFAULT_COLLECTION_PERCENTILE,xn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),xn.DISABLED=new xn(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zv="LruGarbageCollector",B3=1048576;function $v([n,t],[i,a]){const o=Pt(n,i);return o===0?Pt(t,a):o}class F3{constructor(t){this.Ir=t,this.buffer=new Ue($v),this.Er=0}dr(){return++this.Er}Ar(t){const i=[t,this.dr()];if(this.buffer.size<this.Ir)this.buffer=this.buffer.add(i);else{const a=this.buffer.last();$v(i,a)<0&&(this.buffer=this.buffer.delete(a).add(i))}}get maxValue(){return this.buffer.last()[0]}}class q3{constructor(t,i,a){this.garbageCollector=t,this.asyncQueue=i,this.localStore=a,this.Rr=null}start(){this.garbageCollector.params.cacheSizeCollectionThreshold!==-1&&this.Vr(6e4)}stop(){this.Rr&&(this.Rr.cancel(),this.Rr=null)}get started(){return this.Rr!==null}Vr(t){pt(zv,`Garbage collection scheduled in ${t}ms`),this.Rr=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",t,(async()=>{this.Rr=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(i){Ao(i)?pt(zv,"Ignoring IndexedDB error during garbage collection: ",i):await So(i)}await this.Vr(3e5)}))}}class K3{constructor(t,i){this.mr=t,this.params=i}calculateTargetCount(t,i){return this.mr.gr(t).next((a=>Math.floor(i/100*a)))}nthSequenceNumber(t,i){if(i===0)return st.resolve(Yh.ce);const a=new F3(i);return this.mr.forEachTarget(t,(o=>a.Ar(o.sequenceNumber))).next((()=>this.mr.pr(t,(o=>a.Ar(o))))).next((()=>a.maxValue))}removeTargets(t,i,a){return this.mr.removeTargets(t,i,a)}removeOrphanedDocuments(t,i){return this.mr.removeOrphanedDocuments(t,i)}collect(t,i){return this.params.cacheSizeCollectionThreshold===-1?(pt("LruGarbageCollector","Garbage collection skipped; disabled"),st.resolve(Lv)):this.getCacheSize(t).next((a=>a<this.params.cacheSizeCollectionThreshold?(pt("LruGarbageCollector",`Garbage collection skipped; Cache size ${a} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),Lv):this.yr(t,i)))}getCacheSize(t){return this.mr.getCacheSize(t)}yr(t,i){let a,o,u,d,m,p,g;const v=Date.now();return this.calculateTargetCount(t,this.params.percentileToCollect).next((w=>(w>this.params.maximumSequenceNumbersToCollect?(pt("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${w}`),o=this.params.maximumSequenceNumbersToCollect):o=w,d=Date.now(),this.nthSequenceNumber(t,o)))).next((w=>(a=w,m=Date.now(),this.removeTargets(t,a,i)))).next((w=>(u=w,p=Date.now(),this.removeOrphanedDocuments(t,a)))).next((w=>(g=Date.now(),Ws()<=Bt.DEBUG&&pt("LruGarbageCollector",`LRU Garbage Collection
	Counted targets in ${d-v}ms
	Determined least recently used ${o} in `+(m-d)+`ms
	Removed ${u} targets in `+(p-m)+`ms
	Removed ${w} documents in `+(g-p)+`ms
Total Duration: ${g-v}ms`),st.resolve({didRun:!0,sequenceNumbersCollected:o,targetsRemoved:u,documentsRemoved:w}))))}}function H3(n,t){return new K3(n,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q3{constructor(t,i,a,o){this.remoteDocumentCache=t,this.mutationQueue=i,this.documentOverlayCache=a,this.indexManager=o}getDocument(t,i){let a=null;return this.documentOverlayCache.getOverlay(t,i).next((o=>(a=o,this.remoteDocumentCache.getEntry(t,i)))).next((o=>(a!==null&&Ql(a.mutation,o,Cn.empty(),ue.now()),o)))}getDocuments(t,i){return this.remoteDocumentCache.getEntries(t,i).next((a=>this.getLocalViewOfDocuments(t,a,Ut()).next((()=>a))))}getLocalViewOfDocuments(t,i,a=Ut()){const o=Qa();return this.populateOverlays(t,o,i).next((()=>this.computeViews(t,i,o,a).next((u=>{let d=zl();return u.forEach(((m,p)=>{d=d.insert(m,p.overlayedDocument)})),d}))))}getOverlayedDocuments(t,i){const a=Qa();return this.populateOverlays(t,a,i).next((()=>this.computeViews(t,i,a,Ut())))}populateOverlays(t,i,a){const o=[];return a.forEach((u=>{i.has(u)||o.push(u)})),this.documentOverlayCache.getOverlays(t,o).next((u=>{u.forEach(((d,m)=>{i.set(d,m)}))}))}computeViews(t,i,a,o){let u=hr();const d=Yl(),m=(function(){return Yl()})();return i.forEach(((p,g)=>{const v=a.get(g.key);o.has(g.key)&&(v===void 0||v.mutation instanceof ua)?u=u.insert(g.key,g):v!==void 0?(d.set(g.key,v.mutation.getFieldMask()),Ql(v.mutation,g,v.mutation.getFieldMask(),ue.now())):d.set(g.key,Cn.empty())})),this.recalculateAndSaveOverlays(t,u).next((p=>(p.forEach(((g,v)=>d.set(g,v))),i.forEach(((g,v)=>m.set(g,new Y3(v,d.get(g)??null)))),m)))}recalculateAndSaveOverlays(t,i){const a=Yl();let o=new me(((d,m)=>d-m)),u=Ut();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,i).next((d=>{for(const m of d)m.keys().forEach((p=>{const g=i.get(p);if(g===null)return;let v=a.get(p)||Cn.empty();v=m.applyToLocalView(g,v),a.set(p,v);const w=(o.get(m.batchId)||Ut()).add(p);o=o.insert(m.batchId,w)}))})).next((()=>{const d=[],m=o.getReverseIterator();for(;m.hasNext();){const p=m.getNext(),g=p.key,v=p.value,w=gE();v.forEach((T=>{if(!u.has(T)){const R=bE(i.get(T),a.get(T));R!==null&&w.set(T,R),u=u.add(T)}})),d.push(this.documentOverlayCache.saveOverlays(t,g,w))}return st.waitFor(d)})).next((()=>a))}recalculateAndSaveOverlaysForDocumentKeys(t,i){return this.remoteDocumentCache.getEntries(t,i).next((a=>this.recalculateAndSaveOverlays(t,a)))}getDocumentsMatchingQuery(t,i,a,o){return(function(d){return vt.isDocumentKey(d.path)&&d.collectionGroup===null&&d.filters.length===0})(i)?this.getDocumentsMatchingDocumentQuery(t,i.path):hE(i)?this.getDocumentsMatchingCollectionGroupQuery(t,i,a,o):this.getDocumentsMatchingCollectionQuery(t,i,a,o)}getNextDocuments(t,i,a,o){return this.remoteDocumentCache.getAllFromCollectionGroup(t,i,a,o).next((u=>{const d=o-u.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,i,a.largestBatchId,o-u.size):st.resolve(Qa());let m=au,p=u;return d.next((g=>st.forEach(g,((v,w)=>(m<w.largestBatchId&&(m=w.largestBatchId),u.get(v)?st.resolve():this.remoteDocumentCache.getEntry(t,v).next((T=>{p=p.insert(v,T)}))))).next((()=>this.populateOverlays(t,g,u))).next((()=>this.computeViews(t,p,g,Ut()))).next((v=>({batchId:m,changes:mE(v)})))))}))}getDocumentsMatchingDocumentQuery(t,i){return this.getDocument(t,new vt(i)).next((a=>{let o=zl();return a.isFoundDocument()&&(o=o.insert(a.key,a)),o}))}getDocumentsMatchingCollectionGroupQuery(t,i,a,o){const u=i.collectionGroup;let d=zl();return this.indexManager.getCollectionParents(t,u).next((m=>st.forEach(m,(p=>{const g=(function(w,T){return new Ro(T,null,w.explicitOrderBy.slice(),w.filters.slice(),w.limit,w.limitType,w.startAt,w.endAt)})(i,p.child(u));return this.getDocumentsMatchingCollectionQuery(t,g,a,o).next((v=>{v.forEach(((w,T)=>{d=d.insert(w,T)}))}))})).next((()=>d))))}getDocumentsMatchingCollectionQuery(t,i,a,o){let u;return this.documentOverlayCache.getOverlaysForCollection(t,i.path,a.largestBatchId).next((d=>(u=d,this.remoteDocumentCache.getDocumentsMatchingQuery(t,i,a,u,o)))).next((d=>{u.forEach(((p,g)=>{const v=g.getKey();d.get(v)===null&&(d=d.insert(v,sn.newInvalidDocument(v)))}));let m=zl();return d.forEach(((p,g)=>{const v=u.get(p);v!==void 0&&Ql(v.mutation,g,Cn.empty(),ue.now()),Zh(i,g)&&(m=m.insert(p,g))})),m}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eg{constructor(t,i,a,o){this.targetId=t,this.fromCache=i,this.Es=a,this.ds=o}static As(t,i){let a=Ut(),o=Ut();for(const u of i.docChanges)switch(u.type){case 0:a=a.add(u.doc.key);break;case 1:o=o.add(u.doc.key)}return new Eg(t,i.fromCache,a,o)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wg="LocalStore",sj=3e8;class oj{constructor(t,i,a,o){this.persistence=t,this.Fs=i,this.serializer=o,this.Ms=new me(Pt),this.xs=new is((u=>dg(u)),fg),this.Os=new Map,this.Ns=t.getRemoteDocumentCache(),this.Pi=t.getTargetCache(),this.Ii=t.getBundleCache(),this.Bs(a)}Bs(t){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(t),this.indexManager=this.persistence.getIndexManager(t),this.mutationQueue=this.persistence.getMutationQueue(t,this.indexManager),this.localDocuments=new Q3(this.Ns,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Ns.setIndexManager(this.indexManager),this.Fs.initialize(this.localDocuments,this.indexManager)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(i=>t.collect(i,this.Ms)))}}function lj(n,t,i,a){return new oj(n,t,i,a)}async function UE(n,t){const i=It(n);return await i.persistence.runTransaction("Handle user change","readonly",(a=>{let o;return i.mutationQueue.getAllMutationBatches(a).next((u=>(o=u,i.Bs(t),i.mutationQueue.getAllMutationBatches(a)))).next((u=>{const d=[],m=[];let p=Ut();for(const g of o){d.push(g.batchId);for(const v of g.mutations)p=p.add(v.key)}for(const g of u){m.push(g.batchId);for(const v of g.mutations)p=p.add(v.key)}return i.localDocuments.getDocuments(a,p).next((g=>({Ls:g,removedBatchIds:d,addedBatchIds:m})))}))}))}function uj(n,t){const i=It(n);return i.persistence.runTransaction("Acknowledge batch","readwrite-primary",(a=>{const o=t.batch.keys(),u=i.Ns.newChangeBuffer({trackRemovals:!0});return(function(m,p,g,v){const w=g.batch,T=w.keys();let R=st.resolve();return T.forEach((M=>{R=R.next((()=>v.getEntry(p,M))).next((L=>{const U=g.docVersions.get(M);Yt(U!==null,48541),L.version.compareTo(U)<0&&(w.applyToRemoteDocument(L,g),L.isValidDocument()&&(L.setReadTime(g.commitVersion),v.addEntry(L)))}))})),R.next((()=>m.mutationQueue.removeMutationBatch(p,w)))})(i,a,t,u).next((()=>u.apply(a))).next((()=>i.mutationQueue.performConsistencyCheck(a))).next((()=>i.documentOverlayCache.removeOverlaysForBatchId(a,o,t.batch.batchId))).next((()=>i.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(a,(function(m){let p=Ut();for(let g=0;g<m.mutationResults.length;++g)m.mutationResults[g].transformResults.length>0&&(p=p.add(m.batch.mutations[g].key));return p})(t)))).next((()=>i.localDocuments.getDocuments(a,o)))}))}function LE(n){const t=It(n);return t.persistence.runTransaction("Get last remote snapshot version","readonly",(i=>t.Pi.getLastRemoteSnapshotVersion(i)))}function cj(n,t){const i=It(n),a=t.snapshotVersion;let o=i.Ms;return i.persistence.runTransaction("Apply remote event","readwrite-primary",(u=>{const d=i.Ns.newChangeBuffer({trackRemovals:!0});o=i.Ms;const m=[];t.targetChanges.forEach(((v,w)=>{const T=o.get(w);if(!T)return;m.push(i.Pi.removeMatchingKeys(u,v.removedDocuments,w).next((()=>i.Pi.addMatchingKeys(u,v.addedDocuments,w))));let R=T.withSequenceNumber(u.currentSequenceNumber);t.targetMismatches.get(w)!==null?R=R.withResumeToken(Ze.EMPTY_BYTE_STRING,At.min()).withLastLimboFreeSnapshotVersion(At.min()):v.resumeToken.approximateByteSize()>0&&(R=R.withResumeToken(v.resumeToken,a)),o=o.insert(w,R),(function(L,U,K){return L.resumeToken.approximateByteSize()===0||U.snapshotVersion.toMicroseconds()-L.snapshotVersion.toMicroseconds()>=sj?!0:K.addedDocuments.size+K.modifiedDocuments.size+K.removedDocuments.size>0})(T,R,v)&&m.push(i.Pi.updateTargetData(u,R))}));let p=hr(),g=Ut();if(t.documentUpdates.forEach((v=>{t.resolvedLimboDocuments.has(v)&&m.push(i.persistence.referenceDelegate.updateLimboDocument(u,v))})),m.push(hj(u,d,t.documentUpdates).next((v=>{p=v.ks,g=v.qs}))),!a.isEqual(At.min())){const v=i.Pi.getLastRemoteSnapshotVersion(u).next((w=>i.Pi.setTargetsMetadata(u,u.currentSequenceNumber,a)));m.push(v)}return st.waitFor(m).next((()=>d.apply(u))).next((()=>i.localDocuments.getLocalViewOfDocuments(u,p,g))).next((()=>p))})).then((u=>(i.Ms=o,u)))}function hj(n,t,i){let a=Ut(),o=Ut();return i.forEach((u=>a=a.add(u))),t.getEntries(n,a).next((u=>{let d=hr();return i.forEach(((m,p)=>{const g=u.get(m);p.isFoundDocument()!==g.isFoundDocument()&&(o=o.add(m)),p.isNoDocument()&&p.version.isEqual(At.min())?(t.removeEntry(m,p.readTime),d=d.insert(m,p)):!g.isValidDocument()||p.version.compareTo(g.version)>0||p.version.compareTo(g.version)===0&&g.hasPendingWrites?(t.addEntry(p),d=d.insert(m,p)):pt(wg,"Ignoring outdated watch update for ",m,". Current version:",g.version," Watch version:",p.version)})),{ks:d,qs:o}}))}function dj(n,t){const i=It(n);return i.persistence.runTransaction("Get next mutation batch","readonly",(a=>(t===void 0&&(t=ug),i.mutationQueue.getNextMutationBatchAfterBatchId(a,t))))}function fj(n,t){const i=It(n);return i.persistence.runTransaction("Allocate target","readwrite",(a=>{let o;return i.Pi.getTargetData(a,t).next((u=>u?(o=u,st.resolve(o)):i.Pi.allocateTargetId(a).next((d=>(o=new Wr(t,d,"TargetPurposeListen",a.currentSequenceNumber),i.Pi.addTargetData(a,o).next((()=>o)))))))})).then((a=>{const o=i.Ms.get(a.targetId);return(o===null||a.snapshotVersion.compareTo(o.snapshotVersion)>0)&&(i.Ms=i.Ms.insert(a.targetId,a),i.xs.set(t,a.targetId)),a}))}async function Tm(n,t,i){const a=It(n),o=a.Ms.get(t),u=i?"readwrite":"readwrite-primary";try{i||await a.persistence.runTransaction("Release target",u,(d=>a.persistence.referenceDelegate.removeTarget(d,o)))}catch(d){if(!Ao(d))throw d;pt(wg,`Failed to update sequence numbers for target ${t}: ${d}`)}a.Ms=a.Ms.remove(t),a.xs.delete(o.target)}function Bv(n,t,i){const a=It(n);let o=At.min(),u=Ut();return a.persistence.runTransaction("Execute query","readwrite",(d=>(function(p,g,v){const w=It(p),T=w.xs.get(v);return T!==void 0?st.resolve(w.Ms.get(T)):w.Pi.getTargetData(g,v)})(a,d,Si(t)).next((m=>{if(m)return o=m.lastLimboFreeSnapshotVersion,a.Pi.getMatchingKeysForTargetId(d,m.targetId).next((p=>{u=p}))})).next((()=>a.Fs.getDocumentsMatchingQuery(d,t,i?o:At.min(),i?u:Ut()))).next((m=>(pj(a,JI(t),m),{documents:m,Qs:u})))))}function pj(n,t,i){let a=n.Os.get(t)||At.min();i.forEach(((o,u)=>{u.readTime.compareTo(a)>0&&(a=u.readTime)})),n.Os.set(t,a)}class Fv{constructor(){this.activeTargetIds=a3()}zs(t){this.activeTargetIds=this.activeTargetIds.add(t)}js(t){this.activeTargetIds=this.activeTargetIds.delete(t)}Gs(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class mj{constructor(){this.Mo=new Fv,this.xo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,i,a){}addLocalQueryTarget(t,i=!0){return i&&this.Mo.zs(t),this.xo[t]||"not-current"}updateQueryState(t,i,a){this.xo[t]=i}removeLocalQueryTarget(t){this.Mo.js(t)}isLocalQueryTarget(t){return this.Mo.activeTargetIds.has(t)}clearQueryState(t){delete this.xo[t]}getAllActiveQueryTargets(){return this.Mo.activeTargetIds}isActiveQueryTarget(t){return this.Mo.activeTargetIds.has(t)}start(){return this.Mo=new Fv,Promise.resolve()}handleUserChange(t,i,a){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(t){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rn="WebChannelConnection";class _j extends xj{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,i,a,o,u){const d=Sm();return new Promise(((m,p)=>{const g=new z2;g.setWithCredentials(!0),g.listenOnce($2.COMPLETE,(()=>{try{switch(g.getLastErrorCode()){case hh.NO_ERROR:const w=g.getResponseJson();pt(rn,`XHR for RPC '${t}' ${d} received:`,JSON.stringify(w)),m(w);break;case hh.TIMEOUT:pt(rn,`RPC '${t}' ${d} timed out`),p(new ft(it.DEADLINE_EXCEEDED,"Request time out"));break;case hh.HTTP_ERROR:const T=g.getStatus();if(pt(rn,`RPC '${t}' ${d} failed with status:`,T,"response text:",g.getResponseText()),T>0){let R=g.getResponseJson();Array.isArray(R)&&(R=R[0]);const M=R?.error;if(M&&M.status&&M.message){const L=(function(K){const X=K.toLowerCase().replace(/_/g,"-");return Object.values(it).indexOf(X)>=0?X:it.UNKNOWN})(M.status);p(new ft(L,M.message))}else p(new ft(it.UNKNOWN,"Server responded with status "+g.getStatus()))}else p(new ft(it.UNAVAILABLE,"Connection failed."));break;default:bt(9055,{l_:t,streamId:d,h_:g.getLastErrorCode(),P_:g.getLastError()})}}finally{pt(rn,`RPC '${t}' ${d} completed.`)}}));const v=JSON.stringify(o);pt(rn,`RPC '${t}' ${d} sending request:`,o),g.send(i,"POST",v,a,15)}))}T_(t,i,a){const o=Sm(),u=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],d=q2(),m=F2(),p={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},g=this.longPollingOptions.timeoutSeconds;g!==void 0&&(p.longPollingTimeout=Math.round(1e3*g)),this.useFetchStreams&&(p.useFetchStreams=!0),this.jo(p.initMessageHeaders,i,a),p.encodeInitMessageHeaders=!0;const v=u.join("");pt(rn,`Creating RPC '${t}' stream ${o}: ${v}`,p);const w=d.createWebChannel(v,p);this.I_(w);let T=!1,R=!1;const M=new vj({Yo:U=>{R?pt(rn,`Not sending because RPC '${t}' stream ${o} is closed:`,U):(T||(pt(rn,`Opening RPC '${t}' stream ${o} transport.`),w.open(),T=!0),pt(rn,`RPC '${t}' stream ${o} sending:`,U),w.send(U))},Zo:()=>w.close()}),L=(U,K,X)=>{U.listen(K,(tt=>{try{X(tt)}catch(lt){setTimeout((()=>{throw lt}),0)}}))};return L(w,Ll.EventType.OPEN,(()=>{R||(pt(rn,`RPC '${t}' stream ${o} transport opened.`),M.o_())})),L(w,Ll.EventType.CLOSE,(()=>{R||(R=!0,pt(rn,`RPC '${t}' stream ${o} transport closed`),M.a_(),this.E_(w))})),L(w,Ll.EventType.ERROR,(U=>{R||(R=!0,co(rn,`RPC '${t}' stream ${o} transport errored. Name:`,U.name,"Message:",U.message),M.a_(new ft(it.UNAVAILABLE,"The operation could not be completed")))})),L(w,Ll.EventType.MESSAGE,(U=>{if(!R){const K=U.data[0];Yt(!!K,16349);const X=K,tt=X?.error||X[0]?.error;if(tt){pt(rn,`RPC '${t}' stream ${o} received error:`,tt);const lt=tt.status;let Y=(function(I){const C=je[I];if(C!==void 0)return AE(C)})(lt),ot=tt.message;Y===void 0&&(Y=it.INTERNAL,ot="Unknown error status: "+lt+" with message "+tt.message),R=!0,M.a_(new ft(Y,ot)),w.close()}else pt(rn,`RPC '${t}' stream ${o} received:`,K),M.u_(K)}})),L(m,B2.STAT_EVENT,(U=>{U.stat===dm.PROXY?pt(rn,`RPC '${t}' stream ${o} detected buffering proxy`):U.stat===dm.NOPROXY&&pt(rn,`RPC '${t}' stream ${o} detected no buffering proxy`)})),setTimeout((()=>{M.__()}),0),M}terminate(){this.c_.forEach((t=>t.close())),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter((i=>i===t))}}function Op(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nd(n){return new T3(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hv="PersistentStream";class $E{constructor(t,i,a,o,u,d,m,p){this.Mi=t,this.S_=a,this.b_=o,this.connection=u,this.authCredentialsProvider=d,this.appCheckCredentialsProvider=m,this.listener=p,this.state=0,this.D_=0,this.C_=null,this.v_=null,this.stream=null,this.F_=0,this.M_=new zE(t,i)}x_(){return this.state===1||this.state===5||this.O_()}O_(){return this.state===2||this.state===3}start(){this.F_=0,this.state!==4?this.auth():this.N_()}async stop(){this.x_()&&await this.close(0)}B_(){this.state=0,this.M_.reset()}L_(){this.O_()&&this.C_===null&&(this.C_=this.Mi.enqueueAfterDelay(this.S_,6e4,(()=>this.k_())))}q_(t){this.Q_(),this.stream.send(t)}async k_(){if(this.O_())return this.close(0)}Q_(){this.C_&&(this.C_.cancel(),this.C_=null)}U_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(t,i){this.Q_(),this.U_(),this.M_.cancel(),this.D_++,t!==4?this.M_.reset():i&&i.code===it.RESOURCE_EXHAUSTED?(ur(i.toString()),ur("Using maximum backoff delay to prevent overloading the backend."),this.M_.g_()):i&&i.code===it.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.K_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.r_(i)}K_(){}auth(){this.state=1;const t=this.W_(this.D_),i=this.D_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([a,o])=>{this.D_===i&&this.G_(a,o)}),(a=>{t((()=>{const o=new ft(it.UNKNOWN,"Fetching auth token failed: "+a.message);return this.z_(o)}))}))}G_(t,i){const a=this.W_(this.D_);this.stream=this.j_(t,i),this.stream.Xo((()=>{a((()=>this.listener.Xo()))})),this.stream.t_((()=>{a((()=>(this.state=2,this.v_=this.Mi.enqueueAfterDelay(this.b_,1e4,(()=>(this.O_()&&(this.state=3),Promise.resolve()))),this.listener.t_())))})),this.stream.r_((o=>{a((()=>this.z_(o)))})),this.stream.onMessage((o=>{a((()=>++this.F_==1?this.J_(o):this.onNext(o)))}))}N_(){this.state=5,this.M_.p_((async()=>{this.state=0,this.start()}))}z_(t){return pt(Hv,`close with error: ${t}`),this.stream=null,this.close(4,t)}W_(t){return i=>{this.Mi.enqueueAndForget((()=>this.D_===t?i():(pt(Hv,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class Ej extends $E{constructor(t,i,a,o,u,d){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",i,a,o,d),this.serializer=u}j_(t,i){return this.connection.T_("Listen",t,i)}J_(t){return this.onNext(t)}onNext(t){this.M_.reset();const i=R3(this.serializer,t),a=(function(u){if(!("targetChange"in u))return At.min();const d=u.targetChange;return d.targetIds&&d.targetIds.length?At.min():d.readTime?Ri(d.readTime):At.min()})(t);return this.listener.H_(i,a)}Y_(t){const i={};i.database=bm(this.serializer),i.addTarget=(function(u,d){let m;const p=d.target;if(m=ym(p)?{documents:C3(u,p)}:{query:D3(u,p).ft},m.targetId=d.targetId,d.resumeToken.approximateByteSize()>0){m.resumeToken=jE(u,d.resumeToken);const g=_m(u,d.expectedCount);g!==null&&(m.expectedCount=g)}else if(d.snapshotVersion.compareTo(At.min())>0){m.readTime=Dh(u,d.snapshotVersion.toTimestamp());const g=_m(u,d.expectedCount);g!==null&&(m.expectedCount=g)}return m})(this.serializer,t);const a=M3(this.serializer,t);a&&(i.labels=a),this.q_(i)}Z_(t){const i={};i.database=bm(this.serializer),i.removeTarget=t,this.q_(i)}}class wj extends $E{constructor(t,i,a,o,u,d){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",i,a,o,d),this.serializer=u}get X_(){return this.F_>0}start(){this.lastStreamToken=void 0,super.start()}K_(){this.X_&&this.ea([])}j_(t,i){return this.connection.T_("Write",t,i)}J_(t){return Yt(!!t.streamToken,31322),this.lastStreamToken=t.streamToken,Yt(!t.writeResults||t.writeResults.length===0,55816),this.listener.ta()}onNext(t){Yt(!!t.streamToken,12678),this.lastStreamToken=t.streamToken,this.M_.reset();const i=j3(t.writeResults,t.commitTime),a=Ri(t.commitTime);return this.listener.na(a,i)}ra(){const t={};t.database=bm(this.serializer),this.q_(t)}ea(t){const i={streamToken:this.lastStreamToken,writes:t.map((a=>I3(this.serializer,a)))};this.q_(i)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ts="RemoteStore";class Aj{constructor(t,i,a,o,u){this.localStore=t,this.datastore=i,this.asyncQueue=a,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=u,this.Aa.Oo((d=>{a.enqueueAndForget((async()=>{rs(this)&&(pt(ts,"Restarting streams for network reachability change."),await(async function(p){const g=It(p);g.Ea.add(4),await xu(g),g.Ra.set("Unknown"),g.Ea.delete(4),await id(g)})(this))}))})),this.Ra=new Sj(a,o)}}async function id(n){if(rs(n))for(const t of n.da)await t(!0)}async function xu(n){for(const t of n.da)await t(!1)}function BE(n,t){const i=It(n);i.Ia.has(t.targetId)||(i.Ia.set(t.targetId,t),Ag(i)?Sg(i):Io(i).O_()&&Tg(i,t))}function bg(n,t){const i=It(n),a=Io(i);i.Ia.delete(t),a.O_()&&FE(i,t),i.Ia.size===0&&(a.O_()?a.L_():rs(i)&&i.Ra.set("Unknown"))}function Tg(n,t){if(n.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(At.min())>0){const i=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(i)}Io(n).Y_(t)}function FE(n,t){n.Va.Ue(t),Io(n).Z_(t)}function Sg(n){n.Va=new _3({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),At:t=>n.Ia.get(t)||null,ht:()=>n.datastore.serializer.databaseId}),Io(n).start(),n.Ra.ua()}function Ag(n){return rs(n)&&!Io(n).x_()&&n.Ia.size>0}function rs(n){return It(n).Ea.size===0}function qE(n){n.Va=void 0}async function Rj(n){n.Ra.set("Online")}async function Ij(n){n.Ia.forEach(((t,i)=>{Tg(n,t)}))}async function jj(n,t){qE(n),Ag(n)?(n.Ra.ha(t),Sg(n)):n.Ra.set("Unknown")}async function Cj(n,t,i){if(n.Ra.set("Online"),t instanceof IE&&t.state===2&&t.cause)try{await(async function(o,u){const d=u.cause;for(const m of u.targetIds)o.Ia.has(m)&&(await o.remoteSyncer.rejectListen(m,d),o.Ia.delete(m),o.Va.removeTarget(m))})(n,t)}catch(a){pt(ts,"Failed to remove targets %s: %s ",t.targetIds.join(","),a),await Mh(n,a)}else if(t instanceof mh?n.Va.Ze(t):t instanceof RE?n.Va.st(t):n.Va.tt(t),!i.isEqual(At.min()))try{const a=await LE(n.localStore);i.compareTo(a)>=0&&await(function(u,d){const m=u.Va.Tt(d);return m.targetChanges.forEach(((p,g)=>{if(p.resumeToken.approximateByteSize()>0){const v=u.Ia.get(g);v&&u.Ia.set(g,v.withResumeToken(p.resumeToken,d))}})),m.targetMismatches.forEach(((p,g)=>{const v=u.Ia.get(p);if(!v)return;u.Ia.set(p,v.withResumeToken(Ze.EMPTY_BYTE_STRING,v.snapshotVersion)),FE(u,p);const w=new Wr(v.target,p,g,v.sequenceNumber);Tg(u,w)})),u.remoteSyncer.applyRemoteEvent(m)})(n,i)}catch(a){pt(ts,"Failed to raise snapshot:",a),await Mh(n,a)}}async function Mh(n,t,i){if(!Ao(t))throw t;n.Ea.add(1),await xu(n),n.Ra.set("Offline"),i||(i=()=>LE(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{pt(ts,"Retrying IndexedDB access"),await i(),n.Ea.delete(1),await id(n)}))}function KE(n,t){return t().catch((i=>Mh(n,i,t)))}async function rd(n){const t=It(n),i=sa(t);let a=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:ug;for(;Dj(t);)try{const o=await dj(t.localStore,a);if(o===null){t.Ta.length===0&&i.L_();break}a=o.batchId,Nj(t,o)}catch(o){await Mh(t,o)}HE(t)&&GE(t)}function Dj(n){return rs(n)&&n.Ta.length<10}function Nj(n,t){n.Ta.push(t);const i=sa(n);i.O_()&&i.X_&&i.ea(t.mutations)}function HE(n){return rs(n)&&!sa(n).x_()&&n.Ta.length>0}function GE(n){sa(n).start()}async function Mj(n){sa(n).ra()}async function Oj(n){const t=sa(n);for(const i of n.Ta)t.ea(i.mutations)}async function Vj(n,t,i){const a=n.Ta.shift(),o=gg.from(a,t,i);await KE(n,(()=>n.remoteSyncer.applySuccessfulWrite(o))),await rd(n)}async function kj(n,t){t&&sa(n).X_&&await(async function(a,o){if((function(d){return y3(d)&&d!==it.ABORTED})(o.code)){const u=a.Ta.shift();sa(a).B_(),await KE(a,(()=>a.remoteSyncer.rejectFailedWrite(u.batchId,o))),await rd(a)}})(n,t),HE(n)&&GE(n)}async function Gv(n,t){const i=It(n);i.asyncQueue.verifyOperationInProgress(),pt(ts,"RemoteStore received new credentials");const a=rs(i);i.Ea.add(3),await xu(i),a&&i.Ra.set("Unknown"),await i.remoteSyncer.handleCredentialChange(t),i.Ea.delete(3),await id(i)}async function Pj(n,t){const i=It(n);t?(i.Ea.delete(2),await id(i)):t||(i.Ea.add(2),await xu(i),i.Ra.set("Unknown"))}function Io(n){return n.ma||(n.ma=(function(i,a,o){const u=It(i);return u.sa(),new Ej(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:Rj.bind(null,n),t_:Ij.bind(null,n),r_:jj.bind(null,n),H_:Cj.bind(null,n)}),n.da.push((async t=>{t?(n.ma.B_(),Ag(n)?Sg(n):n.Ra.set("Unknown")):(await n.ma.stop(),qE(n))}))),n.ma}function sa(n){return n.fa||(n.fa=(function(i,a,o){const u=It(i);return u.sa(),new wj(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:Mj.bind(null,n),r_:kj.bind(null,n),ta:Oj.bind(null,n),na:Vj.bind(null,n)}),n.da.push((async t=>{t?(n.fa.B_(),await rd(n)):(await n.fa.stop(),n.Ta.length>0&&(pt(ts,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rg{constructor(t,i,a,o,u){this.asyncQueue=t,this.timerId=i,this.targetTimeMs=a,this.op=o,this.removalCallback=u,this.deferred=new rr,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch((d=>{}))}get promise(){return this.deferred.promise}static createAndSchedule(t,i,a,o,u){const d=Date.now()+a,m=new Rg(t,i,d,o,u);return m.start(a),m}start(t){this.timerHandle=setTimeout((()=>this.handleDelayElapsed()),t)}skipDelay(){return this.handleDelayElapsed()}cancel(t){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new ft(it.CANCELLED,"Operation cancelled"+(t?": "+t:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget((()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then((t=>this.deferred.resolve(t)))):Promise.resolve()))}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Ig(n,t){if(ur("AsyncQueue",`${t}: ${n}`),Ao(n))return new ft(it.UNAVAILABLE,`${t}: ${n}`);throw n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uj{constructor(){this.wa=void 0,this.Sa=[]}ba(){return this.Sa.some((t=>t.Da()))}}class Lj{constructor(){this.queries=Qv(),this.onlineState="Unknown",this.Ca=new Set}terminate(){(function(i,a){const o=It(i),u=o.queries;o.queries=Qv(),u.forEach(((d,m)=>{for(const p of m.Sa)p.onError(a)}))})(this,new ft(it.ABORTED,"Firestore shutting down"))}}function Qv(){return new is((n=>dE(n)),Wh)}async function YE(n,t){const i=It(n);let a=3;const o=t.query;let u=i.queries.get(o);u?!u.ba()&&t.Da()&&(a=2):(u=new Uj,a=t.Da()?0:1);try{switch(a){case 0:u.wa=await i.onListen(o,!0);break;case 1:u.wa=await i.onListen(o,!1);break;case 2:await i.onFirstRemoteStoreListen(o)}}catch(d){const m=Ig(d,`Initialization of query '${Zs(t.query)}' failed`);return void t.onError(m)}i.queries.set(o,u),u.Sa.push(t),t.va(i.onlineState),u.wa&&t.Fa(u.wa)&&jg(i)}async function QE(n,t){const i=It(n),a=t.query;let o=3;const u=i.queries.get(a);if(u){const d=u.Sa.indexOf(t);d>=0&&(u.Sa.splice(d,1),u.Sa.length===0?o=t.Da()?0:1:!u.ba()&&t.Da()&&(o=2))}switch(o){case 0:return i.queries.delete(a),i.onUnlisten(a,!0);case 1:return i.queries.delete(a),i.onUnlisten(a,!1);case 2:return i.onLastRemoteStoreUnlisten(a);default:return}}function zj(n,t){const i=It(n);let a=!1;for(const o of t){const u=o.query,d=i.queries.get(u);if(d){for(const m of d.Sa)m.Fa(o)&&(a=!0);d.wa=o}}a&&jg(i)}function $j(n,t,i){const a=It(n),o=a.queries.get(t);if(o)for(const u of o.Sa)u.onError(i);a.queries.delete(t)}function jg(n){n.Ca.forEach((t=>{t.next()}))}var Am,Xv;(Xv=Am||(Am={})).Ma="default",Xv.Cache="cache";class XE{constructor(t,i,a){this.query=t,this.xa=i,this.Oa=!1,this.Na=null,this.onlineState="Unknown",this.options=a||{}}Fa(t){if(!this.options.includeMetadataChanges){const a=[];for(const o of t.docChanges)o.type!==3&&a.push(o);t=new go(t.query,t.docs,t.oldDocs,a,t.mutatedKeys,t.fromCache,t.syncStateChanged,!0,t.hasCachedResults)}let i=!1;return this.Oa?this.Ba(t)&&(this.xa.next(t),i=!0):this.La(t,this.onlineState)&&(this.ka(t),i=!0),this.Na=t,i}onError(t){this.xa.error(t)}va(t){this.onlineState=t;let i=!1;return this.Na&&!this.Oa&&this.La(this.Na,t)&&(this.ka(this.Na),i=!0),i}La(t,i){if(!t.fromCache||!this.Da())return!0;const a=i!=="Offline";return(!this.options.qa||!a)&&(!t.docs.isEmpty()||t.hasCachedResults||i==="Offline")}Ba(t){if(t.docChanges.length>0)return!0;const i=this.Na&&this.Na.hasPendingWrites!==t.hasPendingWrites;return!(!t.syncStateChanged&&!i)&&this.options.includeMetadataChanges===!0}ka(t){t=go.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache,t.hasCachedResults),this.Oa=!0,this.xa.next(t)}Da(){return this.options.source!==Am.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WE{constructor(t){this.key=t}}class ZE{constructor(t){this.key=t}}class Bj{constructor(t,i){this.query=t,this.Ya=i,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=Ut(),this.mutatedKeys=Ut(),this.eu=fE(t),this.tu=new io(this.eu)}get nu(){return this.Ya}ru(t,i){const a=i?i.iu:new Yv,o=i?i.tu:this.tu;let u=i?i.mutatedKeys:this.mutatedKeys,d=o,m=!1;const p=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,g=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(t.inorderTraversal(((v,w)=>{const T=o.get(v),R=Zh(this.query,w)?w:null,M=!!T&&this.mutatedKeys.has(T.key),L=!!R&&(R.hasLocalMutations||this.mutatedKeys.has(R.key)&&R.hasCommittedMutations);let U=!1;T&&R?T.data.isEqual(R.data)?M!==L&&(a.track({type:3,doc:R}),U=!0):this.su(T,R)||(a.track({type:2,doc:R}),U=!0,(p&&this.eu(R,p)>0||g&&this.eu(R,g)<0)&&(m=!0)):!T&&R?(a.track({type:0,doc:R}),U=!0):T&&!R&&(a.track({type:1,doc:T}),U=!0,(p||g)&&(m=!0)),U&&(R?(d=d.add(R),u=L?u.add(v):u.delete(v)):(d=d.delete(v),u=u.delete(v)))})),this.query.limit!==null)for(;d.size>this.query.limit;){const v=this.query.limitType==="F"?d.last():d.first();d=d.delete(v.key),u=u.delete(v.key),a.track({type:1,doc:v})}return{tu:d,iu:a,Cs:m,mutatedKeys:u}}su(t,i){return t.hasLocalMutations&&i.hasCommittedMutations&&!i.hasLocalMutations}applyChanges(t,i,a,o){const u=this.tu;this.tu=t.tu,this.mutatedKeys=t.mutatedKeys;const d=t.iu.ya();d.sort(((v,w)=>(function(R,M){const L=U=>{switch(U){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return bt(20277,{Rt:U})}};return L(R)-L(M)})(v.type,w.type)||this.eu(v.doc,w.doc))),this.ou(a),o=o??!1;const m=i&&!o?this._u():[],p=this.Xa.size===0&&this.current&&!o?1:0,g=p!==this.Za;return this.Za=p,d.length!==0||g?{snapshot:new go(this.query,t.tu,u,d,t.mutatedKeys,p===0,g,!1,!!a&&a.resumeToken.approximateByteSize()>0),au:m}:{au:m}}va(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new Yv,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(t){return!this.Ya.has(t)&&!!this.tu.has(t)&&!this.tu.get(t).hasLocalMutations}ou(t){t&&(t.addedDocuments.forEach((i=>this.Ya=this.Ya.add(i))),t.modifiedDocuments.forEach((i=>{})),t.removedDocuments.forEach((i=>this.Ya=this.Ya.delete(i))),this.current=t.current)}_u(){if(!this.current)return[];const t=this.Xa;this.Xa=Ut(),this.tu.forEach((a=>{this.uu(a.key)&&(this.Xa=this.Xa.add(a.key))}));const i=[];return t.forEach((a=>{this.Xa.has(a)||i.push(new ZE(a))})),this.Xa.forEach((a=>{t.has(a)||i.push(new WE(a))})),i}cu(t){this.Ya=t.Qs,this.Xa=Ut();const i=this.ru(t.documents);return this.applyChanges(i,!0)}lu(){return go.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const Cg="SyncEngine";class Fj{constructor(t,i,a){this.query=t,this.targetId=i,this.view=a}}class qj{constructor(t){this.key=t,this.hu=!1}}class Kj{constructor(t,i,a,o,u,d){this.localStore=t,this.remoteStore=i,this.eventManager=a,this.sharedClientState=o,this.currentUser=u,this.maxConcurrentLimboResolutions=d,this.Pu={},this.Tu=new is((m=>dE(m)),Wh),this.Iu=new Map,this.Eu=new Set,this.du=new me(vt.comparator),this.Au=new Map,this.Ru=new vg,this.Vu={},this.mu=new Map,this.fu=mo.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function Hj(n,t,i=!0){const a=rw(n);let o;const u=a.Tu.get(t);return u?(a.sharedClientState.addLocalQueryTarget(u.targetId),o=u.view.lu()):o=await JE(a,t,i,!0),o}async function Gj(n,t){const i=rw(n);await JE(i,t,!0,!1)}async function JE(n,t,i,a){const o=await fj(n.localStore,Si(t)),u=o.targetId,d=n.sharedClientState.addLocalQueryTarget(u,i);let m;return a&&(m=await Yj(n,t,u,d==="current",o.resumeToken)),n.isPrimaryClient&&i&&BE(n.remoteStore,o),m}async function Yj(n,t,i,a,o){n.pu=(w,T,R)=>(async function(L,U,K,X){let tt=U.view.ru(K);tt.Cs&&(tt=await Bv(L.localStore,U.query,!1).then((({documents:j})=>U.view.ru(j,tt))));const lt=X&&X.targetChanges.get(U.targetId),Y=X&&X.targetMismatches.get(U.targetId)!=null,ot=U.view.applyChanges(tt,L.isPrimaryClient,lt,Y);return Zv(L,U.targetId,ot.au),ot.snapshot})(n,w,T,R);const u=await Bv(n.localStore,t,!0),d=new Bj(t,u.Qs),m=d.ru(u.documents),p=yu.createSynthesizedTargetChangeForCurrentChange(i,a&&n.onlineState!=="Offline",o),g=d.applyChanges(m,n.isPrimaryClient,p);Zv(n,i,g.au);const v=new Fj(t,i,d);return n.Tu.set(t,v),n.Iu.has(i)?n.Iu.get(i).push(t):n.Iu.set(i,[t]),g.snapshot}async function Qj(n,t,i){const a=It(n),o=a.Tu.get(t),u=a.Iu.get(o.targetId);if(u.length>1)return a.Iu.set(o.targetId,u.filter((d=>!Wh(d,t)))),void a.Tu.delete(t);a.isPrimaryClient?(a.sharedClientState.removeLocalQueryTarget(o.targetId),a.sharedClientState.isActiveQueryTarget(o.targetId)||await Tm(a.localStore,o.targetId,!1).then((()=>{a.sharedClientState.clearQueryState(o.targetId),i&&bg(a.remoteStore,o.targetId),Rm(a,o.targetId)})).catch(So)):(Rm(a,o.targetId),await Tm(a.localStore,o.targetId,!0))}async function Xj(n,t){const i=It(n),a=i.Tu.get(t),o=i.Iu.get(a.targetId);i.isPrimaryClient&&o.length===1&&(i.sharedClientState.removeLocalQueryTarget(a.targetId),bg(i.remoteStore,a.targetId))}async function Wj(n,t,i){const a=rC(n);try{const o=await(function(d,m){const p=It(d),g=ue.now(),v=m.reduce(((R,M)=>R.add(M.key)),Ut());let w,T;return p.persistence.runTransaction("Locally write mutations","readwrite",(R=>{let M=hr(),L=Ut();return p.Ns.getEntries(R,v).next((U=>{M=U,M.forEach(((K,X)=>{X.isValidDocument()||(L=L.add(K))}))})).next((()=>p.localDocuments.getOverlayedDocuments(R,M))).next((U=>{w=U;const K=[];for(const X of m){const tt=d3(X,w.get(X.key).overlayedDocument);tt!=null&&K.push(new ua(X.key,tt,rE(tt.value.mapValue),Ai.exists(!0)))}return p.mutationQueue.addMutationBatch(R,g,K,m)})).next((U=>{T=U;const K=U.applyToLocalDocumentSet(w,L);return p.documentOverlayCache.saveOverlays(R,U.batchId,K)}))})).then((()=>({batchId:T.batchId,changes:mE(w)})))})(a.localStore,t);a.sharedClientState.addPendingMutation(o.batchId),(function(d,m,p){let g=d.Vu[d.currentUser.toKey()];g||(g=new me(Pt)),g=g.insert(m,p),d.Vu[d.currentUser.toKey()]=g})(a,o.batchId,i),await vu(a,o.changes),await rd(a.remoteStore)}catch(o){const u=Ig(o,"Failed to persist write");i.reject(u)}}async function tw(n,t){const i=It(n);try{const a=await cj(i.localStore,t);t.targetChanges.forEach(((o,u)=>{const d=i.Au.get(u);d&&(Yt(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1,22616),o.addedDocuments.size>0?d.hu=!0:o.modifiedDocuments.size>0?Yt(d.hu,14607):o.removedDocuments.size>0&&(Yt(d.hu,42227),d.hu=!1))})),await vu(i,a,t)}catch(a){await So(a)}}function Wv(n,t,i){const a=It(n);if(a.isPrimaryClient&&i===0||!a.isPrimaryClient&&i===1){const o=[];a.Tu.forEach(((u,d)=>{const m=d.view.va(t);m.snapshot&&o.push(m.snapshot)})),(function(d,m){const p=It(d);p.onlineState=m;let g=!1;p.queries.forEach(((v,w)=>{for(const T of w.Sa)T.va(m)&&(g=!0)})),g&&jg(p)})(a.eventManager,t),o.length&&a.Pu.H_(o),a.onlineState=t,a.isPrimaryClient&&a.sharedClientState.setOnlineState(t)}}async function Zj(n,t,i){const a=It(n);a.sharedClientState.updateQueryState(t,"rejected",i);const o=a.Au.get(t),u=o&&o.key;if(u){let d=new me(vt.comparator);d=d.insert(u,sn.newNoDocument(u,At.min()));const m=Ut().add(u),p=new ed(At.min(),new Map,new me(Pt),d,m);await tw(a,p),a.du=a.du.remove(u),a.Au.delete(t),Dg(a)}else await Tm(a.localStore,t,!1).then((()=>Rm(a,t,i))).catch(So)}async function Jj(n,t){const i=It(n),a=t.batch.batchId;try{const o=await uj(i.localStore,t);nw(i,a,null),ew(i,a),i.sharedClientState.updateMutationState(a,"acknowledged"),await vu(i,o)}catch(o){await So(o)}}async function tC(n,t,i){const a=It(n);try{const o=await(function(d,m){const p=It(d);return p.persistence.runTransaction("Reject batch","readwrite-primary",(g=>{let v;return p.mutationQueue.lookupMutationBatch(g,m).next((w=>(Yt(w!==null,37113),v=w.keys(),p.mutationQueue.removeMutationBatch(g,w)))).next((()=>p.mutationQueue.performConsistencyCheck(g))).next((()=>p.documentOverlayCache.removeOverlaysForBatchId(g,v,m))).next((()=>p.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(g,v))).next((()=>p.localDocuments.getDocuments(g,v)))}))})(a.localStore,t);nw(a,t,i),ew(a,t),a.sharedClientState.updateMutationState(t,"rejected",i),await vu(a,o)}catch(o){await So(o)}}function ew(n,t){(n.mu.get(t)||[]).forEach((i=>{i.resolve()})),n.mu.delete(t)}function nw(n,t,i){const a=It(n);let o=a.Vu[a.currentUser.toKey()];if(o){const u=o.get(t);u&&(i?u.reject(i):u.resolve(),o=o.remove(t)),a.Vu[a.currentUser.toKey()]=o}}function Rm(n,t,i=null){n.sharedClientState.removeLocalQueryTarget(t);for(const a of n.Iu.get(t))n.Tu.delete(a),i&&n.Pu.yu(a,i);n.Iu.delete(t),n.isPrimaryClient&&n.Ru.jr(t).forEach((a=>{n.Ru.containsKey(a)||iw(n,a)}))}function iw(n,t){n.Eu.delete(t.path.canonicalString());const i=n.du.get(t);i!==null&&(bg(n.remoteStore,i),n.du=n.du.remove(t),n.Au.delete(i),Dg(n))}function Zv(n,t,i){for(const a of i)a instanceof WE?(n.Ru.addReference(a.key,t),eC(n,a)):a instanceof ZE?(pt(Cg,"Document no longer in limbo: "+a.key),n.Ru.removeReference(a.key,t),n.Ru.containsKey(a.key)||iw(n,a.key)):bt(19791,{wu:a})}function eC(n,t){const i=t.key,a=i.path.canonicalString();n.du.get(i)||n.Eu.has(a)||(pt(Cg,"New document in limbo: "+i),n.Eu.add(a),Dg(n))}function Dg(n){for(;n.Eu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const t=n.Eu.values().next().value;n.Eu.delete(t);const i=new vt(ae.fromString(t)),a=n.fu.next();n.Au.set(a,new qj(i)),n.du=n.du.insert(i,a),BE(n.remoteStore,new Wr(Si(pg(i.path)),a,"TargetPurposeLimboResolution",Yh.ce))}}async function vu(n,t,i){const a=It(n),o=[],u=[],d=[];a.Tu.isEmpty()||(a.Tu.forEach(((m,p)=>{d.push(a.pu(p,t,i).then((g=>{if((g||i)&&a.isPrimaryClient){const v=g?!g.fromCache:i?.targetChanges.get(p.targetId)?.current;a.sharedClientState.updateQueryState(p.targetId,v?"current":"not-current")}if(g){o.push(g);const v=Eg.As(p.targetId,g);u.push(v)}})))})),await Promise.all(d),a.Pu.H_(o),await(async function(p,g){const v=It(p);try{await v.persistence.runTransaction("notifyLocalViewChanges","readwrite",(w=>st.forEach(g,(T=>st.forEach(T.Es,(R=>v.persistence.referenceDelegate.addReference(w,T.targetId,R))).next((()=>st.forEach(T.ds,(R=>v.persistence.referenceDelegate.removeReference(w,T.targetId,R)))))))))}catch(w){if(!Ao(w))throw w;pt(wg,"Failed to update sequence numbers: "+w)}for(const w of g){const T=w.targetId;if(!w.fromCache){const R=v.Ms.get(T),M=R.snapshotVersion,L=R.withLastLimboFreeSnapshotVersion(M);v.Ms=v.Ms.insert(T,L)}}})(a.localStore,u))}async function nC(n,t){const i=It(n);if(!i.currentUser.isEqual(t)){pt(Cg,"User change. New user:",t.toKey());const a=await UE(i.localStore,t);i.currentUser=t,(function(u,d){u.mu.forEach((m=>{m.forEach((p=>{p.reject(new ft(it.CANCELLED,d))}))})),u.mu.clear()})(i,"'waitForPendingWrites' promise is rejected due to a user change."),i.sharedClientState.handleUserChange(t,a.removedBatchIds,a.addedBatchIds),await vu(i,a.Ls)}}function iC(n,t){const i=It(n),a=i.Au.get(t);if(a&&a.hu)return Ut().add(a.key);{let o=Ut();const u=i.Iu.get(t);if(!u)return o;for(const d of u){const m=i.Tu.get(d);o=o.unionWith(m.view.nu)}return o}}function rw(n){const t=It(n);return t.remoteStore.remoteSyncer.applyRemoteEvent=tw.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=iC.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=Zj.bind(null,t),t.Pu.H_=zj.bind(null,t.eventManager),t.Pu.yu=$j.bind(null,t.eventManager),t}function rC(n){const t=It(n);return t.remoteStore.remoteSyncer.applySuccessfulWrite=Jj.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=tC.bind(null,t),t}class Oh{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=nd(t.databaseInfo.databaseId),this.sharedClientState=this.Du(t),this.persistence=this.Cu(t),await this.persistence.start(),this.localStore=this.vu(t),this.gcScheduler=this.Fu(t,this.localStore),this.indexBackfillerScheduler=this.Mu(t,this.localStore)}Fu(t,i){return null}Mu(t,i){return null}vu(t){return lj(this.persistence,new aj,t.initialUser,this.serializer)}Cu(t){return new PE(_g.mi,this.serializer)}Du(t){return new mj}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Oh.provider={build:()=>new Oh};class aC extends Oh{constructor(t){super(),this.cacheSizeBytes=t}Fu(t,i){Yt(this.persistence.referenceDelegate instanceof Nh,46915);const a=this.persistence.referenceDelegate.garbageCollector;return new q3(a,t.asyncQueue,i)}Cu(t){const i=this.cacheSizeBytes!==void 0?xn.withCacheSize(this.cacheSizeBytes):xn.DEFAULT;return new PE((a=>Nh.mi(a,i)),this.serializer)}}class Im{async initialize(t,i){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(i),this.remoteStore=this.createRemoteStore(i),this.eventManager=this.createEventManager(i),this.syncEngine=this.createSyncEngine(i,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=a=>Wv(this.syncEngine,a,1),this.remoteStore.remoteSyncer.handleCredentialChange=nC.bind(null,this.syncEngine),await Pj(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return(function(){return new Lj})()}createDatastore(t){const i=nd(t.databaseInfo.databaseId),a=(function(u){return new _j(u)})(t.databaseInfo);return(function(u,d,m,p){return new Tj(u,d,m,p)})(t.authCredentials,t.appCheckCredentials,a,i)}createRemoteStore(t){return(function(a,o,u,d,m){return new Aj(a,o,u,d,m)})(this.localStore,this.datastore,t.asyncQueue,(i=>Wv(this.syncEngine,i,0)),(function(){return Kv.v()?new Kv:new gj})())}createSyncEngine(t,i){return(function(o,u,d,m,p,g,v){const w=new Kj(o,u,d,m,p,g);return v&&(w.gu=!0),w})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,i)}async terminate(){await(async function(i){const a=It(i);pt(ts,"RemoteStore shutting down."),a.Ea.add(5),await xu(a),a.Aa.shutdown(),a.Ra.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}Im.provider={build:()=>new Im};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(t,i,a){this.converter=i,this._query=a,this.type="query",this.firestore=t}withConverter(t){return new as(this.firestore,t,this._query)}}class Ae{constructor(t,i,a){this.converter=i,this._key=a,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new ea(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Ae(this.firestore,t,this._key)}toJSON(){return{type:Ae._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(t,i,a){if(mu(i,Ae._jsonSchema))return new Ae(t,a||null,new vt(ae.fromString(i.referencePath)))}}Ae._jsonSchemaVersion="firestore/documentReference/1.0",Ae._jsonSchema={type:Ne("string",Ae._jsonSchemaVersion),referencePath:Ne("string")};class ea extends as{constructor(t,i,a){super(t,i,pg(a)),this._path=a,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Ae(this.firestore,null,new vt(t))}withConverter(t){return new ea(this.firestore,t,this._path)}}function gh(n,t,...i){if(n=or(n),G2("collection","path",t),n instanceof ad){const a=ae.fromString(t,...i);return mv(a),new ea(n,null,a)}{if(!(n instanceof Ae||n instanceof ea))throw new ft(it.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const a=n._path.child(ae.fromString(t,...i));return mv(a),new ea(n.firestore,null,a)}}function Xl(n,t,...i){if(n=or(n),arguments.length===1&&(t=lg.newId()),G2("doc","path",t),n instanceof ad){const a=ae.fromString(t,...i);return pv(a),new Ae(n,null,new vt(a))}{if(!(n instanceof Ae||n instanceof ea))throw new ft(it.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const a=n._path.child(ae.fromString(t,...i));return pv(a),new Ae(n.firestore,n instanceof ea?n.converter:null,new vt(a))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i_="AsyncQueue";class r_{constructor(t=Promise.resolve()){this.Xu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new zE(this,"async_queue_retry"),this._c=()=>{const a=Op();a&&pt(i_,"Visibility state changed to "+a.visibilityState),this.M_.w_()},this.ac=t;const i=Op();i&&typeof i.addEventListener=="function"&&i.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.uc(),this.cc(t)}enterRestrictedMode(t){if(!this.ec){this.ec=!0,this.sc=t||!1;const i=Op();i&&typeof i.removeEventListener=="function"&&i.removeEventListener("visibilitychange",this._c)}}enqueue(t){if(this.uc(),this.ec)return new Promise((()=>{}));const i=new rr;return this.cc((()=>this.ec&&this.sc?Promise.resolve():(t().then(i.resolve,i.reject),i.promise))).then((()=>i.promise))}enqueueRetryable(t){this.enqueueAndForget((()=>(this.Xu.push(t),this.lc())))}async lc(){if(this.Xu.length!==0){try{await this.Xu[0](),this.Xu.shift(),this.M_.reset()}catch(t){if(!Ao(t))throw t;pt(i_,"Operation failed with retryable error: "+t)}this.Xu.length>0&&this.M_.p_((()=>this.lc()))}}cc(t){const i=this.ac.then((()=>(this.rc=!0,t().catch((a=>{throw this.nc=a,this.rc=!1,ur("INTERNAL UNHANDLED ERROR: ",a_(a)),a})).then((a=>(this.rc=!1,a))))));return this.ac=i,i}enqueueAfterDelay(t,i,a){this.uc(),this.oc.indexOf(t)>-1&&(i=0);const o=Rg.createAndSchedule(this,t,i,a,(u=>this.hc(u)));return this.tc.push(o),o}uc(){this.nc&&bt(47125,{Pc:a_(this.nc)})}verifyOperationInProgress(){}async Tc(){let t;do t=this.ac,await t;while(t!==this.ac)}Ic(t){for(const i of this.tc)if(i.timerId===t)return!0;return!1}Ec(t){return this.Tc().then((()=>{this.tc.sort(((i,a)=>i.targetTimeMs-a.targetTimeMs));for(const i of this.tc)if(i.skipDelay(),t!=="all"&&i.timerId===t)break;return this.Tc()}))}dc(t){this.oc.push(t)}hc(t){const i=this.tc.indexOf(t);this.tc.splice(i,1)}}function a_(n){let t=n.message||"";return n.stack&&(t=n.stack.includes(n.message)?n.stack:n.message+`
`+n.stack),t}class _u extends ad{constructor(t,i,a,o){super(t,i,a,o),this.type="firestore",this._queue=new r_,this._persistenceKey=o?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new r_(t),this._firestoreClient=void 0,await t}}}function cw(n,t){const i=typeof n=="object"?n:iI(),a=typeof n=="string"?n:Rh,o=Z6(i,"firestore").getImmediate({identifier:a});if(!o._initialized){const u=$R("firestore");u&&hC(o,...u)}return o}function Ng(n){if(n._terminated)throw new ft(it.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||dC(n),n._firestoreClient}function dC(n){const t=n._freezeSettings(),i=(function(o,u,d,m){return new PI(o,u,d,m.host,m.ssl,m.experimentalForceLongPolling,m.experimentalAutoDetectLongPolling,lw(m.experimentalLongPollingOptions),m.useFetchStreams,m.isUsingEmulator)})(n._databaseId,n._app?.options.appId||"",n._persistenceKey,t);n._componentsProvider||t.localCache?._offlineComponentProvider&&t.localCache?._onlineComponentProvider&&(n._componentsProvider={_offline:t.localCache._offlineComponentProvider,_online:t.localCache._onlineComponentProvider}),n._firestoreClient=new sC(n._authCredentials,n._appCheckCredentials,n._queue,i,n._componentsProvider&&(function(o){const u=o?._online.build();return{_offline:o?._offline.build(u),_online:u}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sd{constructor(...t){for(let i=0;i<t.length;++i)if(t[i].length===0)throw new ft(it.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new We(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ii{constructor(t,i){if(!isFinite(t)||t<-90||t>90)throw new ft(it.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(i)||i<-180||i>180)throw new ft(it.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+i);this._lat=t,this._long=i}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}_compareTo(t){return Pt(this._lat,t._lat)||Pt(this._long,t._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Ii._jsonSchemaVersion}}static fromJSON(t){if(mu(t,Ii._jsonSchema))return new Ii(t.latitude,t.longitude)}}Ii._jsonSchemaVersion="firestore/geoPoint/1.0",Ii._jsonSchema={type:Ne("string",Ii._jsonSchemaVersion),latitude:Ne("number"),longitude:Ne("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fC=/^__.*__$/;class pC{constructor(t,i,a){this.data=t,this.fieldMask=i,this.fieldTransforms=a}toMutation(t,i){return this.fieldMask!==null?new ua(t,this.data,this.fieldMask,i,this.fieldTransforms):new gu(t,this.data,i,this.fieldTransforms)}}class hw{constructor(t,i,a){this.data=t,this.fieldMask=i,this.fieldTransforms=a}toMutation(t,i){return new ua(t,this.data,this.fieldMask,i,this.fieldTransforms)}}function dw(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw bt(40011,{Ac:n})}}class Mg{constructor(t,i,a,o,u,d){this.settings=t,this.databaseId=i,this.serializer=a,this.ignoreUndefinedProperties=o,u===void 0&&this.Rc(),this.fieldTransforms=u||[],this.fieldMask=d||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(t){return new Mg({...this.settings,...t},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(t){const i=this.path?.child(t),a=this.Vc({path:i,fc:!1});return a.gc(t),a}yc(t){const i=this.path?.child(t),a=this.Vc({path:i,fc:!1});return a.Rc(),a}wc(t){return this.Vc({path:void 0,fc:!0})}Sc(t){return Vh(t,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(t){return this.fieldMask.find((i=>t.isPrefixOf(i)))!==void 0||this.fieldTransforms.find((i=>t.isPrefixOf(i.field)))!==void 0}Rc(){if(this.path)for(let t=0;t<this.path.length;t++)this.gc(this.path.get(t))}gc(t){if(t.length===0)throw this.Sc("Document fields must not be empty");if(dw(this.Ac)&&fC.test(t))throw this.Sc('Document fields cannot begin and end with "__"')}}class mC{constructor(t,i,a){this.databaseId=t,this.ignoreUndefinedProperties=i,this.serializer=a||nd(t)}Cc(t,i,a,o=!1){return new Mg({Ac:t,methodName:i,Dc:a,path:We.emptyPath(),fc:!1,bc:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Og(n){const t=n._freezeSettings(),i=nd(n._databaseId);return new mC(n._databaseId,!!t.ignoreUndefinedProperties,i)}function gC(n,t,i,a,o,u={}){const d=n.Cc(u.merge||u.mergeFields?2:0,t,i,o);kg("Data must be an object, but it was:",d,a);const m=fw(a,d);let p,g;if(u.merge)p=new Cn(d.fieldMask),g=d.fieldTransforms;else if(u.mergeFields){const v=[];for(const w of u.mergeFields){const T=jm(t,w,i);if(!d.contains(T))throw new ft(it.INVALID_ARGUMENT,`Field '${T}' is specified in your field mask but missing from your input data.`);mw(v,T)||v.push(T)}p=new Cn(v),g=d.fieldTransforms.filter((w=>p.covers(w.field)))}else p=null,g=d.fieldTransforms;return new pC(new vn(m),p,g)}class ld extends od{_toFieldTransform(t){if(t.Ac!==2)throw t.Ac===1?t.Sc(`${this._methodName}() can only appear at the top level of your update data`):t.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof ld}}class Vg extends od{constructor(t,i){super(t),this.Fc=i}_toFieldTransform(t){const i=new du(t.serializer,xE(t.serializer,this.Fc));return new l3(t.path,i)}isEqual(t){return t instanceof Vg&&this.Fc===t.Fc}}function yC(n,t,i,a){const o=n.Cc(1,t,i);kg("Data must be an object, but it was:",o,a);const u=[],d=vn.empty();la(a,((p,g)=>{const v=Pg(t,p,i);g=or(g);const w=o.yc(v);if(g instanceof ld)u.push(v);else{const T=Eu(g,w);T!=null&&(u.push(v),d.set(v,T))}}));const m=new Cn(u);return new hw(d,m,o.fieldTransforms)}function xC(n,t,i,a,o,u){const d=n.Cc(1,t,i),m=[jm(t,a,i)],p=[o];if(u.length%2!=0)throw new ft(it.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let T=0;T<u.length;T+=2)m.push(jm(t,u[T])),p.push(u[T+1]);const g=[],v=vn.empty();for(let T=m.length-1;T>=0;--T)if(!mw(g,m[T])){const R=m[T];let M=p[T];M=or(M);const L=d.yc(R);if(M instanceof ld)g.push(R);else{const U=Eu(M,L);U!=null&&(g.push(R),v.set(R,U))}}const w=new Cn(g);return new hw(v,w,d.fieldTransforms)}function vC(n,t,i,a=!1){return Eu(i,n.Cc(a?4:3,t))}function Eu(n,t){if(pw(n=or(n)))return kg("Unsupported field value:",t,n),fw(n,t);if(n instanceof od)return(function(a,o){if(!dw(o.Ac))throw o.Sc(`${a._methodName}() can only be used with update() and set()`);if(!o.path)throw o.Sc(`${a._methodName}() is not currently supported inside arrays`);const u=a._toFieldTransform(o);u&&o.fieldTransforms.push(u)})(n,t),null;if(n===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),n instanceof Array){if(t.settings.fc&&t.Ac!==4)throw t.Sc("Nested arrays are not supported");return(function(a,o){const u=[];let d=0;for(const m of a){let p=Eu(m,o.wc(d));p==null&&(p={nullValue:"NULL_VALUE"}),u.push(p),d++}return{arrayValue:{values:u}}})(n,t)}return(function(a,o){if((a=or(a))===null)return{nullValue:"NULL_VALUE"};if(typeof a=="number")return xE(o.serializer,a);if(typeof a=="boolean")return{booleanValue:a};if(typeof a=="string")return{stringValue:a};if(a instanceof Date){const u=ue.fromDate(a);return{timestampValue:Dh(o.serializer,u)}}if(a instanceof ue){const u=new ue(a.seconds,1e3*Math.floor(a.nanoseconds/1e3));return{timestampValue:Dh(o.serializer,u)}}if(a instanceof Ii)return{geoPointValue:{latitude:a.latitude,longitude:a.longitude}};if(a instanceof Fn)return{bytesValue:jE(o.serializer,a._byteString)};if(a instanceof Ae){const u=o.databaseId,d=a.firestore._databaseId;if(!d.isEqual(u))throw o.Sc(`Document reference is for database ${d.projectId}/${d.database} but should be for database ${u.projectId}/${u.database}`);return{referenceValue:xg(a.firestore._databaseId||o.databaseId,a._key.path)}}if(a instanceof ji)return(function(d,m){return{mapValue:{fields:{[nE]:{stringValue:iE},[Ih]:{arrayValue:{values:d.toArray().map((g=>{if(typeof g!="number")throw m.Sc("VectorValues must only contain numeric values.");return mg(m.serializer,g)}))}}}}}})(a,o);throw o.Sc(`Unsupported field value: ${Gh(a)}`)})(n,t)}function fw(n,t){const i={};return X2(n)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):la(n,((a,o)=>{const u=Eu(o,t.mc(a));u!=null&&(i[a]=u)})),{mapValue:{fields:i}}}function pw(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ue||n instanceof Ii||n instanceof Fn||n instanceof Ae||n instanceof od||n instanceof ji)}function kg(n,t,i){if(!pw(i)||!Y2(i)){const a=Gh(i);throw a==="an object"?t.Sc(n+" a custom object"):t.Sc(n+" "+a)}}function jm(n,t,i){if((t=or(t))instanceof sd)return t._internalPath;if(typeof t=="string")return Pg(n,t);throw Vh("Field path arguments must be of type string or ",n,!1,void 0,i)}const _C=new RegExp("[~\\*/\\[\\]]");function Pg(n,t,i){if(t.search(_C)>=0)throw Vh(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,i);try{return new sd(...t.split("."))._internalPath}catch{throw Vh(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,i)}}function Vh(n,t,i,a,o){const u=a&&!a.isEmpty(),d=o!==void 0;let m=`Function ${t}() called with invalid data`;i&&(m+=" (via `toFirestore()`)"),m+=". ";let p="";return(u||d)&&(p+=" (found",u&&(p+=` in field ${a}`),d&&(p+=` in document ${o}`),p+=")"),new ft(it.INVALID_ARGUMENT,m+n+p)}function mw(n,t){return n.some((i=>i.isEqual(t)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xh(n){n=cr(n,Ae);const t=cr(n.firestore,_u);return uC(Ng(t),n._key).then((i=>AC(t,n,i)))}ro._jsonSchemaVersion="firestore/querySnapshot/1.0",ro._jsonSchema={type:Ne("string",ro._jsonSchemaVersion),bundleSource:Ne("string","QuerySnapshot"),bundleName:Ne("string"),bundle:Ne("string")};class vw extends bC{constructor(t){super(),this.firestore=t}convertBytes(t){return new Fn(t)}convertReference(t){const i=this.convertDocumentKey(t,this.firestore._databaseId);return new Ae(this.firestore,null,i)}}function Cm(n){n=cr(n,as);const t=cr(n.firestore,_u),i=Ng(t),a=new vw(t);return wC(n._query),cC(i,n._query).then((o=>new ro(t,a,n,o)))}function Fg(n,t,i){n=cr(n,Ae);const a=cr(n.firestore,_u),o=TC(n.converter,t,i);return _w(a,[gC(Og(a),"setDoc",n._key,o,n.converter!==null,i).toMutation(n._key,Ai.none())])}function kh(n,t,i,...a){n=cr(n,Ae);const o=cr(n.firestore,_u),u=Og(o);let d;return d=typeof(t=or(t))=="string"||t instanceof sd?xC(u,"updateDoc",n._key,t,i,a):yC(u,"updateDoc",n._key,t),_w(o,[d.toMutation(n._key,Ai.exists(!0))])}function _w(n,t){return(function(a,o){const u=new rr;return a.asyncQueue.enqueueAndForget((async()=>Wj(await lC(a),o,u))),u.promise})(Ng(n),t)}function AC(n,t,i){const a=i.docs.get(t._key),o=new vw(n);return new Za(n,o,t._key,a,new Bl(i.hasPendingWrites,i.fromCache),t.converter)}function Ph(n){return new Vg("increment",n)}(function(t,i=!0){(function(o){To=o})(nI),Sh(new nu("firestore",((a,{instanceIdentifier:o,options:u})=>{const d=a.getProvider("app").getImmediate(),m=new _u(new xI(a.getProvider("auth-internal")),new EI(d,a.getProvider("app-check-internal")),(function(g,v){if(!Object.prototype.hasOwnProperty.apply(g.options,["projectId"]))throw new ft(it.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ou(g.options.projectId,v)})(d,o),d);return u={useFetchStreams:i,...u},m._setSettings(u),m}),"PUBLIC").setMultipleInstances(!0)),no(cv,hv,t),no(cv,hv,"esm2020")})();const RC={apiKey:"AIzaSyAEFzPwTADLzuxWuyk889Jz1cHPsEgLOkQ",authDomain:"tu2025grad.firebaseapp.com",projectId:"tu2025grad",storageBucket:"tu2025grad.firebasestorage.app",messagingSenderId:"553768466639",appId:"1:553768466639:web:7c16f5d6432da7ebc05fba"},IC=av().length?av()[0]:sg(RC),Wl=cw(IC),c_=40;function Ew(n){if(!n)return n;const t="/";if(/^https?:\/\//i.test(n))return n;const i=n.replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const jC=A.div`
  position: relative; background: #fff;
`,CC=A.div`
...
`;function DC({children:n}){return y.jsx(jC,{children:y.jsx(CC,{children:n})})}const NC=A.div`
  position: relative;
...
`,h_=eu,ww=eg,VC={"All Projects":null,"AI & Robot":"c0","Edu & Kids":"c1","Health Care":"c2","IT & Tech":"c3",Living:"c4",Mobility:"c5"};function Dm(n){return n.members.map(t=>{const i=ww.find(a=>a.num===t);return i?i.nameKor:""}).filter(Boolean).join(", ")}function kC(n){return n.members.map(t=>{const i=ww.find(a=>a.num===t);return i?Ew(i.imgUrl):""}).filter(Boolean)}function PC({list:n,statsById:t}){const i={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"};return y.jsx(MC,{children:n.map((a,o)=>{const u=Dm(a),d=kC(a),m=String(a.projectNum+1).padStart(3,"0"),g=`${i[a.category]||"A"}${m}`,v=a.projectNum??a.num;return y.jsx(ng,{titleKor:a.titleKor,titleEng:a.titleEng,src:Ew(`/projects/${a.projectNum}/thumb.jpg`||`/projects/${a.projectNum}/thumb.png`),nameKor:u,profileImgs:d,docId:v,href:`/work/${g}`,like:t[String(v)]?.like??0,view:t[String(v)]?.view??0},o)})})}function UC(){const[n,t]=St.useState("All Projects"),[i,a]=St.useState("이름순"),[o,u]=St.useState({});St.useEffect(()=>{let p=!0;return(async()=>{try{const g=await Cm(gh(Wl,"works"));if(!p)return;const v={};g.forEach(w=>{const T=w.data()||{};v[String(w.id)]={like:typeof T.like=="number"?T.like:0,view:typeof T.view=="number"?T.view:0}}),u(v)}catch(g){console.error("Failed to load works stats:",g)}})(),()=>{p=!1}},[]);const d=St.useMemo(()=>{const p=VC[n]||null;return p?h_.filter(g=>g.category===p):h_},[n]),m=St.useMemo(()=>{const p=[...d];switch(i){case"이름순":p.sort((g,v)=>Dm(g).localeCompare(Dm(v),"ko"));break;case"좋아요순":p.sort((g,v)=>{const w=String(g.projectNum??g.num),T=String(v.projectNum??v.num),R=o[w]?.like??0;return(o[T]?.like??0)-R});break;case"조회수순":p.sort((g,v)=>{const w=String(g.projectNum??g.num),T=String(v.projectNum??v.num),R=o[w]?.view??0;return(o[T]?.view??0)-R});break;case"팀작우선":p.sort((g,v)=>(v.members.length>1)-(g.members.length>1));break;case"개인작우선":p.sort((g,v)=>(g.members.length>1)-(v.members.length>1));break}return p},[d,i,o]);return y.jsxs(NC,{children:[y.jsx(OC,{children:"Projects"}),y.jsx(I2,{type:"project",onCategoryChange:t,onSortChange:a,sortLabel:i}),y.jsx(DC,{children:y.jsx(PC,{list:m,statsById:o})})]})}const LC=A.div(({height:n,from:t,to:i,position:a,z:o})=>({position:"absolute",left:0,right:0,[a]:-1,height:n,pointerEvents:"none",zIndex:o??0,background:`linear-gradient(180deg, ${t} 0%, ${i} 100%)`}));function qg({position:n="bottom",from:t,to:i,height:a=240,z:o=0,style:u}){return y.jsx(LC,{position:n,from:t,to:i,height:a,z:o,style:u})}const ar={heroToWhite:{from:"rgba(18,18,18,0)",to:"#FFFFFF",h:80},whiteToBlack:{from:"rgba(255,255,255,0)",to:"#121212",h:160},blackToBlackSoft:{from:"rgba(18,18,18,0)",to:"#121212",h:180}},zC=A.section`
...
`;function XC(){const[n,t]=St.useState(!1),i=St.useRef(null),a="/",o=Lh();St.useEffect(()=>()=>{i.current&&clearTimeout(i.current)},[]);const u=()=>{const m=`${typeof window<"u"&&window.innerWidth<640?"projects":"showroom"}`;o(m)};return y.jsxs(zC,{"aria-label":"Hero",children:[y.jsxs($C,{children:[y.jsx(BC,{"aria-hidden":!0,children:y.jsx(FC,{autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata",children:y.jsx("source",{src:`${a}video/hero11.mp4`,type:"video/mp4"})})}),y.jsx(qC,{"aria-label":"Hero background video",children:y.jsxs(KC,{autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata",onLoadedData:()=>{i.current&&clearTimeout(i.current),i.current=setTimeout(()=>t(!0),13900)},children:[y.jsx("source",{src:`${a}video/hero11.mp4`,type:"video/mp4"}),"Your browser does not support the video tag."]})}),y.jsx(HC,{})]}),y.jsxs(GC,{$visible:n,children:[y.jsxs(d_,{children:["25. 10. 24. FRI~26. SUN",y.jsx("br",{}),"Hongdae Art Center B2"]}),y.jsx(d_,{children:"Department of Design Engineering"}),y.jsxs(YC,{children:["Tech University of Korea",y.jsx("br",{}),"20th Grad Exhibition"]})]}),y.jsxs(QC,{type:"button",onClick:u,"aria-label":"View More",children:[y.jsx("span",{className:"desktop",children:"View More"}),y.jsx("span",{className:"mobile",children:"View Work"})]}),y.jsx(qg,{position:"bottom",from:ar.heroToWhite.from,to:ar.heroToWhite.to,height:ar.heroToWhite.h,z:0})]})}const f_="/",WC=A.section`
  position: relative;
  z-index: 1;
  background: #FFFFFF;
  padding-top: 120px;
...
`,p_=A.div`
  ...
  aspect-ratio: 1 / 1;
  max-height: 200px;
`;function vD(){const n=[{src:"https://placehold.co/910x512",cap:""},{src:`${fn}sq5.png`,cap:""},{src:`${fn}sq2.png`,cap:""},{src:"https://placehold.co/727x445",cap:""},{src:`${fn}sq6.png`,cap:""},{src:`${fn}sq4.png`,cap:""},{src:"https://placehold.co/987x555",cap:""},{src:`${fn}sq3.png`,cap:""},{src:`${fn}sq1.png`,cap:""}];return y.jsxs(uD,{"aria-label":"Gallery",children:[y.jsx(qg,{position:"top",from:ar.blackToBlackSoft.from,to:ar.blackToBlackSoft.to,height:ar.blackToBlackSoft.h,z:0}),y.jsxs(cD,{children:[y.jsxs(hD,{children:[y.jsx(Ei,{src:"https://placehold.co/1840x1000",alt:"featured"}),y.jsx(dD,{"aria-hidden":!0,children:y.jsx(fD,{})})]}),y.jsxs(pD,{className:"gallery-desktop",children:[y.jsxs(kp,{children:[y.jsx(er,{$w:910,$h:445,children:y.jsx(Ei,{src:`${fn}video/sub1.mp4`,alt:""})}),y.jsx(er,{$w:445,$h:445,children:y.jsx(Ei,{src:`${fn}sq5.png`,alt:""})}),y.jsx(er,{$w:445,$h:445,children:y.jsx(Ei,{src:`${fn}sq6.png`,alt:""})})]}),y.jsxs(kp,{children:[y.jsx(er,{$w:445,$h:445,children:y.jsx(Ei,{src:`${fn}sq4.png`,alt:""})}),y.jsx(er,{$w:445,$h:445,children:y.jsx(Ei,{src:`${fn}sq2.png`,alt:""})}),y.jsx(er,{$w:910,$h:445,children:y.jsx(Ei,{src:`${fn}video/sub1.mp4`,alt:""})})]}),y.jsxs(kp,{children:[y.jsx(er,{$w:910,$h:445,children:y.jsx(Ei,{src:`${fn}video/category.mp4`,alt:""})}),y.jsx(er,{$w:445,$h:445,children:y.jsx(Ei,{src:`${fn}sq3.png`,alt:""})}),y.jsx(er,{$w:445,$h:445,children:y.jsx(Ei,{src:`${fn}sq1.png`,alt:""})})]})]}),y.jsx(mD,{children:y.jsx("div",{style:{marginTop:12,display:"flex",flexDirection:"column",gap:12},children:Array.from({length:3}).map((t,i)=>{const a=i*3,o=n[a],u=n[a+1],d=n[a+2];return y.jsxs(gD,{children:[o&&y.jsxs(yD,{children:[y.jsx("img",{src:o.src,alt:"",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}),o.cap&&y.jsx(Pp,{style:{opacity:1},children:o.cap})]}),y.jsxs(xD,{children:[u&&y.jsxs(p_,{children:[y.jsx("img",{src:u.src,alt:"",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}),u.cap&&y.jsx(Pp,{style:{opacity:1},children:u.cap})]}),d&&y.jsxs(p_,{children:[y.jsx("img",{src:d.src,alt:"",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}),d.cap&&y.jsx(Pp,{style:{opacity:1},children:d.cap})]})]})]},i)})})}),y.jsx("div",{style:{paddingTop:40,display:"flex",justifyContent:"center"},children:y.jsx(Kg,{label:"View More"})})]})]})}const _D=A.section`
  position: relative;
...
`;function bD({durationVh:n=300,center:t=!0,centerOffsetPx:i=0,children:a,style:o}){const u=St.useRef(null),[d,m]=St.useState(0);return St.useEffect(()=>{const p=u.current;if(!p)return;let g=0,v=!0;const w=()=>{if(!v)return;const T=p.getBoundingClientRect(),R=window.innerHeight,M=n/100*R-R,L=Math.min(Math.max(-T.top,0),M);m(M>0?L/M:0),g=requestAnimationFrame(w)};return g=requestAnimationFrame(w),()=>{v=!1,cancelAnimationFrame(g)}},[n]),y.jsx(_D,{ref:u,style:o,$durationVh:n,children:y.jsx(ED,{$center:t,children:y.jsx(wD,{$offset:i,children:typeof a=="function"?a(d):a})})})}const m_=[{id:"w1",index:"A010",artistKr:"송지원, 허지유",dept:"Industrial Design Engineering",titleSmall:"한국산업기술진흥원장상 수상",titleStrong:"BIND",rightMeta1:"Precision and efficency beyond human limits.",rightMeta2:"BIND, 흩어진 시간을 하나로 잇다.",image:"1127032149"},{id:"w2",index:"A017",artistKr:"이채연",dept:"Media Design Engineering",titleSmall:"총동문회장상 수상",titleStrong:"MUSE",rightMeta1:"디자인 논문을 쉽게 활용할 수 있도록 돕는",rightMeta2:"AI 인사이트 제공 서비스",image:"1127403683"},{id:"w3",index:"A011",artistKr:"정혜원, 신주혜",dept:"Industrial Design Engineering",titleSmall:"한국공학대학교총장상 수상",titleStrong:"ENDY",rightMeta1:"감정을 이해하고 반응하는 학습 파트너,",rightMeta2:"자기주도학습의 새로운 동반자 ENDY",image:"1126889031"}],TD=A.div`
  position: relative;
  background: #121212;
  @media (max-width: 640px) {
    background: #121212;
...
`,UD=A.iframe`
  ...
  display: block;
  margin-top: 16px;
`,LD=(n,t=0,i=1)=>Math.max(t,Math.min(i,n)),Xs=(n,t,i)=>n+(t-n)*i,zD=n=>n<.5?2*n*n:1-Math.pow(-2*n+2,2)/2;function $D({work:n,progress:t,videoId:i}){String(i||"").trim();const a=`https://player.vimeo.com/video/${n.image}?muted=1&autoplay=1&loop=1&badge=0&controls=0&autopause=0&title=0&byline=0&portrait=0&app_id=58479`,o=zD(LD(t,0,1)),u=Xs(0,-120,o),d=Xs(0,-360,o),m=Xs(0,-280,o),p=Xs(0,-220,o),g=Xs(0,-260,o),v=Xs(0,-180,o),w=.55,R=o<w?1:1-Math.max(0,Math.min(1,(o-w)/(.9-w))),M={transform:`translate3d(0, ${u}px, 0)`,willChange:"transform"},L=K=>({transform:`translate3d(0, ${K}px, 0)`,opacity:R,willChange:"transform, opacity"}),U={transform:`translate3d(0, ${v}px, 0)`,opacity:R,willChange:"transform, opacity"};return y.jsx(y.Fragment,{children:y.jsx(TD,{children:y.jsxs(ID,{children:[y.jsx(jD,{style:M,children:y.jsx(PD,{src:a,frameBorder:"0"})}),y.jsx(CD,{style:L(d),children:n.artistKr}),y.jsx(DD,{style:L(m),children:n.dept}),y.jsx(ND,{style:L(p),children:n.rightMeta1}),y.jsx(MD,{style:L(g),children:n.rightMeta2}),y.jsxs(OD,{style:U,children:[y.jsx(VD,{children:n.titleSmall}),y.jsx(kD,{children:n.titleStrong})]})]})})})}function BD(){return y.jsxs(y.Fragment,{children:[y.jsx("style",{children:`
        @media (max-width: 640px) {
      ...
      `}),y.jsx("div",{className:"expo-works-desktop",children:m_.slice(0,3).map(n=>y.jsx(bD,{durationVh:320,center:!0,centerOffsetPx:-40,children:t=>y.jsx($D,{work:n,progress:t})},n.id))}),y.jsx(SD,{className:"expo-works-mobile",children:m_.map(n=>y.jsxs(AD,{to:`work/${n.index}`,children:[y.jsx(UD,{src:`https://player.vimeo.com/video/${n.image}?badge=0&controls=0&autopause=0&title=0&byline=0&portrait=0&app_id=58479`}),y.jsxs(RD,{children:[y.jsx("div",{style:{fontWeight:700,fontSize:16},children:n.titleStrong}),y.jsxs("div",{style:{fontSize:13,color:"#D9D9D9"},children:[n.artistKr," | ",n.dept]}),y.jsx("div",{style:{fontSize:12,color:"#A1A1A1",marginTop:2},children:n.rightMeta1}),y.jsx("div",{style:{fontSize:12,color:"#A1A1A1"},children:n.rightMeta2})]})]},n.id))})]})}const FD="/",qD=A.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: flex-start;
...
`;function WD(){return y.jsx(qD,{"aria-labelledby":"insta-title",children:y.jsx(KD,{children:y.jsxs(HD,{children:[y.jsx(GD,{children:y.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"#FFFFFF",children:[y.jsx("path",{d:"M12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 8.2A3.2 3.2 0 1 1 12 8a3.2 3.2 0 0 1 0 6.4z"}),y.jsx("circle",{cx:"17.5",cy:"6.5",r:"1.2"}),y.jsx("path",{d:"M17.8 2H6.2A4.2 4.2 0 0 0 2 6.2v11.6A4.2 4.2 0 0 0 6.2 22h11.6A4.2 4.2 0 0 0 22 17.8V6.2A4.2 4.2 0 0 0 17.8 2zm2.6 15.8a2.6 2.6 0 0 1-2.6 2.6H6.2a2.6 2.6 0 0 1-2.6-2.6V6.2A2.6 2.6 0 0 1 6.2 3.6h11.6a2.6 2.6 0 0 1 2.6 2.6v11.6z"})]})}),y.jsx(YD,{id:"insta-title",children:"@tukd_grad"}),y.jsxs(QD,{children:[y.jsx(XD,{children:y.jsx("img",{src:`${FD}insta-qr.png`,alt:"Instagram preview"})}),y.jsx(Kg,{as:"a",href:"https://www.instagram.com/tukd_grad?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",label:"View Instagram",size:"sm"})]})]})})})}const bu=`'Pretendard', system-ui, -apple-system, Segoe UI, Roboto, "Noto Sans KR", Arial, sans-serif`,g_=350,ZD=A.section`
...
`,e5=({children:n})=>y.jsx(JD,{children:y.jsx(t5,{children:n})}),n5=A.div`
...
`;function r5({title:n}){return y.jsx(n5,{children:y.jsx(i5,{children:n})})}const a5=A.div`
...
`;function Qr({k:n,children:t,divider:i=!0}){return y.jsxs(s5,{$divider:i,children:[y.jsx(o5,{children:y.jsx(l5,{children:n})}),y.jsx(u5,{children:t})]})}const c5=A.div`
...
`;function y_({title:n,children:t,last:i=!1}){return y.jsxs(a5,{$last:i,children:[y.jsx(r5,{title:n}),y.jsx(c5,{children:t})]})}const h5=A.div`
...
`;function m5(){return y.jsx(ZD,{"aria-label":"Venue & Access",children:y.jsxs(e5,{children:[y.jsxs(y_,{title:"Venew Details",children:[y.jsx(h5,{children:y.jsx(d5,{children:"잔향 : 기억의 향기"})}),y.jsx(Qr,{k:"Term",children:y.jsx(Ht,{children:"2025. 10. 24. FRI - 10. 26. SUN"})}),y.jsxs(Qr,{k:"Hours",children:[y.jsx(Ht,{children:"10.24.FRI   13:00 ~ 17:30 (OPENING 16:00~)"}),y.jsx(Ht,{children:"10.25.SAT ~ 10.26.SUN    10:00 ~ 17:30"})]}),y.jsxs(Qr,{k:"Schedule",children:[y.jsx(th,{children:"10.24.FRI"}),y.jsx(Ht,{children:"13:00    자유관람"}),y.jsx(Ht,{children:"15:00    졸업생 홈커밍 행사"}),y.jsx(Ht,{children:"16:00    개회식"}),y.jsx(Ht,{children:"16:20    졸업작품 우수작 시상"}),y.jsx(Ht,{children:"16:30    자유관람"}),y.jsxs(th,{children:[y.jsx("br",{}),"10.25.SAT"]}),y.jsx(Ht,{children:"10:00    자유관람"}),y.jsx(Ht,{children:"13:00    취·창업 커리어 캠프"}),y.jsxs(th,{children:[y.jsx("br",{}),"10.26.SUN"]}),y.jsx(Ht,{children:"10:00    자유관람"})]}),y.jsxs(Qr,{k:"Website",divider:!1,children:[y.jsx(Ht,{children:"Hongik Art Center"}),y.jsx(p5,{href:"https://artscenter.hongik.ac.kr/artcenter/index.do",target:"_blank",rel:"noreferrer",children:"https://artscenter.hongik.ac.kr/artcenter/index.do"})]})]}),y.jsxs(y_,{title:"Access",children:[y.jsxs(Qr,{k:"Address",children:[y.jsxs(Ht,{children:["홍대 아트센터 지하 2층 전시관 3",y.jsx("br",{}),"서울시 종로구 대학로 57"]}),y.jsxs(Ht,{children:["Hongik Art Center B2 Gallery 3",y.jsx("br",{}),"57, Daehak-ro, Jongno-gu, Seoul"]}),y.jsx("div",{style:{marginTop:24},children:y.jsx(Kg,{as:"a",href:"https://maps.app.goo.gl/qc99M9bDqyBTcmx79",label:"Map",size:"sm",showArrow:!0})})]}),y.jsxs(Qr,{k:"Parking",children:[y.jsx(Ht,{children:"B3F ~ B6F"}),y.jsxs(Ht,{children:[y.jsx("br",{}),"기본 30분 3,000원 / 이후 20분당 2,000원"]}),y.jsx(Ht,{children:"이용객 주차권 지참 시 50% 할인 및 1시간 무료이용권 제공"}),y.jsx(th,{children:"(주차권으로만 정산 가능, 티켓정산 불가)"}),y.jsx(f5,{children:"주차권 배부 장소: B2 갤러리 3, 전시장 입구 인포데스크"})]}),y.jsxs(Qr,{k:"By Subway",children:[y.jsx(Ht,{children:"[1호선 종로5가역]"}),y.jsx(Ht,{children:"2번 출구 방면으로 이동 → 이화사거리 방면으로 약 800m 직진 (도보7분)"}),y.jsxs(Ht,{children:[y.jsx("br",{}),"[4호선 혜화역]"]}),y.jsx(Ht,{children:"3번 출구 방면으로 이동 → 이화사거리 방면으로 약 800m 직진 (도보7분)"}),y.jsx(Ht,{children:"또는 08번 마을버스 탑승 후 이화사거리 앞 하차"})]}),y.jsxs(Qr,{k:"By Bus",divider:!1,children:[y.jsx(Ht,{children:"[이화사거리(01-572) 하차]"}),y.jsx(Ht,{children:"마을버스 종로 08번"}),y.jsxs(Ht,{children:[y.jsx("br",{}),"[현대그룹빌딩(01-218) 하차]"]}),y.jsx(Ht,{children:"102, 107, 108, 109, 162, 301, 7025"}),y.jsxs(Ht,{children:[y.jsx("br",{}),"[이화장(01-223) 하차]"]}),y.jsx(Ht,{children:"109, 273, 601, 2112, 7025"})]})]})]})})}A.div`
  @media (max-width: 640px) {
...
`;function y5(){const n=[y.jsx(XC,{},"hero"),y.jsx(aD,{},"brand"),y.jsx(vD,{},"gallery"),y.jsx(g5,{children:"TU-EXPO Works"},"works-title"),y.jsx(BD,{},"works"),y.jsx(WD,{},"insta"),y.jsx(m5,{},"venue")];return y.jsx("div",{style:{background:"#121212",minHeight:"100vh"},children:n})}const x5="/",Hg="Pretendard, system-ui",v5=A.div`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  position: relative;
  border-radius: 8px;
...
`,_5=`${x5}guestbook-card.svg`,E5=A.div`
  width: 181px;
  height: 147px;
  position: absolute;
  left: 6px;
...
`;function A5({to:n,from:t,message:i}){return y.jsxs(v5,{$w:yo,$h:es,children:[y.jsx(E5,{}),y.jsxs(w5,{$w:yo,$h:es,children:[y.jsx(b5,{children:`To. ${n}`}),y.jsx(T5,{children:i}),y.jsx(S5,{children:`From. ${t}`})]})]})}const R5=A.div`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
  overflow: hidden;
...
`,I5=A.img`
  ...
  object-fit: cover;
  display: block;
`;function j5({src:n}){return y.jsx(R5,{$w:yo,$h:es,children:y.jsx(I5,{src:n,alt:"포토 카드"})})}const C5=A.button`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
...
`;function k5({onClick:n}){return y.jsxs(C5,{onClick:n,"aria-label":"방명록 작성",$w:yo,$h:es,children:[y.jsx(D5,{$w:yo,$h:es}),y.jsx(N5,{children:y.jsxs(M5,{children:[y.jsx(O5,{}),y.jsx(V5,{})]})})]})}const yo=270,es=337,P5=30,bw=20,U5=210,L5=60,Tw=173,Sw=216,z5=16,$5=16,Nm=16,B5=A.div`
  padding: 0 0 12px 0;
  @media (max-width: 640px) {
    display: none;
  }
...
`;function CN(){const[n,t]=St.useState(!1),[i,a]=St.useState([]);St.useEffect(()=>{let d=!0;return(async()=>{try{const m=s_(gh(Lp,"guest"),o_("time","desc")),p=await Cm(m);if(!d)return;const g=[];p.forEach(v=>{const w=v.data();g.push({id:v.id,to:w.to||"",from:w.from||"",message:w.message||"",type:"text"})}),a(g)}catch(m){console.error("Failed to load guestbook items:",m)}})(),()=>{d=!1}},[]);const o=async({to:d,from:m,message:p})=>{try{const g=String(Date.now());await Fg(Xl(gh(Lp,"guest"),g),{to:d||"",from:m||"",message:p||"",time:g});try{const v=s_(gh(Lp,"guest"),o_("time","desc")),w=await Cm(v),T=[];w.forEach(R=>{const M=R.data();T.push({id:R.id,to:M.to||"",from:M.from||"",message:M.message||"",type:"text"})}),a(T)}catch(v){console.error("Failed to reload guestbook items after submit:",v)}t(!1)}catch(g){console.error("Failed to submit guest message:",g)}};return y.jsxs(SN,{children:[y.jsxs(AN,{children:[y.jsx(RN,{children:"Guest Book"}),y.jsx(IN,{children:y.jsxs(jN,{className:"gb-wrap",children:[y.jsx("style",{children:`
  ...
  `}),y.jsx(J5,{onOpenModal:()=>t(!0),items:i})]})})]}),y.jsx(EN,{open:n,onClose:()=>t(!1),onSubmit:o})]})}const Mm="/",DN=A.div`
  display: flex;
  position: sticky;
  top: 80px;
  bottom: 0px;
...
`;function Om({titleKor:n,titleEng:t,context:i,isOpen:a=!0,onClose:o,src:u,docId:d,collection:m="works"}){const[p,g]=B.useState(0),[v,w]=B.useState(!1);B.useEffect(()=>{let M=!0;return(async()=>{if(d!=null)try{const L=Xl(Wl,m,String(d)),U=await xh(L);if(!M)return;if(U.exists()){const K=U.data();g(typeof K.like=="number"?K.like:0)}else g(0)}catch(L){console.error("Firestore getDoc error:",L),M&&g(0)}})(),()=>{M=!1}},[d,m]);const T=async()=>{try{const M=Xl(Wl,m,String(d)),L=await xh(M);if(L.exists()){const U=L.data();g(typeof U.like=="number"?U.like:0)}}catch(M){console.error("Firestore refresh error:",M)}},R=async()=>{if(v)return;if(d==null){console.warn("handleLike called without a valid docId");return}w(!0);const M=Xl(Wl,m,String(d));try{await kh(M,{like:Ph(1)}),g(L=>L+1),await T()}catch(L){if(L.code==="not-found"||/No document/i.test(String(L)))try{(await xh(M)).exists()?await kh(M,{like:Ph(1)}):await Fg(M,{like:1},{merge:!0}),await T()}catch(U){console.error("Firestore like fallback error:",U)}else console.error("Firestore like error:",L)}finally{w(!1)}};return y.jsx(DN,{$open:!!a,children:y.jsxs(NN,{children:[y.jsxs(MN,{children:[y.jsx(ON,{onClick:()=>{typeof o=="function"&&o()},children:y.jsx("img",{src:`${Mm}icons/closeIcon.svg`,alt:"Close Icon"})}),y.jsxs(VN,{children:[y.jsx(UN,{$src:u}),y.jsx(kN,{children:n}),y.jsx(PN,{children:i})]})]}),y.jsxs(LN,{children:[y.jsx(zN,{onClick:R,"aria-disabled":v,title:v?"처리 중":"좋아요",children:y.jsxs($N,{children:[y.jsx(BN,{$src:`${Mm}icons/likeIcon(white).svg`,"aria-label":"Like icon"}),y.jsx(FN,{children:{likeCount:p}})]})}),y.jsxs(qN,{onClick:()=>{const L=Math.max(document.documentElement?.scrollHeight||0,document.body?.scrollHeight||0)-window.innerHeight,K=Math.max(0,L-269);window.scrollTo({top:K,behavior:"smooth"})},children:[y.jsx(KN,{children:"Designer Info"}),y.jsx(HN,{})]})]})]})})}Om.propTypes={titleKor:Z.string.isRequired,titleEng:Z.string.isRequired,context:Z.string.isRequired,isOpen:Z.bool,onClose:Z.func,docId:Z.oneOfType([Z.string,Z.number]).isRequired,collection:Z.string};const GN=A.div`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  letter-spacing: 0.24px;
  color: #202020;
  text-decoration: none;
...
`;function Gg({nameKor:n,nameEng:t,part:i,sns:a,eMail:o,imgUrl:u,imgAlt:d}){return y.jsxs(GN,{children:[y.jsx(YN,{children:y.jsx(QN,{src:u,alt:d})}),y.jsxs(XN,{children:[y.jsxs(WN,{children:[y.jsx(ZN,{children:n}),y.jsx(JN,{children:t})]}),y.jsxs(t9,{children:[y.jsxs(e9,{children:[y.jsx(zp,{children:"Part"}),y.jsx(zp,{children:"SNS"}),y.jsx(zp,{children:"E-mail"})]}),y.jsxs(n9,{children:[y.jsx($p,{children:i}),y.jsx($p,{children:a}),y.jsx($p,{children:o})]})]})]})]})}Gg.propTypes={nameKor:Z.string.isRequired,nameEng:Z.string.isRequired,part:Z.string,sns:Z.string,eMail:Z.string,imgUrl:Z.string.isRequired,imgAlt:Z.string.isRequired};Gg.defaultProps={sns:"N/A",eMail:"N/A"};const i9=A.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  width: 775px;
...
`;function __({designers:n}){return y.jsxs(i9,{children:[y.jsx(a9,{children:"Designer"}),y.jsx(r9,{children:n.map((t,i)=>y.jsx(Gg,{nameKor:t.nameKor,nameEng:t.nameEng,part:t.role,sns:t.sns,eMail:t.eMail,imgUrl:t.imgUrl},i))})]})}const s9=A.div`
    width: 100%; // 임시값
    margin-top: 50px;
...
`,d9=A.div`
    ...
    width: 40px;
    height: 40px;
`;function f9({isOpen:n=!1,onClick:t}){const[i,a]=B.useState(!1);return B.useEffect(()=>{let o;return n?a(!1):(a(!1),o=setTimeout(()=>{a(!0)},500)),()=>clearTimeout(o)},[n]),y.jsx(h9,{$visible:!n,$active:i,onClick:()=>{typeof t=="function"&&t()},children:y.jsx(d9,{children:y.jsx("img",{src:`${c9}icons/infoOpenIcon.svg`,alt:"작품 정보 열기"})})})}function eh(n){if(!n)return n;const t="/";if(/^https?:\/\//i.test(n))return n;const i=String(n).replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const p9=A.img`
  width: 100%;
  /* max-width: 1800px; */
  /* padding: 0px 100px; */
  /* padding-right: 100px; */
...
`,Bp=n=>y.jsx(p9,{loading:"lazy",...n}),m9=A.div`
  display: flex;
  position: relative;
  background: #fff;
  width: 100%;
...
`,x9=A.div`
  ...
  height: auto;
  /* max-width: 1800px; */
`,v9={A:"c0",E:"c1",H:"c2",I:"c3",L:"c4",M:"c5"};function _9(){const{pid:n}=VT(),t=(n||"").toUpperCase().match(/^([A-Z])(\d{3})$/),[i,a]=B.useState(!0),[o,u]=B.useState(!0),d=()=>{a(!1),setTimeout(()=>{u(!1)},500)},m=()=>{u(!0),setTimeout(()=>{a(!0)},0)};let p=null;if(t){const[,K,X]=t,tt=v9[K]||null,lt=Math.max(0,parseInt(X,10)-1);p=eu.find(Y=>Y.projectNum===lt&&(!tt||Y.category===tt)),p||(p=eu.find(Y=>Y.projectNum==lt))}if(!p)return y.jsx(E_,{children:y.jsxs(PageContainer,{children:[y.jsx(Om,{titleKor:"작품 제목(한글)",titleEng:"Work Title (English)",context:"이곳은 작품 설명이 들어가는 영역입니다. 작품에 대한 상세한 설명이나 배경, 제작 과정 등을 기술할 수 있습니다. 이 텍스트는 예시로 작성된 내용이며, 실제 작품 설명으로 대체되어야 합니다.",isOpen:i,onClose:()=>a(!1),docId:0}),y.jsx(Bp,{src:"https://placehold.co/1530x4000",alt:"featured"}),y.jsx(__,{children:"  "})]})});const g=(p.members||[]).map(K=>{const X=eg.find(tt=>tt.num===K);return X?{nameKor:X.nameKor,nameEng:X.nameEng,role:X.role||"Designer",sns:X.sns||"-",eMail:X.eMail||"",imgUrl:eh(X.imgUrl||"/김예준.jpg")}:null}).filter(Boolean),w={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"}[p.category]||"A",T=p.projectNum??p.num,R=String(T).padStart(3,"0"),M=`/projects/${T}`,[L,U]=B.useState([]);return B.useEffect(()=>{let K=!1;const X=["jpg"],tt=30,lt=2,Y=j=>!j||!j.ok?!1:(j.headers.get("content-type")||"").startsWith("image/"),ot=async j=>{try{const I=await fetch(j,{method:"GET",cache:"no-store"});return Y(I)}catch{return!1}};return(async()=>{const j=[];let I=0;for(let C=0;C<tt;C++){let O=!1;for(const k of X){const z=eh(`${M}/gallery/${C}.${k}`);if(await ot(z)){j.push(z),O=!0,I=0;break}}if(!O&&(j.length===0||(I+=1,I>=lt)))break}K||U(j)})(),()=>{K=!0}},[M]),B.useEffect(()=>{const K=p?.projectNum??p?.num;if(K==null)return;const tt=Xl(Wl,"works",String(K));(async()=>{try{await kh(tt,{view:Ph(1)})}catch(lt){if(lt.code==="not-found"||/No document/i.test(String(lt)))try{(await xh(tt)).exists()?await kh(tt,{view:Ph(1)}):await Fg(tt,{view:1},{merge:!0})}catch(Y){console.error("Firestore view fallback error:",Y)}else console.error("Firestore view error:",lt)}})()},[p?.projectNum,p?.num]),y.jsx(E_,{children:y.jsxs(m9,{children:[y.jsx(f9,{isOpen:i,onClick:m}),y.jsx(y9,{$visible:o,children:y.jsx(Om,{titleKor:p.titleKor,titleEng:p.titleEng,context:p.description||"null",isOpen:i,onClose:d,src:eh(`/projects/${T}/thumb.jpg`),docId:T})}),y.jsxs(g9,{$isInfoOpen:i,children:[L.length>0?L.map((K,X)=>y.jsx(Bp,{src:K,alt:`project-${w}${R}-img-${X+1}`},X)):y.jsx(Bp,{src:eh("/thumbnailExample.png"),alt:`project-${w}${R}-placeholder`}),y.jsx(u9,{videoId:p.videoId,isInfoOpen:i}),y.jsx(x9,{children:y.jsx(__,{designers:g})})]})]})})}const w_="/",E9=k4`
...
`,b9=A.div`
    animation: ${({$visible:n,$floatDur:t})=>n?Ym`${E9} ${t??1800}ms ease-in-out infinite alternate`:"none"};
...
`,b_=A.div`
    ...
    background-repeat: no-repeat;
    background-position: center;
`;function T9({visible:n=!0,fadeMs:t=800,floatDur:i=1800,amp:a=6}={}){return y.jsxs(w9,{$visible:n,$fadeMs:t,"aria-hidden":!n,children:[y.jsx(b_,{src:`${w_}icons/showIndicatorMouse.svg`}),y.jsx(b9,{$visible:n,$floatDur:i,style:{"--amp":`${a}px`},children:y.jsx(b_,{src:`${w_}icons/showIndicatorDown.svg`})})]})}const Fp=A.div`
    z-index: 5;
    display: flex;
    position: absolute;
    flex-direction: row;
...
`,A9=A.p`
    ...
    text-align: justify;
    margin: 0;
`;function qp({children:n,textWidth:t,textHeight:i,shown:a,tDur:o,tDelay:u,ease:d}){return y.jsx(S9,{$textWidth:t,$textHeight:i,$shown:a,$tDur:o,$tDelay:u,$ease:d,children:y.jsx(A9,{children:n})})}function R9({top:n,left:t,right:i="auto",bottom:a,lineWidth:o,textWidth:u,textHeight:d,children:m,position:p="left",isActive:g,section:v,currentSection:w,anim:T}){const[R,M]=B.useState(!1),L=T?.circle?.easing||T?.line?.easing||T?.text?.easing||"cubic-bezier(0.22,1,0.36,1)",U=T?.circle?.duration??250,K=T?.circle?.delay??120,X=T?.line?.duration??500,tt=K+U+(T?.line?.delay??120),lt=T?.text?.duration??280,Y=tt+X+(T?.text?.delay??80),j=g||R&&w===v;if(B.useEffect(()=>{g&&!R&&M(!0)},[g,R]),p==="right")return y.jsxs(Fp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsx(qp,{textWidth:u,textHeight:d,shown:j,tDur:lt,tDelay:Y,ease:L,children:m}),y.jsxs(R_,{children:[y.jsx(A_,{$lineWidth:o,$shown:j,$lDur:X,$lDelay:tt,$ease:L}),y.jsx(T_,{$shown:j,$cDur:U,$cDelay:K,$ease:L,children:y.jsx(S_,{$shown:j,$cDur:U,$cDelay:K,$ease:L})})]})]});if(p==="left")return y.jsxs(Fp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsxs(R_,{children:[y.jsx(T_,{$shown:j,$cDur:U,$cDelay:K,$ease:L,children:y.jsx(S_,{$shown:j,$cDur:U,$cDelay:K,$ease:L})}),y.jsx(A_,{$lineWidth:o,$shown:j,$lDur:X,$lDelay:tt,$ease:L})]}),y.jsx(qp,{textWidth:u,textHeight:d,shown:j,tDur:lt,tDelay:Y,ease:L,children:m})]});if(p==="no-line")return y.jsx(Fp,{$top:n,$left:t,$right:i,$bottom:a,children:y.jsx(qp,{textWidth:u,textHeight:d,shown:j,tDur:lt,tDelay:Y,ease:L,children:m})})}const Kp="/",I9=A.div`
    display: flex;
    position: relative;
    margin-top: 80px;
    width: 100vw;
...
`+N[l].replace(" at new "," at ");return e.displayName&&et.includes("<anonymous>")&&(et=et.replace("<anonymous>",e.displayName)),et}while(1<=l&&0<=h);break}}}finally{ds=!1,Error.prepareStackTrace=s}return(s=e?e.displayName||e.name:"")?Pi(s):""}function gd(e){switch(e.tag){case 26:case 27:case 5:return Pi(e.type);case 16:return Pi("Lazy");case 13:return Pi("Suspense");case 19:return Pi("SuspenseList");case 0:case 15:return fs(e.type,!1);case 11:return fs(e.type.render,!1);case 1:return fs(e.type,!0);case 31:return Pi("Activity");default:return""}}function Qn(e){try{var r="";do r+=gd(e),e=e.return;while(e);return r}catch(s){return`
Error generating stack: `+s.message+`
`+s.stack}}function fe(e){switch(typeof e){case"bigint":case"boolean":case"number":case"string":case"undefined":return e;case"object":return e;default:return""}}function Er(e){var r=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(r==="checkbox"||r==="radio")}function va(e){var r=Er(e)?"checked":"value",s=Object.getOwnPropertyDescriptor(e.constructor.prototype,r),l=""+e[r];if(!e.hasOwnProperty(r)&&typeof s<"u"&&typeof s.get=="function"&&typeof s.set=="function"){var h=s.get,f=s.set;return Object.defineProperty(e,r,{configurable:!0,get:function(){return h.call(this)},set:function(E){l=""+E,f.call(this,E)}}),Object.defineProperty(e,r,{enumerable:s.enumerable}),{getValue:function(){return l},setValue:function(E){l=""+E},stopTracking:function(){e._valueTracker=null,delete e[r]}}}}function wr(e){e._valueTracker||(e._valueTracker=va(e))}function Zt(e){if(!e)return!1;var r=e._valueTracker;if(!r)return!0;var s=r.getValue(),l="";return e&&(l=Er(e)?e.checked?"true":"false":e.value),e=l,e!==s?(r.setValue(e),!0):!1}function Ui(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}var _a=/[\n"\\]/g;function ze(e){return e.replace(_a,function(r){return"\\"+r.charCodeAt(0).toString(16)+" "})}function Oo(e,r,s,l,h,f,E,b){e.name="",E!=null&&typeof E!="function"&&typeof E!="symbol"&&typeof E!="boolean"?e.type=E:e.removeAttribute("type"),r!=null?E==="number"?(r===0&&e.value===""||e.value!=r)&&(e.value=""+fe(r)):e.value!==""+fe(r)&&(e.value=""+fe(r)):E!=="submit"&&E!=="reset"||e.removeAttribute("value"),r!=null?ko(e,E,fe(r)):s!=null?ko(e,E,fe(s)):l!=null&&e.removeAttribute("value"),h==null&&f!=null&&(e.defaultChecked=!!f),h!=null&&(e.checked=h&&typeof h!="function"&&typeof h!="symbol"),b!=null&&typeof b!="function"&&typeof b!="symbol"&&typeof b!="boolean"?e.name=""+fe(b):e.removeAttribute("name")}function Vo(e,r,s,l,h,f,E,b){if(f!=null&&typeof f!="function"&&typeof f!="symbol"&&typeof f!="boolean"&&(e.type=f),r!=null||s!=null){if(!(f!=="submit"&&f!=="reset"||r!=null))return;s=s!=null?""+fe(s):"",r=r!=null?""+fe(r):s,b||r===e.value||(e.value=r),e.defaultValue=r}l=l??h,l=typeof l!="function"&&typeof l!="symbol"&&!!l,e.checked=b?e.checked:!!l,e.defaultChecked=!!l,E!=null&&typeof E!="function"&&typeof E!="symbol"&&typeof E!="boolean"&&(e.name=E)}function ko(e,r,s){r==="number"&&Ui(e.ownerDocument)===e||e.defaultValue===""+s||(e.defaultValue=""+s)}function br(e,r,s,l){if(e=e.options,r){r={};for(var h=0;h<s.length;h++)r["$"+s[h]]=!0;for(s=0;s<e.length;s++)h=r.hasOwnProperty("$"+e[s].value),e[s].selected!==h&&(e[s].selected=h),h&&l&&(e[s].defaultSelected=!0)}else{for(s=""+fe(s),r=null,h=0;h<e.length;h++){if(e[h].value===s){e[h].selected=!0,l&&(e[h].defaultSelected=!0);return}r!==null||e[h].disabled||(r=e[h])}r!==null&&(r.selected=!0)}}function ju(e,r,s){if(r!=null&&(r=""+fe(r),r!==e.value&&(e.value=r),s==null)){e.defaultValue!==r&&(e.defaultValue=r);return}e.defaultValue=s!=null?""+fe(s):""}function Cu(e,r,s,l){if(r==null){if(l!=null){if(s!=null)throw Error(a(92));if(qt(l)){if(1<l.length)throw Error(a(93));l=l[0]}s=l}s==null&&(s=""),r=s}s=fe(r),e.defaultValue=s,l=e.textContent,l===s&&l!==""&&l!==null&&(e.value=l)}function On(e,r){if(r){var s=e.firstChild;if(s&&s===e.lastChild&&s.nodeType===3){s.nodeValue=r;return}}e.textContent=r}var Li=new Set("animationIterationCount aspectRatio borderImageOutset borderImageSlice borderImageWidth boxFlex boxFlexGroup boxOrdinalGroup columnCount columns flex flexGrow flexPositive flexShrink flexNegative flexOrder gridArea gridRow gridRowEnd gridRowSpan gridRowStart gridColumn gridColumnEnd gridColumnSpan gridColumnStart fontWeight lineClamp lineHeight opacity order orphans scale tabSize widows zIndex zoom fillOpacity floodOpacity stopOpacity strokeDasharray strokeDashoffset strokeMiterlimit strokeOpacity strokeWidth MozAnimationIterationCount MozBoxFlex MozBoxFlexGroup MozLineClamp msAnimationIterationCount msFlex msZoom msFlexGrow msFlexNegative msFlexOrder msFlexPositive msFlexShrink msGridColumn msGridColumnSpan msGridRow msGridRowSpan WebkitAnimationIterationCount WebkitBoxFlex WebKitBoxFlexGroup WebkitBoxOrdinalGroup WebkitColumnCount WebkitColumns WebkitFlex WebkitFlexGrow WebkitFlexPositive WebkitFlexShrink WebkitLineClamp".split(" "));function Po(e,r,s){var l=r.indexOf("--")===0;s==null||typeof s=="boolean"||s===""?l?e.setProperty(r,""):r==="float"?e.cssFloat="":e[r]="":l?e.setProperty(r,s):typeof s!="number"||s===0||Li.has(r)?r==="float"?e.cssFloat=s:e[r]=(""+s).trim():e[r]=s+"px"}function Uo(e,r,s){if(r!=null&&typeof r!="object")throw Error(a(62));if(e=e.style,s!=null){for(var l in s)!s.hasOwnProperty(l)||r!=null&&r.hasOwnProperty(l)||(l.indexOf("--")===0?e.setProperty(l,""):l==="float"?e.cssFloat="":e[l]="");for(var h in r)l=r[h],r.hasOwnProperty(h)&&s[h]!==l&&Po(e,h,l)}else for(var f in r)r.hasOwnProperty(f)&&Po(e,f,r[f])}function ps(e){if(e.indexOf("-")===-1)return!1;switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var Du=new Map([["acceptCharset","accept-charset"],["htmlFor","for"],["httpEquiv","http-equiv"],["crossOrigin","crossorigin"],["accentHeight","accent-height"],["alignmentBaseline","alignment-baseline"],["arabicForm","arabic-form"],["baselineShift","baseline-shift"],["capHeight","cap-height"],["clipPath","clip-path"],["clipRule","clip-rule"],["colorInterpolation","color-interpolation"],["colorInterpolationFilters","color-interpolation-filters"],["colorProfile","color-profile"],["colorRendering","color-rendering"],["dominantBaseline","dominant-baseline"],["enableBackground","enable-background"],["fillOpacity","fill-opacity"],["fillRule","fill-rule"],["floodColor","flood-color"],["floodOpacity","flood-opacity"],["fontFamily","font-family"],["fontSize","font-size"],["fontSizeAdjust","font-size-adjust"],["fontStretch","font-stretch"],["fontStyle","font-style"],["fontVariant","font-variant"],["fontWeight","font-weight"],["glyphName","glyph-name"],["glyphOrientationHorizontal","glyph-orientation-horizontal"],["glyphOrientationVertical","glyph-orientation-vertical"],["horizAdvX","horiz-adv-x"],["horizOriginX","horiz-origin-x"],["imageRendering","image-rendering"],["letterSpacing","letter-spacing"],["lightingColor","lighting-color"],["markerEnd","marker-end"],["markerMid","marker-mid"],["markerStart","marker-start"],["overlinePosition","overline-position"],["overlineThickness","overline-thickness"],["paintOrder","paint-order"],["panose-1","panose-1"],["pointerEvents","pointer-events"],["renderingIntent","rendering-intent"],["shapeRendering","shape-rendering"],["stopColor","stop-color"],["stopOpacity","stop-opacity"],["strikethroughPosition","strikethrough-position"],["strikethroughThickness","strikethrough-thickness"],["strokeDasharray","stroke-dasharray"],["strokeDashoffset","stroke-dashoffset"],["strokeLinecap","stroke-linecap"],["strokeLinejoin","stroke-linejoin"],["strokeMiterlimit","stroke-miterlimit"],["strokeOpacity","stroke-opacity"],["strokeWidth","stroke-width"],["textAnchor","text-anchor"],["textDecoration","text-decoration"],["textRendering","text-rendering"],["transformOrigin","transform-origin"],["underlinePosition","underline-position"],["underlineThickness","underline-thickness"],["unicodeBidi","unicode-bidi"],["unicodeRange","unicode-range"],["unitsPerEm","units-per-em"],["vAlphabetic","v-alphabetic"],["vHanging","v-hanging"],["vIdeographic","v-ideographic"],["vMathematical","v-mathematical"],["vectorEffect","vector-effect"],["vertAdvY","vert-adv-y"],["vertOriginX","vert-origin-x"],["vertOriginY","vert-origin-y"],["wordSpacing","word-spacing"],["writingMode","writing-mode"],["xmlnsXlink","xmlns:xlink"],["xHeight","x-height"]]),Nu=/^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*:/i;function Xn(e){return Nu.test(""+e)?"javascript:throw new Error('React has blocked a javascript: URL as a security precaution.')":e}var Lo=null;function zo(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var Tr=null,un=null;function Mu(e){var r=ci(e);if(r&&(e=r.stateNode)){var s=e[He]||null;t:switch(e=r.stateNode,r.type){case"input":if(Oo(e,s.value,s.defaultValue,s.defaultValue,s.checked,s.defaultChecked,s.type,s.name),r=s.name,s.type==="radio"&&r!=null){for(s=e;s.parentNode;)s=s.parentNode;for(s=s.querySelectorAll('input[name="'+ze(""+r)+'"][type="radio"]'),r=0;r<s.length;r++){var l=s[r];if(l!==e&&l.form===e.form){var h=l[He]||null;if(!h)throw Error(a(90));Oo(l,h.value,h.defaultValue,h.defaultValue,h.checked,h.defaultChecked,h.type,h.name)}}for(r=0;r<s.length;r++)l=s[r],l.form===e.form&&Zt(l)}break t;case"textarea":ju(e,s.value,s.defaultValue);break t;case"select":r=s.value,r!=null&&br(e,!!s.multiple,r,!1)}}}var Ea=!1;function wa(e,r,s){if(Ea)return e(r,s);Ea=!0;try{var l=e(r);return l}finally{if(Ea=!1,(Tr!==null||un!==null)&&(wc(),Tr&&(r=Tr,e=un,un=Tr=null,Mu(r),e)))for(r=0;r<e.length;r++)Mu(e[r])}}function Sr(e,r){var s=e.stateNode;if(s===null)return null;var l=s[He]||null;if(l===null)return null;s=l[r];t:switch(r){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(l=!l.disabled)||(e=e.type,l=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!l;break t;default:e=!1}if(e)return null;if(s&&typeof s!="function")throw Error(a(231,r,typeof s));return s}var cn=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),zi=!1;if(cn)try{var Ar={};Object.defineProperty(Ar,"passive",{get:function(){zi=!0}}),window.addEventListener("test",Ar,Ar),window.removeEventListener("test",Ar,Ar)}catch{zi=!1}var Vn=null,ie=null,ms=null;function Ou(){if(ms)return ms;var e,r=ie,s=r.length,l,h="value"in Vn?Vn.value:Vn.textContent,f=h.length;for(e=0;e<s&&r[e]===h[e];e++);var E=s-e;for(l=1;l<=E&&r[s-l]===h[f-l];l++);return ms=h.slice(e,1<l?1-l:void 0)}function ba(e){var r=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&r===13&&(e=13)):e=r,e===10&&(e=13),32<=e||e===13?e:0}function Ta(){return!0}function $o(){return!1}function Ve(e){function r(s,l,h,f,E){this._reactName=s,this._targetInst=h,this.type=l,this.nativeEvent=f,this.target=E,this.currentTarget=null;for(var b in e)e.hasOwnProperty(b)&&(s=e[b],this[b]=s?s(f):f[b]);return this.isDefaultPrevented=(f.defaultPrevented!=null?f.defaultPrevented:f.returnValue===!1)?Ta:$o,this.isPropagationStopped=$o,this}return v(r.prototype,{preventDefault:function(){this.defaultPrevented=!0;var s=this.nativeEvent;s&&(s.preventDefault?s.preventDefault():typeof s.returnValue!="unknown"&&(s.returnValue=!1),this.isDefaultPrevented=Ta)},stopPropagation:function(){var s=this.nativeEvent;s&&(s.stopPropagation?s.stopPropagation():typeof s.cancelBubble!="unknown"&&(s.cancelBubble=!0),this.isPropagationStopped=Ta)},persist:function(){},isPersistent:Ta}),r}var tn={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Sa=Ve(tn),Aa=v({},tn,{view:0,detail:0}),Ra=Ve(Aa),gs,Ia,pi,ja=v({},Aa,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:vs,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==pi&&(pi&&e.type==="mousemove"?(gs=e.screenX-pi.screenX,Ia=e.screenY-pi.screenY):Ia=gs=0,pi=e),gs)},movementY:function(e){return"movementY"in e?e.movementY:Ia}}),Ca=Ve(ja),yd=v({},ja,{dataTransfer:0}),Vu=Ve(yd),Da=v({},Aa,{relatedTarget:0}),ys=Ve(Da),ku=v({},tn,{animationName:0,elapsedTime:0,pseudoElement:0}),Bo=Ve(ku),Fo=v({},tn,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),Pu=Ve(Fo),xs=v({},tn,{data:0}),qo=Ve(xs),Uu={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},$i={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},Lu={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function zu(e){var r=this.nativeEvent;return r.getModifierState?r.getModifierState(e):(e=Lu[e])?!!r[e]:!1}function vs(){return zu}var $u=v({},Aa,{key:function(e){if(e.key){var r=Uu[e.key]||e.key;if(r!=="Unidentified")return r}return e.type==="keypress"?(e=ba(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?$i[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:vs,charCode:function(e){return e.type==="keypress"?ba(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?ba(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),_s=Ve($u),hn=v({},ja,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),Ko=Ve(hn),Bu=v({},Aa,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:vs}),Rr=Ve(Bu),c=v({},tn,{propertyName:0,elapsedTime:0,pseudoElement:0}),x=Ve(c),_=v({},ja,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),S=Ve(_),q=v({},tn,{newState:0,oldState:0}),W=Ve(q),ut=[9,13,27,32],Rt=cn&&"CompositionEvent"in window,oe=null;cn&&"documentMode"in document&&(oe=document.documentMode);var Qt=cn&&"TextEvent"in window&&!oe,we=cn&&(!Rt||oe&&8<oe&&11>=oe),En=" ",mi=!1;function Wn(e,r){switch(e){case"keyup":return ut.indexOf(r.keyCode)!==-1;case"keydown":return r.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function Zn(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var Jn=!1;function Ho(e,r){switch(e){case"compositionend":return Zn(r);case"keypress":return r.which!==32?null:(mi=!0,En);case"textInput":return e=r.data,e===En&&mi?null:e;default:return null}}function Rw(e,r){if(Jn)return e==="compositionend"||!Rt&&Wn(e,r)?(e=Ou(),ms=ie=Vn=null,Jn=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(r.ctrlKey||r.altKey||r.metaKey)||r.ctrlKey&&r.altKey){if(r.char&&1<r.char.length)return r.char;if(r.which)return String.fromCharCode(r.which)}return null;case"compositionend":return we&&r.locale!=="ko"?null:r.data;default:return null}}var Iw={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Yg(e){var r=e&&e.nodeName&&e.nodeName.toLowerCase();return r==="input"?!!Iw[e.type]:r==="textarea"}function Qg(e,r,s,l){Tr?un?un.push(l):un=[l]:Tr=l,r=Ic(r,"onChange"),0<r.length&&(s=new Sa("onChange","change",null,s,l),e.push({event:s,listeners:r}))}var Go=null,Yo=null;function jw(e){j1(e,0)}function Fu(e){var r=vr(e);if(Zt(r))return e}function Xg(e,r){if(e==="change")return r}var Wg=!1;if(cn){var xd;if(cn){var vd="oninput"in document;if(!vd){var Zg=document.createElement("div");Zg.setAttribute("oninput","return;"),vd=typeof Zg.oninput=="function"}xd=vd}else xd=!1;Wg=xd&&(!document.documentMode||9<document.documentMode)}function Jg(){Go&&(Go.detachEvent("onpropertychange",t0),Yo=Go=null)}function t0(e){if(e.propertyName==="value"&&Fu(Yo)){var r=[];Qg(r,Yo,e,zo(e)),wa(jw,r)}}function Cw(e,r,s){e==="focusin"?(Jg(),Go=r,Yo=s,Go.attachEvent("onpropertychange",t0)):e==="focusout"&&Jg()}function Dw(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return Fu(Yo)}function Nw(e,r){if(e==="click")return Fu(r)}function Mw(e,r){if(e==="input"||e==="change")return Fu(r)}function Ow(e,r){return e===r&&(e!==0||1/e===1/r)||e!==e&&r!==r}var wn=typeof Object.is=="function"?Object.is:Ow;function Qo(e,r){if(wn(e,r))return!0;if(typeof e!="object"||e===null||typeof r!="object"||r===null)return!1;var s=Object.keys(e),l=Object.keys(r);if(s.length!==l.length)return!1;for(l=0;l<s.length;l++){var h=s[l];if(!on.call(r,h)||!wn(e[h],r[h]))return!1}return!0}function e0(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function n0(e,r){var s=e0(e);e=0;for(var l;s;){if(s.nodeType===3){if(l=e+s.textContent.length,e<=r&&l>=r)return{node:s,offset:r-e};e=l}t:{for(;s;){if(s.nextSibling){s=s.nextSibling;break t}s=s.parentNode}s=void 0}s=e0(s)}}function i0(e,r){return e&&r?e===r?!0:e&&e.nodeType===3?!1:r&&r.nodeType===3?i0(e,r.parentNode):"contains"in e?e.contains(r):e.compareDocumentPosition?!!(e.compareDocumentPosition(r)&16):!1:!1}function r0(e){e=e!=null&&e.ownerDocument!=null&&e.ownerDocument.defaultView!=null?e.ownerDocument.defaultView:window;for(var r=Ui(e.document);r instanceof e.HTMLIFrameElement;){try{var s=typeof r.contentWindow.location.href=="string"}catch{s=!1}if(s)e=r.contentWindow;else break;r=Ui(e.document)}return r}function _d(e){var r=e&&e.nodeName&&e.nodeName.toLowerCase();return r&&(r==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||r==="textarea"||e.contentEditable==="true")}var Vw=cn&&"documentMode"in document&&11>=document.documentMode,Es=null,Ed=null,Xo=null,wd=!1;function a0(e,r,s){var l=s.window===s?s.document:s.nodeType===9?s:s.ownerDocument;wd||Es==null||Es!==Ui(l)||(l=Es,"selectionStart"in l&&_d(l)?l={start:l.selectionStart,end:l.selectionEnd}:(l=(l.ownerDocument&&l.ownerDocument.defaultView||window).getSelection(),l={anchorNode:l.anchorNode,anchorOffset:l.anchorOffset,focusNode:l.focusNode,focusOffset:l.focusOffset}),Xo&&Qo(Xo,l)||(Xo=l,l=Ic(Ed,"onSelect"),0<l.length&&(r=new Sa("onSelect","select",null,r,s),e.push({event:r,listeners:l}),r.target=Es)))}function Na(e,r){var s={};return s[e.toLowerCase()]=r.toLowerCase(),s["Webkit"+e]="webkit"+r,s["Moz"+e]="moz"+r,s}var ws={animationend:Na("Animation","AnimationEnd"),animationiteration:Na("Animation","AnimationIteration"),animationstart:Na("Animation","AnimationStart"),transitionrun:Na("Transition","TransitionRun"),transitionstart:Na("Transition","TransitionStart"),transitioncancel:Na("Transition","TransitionCancel"),transitionend:Na("Transition","TransitionEnd")},bd={},s0={};cn&&(s0=document.createElement("div").style,"AnimationEvent"in window||(delete ws.animationend.animation,delete ws.animationiteration.animation,delete ws.animationstart.animation),"TransitionEvent"in window||delete ws.transitionend.transition);function Ma(e){if(bd[e])return bd[e];if(!ws[e])return e;var r=ws[e],s;for(s in r)if(r.hasOwnProperty(s)&&s in s0)return bd[e]=r[s];return e}var o0=Ma("animationend"),l0=Ma("animationiteration"),u0=Ma("animationstart"),kw=Ma("transitionrun"),Pw=Ma("transitionstart"),Uw=Ma("transitioncancel"),c0=Ma("transitionend"),h0=new Map,Td="abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");Td.push("scrollEnd");function ti(e,r){h0.set(e,r),hi(r,[e])}var d0=new WeakMap;function kn(e,r){if(typeof e=="object"&&e!==null){var s=d0.get(e);return s!==void 0?s:(r={value:e,source:r,stack:Qn(r)},d0.set(e,r),r)}return{value:e,source:r,stack:Qn(r)}}var Pn=[],bs=0,Sd=0;function qu(){for(var e=bs,r=Sd=bs=0;r<e;){var s=Pn[r];Pn[r++]=null;var l=Pn[r];Pn[r++]=null;var h=Pn[r];Pn[r++]=null;var f=Pn[r];if(Pn[r++]=null,l!==null&&h!==null){var E=l.pending;E===null?h.next=h:(h.next=E.next,E.next=h),l.pending=h}f!==0&&f0(s,h,f)}}function Ku(e,r,s,l){Pn[bs++]=e,Pn[bs++]=r,Pn[bs++]=s,Pn[bs++]=l,Sd|=l,e.lanes|=l,e=e.alternate,e!==null&&(e.lanes|=l)}function Ad(e,r,s,l){return Ku(e,r,s,l),Hu(e)}function Ts(e,r){return Ku(e,null,null,r),Hu(e)}function f0(e,r,s){e.lanes|=s;var l=e.alternate;l!==null&&(l.lanes|=s);for(var h=!1,f=e.return;f!==null;)f.childLanes|=s,l=f.alternate,l!==null&&(l.childLanes|=s),f.tag===22&&(e=f.stateNode,e===null||e._visibility&1||(h=!0)),e=f,f=f.return;return e.tag===3?(f=e.stateNode,h&&r!==null&&(h=31-ln(s),e=f.hiddenUpdates,l=e[h],l===null?e[h]=[r]:l.push(r),r.lane=s|536870912),f):null}function Hu(e){if(50<El)throw El=0,Mf=null,Error(a(185));for(var r=e.return;r!==null;)e=r,r=e.return;return e.tag===3?e.stateNode:null}var Ss={};function Lw(e,r,s,l){this.tag=e,this.key=s,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.refCleanup=this.ref=null,this.pendingProps=r,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=l,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function bn(e,r,s,l){return new Lw(e,r,s,l)}function Rd(e){return e=e.prototype,!(!e||!e.isReactComponent)}function Bi(e,r){var s=e.alternate;return s===null?(s=bn(e.tag,r,e.key,e.mode),s.elementType=e.elementType,s.type=e.type,s.stateNode=e.stateNode,s.alternate=e,e.alternate=s):(s.pendingProps=r,s.type=e.type,s.flags=0,s.subtreeFlags=0,s.deletions=null),s.flags=e.flags&65011712,s.childLanes=e.childLanes,s.lanes=e.lanes,s.child=e.child,s.memoizedProps=e.memoizedProps,s.memoizedState=e.memoizedState,s.updateQueue=e.updateQueue,r=e.dependencies,s.dependencies=r===null?null:{lanes:r.lanes,firstContext:r.firstContext},s.sibling=e.sibling,s.index=e.index,s.ref=e.ref,s.refCleanup=e.refCleanup,s}function p0(e,r){e.flags&=65011714;var s=e.alternate;return s===null?(e.childLanes=0,e.lanes=r,e.child=null,e.subtreeFlags=0,e.memoizedProps=null,e.memoizedState=null,e.updateQueue=null,e.dependencies=null,e.stateNode=null):(e.childLanes=s.childLanes,e.lanes=s.lanes,e.child=s.child,e.subtreeFlags=0,e.deletions=null,e.memoizedProps=s.memoizedProps,e.memoizedState=s.memoizedState,e.updateQueue=s.updateQueue,e.type=s.type,r=s.dependencies,e.dependencies=r===null?null:{lanes:r.lanes,firstContext:r.firstContext}),e}function Gu(e,r,s,l,h,f){var E=0;if(l=e,typeof e=="function")Rd(e)&&(E=1);else if(typeof e=="string")E=$b(e,s,gt.current)?26:e==="html"||e==="head"||e==="body"?27:5;else t:switch(e){case C:return e=bn(31,s,r,h),e.elementType=C,e.lanes=f,e;case M:return Oa(s.children,h,f,r);case L:E=8,h|=24;break;case U:return e=bn(12,s,r,h|2),e.elementType=U,e.lanes=f,e;case Y:return e=bn(13,s,r,h),e.elementType=Y,e.lanes=f,e;case ot:return e=bn(19,s,r,h),e.elementType=ot,e.lanes=f,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case K:case tt:E=10;break t;case X:E=9;break t;case lt:E=11;break t;case j:E=14;break t;case I:E=16,l=null;break t}E=29,s=Error(a(130,e===null?"null":typeof e,"")),l=null}return r=bn(E,s,r,h),r.elementType=e,r.type=l,r.lanes=f,r}function Oa(e,r,s,l){return e=bn(7,e,l,r),e.lanes=s,e}function Id(e,r,s){return e=bn(6,e,null,r),e.lanes=s,e}function jd(e,r,s){return r=bn(4,e.children!==null?e.children:[],e.key,r),r.lanes=s,r.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},r}var As=[],Rs=0,Yu=null,Qu=0,Un=[],Ln=0,Va=null,Fi=1,qi="";function ka(e,r){As[Rs++]=Qu,As[Rs++]=Yu,Yu=e,Qu=r}function m0(e,r,s){Un[Ln++]=Fi,Un[Ln++]=qi,Un[Ln++]=Va,Va=e;var l=Fi;e=qi;var h=32-ln(l)-1;l&=~(1<<h),s+=1;var f=32-ln(r)+h;if(30<f){var E=h-h%5;f=(l&(1<<E)-1).toString(32),l>>=E,h-=E,Fi=1<<32-ln(r)+h|s<<h|l,qi=f+e}else Fi=1<<f|s<<h|l,qi=e}function Cd(e){e.return!==null&&(ka(e,1),m0(e,1,0))}function Dd(e){for(;e===Yu;)Yu=As[--Rs],As[Rs]=null,Qu=As[--Rs],As[Rs]=null;for(;e===Va;)Va=Un[--Ln],Un[Ln]=null,qi=Un[--Ln],Un[Ln]=null,Fi=Un[--Ln],Un[Ln]=null}var dn=null,ye=null,Kt=!1,Pa=null,gi=!1,Nd=Error(a(519));function Ua(e){var r=Error(a(418,""));throw Jo(kn(r,e)),Nd}function g0(e){var r=e.stateNode,s=e.type,l=e.memoizedProps;switch(r[_e]=e,r[He]=l,s){case"dialog":kt("cancel",r),kt("close",r);break;case"iframe":case"object":case"embed":kt("load",r);break;case"video":case"audio":for(s=0;s<bl.length;s++)kt(bl[s],r);break;case"source":kt("error",r);break;case"img":case"image":case"link":kt("error",r),kt("load",r);break;case"details":kt("toggle",r);break;case"input":kt("invalid",r),Vo(r,l.value,l.defaultValue,l.checked,l.defaultChecked,l.type,l.name,!0),wr(r);break;case"select":kt("invalid",r);break;case"textarea":kt("invalid",r),Cu(r,l.value,l.defaultValue,l.children),wr(r)}s=l.children,typeof s!="string"&&typeof s!="number"&&typeof s!="bigint"||r.textContent===""+s||l.suppressHydrationWarning===!0||M1(r.textContent,s)?(l.popover!=null&&(kt("beforetoggle",r),kt("toggle",r)),l.onScroll!=null&&kt("scroll",r),l.onScrollEnd!=null&&kt("scrollend",r),l.onClick!=null&&(r.onclick=jc),r=!0):r=!1,r||Ua(e)}function y0(e){for(dn=e.return;dn;)switch(dn.tag){case 5:case 13:gi=!1;return;case 27:case 3:gi=!0;return;default:dn=dn.return}}function Wo(e){if(e!==dn)return!1;if(!Kt)return y0(e),Kt=!0,!1;var r=e.tag,s;if((s=r!==3&&r!==27)&&((s=r===5)&&(s=e.type,s=!(s!=="form"&&s!=="button")||Qf(e.type,e.memoizedProps)),s=!s),s&&ye&&Ua(e),y0(e),r===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(a(317));t:{for(e=e.nextSibling,r=0;e;){if(e.nodeType===8)if(s=e.data,s==="/$"){if(r===0){ye=ni(e.nextSibling);break t}r--}else s!=="$"&&s!=="$!"&&s!=="$?"||r++;e=e.nextSibling}ye=null}}else r===27?(r=ye,Fr(e.type)?(e=Jf,Jf=null,ye=e):ye=r):ye=dn?ni(e.stateNode.nextSibling):null;return!0}function Zo(){ye=dn=null,Kt=!1}function x0(){var e=Pa;return e!==null&&(yn===null?yn=e:yn.push.apply(yn,e),Pa=null),e}function Jo(e){Pa===null?Pa=[e]:Pa.push(e)}var Md=at(null),La=null,Ki=null;function Ir(e,r,s){ht(Md,r._currentValue),r._currentValue=s}function Hi(e){e._currentValue=Md.current,ct(Md)}function Od(e,r,s){for(;e!==null;){var l=e.alternate;if((e.childLanes&r)!==r?(e.childLanes|=r,l!==null&&(l.childLanes|=r)):l!==null&&(l.childLanes&r)!==r&&(l.childLanes|=r),e===s)break;e=e.return}}function Vd(e,r,s,l){var h=e.child;for(h!==null&&(h.return=e);h!==null;){var f=h.dependencies;if(f!==null){var E=h.child;f=f.firstContext;t:for(;f!==null;){var b=f;f=h;for(var N=0;N<r.length;N++)if(b.context===r[N]){f.lanes|=s,b=f.alternate,b!==null&&(b.lanes|=s),Od(f.return,s,e),l||(E=null);break t}f=b.next}}else if(h.tag===18){if(E=h.return,E===null)throw Error(a(341));E.lanes|=s,f=E.alternate,f!==null&&(f.lanes|=s),Od(E,s,e),E=null}else E=h.child;if(E!==null)E.return=h;else for(E=h;E!==null;){if(E===e){E=null;break}if(h=E.sibling,h!==null){h.return=E.return,E=h;break}E=E.return}h=E}}function tl(e,r,s,l){e=null;for(var h=r,f=!1;h!==null;){if(!f){if((h.flags&524288)!==0)f=!0;else if((h.flags&262144)!==0)break}if(h.tag===10){var E=h.alternate;if(E===null)throw Error(a(387));if(E=E.memoizedProps,E!==null){var b=h.type;wn(h.pendingProps.value,E.value)||(e!==null?e.push(b):e=[b])}}else if(h===ge.current){if(E=h.alternate,E===null)throw Error(a(387));E.memoizedState.memoizedState!==h.memoizedState.memoizedState&&(e!==null?e.push(jl):e=[jl])}h=h.return}e!==null&&Vd(r,e,s,l),r.flags|=262144}function Xu(e){for(e=e.firstContext;e!==null;){if(!wn(e.context._currentValue,e.memoizedValue))return!0;e=e.next}return!1}function za(e){La=e,Ki=null,e=e.dependencies,e!==null&&(e.firstContext=null)}function en(e){return v0(La,e)}function Wu(e,r){return La===null&&za(e),v0(e,r)}function v0(e,r){var s=r._currentValue;if(r={context:r,memoizedValue:s,next:null},Ki===null){if(e===null)throw Error(a(308));Ki=r,e.dependencies={lanes:0,firstContext:r},e.flags|=524288}else Ki=Ki.next=r;return s}var zw=typeof AbortController<"u"?AbortController:function(){var e=[],r=this.signal={aborted:!1,addEventListener:function(s,l){e.push(l)}};this.abort=function(){r.aborted=!0,e.forEach(function(s){return s()})}},$w=n.unstable_scheduleCallback,Bw=n.unstable_NormalPriority,ke={$$typeof:tt,Consumer:null,Provider:null,_currentValue:null,_currentValue2:null,_threadCount:0};function kd(){return{controller:new zw,data:new Map,refCount:0}}function el(e){e.refCount--,e.refCount===0&&$w(Bw,function(){e.controller.abort()})}var nl=null,Pd=0,Is=0,js=null;function Fw(e,r){if(nl===null){var s=nl=[];Pd=0,Is=zf(),js={status:"pending",value:void 0,then:function(l){s.push(l)}}}return Pd++,r.then(_0,_0),r}function _0(){if(--Pd===0&&nl!==null){js!==null&&(js.status="fulfilled");var e=nl;nl=null,Is=0,js=null;for(var r=0;r<e.length;r++)(0,e[r])()}}function qw(e,r){var s=[],l={status:"pending",value:null,reason:null,then:function(h){s.push(h)}};return e.then(function(){l.status="fulfilled",l.value=r;for(var h=0;h<s.length;h++)(0,s[h])(r)},function(h){for(l.status="rejected",l.reason=h,h=0;h<s.length;h++)(0,s[h])(void 0)}),l}var E0=J.S;J.S=function(e,r){typeof r=="object"&&r!==null&&typeof r.then=="function"&&Fw(e,r),E0!==null&&E0(e,r)};var $a=at(null);function Ud(){var e=$a.current;return e!==null?e:re.pooledCache}function Zu(e,r){r===null?ht($a,$a.current):ht($a,r.pool)}function w0(){var e=Ud();return e===null?null:{parent:ke._currentValue,pool:e}}var il=Error(a(460)),b0=Error(a(474)),Ju=Error(a(542)),Ld={then:function(){}};function T0(e){return e=e.status,e==="fulfilled"||e==="rejected"}function tc(){}function S0(e,r,s){switch(s=e[s],s===void 0?e.push(r):s!==r&&(r.then(tc,tc),r=s),r.status){case"fulfilled":return r.value;case"rejected":throw e=r.reason,R0(e),e;default:if(typeof r.status=="string")r.then(tc,tc);else{if(e=re,e!==null&&100<e.shellSuspendCounter)throw Error(a(482));e=r,e.status="pending",e.then(function(l){if(r.status==="pending"){var h=r;h.status="fulfilled",h.value=l}},function(l){if(r.status==="pending"){var h=r;h.status="rejected",h.reason=l}})}switch(r.status){case"fulfilled":return r.value;case"rejected":throw e=r.reason,R0(e),e}throw rl=r,il}}var rl=null;function A0(){if(rl===null)throw Error(a(459));var e=rl;return rl=null,e}function R0(e){if(e===il||e===Ju)throw Error(a(483))}var jr=!1;function zd(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,lanes:0,hiddenCallbacks:null},callbacks:null}}function $d(e,r){e=e.updateQueue,r.updateQueue===e&&(r.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,callbacks:null})}function Cr(e){return{lane:e,tag:0,payload:null,callback:null,next:null}}function Dr(e,r,s){var l=e.updateQueue;if(l===null)return null;if(l=l.shared,(Xt&2)!==0){var h=l.pending;return h===null?r.next=r:(r.next=h.next,h.next=r),l.pending=r,r=Hu(e),f0(e,null,s),r}return Ku(e,l,r,s),Hu(e)}function al(e,r,s){if(r=r.updateQueue,r!==null&&(r=r.shared,(s&4194048)!==0)){var l=r.lanes;l&=e.pendingLanes,s|=l,r.lanes=s,yr(e,s)}}function Bd(e,r){var s=e.updateQueue,l=e.alternate;if(l!==null&&(l=l.updateQueue,s===l)){var h=null,f=null;if(s=s.firstBaseUpdate,s!==null){do{var E={lane:s.lane,tag:s.tag,payload:s.payload,callback:null,next:null};f===null?h=f=E:f=f.next=E,s=s.next}while(s!==null);f===null?h=f=r:f=f.next=r}else h=f=r;s={baseState:l.baseState,firstBaseUpdate:h,lastBaseUpdate:f,shared:l.shared,callbacks:l.callbacks},e.updateQueue=s;return}e=s.lastBaseUpdate,e===null?s.firstBaseUpdate=r:e.next=r,s.lastBaseUpdate=r}var Fd=!1;function sl(){if(Fd){var e=js;if(e!==null)throw e}}function ol(e,r,s,l){Fd=!1;var h=e.updateQueue;jr=!1;var f=h.firstBaseUpdate,E=h.lastBaseUpdate,b=h.shared.pending;if(b!==null){h.shared.pending=null;var N=b,H=N.next;N.next=null,E===null?f=H:E.next=H,E=N;var et=e.alternate;et!==null&&(et=et.updateQueue,b=et.lastBaseUpdate,b!==E&&(b===null?et.firstBaseUpdate=H:b.next=H,et.lastBaseUpdate=N))}if(f!==null){var rt=h.baseState;E=0,et=H=N=null,b=f;do{var G=b.lane&-536870913,Q=G!==b.lane;if(Q?(zt&G)===G:(l&G)===G){G!==0&&G===Is&&(Fd=!0),et!==null&&(et=et.next={lane:0,tag:b.tag,payload:b.payload,callback:null,next:null});t:{var Tt=e,Et=b;G=r;var ee=s;switch(Et.tag){case 1:if(Tt=Et.payload,typeof Tt=="function"){rt=Tt.call(ee,rt,G);break t}rt=Tt;break t;case 3:Tt.flags=Tt.flags&-65537|128;case 0:if(Tt=Et.payload,G=typeof Tt=="function"?Tt.call(ee,rt,G):Tt,G==null)break t;rt=v({},rt,G);break t;case 2:jr=!0}}G=b.callback,G!==null&&(e.flags|=64,Q&&(e.flags|=8192),Q=h.callbacks,Q===null?h.callbacks=[G]:Q.push(G))}else Q={lane:G,tag:b.tag,payload:b.payload,callback:b.callback,next:null},et===null?(H=et=Q,N=rt):et=et.next=Q,E|=G;if(b=b.next,b===null){if(b=h.shared.pending,b===null)break;Q=b,b=Q.next,Q.next=null,h.lastBaseUpdate=Q,h.shared.pending=null}}while(!0);et===null&&(N=rt),h.baseState=N,h.firstBaseUpdate=H,h.lastBaseUpdate=et,f===null&&(h.shared.lanes=0),Lr|=E,e.lanes=E,e.memoizedState=rt}}function I0(e,r){if(typeof e!="function")throw Error(a(191,e));e.call(r)}function j0(e,r){var s=e.callbacks;if(s!==null)for(e.callbacks=null,e=0;e<s.length;e++)I0(s[e],r)}var Cs=at(null),ec=at(0);function C0(e,r){e=Ji,ht(ec,e),ht(Cs,r),Ji=e|r.baseLanes}function qd(){ht(ec,Ji),ht(Cs,Cs.current)}function Kd(){Ji=ec.current,ct(Cs),ct(ec)}var Nr=0,Mt=null,Jt=null,Re=null,nc=!1,Ds=!1,Ba=!1,ic=0,ll=0,Ns=null,Kw=0;function be(){throw Error(a(321))}function Hd(e,r){if(r===null)return!1;for(var s=0;s<r.length&&s<e.length;s++)if(!wn(e[s],r[s]))return!1;return!0}function Gd(e,r,s,l,h,f){return Nr=f,Mt=r,r.memoizedState=null,r.updateQueue=null,r.lanes=0,J.H=e===null||e.memoizedState===null?fy:py,Ba=!1,f=s(l,h),Ba=!1,Ds&&(f=N0(r,s,l,h)),D0(e),f}function D0(e){J.H=uc;var r=Jt!==null&&Jt.next!==null;if(Nr=0,Re=Jt=Mt=null,nc=!1,ll=0,Ns=null,r)throw Error(a(300));e===null||$e||(e=e.dependencies,e!==null&&Xu(e)&&($e=!0))}function N0(e,r,s,l){Mt=e;var h=0;do{if(Ds&&(Ns=null),ll=0,Ds=!1,25<=h)throw Error(a(301));if(h+=1,Re=Jt=null,e.updateQueue!=null){var f=e.updateQueue;f.lastEffect=null,f.events=null,f.stores=null,f.memoCache!=null&&(f.memoCache.index=0)}J.H=Zw,f=r(s,l)}while(Ds);return f}function Hw(){var e=J.H,r=e.useState()[0];return r=typeof r.then=="function"?ul(r):r,e=e.useState()[0],(Jt!==null?Jt.memoizedState:null)!==e&&(Mt.flags|=1024),r}function Yd(){var e=ic!==0;return ic=0,e}function Qd(e,r,s){r.updateQueue=e.updateQueue,r.flags&=-2053,e.lanes&=~s}function Xd(e){if(nc){for(e=e.memoizedState;e!==null;){var r=e.queue;r!==null&&(r.pending=null),e=e.next}nc=!1}Nr=0,Re=Jt=Mt=null,Ds=!1,ll=ic=0,Ns=null}function mn(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return Re===null?Mt.memoizedState=Re=e:Re=Re.next=e,Re}function Ie(){if(Jt===null){var e=Mt.alternate;e=e!==null?e.memoizedState:null}else e=Jt.next;var r=Re===null?Mt.memoizedState:Re.next;if(r!==null)Re=r,Jt=e;else{if(e===null)throw Mt.alternate===null?Error(a(467)):Error(a(310));Jt=e,e={memoizedState:Jt.memoizedState,baseState:Jt.baseState,baseQueue:Jt.baseQueue,queue:Jt.queue,next:null},Re===null?Mt.memoizedState=Re=e:Re=Re.next=e}return Re}function Wd(){return{lastEffect:null,events:null,stores:null,memoCache:null}}function ul(e){var r=ll;return ll+=1,Ns===null&&(Ns=[]),e=S0(Ns,e,r),r=Mt,(Re===null?r.memoizedState:Re.next)===null&&(r=r.alternate,J.H=r===null||r.memoizedState===null?fy:py),e}function rc(e){if(e!==null&&typeof e=="object"){if(typeof e.then=="function")return ul(e);if(e.$$typeof===tt)return en(e)}throw Error(a(438,String(e)))}function Zd(e){var r=null,s=Mt.updateQueue;if(s!==null&&(r=s.memoCache),r==null){var l=Mt.alternate;l!==null&&(l=l.updateQueue,l!==null&&(l=l.memoCache,l!=null&&(r={data:l.data.map(function(h){return h.slice()}),index:0})))}if(r==null&&(r={data:[],index:0}),s===null&&(s=Wd(),Mt.updateQueue=s),s.memoCache=r,s=r.data[r.index],s===void 0)for(s=r.data[r.index]=Array(e),l=0;l<e;l++)s[l]=O;return r.index++,s}function Gi(e,r){return typeof r=="function"?r(e):r}function ac(e){var r=Ie();return Jd(r,Jt,e)}function Jd(e,r,s){var l=e.queue;if(l===null)throw Error(a(311));l.lastRenderedReducer=s;var h=e.baseQueue,f=l.pending;if(f!==null){if(h!==null){var E=h.next;h.next=f.next,f.next=E}r.baseQueue=h=f,l.pending=null}if(f=e.baseState,h===null)e.memoizedState=f;else{r=h.next;var b=E=null,N=null,H=r,et=!1;do{var rt=H.lane&-536870913;if(rt!==H.lane?(zt&rt)===rt:(Nr&rt)===rt){var G=H.revertLane;if(G===0)N!==null&&(N=N.next={lane:0,revertLane:0,action:H.action,hasEagerState:H.hasEagerState,eagerState:H.eagerState,next:null}),rt===Is&&(et=!0);else if((Nr&G)===G){H=H.next,G===Is&&(et=!0);continue}else rt={lane:0,revertLane:H.revertLane,action:H.action,hasEagerState:H.hasEagerState,eagerState:H.eagerState,next:null},N===null?(b=N=rt,E=f):N=N.next=rt,Mt.lanes|=G,Lr|=G;rt=H.action,Ba&&s(f,rt),f=H.hasEagerState?H.eagerState:s(f,rt)}else G={lane:rt,revertLane:H.revertLane,action:H.action,hasEagerState:H.hasEagerState,eagerState:H.eagerState,next:null},N===null?(b=N=G,E=f):N=N.next=G,Mt.lanes|=rt,Lr|=rt;H=H.next}while(H!==null&&H!==r);if(N===null?E=f:N.next=b,!wn(f,e.memoizedState)&&($e=!0,et&&(s=js,s!==null)))throw s;e.memoizedState=f,e.baseState=E,e.baseQueue=N,l.lastRenderedState=f}return h===null&&(l.lanes=0),[e.memoizedState,l.dispatch]}function tf(e){var r=Ie(),s=r.queue;if(s===null)throw Error(a(311));s.lastRenderedReducer=e;var l=s.dispatch,h=s.pending,f=r.memoizedState;if(h!==null){s.pending=null;var E=h=h.next;do f=e(f,E.action),E=E.next;while(E!==h);wn(f,r.memoizedState)||($e=!0),r.memoizedState=f,r.baseQueue===null&&(r.baseState=f),s.lastRenderedState=f}return[f,l]}function M0(e,r,s){var l=Mt,h=Ie(),f=Kt;if(f){if(s===void 0)throw Error(a(407));s=s()}else s=r();var E=!wn((Jt||h).memoizedState,s);E&&(h.memoizedState=s,$e=!0),h=h.queue;var b=k0.bind(null,l,h,e);if(cl(2048,8,b,[e]),h.getSnapshot!==r||E||Re!==null&&Re.memoizedState.tag&1){if(l.flags|=2048,Ms(9,sc(),V0.bind(null,l,h,s,r),null),re===null)throw Error(a(349));f||(Nr&124)!==0||O0(l,r,s)}return s}function O0(e,r,s){e.flags|=16384,e={getSnapshot:r,value:s},r=Mt.updateQueue,r===null?(r=Wd(),Mt.updateQueue=r,r.stores=[e]):(s=r.stores,s===null?r.stores=[e]:s.push(e))}function V0(e,r,s,l){r.value=s,r.getSnapshot=l,P0(r)&&U0(e)}function k0(e,r,s){return s(function(){P0(r)&&U0(e)})}function P0(e){var r=e.getSnapshot;e=e.value;try{var s=r();return!wn(e,s)}catch{return!0}}function U0(e){var r=Ts(e,2);r!==null&&In(r,e,2)}function ef(e){var r=mn();if(typeof e=="function"){var s=e;if(e=s(),Ba){Dn(!0);try{s()}finally{Dn(!1)}}}return r.memoizedState=r.baseState=e,r.queue={pending:null,lanes:0,dispatch:null,lastRenderedReducer:Gi,lastRenderedState:e},r}function L0(e,r,s,l){return e.baseState=s,Jd(e,Jt,typeof l=="function"?l:Gi)}function Gw(e,r,s,l,h){if(lc(e))throw Error(a(485));if(e=r.action,e!==null){var f={payload:h,action:e,next:null,isTransition:!0,status:"pending",value:null,reason:null,listeners:[],then:function(E){f.listeners.push(E)}};J.T!==null?s(!0):f.isTransition=!1,l(f),s=r.pending,s===null?(f.next=r.pending=f,z0(r,f)):(f.next=s.next,r.pending=s.next=f)}}function z0(e,r){var s=r.action,l=r.payload,h=e.state;if(r.isTransition){var f=J.T,E={};J.T=E;try{var b=s(h,l),N=J.S;N!==null&&N(E,b),$0(e,r,b)}catch(H){nf(e,r,H)}finally{J.T=f}}else try{f=s(h,l),$0(e,r,f)}catch(H){nf(e,r,H)}}function $0(e,r,s){s!==null&&typeof s=="object"&&typeof s.then=="function"?s.then(function(l){B0(e,r,l)},function(l){return nf(e,r,l)}):B0(e,r,s)}function B0(e,r,s){r.status="fulfilled",r.value=s,F0(r),e.state=s,r=e.pending,r!==null&&(s=r.next,s===r?e.pending=null:(s=s.next,r.next=s,z0(e,s)))}function nf(e,r,s){var l=e.pending;if(e.pending=null,l!==null){l=l.next;do r.status="rejected",r.reason=s,F0(r),r=r.next;while(r!==l)}e.action=null}function F0(e){e=e.listeners;for(var r=0;r<e.length;r++)(0,e[r])()}function q0(e,r){return r}function K0(e,r){if(Kt){var s=re.formState;if(s!==null){t:{var l=Mt;if(Kt){if(ye){e:{for(var h=ye,f=gi;h.nodeType!==8;){if(!f){h=null;break e}if(h=ni(h.nextSibling),h===null){h=null;break e}}f=h.data,h=f==="F!"||f==="F"?h:null}if(h){ye=ni(h.nextSibling),l=h.data==="F!";break t}}Ua(l)}l=!1}l&&(r=s[0])}}return s=mn(),s.memoizedState=s.baseState=r,l={pending:null,lanes:0,dispatch:null,lastRenderedReducer:q0,lastRenderedState:r},s.queue=l,s=cy.bind(null,Mt,l),l.dispatch=s,l=ef(!1),f=lf.bind(null,Mt,!1,l.queue),l=mn(),h={state:r,dispatch:null,action:e,pending:null},l.queue=h,s=Gw.bind(null,Mt,h,f,s),h.dispatch=s,l.memoizedState=e,[r,s,!1]}function H0(e){var r=Ie();return G0(r,Jt,e)}function G0(e,r,s){if(r=Jd(e,r,q0)[0],e=ac(Gi)[0],typeof r=="object"&&r!==null&&typeof r.then=="function")try{var l=ul(r)}catch(E){throw E===il?Ju:E}else l=r;r=Ie();var h=r.queue,f=h.dispatch;return s!==r.memoizedState&&(Mt.flags|=2048,Ms(9,sc(),Yw.bind(null,h,s),null)),[l,f,e]}function Yw(e,r){e.action=r}function Y0(e){var r=Ie(),s=Jt;if(s!==null)return G0(r,s,e);Ie(),r=r.memoizedState,s=Ie();var l=s.queue.dispatch;return s.memoizedState=e,[r,l,!1]}function Ms(e,r,s,l){return e={tag:e,create:s,deps:l,inst:r,next:null},r=Mt.updateQueue,r===null&&(r=Wd(),Mt.updateQueue=r),s=r.lastEffect,s===null?r.lastEffect=e.next=e:(l=s.next,s.next=e,e.next=l,r.lastEffect=e),e}function sc(){return{destroy:void 0,resource:void 0}}function Q0(){return Ie().memoizedState}function oc(e,r,s,l){var h=mn();l=l===void 0?null:l,Mt.flags|=e,h.memoizedState=Ms(1|r,sc(),s,l)}function cl(e,r,s,l){var h=Ie();l=l===void 0?null:l;var f=h.memoizedState.inst;Jt!==null&&l!==null&&Hd(l,Jt.memoizedState.deps)?h.memoizedState=Ms(r,f,s,l):(Mt.flags|=e,h.memoizedState=Ms(1|r,f,s,l))}function X0(e,r){oc(8390656,8,e,r)}function W0(e,r){cl(2048,8,e,r)}function Z0(e,r){return cl(4,2,e,r)}function J0(e,r){return cl(4,4,e,r)}function ty(e,r){if(typeof r=="function"){e=e();var s=r(e);return function(){typeof s=="function"?s():r(null)}}if(r!=null)return e=e(),r.current=e,function(){r.current=null}}function ey(e,r,s){s=s!=null?s.concat([e]):null,cl(4,4,ty.bind(null,r,e),s)}function rf(){}function ny(e,r){var s=Ie();r=r===void 0?null:r;var l=s.memoizedState;return r!==null&&Hd(r,l[1])?l[0]:(s.memoizedState=[e,r],e)}function iy(e,r){var s=Ie();r=r===void 0?null:r;var l=s.memoizedState;if(r!==null&&Hd(r,l[1]))return l[0];if(l=e(),Ba){Dn(!0);try{e()}finally{Dn(!1)}}return s.memoizedState=[l,r],l}function af(e,r,s){return s===void 0||(Nr&1073741824)!==0?e.memoizedState=r:(e.memoizedState=s,e=s1(),Mt.lanes|=e,Lr|=e,s)}function ry(e,r,s,l){return wn(s,r)?s:Cs.current!==null?(e=af(e,s,l),wn(e,r)||($e=!0),e):(Nr&42)===0?($e=!0,e.memoizedState=s):(e=s1(),Mt.lanes|=e,Lr|=e,r)}function ay(e,r,s,l,h){var f=dt.p;dt.p=f!==0&&8>f?f:8;var E=J.T,b={};J.T=b,lf(e,!1,r,s);try{var N=h(),H=J.S;if(H!==null&&H(b,N),N!==null&&typeof N=="object"&&typeof N.then=="function"){var et=qw(N,l);hl(e,r,et,Rn(e))}else hl(e,r,l,Rn(e))}catch(rt){hl(e,r,{then:function(){},status:"rejected",reason:rt},Rn())}finally{dt.p=f,J.T=E}}function Qw(){}function sf(e,r,s,l){if(e.tag!==5)throw Error(a(476));var h=sy(e).queue;ay(e,h,r,yt,s===null?Qw:function(){return oy(e),s(l)})}function sy(e){var r=e.memoizedState;if(r!==null)return r;r={memoizedState:yt,baseState:yt,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:Gi,lastRenderedState:yt},next:null};var s={};return r.next={memoizedState:s,baseState:s,baseQueue:null,queue:{pending:null,lanes:0,dispatch:null,lastRenderedReducer:Gi,lastRenderedState:s},next:null},e.memoizedState=r,e=e.alternate,e!==null&&(e.memoizedState=r),r}function oy(e){var r=sy(e).next.queue;hl(e,r,{},Rn())}function of(){return en(jl)}function ly(){return Ie().memoizedState}function uy(){return Ie().memoizedState}function Xw(e){for(var r=e.return;r!==null;){switch(r.tag){case 24:case 3:var s=Rn();e=Cr(s);var l=Dr(r,e,s);l!==null&&(In(l,r,s),al(l,r,s)),r={cache:kd()},e.payload=r;return}r=r.return}}function Ww(e,r,s){var l=Rn();s={lane:l,revertLane:0,action:s,hasEagerState:!1,eagerState:null,next:null},lc(e)?hy(r,s):(s=Ad(e,r,s,l),s!==null&&(In(s,e,l),dy(s,r,l)))}function cy(e,r,s){var l=Rn();hl(e,r,s,l)}function hl(e,r,s,l){var h={lane:l,revertLane:0,action:s,hasEagerState:!1,eagerState:null,next:null};if(lc(e))hy(r,h);else{var f=e.alternate;if(e.lanes===0&&(f===null||f.lanes===0)&&(f=r.lastRenderedReducer,f!==null))try{var E=r.lastRenderedState,b=f(E,s);if(h.hasEagerState=!0,h.eagerState=b,wn(b,E))return Ku(e,r,h,0),re===null&&qu(),!1}catch{}finally{}if(s=Ad(e,r,h,l),s!==null)return In(s,e,l),dy(s,r,l),!0}return!1}function lf(e,r,s,l){if(l={lane:2,revertLane:zf(),action:l,hasEagerState:!1,eagerState:null,next:null},lc(e)){if(r)throw Error(a(479))}else r=Ad(e,s,l,2),r!==null&&In(r,e,2)}function lc(e){var r=e.alternate;return e===Mt||r!==null&&r===Mt}function hy(e,r){Ds=nc=!0;var s=e.pending;s===null?r.next=r:(r.next=s.next,s.next=r),e.pending=r}function dy(e,r,s){if((s&4194048)!==0){var l=r.lanes;l&=e.pendingLanes,s|=l,r.lanes=s,yr(e,s)}}var uc={readContext:en,use:rc,useCallback:be,useContext:be,useEffect:be,useImperativeHandle:be,useLayoutEffect:be,useInsertionEffect:be,useMemo:be,useReducer:be,useRef:be,useState:be,useDebugValue:be,useDeferredValue:be,useTransition:be,useSyncExternalStore:be,useId:be,useHostTransitionStatus:be,useFormState:be,useActionState:be,useOptimistic:be,useMemoCache:be,useCacheRefresh:be},fy={readContext:en,use:rc,useCallback:function(e,r){return mn().memoizedState=[e,r===void 0?null:r],e},useContext:en,useEffect:X0,useImperativeHandle:function(e,r,s){s=s!=null?s.concat([e]):null,oc(4194308,4,ty.bind(null,r,e),s)},useLayoutEffect:function(e,r){return oc(4194308,4,e,r)},useInsertionEffect:function(e,r){oc(4,2,e,r)},useMemo:function(e,r){var s=mn();r=r===void 0?null:r;var l=e();if(Ba){Dn(!0);try{e()}finally{Dn(!1)}}return s.memoizedState=[l,r],l},useReducer:function(e,r,s){var l=mn();if(s!==void 0){var h=s(r);if(Ba){Dn(!0);try{s(r)}finally{Dn(!1)}}}else h=r;return l.memoizedState=l.baseState=h,e={pending:null,lanes:0,dispatch:null,lastRenderedReducer:e,lastRenderedState:h},l.queue=e,e=e.dispatch=Ww.bind(null,Mt,e),[l.memoizedState,e]},useRef:function(e){var r=mn();return e={current:e},r.memoizedState=e},useState:function(e){e=ef(e);var r=e.queue,s=cy.bind(null,Mt,r);return r.dispatch=s,[e.memoizedState,s]},useDebugValue:rf,useDeferredValue:function(e,r){var s=mn();return af(s,e,r)},useTransition:function(){var e=ef(!1);return e=ay.bind(null,Mt,e.queue,!0,!1),mn().memoizedState=e,[!1,e]},useSyncExternalStore:function(e,r,s){var l=Mt,h=mn();if(Kt){if(s===void 0)throw Error(a(407));s=s()}else{if(s=r(),re===null)throw Error(a(349));(zt&124)!==0||O0(l,r,s)}h.memoizedState=s;var f={value:s,getSnapshot:r};return h.queue=f,X0(k0.bind(null,l,f,e),[e]),l.flags|=2048,Ms(9,sc(),V0.bind(null,l,f,s,r),null),s},useId:function(){var e=mn(),r=re.identifierPrefix;if(Kt){var s=qi,l=Fi;s=(l&~(1<<32-ln(l)-1)).toString(32)+s,r="«"+r+"R"+s,s=ic++,0<s&&(r+="H"+s.toString(32)),r+="»"}else s=Kw++,r="«"+r+"r"+s.toString(32)+"»";return e.memoizedState=r},useHostTransitionStatus:of,useFormState:K0,useActionState:K0,useOptimistic:function(e){var r=mn();r.memoizedState=r.baseState=e;var s={pending:null,lanes:0,dispatch:null,lastRenderedReducer:null,lastRenderedState:null};return r.queue=s,r=lf.bind(null,Mt,!0,s),s.dispatch=r,[e,r]},useMemoCache:Zd,useCacheRefresh:function(){return mn().memoizedState=Xw.bind(null,Mt)}},py={readContext:en,use:rc,useCallback:ny,useContext:en,useEffect:W0,useImperativeHandle:ey,useInsertionEffect:Z0,useLayoutEffect:J0,useMemo:iy,useReducer:ac,useRef:Q0,useState:function(){return ac(Gi)},useDebugValue:rf,useDeferredValue:function(e,r){var s=Ie();return ry(s,Jt.memoizedState,e,r)},useTransition:function(){var e=ac(Gi)[0],r=Ie().memoizedState;return[typeof e=="boolean"?e:ul(e),r]},useSyncExternalStore:M0,useId:ly,useHostTransitionStatus:of,useFormState:H0,useActionState:H0,useOptimistic:function(e,r){var s=Ie();return L0(s,Jt,e,r)},useMemoCache:Zd,useCacheRefresh:uy},Zw={readContext:en,use:rc,useCallback:ny,useContext:en,useEffect:W0,useImperativeHandle:ey,useInsertionEffect:Z0,useLayoutEffect:J0,useMemo:iy,useReducer:tf,useRef:Q0,useState:function(){return tf(Gi)},useDebugValue:rf,useDeferredValue:function(e,r){var s=Ie();return Jt===null?af(s,e,r):ry(s,Jt.memoizedState,e,r)},useTransition:function(){var e=tf(Gi)[0],r=Ie().memoizedState;return[typeof e=="boolean"?e:ul(e),r]},useSyncExternalStore:M0,useId:ly,useHostTransitionStatus:of,useFormState:Y0,useActionState:Y0,useOptimistic:function(e,r){var s=Ie();return Jt!==null?L0(s,Jt,e,r):(s.baseState=e,[e,s.queue.dispatch])},useMemoCache:Zd,useCacheRefresh:uy},Os=null,dl=0;function cc(e){var r=dl;return dl+=1,Os===null&&(Os=[]),S0(Os,e,r)}function fl(e,r){r=r.props.ref,e.ref=r!==void 0?r:null}function hc(e,r){throw r.$$typeof===w?Error(a(525)):(e=Object.prototype.toString.call(r),Error(a(31,e==="[object Object]"?"object with keys {"+Object.keys(r).join(", ")+"}":e)))}function my(e){var r=e._init;return r(e._payload)}function gy(e){function r($,P){if(e){var F=$.deletions;F===null?($.deletions=[P],$.flags|=16):F.push(P)}}function s($,P){if(!e)return null;for(;P!==null;)r($,P),P=P.sibling;return null}function l($){for(var P=new Map;$!==null;)$.key!==null?P.set($.key,$):P.set($.index,$),$=$.sibling;return P}function h($,P){return $=Bi($,P),$.index=0,$.sibling=null,$}function f($,P,F){return $.index=F,e?(F=$.alternate,F!==null?(F=F.index,F<P?($.flags|=67108866,P):F):($.flags|=67108866,P)):($.flags|=1048576,P)}function E($){return e&&$.alternate===null&&($.flags|=67108866),$}function b($,P,F,nt){return P===null||P.tag!==6?(P=Id(F,$.mode,nt),P.return=$,P):(P=h(P,F),P.return=$,P)}function N($,P,F,nt){var mt=F.type;return mt===M?et($,P,F.props.children,nt,F.key):P!==null&&(P.elementType===mt||typeof mt=="object"&&mt!==null&&mt.$$typeof===I&&my(mt)===P.type)?(P=h(P,F.props),fl(P,F),P.return=$,P):(P=Gu(F.type,F.key,F.props,null,$.mode,nt),fl(P,F),P.return=$,P)}function H($,P,F,nt){return P===null||P.tag!==4||P.stateNode.containerInfo!==F.containerInfo||P.stateNode.implementation!==F.implementation?(P=jd(F,$.mode,nt),P.return=$,P):(P=h(P,F.children||[]),P.return=$,P)}function et($,P,F,nt,mt){return P===null||P.tag!==7?(P=Oa(F,$.mode,nt,mt),P.return=$,P):(P=h(P,F),P.return=$,P)}function rt($,P,F){if(typeof P=="string"&&P!==""||typeof P=="number"||typeof P=="bigint")return P=Id(""+P,$.mode,F),P.return=$,P;if(typeof P=="object"&&P!==null){switch(P.$$typeof){case T:return F=Gu(P.type,P.key,P.props,null,$.mode,F),fl(F,P),F.return=$,F;case R:return P=jd(P,$.mode,F),P.return=$,P;case I:var nt=P._init;return P=nt(P._payload),rt($,P,F)}if(qt(P)||z(P))return P=Oa(P,$.mode,F,null),P.return=$,P;if(typeof P.then=="function")return rt($,cc(P),F);if(P.$$typeof===tt)return rt($,Wu($,P),F);hc($,P)}return null}function G($,P,F,nt){var mt=P!==null?P.key:null;if(typeof F=="string"&&F!==""||typeof F=="number"||typeof F=="bigint")return mt!==null?null:b($,P,""+F,nt);if(typeof F=="object"&&F!==null){switch(F.$$typeof){case T:return F.key===mt?N($,P,F,nt):null;case R:return F.key===mt?H($,P,F,nt):null;case I:return mt=F._init,F=mt(F._payload),G($,P,F,nt)}if(qt(F)||z(F))return mt!==null?null:et($,P,F,nt,null);if(typeof F.then=="function")return G($,P,cc(F),nt);if(F.$$typeof===tt)return G($,P,Wu($,F),nt);hc($,F)}return null}function Q($,P,F,nt,mt){if(typeof nt=="string"&&nt!==""||typeof nt=="number"||typeof nt=="bigint")return $=$.get(F)||null,b(P,$,""+nt,mt);if(typeof nt=="object"&&nt!==null){switch(nt.$$typeof){case T:return $=$.get(nt.key===null?F:nt.key)||null,N(P,$,nt,mt);case R:return $=$.get(nt.key===null?F:nt.key)||null,H(P,$,nt,mt);case I:var Ot=nt._init;return nt=Ot(nt._payload),Q($,P,F,nt,mt)}if(qt(nt)||z(nt))return $=$.get(F)||null,et(P,$,nt,mt,null);if(typeof nt.then=="function")return Q($,P,F,cc(nt),mt);if(nt.$$typeof===tt)return Q($,P,F,Wu(P,nt),mt);hc(P,nt)}return null}function Tt($,P,F,nt){for(var mt=null,Ot=null,xt=P,wt=P=0,Fe=null;xt!==null&&wt<F.length;wt++){xt.index>wt?(Fe=xt,xt=null):Fe=xt.sibling;var Ft=G($,xt,F[wt],nt);if(Ft===null){xt===null&&(xt=Fe);break}e&&xt&&Ft.alternate===null&&r($,xt),P=f(Ft,P,wt),Ot===null?mt=Ft:Ot.sibling=Ft,Ot=Ft,xt=Fe}if(wt===F.length)return s($,xt),Kt&&ka($,wt),mt;if(xt===null){for(;wt<F.length;wt++)xt=rt($,F[wt],nt),xt!==null&&(P=f(xt,P,wt),Ot===null?mt=xt:Ot.sibling=xt,Ot=xt);return Kt&&ka($,wt),mt}for(xt=l(xt);wt<F.length;wt++)Fe=Q(xt,$,wt,F[wt],nt),Fe!==null&&(e&&Fe.alternate!==null&&xt.delete(Fe.key===null?wt:Fe.key),P=f(Fe,P,wt),Ot===null?mt=Fe:Ot.sibling=Fe,Ot=Fe);return e&&xt.forEach(function(Yr){return r($,Yr)}),Kt&&ka($,wt),mt}function Et($,P,F,nt){if(F==null)throw Error(a(151));for(var mt=null,Ot=null,xt=P,wt=P=0,Fe=null,Ft=F.next();xt!==null&&!Ft.done;wt++,Ft=F.next()){xt.index>wt?(Fe=xt,xt=null):Fe=xt.sibling;var Yr=G($,xt,Ft.value,nt);if(Yr===null){xt===null&&(xt=Fe);break}e&&xt&&Yr.alternate===null&&r($,xt),P=f(Yr,P,wt),Ot===null?mt=Yr:Ot.sibling=Yr,Ot=Yr,xt=Fe}if(Ft.done)return s($,xt),Kt&&ka($,wt),mt;if(xt===null){for(;!Ft.done;wt++,Ft=F.next())Ft=rt($,Ft.value,nt),Ft!==null&&(P=f(Ft,P,wt),Ot===null?mt=Ft:Ot.sibling=Ft,Ot=Ft);return Kt&&ka($,wt),mt}for(xt=l(xt);!Ft.done;wt++,Ft=F.next())Ft=Q(xt,$,wt,Ft.value,nt),Ft!==null&&(e&&Ft.alternate!==null&&xt.delete(Ft.key===null?wt:Ft.key),P=f(Ft,P,wt),Ot===null?mt=Ft:Ot.sibling=Ft,Ot=Ft);return e&&xt.forEach(function(Jb){return r($,Jb)}),Kt&&ka($,wt),mt}function ee($,P,F,nt){if(typeof F=="object"&&F!==null&&F.type===M&&F.key===null&&(F=F.props.children),typeof F=="object"&&F!==null){switch(F.$$typeof){case T:t:{for(var mt=F.key;P!==null;){if(P.key===mt){if(mt=F.type,mt===M){if(P.tag===7){s($,P.sibling),nt=h(P,F.props.children),nt.return=$,$=nt;break t}}else if(P.elementType===mt||typeof mt=="object"&&mt!==null&&mt.$$typeof===I&&my(mt)===P.type){s($,P.sibling),nt=h(P,F.props),fl(nt,F),nt.return=$,$=nt;break t}s($,P);break}else r($,P);P=P.sibling}F.type===M?(nt=Oa(F.props.children,$.mode,nt,F.key),nt.return=$,$=nt):(nt=Gu(F.type,F.key,F.props,null,$.mode,nt),fl(nt,F),nt.return=$,$=nt)}return E($);case R:t:{for(mt=F.key;P!==null;){if(P.key===mt)if(P.tag===4&&P.stateNode.containerInfo===F.containerInfo&&P.stateNode.implementation===F.implementation){s($,P.sibling),nt=h(P,F.children||[]),nt.return=$,$=nt;break t}else{s($,P);break}else r($,P);P=P.sibling}nt=jd(F,$.mode,nt),nt.return=$,$=nt}return E($);case I:return mt=F._init,F=mt(F._payload),ee($,P,F,nt)}if(qt(F))return Tt($,P,F,nt);if(z(F)){if(mt=z(F),typeof mt!="function")throw Error(a(150));return F=mt.call(F),Et($,P,F,nt)}if(typeof F.then=="function")return ee($,P,cc(F),nt);if(F.$$typeof===tt)return ee($,P,Wu($,F),nt);hc($,F)}return typeof F=="string"&&F!==""||typeof F=="number"||typeof F=="bigint"?(F=""+F,P!==null&&P.tag===6?(s($,P.sibling),nt=h(P,F),nt.return=$,$=nt):(s($,P),nt=Id(F,$.mode,nt),nt.return=$,$=nt),E($)):s($,P)}return function($,P,F,nt){try{dl=0;var mt=ee($,P,F,nt);return Os=null,mt}catch(xt){if(xt===il||xt===Ju)throw xt;var Ot=bn(29,xt,null,$.mode);return Ot.lanes=nt,Ot.return=$,Ot}finally{}}}var Vs=gy(!0),yy=gy(!1),zn=at(null),yi=null;function Mr(e){var r=e.alternate;ht(Pe,Pe.current&1),ht(zn,e),yi===null&&(r===null||Cs.current!==null||r.memoizedState!==null)&&(yi=e)}function xy(e){if(e.tag===22){if(ht(Pe,Pe.current),ht(zn,e),yi===null){var r=e.alternate;r!==null&&r.memoizedState!==null&&(yi=e)}}else Or()}function Or(){ht(Pe,Pe.current),ht(zn,zn.current)}function Yi(e){ct(zn),yi===e&&(yi=null),ct(Pe)}var Pe=at(0);function dc(e){for(var r=e;r!==null;){if(r.tag===13){var s=r.memoizedState;if(s!==null&&(s=s.dehydrated,s===null||s.data==="$?"||Zf(s)))return r}else if(r.tag===19&&r.memoizedProps.revealOrder!==void 0){if((r.flags&128)!==0)return r}else if(r.child!==null){r.child.return=r,r=r.child;continue}if(r===e)break;for(;r.sibling===null;){if(r.return===null||r.return===e)return null;r=r.return}r.sibling.return=r.return,r=r.sibling}return null}function uf(e,r,s,l){r=e.memoizedState,s=s(l,r),s=s==null?r:v({},r,s),e.memoizedState=s,e.lanes===0&&(e.updateQueue.baseState=s)}var cf={enqueueSetState:function(e,r,s){e=e._reactInternals;var l=Rn(),h=Cr(l);h.payload=r,s!=null&&(h.callback=s),r=Dr(e,h,l),r!==null&&(In(r,e,l),al(r,e,l))},enqueueReplaceState:function(e,r,s){e=e._reactInternals;var l=Rn(),h=Cr(l);h.tag=1,h.payload=r,s!=null&&(h.callback=s),r=Dr(e,h,l),r!==null&&(In(r,e,l),al(r,e,l))},enqueueForceUpdate:function(e,r){e=e._reactInternals;var s=Rn(),l=Cr(s);l.tag=2,r!=null&&(l.callback=r),r=Dr(e,l,s),r!==null&&(In(r,e,s),al(r,e,s))}};function vy(e,r,s,l,h,f,E){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(l,f,E):r.prototype&&r.prototype.isPureReactComponent?!Qo(s,l)||!Qo(h,f):!0}function _y(e,r,s,l){e=r.state,typeof r.componentWillReceiveProps=="function"&&r.componentWillReceiveProps(s,l),typeof r.UNSAFE_componentWillReceiveProps=="function"&&r.UNSAFE_componentWillReceiveProps(s,l),r.state!==e&&cf.enqueueReplaceState(r,r.state,null)}function Fa(e,r){var s=r;if("ref"in r){s={};for(var l in r)l!=="ref"&&(s[l]=r[l])}if(e=e.defaultProps){s===r&&(s=v({},s));for(var h in e)s[h]===void 0&&(s[h]=e[h])}return s}var fc=typeof reportError=="function"?reportError:function(e){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var r=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof e=="object"&&e!==null&&typeof e.message=="string"?String(e.message):String(e),error:e});if(!window.dispatchEvent(r))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",e);return}console.error(e)};function Ey(e){fc(e)}function wy(e){console.error(e)}function by(e){fc(e)}function pc(e,r){try{var s=e.onUncaughtError;s(r.value,{componentStack:r.stack})}catch(l){setTimeout(function(){throw l})}}function Ty(e,r,s){try{var l=e.onCaughtError;l(s.value,{componentStack:s.stack,errorBoundary:r.tag===1?r.stateNode:null})}catch(h){setTimeout(function(){throw h})}}function hf(e,r,s){return s=Cr(s),s.tag=3,s.payload={element:null},s.callback=function(){pc(e,r)},s}function Sy(e){return e=Cr(e),e.tag=3,e}function Ay(e,r,s,l){var h=s.type.getDerivedStateFromError;if(typeof h=="function"){var f=l.value;e.payload=function(){return h(f)},e.callback=function(){Ty(r,s,l)}}var E=s.stateNode;E!==null&&typeof E.componentDidCatch=="function"&&(e.callback=function(){Ty(r,s,l),typeof h!="function"&&(zr===null?zr=new Set([this]):zr.add(this));var b=l.stack;this.componentDidCatch(l.value,{componentStack:b!==null?b:""})})}function Jw(e,r,s,l,h){if(s.flags|=32768,l!==null&&typeof l=="object"&&typeof l.then=="function"){if(r=s.alternate,r!==null&&tl(r,s,h,!0),s=zn.current,s!==null){switch(s.tag){case 13:return yi===null?Vf():s.alternate===null&&xe===0&&(xe=3),s.flags&=-257,s.flags|=65536,s.lanes=h,l===Ld?s.flags|=16384:(r=s.updateQueue,r===null?s.updateQueue=new Set([l]):r.add(l),Pf(e,l,h)),!1;case 22:return s.flags|=65536,l===Ld?s.flags|=16384:(r=s.updateQueue,r===null?(r={transitions:null,markerInstances:null,retryQueue:new Set([l])},s.updateQueue=r):(s=r.retryQueue,s===null?r.retryQueue=new Set([l]):s.add(l)),Pf(e,l,h)),!1}throw Error(a(435,s.tag))}return Pf(e,l,h),Vf(),!1}if(Kt)return r=zn.current,r!==null?((r.flags&65536)===0&&(r.flags|=256),r.flags|=65536,r.lanes=h,l!==Nd&&(e=Error(a(422),{cause:l}),Jo(kn(e,s)))):(l!==Nd&&(r=Error(a(423),{cause:l}),Jo(kn(r,s))),e=e.current.alternate,e.flags|=65536,h&=-h,e.lanes|=h,l=kn(l,s),h=hf(e.stateNode,l,h),Bd(e,h),xe!==4&&(xe=2)),!1;var f=Error(a(520),{cause:l});if(f=kn(f,s),_l===null?_l=[f]:_l.push(f),xe!==4&&(xe=2),r===null)return!0;l=kn(l,s),s=r;do{switch(s.tag){case 3:return s.flags|=65536,e=h&-h,s.lanes|=e,e=hf(s.stateNode,l,e),Bd(s,e),!1;case 1:if(r=s.type,f=s.stateNode,(s.flags&128)===0&&(typeof r.getDerivedStateFromError=="function"||f!==null&&typeof f.componentDidCatch=="function"&&(zr===null||!zr.has(f))))return s.flags|=65536,h&=-h,s.lanes|=h,h=Sy(h),Ay(h,e,s,l),Bd(s,h),!1}s=s.return}while(s!==null);return!1}var Ry=Error(a(461)),$e=!1;function Ge(e,r,s,l){r.child=e===null?yy(r,null,s,l):Vs(r,e.child,s,l)}function Iy(e,r,s,l,h){s=s.render;var f=r.ref;if("ref"in l){var E={};for(var b in l)b!=="ref"&&(E[b]=l[b])}else E=l;return za(r),l=Gd(e,r,s,E,f,h),b=Yd(),e!==null&&!$e?(Qd(e,r,h),Qi(e,r,h)):(Kt&&b&&Cd(r),r.flags|=1,Ge(e,r,l,h),r.child)}function jy(e,r,s,l,h){if(e===null){var f=s.type;return typeof f=="function"&&!Rd(f)&&f.defaultProps===void 0&&s.compare===null?(r.tag=15,r.type=f,Cy(e,r,f,l,h)):(e=Gu(s.type,null,l,r,r.mode,h),e.ref=r.ref,e.return=r,r.child=e)}if(f=e.child,!vf(e,h)){var E=f.memoizedProps;if(s=s.compare,s=s!==null?s:Qo,s(E,l)&&e.ref===r.ref)return Qi(e,r,h)}return r.flags|=1,e=Bi(f,l),e.ref=r.ref,e.return=r,r.child=e}function Cy(e,r,s,l,h){if(e!==null){var f=e.memoizedProps;if(Qo(f,l)&&e.ref===r.ref)if($e=!1,r.pendingProps=l=f,vf(e,h))(e.flags&131072)!==0&&($e=!0);else return r.lanes=e.lanes,Qi(e,r,h)}return df(e,r,s,l,h)}function Dy(e,r,s){var l=r.pendingProps,h=l.children,f=e!==null?e.memoizedState:null;if(l.mode==="hidden"){if((r.flags&128)!==0){if(l=f!==null?f.baseLanes|s:s,e!==null){for(h=r.child=e.child,f=0;h!==null;)f=f|h.lanes|h.childLanes,h=h.sibling;r.childLanes=f&~l}else r.childLanes=0,r.child=null;return Ny(e,r,l,s)}if((s&536870912)!==0)r.memoizedState={baseLanes:0,cachePool:null},e!==null&&Zu(r,f!==null?f.cachePool:null),f!==null?C0(r,f):qd(),xy(r);else return r.lanes=r.childLanes=536870912,Ny(e,r,f!==null?f.baseLanes|s:s,s)}else f!==null?(Zu(r,f.cachePool),C0(r,f),Or(),r.memoizedState=null):(e!==null&&Zu(r,null),qd(),Or());return Ge(e,r,h,s),r.child}function Ny(e,r,s,l){var h=Ud();return h=h===null?null:{parent:ke._currentValue,pool:h},r.memoizedState={baseLanes:s,cachePool:h},e!==null&&Zu(r,null),qd(),xy(r),e!==null&&tl(e,r,l,!0),null}function mc(e,r){var s=r.ref;if(s===null)e!==null&&e.ref!==null&&(r.flags|=4194816);else{if(typeof s!="function"&&typeof s!="object")throw Error(a(284));(e===null||e.ref!==s)&&(r.flags|=4194816)}}function df(e,r,s,l,h){return za(r),s=Gd(e,r,s,l,void 0,h),l=Yd(),e!==null&&!$e?(Qd(e,r,h),Qi(e,r,h)):(Kt&&l&&Cd(r),r.flags|=1,Ge(e,r,s,h),r.child)}function My(e,r,s,l,h,f){return za(r),r.updateQueue=null,s=N0(r,l,s,h),D0(e),l=Yd(),e!==null&&!$e?(Qd(e,r,f),Qi(e,r,f)):(Kt&&l&&Cd(r),r.flags|=1,Ge(e,r,s,f),r.child)}function Oy(e,r,s,l,h){if(za(r),r.stateNode===null){var f=Ss,E=s.contextType;typeof E=="object"&&E!==null&&(f=en(E)),f=new s(l,f),r.memoizedState=f.state!==null&&f.state!==void 0?f.state:null,f.updater=cf,r.stateNode=f,f._reactInternals=r,f=r.stateNode,f.props=l,f.state=r.memoizedState,f.refs={},zd(r),E=s.contextType,f.context=typeof E=="object"&&E!==null?en(E):Ss,f.state=r.memoizedState,E=s.getDerivedStateFromProps,typeof E=="function"&&(uf(r,s,E,l),f.state=r.memoizedState),typeof s.getDerivedStateFromProps=="function"||typeof f.getSnapshotBeforeUpdate=="function"||typeof f.UNSAFE_componentWillMount!="function"&&typeof f.componentWillMount!="function"||(E=f.state,typeof f.componentWillMount=="function"&&f.componentWillMount(),typeof f.UNSAFE_componentWillMount=="function"&&f.UNSAFE_componentWillMount(),E!==f.state&&cf.enqueueReplaceState(f,f.state,null),ol(r,l,f,h),sl(),f.state=r.memoizedState),typeof f.componentDidMount=="function"&&(r.flags|=4194308),l=!0}else if(e===null){f=r.stateNode;var b=r.memoizedProps,N=Fa(s,b);f.props=N;var H=f.context,et=s.contextType;E=Ss,typeof et=="object"&&et!==null&&(E=en(et));var rt=s.getDerivedStateFromProps;et=typeof rt=="function"||typeof f.getSnapshotBeforeUpdate=="function",b=r.pendingProps!==b,et||typeof f.UNSAFE_componentWillReceiveProps!="function"&&typeof f.componentWillReceiveProps!="function"||(b||H!==E)&&_y(r,f,l,E),jr=!1;var G=r.memoizedState;f.state=G,ol(r,l,f,h),sl(),H=r.memoizedState,b||G!==H||jr?(typeof rt=="function"&&(uf(r,s,rt,l),H=r.memoizedState),(N=jr||vy(r,s,N,l,G,H,E))?(et||typeof f.UNSAFE_componentWillMount!="function"&&typeof f.componentWillMount!="function"||(typeof f.componentWillMount=="function"&&f.componentWillMount(),typeof f.UNSAFE_componentWillMount=="function"&&f.UNSAFE_componentWillMount()),typeof f.componentDidMount=="function"&&(r.flags|=4194308)):(typeof f.componentDidMount=="function"&&(r.flags|=4194308),r.memoizedProps=l,r.memoizedState=H),f.props=l,f.state=H,f.context=E,l=N):(typeof f.componentDidMount=="function"&&(r.flags|=4194308),l=!1)}else{f=r.stateNode,$d(e,r),E=r.memoizedProps,et=Fa(s,E),f.props=et,rt=r.pendingProps,G=f.context,H=s.contextType,N=Ss,typeof H=="object"&&H!==null&&(N=en(H)),b=s.getDerivedStateFromProps,(H=typeof b=="function"||typeof f.getSnapshotBeforeUpdate=="function")||typeof f.UNSAFE_componentWillReceiveProps!="function"&&typeof f.componentWillReceiveProps!="function"||(E!==rt||G!==N)&&_y(r,f,l,N),jr=!1,G=r.memoizedState,f.state=G,ol(r,l,f,h),sl();var Q=r.memoizedState;E!==rt||G!==Q||jr||e!==null&&e.dependencies!==null&&Xu(e.dependencies)?(typeof b=="function"&&(uf(r,s,b,l),Q=r.memoizedState),(et=jr||vy(r,s,et,l,G,Q,N)||e!==null&&e.dependencies!==null&&Xu(e.dependencies))?(H||typeof f.UNSAFE_componentWillUpdate!="function"&&typeof f.componentWillUpdate!="function"||(typeof f.componentWillUpdate=="function"&&f.componentWillUpdate(l,Q,N),typeof f.UNSAFE_componentWillUpdate=="function"&&f.UNSAFE_componentWillUpdate(l,Q,N)),typeof f.componentDidUpdate=="function"&&(r.flags|=4),typeof f.getSnapshotBeforeUpdate=="function"&&(r.flags|=1024)):(typeof f.componentDidUpdate!="function"||E===e.memoizedProps&&G===e.memoizedState||(r.flags|=4),typeof f.getSnapshotBeforeUpdate!="function"||E===e.memoizedProps&&G===e.memoizedState||(r.flags|=1024),r.memoizedProps=l,r.memoizedState=Q),f.props=l,f.state=Q,f.context=N,l=et):(typeof f.componentDidUpdate!="function"||E===e.memoizedProps&&G===e.memoizedState||(r.flags|=4),typeof f.getSnapshotBeforeUpdate!="function"||E===e.memoizedProps&&G===e.memoizedState||(r.flags|=1024),l=!1)}return f=l,mc(e,r),l=(r.flags&128)!==0,f||l?(f=r.stateNode,s=l&&typeof s.getDerivedStateFromError!="function"?null:f.render(),r.flags|=1,e!==null&&l?(r.child=Vs(r,e.child,null,h),r.child=Vs(r,null,s,h)):Ge(e,r,s,h),r.memoizedState=f.state,e=r.child):e=Qi(e,r,h),e}function Vy(e,r,s,l){return Zo(),r.flags|=256,Ge(e,r,s,l),r.child}var ff={dehydrated:null,treeContext:null,retryLane:0,hydrationErrors:null};function pf(e){return{baseLanes:e,cachePool:w0()}}function mf(e,r,s){return e=e!==null?e.childLanes&~s:0,r&&(e|=$n),e}function ky(e,r,s){var l=r.pendingProps,h=!1,f=(r.flags&128)!==0,E;if((E=f)||(E=e!==null&&e.memoizedState===null?!1:(Pe.current&2)!==0),E&&(h=!0,r.flags&=-129),E=(r.flags&32)!==0,r.flags&=-33,e===null){if(Kt){if(h?Mr(r):Or(),Kt){var b=ye,N;if(N=b){t:{for(N=b,b=gi;N.nodeType!==8;){if(!b){b=null;break t}if(N=ni(N.nextSibling),N===null){b=null;break t}}b=N}b!==null?(r.memoizedState={dehydrated:b,treeContext:Va!==null?{id:Fi,overflow:qi}:null,retryLane:536870912,hydrationErrors:null},N=bn(18,null,null,0),N.stateNode=b,N.return=r,r.child=N,dn=r,ye=null,N=!0):N=!1}N||Ua(r)}if(b=r.memoizedState,b!==null&&(b=b.dehydrated,b!==null))return Zf(b)?r.lanes=32:r.lanes=536870912,null;Yi(r)}return b=l.children,l=l.fallback,h?(Or(),h=r.mode,b=gc({mode:"hidden",children:b},h),l=Oa(l,h,s,null),b.return=r,l.return=r,b.sibling=l,r.child=b,h=r.child,h.memoizedState=pf(s),h.childLanes=mf(e,E,s),r.memoizedState=ff,l):(Mr(r),gf(r,b))}if(N=e.memoizedState,N!==null&&(b=N.dehydrated,b!==null)){if(f)r.flags&256?(Mr(r),r.flags&=-257,r=yf(e,r,s)):r.memoizedState!==null?(Or(),r.child=e.child,r.flags|=128,r=null):(Or(),h=l.fallback,b=r.mode,l=gc({mode:"visible",children:l.children},b),h=Oa(h,b,s,null),h.flags|=2,l.return=r,h.return=r,l.sibling=h,r.child=l,Vs(r,e.child,null,s),l=r.child,l.memoizedState=pf(s),l.childLanes=mf(e,E,s),r.memoizedState=ff,r=h);else if(Mr(r),Zf(b)){if(E=b.nextSibling&&b.nextSibling.dataset,E)var H=E.dgst;E=H,l=Error(a(419)),l.stack="",l.digest=E,Jo({value:l,source:null,stack:null}),r=yf(e,r,s)}else if($e||tl(e,r,s,!1),E=(s&e.childLanes)!==0,$e||E){if(E=re,E!==null&&(l=s&-s,l=(l&42)!==0?1:No(l),l=(l&(E.suspendedLanes|s))!==0?0:l,l!==0&&l!==N.retryLane))throw N.retryLane=l,Ts(e,l),In(E,e,l),Ry;b.data==="$?"||Vf(),r=yf(e,r,s)}else b.data==="$?"?(r.flags|=192,r.child=e.child,r=null):(e=N.treeContext,ye=ni(b.nextSibling),dn=r,Kt=!0,Pa=null,gi=!1,e!==null&&(Un[Ln++]=Fi,Un[Ln++]=qi,Un[Ln++]=Va,Fi=e.id,qi=e.overflow,Va=r),r=gf(r,l.children),r.flags|=4096);return r}return h?(Or(),h=l.fallback,b=r.mode,N=e.child,H=N.sibling,l=Bi(N,{mode:"hidden",children:l.children}),l.subtreeFlags=N.subtreeFlags&65011712,H!==null?h=Bi(H,h):(h=Oa(h,b,s,null),h.flags|=2),h.return=r,l.return=r,l.sibling=h,r.child=l,l=h,h=r.child,b=e.child.memoizedState,b===null?b=pf(s):(N=b.cachePool,N!==null?(H=ke._currentValue,N=N.parent!==H?{parent:H,pool:H}:N):N=w0(),b={baseLanes:b.baseLanes|s,cachePool:N}),h.memoizedState=b,h.childLanes=mf(e,E,s),r.memoizedState=ff,l):(Mr(r),s=e.child,e=s.sibling,s=Bi(s,{mode:"visible",children:l.children}),s.return=r,s.sibling=null,e!==null&&(E=r.deletions,E===null?(r.deletions=[e],r.flags|=16):E.push(e)),r.child=s,r.memoizedState=null,s)}function gf(e,r){return r=gc({mode:"visible",children:r},e.mode),r.return=e,e.child=r}function gc(e,r){return e=bn(22,e,null,r),e.lanes=0,e.stateNode={_visibility:1,_pendingMarkers:null,_retryCache:null,_transitions:null},e}function yf(e,r,s){return Vs(r,e.child,null,s),e=gf(r,r.pendingProps.children),e.flags|=2,r.memoizedState=null,e}function Py(e,r,s){e.lanes|=r;var l=e.alternate;l!==null&&(l.lanes|=r),Od(e.return,r,s)}function xf(e,r,s,l,h){var f=e.memoizedState;f===null?e.memoizedState={isBackwards:r,rendering:null,renderingStartTime:0,last:l,tail:s,tailMode:h}:(f.isBackwards=r,f.rendering=null,f.renderingStartTime=0,f.last=l,f.tail=s,f.tailMode=h)}function Uy(e,r,s){var l=r.pendingProps,h=l.revealOrder,f=l.tail;if(Ge(e,r,l.children,s),l=Pe.current,(l&2)!==0)l=l&1|2,r.flags|=128;else{if(e!==null&&(e.flags&128)!==0)t:for(e=r.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&Py(e,s,r);else if(e.tag===19)Py(e,s,r);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===r)break t;for(;e.sibling===null;){if(e.return===null||e.return===r)break t;e=e.return}e.sibling.return=e.return,e=e.sibling}l&=1}switch(ht(Pe,l),h){case"forwards":for(s=r.child,h=null;s!==null;)e=s.alternate,e!==null&&dc(e)===null&&(h=s),s=s.sibling;s=h,s===null?(h=r.child,r.child=null):(h=s.sibling,s.sibling=null),xf(r,!1,h,s,f);break;case"backwards":for(s=null,h=r.child,r.child=null;h!==null;){if(e=h.alternate,e!==null&&dc(e)===null){r.child=h;break}e=h.sibling,h.sibling=s,s=h,h=e}xf(r,!0,s,null,f);break;case"together":xf(r,!1,null,null,void 0);break;default:r.memoizedState=null}return r.child}function Qi(e,r,s){if(e!==null&&(r.dependencies=e.dependencies),Lr|=r.lanes,(s&r.childLanes)===0)if(e!==null){if(tl(e,r,s,!1),(s&r.childLanes)===0)return null}else return null;if(e!==null&&r.child!==e.child)throw Error(a(153));if(r.child!==null){for(e=r.child,s=Bi(e,e.pendingProps),r.child=s,s.return=r;e.sibling!==null;)e=e.sibling,s=s.sibling=Bi(e,e.pendingProps),s.return=r;s.sibling=null}return r.child}function vf(e,r){return(e.lanes&r)!==0?!0:(e=e.dependencies,!!(e!==null&&Xu(e)))}function tb(e,r,s){switch(r.tag){case 3:Lt(r,r.stateNode.containerInfo),Ir(r,ke,e.memoizedState.cache),Zo();break;case 27:case 5:Mi(r);break;case 4:Lt(r,r.stateNode.containerInfo);break;case 10:Ir(r,r.type,r.memoizedProps.value);break;case 13:var l=r.memoizedState;if(l!==null)return l.dehydrated!==null?(Mr(r),r.flags|=128,null):(s&r.child.childLanes)!==0?ky(e,r,s):(Mr(r),e=Qi(e,r,s),e!==null?e.sibling:null);Mr(r);break;case 19:var h=(e.flags&128)!==0;if(l=(s&r.childLanes)!==0,l||(tl(e,r,s,!1),l=(s&r.childLanes)!==0),h){if(l)return Uy(e,r,s);r.flags|=128}if(h=r.memoizedState,h!==null&&(h.rendering=null,h.tail=null,h.lastEffect=null),ht(Pe,Pe.current),l)break;return null;case 22:case 23:return r.lanes=0,Dy(e,r,s);case 24:Ir(r,ke,e.memoizedState.cache)}return Qi(e,r,s)}function Ly(e,r,s){if(e!==null)if(e.memoizedProps!==r.pendingProps)$e=!0;else{if(!vf(e,s)&&(r.flags&128)===0)return $e=!1,tb(e,r,s);$e=(e.flags&131072)!==0}else $e=!1,Kt&&(r.flags&1048576)!==0&&m0(r,Qu,r.index);switch(r.lanes=0,r.tag){case 16:t:{e=r.pendingProps;var l=r.elementType,h=l._init;if(l=h(l._payload),r.type=l,typeof l=="function")Rd(l)?(e=Fa(l,e),r.tag=1,r=Oy(null,r,l,e,s)):(r.tag=0,r=df(null,r,l,e,s));else{if(l!=null){if(h=l.$$typeof,h===lt){r.tag=11,r=Iy(null,r,l,e,s);break t}else if(h===j){r.tag=14,r=jy(null,r,l,e,s);break t}}throw r=se(l)||l,Error(a(306,r,""))}}return r;case 0:return df(e,r,r.type,r.pendingProps,s);case 1:return l=r.type,h=Fa(l,r.pendingProps),Oy(e,r,l,h,s);case 3:t:{if(Lt(r,r.stateNode.containerInfo),e===null)throw Error(a(387));l=r.pendingProps;var f=r.memoizedState;h=f.element,$d(e,r),ol(r,l,null,s);var E=r.memoizedState;if(l=E.cache,Ir(r,ke,l),l!==f.cache&&Vd(r,[ke],s,!0),sl(),l=E.element,f.isDehydrated)if(f={element:l,isDehydrated:!1,cache:E.cache},r.updateQueue.baseState=f,r.memoizedState=f,r.flags&256){r=Vy(e,r,l,s);break t}else if(l!==h){h=kn(Error(a(424)),r),Jo(h),r=Vy(e,r,l,s);break t}else{switch(e=r.stateNode.containerInfo,e.nodeType){case 9:e=e.body;break;default:e=e.nodeName==="HTML"?e.ownerDocument.body:e}for(ye=ni(e.firstChild),dn=r,Kt=!0,Pa=null,gi=!0,s=yy(r,null,l,s),r.child=s;s;)s.flags=s.flags&-3|4096,s=s.sibling}else{if(Zo(),l===h){r=Qi(e,r,s);break t}Ge(e,r,l,s)}r=r.child}return r;case 26:return mc(e,r),e===null?(s=F1(r.type,null,r.pendingProps,null))?r.memoizedState=s:Kt||(s=r.type,e=r.pendingProps,l=Cc(_t.current).createElement(s),l[_e]=r,l[He]=e,Qe(l,s,e),Ee(l),r.stateNode=l):r.memoizedState=F1(r.type,e.memoizedProps,r.pendingProps,e.memoizedState),null;case 27:return Mi(r),e===null&&Kt&&(l=r.stateNode=z1(r.type,r.pendingProps,_t.current),dn=r,gi=!0,h=ye,Fr(r.type)?(Jf=h,ye=ni(l.firstChild)):ye=h),Ge(e,r,r.pendingProps.children,s),mc(e,r),e===null&&(r.flags|=4194304),r.child;case 5:return e===null&&Kt&&((h=l=ye)&&(l=Ib(l,r.type,r.pendingProps,gi),l!==null?(r.stateNode=l,dn=r,ye=ni(l.firstChild),gi=!1,h=!0):h=!1),h||Ua(r)),Mi(r),h=r.type,f=r.pendingProps,E=e!==null?e.memoizedProps:null,l=f.children,Qf(h,f)?l=null:E!==null&&Qf(h,E)&&(r.flags|=32),r.memoizedState!==null&&(h=Gd(e,r,Hw,null,null,s),jl._currentValue=h),mc(e,r),Ge(e,r,l,s),r.child;case 6:return e===null&&Kt&&((e=s=ye)&&(s=jb(s,r.pendingProps,gi),s!==null?(r.stateNode=s,dn=r,ye=null,e=!0):e=!1),e||Ua(r)),null;case 13:return ky(e,r,s);case 4:return Lt(r,r.stateNode.containerInfo),l=r.pendingProps,e===null?r.child=Vs(r,null,l,s):Ge(e,r,l,s),r.child;case 11:return Iy(e,r,r.type,r.pendingProps,s);case 7:return Ge(e,r,r.pendingProps,s),r.child;case 8:return Ge(e,r,r.pendingProps.children,s),r.child;case 12:return Ge(e,r,r.pendingProps.children,s),r.child;case 10:return l=r.pendingProps,Ir(r,r.type,l.value),Ge(e,r,l.children,s),r.child;case 9:return h=r.type._context,l=r.pendingProps.children,za(r),h=en(h),l=l(h),r.flags|=1,Ge(e,r,l,s),r.child;case 14:return jy(e,r,r.type,r.pendingProps,s);case 15:return Cy(e,r,r.type,r.pendingProps,s);case 19:return Uy(e,r,s);case 31:return l=r.pendingProps,s=r.mode,l={mode:l.mode,children:l.children},e===null?(s=gc(l,s),s.ref=r.ref,r.child=s,s.return=r,r=s):(s=Bi(e.child,l),s.ref=r.ref,r.child=s,s.return=r,r=s),r;case 22:return Dy(e,r,s);case 24:return za(r),l=en(ke),e===null?(h=Ud(),h===null&&(h=re,f=kd(),h.pooledCache=f,f.refCount++,f!==null&&(h.pooledCacheLanes|=s),h=f),r.memoizedState={parent:l,cache:h},zd(r),Ir(r,ke,h)):((e.lanes&s)!==0&&($d(e,r),ol(r,null,null,s),sl()),h=e.memoizedState,f=r.memoizedState,h.parent!==l?(h={parent:l,cache:l},r.memoizedState=h,r.lanes===0&&(r.memoizedState=r.updateQueue.baseState=h),Ir(r,ke,l)):(l=f.cache,Ir(r,ke,l),l!==h.cache&&Vd(r,[ke],s,!0))),Ge(e,r,r.pendingProps.children,s),r.child;case 29:throw r.pendingProps}throw Error(a(156,r.tag))}function Xi(e){e.flags|=4}function zy(e,r){if(r.type!=="stylesheet"||(r.state.loading&4)!==0)e.flags&=-16777217;else if(e.flags|=16777216,!Y1(r)){if(r=zn.current,r!==null&&((zt&4194048)===zt?yi!==null:(zt&62914560)!==zt&&(zt&536870912)===0||r!==yi))throw rl=Ld,b0;e.flags|=8192}}function yc(e,r){r!==null&&(e.flags|=4),e.flags&16384&&(r=e.tag!==22?mr():536870912,e.lanes|=r,Ls|=r)}function pl(e,r){if(!Kt)switch(e.tailMode){case"hidden":r=e.tail;for(var s=null;r!==null;)r.alternate!==null&&(s=r),r=r.sibling;s===null?e.tail=null:s.sibling=null;break;case"collapsed":s=e.tail;for(var l=null;s!==null;)s.alternate!==null&&(l=s),s=s.sibling;l===null?r||e.tail===null?e.tail=null:e.tail.sibling=null:l.sibling=null}}function pe(e){var r=e.alternate!==null&&e.alternate.child===e.child,s=0,l=0;if(r)for(var h=e.child;h!==null;)s|=h.lanes|h.childLanes,l|=h.subtreeFlags&65011712,l|=h.flags&65011712,h.return=e,h=h.sibling;else for(h=e.child;h!==null;)s|=h.lanes|h.childLanes,l|=h.subtreeFlags,l|=h.flags,h.return=e,h=h.sibling;return e.subtreeFlags|=l,e.childLanes=s,r}function eb(e,r,s){var l=r.pendingProps;switch(Dd(r),r.tag){case 31:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return pe(r),null;case 1:return pe(r),null;case 3:return s=r.stateNode,l=null,e!==null&&(l=e.memoizedState.cache),r.memoizedState.cache!==l&&(r.flags|=2048),Hi(ke),Me(),s.pendingContext&&(s.context=s.pendingContext,s.pendingContext=null),(e===null||e.child===null)&&(Wo(r)?Xi(r):e===null||e.memoizedState.isDehydrated&&(r.flags&256)===0||(r.flags|=1024,x0())),pe(r),null;case 26:return s=r.memoizedState,e===null?(Xi(r),s!==null?(pe(r),zy(r,s)):(pe(r),r.flags&=-16777217)):s?s!==e.memoizedState?(Xi(r),pe(r),zy(r,s)):(pe(r),r.flags&=-16777217):(e.memoizedProps!==l&&Xi(r),pe(r),r.flags&=-16777217),null;case 27:Hn(r),s=_t.current;var h=r.type;if(e!==null&&r.stateNode!=null)e.memoizedProps!==l&&Xi(r);else{if(!l){if(r.stateNode===null)throw Error(a(166));return pe(r),null}e=gt.current,Wo(r)?g0(r):(e=z1(h,l,s),r.stateNode=e,Xi(r))}return pe(r),null;case 5:if(Hn(r),s=r.type,e!==null&&r.stateNode!=null)e.memoizedProps!==l&&Xi(r);else{if(!l){if(r.stateNode===null)throw Error(a(166));return pe(r),null}if(e=gt.current,Wo(r))g0(r);else{switch(h=Cc(_t.current),e){case 1:e=h.createElementNS("http://www.w3.org/2000/svg",s);break;case 2:e=h.createElementNS("http://www.w3.org/1998/Math/MathML",s);break;default:switch(s){case"svg":e=h.createElementNS("http://www.w3.org/2000/svg",s);break;case"math":e=h.createElementNS("http://www.w3.org/1998/Math/MathML",s);break;case"script":e=h.createElement("div"),e.innerHTML="<script><\/script>",e=e.removeChild(e.firstChild);break;case"select":e=typeof l.is=="string"?h.createElement("select",{is:l.is}):h.createElement("select"),l.multiple?e.multiple=!0:l.size&&(e.size=l.size);break;default:e=typeof l.is=="string"?h.createElement(s,{is:l.is}):h.createElement(s)}}e[_e]=r,e[He]=l;t:for(h=r.child;h!==null;){if(h.tag===5||h.tag===6)e.appendChild(h.stateNode);else if(h.tag!==4&&h.tag!==27&&h.child!==null){h.child.return=h,h=h.child;continue}if(h===r)break t;for(;h.sibling===null;){if(h.return===null||h.return===r)break t;h=h.return}h.sibling.return=h.return,h=h.sibling}r.stateNode=e;t:switch(Qe(e,s,l),s){case"button":case"input":case"select":case"textarea":e=!!l.autoFocus;break t;case"img":e=!0;break t;default:e=!1}e&&Xi(r)}}return pe(r),r.flags&=-16777217,null;case 6:if(e&&r.stateNode!=null)e.memoizedProps!==l&&Xi(r);else{if(typeof l!="string"&&r.stateNode===null)throw Error(a(166));if(e=_t.current,Wo(r)){if(e=r.stateNode,s=r.memoizedProps,l=null,h=dn,h!==null)switch(h.tag){case 27:case 5:l=h.memoizedProps}e[_e]=r,e=!!(e.nodeValue===s||l!==null&&l.suppressHydrationWarning===!0||M1(e.nodeValue,s)),e||Ua(r)}else e=Cc(e).createTextNode(l),e[_e]=r,r.stateNode=e}return pe(r),null;case 13:if(l=r.memoizedState,e===null||e.memoizedState!==null&&e.memoizedState.dehydrated!==null){if(h=Wo(r),l!==null&&l.dehydrated!==null){if(e===null){if(!h)throw Error(a(318));if(h=r.memoizedState,h=h!==null?h.dehydrated:null,!h)throw Error(a(317));h[_e]=r}else Zo(),(r.flags&128)===0&&(r.memoizedState=null),r.flags|=4;pe(r),h=!1}else h=x0(),e!==null&&e.memoizedState!==null&&(e.memoizedState.hydrationErrors=h),h=!0;if(!h)return r.flags&256?(Yi(r),r):(Yi(r),null)}if(Yi(r),(r.flags&128)!==0)return r.lanes=s,r;if(s=l!==null,e=e!==null&&e.memoizedState!==null,s){l=r.child,h=null,l.alternate!==null&&l.alternate.memoizedState!==null&&l.alternate.memoizedState.cachePool!==null&&(h=l.alternate.memoizedState.cachePool.pool);var f=null;l.memoizedState!==null&&l.memoizedState.cachePool!==null&&(f=l.memoizedState.cachePool.pool),f!==h&&(l.flags|=2048)}return s!==e&&s&&(r.child.flags|=8192),yc(r,r.updateQueue),pe(r),null;case 4:return Me(),e===null&&qf(r.stateNode.containerInfo),pe(r),null;case 10:return Hi(r.type),pe(r),null;case 19:if(ct(Pe),h=r.memoizedState,h===null)return pe(r),null;if(l=(r.flags&128)!==0,f=h.rendering,f===null)if(l)pl(h,!1);else{if(xe!==0||e!==null&&(e.flags&128)!==0)for(e=r.child;e!==null;){if(f=dc(e),f!==null){for(r.flags|=128,pl(h,!1),e=f.updateQueue,r.updateQueue=e,yc(r,e),r.subtreeFlags=0,e=s,s=r.child;s!==null;)p0(s,e),s=s.sibling;return ht(Pe,Pe.current&1|2),r.child}e=e.sibling}h.tail!==null&&pn()>_c&&(r.flags|=128,l=!0,pl(h,!1),r.lanes=4194304)}else{if(!l)if(e=dc(f),e!==null){if(r.flags|=128,l=!0,e=e.updateQueue,r.updateQueue=e,yc(r,e),pl(h,!0),h.tail===null&&h.tailMode==="hidden"&&!f.alternate&&!Kt)return pe(r),null}else 2*pn()-h.renderingStartTime>_c&&s!==536870912&&(r.flags|=128,l=!0,pl(h,!1),r.lanes=4194304);h.isBackwards?(f.sibling=r.child,r.child=f):(e=h.last,e!==null?e.sibling=f:r.child=f,h.last=f)}return h.tail!==null?(r=h.tail,h.rendering=r,h.tail=r.sibling,h.renderingStartTime=pn(),r.sibling=null,e=Pe.current,ht(Pe,l?e&1|2:e&1),r):(pe(r),null);case 22:case 23:return Yi(r),Kd(),l=r.memoizedState!==null,e!==null?e.memoizedState!==null!==l&&(r.flags|=8192):l&&(r.flags|=8192),l?(s&536870912)!==0&&(r.flags&128)===0&&(pe(r),r.subtreeFlags&6&&(r.flags|=8192)):pe(r),s=r.updateQueue,s!==null&&yc(r,s.retryQueue),s=null,e!==null&&e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(s=e.memoizedState.cachePool.pool),l=null,r.memoizedState!==null&&r.memoizedState.cachePool!==null&&(l=r.memoizedState.cachePool.pool),l!==s&&(r.flags|=2048),e!==null&&ct($a),null;case 24:return s=null,e!==null&&(s=e.memoizedState.cache),r.memoizedState.cache!==s&&(r.flags|=2048),Hi(ke),pe(r),null;case 25:return null;case 30:return null}throw Error(a(156,r.tag))}function nb(e,r){switch(Dd(r),r.tag){case 1:return e=r.flags,e&65536?(r.flags=e&-65537|128,r):null;case 3:return Hi(ke),Me(),e=r.flags,(e&65536)!==0&&(e&128)===0?(r.flags=e&-65537|128,r):null;case 26:case 27:case 5:return Hn(r),null;case 13:if(Yi(r),e=r.memoizedState,e!==null&&e.dehydrated!==null){if(r.alternate===null)throw Error(a(340));Zo()}return e=r.flags,e&65536?(r.flags=e&-65537|128,r):null;case 19:return ct(Pe),null;case 4:return Me(),null;case 10:return Hi(r.type),null;case 22:case 23:return Yi(r),Kd(),e!==null&&ct($a),e=r.flags,e&65536?(r.flags=e&-65537|128,r):null;case 24:return Hi(ke),null;case 25:return null;default:return null}}function $y(e,r){switch(Dd(r),r.tag){case 3:Hi(ke),Me();break;case 26:case 27:case 5:Hn(r);break;case 4:Me();break;case 13:Yi(r);break;case 19:ct(Pe);break;case 10:Hi(r.type);break;case 22:case 23:Yi(r),Kd(),e!==null&&ct($a);break;case 24:Hi(ke)}}function ml(e,r){try{var s=r.updateQueue,l=s!==null?s.lastEffect:null;if(l!==null){var h=l.next;s=h;do{if((s.tag&e)===e){l=void 0;var f=s.create,E=s.inst;l=f(),E.destroy=l}s=s.next}while(s!==h)}}catch(b){ne(r,r.return,b)}}function Vr(e,r,s){try{var l=r.updateQueue,h=l!==null?l.lastEffect:null;if(h!==null){var f=h.next;l=f;do{if((l.tag&e)===e){var E=l.inst,b=E.destroy;if(b!==void 0){E.destroy=void 0,h=r;var N=s,H=b;try{H()}catch(et){ne(h,N,et)}}}l=l.next}while(l!==f)}}catch(et){ne(r,r.return,et)}}function By(e){var r=e.updateQueue;if(r!==null){var s=e.stateNode;try{j0(r,s)}catch(l){ne(e,e.return,l)}}}function Fy(e,r,s){s.props=Fa(e.type,e.memoizedProps),s.state=e.memoizedState;try{s.componentWillUnmount()}catch(l){ne(e,r,l)}}function gl(e,r){try{var s=e.ref;if(s!==null){switch(e.tag){case 26:case 27:case 5:var l=e.stateNode;break;case 30:l=e.stateNode;break;default:l=e.stateNode}typeof s=="function"?e.refCleanup=s(l):s.current=l}}catch(h){ne(e,r,h)}}function xi(e,r){var s=e.ref,l=e.refCleanup;if(s!==null)if(typeof l=="function")try{l()}catch(h){ne(e,r,h)}finally{e.refCleanup=null,e=e.alternate,e!=null&&(e.refCleanup=null)}else if(typeof s=="function")try{s(null)}catch(h){ne(e,r,h)}else s.current=null}function qy(e){var r=e.type,s=e.memoizedProps,l=e.stateNode;try{t:switch(r){case"button":case"input":case"select":case"textarea":s.autoFocus&&l.focus();break t;case"img":s.src?l.src=s.src:s.srcSet&&(l.srcset=s.srcSet)}}catch(h){ne(e,e.return,h)}}function _f(e,r,s){try{var l=e.stateNode;bb(l,e.type,s,r),l[He]=r}catch(h){ne(e,e.return,h)}}function Ky(e){return e.tag===5||e.tag===3||e.tag===26||e.tag===27&&Fr(e.type)||e.tag===4}function Ef(e){t:for(;;){for(;e.sibling===null;){if(e.return===null||Ky(e.return))return null;e=e.return}for(e.sibling.return=e.return,e=e.sibling;e.tag!==5&&e.tag!==6&&e.tag!==18;){if(e.tag===27&&Fr(e.type)||e.flags&2||e.child===null||e.tag===4)continue t;e.child.return=e,e=e.child}if(!(e.flags&2))return e.stateNode}}function wf(e,r,s){var l=e.tag;if(l===5||l===6)e=e.stateNode,r?(s.nodeType===9?s.body:s.nodeName==="HTML"?s.ownerDocument.body:s).insertBefore(e,r):(r=s.nodeType===9?s.body:s.nodeName==="HTML"?s.ownerDocument.body:s,r.appendChild(e),s=s._reactRootContainer,s!=null||r.onclick!==null||(r.onclick=jc));else if(l!==4&&(l===27&&Fr(e.type)&&(s=e.stateNode,r=null),e=e.child,e!==null))for(wf(e,r,s),e=e.sibling;e!==null;)wf(e,r,s),e=e.sibling}function xc(e,r,s){var l=e.tag;if(l===5||l===6)e=e.stateNode,r?s.insertBefore(e,r):s.appendChild(e);else if(l!==4&&(l===27&&Fr(e.type)&&(s=e.stateNode),e=e.child,e!==null))for(xc(e,r,s),e=e.sibling;e!==null;)xc(e,r,s),e=e.sibling}function Hy(e){var r=e.stateNode,s=e.memoizedProps;try{for(var l=e.type,h=r.attributes;h.length;)r.removeAttributeNode(h[0]);Qe(r,l,s),r[_e]=e,r[He]=s}catch(f){ne(e,e.return,f)}}var Wi=!1,Te=!1,bf=!1,Gy=typeof WeakSet=="function"?WeakSet:Set,Be=null;function ib(e,r){if(e=e.containerInfo,Gf=kc,e=r0(e),_d(e)){if("selectionStart"in e)var s={start:e.selectionStart,end:e.selectionEnd};else t:{s=(s=e.ownerDocument)&&s.defaultView||window;var l=s.getSelection&&s.getSelection();if(l&&l.rangeCount!==0){s=l.anchorNode;var h=l.anchorOffset,f=l.focusNode;l=l.focusOffset;try{s.nodeType,f.nodeType}catch{s=null;break t}var E=0,b=-1,N=-1,H=0,et=0,rt=e,G=null;e:for(;;){for(var Q;rt!==s||h!==0&&rt.nodeType!==3||(b=E+h),rt!==f||l!==0&&rt.nodeType!==3||(N=E+l),rt.nodeType===3&&(E+=rt.nodeValue.length),(Q=rt.firstChild)!==null;)G=rt,rt=Q;for(;;){if(rt===e)break e;if(G===s&&++H===h&&(b=E),G===f&&++et===l&&(N=E),(Q=rt.nextSibling)!==null)break;rt=G,G=rt.parentNode}rt=Q}s=b===-1||N===-1?null:{start:b,end:N}}else s=null}s=s||{start:0,end:0}}else s=null;for(Yf={focusedElem:e,selectionRange:s},kc=!1,Be=r;Be!==null;)if(r=Be,e=r.child,(r.subtreeFlags&1024)!==0&&e!==null)e.return=r,Be=e;else for(;Be!==null;){switch(r=Be,f=r.alternate,e=r.flags,r.tag){case 0:break;case 11:case 15:break;case 1:if((e&1024)!==0&&f!==null){e=void 0,s=r,h=f.memoizedProps,f=f.memoizedState,l=s.stateNode;try{var Tt=Fa(s.type,h,s.elementType===s.type);e=l.getSnapshotBeforeUpdate(Tt,f),l.__reactInternalSnapshotBeforeUpdate=e}catch(Et){ne(s,s.return,Et)}}break;case 3:if((e&1024)!==0){if(e=r.stateNode.containerInfo,s=e.nodeType,s===9)Wf(e);else if(s===1)switch(e.nodeName){case"HEAD":case"HTML":case"BODY":Wf(e);break;default:e.textContent=""}}break;case 5:case 26:case 27:case 6:case 4:case 17:break;default:if((e&1024)!==0)throw Error(a(163))}if(e=r.sibling,e!==null){e.return=r.return,Be=e;break}Be=r.return}}function Yy(e,r,s){var l=s.flags;switch(s.tag){case 0:case 11:case 15:kr(e,s),l&4&&ml(5,s);break;case 1:if(kr(e,s),l&4)if(e=s.stateNode,r===null)try{e.componentDidMount()}catch(E){ne(s,s.return,E)}else{var h=Fa(s.type,r.memoizedProps);r=r.memoizedState;try{e.componentDidUpdate(h,r,e.__reactInternalSnapshotBeforeUpdate)}catch(E){ne(s,s.return,E)}}l&64&&By(s),l&512&&gl(s,s.return);break;case 3:if(kr(e,s),l&64&&(e=s.updateQueue,e!==null)){if(r=null,s.child!==null)switch(s.child.tag){case 27:case 5:r=s.child.stateNode;break;case 1:r=s.child.stateNode}try{j0(e,r)}catch(E){ne(s,s.return,E)}}break;case 27:r===null&&l&4&&Hy(s);case 26:case 5:kr(e,s),r===null&&l&4&&qy(s),l&512&&gl(s,s.return);break;case 12:kr(e,s);break;case 13:kr(e,s),l&4&&Wy(e,s),l&64&&(e=s.memoizedState,e!==null&&(e=e.dehydrated,e!==null&&(s=db.bind(null,s),Cb(e,s))));break;case 22:if(l=s.memoizedState!==null||Wi,!l){r=r!==null&&r.memoizedState!==null||Te,h=Wi;var f=Te;Wi=l,(Te=r)&&!f?Pr(e,s,(s.subtreeFlags&8772)!==0):kr(e,s),Wi=h,Te=f}break;case 30:break;default:kr(e,s)}}function Qy(e){var r=e.alternate;r!==null&&(e.alternate=null,Qy(r)),e.child=null,e.deletions=null,e.sibling=null,e.tag===5&&(r=e.stateNode,r!==null&&us(r)),e.stateNode=null,e.return=null,e.dependencies=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.stateNode=null,e.updateQueue=null}var ce=null,gn=!1;function Zi(e,r,s){for(s=s.child;s!==null;)Xy(e,r,s),s=s.sibling}function Xy(e,r,s){if(Je&&typeof Je.onCommitFiberUnmount=="function")try{Je.onCommitFiberUnmount(dr,s)}catch{}switch(s.tag){case 26:Te||xi(s,r),Zi(e,r,s),s.memoizedState?s.memoizedState.count--:s.stateNode&&(s=s.stateNode,s.parentNode.removeChild(s));break;case 27:Te||xi(s,r);var l=ce,h=gn;Fr(s.type)&&(ce=s.stateNode,gn=!1),Zi(e,r,s),Sl(s.stateNode),ce=l,gn=h;break;case 5:Te||xi(s,r);case 6:if(l=ce,h=gn,ce=null,Zi(e,r,s),ce=l,gn=h,ce!==null)if(gn)try{(ce.nodeType===9?ce.body:ce.nodeName==="HTML"?ce.ownerDocument.body:ce).removeChild(s.stateNode)}catch(f){ne(s,r,f)}else try{ce.removeChild(s.stateNode)}catch(f){ne(s,r,f)}break;case 18:ce!==null&&(gn?(e=ce,U1(e.nodeType===9?e.body:e.nodeName==="HTML"?e.ownerDocument.body:e,s.stateNode),Ml(e)):U1(ce,s.stateNode));break;case 4:l=ce,h=gn,ce=s.stateNode.containerInfo,gn=!0,Zi(e,r,s),ce=l,gn=h;break;case 0:case 11:case 14:case 15:Te||Vr(2,s,r),Te||Vr(4,s,r),Zi(e,r,s);break;case 1:Te||(xi(s,r),l=s.stateNode,typeof l.componentWillUnmount=="function"&&Fy(s,r,l)),Zi(e,r,s);break;case 21:Zi(e,r,s);break;case 22:Te=(l=Te)||s.memoizedState!==null,Zi(e,r,s),Te=l;break;default:Zi(e,r,s)}}function Wy(e,r){if(r.memoizedState===null&&(e=r.alternate,e!==null&&(e=e.memoizedState,e!==null&&(e=e.dehydrated,e!==null))))try{Ml(e)}catch(s){ne(r,r.return,s)}}function rb(e){switch(e.tag){case 13:case 19:var r=e.stateNode;return r===null&&(r=e.stateNode=new Gy),r;case 22:return e=e.stateNode,r=e._retryCache,r===null&&(r=e._retryCache=new Gy),r;default:throw Error(a(435,e.tag))}}function Tf(e,r){var s=rb(e);r.forEach(function(l){var h=fb.bind(null,e,l);s.has(l)||(s.add(l),l.then(h,h))})}function Tn(e,r){var s=r.deletions;if(s!==null)for(var l=0;l<s.length;l++){var h=s[l],f=e,E=r,b=E;t:for(;b!==null;){switch(b.tag){case 27:if(Fr(b.type)){ce=b.stateNode,gn=!1;break t}break;case 5:ce=b.stateNode,gn=!1;break t;case 3:case 4:ce=b.stateNode.containerInfo,gn=!0;break t}b=b.return}if(ce===null)throw Error(a(160));Xy(f,E,h),ce=null,gn=!1,f=h.alternate,f!==null&&(f.return=null),h.return=null}if(r.subtreeFlags&13878)for(r=r.child;r!==null;)Zy(r,e),r=r.sibling}var ei=null;function Zy(e,r){var s=e.alternate,l=e.flags;switch(e.tag){case 0:case 11:case 14:case 15:Tn(r,e),Sn(e),l&4&&(Vr(3,e,e.return),ml(3,e),Vr(5,e,e.return));break;case 1:Tn(r,e),Sn(e),l&512&&(Te||s===null||xi(s,s.return)),l&64&&Wi&&(e=e.updateQueue,e!==null&&(l=e.callbacks,l!==null&&(s=e.shared.hiddenCallbacks,e.shared.hiddenCallbacks=s===null?l:s.concat(l))));break;case 26:var h=ei;if(Tn(r,e),Sn(e),l&512&&(Te||s===null||xi(s,s.return)),l&4){var f=s!==null?s.memoizedState:null;if(l=e.memoizedState,s===null)if(l===null)if(e.stateNode===null){t:{l=e.type,s=e.memoizedProps,h=h.ownerDocument||h;e:switch(l){case"title":f=h.getElementsByTagName("title")[0],(!f||f[xr]||f[_e]||f.namespaceURI==="http://www.w3.org/2000/svg"||f.hasAttribute("itemprop"))&&(f=h.createElement(l),h.head.insertBefore(f,h.querySelector("head > title"))),Qe(f,l,s),f[_e]=e,Ee(f),l=f;break t;case"link":var E=H1("link","href",h).get(l+(s.href||""));if(E){for(var b=0;b<E.length;b++)if(f=E[b],f.getAttribute("href")===(s.href==null||s.href===""?null:s.href)&&f.getAttribute("rel")===(s.rel==null?null:s.rel)&&f.getAttribute("title")===(s.title==null?null:s.title)&&f.getAttribute("crossorigin")===(s.crossOrigin==null?null:s.crossOrigin)){E.splice(b,1);break e}}f=h.createElement(l),Qe(f,l,s),h.head.appendChild(f);break;case"meta":if(E=H1("meta","content",h).get(l+(s.content||""))){for(b=0;b<E.length;b++)if(f=E[b],f.getAttribute("content")===(s.content==null?null:""+s.content)&&f.getAttribute("name")===(s.name==null?null:s.name)&&f.getAttribute("property")===(s.property==null?null:s.property)&&f.getAttribute("http-equiv")===(s.httpEquiv==null?null:s.httpEquiv)&&f.getAttribute("charset")===(s.charSet==null?null:s.charSet)){E.splice(b,1);break e}}f=h.createElement(l),Qe(f,l,s),h.head.appendChild(f);break;default:throw Error(a(468,l))}f[_e]=e,Ee(f),l=f}e.stateNode=l}else G1(h,e.type,e.stateNode);else e.stateNode=K1(h,l,e.memoizedProps);else f!==l?(f===null?s.stateNode!==null&&(s=s.stateNode,s.parentNode.removeChild(s)):f.count--,l===null?G1(h,e.type,e.stateNode):K1(h,l,e.memoizedProps)):l===null&&e.stateNode!==null&&_f(e,e.memoizedProps,s.memoizedProps)}break;case 27:Tn(r,e),Sn(e),l&512&&(Te||s===null||xi(s,s.return)),s!==null&&l&4&&_f(e,e.memoizedProps,s.memoizedProps);break;case 5:if(Tn(r,e),Sn(e),l&512&&(Te||s===null||xi(s,s.return)),e.flags&32){h=e.stateNode;try{On(h,"")}catch(Q){ne(e,e.return,Q)}}l&4&&e.stateNode!=null&&(h=e.memoizedProps,_f(e,h,s!==null?s.memoizedProps:h)),l&1024&&(bf=!0);break;case 6:if(Tn(r,e),Sn(e),l&4){if(e.stateNode===null)throw Error(a(162));l=e.memoizedProps,s=e.stateNode;try{s.nodeValue=l}catch(Q){ne(e,e.return,Q)}}break;case 3:if(Mc=null,h=ei,ei=Dc(r.containerInfo),Tn(r,e),ei=h,Sn(e),l&4&&s!==null&&s.memoizedState.isDehydrated)try{Ml(r.containerInfo)}catch(Q){ne(e,e.return,Q)}bf&&(bf=!1,Jy(e));break;case 4:l=ei,ei=Dc(e.stateNode.containerInfo),Tn(r,e),Sn(e),ei=l;break;case 12:Tn(r,e),Sn(e);break;case 13:Tn(r,e),Sn(e),e.child.flags&8192&&e.memoizedState!==null!=(s!==null&&s.memoizedState!==null)&&(Cf=pn()),l&4&&(l=e.updateQueue,l!==null&&(e.updateQueue=null,Tf(e,l)));break;case 22:h=e.memoizedState!==null;var N=s!==null&&s.memoizedState!==null,H=Wi,et=Te;if(Wi=H||h,Te=et||N,Tn(r,e),Te=et,Wi=H,Sn(e),l&8192)t:for(r=e.stateNode,r._visibility=h?r._visibility&-2:r._visibility|1,h&&(s===null||N||Wi||Te||qa(e)),s=null,r=e;;){if(r.tag===5||r.tag===26){if(s===null){N=s=r;try{if(f=N.stateNode,h)E=f.style,typeof E.setProperty=="function"?E.setProperty("display","none","important"):E.display="none";else{b=N.stateNode;var rt=N.memoizedProps.style,G=rt!=null&&rt.hasOwnProperty("display")?rt.display:null;b.style.display=G==null||typeof G=="boolean"?"":(""+G).trim()}}catch(Q){ne(N,N.return,Q)}}}else if(r.tag===6){if(s===null){N=r;try{N.stateNode.nodeValue=h?"":N.memoizedProps}catch(Q){ne(N,N.return,Q)}}}else if((r.tag!==22&&r.tag!==23||r.memoizedState===null||r===e)&&r.child!==null){r.child.return=r,r=r.child;continue}if(r===e)break t;for(;r.sibling===null;){if(r.return===null||r.return===e)break t;s===r&&(s=null),r=r.return}s===r&&(s=null),r.sibling.return=r.return,r=r.sibling}l&4&&(l=e.updateQueue,l!==null&&(s=l.retryQueue,s!==null&&(l.retryQueue=null,Tf(e,s))));break;case 19:Tn(r,e),Sn(e),l&4&&(l=e.updateQueue,l!==null&&(e.updateQueue=null,Tf(e,l)));break;case 30:break;case 21:break;default:Tn(r,e),Sn(e)}}function Sn(e){var r=e.flags;if(r&2){try{for(var s,l=e.return;l!==null;){if(Ky(l)){s=l;break}l=l.return}if(s==null)throw Error(a(160));switch(s.tag){case 27:var h=s.stateNode,f=Ef(e);xc(e,f,h);break;case 5:var E=s.stateNode;s.flags&32&&(On(E,""),s.flags&=-33);var b=Ef(e);xc(e,b,E);break;case 3:case 4:var N=s.stateNode.containerInfo,H=Ef(e);wf(e,H,N);break;default:throw Error(a(161))}}catch(et){ne(e,e.return,et)}e.flags&=-3}r&4096&&(e.flags&=-4097)}function Jy(e){if(e.subtreeFlags&1024)for(e=e.child;e!==null;){var r=e;Jy(r),r.tag===5&&r.flags&1024&&r.stateNode.reset(),e=e.sibling}}function kr(e,r){if(r.subtreeFlags&8772)for(r=r.child;r!==null;)Yy(e,r.alternate,r),r=r.sibling}function qa(e){for(e=e.child;e!==null;){var r=e;switch(r.tag){case 0:case 11:case 14:case 15:Vr(4,r,r.return),qa(r);break;case 1:xi(r,r.return);var s=r.stateNode;typeof s.componentWillUnmount=="function"&&Fy(r,r.return,s),qa(r);break;case 27:Sl(r.stateNode);case 26:case 5:xi(r,r.return),qa(r);break;case 22:r.memoizedState===null&&qa(r);break;case 30:qa(r);break;default:qa(r)}e=e.sibling}}function Pr(e,r,s){for(s=s&&(r.subtreeFlags&8772)!==0,r=r.child;r!==null;){var l=r.alternate,h=e,f=r,E=f.flags;switch(f.tag){case 0:case 11:case 15:Pr(h,f,s),ml(4,f);break;case 1:if(Pr(h,f,s),l=f,h=l.stateNode,typeof h.componentDidMount=="function")try{h.componentDidMount()}catch(H){ne(l,l.return,H)}if(l=f,h=l.updateQueue,h!==null){var b=l.stateNode;try{var N=h.shared.hiddenCallbacks;if(N!==null)for(h.shared.hiddenCallbacks=null,h=0;h<N.length;h++)I0(N[h],b)}catch(H){ne(l,l.return,H)}}s&&E&64&&By(f),gl(f,f.return);break;case 27:Hy(f);case 26:case 5:Pr(h,f,s),s&&l===null&&E&4&&qy(f),gl(f,f.return);break;case 12:Pr(h,f,s);break;case 13:Pr(h,f,s),s&&E&4&&Wy(h,f);break;case 22:f.memoizedState===null&&Pr(h,f,s),gl(f,f.return);break;case 30:break;default:Pr(h,f,s)}r=r.sibling}}function Sf(e,r){var s=null;e!==null&&e.memoizedState!==null&&e.memoizedState.cachePool!==null&&(s=e.memoizedState.cachePool.pool),e=null,r.memoizedState!==null&&r.memoizedState.cachePool!==null&&(e=r.memoizedState.cachePool.pool),e!==s&&(e!=null&&e.refCount++,s!=null&&el(s))}function Af(e,r){e=null,r.alternate!==null&&(e=r.alternate.memoizedState.cache),r=r.memoizedState.cache,r!==e&&(r.refCount++,e!=null&&el(e))}function vi(e,r,s,l){if(r.subtreeFlags&10256)for(r=r.child;r!==null;)t1(e,r,s,l),r=r.sibling}function t1(e,r,s,l){var h=r.flags;switch(r.tag){case 0:case 11:case 15:vi(e,r,s,l),h&2048&&ml(9,r);break;case 1:vi(e,r,s,l);break;case 3:vi(e,r,s,l),h&2048&&(e=null,r.alternate!==null&&(e=r.alternate.memoizedState.cache),r=r.memoizedState.cache,r!==e&&(r.refCount++,e!=null&&el(e)));break;case 12:if(h&2048){vi(e,r,s,l),e=r.stateNode;try{var f=r.memoizedProps,E=f.id,b=f.onPostCommit;typeof b=="function"&&b(E,r.alternate===null?"mount":"update",e.passiveEffectDuration,-0)}catch(N){ne(r,r.return,N)}}else vi(e,r,s,l);break;case 13:vi(e,r,s,l);break;case 23:break;case 22:f=r.stateNode,E=r.alternate,r.memoizedState!==null?f._visibility&2?vi(e,r,s,l):yl(e,r):f._visibility&2?vi(e,r,s,l):(f._visibility|=2,ks(e,r,s,l,(r.subtreeFlags&10256)!==0)),h&2048&&Sf(E,r);break;case 24:vi(e,r,s,l),h&2048&&Af(r.alternate,r);break;default:vi(e,r,s,l)}}function ks(e,r,s,l,h){for(h=h&&(r.subtreeFlags&10256)!==0,r=r.child;r!==null;){var f=e,E=r,b=s,N=l,H=E.flags;switch(E.tag){case 0:case 11:case 15:ks(f,E,b,N,h),ml(8,E);break;case 23:break;case 22:var et=E.stateNode;E.memoizedState!==null?et._visibility&2?ks(f,E,b,N,h):yl(f,E):(et._visibility|=2,ks(f,E,b,N,h)),h&&H&2048&&Sf(E.alternate,E);break;case 24:ks(f,E,b,N,h),h&&H&2048&&Af(E.alternate,E);break;default:ks(f,E,b,N,h)}r=r.sibling}}function yl(e,r){if(r.subtreeFlags&10256)for(r=r.child;r!==null;){var s=e,l=r,h=l.flags;switch(l.tag){case 22:yl(s,l),h&2048&&Sf(l.alternate,l);break;case 24:yl(s,l),h&2048&&Af(l.alternate,l);break;default:yl(s,l)}r=r.sibling}}var xl=8192;function Ps(e){if(e.subtreeFlags&xl)for(e=e.child;e!==null;)e1(e),e=e.sibling}function e1(e){switch(e.tag){case 26:Ps(e),e.flags&xl&&e.memoizedState!==null&&Fb(ei,e.memoizedState,e.memoizedProps);break;case 5:Ps(e);break;case 3:case 4:var r=ei;ei=Dc(e.stateNode.containerInfo),Ps(e),ei=r;break;case 22:e.memoizedState===null&&(r=e.alternate,r!==null&&r.memoizedState!==null?(r=xl,xl=16777216,Ps(e),xl=r):Ps(e));break;default:Ps(e)}}function n1(e){var r=e.alternate;if(r!==null&&(e=r.child,e!==null)){r.child=null;do r=e.sibling,e.sibling=null,e=r;while(e!==null)}}function vl(e){var r=e.deletions;if((e.flags&16)!==0){if(r!==null)for(var s=0;s<r.length;s++){var l=r[s];Be=l,r1(l,e)}n1(e)}if(e.subtreeFlags&10256)for(e=e.child;e!==null;)i1(e),e=e.sibling}function i1(e){switch(e.tag){case 0:case 11:case 15:vl(e),e.flags&2048&&Vr(9,e,e.return);break;case 3:vl(e);break;case 12:vl(e);break;case 22:var r=e.stateNode;e.memoizedState!==null&&r._visibility&2&&(e.return===null||e.return.tag!==13)?(r._visibility&=-3,vc(e)):vl(e);break;default:vl(e)}}function vc(e){var r=e.deletions;if((e.flags&16)!==0){if(r!==null)for(var s=0;s<r.length;s++){var l=r[s];Be=l,r1(l,e)}n1(e)}for(e=e.child;e!==null;){switch(r=e,r.tag){case 0:case 11:case 15:Vr(8,r,r.return),vc(r);break;case 22:s=r.stateNode,s._visibility&2&&(s._visibility&=-3,vc(r));break;default:vc(r)}e=e.sibling}}function r1(e,r){for(;Be!==null;){var s=Be;switch(s.tag){case 0:case 11:case 15:Vr(8,s,r);break;case 23:case 22:if(s.memoizedState!==null&&s.memoizedState.cachePool!==null){var l=s.memoizedState.cachePool.pool;l!=null&&l.refCount++}break;case 24:el(s.memoizedState.cache)}if(l=s.child,l!==null)l.return=s,Be=l;else t:for(s=e;Be!==null;){l=Be;var h=l.sibling,f=l.return;if(Qy(l),l===s){Be=null;break t}if(h!==null){h.return=f,Be=h;break t}Be=f}}}var ab={getCacheForType:function(e){var r=en(ke),s=r.data.get(e);return s===void 0&&(s=e(),r.data.set(e,s)),s}},sb=typeof WeakMap=="function"?WeakMap:Map,Xt=0,re=null,Vt=null,zt=0,Wt=0,An=null,Ur=!1,Us=!1,Rf=!1,Ji=0,xe=0,Lr=0,Ka=0,If=0,$n=0,Ls=0,_l=null,yn=null,jf=!1,Cf=0,_c=1/0,Ec=null,zr=null,Ye=0,$r=null,zs=null,$s=0,Df=0,Nf=null,a1=null,El=0,Mf=null;function Rn(){if((Xt&2)!==0&&zt!==0)return zt&-zt;if(J.T!==null){var e=Is;return e!==0?e:zf()}return Vi()}function s1(){$n===0&&($n=(zt&536870912)===0||Kt?Do():536870912);var e=zn.current;return e!==null&&(e.flags|=32),$n}function In(e,r,s){(e===re&&(Wt===2||Wt===9)||e.cancelPendingCommit!==null)&&(Bs(e,0),Br(e,zt,$n,!1)),ve(e,s),((Xt&2)===0||e!==re)&&(e===re&&((Xt&2)===0&&(Ka|=s),xe===4&&Br(e,zt,$n,!1)),_i(e))}function o1(e,r,s){if((Xt&6)!==0)throw Error(a(327));var l=!s&&(r&124)===0&&(r&e.expiredLanes)===0||pr(e,r),h=l?ub(e,r):kf(e,r,!0),f=l;do{if(h===0){Us&&!l&&Br(e,r,0,!1);break}else{if(s=e.current.alternate,f&&!ob(s)){h=kf(e,r,!1),f=!1;continue}if(h===2){if(f=r,e.errorRecoveryDisabledLanes&f)var E=0;else E=e.pendingLanes&-536870913,E=E!==0?E:E&536870912?536870912:0;if(E!==0){r=E;t:{var b=e;h=_l;var N=b.current.memoizedState.isDehydrated;if(N&&(Bs(b,E).flags|=256),E=kf(b,E,!1),E!==2){if(Rf&&!N){b.errorRecoveryDisabledLanes|=f,Ka|=f,h=4;break t}f=yn,yn=h,f!==null&&(yn===null?yn=f:yn.push.apply(yn,f))}h=E}if(f=!1,h!==2)continue}}if(h===1){Bs(e,0),Br(e,r,0,!0);break}t:{switch(l=e,f=h,f){case 0:case 1:throw Error(a(345));case 4:if((r&4194048)!==r)break;case 6:Br(l,r,$n,!Ur);break t;case 2:yn=null;break;case 3:case 5:break;default:throw Error(a(329))}if((r&62914560)===r&&(h=Cf+300-pn(),10<h)){if(Br(l,r,$n,!Ur),Nn(l,0,!0)!==0)break t;l.timeoutHandle=k1(l1.bind(null,l,s,yn,Ec,jf,r,$n,Ka,Ls,Ur,f,2,-0,0),h);break t}l1(l,s,yn,Ec,jf,r,$n,Ka,Ls,Ur,f,0,-0,0)}}break}while(!0);_i(e)}function l1(e,r,s,l,h,f,E,b,N,H,et,rt,G,Q){if(e.timeoutHandle=-1,rt=r.subtreeFlags,(rt&8192||(rt&16785408)===16785408)&&(Il={stylesheets:null,count:0,unsuspend:Bb},e1(r),rt=qb(),rt!==null)){e.cancelPendingCommit=rt(m1.bind(null,e,r,f,s,l,h,E,b,N,et,1,G,Q)),Br(e,f,E,!H);return}m1(e,r,f,s,l,h,E,b,N)}function ob(e){for(var r=e;;){var s=r.tag;if((s===0||s===11||s===15)&&r.flags&16384&&(s=r.updateQueue,s!==null&&(s=s.stores,s!==null)))for(var l=0;l<s.length;l++){var h=s[l],f=h.getSnapshot;h=h.value;try{if(!wn(f(),h))return!1}catch{return!1}}if(s=r.child,r.subtreeFlags&16384&&s!==null)s.return=r,r=s;else{if(r===e)break;for(;r.sibling===null;){if(r.return===null||r.return===e)return!0;r=r.return}r.sibling.return=r.return,r=r.sibling}}return!0}function Br(e,r,s,l){r&=~If,r&=~Ka,e.suspendedLanes|=r,e.pingedLanes&=~r,l&&(e.warmLanes|=r),l=e.expirationTimes;for(var h=r;0<h;){var f=31-ln(h),E=1<<f;l[f]=-1,h&=~E}s!==0&&gr(e,s,r)}function wc(){return(Xt&6)===0?(wl(0),!1):!0}function Of(){if(Vt!==null){if(Wt===0)var e=Vt.return;else e=Vt,Ki=La=null,Xd(e),Os=null,dl=0,e=Vt;for(;e!==null;)$y(e.alternate,e),e=e.return;Vt=null}}function Bs(e,r){var s=e.timeoutHandle;s!==-1&&(e.timeoutHandle=-1,Sb(s)),s=e.cancelPendingCommit,s!==null&&(e.cancelPendingCommit=null,s()),Of(),re=e,Vt=s=Bi(e.current,null),zt=r,Wt=0,An=null,Ur=!1,Us=pr(e,r),Rf=!1,Ls=$n=If=Ka=Lr=xe=0,yn=_l=null,jf=!1,(r&8)!==0&&(r|=r&32);var l=e.entangledLanes;if(l!==0)for(e=e.entanglements,l&=r;0<l;){var h=31-ln(l),f=1<<h;r|=e[h],l&=~f}return Ji=r,qu(),s}function u1(e,r){Mt=null,J.H=uc,r===il||r===Ju?(r=A0(),Wt=3):r===b0?(r=A0(),Wt=4):Wt=r===Ry?8:r!==null&&typeof r=="object"&&typeof r.then=="function"?6:1,An=r,Vt===null&&(xe=1,pc(e,kn(r,e.current)))}function c1(){var e=J.H;return J.H=uc,e===null?uc:e}function h1(){var e=J.A;return J.A=ab,e}function Vf(){xe=4,Ur||(zt&4194048)!==zt&&zn.current!==null||(Us=!0),(Lr&134217727)===0&&(Ka&134217727)===0||re===null||Br(re,zt,$n,!1)}function kf(e,r,s){var l=Xt;Xt|=2;var h=c1(),f=h1();(re!==e||zt!==r)&&(Ec=null,Bs(e,r)),r=!1;var E=xe;t:do try{if(Wt!==0&&Vt!==null){var b=Vt,N=An;switch(Wt){case 8:Of(),E=6;break t;case 3:case 2:case 9:case 6:zn.current===null&&(r=!0);var H=Wt;if(Wt=0,An=null,Fs(e,b,N,H),s&&Us){E=0;break t}break;default:H=Wt,Wt=0,An=null,Fs(e,b,N,H)}}lb(),E=xe;break}catch(et){u1(e,et)}while(!0);return r&&e.shellSuspendCounter++,Ki=La=null,Xt=l,J.H=h,J.A=f,Vt===null&&(re=null,zt=0,qu()),E}function lb(){for(;Vt!==null;)d1(Vt)}function ub(e,r){var s=Xt;Xt|=2;var l=c1(),h=h1();re!==e||zt!==r?(Ec=null,_c=pn()+500,Bs(e,r)):Us=pr(e,r);t:do try{if(Wt!==0&&Vt!==null){r=Vt;var f=An;e:switch(Wt){case 1:Wt=0,An=null,Fs(e,r,f,1);break;case 2:case 9:if(T0(f)){Wt=0,An=null,f1(r);break}r=function(){Wt!==2&&Wt!==9||re!==e||(Wt=7),_i(e)},f.then(r,r);break t;case 3:Wt=7;break t;case 4:Wt=5;break t;case 7:T0(f)?(Wt=0,An=null,f1(r)):(Wt=0,An=null,Fs(e,r,f,7));break;case 5:var E=null;switch(Vt.tag){case 26:E=Vt.memoizedState;case 5:case 27:var b=Vt;if(!E||Y1(E)){Wt=0,An=null;var N=b.sibling;if(N!==null)Vt=N;else{var H=b.return;H!==null?(Vt=H,bc(H)):Vt=null}break e}}Wt=0,An=null,Fs(e,r,f,5);break;case 6:Wt=0,An=null,Fs(e,r,f,6);break;case 8:Of(),xe=6;break t;default:throw Error(a(462))}}cb();break}catch(et){u1(e,et)}while(!0);return Ki=La=null,J.H=l,J.A=h,Xt=s,Vt!==null?0:(re=null,zt=0,qu(),xe)}function cb(){for(;Vt!==null&&!ud();)d1(Vt)}function d1(e){var r=Ly(e.alternate,e,Ji);e.memoizedProps=e.pendingProps,r===null?bc(e):Vt=r}function f1(e){var r=e,s=r.alternate;switch(r.tag){case 15:case 0:r=My(s,r,r.pendingProps,r.type,void 0,zt);break;case 11:r=My(s,r,r.pendingProps,r.type.render,r.ref,zt);break;case 5:Xd(r);default:$y(s,r),r=Vt=p0(r,Ji),r=Ly(s,r,Ji)}e.memoizedProps=e.pendingProps,r===null?bc(e):Vt=r}function Fs(e,r,s,l){Ki=La=null,Xd(r),Os=null,dl=0;var h=r.return;try{if(Jw(e,h,r,s,zt)){xe=1,pc(e,kn(s,e.current)),Vt=null;return}}catch(f){if(h!==null)throw Vt=h,f;xe=1,pc(e,kn(s,e.current)),Vt=null;return}r.flags&32768?(Kt||l===1?e=!0:Us||(zt&536870912)!==0?e=!1:(Ur=e=!0,(l===2||l===9||l===3||l===6)&&(l=zn.current,l!==null&&l.tag===13&&(l.flags|=16384))),p1(r,e)):bc(r)}function bc(e){var r=e;do{if((r.flags&32768)!==0){p1(r,Ur);return}e=r.return;var s=eb(r.alternate,r,Ji);if(s!==null){Vt=s;return}if(r=r.sibling,r!==null){Vt=r;return}Vt=r=e}while(r!==null);xe===0&&(xe=5)}function p1(e,r){do{var s=nb(e.alternate,e);if(s!==null){s.flags&=32767,Vt=s;return}if(s=e.return,s!==null&&(s.flags|=32768,s.subtreeFlags=0,s.deletions=null),!r&&(e=e.sibling,e!==null)){Vt=e;return}Vt=e=s}while(e!==null);xe=6,Vt=null}function m1(e,r,s,l,h,f,E,b,N){e.cancelPendingCommit=null;do Tc();while(Ye!==0);if((Xt&6)!==0)throw Error(a(327));if(r!==null){if(r===e.current)throw Error(a(177));if(f=r.lanes|r.childLanes,f|=Sd,Ru(e,s,f,E,b,N),e===re&&(Vt=re=null,zt=0),zs=r,$r=e,$s=s,Df=f,Nf=h,a1=l,(r.subtreeFlags&10256)!==0||(r.flags&10256)!==0?(e.callbackNode=null,e.callbackPriority=0,pb(Oi,function(){return _1(),null})):(e.callbackNode=null,e.callbackPriority=0),l=(r.flags&13878)!==0,(r.subtreeFlags&13878)!==0||l){l=J.T,J.T=null,h=dt.p,dt.p=2,E=Xt,Xt|=4;try{ib(e,r,s)}finally{Xt=E,dt.p=h,J.T=l}}Ye=1,g1(),y1(),x1()}}function g1(){if(Ye===1){Ye=0;var e=$r,r=zs,s=(r.flags&13878)!==0;if((r.subtreeFlags&13878)!==0||s){s=J.T,J.T=null;var l=dt.p;dt.p=2;var h=Xt;Xt|=4;try{Zy(r,e);var f=Yf,E=r0(e.containerInfo),b=f.focusedElem,N=f.selectionRange;if(E!==b&&b&&b.ownerDocument&&i0(b.ownerDocument.documentElement,b)){if(N!==null&&_d(b)){var H=N.start,et=N.end;if(et===void 0&&(et=H),"selectionStart"in b)b.selectionStart=H,b.selectionEnd=Math.min(et,b.value.length);else{var rt=b.ownerDocument||document,G=rt&&rt.defaultView||window;if(G.getSelection){var Q=G.getSelection(),Tt=b.textContent.length,Et=Math.min(N.start,Tt),ee=N.end===void 0?Et:Math.min(N.end,Tt);!Q.extend&&Et>ee&&(E=ee,ee=Et,Et=E);var $=n0(b,Et),P=n0(b,ee);if($&&P&&(Q.rangeCount!==1||Q.anchorNode!==$.node||Q.anchorOffset!==$.offset||Q.focusNode!==P.node||Q.focusOffset!==P.offset)){var F=rt.createRange();F.setStart($.node,$.offset),Q.removeAllRanges(),Et>ee?(Q.addRange(F),Q.extend(P.node,P.offset)):(F.setEnd(P.node,P.offset),Q.addRange(F))}}}}for(rt=[],Q=b;Q=Q.parentNode;)Q.nodeType===1&&rt.push({element:Q,left:Q.scrollLeft,top:Q.scrollTop});for(typeof b.focus=="function"&&b.focus(),b=0;b<rt.length;b++){var nt=rt[b];nt.element.scrollLeft=nt.left,nt.element.scrollTop=nt.top}}kc=!!Gf,Yf=Gf=null}finally{Xt=h,dt.p=l,J.T=s}}e.current=r,Ye=2}}function y1(){if(Ye===2){Ye=0;var e=$r,r=zs,s=(r.flags&8772)!==0;if((r.subtreeFlags&8772)!==0||s){s=J.T,J.T=null;var l=dt.p;dt.p=2;var h=Xt;Xt|=4;try{Yy(e,r.alternate,r)}finally{Xt=h,dt.p=l,J.T=s}}Ye=3}}function x1(){if(Ye===4||Ye===3){Ye=0,jo();var e=$r,r=zs,s=$s,l=a1;(r.subtreeFlags&10256)!==0||(r.flags&10256)!==0?Ye=5:(Ye=0,zs=$r=null,v1(e,e.pendingLanes));var h=e.pendingLanes;if(h===0&&(zr=null),Mo(s),r=r.stateNode,Je&&typeof Je.onCommitFiberRoot=="function")try{Je.onCommitFiberRoot(dr,r,void 0,(r.current.flags&128)===128)}catch{}if(l!==null){r=J.T,h=dt.p,dt.p=2,J.T=null;try{for(var f=e.onRecoverableError,E=0;E<l.length;E++){var b=l[E];f(b.value,{componentStack:b.stack})}}finally{J.T=r,dt.p=h}}($s&3)!==0&&Tc(),_i(e),h=e.pendingLanes,(s&4194090)!==0&&(h&42)!==0?e===Mf?El++:(El=0,Mf=e):El=0,wl(0)}}function v1(e,r){(e.pooledCacheLanes&=r)===0&&(r=e.pooledCache,r!=null&&(e.pooledCache=null,el(r)))}function Tc(e){return g1(),y1(),x1(),_1()}function _1(){if(Ye!==5)return!1;var e=$r,r=Df;Df=0;var s=Mo($s),l=J.T,h=dt.p;try{dt.p=32>s?32:s,J.T=null,s=Nf,Nf=null;var f=$r,E=$s;if(Ye=0,zs=$r=null,$s=0,(Xt&6)!==0)throw Error(a(331));var b=Xt;if(Xt|=4,i1(f.current),t1(f,f.current,E,s),Xt=b,wl(0,!1),Je&&typeof Je.onPostCommitFiberRoot=="function")try{Je.onPostCommitFiberRoot(dr,f)}catch{}return!0}finally{dt.p=h,J.T=l,v1(e,r)}}function E1(e,r,s){r=kn(s,r),r=hf(e.stateNode,r,2),e=Dr(e,r,2),e!==null&&(ve(e,2),_i(e))}function ne(e,r,s){if(e.tag===3)E1(e,e,s);else for(;r!==null;){if(r.tag===3){E1(r,e,s);break}else if(r.tag===1){var l=r.stateNode;if(typeof r.type.getDerivedStateFromError=="function"||typeof l.componentDidCatch=="function"&&(zr===null||!zr.has(l))){e=kn(s,e),s=Sy(2),l=Dr(r,s,2),l!==null&&(Ay(s,l,r,e),ve(l,2),_i(l));break}}r=r.return}}function Pf(e,r,s){var l=e.pingCache;if(l===null){l=e.pingCache=new sb;var h=new Set;l.set(r,h)}else h=l.get(r),h===void 0&&(h=new Set,l.set(r,h));h.has(s)||(Rf=!0,h.add(s),e=hb.bind(null,e,r,s),r.then(e,e))}function hb(e,r,s){var l=e.pingCache;l!==null&&l.delete(r),e.pingedLanes|=e.suspendedLanes&s,e.warmLanes&=~s,re===e&&(zt&s)===s&&(xe===4||xe===3&&(zt&62914560)===zt&&300>pn()-Cf?(Xt&2)===0&&Bs(e,0):If|=s,Ls===zt&&(Ls=0)),_i(e)}function w1(e,r){r===0&&(r=mr()),e=Ts(e,r),e!==null&&(ve(e,r),_i(e))}function db(e){var r=e.memoizedState,s=0;r!==null&&(s=r.retryLane),w1(e,s)}function fb(e,r){var s=0;switch(e.tag){case 13:var l=e.stateNode,h=e.memoizedState;h!==null&&(s=h.retryLane);break;case 19:l=e.stateNode;break;case 22:l=e.stateNode._retryCache;break;default:throw Error(a(314))}l!==null&&l.delete(r),w1(e,s)}function pb(e,r){return ca(e,r)}var Sc=null,qs=null,Uf=!1,Ac=!1,Lf=!1,Ha=0;function _i(e){e!==qs&&e.next===null&&(qs===null?Sc=qs=e:qs=qs.next=e),Ac=!0,Uf||(Uf=!0,gb())}function wl(e,r){if(!Lf&&Ac){Lf=!0;do for(var s=!1,l=Sc;l!==null;){if(e!==0){var h=l.pendingLanes;if(h===0)var f=0;else{var E=l.suspendedLanes,b=l.pingedLanes;f=(1<<31-ln(42|e)+1)-1,f&=h&~(E&~b),f=f&201326741?f&201326741|1:f?f|2:0}f!==0&&(s=!0,A1(l,f))}else f=zt,f=Nn(l,l===re?f:0,l.cancelPendingCommit!==null||l.timeoutHandle!==-1),(f&3)===0||pr(l,f)||(s=!0,A1(l,f));l=l.next}while(s);Lf=!1}}function mb(){b1()}function b1(){Ac=Uf=!1;var e=0;Ha!==0&&(Tb()&&(e=Ha),Ha=0);for(var r=pn(),s=null,l=Sc;l!==null;){var h=l.next,f=T1(l,r);f===0?(l.next=null,s===null?Sc=h:s.next=h,h===null&&(qs=s)):(s=l,(e!==0||(f&3)!==0)&&(Ac=!0)),l=h}wl(e)}function T1(e,r){for(var s=e.suspendedLanes,l=e.pingedLanes,h=e.expirationTimes,f=e.pendingLanes&-62914561;0<f;){var E=31-ln(f),b=1<<E,N=h[E];N===-1?((b&s)===0||(b&l)!==0)&&(h[E]=os(b,r)):N<=r&&(e.expiredLanes|=b),f&=~b}if(r=re,s=zt,s=Nn(e,e===r?s:0,e.cancelPendingCommit!==null||e.timeoutHandle!==-1),l=e.callbackNode,s===0||e===r&&(Wt===2||Wt===9)||e.cancelPendingCommit!==null)return l!==null&&l!==null&&ss(l),e.callbackNode=null,e.callbackPriority=0;if((s&3)===0||pr(e,s)){if(r=s&-s,r===e.callbackPriority)return r;switch(l!==null&&ss(l),Mo(s)){case 2:case 8:s=Le;break;case 32:s=Oi;break;case 268435456:s=Co;break;default:s=Oi}return l=S1.bind(null,e),s=ca(s,l),e.callbackPriority=r,e.callbackNode=s,r}return l!==null&&l!==null&&ss(l),e.callbackPriority=2,e.callbackNode=null,2}function S1(e,r){if(Ye!==0&&Ye!==5)return e.callbackNode=null,e.callbackPriority=0,null;var s=e.callbackNode;if(Tc()&&e.callbackNode!==s)return null;var l=zt;return l=Nn(e,e===re?l:0,e.cancelPendingCommit!==null||e.timeoutHandle!==-1),l===0?null:(o1(e,l,r),T1(e,pn()),e.callbackNode!=null&&e.callbackNode===s?S1.bind(null,e):null)}function A1(e,r){if(Tc())return null;o1(e,r,!0)}function gb(){Ab(function(){(Xt&6)!==0?ca(Oe,mb):b1()})}function zf(){return Ha===0&&(Ha=Do()),Ha}function R1(e){return e==null||typeof e=="symbol"||typeof e=="boolean"?null:typeof e=="function"?e:Xn(""+e)}function I1(e,r){var s=r.ownerDocument.createElement("input");return s.name=r.name,s.value=r.value,e.id&&s.setAttribute("form",e.id),r.parentNode.insertBefore(s,r),e=new FormData(e),s.parentNode.removeChild(s),e}function yb(e,r,s,l,h){if(r==="submit"&&s&&s.stateNode===h){var f=R1((h[He]||null).action),E=l.submitter;E&&(r=(r=E[He]||null)?R1(r.formAction):E.getAttribute("formAction"),r!==null&&(f=r,E=null));var b=new Sa("action","action",null,l,h);e.push({event:b,listeners:[{instance:null,listener:function(){if(l.defaultPrevented){if(Ha!==0){var N=E?I1(h,E):new FormData(h);sf(s,{pending:!0,data:N,method:h.method,action:f},null,N)}}else typeof f=="function"&&(b.preventDefault(),N=E?I1(h,E):new FormData(h),sf(s,{pending:!0,data:N,method:h.method,action:f},f,N))},currentTarget:h}]})}}for(var $f=0;$f<Td.length;$f++){var Bf=Td[$f],xb=Bf.toLowerCase(),vb=Bf[0].toUpperCase()+Bf.slice(1);ti(xb,"on"+vb)}ti(o0,"onAnimationEnd"),ti(l0,"onAnimationIteration"),ti(u0,"onAnimationStart"),ti("dblclick","onDoubleClick"),ti("focusin","onFocus"),ti("focusout","onBlur"),ti(kw,"onTransitionRun"),ti(Pw,"onTransitionStart"),ti(Uw,"onTransitionCancel"),ti(c0,"onTransitionEnd"),di("onMouseEnter",["mouseout","mouseover"]),di("onMouseLeave",["mouseout","mouseover"]),di("onPointerEnter",["pointerout","pointerover"]),di("onPointerLeave",["pointerout","pointerover"]),hi("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),hi("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),hi("onBeforeInput",["compositionend","keypress","textInput","paste"]),hi("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),hi("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),hi("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var bl="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),_b=new Set("beforetoggle cancel close invalid load scroll scrollend toggle".split(" ").concat(bl));function j1(e,r){r=(r&4)!==0;for(var s=0;s<e.length;s++){var l=e[s],h=l.event;l=l.listeners;t:{var f=void 0;if(r)for(var E=l.length-1;0<=E;E--){var b=l[E],N=b.instance,H=b.currentTarget;if(b=b.listener,N!==f&&h.isPropagationStopped())break t;f=b,h.currentTarget=H;try{f(h)}catch(et){fc(et)}h.currentTarget=null,f=N}else for(E=0;E<l.length;E++){if(b=l[E],N=b.instance,H=b.currentTarget,b=b.listener,N!==f&&h.isPropagationStopped())break t;f=b,h.currentTarget=H;try{f(h)}catch(et){fc(et)}h.currentTarget=null,f=N}}}}function kt(e,r){var s=r[da];s===void 0&&(s=r[da]=new Set);var l=e+"__bubble";s.has(l)||(C1(r,e,2,!1),s.add(l))}function Ff(e,r,s){var l=0;r&&(l|=4),C1(s,e,l,r)}var Rc="_reactListening"+Math.random().toString(36).slice(2);function qf(e){if(!e[Rc]){e[Rc]=!0,Iu.forEach(function(s){s!=="selectionchange"&&(_b.has(s)||Ff(s,!1,e),Ff(s,!0,e))});var r=e.nodeType===9?e:e.ownerDocument;r===null||r[Rc]||(r[Rc]=!0,Ff("selectionchange",!1,r))}}function C1(e,r,s,l){switch(tx(r)){case 2:var h=Gb;break;case 8:h=Yb;break;default:h=rp}s=h.bind(null,r,s,e),h=void 0,!zi||r!=="touchstart"&&r!=="touchmove"&&r!=="wheel"||(h=!0),l?h!==void 0?e.addEventListener(r,s,{capture:!0,passive:h}):e.addEventListener(r,s,!0):h!==void 0?e.addEventListener(r,s,{passive:h}):e.addEventListener(r,s,!1)}function Kf(e,r,s,l,h){var f=l;if((r&1)===0&&(r&2)===0&&l!==null)t:for(;;){if(l===null)return;var E=l.tag;if(E===3||E===4){var b=l.stateNode.containerInfo;if(b===h)break;if(E===4)for(E=l.return;E!==null;){var N=E.tag;if((N===3||N===4)&&E.stateNode.containerInfo===h)return;E=E.return}for(;b!==null;){if(E=ui(b),E===null)return;if(N=E.tag,N===5||N===6||N===26||N===27){l=f=E;continue t}b=b.parentNode}}l=l.return}wa(function(){var H=f,et=zo(s),rt=[];t:{var G=h0.get(e);if(G!==void 0){var Q=Sa,Tt=e;switch(e){case"keypress":if(ba(s)===0)break t;case"keydown":case"keyup":Q=_s;break;case"focusin":Tt="focus",Q=ys;break;case"focusout":Tt="blur",Q=ys;break;case"beforeblur":case"afterblur":Q=ys;break;case"click":if(s.button===2)break t;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":Q=Ca;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":Q=Vu;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":Q=Rr;break;case o0:case l0:case u0:Q=Bo;break;case c0:Q=x;break;case"scroll":case"scrollend":Q=Ra;break;case"wheel":Q=S;break;case"copy":case"cut":case"paste":Q=Pu;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":Q=Ko;break;case"toggle":case"beforetoggle":Q=W}var Et=(r&4)!==0,ee=!Et&&(e==="scroll"||e==="scrollend"),$=Et?G!==null?G+"Capture":null:G;Et=[];for(var P=H,F;P!==null;){var nt=P;if(F=nt.stateNode,nt=nt.tag,nt!==5&&nt!==26&&nt!==27||F===null||$===null||(nt=Sr(P,$),nt!=null&&Et.push(Tl(P,nt,F))),ee)break;P=P.return}0<Et.length&&(G=new Q(G,Tt,null,s,et),rt.push({event:G,listeners:Et}))}}if((r&7)===0){t:{if(G=e==="mouseover"||e==="pointerover",Q=e==="mouseout"||e==="pointerout",G&&s!==Lo&&(Tt=s.relatedTarget||s.fromElement)&&(ui(Tt)||Tt[ki]))break t;if((Q||G)&&(G=et.window===et?et:(G=et.ownerDocument)?G.defaultView||G.parentWindow:window,Q?(Tt=s.relatedTarget||s.toElement,Q=H,Tt=Tt?ui(Tt):null,Tt!==null&&(ee=u(Tt),Et=Tt.tag,Tt!==ee||Et!==5&&Et!==27&&Et!==6)&&(Tt=null)):(Q=null,Tt=H),Q!==Tt)){if(Et=Ca,nt="onMouseLeave",$="onMouseEnter",P="mouse",(e==="pointerout"||e==="pointerover")&&(Et=Ko,nt="onPointerLeave",$="onPointerEnter",P="pointer"),ee=Q==null?G:vr(Q),F=Tt==null?G:vr(Tt),G=new Et(nt,P+"leave",Q,s,et),G.target=ee,G.relatedTarget=F,nt=null,ui(et)===H&&(Et=new Et($,P+"enter",Tt,s,et),Et.target=F,Et.relatedTarget=ee,nt=Et),ee=nt,Q&&Tt)e:{for(Et=Q,$=Tt,P=0,F=Et;F;F=Ks(F))P++;for(F=0,nt=$;nt;nt=Ks(nt))F++;for(;0<P-F;)Et=Ks(Et),P--;for(;0<F-P;)$=Ks($),F--;for(;P--;){if(Et===$||$!==null&&Et===$.alternate)break e;Et=Ks(Et),$=Ks($)}Et=null}else Et=null;Q!==null&&D1(rt,G,Q,Et,!1),Tt!==null&&ee!==null&&D1(rt,ee,Tt,Et,!0)}}t:{if(G=H?vr(H):window,Q=G.nodeName&&G.nodeName.toLowerCase(),Q==="select"||Q==="input"&&G.type==="file")var mt=Xg;else if(Yg(G))if(Wg)mt=Mw;else{mt=Dw;var Ot=Cw}else Q=G.nodeName,!Q||Q.toLowerCase()!=="input"||G.type!=="checkbox"&&G.type!=="radio"?H&&ps(H.elementType)&&(mt=Xg):mt=Nw;if(mt&&(mt=mt(e,H))){Qg(rt,mt,s,et);break t}Ot&&Ot(e,G,H),e==="focusout"&&H&&G.type==="number"&&H.memoizedProps.value!=null&&ko(G,"number",G.value)}switch(Ot=H?vr(H):window,e){case"focusin":(Yg(Ot)||Ot.contentEditable==="true")&&(Es=Ot,Ed=H,Xo=null);break;case"focusout":Xo=Ed=Es=null;break;case"mousedown":wd=!0;break;case"contextmenu":case"mouseup":case"dragend":wd=!1,a0(rt,s,et);break;case"selectionchange":if(Vw)break;case"keydown":case"keyup":a0(rt,s,et)}var xt;if(Rt)t:{switch(e){case"compositionstart":var wt="onCompositionStart";break t;case"compositionend":wt="onCompositionEnd";break t;case"compositionupdate":wt="onCompositionUpdate";break t}wt=void 0}else Jn?Wn(e,s)&&(wt="onCompositionEnd"):e==="keydown"&&s.keyCode===229&&(wt="onCompositionStart");wt&&(we&&s.locale!=="ko"&&(Jn||wt!=="onCompositionStart"?wt==="onCompositionEnd"&&Jn&&(xt=Ou()):(Vn=et,ie="value"in Vn?Vn.value:Vn.textContent,Jn=!0)),Ot=Ic(H,wt),0<Ot.length&&(wt=new qo(wt,e,null,s,et),rt.push({event:wt,listeners:Ot}),xt?wt.data=xt:(xt=Zn(s),xt!==null&&(wt.data=xt)))),(xt=Qt?Ho(e,s):Rw(e,s))&&(wt=Ic(H,"onBeforeInput"),0<wt.length&&(Ot=new qo("onBeforeInput","beforeinput",null,s,et),rt.push({event:Ot,listeners:wt}),Ot.data=xt)),yb(rt,e,H,s,et)}j1(rt,r)})}function Tl(e,r,s){return{instance:e,listener:r,currentTarget:s}}function Ic(e,r){for(var s=r+"Capture",l=[];e!==null;){var h=e,f=h.stateNode;if(h=h.tag,h!==5&&h!==26&&h!==27||f===null||(h=Sr(e,s),h!=null&&l.unshift(Tl(e,h,f)),h=Sr(e,r),h!=null&&l.push(Tl(e,h,f))),e.tag===3)return l;e=e.return}return[]}function Ks(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5&&e.tag!==27);return e||null}function D1(e,r,s,l,h){for(var f=r._reactName,E=[];s!==null&&s!==l;){var b=s,N=b.alternate,H=b.stateNode;if(b=b.tag,N!==null&&N===l)break;b!==5&&b!==26&&b!==27||H===null||(N=H,h?(H=Sr(s,f),H!=null&&E.unshift(Tl(s,H,N))):h||(H=Sr(s,f),H!=null&&E.push(Tl(s,H,N)))),s=s.return}E.length!==0&&e.push({event:r,listeners:E})}var Eb=/\r\n?/g,wb=/\u0000|\uFFFD/g;function N1(e){return(typeof e=="string"?e:""+e).replace(Eb,`
`).replace(wb,"")}function M1(e,r){return r=N1(r),N1(e)===r}function jc(){}function te(e,r,s,l,h,f){switch(s){case"children":typeof l=="string"?r==="body"||r==="textarea"&&l===""||On(e,l):(typeof l=="number"||typeof l=="bigint")&&r!=="body"&&On(e,""+l);break;case"className":ya(e,"class",l);break;case"tabIndex":ya(e,"tabindex",l);break;case"dir":case"role":case"viewBox":case"width":case"height":ya(e,s,l);break;case"style":Uo(e,l,f);break;case"data":if(r!=="object"){ya(e,"data",l);break}case"src":case"href":if(l===""&&(r!=="a"||s!=="href")){e.removeAttribute(s);break}if(l==null||typeof l=="function"||typeof l=="symbol"||typeof l=="boolean"){e.removeAttribute(s);break}l=Xn(""+l),e.setAttribute(s,l);break;case"action":case"formAction":if(typeof l=="function"){e.setAttribute(s,"javascript:throw new Error('A React form was unexpectedly submitted. If you called form.submit() manually, consider using form.requestSubmit() instead. If you\\'re trying to use event.stopPropagation() in a submit event handler, consider also calling event.preventDefault().')");break}else typeof f=="function"&&(s==="formAction"?(r!=="input"&&te(e,r,"name",h.name,h,null),te(e,r,"formEncType",h.formEncType,h,null),te(e,r,"formMethod",h.formMethod,h,null),te(e,r,"formTarget",h.formTarget,h,null)):(te(e,r,"encType",h.encType,h,null),te(e,r,"method",h.method,h,null),te(e,r,"target",h.target,h,null)));if(l==null||typeof l=="symbol"||typeof l=="boolean"){e.removeAttribute(s);break}l=Xn(""+l),e.setAttribute(s,l);break;case"onClick":l!=null&&(e.onclick=jc);break;case"onScroll":l!=null&&kt("scroll",e);break;case"onScrollEnd":l!=null&&kt("scrollend",e);break;case"dangerouslySetInnerHTML":if(l!=null){if(typeof l!="object"||!("__html"in l))throw Error(a(61));if(s=l.__html,s!=null){if(h.children!=null)throw Error(a(60));e.innerHTML=s}}break;case"multiple":e.multiple=l&&typeof l!="function"&&typeof l!="symbol";break;case"muted":e.muted=l&&typeof l!="function"&&typeof l!="symbol";break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"defaultValue":case"defaultChecked":case"innerHTML":case"ref":break;case"autoFocus":break;case"xlinkHref":if(l==null||typeof l=="function"||typeof l=="boolean"||typeof l=="symbol"){e.removeAttribute("xlink:href");break}s=Xn(""+l),e.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",s);break;case"contentEditable":case"spellCheck":case"draggable":case"value":case"autoReverse":case"externalResourcesRequired":case"focusable":case"preserveAlpha":l!=null&&typeof l!="function"&&typeof l!="symbol"?e.setAttribute(s,""+l):e.removeAttribute(s);break;case"inert":case"allowFullScreen":case"async":case"autoPlay":case"controls":case"default":case"defer":case"disabled":case"disablePictureInPicture":case"disableRemotePlayback":case"formNoValidate":case"hidden":case"loop":case"noModule":case"noValidate":case"open":case"playsInline":case"readOnly":case"required":case"reversed":case"scoped":case"seamless":case"itemScope":l&&typeof l!="function"&&typeof l!="symbol"?e.setAttribute(s,""):e.removeAttribute(s);break;case"capture":case"download":l===!0?e.setAttribute(s,""):l!==!1&&l!=null&&typeof l!="function"&&typeof l!="symbol"?e.setAttribute(s,l):e.removeAttribute(s);break;case"cols":case"rows":case"size":case"span":l!=null&&typeof l!="function"&&typeof l!="symbol"&&!isNaN(l)&&1<=l?e.setAttribute(s,l):e.removeAttribute(s);break;case"rowSpan":case"start":l==null||typeof l=="function"||typeof l=="symbol"||isNaN(l)?e.removeAttribute(s):e.setAttribute(s,l);break;case"popover":kt("beforetoggle",e),kt("toggle",e),ga(e,"popover",l);break;case"xlinkActuate":Mn(e,"http://www.w3.org/1999/xlink","xlink:actuate",l);break;case"xlinkArcrole":Mn(e,"http://www.w3.org/1999/xlink","xlink:arcrole",l);break;case"xlinkRole":Mn(e,"http://www.w3.org/1999/xlink","xlink:role",l);break;case"xlinkShow":Mn(e,"http://www.w3.org/1999/xlink","xlink:show",l);break;case"xlinkTitle":Mn(e,"http://www.w3.org/1999/xlink","xlink:title",l);break;case"xlinkType":Mn(e,"http://www.w3.org/1999/xlink","xlink:type",l);break;case"xmlBase":Mn(e,"http://www.w3.org/XML/1998/namespace","xml:base",l);break;case"xmlLang":Mn(e,"http://www.w3.org/XML/1998/namespace","xml:lang",l);break;case"xmlSpace":Mn(e,"http://www.w3.org/XML/1998/namespace","xml:space",l);break;case"is":ga(e,"is",l);break;case"innerText":case"textContent":break;default:(!(2<s.length)||s[0]!=="o"&&s[0]!=="O"||s[1]!=="n"&&s[1]!=="N")&&(s=Du.get(s)||s,ga(e,s,l))}}function Hf(e,r,s,l,h,f){switch(s){case"style":Uo(e,l,f);break;case"dangerouslySetInnerHTML":if(l!=null){if(typeof l!="object"||!("__html"in l))throw Error(a(61));if(s=l.__html,s!=null){if(h.children!=null)throw Error(a(60));e.innerHTML=s}}break;case"children":typeof l=="string"?On(e,l):(typeof l=="number"||typeof l=="bigint")&&On(e,""+l);break;case"onScroll":l!=null&&kt("scroll",e);break;case"onScrollEnd":l!=null&&kt("scrollend",e);break;case"onClick":l!=null&&(e.onclick=jc);break;case"suppressContentEditableWarning":case"suppressHydrationWarning":case"innerHTML":case"ref":break;case"innerText":case"textContent":break;default:if(!pa.hasOwnProperty(s))t:{if(s[0]==="o"&&s[1]==="n"&&(h=s.endsWith("Capture"),r=s.slice(2,h?s.length-7:void 0),f=e[He]||null,f=f!=null?f[s]:null,typeof f=="function"&&e.removeEventListener(r,f,h),typeof l=="function")){typeof f!="function"&&f!==null&&(s in e?e[s]=null:e.hasAttribute(s)&&e.removeAttribute(s)),e.addEventListener(r,l,h);break t}s in e?e[s]=l:l===!0?e.setAttribute(s,""):ga(e,s,l)}}}function Qe(e,r,s){switch(r){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"img":kt("error",e),kt("load",e);var l=!1,h=!1,f;for(f in s)if(s.hasOwnProperty(f)){var E=s[f];if(E!=null)switch(f){case"src":l=!0;break;case"srcSet":h=!0;break;case"children":case"dangerouslySetInnerHTML":throw Error(a(137,r));default:te(e,r,f,E,s,null)}}h&&te(e,r,"srcSet",s.srcSet,s,null),l&&te(e,r,"src",s.src,s,null);return;case"input":kt("invalid",e);var b=f=E=h=null,N=null,H=null;for(l in s)if(s.hasOwnProperty(l)){var et=s[l];if(et!=null)switch(l){case"name":h=et;break;case"type":E=et;break;case"checked":N=et;break;case"defaultChecked":H=et;break;case"value":f=et;break;case"defaultValue":b=et;break;case"children":case"dangerouslySetInnerHTML":if(et!=null)throw Error(a(137,r));break;default:te(e,r,l,et,s,null)}}Vo(e,f,b,N,H,E,h,!1),wr(e);return;case"select":kt("invalid",e),l=E=f=null;for(h in s)if(s.hasOwnProperty(h)&&(b=s[h],b!=null))switch(h){case"value":f=b;break;case"defaultValue":E=b;break;case"multiple":l=b;default:te(e,r,h,b,s,null)}r=f,s=E,e.multiple=!!l,r!=null?br(e,!!l,r,!1):s!=null&&br(e,!!l,s,!0);return;case"textarea":kt("invalid",e),f=h=l=null;for(E in s)if(s.hasOwnProperty(E)&&(b=s[E],b!=null))switch(E){case"value":l=b;break;case"defaultValue":h=b;break;case"children":f=b;break;case"dangerouslySetInnerHTML":if(b!=null)throw Error(a(91));break;default:te(e,r,E,b,s,null)}Cu(e,l,h,f),wr(e);return;case"option":for(N in s)if(s.hasOwnProperty(N)&&(l=s[N],l!=null))switch(N){case"selected":e.selected=l&&typeof l!="function"&&typeof l!="symbol";break;default:te(e,r,N,l,s,null)}return;case"dialog":kt("beforetoggle",e),kt("toggle",e),kt("cancel",e),kt("close",e);break;case"iframe":case"object":kt("load",e);break;case"video":case"audio":for(l=0;l<bl.length;l++)kt(bl[l],e);break;case"image":kt("error",e),kt("load",e);break;case"details":kt("toggle",e);break;case"embed":case"source":case"link":kt("error",e),kt("load",e);case"area":case"base":case"br":case"col":case"hr":case"keygen":case"meta":case"param":case"track":case"wbr":case"menuitem":for(H in s)if(s.hasOwnProperty(H)&&(l=s[H],l!=null))switch(H){case"children":case"dangerouslySetInnerHTML":throw Error(a(137,r));default:te(e,r,H,l,s,null)}return;default:if(ps(r)){for(et in s)s.hasOwnProperty(et)&&(l=s[et],l!==void 0&&Hf(e,r,et,l,s,void 0));return}}for(b in s)s.hasOwnProperty(b)&&(l=s[b],l!=null&&te(e,r,b,l,s,null))}function bb(e,r,s,l){switch(r){case"div":case"span":case"svg":case"path":case"a":case"g":case"p":case"li":break;case"input":var h=null,f=null,E=null,b=null,N=null,H=null,et=null;for(Q in s){var rt=s[Q];if(s.hasOwnProperty(Q)&&rt!=null)switch(Q){case"checked":break;case"value":break;case"defaultValue":N=rt;default:l.hasOwnProperty(Q)||te(e,r,Q,null,l,rt)}}for(var G in l){var Q=l[G];if(rt=s[G],l.hasOwnProperty(G)&&(Q!=null||rt!=null))switch(G){case"type":f=Q;break;case"name":h=Q;break;case"checked":H=Q;break;case"defaultChecked":et=Q;break;case"value":E=Q;break;case"defaultValue":b=Q;break;case"children":case"dangerouslySetInnerHTML":if(Q!=null)throw Error(a(137,r));break;default:Q!==rt&&te(e,r,G,Q,l,rt)}}Oo(e,E,b,N,H,et,f,h);return;case"select":Q=E=b=G=null;for(f in s)if(N=s[f],s.hasOwnProperty(f)&&N!=null)switch(f){case"value":break;case"multiple":Q=N;default:l.hasOwnProperty(f)||te(e,r,f,null,l,N)}for(h in l)if(f=l[h],N=s[h],l.hasOwnProperty(h)&&(f!=null||N!=null))switch(h){case"value":G=f;break;case"defaultValue":b=f;break;case"multiple":E=f;default:f!==N&&te(e,r,h,f,l,N)}r=b,s=E,l=Q,G!=null?br(e,!!s,G,!1):!!l!=!!s&&(r!=null?br(e,!!s,r,!0):br(e,!!s,s?[]:"",!1));return;case"textarea":Q=G=null;for(b in s)if(h=s[b],s.hasOwnProperty(b)&&h!=null&&!l.hasOwnProperty(b))switch(b){case"value":break;case"children":break;default:te(e,r,b,null,l,h)}for(E in l)if(h=l[E],f=s[E],l.hasOwnProperty(E)&&(h!=null||f!=null))switch(E){case"value":G=h;break;case"defaultValue":Q=h;break;case"children":break;case"dangerouslySetInnerHTML":if(h!=null)throw Error(a(91));break;default:h!==f&&te(e,r,E,h,l,f)}ju(e,G,Q);return;case"option":for(var Tt in s)if(G=s[Tt],s.hasOwnProperty(Tt)&&G!=null&&!l.hasOwnProperty(Tt))switch(Tt){case"selected":e.selected=!1;break;default:te(e,r,Tt,null,l,G)}for(N in l)if(G=l[N],Q=s[N],l.hasOwnProperty(N)&&G!==Q&&(G!=null||Q!=null))switch(N){case"selected":e.selected=G&&typeof G!="function"&&typeof G!="symbol";break;default:te(e,r,N,G,l,Q)}return;case"img":case"link":case"area":case"base":case"br":case"col":case"embed":case"hr":case"keygen":case"meta":case"param":case"source":case"track":case"wbr":case"menuitem":for(var Et in s)G=s[Et],s.hasOwnProperty(Et)&&G!=null&&!l.hasOwnProperty(Et)&&te(e,r,Et,null,l,G);for(H in l)if(G=l[H],Q=s[H],l.hasOwnProperty(H)&&G!==Q&&(G!=null||Q!=null))switch(H){case"children":case"dangerouslySetInnerHTML":if(G!=null)throw Error(a(137,r));break;default:te(e,r,H,G,l,Q)}return;default:if(ps(r)){for(var ee in s)G=s[ee],s.hasOwnProperty(ee)&&G!==void 0&&!l.hasOwnProperty(ee)&&Hf(e,r,ee,void 0,l,G);for(et in l)G=l[et],Q=s[et],!l.hasOwnProperty(et)||G===Q||G===void 0&&Q===void 0||Hf(e,r,et,G,l,Q);return}}for(var $ in s)G=s[$],s.hasOwnProperty($)&&G!=null&&!l.hasOwnProperty($)&&te(e,r,$,null,l,G);for(rt in l)G=l[rt],Q=s[rt],!l.hasOwnProperty(rt)||G===Q||G==null&&Q==null||te(e,r,rt,G,l,Q)}var Gf=null,Yf=null;function Cc(e){return e.nodeType===9?e:e.ownerDocument}function O1(e){switch(e){case"http://www.w3.org/2000/svg":return 1;case"http://www.w3.org/1998/Math/MathML":return 2;default:return 0}}function V1(e,r){if(e===0)switch(r){case"svg":return 1;case"math":return 2;default:return 0}return e===1&&r==="foreignObject"?0:e}function Qf(e,r){return e==="textarea"||e==="noscript"||typeof r.children=="string"||typeof r.children=="number"||typeof r.children=="bigint"||typeof r.dangerouslySetInnerHTML=="object"&&r.dangerouslySetInnerHTML!==null&&r.dangerouslySetInnerHTML.__html!=null}var Xf=null;function Tb(){var e=window.event;return e&&e.type==="popstate"?e===Xf?!1:(Xf=e,!0):(Xf=null,!1)}var k1=typeof setTimeout=="function"?setTimeout:void 0,Sb=typeof clearTimeout=="function"?clearTimeout:void 0,P1=typeof Promise=="function"?Promise:void 0,Ab=typeof queueMicrotask=="function"?queueMicrotask:typeof P1<"u"?function(e){return P1.resolve(null).then(e).catch(Rb)}:k1;function Rb(e){setTimeout(function(){throw e})}function Fr(e){return e==="head"}function U1(e,r){var s=r,l=0,h=0;do{var f=s.nextSibling;if(e.removeChild(s),f&&f.nodeType===8)if(s=f.data,s==="/$"){if(0<l&&8>l){s=l;var E=e.ownerDocument;if(s&1&&Sl(E.documentElement),s&2&&Sl(E.body),s&4)for(s=E.head,Sl(s),E=s.firstChild;E;){var b=E.nextSibling,N=E.nodeName;E[xr]||N==="SCRIPT"||N==="STYLE"||N==="LINK"&&E.rel.toLowerCase()==="stylesheet"||s.removeChild(E),E=b}}if(h===0){e.removeChild(f),Ml(r);return}h--}else s==="$"||s==="$?"||s==="$!"?h++:l=s.charCodeAt(0)-48;else l=0;s=f}while(s);Ml(r)}function Wf(e){var r=e.firstChild;for(r&&r.nodeType===10&&(r=r.nextSibling);r;){var s=r;switch(r=r.nextSibling,s.nodeName){case"HTML":case"HEAD":case"BODY":Wf(s),us(s);continue;case"SCRIPT":case"STYLE":continue;case"LINK":if(s.rel.toLowerCase()==="stylesheet")continue}e.removeChild(s)}}function Ib(e,r,s,l){for(;e.nodeType===1;){var h=s;if(e.nodeName.toLowerCase()!==r.toLowerCase()){if(!l&&(e.nodeName!=="INPUT"||e.type!=="hidden"))break}else if(l){if(!e[xr])switch(r){case"meta":if(!e.hasAttribute("itemprop"))break;return e;case"link":if(f=e.getAttribute("rel"),f==="stylesheet"&&e.hasAttribute("data-precedence"))break;if(f!==h.rel||e.getAttribute("href")!==(h.href==null||h.href===""?null:h.href)||e.getAttribute("crossorigin")!==(h.crossOrigin==null?null:h.crossOrigin)||e.getAttribute("title")!==(h.title==null?null:h.title))break;return e;case"style":if(e.hasAttribute("data-precedence"))break;return e;case"script":if(f=e.getAttribute("src"),(f!==(h.src==null?null:h.src)||e.getAttribute("type")!==(h.type==null?null:h.type)||e.getAttribute("crossorigin")!==(h.crossOrigin==null?null:h.crossOrigin))&&f&&e.hasAttribute("async")&&!e.hasAttribute("itemprop"))break;return e;default:return e}}else if(r==="input"&&e.type==="hidden"){var f=h.name==null?null:""+h.name;if(h.type==="hidden"&&e.getAttribute("name")===f)return e}else return e;if(e=ni(e.nextSibling),e===null)break}return null}function jb(e,r,s){if(r==="")return null;for(;e.nodeType!==3;)if((e.nodeType!==1||e.nodeName!=="INPUT"||e.type!=="hidden")&&!s||(e=ni(e.nextSibling),e===null))return null;return e}function Zf(e){return e.data==="$!"||e.data==="$?"&&e.ownerDocument.readyState==="complete"}function Cb(e,r){var s=e.ownerDocument;if(e.data!=="$?"||s.readyState==="complete")r();else{var l=function(){r(),s.removeEventListener("DOMContentLoaded",l)};s.addEventListener("DOMContentLoaded",l),e._reactRetry=l}}function ni(e){for(;e!=null;e=e.nextSibling){var r=e.nodeType;if(r===1||r===3)break;if(r===8){if(r=e.data,r==="$"||r==="$!"||r==="$?"||r==="F!"||r==="F")break;if(r==="/$")return null}}return e}var Jf=null;function L1(e){e=e.previousSibling;for(var r=0;e;){if(e.nodeType===8){var s=e.data;if(s==="$"||s==="$!"||s==="$?"){if(r===0)return e;r--}else s==="/$"&&r++}e=e.previousSibling}return null}function z1(e,r,s){switch(r=Cc(s),e){case"html":if(e=r.documentElement,!e)throw Error(a(452));return e;case"head":if(e=r.head,!e)throw Error(a(453));return e;case"body":if(e=r.body,!e)throw Error(a(454));return e;default:throw Error(a(451))}}function Sl(e){for(var r=e.attributes;r.length;)e.removeAttributeNode(r[0]);us(e)}var Bn=new Map,$1=new Set;function Dc(e){return typeof e.getRootNode=="function"?e.getRootNode():e.nodeType===9?e:e.ownerDocument}var tr=dt.d;dt.d={f:Db,r:Nb,D:Mb,C:Ob,L:Vb,m:kb,X:Ub,S:Pb,M:Lb};function Db(){var e=tr.f(),r=wc();return e||r}function Nb(e){var r=ci(e);r!==null&&r.tag===5&&r.type==="form"?oy(r):tr.r(e)}var Hs=typeof document>"u"?null:document;function B1(e,r,s){var l=Hs;if(l&&typeof r=="string"&&r){var h=ze(r);h='link[rel="'+e+'"][href="'+h+'"]',typeof s=="string"&&(h+='[crossorigin="'+s+'"]'),$1.has(h)||($1.add(h),e={rel:e,crossOrigin:s,href:r},l.querySelector(h)===null&&(r=l.createElement("link"),Qe(r,"link",e),Ee(r),l.head.appendChild(r)))}}function Mb(e){tr.D(e),B1("dns-prefetch",e,null)}function Ob(e,r){tr.C(e,r),B1("preconnect",e,r)}function Vb(e,r,s){tr.L(e,r,s);var l=Hs;if(l&&e&&r){var h='link[rel="preload"][as="'+ze(r)+'"]';r==="image"&&s&&s.imageSrcSet?(h+='[imagesrcset="'+ze(s.imageSrcSet)+'"]',typeof s.imageSizes=="string"&&(h+='[imagesizes="'+ze(s.imageSizes)+'"]')):h+='[href="'+ze(e)+'"]';var f=h;switch(r){case"style":f=Gs(e);break;case"script":f=Ys(e)}Bn.has(f)||(e=v({rel:"preload",href:r==="image"&&s&&s.imageSrcSet?void 0:e,as:r},s),Bn.set(f,e),l.querySelector(h)!==null||r==="style"&&l.querySelector(Al(f))||r==="script"&&l.querySelector(Rl(f))||(r=l.createElement("link"),Qe(r,"link",e),Ee(r),l.head.appendChild(r)))}}function kb(e,r){tr.m(e,r);var s=Hs;if(s&&e){var l=r&&typeof r.as=="string"?r.as:"script",h='link[rel="modulepreload"][as="'+ze(l)+'"][href="'+ze(e)+'"]',f=h;switch(l){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":f=Ys(e)}if(!Bn.has(f)&&(e=v({rel:"modulepreload",href:e},r),Bn.set(f,e),s.querySelector(h)===null)){switch(l){case"audioworklet":case"paintworklet":case"serviceworker":case"sharedworker":case"worker":case"script":if(s.querySelector(Rl(f)))return}l=s.createElement("link"),Qe(l,"link",e),Ee(l),s.head.appendChild(l)}}}function Pb(e,r,s){tr.S(e,r,s);var l=Hs;if(l&&e){var h=_r(l).hoistableStyles,f=Gs(e);r=r||"default";var E=h.get(f);if(!E){var b={loading:0,preload:null};if(E=l.querySelector(Al(f)))b.loading=5;else{e=v({rel:"stylesheet",href:e,"data-precedence":r},s),(s=Bn.get(f))&&tp(e,s);var N=E=l.createElement("link");Ee(N),Qe(N,"link",e),N._p=new Promise(function(H,et){N.onload=H,N.onerror=et}),N.addEventListener("load",function(){b.loading|=1}),N.addEventListener("error",function(){b.loading|=2}),b.loading|=4,Nc(E,r,l)}E={type:"stylesheet",instance:E,count:1,state:b},h.set(f,E)}}}function Ub(e,r){tr.X(e,r);var s=Hs;if(s&&e){var l=_r(s).hoistableScripts,h=Ys(e),f=l.get(h);f||(f=s.querySelector(Rl(h)),f||(e=v({src:e,async:!0},r),(r=Bn.get(h))&&ep(e,r),f=s.createElement("script"),Ee(f),Qe(f,"link",e),s.head.appendChild(f)),f={type:"script",instance:f,count:1,state:null},l.set(h,f))}}function Lb(e,r){tr.M(e,r);var s=Hs;if(s&&e){var l=_r(s).hoistableScripts,h=Ys(e),f=l.get(h);f||(f=s.querySelector(Rl(h)),f||(e=v({src:e,async:!0,type:"module"},r),(r=Bn.get(h))&&ep(e,r),f=s.createElement("script"),Ee(f),Qe(f,"link",e),s.head.appendChild(f)),f={type:"script",instance:f,count:1,state:null},l.set(h,f))}}function F1(e,r,s,l){var h=(h=_t.current)?Dc(h):null;if(!h)throw Error(a(446));switch(e){case"meta":case"title":return null;case"style":return typeof s.precedence=="string"&&typeof s.href=="string"?(r=Gs(s.href),s=_r(h).hoistableStyles,l=s.get(r),l||(l={type:"style",instance:null,count:0,state:null},s.set(r,l)),l):{type:"void",instance:null,count:0,state:null};case"link":if(s.rel==="stylesheet"&&typeof s.href=="string"&&typeof s.precedence=="string"){e=Gs(s.href);var f=_r(h).hoistableStyles,E=f.get(e);if(E||(h=h.ownerDocument||h,E={type:"stylesheet",instance:null,count:0,state:{loading:0,preload:null}},f.set(e,E),(f=h.querySelector(Al(e)))&&!f._p&&(E.instance=f,E.state.loading=5),Bn.has(e)||(s={rel:"preload",as:"style",href:s.href,crossOrigin:s.crossOrigin,integrity:s.integrity,media:s.media,hrefLang:s.hrefLang,referrerPolicy:s.referrerPolicy},Bn.set(e,s),f||zb(h,e,s,E.state))),r&&l===null)throw Error(a(528,""));return E}if(r&&l!==null)throw Error(a(529,""));return null;case"script":return r=s.async,s=s.src,typeof s=="string"&&r&&typeof r!="function"&&typeof r!="symbol"?(r=Ys(s),s=_r(h).hoistableScripts,l=s.get(r),l||(l={type:"script",instance:null,count:0,state:null},s.set(r,l)),l):{type:"void",instance:null,count:0,state:null};default:throw Error(a(444,e))}}function Gs(e){return'href="'+ze(e)+'"'}function Al(e){return'link[rel="stylesheet"]['+e+"]"}function q1(e){return v({},e,{"data-precedence":e.precedence,precedence:null})}function zb(e,r,s,l){e.querySelector('link[rel="preload"][as="style"]['+r+"]")?l.loading=1:(r=e.createElement("link"),l.preload=r,r.addEventListener("load",function(){return l.loading|=1}),r.addEventListener("error",function(){return l.loading|=2}),Qe(r,"link",s),Ee(r),e.head.appendChild(r))}function Ys(e){return'[src="'+ze(e)+'"]'}function Rl(e){return"script[async]"+e}function K1(e,r,s){if(r.count++,r.instance===null)switch(r.type){case"style":var l=e.querySelector('style[data-href~="'+ze(s.href)+'"]');if(l)return r.instance=l,Ee(l),l;var h=v({},s,{"data-href":s.href,"data-precedence":s.precedence,href:null,precedence:null});return l=(e.ownerDocument||e).createElement("style"),Ee(l),Qe(l,"style",h),Nc(l,s.precedence,e),r.instance=l;case"stylesheet":h=Gs(s.href);var f=e.querySelector(Al(h));if(f)return r.state.loading|=4,r.instance=f,Ee(f),f;l=q1(s),(h=Bn.get(h))&&tp(l,h),f=(e.ownerDocument||e).createElement("link"),Ee(f);var E=f;return E._p=new Promise(function(b,N){E.onload=b,E.onerror=N}),Qe(f,"link",l),r.state.loading|=4,Nc(f,s.precedence,e),r.instance=f;case"script":return f=Ys(s.src),(h=e.querySelector(Rl(f)))?(r.instance=h,Ee(h),h):(l=s,(h=Bn.get(f))&&(l=v({},s),ep(l,h)),e=e.ownerDocument||e,h=e.createElement("script"),Ee(h),Qe(h,"link",l),e.head.appendChild(h),r.instance=h);case"void":return null;default:throw Error(a(443,r.type))}else r.type==="stylesheet"&&(r.state.loading&4)===0&&(l=r.instance,r.state.loading|=4,Nc(l,s.precedence,e));return r.instance}function Nc(e,r,s){for(var l=s.querySelectorAll('link[rel="stylesheet"][data-precedence],style[data-precedence]'),h=l.length?l[l.length-1]:null,f=h,E=0;E<l.length;E++){var b=l[E];if(b.dataset.precedence===r)f=b;else if(f!==h)break}f?f.parentNode.insertBefore(e,f.nextSibling):(r=s.nodeType===9?s.head:s,r.insertBefore(e,r.firstChild))}function tp(e,r){e.crossOrigin==null&&(e.crossOrigin=r.crossOrigin),e.referrerPolicy==null&&(e.referrerPolicy=r.referrerPolicy),e.title==null&&(e.title=r.title)}function ep(e,r){e.crossOrigin==null&&(e.crossOrigin=r.crossOrigin),e.referrerPolicy==null&&(e.referrerPolicy=r.referrerPolicy),e.integrity==null&&(e.integrity=r.integrity)}var Mc=null;function H1(e,r,s){if(Mc===null){var l=new Map,h=Mc=new Map;h.set(s,l)}else h=Mc,l=h.get(s),l||(l=new Map,h.set(s,l));if(l.has(e))return l;for(l.set(e,null),s=s.getElementsByTagName(e),h=0;h<s.length;h++){var f=s[h];if(!(f[xr]||f[_e]||e==="link"&&f.getAttribute("rel")==="stylesheet")&&f.namespaceURI!=="http://www.w3.org/2000/svg"){var E=f.getAttribute(r)||"";E=e+E;var b=l.get(E);b?b.push(f):l.set(E,[f])}}return l}function G1(e,r,s){e=e.ownerDocument||e,e.head.insertBefore(s,r==="title"?e.querySelector("head > title"):null)}function $b(e,r,s){if(s===1||r.itemProp!=null)return!1;switch(e){case"meta":case"title":return!0;case"style":if(typeof r.precedence!="string"||typeof r.href!="string"||r.href==="")break;return!0;case"link":if(typeof r.rel!="string"||typeof r.href!="string"||r.href===""||r.onLoad||r.onError)break;switch(r.rel){case"stylesheet":return e=r.disabled,typeof r.precedence=="string"&&e==null;default:return!0}case"script":if(r.async&&typeof r.async!="function"&&typeof r.async!="symbol"&&!r.onLoad&&!r.onError&&r.src&&typeof r.src=="string")return!0}return!1}function Y1(e){return!(e.type==="stylesheet"&&(e.state.loading&3)===0)}var Il=null;function Bb(){}function Fb(e,r,s){if(Il===null)throw Error(a(475));var l=Il;if(r.type==="stylesheet"&&(typeof s.media!="string"||matchMedia(s.media).matches!==!1)&&(r.state.loading&4)===0){if(r.instance===null){var h=Gs(s.href),f=e.querySelector(Al(h));if(f){e=f._p,e!==null&&typeof e=="object"&&typeof e.then=="function"&&(l.count++,l=Oc.bind(l),e.then(l,l)),r.state.loading|=4,r.instance=f,Ee(f);return}f=e.ownerDocument||e,s=q1(s),(h=Bn.get(h))&&tp(s,h),f=f.createElement("link"),Ee(f);var E=f;E._p=new Promise(function(b,N){E.onload=b,E.onerror=N}),Qe(f,"link",s),r.instance=f}l.stylesheets===null&&(l.stylesheets=new Map),l.stylesheets.set(r,e),(e=r.state.preload)&&(r.state.loading&3)===0&&(l.count++,r=Oc.bind(l),e.addEventListener("load",r),e.addEventListener("error",r))}}function qb(){if(Il===null)throw Error(a(475));var e=Il;return e.stylesheets&&e.count===0&&np(e,e.stylesheets),0<e.count?function(r){var s=setTimeout(function(){if(e.stylesheets&&np(e,e.stylesheets),e.unsuspend){var l=e.unsuspend;e.unsuspend=null,l()}},6e4);return e.unsuspend=r,function(){e.unsuspend=null,clearTimeout(s)}}:null}function Oc(){if(this.count--,this.count===0){if(this.stylesheets)np(this,this.stylesheets);else if(this.unsuspend){var e=this.unsuspend;this.unsuspend=null,e()}}}var Vc=null;function np(e,r){e.stylesheets=null,e.unsuspend!==null&&(e.count++,Vc=new Map,r.forEach(Kb,e),Vc=null,Oc.call(e))}function Kb(e,r){if(!(r.state.loading&4)){var s=Vc.get(e);if(s)var l=s.get(null);else{s=new Map,Vc.set(e,s);for(var h=e.querySelectorAll("link[data-precedence],style[data-precedence]"),f=0;f<h.length;f++){var E=h[f];(E.nodeName==="LINK"||E.getAttribute("media")!=="not all")&&(s.set(E.dataset.precedence,E),l=E)}l&&s.set(null,l)}h=r.instance,E=h.getAttribute("data-precedence"),f=s.get(E)||l,f===l&&s.set(null,h),s.set(E,h),this.count++,l=Oc.bind(this),h.addEventListener("load",l),h.addEventListener("error",l),f?f.parentNode.insertBefore(h,f.nextSibling):(e=e.nodeType===9?e.head:e,e.insertBefore(h,e.firstChild)),r.state.loading|=4}}var jl={$$typeof:tt,Provider:null,Consumer:null,_currentValue:yt,_currentValue2:yt,_threadCount:0};function Hb(e,r,s,l,h,f,E,b){this.tag=1,this.containerInfo=e,this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.next=this.pendingContext=this.context=this.cancelPendingCommit=null,this.callbackPriority=0,this.expirationTimes=ls(-1),this.entangledLanes=this.shellSuspendCounter=this.errorRecoveryDisabledLanes=this.expiredLanes=this.warmLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=ls(0),this.hiddenUpdates=ls(null),this.identifierPrefix=l,this.onUncaughtError=h,this.onCaughtError=f,this.onRecoverableError=E,this.pooledCache=null,this.pooledCacheLanes=0,this.formState=b,this.incompleteTransitions=new Map}function Q1(e,r,s,l,h,f,E,b,N,H,et,rt){return e=new Hb(e,r,s,E,b,N,H,rt),r=1,f===!0&&(r|=24),f=bn(3,null,null,r),e.current=f,f.stateNode=e,r=kd(),r.refCount++,e.pooledCache=r,r.refCount++,f.memoizedState={element:l,isDehydrated:s,cache:r},zd(f),e}function X1(e){return e?(e=Ss,e):Ss}function W1(e,r,s,l,h,f){h=X1(h),l.context===null?l.context=h:l.pendingContext=h,l=Cr(r),l.payload={element:s},f=f===void 0?null:f,f!==null&&(l.callback=f),s=Dr(e,l,r),s!==null&&(In(s,e,r),al(s,e,r))}function Z1(e,r){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var s=e.retryLane;e.retryLane=s!==0&&s<r?s:r}}function ip(e,r){Z1(e,r),(e=e.alternate)&&Z1(e,r)}function J1(e){if(e.tag===13){var r=Ts(e,67108864);r!==null&&In(r,e,67108864),ip(e,67108864)}}var kc=!0;function Gb(e,r,s,l){var h=J.T;J.T=null;var f=dt.p;try{dt.p=2,rp(e,r,s,l)}finally{dt.p=f,J.T=h}}function Yb(e,r,s,l){var h=J.T;J.T=null;var f=dt.p;try{dt.p=8,rp(e,r,s,l)}finally{dt.p=f,J.T=h}}function rp(e,r,s,l){if(kc){var h=ap(l);if(h===null)Kf(e,r,l,Pc,s),ex(e,l);else if(Xb(h,e,r,s,l))l.stopPropagation();else if(ex(e,l),r&4&&-1<Qb.indexOf(e)){for(;h!==null;){var f=ci(h);if(f!==null)switch(f.tag){case 3:if(f=f.stateNode,f.current.memoizedState.isDehydrated){var E=Gn(f.pendingLanes);if(E!==0){var b=f;for(b.pendingLanes|=2,b.entangledLanes|=2;E;){var N=1<<31-ln(E);b.entanglements[1]|=N,E&=~N}_i(f),(Xt&6)===0&&(_c=pn()+500,wl(0))}}break;case 13:b=Ts(f,2),b!==null&&In(b,f,2),wc(),ip(f,2)}if(f=ap(l),f===null&&Kf(e,r,l,Pc,s),f===h)break;h=f}h!==null&&l.stopPropagation()}else Kf(e,r,l,null,s)}}function ap(e){return e=zo(e),sp(e)}var Pc=null;function sp(e){if(Pc=null,e=ui(e),e!==null){var r=u(e);if(r===null)e=null;else{var s=r.tag;if(s===13){if(e=d(r),e!==null)return e;e=null}else if(s===3){if(r.stateNode.current.memoizedState.isDehydrated)return r.tag===3?r.stateNode.containerInfo:null;e=null}else r!==e&&(e=null)}}return Pc=e,null}function tx(e){switch(e){case"beforetoggle":case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"toggle":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 2;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 8;case"message":switch(Tu()){case Oe:return 2;case Le:return 8;case Oi:case cd:return 32;case Co:return 268435456;default:return 32}default:return 32}}var op=!1,qr=null,Kr=null,Hr=null,Cl=new Map,Dl=new Map,Gr=[],Qb="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");function ex(e,r){switch(e){case"focusin":case"focusout":qr=null;break;case"dragenter":case"dragleave":Kr=null;break;case"mouseover":case"mouseout":Hr=null;break;case"pointerover":case"pointerout":Cl.delete(r.pointerId);break;case"gotpointercapture":case"lostpointercapture":Dl.delete(r.pointerId)}}function Nl(e,r,s,l,h,f){return e===null||e.nativeEvent!==f?(e={blockedOn:r,domEventName:s,eventSystemFlags:l,nativeEvent:f,targetContainers:[h]},r!==null&&(r=ci(r),r!==null&&J1(r)),e):(e.eventSystemFlags|=l,r=e.targetContainers,h!==null&&r.indexOf(h)===-1&&r.push(h),e)}function Xb(e,r,s,l,h){switch(r){case"focusin":return qr=Nl(qr,e,r,s,l,h),!0;case"dragenter":return Kr=Nl(Kr,e,r,s,l,h),!0;case"mouseover":return Hr=Nl(Hr,e,r,s,l,h),!0;case"pointerover":var f=h.pointerId;return Cl.set(f,Nl(Cl.get(f)||null,e,r,s,l,h)),!0;case"gotpointercapture":return f=h.pointerId,Dl.set(f,Nl(Dl.get(f)||null,e,r,s,l,h)),!0}return!1}function nx(e){var r=ui(e.target);if(r!==null){var s=u(r);if(s!==null){if(r=s.tag,r===13){if(r=d(s),r!==null){e.blockedOn=r,fd(e.priority,function(){if(s.tag===13){var l=Rn();l=No(l);var h=Ts(s,l);h!==null&&In(h,s,l),ip(s,l)}});return}}else if(r===3&&s.stateNode.current.memoizedState.isDehydrated){e.blockedOn=s.tag===3?s.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Uc(e){if(e.blockedOn!==null)return!1;for(var r=e.targetContainers;0<r.length;){var s=ap(e.nativeEvent);if(s===null){s=e.nativeEvent;var l=new s.constructor(s.type,s);Lo=l,s.target.dispatchEvent(l),Lo=null}else return r=ci(s),r!==null&&J1(r),e.blockedOn=s,!1;r.shift()}return!0}function ix(e,r,s){Uc(e)&&s.delete(r)}function Wb(){op=!1,qr!==null&&Uc(qr)&&(qr=null),Kr!==null&&Uc(Kr)&&(Kr=null),Hr!==null&&Uc(Hr)&&(Hr=null),Cl.forEach(ix),Dl.forEach(ix)}function Lc(e,r){e.blockedOn===r&&(e.blockedOn=null,op||(op=!0,n.unstable_scheduleCallback(n.unstable_NormalPriority,Wb)))}var zc=null;function rx(e){zc!==e&&(zc=e,n.unstable_scheduleCallback(n.unstable_NormalPriority,function(){zc===e&&(zc=null);for(var r=0;r<e.length;r+=3){var s=e[r],l=e[r+1],h=e[r+2];if(typeof l!="function"){if(sp(l||s)===null)continue;break}var f=ci(s);f!==null&&(e.splice(r,3),r-=3,sf(f,{pending:!0,data:h,method:s.method,action:l},l,h))}}))}function Ml(e){function r(N){return Lc(N,e)}qr!==null&&Lc(qr,e),Kr!==null&&Lc(Kr,e),Hr!==null&&Lc(Hr,e),Cl.forEach(r),Dl.forEach(r);for(var s=0;s<Gr.length;s++){var l=Gr[s];l.blockedOn===e&&(l.blockedOn=null)}for(;0<Gr.length&&(s=Gr[0],s.blockedOn===null);)nx(s),s.blockedOn===null&&Gr.shift();if(s=(e.ownerDocument||e).$$reactFormReplay,s!=null)for(l=0;l<s.length;l+=3){var h=s[l],f=s[l+1],E=h[He]||null;if(typeof f=="function")E||rx(s);else if(E){var b=null;if(f&&f.hasAttribute("formAction")){if(h=f,E=f[He]||null)b=E.formAction;else if(sp(h)!==null)continue}else b=E.action;typeof b=="function"?s[l+1]=b:(s.splice(l,3),l-=3),rx(s)}}}function lp(e){this._internalRoot=e}$c.prototype.render=lp.prototype.render=function(e){var r=this._internalRoot;if(r===null)throw Error(a(409));var s=r.current,l=Rn();W1(s,l,e,r,null,null)},$c.prototype.unmount=lp.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var r=e.containerInfo;W1(e.current,2,null,e,null,null),wc(),r[ki]=null}};function $c(e){this._internalRoot=e}$c.prototype.unstable_scheduleHydration=function(e){if(e){var r=Vi();e={blockedOn:null,target:e,priority:r};for(var s=0;s<Gr.length&&r!==0&&r<Gr[s].priority;s++);Gr.splice(s,0,e),s===0&&nx(e)}};var ax=t.version;if(ax!=="19.1.1")throw Error(a(527,ax,"19.1.1"));dt.findDOMNode=function(e){var r=e._reactInternals;if(r===void 0)throw typeof e.render=="function"?Error(a(188)):(e=Object.keys(e).join(","),Error(a(268,e)));return e=p(r),e=e!==null?g(e):null,e=e===null?null:e.stateNode,e};var Zb={bundleType:0,version:"19.1.1",rendererPackageName:"react-dom",currentDispatcherRef:J,reconcilerVersion:"19.1.1"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var Bc=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!Bc.isDisabled&&Bc.supportsFiber)try{dr=Bc.inject(Zb),Je=Bc}catch{}}return Pl.createRoot=function(e,r){if(!o(e))throw Error(a(299));var s=!1,l="",h=Ey,f=wy,E=by,b=null;return r!=null&&(r.unstable_strictMode===!0&&(s=!0),r.identifierPrefix!==void 0&&(l=r.identifierPrefix),r.onUncaughtError!==void 0&&(h=r.onUncaughtError),r.onCaughtError!==void 0&&(f=r.onCaughtError),r.onRecoverableError!==void 0&&(E=r.onRecoverableError),r.unstable_transitionCallbacks!==void 0&&(b=r.unstable_transitionCallbacks)),r=Q1(e,1,!1,null,null,s,l,h,f,E,b,null),e[ki]=r.current,qf(e),new lp(r)},Pl.hydrateRoot=function(e,r,s){if(!o(e))throw Error(a(299));var l=!1,h="",f=Ey,E=wy,b=by,N=null,H=null;return s!=null&&(s.unstable_strictMode===!0&&(l=!0),s.identifierPrefix!==void 0&&(h=s.identifierPrefix),s.onUncaughtError!==void 0&&(f=s.onUncaughtError),s.onCaughtError!==void 0&&(E=s.onCaughtError),s.onRecoverableError!==void 0&&(b=s.onRecoverableError),s.unstable_transitionCallbacks!==void 0&&(N=s.unstable_transitionCallbacks),s.formState!==void 0&&(H=s.formState)),r=Q1(e,1,!0,r,s??null,l,h,f,E,b,N,H),r.context=X1(null),s=r.current,l=Rn(),l=No(l),h=Cr(l),h.callback=null,Dr(s,h,l),s=l,r.current.lanes=s,ve(r,s),_i(r),e[ki]=r.current,qf(e),new $c(r)},Pl.version="19.1.1",Pl}var D_;function V9(){if(D_)return Gp.exports;D_=1;function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(t){console.error(t)}}return n(),Gp.exports=O9(),Gp.exports}var k9=V9();function P9(){const n=Di(),t=DT();return St.useEffect(()=>{t!=="POP"&&window.scrollTo({top:0,behavior:"instant"});const i=document.getElementById("main");i&&i.focus({preventScroll:!0})},[n,t]),null}function U9({headerMode:n,setHeaderMode:t}){const i=B.useMemo(()=>[{key:"projects",label:"PROJECTS",href:"/projects/"},{key:"peoples",label:"PEOPLES",href:"/peoples/"},{key:"showroom",label:"SHOWROOM",href:"/showroom/"},{key:"guestbook",label:"GUESTBOOK",href:"/guestbook/"},{key:"credits",label:"CREDITS",href:"/credits/"}],[]),a=Di(),o=B.useMemo(()=>{const d=a.pathname.replace(/^\/+/,"");if(!d)return;const m=d.split("/")[0];return["projects","peoples","showroom","guestbook","credits"].includes(m)?m:void 0},[a.pathname]),u=o==="showroom";return y.jsxs(y.Fragment,{children:[y.jsx(_2,{items:i,activeKey:o,mode:n,autoOnScroll:n===he.GRADIENT_DARK||n===he.DARK,scrollThreshold:8,sticky:!0,overlay:n===he.GRADIENT_DARK||n===he.DARK,maxWidth:1280,onModeChange:t}),y.jsx("main",{id:"main",tabIndex:-1,style:{outline:"none",width:"100vw",boxSizing:"border-box",padding:0},children:y.jsx(XT,{})}),!u&&y.jsx(E2,{title:"잔향 : 기억의 향기",nav:[{label:"PROJECTS",href:"/projects/"},{label:"PEOPLES",href:"/peoples/"},{label:"SHOWROOM",href:"/showroom/"},{label:"GUESTBOOK",href:"/guestbook/"},{label:"CREDITS",href:"/credits/"}],copyright:["ⓒ 2025 TECH UNIV KOREA. ALL RIGHTS RESERVED.","TUKOREA DESIGN ENGINEERING 20TH GRADUATION EXHIBITION"],social:{youtube:{href:"https://youtube.com/",label:"YouTube"},instagram:{href:"https://www.instagram.com/tukd_grad?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",label:"Instagram"}},sidePadding:350,maxWidth:1220})]})}function L9({setHeaderMode:n}){return St.useEffect(()=>{n(he.GRADIENT)},[n]),y.jsx(OA,{})}function z9({setHeaderMode:n}){return St.useEffect(()=>{n(he.GRADIENT)},[n]),y.jsx(yR,{})}function $9({setHeaderMode:n}){return St.useEffect(()=>{n(he.GRADIENT)},[n]),y.jsx(UC,{})}function B9({setHeaderMode:n}){return St.useEffect(()=>{n(he.GRADIENT_DARK)},[n]),y.jsx(y5,{})}function F9({setHeaderMode:n}){return St.useEffect(()=>{n(he.DARK)},[n]),y.jsx(CN,{})}function q9({setHeaderMode:n}){return St.useEffect(()=>{n(he.LIGHT)},[n]),y.jsx(_9,{})}function K9({setHeaderMode:n}){return St.useEffect(()=>{n(he.DARK)},[n]),y.jsx(D9,{})}function H9(){const[n,t]=B.useState(he.GRADIENT);return y.jsxs(ES,{basename:"/",children:[y.jsx(P9,{}),y.jsx(ZT,{children:y.jsxs(wi,{element:y.jsx(U9,{headerMode:n,setHeaderMode:t}),children:[y.jsx(wi,{index:!0,element:y.jsx(B9,{setHeaderMode:t})}),y.jsx(wi,{path:"projects/",element:y.jsx($9,{setHeaderMode:t})}),y.jsx(wi,{path:"peoples/",element:y.jsx(z9,{setHeaderMode:t})}),y.jsx(wi,{path:"guestbook/",element:y.jsx(F9,{setHeaderMode:t})}),y.jsx(wi,{path:"work/:pid",element:y.jsx(q9,{setHeaderMode:t})}),y.jsx(wi,{path:"credits/",element:y.jsx(L9,{setHeaderMode:t})}),y.jsx(wi,{path:"showroom/",element:y.jsx(K9,{setHeaderMode:t})}),y.jsx(wi,{path:"*",element:y.jsx(QT,{to:"/",replace:!0})})]})})]})}const N_=typeof document<"u"?document.getElementById("root"):null;N_&&k9.createRoot(N_).render(y.jsx(H9,{}));
