 ...
 */var hx;function oT(){if(hx)return Ml;hx=1;var n=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(a,o,u){var d=null;if(u!==void 0&&(d=""+u),o.key!==void 0&&(d=""+o.key),"key"in o){u={};for(var m in o)m!=="key"&&(u[m]=o[m])}else u=o;return o=u.ref,{$$typeof:n,type:a,key:d,ref:o!==void 0?o:null,props:u}}return Ml.Fragment=t,Ml.jsx=i,Ml.jsxs=i,Ml}var dx;function lT(){return dx||(dx=1,cp.exports=oT()),cp.exports}var y=lT(),hp={exports:{}},Dt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`;function y4({text:n}){return y.jsxs(f4,{children:[y.jsx(I2,{}),y.jsx(p4,{}),y.jsx(d4,{dangerouslySetInnerHTML:{__html:n}})]})}const x4=T.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  gap: 46px;
...
`;function A4({blocks:n}){return y.jsxs(E4,{children:[y.jsx(I2,{}),n.map(t=>y.jsxs(b4,{children:[y.jsx(T4,{children:t.title}),y.jsx(S4,{dangerouslySetInnerHTML:{__html:t.body}})]},t.title))]})}const R4=T.div`
...
`;function hm({path:n="student",isActive:t=!1,onClick:i}){return y.jsxs(Y4,{onClick:i,children:[y.jsx(C2,{$active:t,children:"교수"}),y.jsx(X4,{$active:t,children:"학생"}),y.jsx(Q4,{$active:t})]})}hm.propTypes={path:Z.oneOf(["student","professor"]),isActive:Z.bool,onClick:Z.func};const Fx=T.a`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  font-size: 24px;
  line-height: 28.8px;
  letter-spacing: 0.24px;
...
`;function M2({options:n,isOpen:t,onSelect:i,selected:a}){return y.jsx(iR,{$open:t,children:y.jsx(rR,{$open:t,children:n.map((o,u)=>y.jsx(aR,{$selected:a===o,onClick:()=>i(o),children:o},u))})})}M2.propTypes={options:Z.arrayOf(Z.string).isRequired,isOpen:Z.bool.isRequired,onSelect:Z.func.isRequired,selected:Z.oneOfType([Z.string,Z.number])};const sR=T.div`
    position: relative;
    // 안에 들어가는 요소들 왼쪽 정렬
    display: flex;
    flex-direction: row;
    justify-content: flex-start;
`;function Kl({label:n,options:t,onSelect:i,style:a,mode:o}){const[u,d]=St.useState(!1),m=St.useRef(null),p=()=>{d(v=>!v)},g=v=>{i&&i(v),d(!1)};return y.jsxs(sR,{ref:m,style:a,children:[y.jsx("div",{onClick:p,children:y.jsx(rg,{label:n,mode:o})}),y.jsx(M2,{options:t,onSelect:g,isOpen:u,selected:n})]})}Kl.propTypes={label:Z.string.isRequired,options:Z.arrayOf(Z.string).isRequired,onSelect:Z.func.isRequired,style:Z.object,mode:Z.string};Kl.defaultProps={style:{},mode:"category"};const bp=T.div`
  display: flex;
  justify-content: space-between;
  width: auto;
  padding-left: 40px;
...
`;function O2({onCategoryChange:n,onToggleChange:t,type:i,onSortChange:a,sortLabel:o}){const u={type:i},[d,m]=St.useState(!1),p=()=>m(Y=>{const ot=!Y;return t&&t(ot),ot}),[g,v]=St.useState("전체"),[E,S]=St.useState("All Projects"),R=["전체","산업디자인공학","미디어디자인공학"],M=["장영주","권오재","김 억","김한종","조남주","한민섭","홍성수","김태균"],L=["All Projects","AI & Robot","Edu & Kids","Health Care","IT & Tech","Living","Mobility"],U=["이름순","좋아요순","조회수순","팀작우선","개인작우선"],[q,X]=St.useState("이름순"),tt=o||q,lt=Y=>{X(Y),a&&a(Y)};return B.useEffect(()=>{v(d?M[0]:R[0])},[d]),u.type==="project"?y.jsxs(bp,{children:[y.jsx(Tp,{}),y.jsx(Sp,{children:L.map(Y=>y.jsx(hh,{label:Y,active:E===Y,onClick:()=>{S(Y),n&&n(Y)}},Y))}),y.jsx(Ap,{children:y.jsx(Kl,{mode:"category",label:E,options:L,onSelect:Y=>{S(Y),n&&n(Y)}})}),y.jsx(ag,{label:tt,options:U,onSelect:lt})]}):d?y.jsxs(bp,{children:[y.jsx(Tp,{}),y.jsx(Sp,{children:M.map(Y=>y.jsx(hh,{label:Y,active:g===Y,onClick:()=>{v(Y),n&&n(Y)}},Y))}),y.jsx(Ap,{children:y.jsx(Kl,{mode:"category",label:g,options:M,onSelect:Y=>{v(Y),n&&n(Y)}})}),y.jsx(hm,{path:d?"professor":"student",isActive:d,onClick:p})]}):y.jsxs(bp,{children:[y.jsx(Tp,{}),y.jsx(Sp,{children:R.map(Y=>y.jsx(hh,{label:Y,active:g===Y,onClick:()=>{v(Y),n&&n(Y)}},Y))}),y.jsx(Ap,{children:y.jsx(Kl,{mode:"category",label:g,options:R,onSelect:Y=>{v(Y),n&&n(Y)}})}),y.jsx(hm,{path:d?"professor":"student",isActive:d,onClick:p})]})}const oR=T.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  justify-content: center;
...
`,wR=T.div`position: relative;`;function ER({people:n}){const t=zh();return y.jsx(xR,{children:n.map((i,a)=>{const o=i.id??i.studentId??`${i.nameKor}-${a}`,u=typeof i.projectNum=="number"&&i.category,d=u?i.projectNum+1:null,m=u?`${fR[i.category]||"A"}${String(d).padStart(3,"0")}`:null,p=y.jsx(ig,{nameKor:i.nameKor,nameEng:i.nameEng,role:i.role,sns:i.sns||"-",eMail:i.eMail,imgSrc:V2(i.imgUrl),imgAlt:`${i.nameKor} profile`},o);return u?y.jsx(_R,{role:"link",tabIndex:0,onClick:()=>t(`/work/${m}`),onKeyDown:g=>{(g.key==="Enter"||g.key===" ")&&t(`/work/${m}`)},"aria-label":`${i.nameKor} 작품 보기 (${m})`,children:p},`link-${o}`):p})})}function bR(){const[n,t]=St.useState(!1),[i,a]=St.useState(Yx[0]),o=St.useMemo(()=>{const m=new Map;return(eu||[]).forEach(p=>{(p.members||[]).forEach(g=>{m.has(g)||m.set(g,p)})}),m},[]);St.useEffect(()=>{a(n?Vl[0]?.id||"":Yx[0])},[n]);const u=St.useMemo(()=>{if(!n){if(i==="전체")return Rp;let p=pR[i];return p===void 0&&(p=Qx(i)),Rp.filter(g=>Qx(g.department)===p)}const m=Vl.some(p=>p.id===i)?i:Vl.find(p=>p.nameKor===i)?.id||"";return Rp.filter(p=>p.professorId===m).map(p=>{let g=o.get(p.num);g||(g=(eu||[]).find(E=>E.category===p.category&&E.projectNum===p.projectNum)||null);const v=g?`/projects/${g.projectNum}/thumb.jpg`:"/thumbnailExample.png";return{...p,imgUrl:v}})},[i,n,o]),d=St.useMemo(()=>n&&(Vl.find(p=>p.id===i)||Vl.find(p=>p.nameKor===i))||null,[n,i]);return y.jsxs(wR,{children:[y.jsx(vR,{children:"Peoples"}),y.jsx(O2,{type:"people",onCategoryChange:a,onToggleChange:t}),y.jsxs(yR,{children:[n&&d&&y.jsx(sg,{nameKor:d.nameKor,rank:d.rank||"교수",eMail:d.email,education:d.education,field:d.field,imgSrc:V2(d.imgUrl),imgAlt:`${d.nameKor} profile`}),y.jsx(ER,{people:u})]})]})}const Xx=T.div`
  @media (max-width: 393px) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const a6="FirebaseError";class Eo extends Error{constructor(t,i,a){super(i),this.code=t,this.customData=a,this.name=a6,Object.setPrototypeOf(this,Eo.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,L2.prototype.create)}}class L2{constructor(t,i,a){this.service=t,this.serviceName=i,this.errors=a}create(t,...i){const a=i[0]||{},o=`${this.service}/${t}`,u=this.errors[t],d=u?s6(u,a):"Error",m=`${this.serviceName}: ${d} (${o}).`;return new Eo(o,m,a)}}function s6(n,t){return n.replace(o6,(i,a)=>{const o=t[a];return o!=null?String(o):`<${a}?>`})}const o6=/\{\$([^}]+)}/g;function Sh(n,t){if(n===t)return!0;const i=Object.keys(n),a=Object.keys(t);for(const o of i){if(!a.includes(o))return!1;const u=n[o],d=t[o];if(rv(u)&&rv(d)){if(!Sh(u,d))return!1}else if(u!==d)return!1}for(const o of a)if(!i.includes(o))return!1;return!0}function rv(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lI=eI;function dg(n,t={}){let i=n;typeof t!="object"&&(t={name:t});const a={name:mm,automaticDataCollectionEnabled:!0,...t},o=a.name;if(typeof o!="string"||!o)throw Wr.create("bad-app-name",{appName:String(o)});if(i||(i=U2()),!i)throw Wr.create("no-options");const u=iu.get(o);if(u){if(Sh(i,u.options)&&Sh(a,u.config))return u;throw Wr.create("duplicate-app",{appName:o})}const d=new h6(o);for(const p of gm.values())d.addComponent(p);const m=new oI(i,a,d);return iu.set(o,m),m}function uI(n=mm){const t=iu.get(n);if(!t&&n===mm&&U2())return dg();if(!t)throw Wr.create("no-app",{appName:n});return t}function cv(){return Array.from(iu.values())}function eo(n,t,i){let a=nI[n]??n;i&&(a+=`-${i}`);const o=a.match(/\s|\//),u=t.match(/\s|\//);if(o||u){const d=[`Unable to register library "${a}" with version "${t}":`];o&&d.push(`library name "${a}" contains illegal characters (whitespace or "/")`),o&&u&&d.push("and"),u&&d.push(`version name "${t}" contains illegal characters (whitespace or "/")`),sr.warn(d.join(" "));return}Ah(new nu(`${a}-version`,()=>({library:a,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vI(n){Ah(new nu("platform-logger",t=>new R6(t),"PRIVATE")),Ah(new nu("heartbeat",t=>new mI(t),"PRIVATE")),eo(pm,lv,n),eo(pm,lv,"esm2020"),eo("fire-js","")}vI("");var _I="firebase",wI="12.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mg=-1;function Xh(n){return n==null}function Rh(n){return n===0&&1/n==-1/0}function LI(n){return typeof n=="number"&&Number.isInteger(n)&&!Rh(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ew="";function zI(n){let t="";for(let i=0;i<n.length;i++)t.length>0&&(t=bv(t)),t=$I(n.get(i),t);return bv(t)}function $I(n,t){let i=t;const a=n.length;for(let o=0;o<a;o++){const u=n.charAt(o);switch(u){case"\0":i+="";break;case ew:i+="";break;default:i+=u}}return i}function bv(n){return n+ew+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tv(n){let t=0;for(const i in n)Object.prototype.hasOwnProperty.call(n,i)&&t++;return t}function sa(n,t){for(const i in n)Object.prototype.hasOwnProperty.call(n,i)&&t(i,n[i])}function nw(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rw="server_timestamp",aw="__type__",sw="__previous_value__",ow="__local_write_time__";function gg(n){return(n?.mapValue?.fields||{})[aw]?.stringValue===rw}function Wh(n){const t=n.mapValue.fields[sw];return gg(t)?Wh(t):t}function su(n){const t=ea(n.mapValue.fields[ow].timestampValue);return new ue(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wg(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Rh(t)?"-0":t}}function bw(n){return{integerValue:""+n}}function Tw(n,t){return LI(t)?bw(t):wg(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class td{constructor(){this._=void 0}}function d3(n,t,i){return n instanceof Dh?(function(o,u){const d={fields:{[aw]:{stringValue:rw},[ow]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return u&&gg(u)&&(u=Wh(u)),u&&(d.fields[sw]=u),{mapValue:d}})(i,t):n instanceof cu?Aw(n,t):n instanceof hu?Rw(n,t):(function(o,u){const d=Sw(o,u),m=Vv(d)+Vv(o.Ae);return _m(d)&&_m(o.Ae)?bw(m):wg(o.serializer,m)})(n,t)}function f3(n,t,i){return n instanceof cu?Aw(n,t):n instanceof hu?Rw(n,t):i}function Sw(n,t){return n instanceof du?(function(a){return _m(a)||(function(u){return!!u&&"doubleValue"in u})(a)})(t)?t:{integerValue:0}:null}class Dh extends td{}class cu extends td{constructor(t){super(),this.elements=t}}function Aw(n,t){const i=Iw(t);for(const a of n.elements)i.some((o=>Ci(o,a)))||i.push(a);return{arrayValue:{values:i}}}class hu extends td{constructor(t){super(),this.elements=t}}function Rw(n,t){let i=Iw(t);for(const a of n.elements)i=i.filter((o=>!Ci(o,a)));return{arrayValue:{values:i}}}class du extends td{constructor(t,i){super(),this.serializer=t,this.Ae=i}}function Vv(n){return Se(n.integerValue||n.doubleValue)}function Iw(n){return yg(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nd{constructor(t,i,a,o,u){this.snapshotVersion=t,this.targetChanges=i,this.targetMismatches=a,this.documentUpdates=o,this.resolvedLimboDocuments=u}static createSynthesizedRemoteEventForCurrentChange(t,i,a){const o=new Map;return o.set(t,xu.createSynthesizedTargetChangeForCurrentChange(t,i,a)),new nd(At.min(),o,new me(Pt),ur(),Ut())}}class xu{constructor(t,i,a,o,u){this.resumeToken=t,this.current=i,this.addedDocuments=a,this.modifiedDocuments=o,this.removedDocuments=u}static createSynthesizedTargetChangeForCurrentChange(t,i,a){return new xu(a,i,Ut(),Ut(),Ut())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function id(n){return new j3(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Za="RemoteStore";class NC{constructor(t,i,a,o,u){this.localStore=t,this.datastore=i,this.asyncQueue=a,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=u,this.Aa.Oo((d=>{a.enqueueAndForget((async()=>{ns(this)&&(pt(Za,"Restarting streams for network reachability change."),await(async function(p){const g=It(p);g.Ea.add(4),await vu(g),g.Ra.set("Unknown"),g.Ea.delete(4),await rd(g)})(this))}))})),this.Ra=new DC(a,o)}}async function rd(n){if(ns(n))for(const t of n.da)await t(!0)}async function vu(n){for(const t of n.da)await t(!1)}function Yw(n,t){const i=It(n);i.Ia.has(t.targetId)||(i.Ia.set(t.targetId,t),Ng(i)?Dg(i):Ro(i).O_()&&jg(i,t))}function Cg(n,t){const i=It(n),a=Ro(i);i.Ia.delete(t),a.O_()&&Qw(i,t),i.Ia.size===0&&(a.O_()?a.L_():ns(i)&&i.Ra.set("Unknown"))}function jg(n,t){if(n.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(At.min())>0){const i=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(i)}Ro(n).Y_(t)}function Qw(n,t){n.Va.Ue(t),Ro(n).Z_(t)}function Dg(n){n.Va=new A3({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),At:t=>n.Ia.get(t)||null,ht:()=>n.datastore.serializer.databaseId}),Ro(n).start(),n.Ra.ua()}function Ng(n){return ns(n)&&!Ro(n).x_()&&n.Ia.size>0}function ns(n){return It(n).Ea.size===0}function Xw(n){n.Va=void 0}async function MC(n){n.Ra.set("Online")}async function OC(n){n.Ia.forEach(((t,i)=>{jg(n,t)}))}async function VC(n,t){Xw(n),Ng(n)?(n.Ra.ha(t),Dg(n)):n.Ra.set("Unknown")}async function kC(n,t,i){if(n.Ra.set("Online"),t instanceof Ow&&t.state===2&&t.cause)try{await(async function(o,u){const d=u.cause;for(const m of u.targetIds)o.Ia.has(m)&&(await o.remoteSyncer.rejectListen(m,d),o.Ia.delete(m),o.Va.removeTarget(m))})(n,t)}catch(a){pt(Za,"Failed to remove targets %s: %s ",t.targetIds.join(","),a),await Oh(n,a)}else if(t instanceof gh?n.Va.Ze(t):t instanceof Mw?n.Va.st(t):n.Va.tt(t),!i.isEqual(At.min()))try{const a=await qw(n.localStore);i.compareTo(a)>=0&&await(function(u,d){const m=u.Va.Tt(d);return m.targetChanges.forEach(((p,g)=>{if(p.resumeToken.approximateByteSize()>0){const v=u.Ia.get(g);v&&u.Ia.set(g,v.withResumeToken(p.resumeToken,d))}})),m.targetMismatches.forEach(((p,g)=>{const v=u.Ia.get(p);if(!v)return;u.Ia.set(p,v.withResumeToken(Je.EMPTY_BYTE_STRING,v.snapshotVersion)),Qw(u,p);const E=new Qr(v.target,p,g,v.sequenceNumber);jg(u,E)})),u.remoteSyncer.applyRemoteEvent(m)})(n,i)}catch(a){pt(Za,"Failed to raise snapshot:",a),await Oh(n,a)}}async function Oh(n,t,i){if(!So(t))throw t;n.Ea.add(1),await vu(n),n.Ra.set("Offline"),i||(i=()=>qw(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{pt(Za,"Retrying IndexedDB access"),await i(),n.Ea.delete(1),await rd(n)}))}function Ww(n,t){return t().catch((i=>Oh(n,i,t)))}async function ad(n){const t=It(n),i=ra(t);let a=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:mg;for(;PC(t);)try{const o=await xC(t.localStore,a);if(o===null){t.Ta.length===0&&i.L_();break}a=o.batchId,UC(t,o)}catch(o){await Oh(t,o)}Zw(t)&&Jw(t)}function PC(n){return ns(n)&&n.Ta.length<10}function UC(n,t){n.Ta.push(t);const i=ra(n);i.O_()&&i.X_&&i.ea(t.mutations)}function Zw(n){return ns(n)&&!ra(n).x_()&&n.Ta.length>0}function Jw(n){ra(n).start()}async function LC(n){ra(n).ra()}async function zC(n){const t=ra(n);for(const i of n.Ta)t.ea(i.mutations)}async function $C(n,t,i){const a=n.Ta.shift(),o=Eg.from(a,t,i);await Ww(n,(()=>n.remoteSyncer.applySuccessfulWrite(o))),await ad(n)}async function BC(n,t){t&&ra(n).X_&&await(async function(a,o){if((function(d){return b3(d)&&d!==it.ABORTED})(o.code)){const u=a.Ta.shift();ra(a).B_(),await Ww(a,(()=>a.remoteSyncer.rejectFailedWrite(u.batchId,o))),await ad(a)}})(n,t),Zw(n)&&Jw(n)}async function Zv(n,t){const i=It(n);i.asyncQueue.verifyOperationInProgress(),pt(Za,"RemoteStore received new credentials");const a=ns(i);i.Ea.add(3),await vu(i),a&&i.Ra.set("Unknown"),await i.remoteSyncer.handleCredentialChange(t),i.Ea.delete(3),await rd(i)}async function FC(n,t){const i=It(n);t?(i.Ea.delete(2),await rd(i)):t||(i.Ea.add(2),await vu(i),i.Ra.set("Unknown"))}function Ro(n){return n.ma||(n.ma=(function(i,a,o){const u=It(i);return u.sa(),new RC(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:MC.bind(null,n),t_:OC.bind(null,n),r_:VC.bind(null,n),H_:kC.bind(null,n)}),n.da.push((async t=>{t?(n.ma.B_(),Ng(n)?Dg(n):n.Ra.set("Unknown")):(await n.ma.stop(),Xw(n))}))),n.ma}function ra(n){return n.fa||(n.fa=(function(i,a,o){const u=It(i);return u.sa(),new IC(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:LC.bind(null,n),r_:BC.bind(null,n),ta:zC.bind(null,n),na:$C.bind(null,n)}),n.da.push((async t=>{t?(n.fa.B_(),await ad(n)):(await n.fa.stop(),n.Ta.length>0&&(pt(Za,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vj=/^__.*__$/;class _j{constructor(t,i,a){this.data=t,this.fieldMask=i,this.fieldTransforms=a}toMutation(t,i){return this.fieldMask!==null?new oa(t,this.data,this.fieldMask,i,this.fieldTransforms):new yu(t,this.data,i,this.fieldTransforms)}}class yE{constructor(t,i,a){this.data=t,this.fieldMask=i,this.fieldTransforms=a}toMutation(t,i){return new oa(t,this.data,this.fieldMask,i,this.fieldTransforms)}}function xE(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw bt(40011,{Ac:n})}}class Lg{constructor(t,i,a,o,u,d){this.settings=t,this.databaseId=i,this.serializer=a,this.ignoreUndefinedProperties=o,u===void 0&&this.Rc(),this.fieldTransforms=u||[],this.fieldMask=d||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(t){return new Lg({...this.settings,...t},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(t){const i=this.path?.child(t),a=this.Vc({path:i,fc:!1});return a.gc(t),a}yc(t){const i=this.path?.child(t),a=this.Vc({path:i,fc:!1});return a.Rc(),a}wc(t){return this.Vc({path:void 0,fc:!0})}Sc(t){return kh(t,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(t){return this.fieldMask.find((i=>t.isPrefixOf(i)))!==void 0||this.fieldTransforms.find((i=>t.isPrefixOf(i.field)))!==void 0}Rc(){if(this.path)for(let t=0;t<this.path.length;t++)this.gc(this.path.get(t))}gc(t){if(t.length===0)throw this.Sc("Document fields must not be empty");if(xE(this.Ac)&&vj.test(t))throw this.Sc('Document fields cannot begin and end with "__"')}}class wj{constructor(t,i,a){this.databaseId=t,this.ignoreUndefinedProperties=i,this.serializer=a||id(t)}Cc(t,i,a,o=!1){return new Lg({Ac:t,methodName:i,Dc:a,path:Ze.emptyPath(),fc:!1,bc:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function zg(n){const t=n._freezeSettings(),i=id(n._databaseId);return new wj(n._databaseId,!!t.ignoreUndefinedProperties,i)}function Ej(n,t,i,a,o,u={}){const d=n.Cc(u.merge||u.mergeFields?2:0,t,i,o);Bg("Data must be an object, but it was:",d,a);const m=vE(a,d);let p,g;if(u.merge)p=new jn(d.fieldMask),g=d.fieldTransforms;else if(u.mergeFields){const v=[];for(const E of u.mergeFields){const S=Om(t,E,i);if(!d.contains(S))throw new ft(it.INVALID_ARGUMENT,`Field '${S}' is specified in your field mask but missing from your input data.`);wE(v,S)||v.push(S)}p=new jn(v),g=d.fieldTransforms.filter((E=>p.covers(E.field)))}else p=null,g=d.fieldTransforms;return new _j(new vn(m),p,g)}class ud extends ld{_toFieldTransform(t){if(t.Ac!==2)throw t.Ac===1?t.Sc(`${this._methodName}() can only appear at the top level of your update data`):t.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof ud}}class $g extends ld{constructor(t,i){super(t),this.Fc=i}_toFieldTransform(t){const i=new du(t.serializer,Tw(t.serializer,this.Fc));return new p3(t.path,i)}isEqual(t){return t instanceof $g&&this.Fc===t.Fc}}function bj(n,t,i,a){const o=n.Cc(1,t,i);Bg("Data must be an object, but it was:",o,a);const u=[],d=vn.empty();sa(a,((p,g)=>{const v=Fg(t,p,i);g=ar(g);const E=o.yc(v);if(g instanceof ud)u.push(v);else{const S=Eu(g,E);S!=null&&(u.push(v),d.set(v,S))}}));const m=new jn(u);return new yE(d,m,o.fieldTransforms)}function Tj(n,t,i,a,o,u){const d=n.Cc(1,t,i),m=[Om(t,a,i)],p=[o];if(u.length%2!=0)throw new ft(it.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let S=0;S<u.length;S+=2)m.push(Om(t,u[S])),p.push(u[S+1]);const g=[],v=vn.empty();for(let S=m.length-1;S>=0;--S)if(!wE(g,m[S])){const R=m[S];let M=p[S];M=ar(M);const L=d.yc(R);if(M instanceof ud)g.push(R);else{const U=Eu(M,L);U!=null&&(g.push(R),v.set(R,U))}}const E=new jn(g);return new yE(v,E,d.fieldTransforms)}function Sj(n,t,i,a=!1){return Eu(i,n.Cc(a?4:3,t))}function Eu(n,t){if(_E(n=ar(n)))return Bg("Unsupported field value:",t,n),vE(n,t);if(n instanceof ld)return(function(a,o){if(!xE(o.Ac))throw o.Sc(`${a._methodName}() can only be used with update() and set()`);if(!o.path)throw o.Sc(`${a._methodName}() is not currently supported inside arrays`);const u=a._toFieldTransform(o);u&&o.fieldTransforms.push(u)})(n,t),null;if(n===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),n instanceof Array){if(t.settings.fc&&t.Ac!==4)throw t.Sc("Nested arrays are not supported");return(function(a,o){const u=[];let d=0;for(const m of a){let p=Eu(m,o.wc(d));p==null&&(p={nullValue:"NULL_VALUE"}),u.push(p),d++}return{arrayValue:{values:u}}})(n,t)}return(function(a,o){if((a=ar(a))===null)return{nullValue:"NULL_VALUE"};if(typeof a=="number")return Tw(o.serializer,a);if(typeof a=="boolean")return{booleanValue:a};if(typeof a=="string")return{stringValue:a};if(a instanceof Date){const u=ue.fromDate(a);return{timestampValue:Nh(o.serializer,u)}}if(a instanceof ue){const u=new ue(a.seconds,1e3*Math.floor(a.nanoseconds/1e3));return{timestampValue:Nh(o.serializer,u)}}if(a instanceof Ri)return{geoPointValue:{latitude:a.latitude,longitude:a.longitude}};if(a instanceof Fn)return{bytesValue:Vw(o.serializer,a._byteString)};if(a instanceof Ae){const u=o.databaseId,d=a.firestore._databaseId;if(!d.isEqual(u))throw o.Sc(`Document reference is for database ${d.projectId}/${d.database} but should be for database ${u.projectId}/${u.database}`);return{referenceValue:Tg(a.firestore._databaseId||o.databaseId,a._key.path)}}if(a instanceof Ii)return(function(d,m){return{mapValue:{fields:{[lw]:{stringValue:uw},[Ch]:{arrayValue:{values:d.toArray().map((g=>{if(typeof g!="number")throw m.Sc("VectorValues must only contain numeric values.");return wg(m.serializer,g)}))}}}}}})(a,o);throw o.Sc(`Unsupported field value: ${Yh(a)}`)})(n,t)}function vE(n,t){const i={};return nw(n)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):sa(n,((a,o)=>{const u=Eu(o,t.mc(a));u!=null&&(i[a]=u)})),{mapValue:{fields:i}}}function _E(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ue||n instanceof Ri||n instanceof Fn||n instanceof Ae||n instanceof ld||n instanceof Ii)}function Bg(n,t,i){if(!_E(i)||!tw(i)){const a=Yh(i);throw a==="an object"?t.Sc(n+" a custom object"):t.Sc(n+" "+a)}}function Om(n,t,i){if((t=ar(t))instanceof od)return t._internalPath;if(typeof t=="string")return Fg(n,t);throw kh("Field path arguments must be of type string or ",n,!1,void 0,i)}const Aj=new RegExp("[~\\*/\\[\\]]");function Fg(n,t,i){if(t.search(Aj)>=0)throw kh(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,i);try{return new od(...t.split("."))._internalPath}catch{throw kh(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,i)}}function kh(n,t,i,a,o){const u=a&&!a.isEmpty(),d=o!==void 0;let m=`Function ${t}() called with invalid data`;i&&(m+=" (via `toFirestore()`)"),m+=". ";let p="";return(u||d)&&(p+=" (found",u&&(p+=` in field ${a}`),d&&(p+=` in document ${o}`),p+=")"),new ft(it.INVALID_ARGUMENT,m+n+p)}function wE(n,t){return n.some((i=>i.isEqual(t)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vh(n){n=lr(n,Ae);const t=lr(n.firestore,wu);return mj(Ug(t),n._key).then((i=>Nj(t,n,i)))}io._jsonSchemaVersion="firestore/querySnapshot/1.0",io._jsonSchema={type:Ne("string",io._jsonSchemaVersion),bundleSource:Ne("string","QuerySnapshot"),bundleName:Ne("string"),bundle:Ne("string")};class SE extends Cj{constructor(t){super(),this.firestore=t}convertBytes(t){return new Fn(t)}convertReference(t){const i=this.convertDocumentKey(t,this.firestore._databaseId);return new Ae(this.firestore,null,i)}}function Vm(n){n=lr(n,is);const t=lr(n.firestore,wu),i=Ug(t),a=new SE(t);return Ij(n._query),gj(i,n._query).then((o=>new io(t,a,n,o)))}function Qg(n,t,i){n=lr(n,Ae);const a=lr(n.firestore,wu),o=jj(n.converter,t,i);return AE(a,[Ej(zg(a),"setDoc",n._key,o,n.converter!==null,i).toMutation(n._key,Si.none())])}function Ph(n,t,i,...a){n=lr(n,Ae);const o=lr(n.firestore,wu),u=zg(o);let d;return d=typeof(t=ar(t))=="string"||t instanceof od?Tj(u,"updateDoc",n._key,t,i,a):bj(u,"updateDoc",n._key,t),AE(o,[d.toMutation(n._key,Si.exists(!0))])}function AE(n,t){return(function(a,o){const u=new ir;return a.asyncQueue.enqueueAndForget((async()=>ij(await pj(a),o,u))),u.promise})(Ug(n),t)}function Nj(n,t,i){const a=i.docs.get(t._key),o=new SE(n);return new Xa(n,o,t._key,a,new Bl(i.hasPendingWrites,i.fromCache),t.converter)}function Uh(n){return new $g("increment",n)}(function(t,i=!0){(function(o){bo=o})(lI),Ah(new nu("firestore",((a,{instanceIdentifier:o,options:u})=>{const d=a.getProvider("app").getImmediate(),m=new wu(new TI(a.getProvider("auth-internal")),new RI(d,a.getProvider("app-check-internal")),(function(g,v){if(!Object.prototype.hasOwnProperty.apply(g.options,["projectId"]))throw new ft(it.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ou(g.options.projectId,v)})(d,o),d);return u={useFetchStreams:i,...u},m._setSettings(u),m}),"PUBLIC").setMultipleInstances(!0)),eo(mv,gv,t),eo(mv,gv,"esm2020")})();const Mj={apiKey:"AIzaSyAEFzPwTADLzuxWuyk889Jz1cHPsEgLOkQ",authDomain:"tu2025grad.firebaseapp.com",projectId:"tu2025grad",storageBucket:"tu2025grad.firebasestorage.app",messagingSenderId:"553768466639",appId:"1:553768466639:web:7c16f5d6432da7ebc05fba"},Oj=cv().length?cv()[0]:dg(Mj),Wl=gE(Oj),m_=40;function RE(n){if(!n)return n;const t="/";if(/^https?:\/\//i.test(n))return n;const i=n.replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const Vj=T.div`
  position: relative; background: #fff;
`,kj=T.div`
...
`,g_=eu,IE=og,$j={"All Projects":null,"AI & Robot":"c0","Edu & Kids":"c1","Health Care":"c2","IT & Tech":"c3",Living:"c4",Mobility:"c5"};function km(n){return n.members.map(t=>{const i=IE.find(a=>a.num===t);return i?i.nameKor:""}).filter(Boolean).join(", ")}function Bj(n){return n.members.map(t=>{const i=IE.find(a=>a.num===t);return i?RE(i.imgUrl):""}).filter(Boolean)}function Fj({list:n,statsById:t}){const i={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"};return y.jsx(Lj,{children:n.map((a,o)=>{const u=km(a),d=Bj(a),m=String(a.projectNum+1).padStart(3,"0"),g=`${i[a.category]||"A"}${m}`,v=a.projectNum??a.num;return y.jsx(lg,{titleKor:a.titleKor,titleEng:a.titleEng,src:RE(`/projects/${a.projectNum}/thumb.jpg`||`/projects/${a.projectNum}/thumb.png`),nameKor:u,profileImgs:d,docId:v,href:`/work/${g}`,like:t[String(v)]?.like??0,view:t[String(v)]?.view??0},o)})})}function Kj(){const[n,t]=St.useState("All Projects"),[i,a]=St.useState("이름순"),[o,u]=St.useState({});St.useEffect(()=>{let p=!0;return(async()=>{try{const g=await Vm(yh(Wl,"works"));if(!p)return;const v={};g.forEach(E=>{const S=E.data()||{};v[String(E.id)]={like:typeof S.like=="number"?S.like:0,view:typeof S.view=="number"?S.view:0}}),u(v)}catch(g){console.error("Failed to load works stats:",g)}})(),()=>{p=!1}},[]);const d=St.useMemo(()=>{const p=$j[n]||null;return p?g_.filter(g=>g.category===p):g_},[n]),m=St.useMemo(()=>{const p=[...d];switch(i){case"이름순":p.sort((g,v)=>km(g).localeCompare(km(v),"ko"));break;case"좋아요순":p.sort((g,v)=>{const E=String(g.projectNum??g.num),S=String(v.projectNum??v.num),R=o[E]?.like??0;return(o[S]?.like??0)-R});break;case"조회수순":p.sort((g,v)=>{const E=String(g.projectNum??g.num),S=String(v.projectNum??v.num),R=o[E]?.view??0;return(o[S]?.view??0)-R});break;case"팀작우선":p.sort((g,v)=>(v.members.length>1)-(g.members.length>1));break;case"개인작우선":p.sort((g,v)=>(g.members.length>1)-(v.members.length>1));break}return p},[d,i,o]);return y.jsxs(Uj,{children:[y.jsx(zj,{children:"Projects"}),y.jsx(O2,{type:"project",onCategoryChange:t,onSortChange:a,sortLabel:i}),y.jsx(Pj,{children:y.jsx(Fj,{list:m,statsById:o})})]})}const qj=T.div(({height:n,from:t,to:i,position:a,z:o})=>({position:"absolute",left:0,right:0,[a]:-1,height:n,pointerEvents:"none",zIndex:o??0,background:`linear-gradient(180deg, ${t} 0%, ${i} 100%)`}));function CE({position:n="bottom",from:t,to:i,height:a=240,z:o=0,style:u}){return y.jsx(qj,{position:n,from:t,to:i,height:a,z:o,style:u})}const ro={heroToWhite:{from:"rgba(18,18,18,0)",to:"#FFFFFF",h:80},whiteToBlack:{from:"rgba(255,255,255,0)",to:"#121212",h:160}},Hj=T.section`
...
`;function nD(){const[n,t]=St.useState(!1),i=St.useRef(null),a="/",o=zh();St.useEffect(()=>()=>{i.current&&clearTimeout(i.current)},[]);const u=()=>{const m=`${typeof window<"u"&&window.innerWidth<640?"projects":"showroom"}`;o(m)};return y.jsxs(Hj,{"aria-label":"Hero",children:[y.jsxs(Gj,{children:[y.jsx(Yj,{"aria-hidden":!0,children:y.jsx(Qj,{autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata",children:y.jsx("source",{src:`${a}video/hero11.mp4`,type:"video/mp4"})})}),y.jsx(Xj,{"aria-label":"Hero background video",children:y.jsxs(Wj,{autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata",onLoadedData:()=>{i.current&&clearTimeout(i.current),i.current=setTimeout(()=>t(!0),13900)},children:[y.jsx("source",{src:`${a}video/hero11.mp4`,type:"video/mp4"}),"Your browser does not support the video tag."]})}),y.jsx(Zj,{})]}),y.jsxs(Jj,{$visible:n,children:[y.jsxs(y_,{children:["25. 10. 24. FRI~26. SUN",y.jsx("br",{}),"Hongdae Art Center B2"]}),y.jsx(y_,{children:"Department of Design Engineering"}),y.jsxs(tD,{children:["Tech University of Korea",y.jsx("br",{}),"20th Grad Exhibition"]})]}),y.jsxs(eD,{type:"button",onClick:u,"aria-label":"View More",children:[y.jsx("span",{className:"desktop",children:"View More"}),y.jsx("span",{className:"mobile",children:"View Work"})]}),y.jsx(CE,{position:"bottom",from:ro.heroToWhite.from,to:ro.heroToWhite.to,height:ro.heroToWhite.h,z:0})]})}T.section`
  position: relative;
  z-index: 1;
  background: #FFFFFF;
  padding-top: 120px;
...
`,g5=T.div`
    ...
    bottom: 0;
    z-index: 10;
`;function y5({}){const[n,t]=B.useState(!1),i=[{title:"잔향 : 기억의 향기",context:`우리는 살아가며 수많은 순간들을 스쳐 지나간다.
                ...
                학생들이 쌓아온 고민과 탐구의 시간, 하나의 작품을 완성하기 위한 노력한 과정은 AI&ROBOT, EDUCATION&KIDS, HEALTH CARE, IT& TECH, LIVING, MOBILITY라는 여섯 가지 향으로 드러납니다. 각각 독립된 향은 노트처럼 뚜렷한 개성을 지니면서도 함께 어우러져 전체적인 조화를 완성합니다.`},{title:"잔향의 형",context:"세 갈래로 뻗어 나가는 유기적인 곡선은 꽃잎의 형상을 닮아, 작품 속에서 향이 피어오르고 퍼져나가는 순간을 담았습니다. 곡선들이 서로 교차하며 만들어내는 흐름은 창작의 과정에서 이어지는 영감과 감정을 나타내고, 그 중심에 놓인 물방울은 남겨진 향과 기억의 매개체를 의미합니다. 이는 전시를 통해 스며든 감각과 감정이 시간이 지나도 서서히 피어오르는 잔향으로 남기를 바라는 의지를 담고 있습니다."}];return y.jsxs(h5,{children:[y.jsxs(d5,{children:[y.jsxs(zp,{children:[y.jsx(E_,{children:y.jsx($p,{children:y.jsx("span",{children:i[0].title})})}),y.jsxs(b_,{children:[y.jsx(Pm,{children:i[0].context}),y.jsx(Bp,{src:`${Lp}brand-concept-logo.png`})]})]}),y.jsxs(zp,{children:[y.jsx(E_,{children:y.jsx($p,{children:i[1].title})}),y.jsxs(b_,{children:[y.jsx(Pm,{children:i[1].context}),y.jsx(Bp,{src:`${Lp}brand-category.png`})]})]}),y.jsxs(zp,{children:[y.jsxs(p5,{children:[y.jsx($p,{children:i[2].title}),y.jsx(f5,{children:i[2].context})]}),y.jsx(Bp,{src:`${Lp}brand-variation.png`})]})]}),y.jsx(CE,{position:"bottom",from:ro.whiteToBlack.from,to:ro.whiteToBlack.to,height:ro.whiteToBlack.h,z:0}),y.jsx(g5,{children:y.jsx(m5,{})})]})}T.div`
  @media (max-width: 640px) {
...
`;function v5(){const n=[y.jsx(nD,{},"hero"),y.jsx(y5,{},"new-brand"),y.jsx(pD,{},"gallery"),y.jsx(x5,{children:"TU-EXPO Works"},"works-title"),y.jsx(PD,{},"works"),y.jsx(HD,{},"insta"),y.jsx(c5,{},"venue")];return y.jsx("div",{style:{background:"#121212",minHeight:"100vh"},children:n})}const _5="/",Wg="Pretendard, system-ui",w5=T.div`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  position: relative;
  border-radius: 8px;
...
`,E5=`${_5}guestbook-card.svg`,b5=T.div`
  width: 181px;
  height: 147px;
  position: absolute;
  left: 6px;
  top: 190px;
  background-image: url(${E5});
...
`;function I5({to:n,from:t,message:i}){return y.jsxs(w5,{$w:yo,$h:Ja,children:[y.jsx(b5,{}),y.jsxs(T5,{$w:yo,$h:Ja,children:[y.jsx(S5,{children:`To. ${n}`}),y.jsx(A5,{children:i}),y.jsx(R5,{children:`From. ${t}`})]})]})}const C5=T.div`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
  overflow: hidden;
...
`,j5=T.img`
  ...
  object-fit: cover;
  display: block;
`;function D5({src:n}){return y.jsx(C5,{$w:yo,$h:Ja,children:y.jsx(j5,{src:n,alt:"포토 카드"})})}const N5=T.button`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
...
`;function U5({onClick:n}){return y.jsxs(N5,{onClick:n,"aria-label":"방명록 작성",$w:yo,$h:Ja,children:[y.jsx(M5,{$w:yo,$h:Ja}),y.jsx(O5,{children:y.jsxs(V5,{children:[y.jsx(k5,{}),y.jsx(P5,{})]})})]})}const yo=270,Ja=337,L5=30,jE=20,z5=210,$5=60,DE=173,NE=216,B5=16,F5=16,Um=16,K5=T.div`
  padding: 0 0 12px 0;
  @media (max-width: 640px) {
    display: none;
  }
...
`,lN=T.div`
  ...
  width: 302px;
  height: 246px;
  background-image: url(${nN}/gestbook-card.svg);
  background-size: cover;
  background-repeat: no-repeat;
  @media (max-width: 640px) {
    left: 4px;
...
`;function bN({open:n,onClose:t,onSubmit:i,defaultTo:a="",defaultFrom:o=""}){const[u,d]=B.useState(a),[m,p]=B.useState(o),[g,v]=B.useState(""),E=B.useRef(null);if(B.useEffect(()=>{const M=L=>{L.key==="Escape"&&t?.()};return n&&document.addEventListener("keydown",M),()=>document.removeEventListener("keydown",M)},[n,t]),!n)return null;const S=M=>{M.target===E.current&&t?.()},R=()=>{const M={to:(u||"").trim(),from:(m||"").trim(),message:(g||"").trim()};M.message&&i?.(M)};return y.jsx(iN,{ref:E,onMouseDown:S,children:y.jsxs(rN,{onMouseDown:M=>M.stopPropagation(),children:[y.jsx(aN,{children:y.jsxs(sN,{children:[y.jsxs(oN,{children:[y.jsx(lN,{}),y.jsxs(uN,{children:[y.jsx(cN,{children:"To."}),y.jsx(hN,{value:u,onChange:M=>d(M.target.value),placeholder:"받는 사람"})]}),y.jsx(dN,{children:y.jsx(fN,{placeholder:"내용을 입력해 주세요.",value:g,onChange:M=>v(M.target.value)})}),y.jsxs(pN,{children:[y.jsx(mN,{children:"From."}),y.jsx(gN,{value:m,onChange:M=>p(M.target.value),placeholder:"보내는 사람"})]})]}),y.jsx(yN,{children:y.jsx(xN,{type:"button",onClick:R,"aria-label":"send",children:y.jsx(vN,{})})})]})}),y.jsx(_N,{children:y.jsx(wN,{type:"button",onClick:t,"aria-label":"close",children:y.jsxs(EN,{children:[y.jsx(S_,{$deg:45}),y.jsx(S_,{$deg:-45})]})})})]})})}const TN={apiKey:"AIzaSyAEFzPwTADLzuxWuyk889Jz1cHPsEgLOkQ",authDomain:"tu2025grad.firebaseapp.com",projectId:"tu2025grad",storageBucket:"tu2025grad.firebasestorage.app",messagingSenderId:"553768466639",appId:"1:553768466639:web:7c16f5d6432da7ebc05fba"},SN=dg(TN),Kp=gE(SN),AN='Pretendard, system-ui, -apple-system, Segoe UI, Roboto, "Noto Sans KR", Arial, sans-serif',RN=T.div`
...
`,CN=T.h1`
  font-family: ${AN}; font-weight: 700; font-size: 32px; color: #FFFFFF; text-align: center; margin: 20px 0 40px;
  @media (max-width: 640px) {
...
`;function NN(){const[n,t]=St.useState(!1),[i,a]=St.useState([]);St.useEffect(()=>{let d=!0;return(async()=>{try{const m=h_(yh(Kp,"guest"),d_("time","desc")),p=await Vm(m);if(!d)return;const g=[];p.forEach(v=>{const E=v.data();g.push({id:v.id,to:E.to||"",from:E.from||"",message:E.message||"",type:"text"})}),a(g)}catch(m){console.error("Failed to load guestbook items:",m)}})(),()=>{d=!1}},[]);const o=async({to:d,from:m,message:p})=>{try{const g=String(Date.now());await Qg(Xl(yh(Kp,"guest"),g),{to:d||"",from:m||"",message:p||"",time:g});try{const v=h_(yh(Kp,"guest"),d_("time","desc")),E=await Vm(v),S=[];E.forEach(R=>{const M=R.data();S.push({id:R.id,to:M.to||"",from:M.from||"",message:M.message||"",type:"text"})}),a(S)}catch(v){console.error("Failed to reload guestbook items after submit:",v)}t(!1)}catch(g){console.error("Failed to submit guest message:",g)}};return y.jsxs(RN,{children:[y.jsxs(IN,{children:[y.jsx(CN,{children:"Guest Book"}),y.jsx(jN,{children:y.jsxs(DN,{className:"gb-wrap",children:[y.jsx("style",{children:`
  ...
  `}),y.jsx(eN,{onOpenModal:()=>t(!0),items:i})]})})]}),y.jsx(bN,{open:n,onClose:()=>t(!1),onSubmit:o})]})}const Lm="/",MN=T.div`
  display: flex;
  position: sticky;
  top: 80px;
  bottom: 0px;
...
`;function zm({titleKor:n,titleEng:t,context:i,isOpen:a=!0,onClose:o,src:u,docId:d,collection:m="works"}){const[p,g]=B.useState(0),[v,E]=B.useState(!1);B.useEffect(()=>{let M=!0;return(async()=>{if(d!=null)try{const L=Xl(Wl,m,String(d)),U=await vh(L);if(!M)return;if(U.exists()){const q=U.data();g(typeof q.like=="number"?q.like:0)}else g(0)}catch(L){console.error("Firestore getDoc error:",L),M&&g(0)}})(),()=>{M=!1}},[d,m]);const S=async()=>{try{const M=Xl(Wl,m,String(d)),L=await vh(M);if(L.exists()){const U=L.data();g(typeof U.like=="number"?U.like:0)}}catch(M){console.error("Firestore refresh error:",M)}},R=async()=>{if(v)return;if(d==null){console.warn("handleLike called without a valid docId");return}E(!0);const M=Xl(Wl,m,String(d));try{await Ph(M,{like:Uh(1)}),g(L=>L+1),await S()}catch(L){if(L.code==="not-found"||/No document/i.test(String(L)))try{(await vh(M)).exists()?await Ph(M,{like:Uh(1)}):await Qg(M,{like:1},{merge:!0}),await S()}catch(U){console.error("Firestore like fallback error:",U)}else console.error("Firestore like error:",L)}finally{E(!1)}};return y.jsx(MN,{$open:!!a,children:y.jsxs(ON,{children:[y.jsxs(VN,{children:[y.jsx(kN,{onClick:()=>{typeof o=="function"&&o()},children:y.jsx("img",{src:`${Lm}icons/closeIcon.svg`,alt:"Close Icon"})}),y.jsxs(PN,{children:[y.jsx(BN,{$src:u}),y.jsxs(zN,{children:[y.jsx(LN,{children:n}),y.jsx(UN,{children:t})]}),y.jsx($N,{children:i})]})]}),y.jsxs(FN,{children:[y.jsx(KN,{onClick:R,"aria-disabled":v,title:v?"처리 중":"좋아요",children:y.jsxs(qN,{children:[y.jsx(HN,{$src:`${Lm}icons/likeIcon(white).svg`,"aria-label":"Like icon"}),y.jsx(GN,{children:p||0})]})}),y.jsxs(YN,{onClick:()=>{const L=Math.max(document.documentElement?.scrollHeight||0,document.body?.scrollHeight||0)-window.innerHeight,q=Math.max(0,L-269);window.scrollTo({top:q,behavior:"smooth"})},children:[y.jsx(QN,{children:"Designer Info"}),y.jsx(XN,{})]})]})]})})}zm.propTypes={titleKor:Z.string.isRequired,titleEng:Z.string.isRequired,context:Z.string.isRequired,isOpen:Z.bool,onClose:Z.func,docId:Z.oneOfType([Z.string,Z.number]).isRequired,collection:Z.string};const WN=T.div`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  letter-spacing: 0.24px;
  color: #202020;
  text-decoration: none;
...
`;function Zg({nameKor:n,nameEng:t,part:i,sns:a,eMail:o,imgUrl:u,imgAlt:d}){return y.jsxs(WN,{children:[y.jsx(ZN,{children:y.jsx(JN,{src:u,alt:d})}),y.jsxs(t9,{children:[y.jsxs(e9,{children:[y.jsx(n9,{children:n}),y.jsx(i9,{children:t})]}),y.jsxs(r9,{children:[y.jsxs(a9,{children:[y.jsx(qp,{children:"Part"}),y.jsx(qp,{children:"SNS"}),y.jsx(qp,{children:"E-mail"})]}),y.jsxs(s9,{children:[y.jsx(Hp,{children:i}),y.jsx(Hp,{children:a}),y.jsx(Hp,{children:o})]})]})]})]})}Zg.propTypes={nameKor:Z.string.isRequired,nameEng:Z.string.isRequired,part:Z.string,sns:Z.string,eMail:Z.string,imgUrl:Z.string.isRequired,imgAlt:Z.string.isRequired};Zg.defaultProps={sns:"N/A",eMail:"N/A"};const o9=T.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  width: 775px;
...
`;function A_({designers:n}){return y.jsxs(o9,{children:[y.jsx(u9,{children:"Designer"}),y.jsx(l9,{children:n.map((t,i)=>y.jsx(Zg,{nameKor:t.nameKor,nameEng:t.nameEng,part:t.role,sns:t.sns,eMail:t.eMail,imgUrl:t.imgUrl},i))})]})}const c9=T.div`
    width: 100%; // 임시값
    margin-top: 50px;
...
`,d9=T.iframe`
    ...
    padding: 0;
    overflow: hidden;
`;function f9({videoId:n,isInfoOpen:t}){const a=`https://player.vimeo.com/video/${String(n||"").trim()}?badge=0&autopause=0&title=0&byline=0&portrait=0&app_id=58479`;return y.jsx(c9,{$isInfoOpen:t,children:y.jsx(h9,{children:y.jsx(d9,{src:a,frameBorder:"0",allow:"autoplay; fullscreen; picture-in-picture",allowFullScreen:!0,title:"Embedded Vimeo"})})})}const p9="/",m9=T.div`
...
`,g9=T.div`
    ...
    width: 40px;
    height: 40px;
`;function y9({isOpen:n=!1,onClick:t}){const[i,a]=B.useState(!1);return B.useEffect(()=>{let o;return n?a(!1):(a(!1),o=setTimeout(()=>{a(!0)},500)),()=>clearTimeout(o)},[n]),y.jsx(m9,{$visible:!n,$active:i,onClick:()=>{typeof t=="function"&&t()},children:y.jsx(g9,{children:y.jsx("img",{src:`${p9}icons/infoOpenIcon.svg`,alt:"작품 정보 열기"})})})}function nh(n){if(!n)return n;const t="/";if(/^https?:\/\//i.test(n))return n;const i=String(n).replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const x9=T.img`
  width: 100%;
  /* max-width: 1800px; */
  /* padding: 0px 100px; */
  /* padding-right: 100px; */
...
`,Gp=n=>y.jsx(x9,{loading:"lazy",...n}),v9=T.div`
  display: flex;
  position: relative;
  background: #fff;
  width: 100%;
...
`,R9=T.div`
    animation: ${({$visible:n,$floatDur:t})=>n?tg`${S9} ${t??1800}ms ease-in-out infinite alternate`:"none"};
...
`,C_=T.div`
    ...
    background-repeat: no-repeat;
    background-position: center;
`;function I9({visible:n=!0,fadeMs:t=800,floatDur:i=1800,amp:a=6}={}){return y.jsxs(A9,{$visible:n,$fadeMs:t,"aria-hidden":!n,children:[y.jsx(C_,{src:`${I_}icons/showIndicatorMouse.svg`,style:{color:"#FFF"}}),y.jsx(R9,{$visible:n,$floatDur:i,style:{"--amp":`${a}px`},children:y.jsx(C_,{src:`${I_}icons/showIndicatorDown.svg`})})]})}const Yp=T.div`
    z-index: 5;
    display: flex;
    position: absolute;
    flex-direction: row;
...
`,j9=T.p`
    ...
    text-align: justify;
    margin: 0;
`;function Qp({children:n,textWidth:t,textHeight:i,shown:a,tDur:o,tDelay:u,ease:d}){return y.jsx(C9,{$textWidth:t,$textHeight:i,$shown:a,$tDur:o,$tDelay:u,$ease:d,children:y.jsx(j9,{children:n})})}function D9({top:n,left:t,right:i="auto",bottom:a,lineWidth:o,textWidth:u,textHeight:d,children:m,position:p="left",isActive:g,section:v,currentSection:E,anim:S}){const[R,M]=B.useState(!1),L=S?.circle?.easing||S?.line?.easing||S?.text?.easing||"cubic-bezier(0.22,1,0.36,1)",U=S?.circle?.duration??250,q=S?.circle?.delay??120,X=S?.line?.duration??500,tt=q+U+(S?.line?.delay??120),lt=S?.text?.duration??280,Y=tt+X+(S?.text?.delay??80),C=g||R&&E===v;if(B.useEffect(()=>{g&&!R&&M(!0)},[g,R]),p==="right")return y.jsxs(Yp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsx(Qp,{textWidth:u,textHeight:d,shown:C,tDur:lt,tDelay:Y,ease:L,children:m}),y.jsxs(M_,{children:[y.jsx(N_,{$lineWidth:o,$shown:C,$lDur:X,$lDelay:tt,$ease:L}),y.jsx(j_,{$shown:C,$cDur:U,$cDelay:q,$ease:L,children:y.jsx(D_,{$shown:C,$cDur:U,$cDelay:q,$ease:L})})]})]});if(p==="left")return y.jsxs(Yp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsxs(M_,{children:[y.jsx(j_,{$shown:C,$cDur:U,$cDelay:q,$ease:L,children:y.jsx(D_,{$shown:C,$cDur:U,$cDelay:q,$ease:L})}),y.jsx(N_,{$lineWidth:o,$shown:C,$lDur:X,$lDelay:tt,$ease:L})]}),y.jsx(Qp,{textWidth:u,textHeight:d,shown:C,tDur:lt,tDelay:Y,ease:L,children:m})]});if(p==="no-line")return y.jsx(Yp,{$top:n,$left:t,$right:i,$bottom:a,children:y.jsx(Qp,{textWidth:u,textHeight:d,shown:C,tDur:lt,tDelay:Y,ease:L,children:m})})}const Xp="/",N9=T.div`
    display: flex;
    position: relative;
    margin-top: 80px;
    width: 100vw;
