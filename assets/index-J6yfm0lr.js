...
`;function _2({items:n=[],activeKey:t,mode:i,onModeChange:a,autoOnScroll:o=!1,scrollThreshold:u=8,sticky:d=!0,maxWidth:m,overlay:p=!1}){const[g,v]=B.useState(!1),[w,T]=B.useState(he.GRADIENT),R=typeof i=="string",M=R?i:w,z=B.useRef(R?i:w);B.useEffect(()=>{if(!R)return;(window.scrollY||document.documentElement.scrollTop||0)<=u&&(z.current=i)},[i,R,u]),B.useEffect(()=>{if(!o)return;const O=()=>{const V=window.scrollY||document.documentElement.scrollTop||0,L=z.current||he.GRADIENT_DARK,N=V>u?he.DARK:L;R||T(N),a&&a(N)};return O(),window.addEventListener("scroll",O,{passive:!0}),()=>window.removeEventListener("scroll",O)},[o,R,a,u]);const{baseColor:U,gradient:H,textColor:F,boxShadow:Z,showGradient:ot}=B.useMemo(()=>{switch(M){case he.LIGHT:return{baseColor:"linear-gradient(180deg, rgba(255,255,255,0.8) 60%, rgba(255,255,255,0) 100%)",gradient:"rgba(255,255,255,1)",textColor:"#000",showGradient:!0};case he.DARK:return{baseColor:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,0) 100%)",gradient:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,1) 100%)",textColor:"#fff",showGradient:!0};case he.GRADIENT_DARK:return{baseColor:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,0) 100%)",gradient:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,1) 100%)",textColor:"#fff",showGradient:!1};default:return{baseColor:"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0) 100%)",gradient:"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0) 100%)",textColor:"#000",showGradient:!1}}},[M]),I=M===he.DARK||M===he.GRADIENT_DARK||g,j=I?"/icons/logoLight.svg":"/icons/logoDark.svg",C=n.filter(O=>O.label!=="SHOWROOM");return B.useEffect(()=>(g?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[g]),y.jsxs(U4,{role:"banner",$sticky:d,$overlay:p,$baseColor:U,$gradient:H,$showGradient:ot,$textColor:F,$boxShadow:Z,children:[y.jsx(z4,{$maxWidth:m,children:y.jsxs(L4,{children:[y.jsxs($4,{children:[y.jsx(ns,{to:"/","aria-label":"홈으로",style:{color:"inherit",textDecoration:"none"},children:y.jsx(G4,{"aria-hidden":!0,children:y.jsx(Y4,{children:y.jsx("div",{style:{backgroundImage:`url(${j})`,width:"100%",height:"100%",backgroundSize:"contain",backgroundRepeat:"no-repeat"}})})})}),y.jsx(B4,{"aria-label":"주 메뉴",children:n.map(O=>y.jsx(Qm,{label:O.label,href:O.href,active:O.key===t},O.key))})]}),y.jsx(F4,{"aria-label":g?"메뉴 닫기":"메뉴 열기",onClick:()=>v(O=>!O),children:y.jsx(P4,{isOpen:g,size:24,color:I?"#fff":"#000"})})]})}),y.jsx(q4,{$open:g,onClick:()=>v(!1),children:y.jsx(K4,{onClick:O=>O.stopPropagation(),children:C.map(O=>y.jsx(H4,{label:O.label,href:O.href,active:O.key===t,style:{fontSize:18,fontWeight:500,color:"#fff",textAlign:"center"},onClick:()=>v(!1)},O.key))})})]})}_2.propTypes={items:J.arrayOf(J.shape({key:J.string.isRequired,label:J.string.isRequired,href:J.string})),activeKey:J.string,mode:J.oneOf([he.GRADIENT,he.LIGHT,he.DARK,he.GRADIENT_DARK]),onModeChange:J.func,autoOnScroll:J.bool,scrollThreshold:J.number,sticky:J.bool,overlay:J.bool,maxWidth:J.oneOfType([J.string,J.number])};const Xm="Pretendard, system-ui, -apple-system, Segoe UI, Roboto, 'Noto Sans KR', Arial, sans-serif",Q4=A.footer`
  width: 100vw;
  background: #0E0E0E;
...
`,$A=A(uh)`
 @media (max-width: 640px) {
    display: none;
 }`;function Wm({nameKor:n,nameEng:t,role:i,sns:a,eMail:o,imgSrc:u,imgAlt:d}){return y.jsxs(VA,{children:[y.jsxs(kA,{children:[y.jsx(PA,{src:u,alt:d}),y.jsx(UA,{})]}),y.jsxs(zA,{children:[y.jsxs(Px,{style:{top:"50px"},children:[y.jsx(LA,{children:n}),y.jsx(uh,{children:t})]}),y.jsxs(Px,{children:[y.jsx(uh,{children:i}),typeof a=="string"&&a.trim()&&a!=="-"?y.jsx(uh,{children:a}):Array.isArray(a)&&a.length>0?y.jsx("div",{style:{display:"flex",gap:"8px",flexWrap:"wrap",margin:"4px 0 0 0"},children:a.map((m,p)=>y.jsx("span",{style:{wordBreak:"break-all"},children:m.handle||m.url},`${m.platform}-${p}`))}):"-",y.jsx($A,{children:o?y.jsx("a",{style:{textDecoration:"none",color:"inherit"},href:`mailto:${o}`,children:o}):null})]})]})]})}Wm.defaultProps={sns:[]};Wm.propTypes={nameKor:J.string.isRequired,nameEng:J.string,role:J.string,sns:J.arrayOf(J.shape({platform:J.string.isRequired,url:J.string.isRequired})),eMail:J.string,imgSrc:J.string.isRequired,imgAlt:J.string.isRequired};const BA=A.div`
  display: flex;
  align-items: center;
  justify-content: flex-start;
  flex-direction: row;
...
`;function sm({path:n="student",isActive:t=!1,onClick:i}){return y.jsxs(BA,{onClick:i,children:[y.jsx(b2,{$active:t,children:"교수"}),y.jsx(qA,{$active:t,children:"학생"}),y.jsx(FA,{$active:t})]})}sm.propTypes={path:J.oneOf(["student","professor"]),isActive:J.bool,onClick:J.func};const Ux=A.a`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  font-size: 24px;
  line-height: 28.8px;
  letter-spacing: 0.24px;
...
`,zx=A.span`
    ...
    align-items: center;
    justify-content: flex-start;
`;function ch({label:n,href:t=null,active:i=!1,onClick:a,style:o,target:u,rel:d}){const p={"aria-current":i?"page":void 0,"data-active":i?"true":"false",onKeyDown:g=>{a&&(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),a(g))},"data-label":n,onClick:a,style:o,$active:i};return t?y.jsx(Ux,{href:t,target:u,rel:d,...p,children:y.jsx(zx,{className:"navbtn-text",children:n})}):y.jsx(Ux,{as:"button",type:"button",...p,style:{background:"none",border:0,...o},children:y.jsx(zx,{className:"navbtn-text",children:n})})}ch.propTypes={label:J.string.isRequired,href:J.string,active:J.bool,onClick:J.func,style:J.object,target:J.string,rel:J.string};const T2=A.div`
  display: flex;
  width: 120px;
  height: 40px;
  flex-direction: row;
...
`;function Zm({label:n,style:t,mode:i}){const u=window.matchMedia("(max-width: 640px)").matches?"/icons/dropDownMobileIcon.svg":"/icons/arrowDropdownIcon.svg";return i==="category"?y.jsxs(KA,{style:t,children:[y.jsx(HA,{children:n}),y.jsx(Lx,{children:y.jsx("img",{src:"/icons/arrowDropdownIcon.svg",alt:"dropdownIcon"})})]}):y.jsxs(T2,{style:t,children:[y.jsx(S2,{children:n}),y.jsx(Lx,{children:y.jsx("img",{src:u,alt:"dropdownIcon"})})]})}Zm.propTypes={label:J.string.isRequired,style:J.object};const GA=A.div`
...
`;function I2({onCategoryChange:n,onToggleChange:t,type:i,onSortChange:a,sortLabel:o}){const u={type:i},[d,m]=St.useState(!1),p=()=>m(W=>{const ut=!W;return t&&t(ut),ut}),[g,v]=St.useState("전체"),[w,T]=St.useState("All Projects"),R=["전체","산업디자인공학","미디어디자인공학"],M=["장영주","권오재","김 억","김한종","조남주","한민섭","홍성수","김태균"],z=["All Projects","AI & Robot","Edu & Kids","Health Care","IT & Tech","Living","Mobility"],U=["이름순","좋아요순","조회수순","팀작우선","개인작우선"],[H,F]=St.useState("이름순"),Z=o||H,ot=W=>{F(W),a&&a(W)};return B.useEffect(()=>{v(d?M[0]:R[0])},[d]),u.type==="project"?y.jsxs(wp,{children:[y.jsx(bp,{}),y.jsx(Tp,{children:z.map(W=>y.jsx(ch,{label:W,active:w===W,onClick:()=>{T(W),n&&n(W)}},W))}),y.jsx(Sp,{children:y.jsx(ql,{mode:"category",label:w,options:z,onSelect:W=>{T(W),n&&n(W)}})}),y.jsx(Jm,{label:Z,options:U,onSelect:ot})]}):d?y.jsxs(wp,{children:[y.jsx(bp,{}),y.jsx(Tp,{children:M.map(W=>y.jsx(ch,{label:W,active:g===W,onClick:()=>{v(W),n&&n(W)}},W))}),y.jsx(Sp,{children:y.jsx(ql,{mode:"category",label:g,options:M,onSelect:W=>{v(W),n&&n(W)}})}),y.jsx(sm,{path:d?"professor":"student",isActive:d,onClick:p})]}):y.jsxs(wp,{children:[y.jsx(bp,{}),y.jsx(Tp,{children:R.map(W=>y.jsx(ch,{label:W,active:g===W,onClick:()=>{v(W),n&&n(W)}},W))}),y.jsx(Sp,{children:y.jsx(ql,{mode:"category",label:g,options:R,onSelect:W=>{v(W),n&&n(W)}})}),y.jsx(sm,{path:d?"professor":"student",isActive:d,onClick:p})]})}const eR=A.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  justify-content: center;
...
`;function Xx(n){return typeof n=="number"&&n>999?"999+":n}function ng({titleKor:n,titleEng:t,nameKor:i,view:a,like:o,href:u,src:d,profileImgs:m,docId:p}){const g=typeof o=="number"?o:0,v=typeof a=="number"?a:0,w=U=>{const H=U.currentTarget.querySelector(".card-hover");H&&(H.style.opacity=1)},T=U=>{const H=U.currentTarget.querySelector(".card-hover");H&&(H.style.opacity=0)},R="/",M=/^https?:\/\//i.test(u),z=y.jsxs(y.Fragment,{children:[y.jsx(xR,{children:y.jsxs(vR,{onMouseEnter:w,onMouseLeave:T,children:[y.jsx(ER,{className:"card-hover",children:y.jsxs(wR,{children:[y.jsx(TR,{children:n}),y.jsx(bR,{children:t})]})}),y.jsx(_R,{src:d,alt:"Project"})]})}),y.jsxs(SR,{children:[y.jsxs(AR,{children:[y.jsx(IR,{children:m.map((U,H)=>y.jsx(jR,{src:U,alt:`Profile${H+1}`,$z:3-H,$ml:H>0},H))}),y.jsx(RR,{children:i})]}),y.jsxs(CR,{children:[y.jsxs(Gx,{children:[y.jsx(Yx,{src:`${R}icons/likeIcon.svg`}),y.jsx(Qx,{children:Xx(g)})]}),y.jsxs(Gx,{children:[y.jsx(Yx,{src:`${R}icons/viewIcon.svg`}),y.jsx(Qx,{children:Xx(v)})]})]})]})]});return M?y.jsx(Kx,{children:y.jsx(Hx,{as:"a",href:u,style:{textDecoration:"none"},children:z})}):y.jsx(Kx,{children:y.jsx(Hx,{as:ns,to:u.startsWith("/")?u:`/${u}`,style:{textDecoration:"none"},children:z})})}ng.propTypes={titleKor:J.string.isRequired,titleEng:J.string.isRequired,nameKor:J.string.isRequired,view:J.number,like:J.number,src:J.string.isRequired,href:J.string.isRequired,profileImgs:J.arrayOf(J.string).isRequired,docId:J.oneOfType([J.string,J.number]),collection:J.string};ng.defaultProps={titleKor:"프로젝트 제목",titleEng:"Project Title",nameKor:"Author Name",view:0,like:0,collection:"works"};const DR=()=>{};var Wx={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lr=new O2("@firebase/app"),b6="@firebase/app-compat",T6="@firebase/analytics-compat",S6="@firebase/analytics",A6="@firebase/app-check-compat",R6="@firebase/app-check",I6="@firebase/auth",j6="@firebase/auth-compat",C6="@firebase/database",D6="@firebase/data-connect",N6="@firebase/database-compat",M6="@firebase/functions",O6="@firebase/functions-compat",V6="@firebase/installations",k6="@firebase/installations-compat",P6="@firebase/messaging",U6="@firebase/messaging-compat",z6="@firebase/performance",L6="@firebase/performance-compat",$6="@firebase/remote-config",B6="@firebase/remote-config-compat",F6="@firebase/storage",q6="@firebase/storage-compat",K6="@firebase/firestore",H6="@firebase/ai",G6="@firebase/firestore-compat",Y6="firebase",Q6="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cm="[DEFAULT]",X6={[um]:"fire-core",[b6]:"fire-core-compat",[S6]:"fire-analytics",[T6]:"fire-analytics-compat",[R6]:"fire-app-check",[A6]:"fire-app-check-compat",[I6]:"fire-auth",[j6]:"fire-auth-compat",[C6]:"fire-rtdb",[D6]:"fire-data-connect",[N6]:"fire-rtdb-compat",[M6]:"fire-fn",[O6]:"fire-fn-compat",[V6]:"fire-iid",[k6]:"fire-iid-compat",[P6]:"fire-fcm",[U6]:"fire-fcm-compat",[z6]:"fire-perf",[L6]:"fire-perf-compat",[$6]:"fire-rc",[B6]:"fire-rc-compat",[F6]:"fire-gcs",[q6]:"fire-gcs-compat",[K6]:"fire-fst",[G6]:"fire-fst-compat",[H6]:"fire-vertex","fire-js":"fire-js",[Y6]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn{constructor(t){this.fields=t,t.sort(We.comparator)}static empty(){return new jn([])}unionWith(t){let i=new Ue(We.comparator);for(const a of this.fields)i=i.add(a);for(const a of t)i=i.add(a);return new jn(i.toArray())}covers(t){for(const i of this.fields)if(i.isPrefixOf(t))return!0;return!1}isEqual(t){return ho(this.fields,t.fields,((i,a)=>i.isEqual(a)))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z2="server_timestamp",J2="__type__",tE="__previous_value__",eE="__local_write_time__";function cg(n){return(n?.mapValue?.fields||{})[J2]?.stringValue===Z2}function Xh(n){const t=n.mapValue.fields[tE];return cg(t)?Xh(t):t}function su(n){const t=ia(n.mapValue.fields[eE].timestampValue);return new le(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xn{constructor(t){this.value=t}static empty(){return new xn({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let i=this.value;for(let a=0;a<t.length-1;++a)if(i=(i.mapValue.fields||{})[t.get(a)],!fh(i))return null;return i=(i.mapValue.fields||{})[t.lastSegment()],i||null}}set(t,i){this.getFieldsMap(t.popLast())[t.lastSegment()]=Hl(i)}setAll(t){let i=We.emptyPath(),a={},o=[];t.forEach(((d,m)=>{if(!i.isImmediateParentOf(m)){const p=this.getFieldsMap(i);this.applyChanges(p,a,o),a={},o=[],i=m.popLast()}d?a[m.lastSegment()]=Hl(d):o.push(m.lastSegment())}));const u=this.getFieldsMap(i);this.applyChanges(u,a,o)}delete(t){const i=this.field(t.popLast());fh(i)&&i.mapValue.fields&&delete i.mapValue.fields[t.lastSegment()]}isEqual(t){return Ci(this.value,t.value)}getFieldsMap(t){let i=this.value;i.mapValue.fields||(i.mapValue={fields:{}});for(let a=0;a<t.length;++a){let o=i.mapValue.fields[t.get(a)];fh(o)&&o.mapValue.fields||(o={mapValue:{fields:{}}},i.mapValue.fields[t.get(a)]=o),i=o}return i.mapValue.fields}applyChanges(t,i,a){la(i,((o,u)=>t[o]=u));for(const o of a)delete t[o]}clone(){return new xn(Hl(this.value))}}function rE(n){const t=[];return la(n.fields,((i,a)=>{const o=new We([i]);if(fh(a)){const u=rE(a.mapValue).fields;if(u.length===0)t.push(o);else for(const d of u)t.push(o.child(d))}else t.push(o)})),new jn(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(t,i,a,o,u,d,m){this.key=t,this.documentType=i,this.version=a,this.readTime=o,this.createTime=u,this.data=d,this.documentState=m}static newInvalidDocument(t){return new sn(t,0,At.min(),At.min(),At.min(),xn.empty(),0)}static newFoundDocument(t,i,a,o){return new sn(t,1,i,At.min(),a,o,0)}static newNoDocument(t,i){return new sn(t,2,i,At.min(),At.min(),xn.empty(),0)}static newUnknownDocument(t,i){return new sn(t,3,i,At.min(),At.min(),xn.empty(),2)}convertToFoundDocument(t,i){return!this.createTime.isEqual(At.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=t),this.version=t,this.documentType=1,this.data=i,this.documentState=0,this}convertToNoDocument(t){return this.version=t,this.documentType=2,this.data=xn.empty(),this.documentState=0,this}convertToUnknownDocument(t){return this.version=t,this.documentType=3,this.data=xn.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=At.min(),this}setReadTime(t){return this.readTime=t,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(t){return t instanceof sn&&this.key.isEqual(t.key)&&this.version.isEqual(t.version)&&this.documentType===t.documentType&&this.documentState===t.documentState&&this.data.isEqual(t.data)}mutableCopy(){return new sn(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U3{constructor(t){this.yt=t}}function z3(n){const t=N3({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?vm(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q3{constructor(t,i,a,o){this.remoteDocumentCache=t,this.mutationQueue=i,this.documentOverlayCache=a,this.indexManager=o}getDocument(t,i){let a=null;return this.documentOverlayCache.getOverlay(t,i).next((o=>(a=o,this.remoteDocumentCache.getEntry(t,i)))).next((o=>(a!==null&&Ql(a.mutation,o,jn.empty(),le.now()),o)))}getDocuments(t,i){return this.remoteDocumentCache.getEntries(t,i).next((a=>this.getLocalViewOfDocuments(t,a,Ut()).next((()=>a))))}getLocalViewOfDocuments(t,i,a=Ut()){const o=Qa();return this.populateOverlays(t,o,i).next((()=>this.computeViews(t,i,o,a).next((u=>{let d=Ll();return u.forEach(((m,p)=>{d=d.insert(m,p.overlayedDocument)})),d}))))}getOverlayedDocuments(t,i){const a=Qa();return this.populateOverlays(t,a,i).next((()=>this.computeViews(t,i,a,Ut())))}populateOverlays(t,i,a){const o=[];return a.forEach((u=>{i.has(u)||o.push(u)})),this.documentOverlayCache.getOverlays(t,o).next((u=>{u.forEach(((d,m)=>{i.set(d,m)}))}))}computeViews(t,i,a,o){let u=hr();const d=Yl(),m=(function(){return Yl()})();return i.forEach(((p,g)=>{const v=a.get(g.key);o.has(g.key)&&(v===void 0||v.mutation instanceof ua)?u=u.insert(g.key,g):v!==void 0?(d.set(g.key,v.mutation.getFieldMask()),Ql(v.mutation,g,v.mutation.getFieldMask(),le.now())):d.set(g.key,jn.empty())})),this.recalculateAndSaveOverlays(t,u).next((p=>(p.forEach(((g,v)=>d.set(g,v))),i.forEach(((g,v)=>m.set(g,new Y3(v,d.get(g)??null)))),m)))}recalculateAndSaveOverlays(t,i){const a=Yl();let o=new me(((d,m)=>d-m)),u=Ut();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,i).next((d=>{for(const m of d)m.keys().forEach((p=>{const g=i.get(p);if(g===null)return;let v=a.get(p)||jn.empty();v=m.applyToLocalView(g,v),a.set(p,v);const w=(o.get(m.batchId)||Ut()).add(p);o=o.insert(m.batchId,w)}))})).next((()=>{const d=[],m=o.getReverseIterator();for(;m.hasNext();){const p=m.getNext(),g=p.key,v=p.value,w=gE();v.forEach((T=>{if(!u.has(T)){const R=bE(i.get(T),a.get(T));R!==null&&w.set(T,R),u=u.add(T)}})),d.push(this.documentOverlayCache.saveOverlays(t,g,w))}return st.waitFor(d)})).next((()=>a))}recalculateAndSaveOverlaysForDocumentKeys(t,i){return this.remoteDocumentCache.getEntries(t,i).next((a=>this.recalculateAndSaveOverlays(t,a)))}getDocumentsMatchingQuery(t,i,a,o){return(function(d){return vt.isDocumentKey(d.path)&&d.collectionGroup===null&&d.filters.length===0})(i)?this.getDocumentsMatchingDocumentQuery(t,i.path):hE(i)?this.getDocumentsMatchingCollectionGroupQuery(t,i,a,o):this.getDocumentsMatchingCollectionQuery(t,i,a,o)}getNextDocuments(t,i,a,o){return this.remoteDocumentCache.getAllFromCollectionGroup(t,i,a,o).next((u=>{const d=o-u.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,i,a.largestBatchId,o-u.size):st.resolve(Qa());let m=au,p=u;return d.next((g=>st.forEach(g,((v,w)=>(m<w.largestBatchId&&(m=w.largestBatchId),u.get(v)?st.resolve():this.remoteDocumentCache.getEntry(t,v).next((T=>{p=p.insert(v,T)}))))).next((()=>this.populateOverlays(t,g,u))).next((()=>this.computeViews(t,p,g,Ut()))).next((v=>({batchId:m,changes:mE(v)})))))}))}getDocumentsMatchingDocumentQuery(t,i){return this.getDocument(t,new vt(i)).next((a=>{let o=Ll();return a.isFoundDocument()&&(o=o.insert(a.key,a)),o}))}getDocumentsMatchingCollectionGroupQuery(t,i,a,o){const u=i.collectionGroup;let d=Ll();return this.indexManager.getCollectionParents(t,u).next((m=>st.forEach(m,(p=>{const g=(function(w,T){return new Ro(T,null,w.explicitOrderBy.slice(),w.filters.slice(),w.limit,w.limitType,w.startAt,w.endAt)})(i,p.child(u));return this.getDocumentsMatchingCollectionQuery(t,g,a,o).next((v=>{v.forEach(((w,T)=>{d=d.insert(w,T)}))}))})).next((()=>d))))}getDocumentsMatchingCollectionQuery(t,i,a,o){let u;return this.documentOverlayCache.getOverlaysForCollection(t,i.path,a.largestBatchId).next((d=>(u=d,this.remoteDocumentCache.getDocumentsMatchingQuery(t,i,a,u,o)))).next((d=>{u.forEach(((p,g)=>{const v=g.getKey();d.get(v)===null&&(d=d.insert(v,sn.newInvalidDocument(v)))}));let m=Ll();return d.forEach(((p,g)=>{const v=u.get(p);v!==void 0&&Ql(v.mutation,g,jn.empty(),le.now()),Zh(i,g)&&(m=m.insert(p,g))})),m}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;function XC(){const[n,t]=St.useState(!1),i=St.useRef(null),a="/",o=zh();St.useEffect(()=>()=>{i.current&&clearTimeout(i.current)},[]);const u=()=>{const m=`${typeof window<"u"&&window.innerWidth<640?"projects":"showroom"}`;o(m)};return y.jsxs(LC,{"aria-label":"Hero",children:[y.jsxs($C,{children:[y.jsx(BC,{"aria-hidden":!0,children:y.jsx(FC,{autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata",children:y.jsx("source",{src:`${a}video/hero11.mp4`,type:"video/mp4"})})}),y.jsx(qC,{"aria-label":"Hero background video",children:y.jsxs(KC,{autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata",onLoadedData:()=>{i.current&&clearTimeout(i.current),i.current=setTimeout(()=>t(!0),13900)},children:[y.jsx("source",{src:`${a}video/hero11.mp4`,type:"video/mp4"}),"Your browser does not support the video tag."]})}),y.jsx(HC,{})]}),y.jsxs(GC,{$visible:n,children:[y.jsxs(d_,{children:["25. 10. 24. FRI~26. SUN",y.jsx("br",{}),"Hongdae Art Center B2"]}),y.jsx(d_,{children:"Department of Design Engineering"}),y.jsxs(YC,{children:["Tech University of Korea",y.jsx("br",{}),"20th Grad Exhibition"]})]}),y.jsxs(QC,{type:"button",onClick:u,"aria-label":"View More",children:[y.jsx("span",{className:"desktop",children:"View More"}),y.jsx("span",{className:"mobile",children:"View Work"})]}),y.jsx(qg,{position:"bottom",from:ar.heroToWhite.from,to:ar.heroToWhite.to,height:ar.heroToWhite.h,z:0})]})}const f_="/",WC=A.section`
  position: relative;
  z-index: 1;
  background: #FFFFFF;
  padding-top: 120px;
...
`;function bD({durationVh:n=300,center:t=!0,centerOffsetPx:i=0,children:a,style:o}){const u=St.useRef(null),[d,m]=St.useState(0);return St.useEffect(()=>{const p=u.current;if(!p)return;let g=0,v=!0;const w=()=>{if(!v)return;const T=p.getBoundingClientRect(),R=window.innerHeight,M=n/100*R-R,z=Math.min(Math.max(-T.top,0),M);m(M>0?z/M:0),g=requestAnimationFrame(w)};return g=requestAnimationFrame(w),()=>{v=!1,cancelAnimationFrame(g)}},[n]),y.jsx(_D,{ref:u,style:o,$durationVh:n,children:y.jsx(ED,{$center:t,children:y.jsx(wD,{$offset:i,children:typeof a=="function"?a(d):a})})})}const m_=[{id:"w1",index:"A010",artistKr:"송지원, 허지유",dept:"Industrial Design Engineering",titleSmall:"한국산업기술진흥원장상 수상",titleStrong:"BIND",rightMeta1:"Precision and efficency beyond human limits.",rightMeta2:"BIND, 흩어진 시간을 하나로 잇다.",image:"1127032149"},{id:"w2",index:"A017",artistKr:"이채연",dept:"Media Design Engineering",titleSmall:"총동문회장상 수상",titleStrong:"MUSE",rightMeta1:"디자인 논문을 쉽게 활용할 수 있도록 돕는",rightMeta2:"AI 인사이트 제공 서비스",image:"1127403683"},{id:"w3",index:"A011",artistKr:"정혜원, 신주혜",dept:"Industrial Design Engineering",titleSmall:"한국공학대학교총장상 수상",titleStrong:"ENDY",rightMeta1:"감정을 이해하고 반응하는 학습 파트너,",rightMeta2:"자기주도학습의 새로운 동반자 ENDY",image:"1126889031"}],TD=A.div`
  position: relative;
  background: #121212;
  @media (max-width: 640px) {
    background: #121212;
...
`,UD=A.iframe`
  ...
  display: block;
  margin-top: 16px;
`,zD=(n,t=0,i=1)=>Math.max(t,Math.min(i,n)),Xs=(n,t,i)=>n+(t-n)*i,LD=n=>n<.5?2*n*n:1-Math.pow(-2*n+2,2)/2;function $D({work:n,progress:t,videoId:i}){String(i||"").trim();const a=`https://player.vimeo.com/video/${n.image}?muted=1&autoplay=1&loop=1&badge=0&controls=0&autopause=0&title=0&byline=0&portrait=0&app_id=58479`,o=LD(zD(t,0,1)),u=Xs(0,-120,o),d=Xs(0,-360,o),m=Xs(0,-280,o),p=Xs(0,-220,o),g=Xs(0,-260,o),v=Xs(0,-180,o),w=.55,R=o<w?1:1-Math.max(0,Math.min(1,(o-w)/(.9-w))),M={transform:`translate3d(0, ${u}px, 0)`,willChange:"transform"},z=H=>({transform:`translate3d(0, ${H}px, 0)`,opacity:R,willChange:"transform, opacity"}),U={transform:`translate3d(0, ${v}px, 0)`,opacity:R,willChange:"transform, opacity"};return y.jsx(y.Fragment,{children:y.jsx(TD,{children:y.jsxs(ID,{children:[y.jsx(jD,{style:M,children:y.jsx(PD,{src:a,frameBorder:"0"})}),y.jsx(CD,{style:z(d),children:n.artistKr}),y.jsx(DD,{style:z(m),children:n.dept}),y.jsx(ND,{style:z(p),children:n.rightMeta1}),y.jsx(MD,{style:z(g),children:n.rightMeta2}),y.jsxs(OD,{style:U,children:[y.jsx(VD,{children:n.titleSmall}),y.jsx(kD,{children:n.titleStrong})]})]})})})}function BD(){return y.jsxs(y.Fragment,{children:[y.jsx("style",{children:`
        @media (max-width: 640px) {
...
`;function m5(){return y.jsx(ZD,{"aria-label":"Venue & Access",children:y.jsxs(e5,{children:[y.jsxs(y_,{title:"Venew Details",children:[y.jsx(h5,{children:y.jsx(d5,{children:"잔향 : 기억의 향기"})}),y.jsx(Qr,{k:"Term",children:y.jsx(Kt,{children:"2025. 10. 24. FRI - 10. 26. SUN"})}),y.jsxs(Qr,{k:"Hours",children:[y.jsx(Kt,{children:"10.24.FRI   13:00 ~ 17:30 (OPENING 16:00~)"}),y.jsx(Kt,{children:"10.25.SAT ~ 10.26.SUN    10:00 ~ 17:30"})]}),y.jsxs(Qr,{k:"Schedule",children:[y.jsx(th,{children:"10.24.FRI"}),y.jsx(Kt,{children:"13:00    자유관람"}),y.jsx(Kt,{children:"15:00    졸업생 홈커밍 행사"}),y.jsx(Kt,{children:"16:00    개회식"}),y.jsx(Kt,{children:"16:20    졸업작품 우수작 시상"}),y.jsx(Kt,{children:"16:30    자유관람"}),y.jsxs(th,{children:[y.jsx("br",{}),"10.25.SAT"]}),y.jsx(Kt,{children:"10:00    자유관람"}),y.jsx(Kt,{children:"13:00    취·창업 커리어 캠프"}),y.jsxs(th,{children:[y.jsx("br",{}),"10.26.SUN"]}),y.jsx(Kt,{children:"10:00    자유관람"})]}),y.jsxs(Qr,{k:"Website",divider:!1,children:[y.jsx(Kt,{children:"Hongik Art Center"}),y.jsx(p5,{href:"https://artscenter.hongik.ac.kr/artcenter/index.do",target:"_blank",rel:"noreferrer",children:"https://artscenter.hongik.ac.kr/artcenter/index.do"})]})]}),y.jsxs(y_,{title:"Access",children:[y.jsxs(Qr,{k:"Address",children:[y.jsxs(Kt,{children:["홍대 아트센터 지하 2층 전시관 3",y.jsx("br",{}),"서울시 종로구 대학로 57"]}),y.jsxs(Kt,{children:["Hongik Art Center B2 Gallery 3",y.jsx("br",{}),"57, Daehak-ro, Jongno-gu, Seoul"]}),y.jsx("div",{style:{marginTop:24},children:y.jsx(Kg,{as:"a",href:"https://maps.app.goo.gl/qc99M9bDqyBTcmx79",label:"Map",size:"sm",showArrow:!0})})]}),y.jsxs(Qr,{k:"Parking",children:[y.jsx(Kt,{children:"B3F ~ B6F"}),y.jsxs(Kt,{children:[y.jsx("br",{}),"기본 30분 3,000원 / 이후 20분당 2,000원"]}),y.jsx(Kt,{children:"이용객 주차권 지참 시 50% 할인 및 1시간 무료이용권 제공"}),y.jsx(th,{children:"(주차권으로만 정산 가능, 티켓정산 불가)"}),y.jsx(f5,{children:"주차권 배부 장소: B2 갤러리 3, 전시장 입구 인포데스크"})]}),y.jsxs(Qr,{k:"By Subway",children:[y.jsx(Kt,{children:"[1호선 종로5가역]"}),y.jsx(Kt,{children:"2번 출구 방면으로 이동 → 이화사거리 방면으로 약 800m 직진 (도보7분)"}),y.jsxs(Kt,{children:[y.jsx("br",{}),"[4호선 혜화역]"]}),y.jsx(Kt,{children:"3번 출구 방면으로 이동 → 이화사거리 방면으로 약 800m 직진 (도보7분)"}),y.jsx(Kt,{children:"또는 08번 마을버스 탑승 후 이화사거리 앞 하차"})]}),y.jsxs(Qr,{k:"By Bus",divider:!1,children:[y.jsx(Kt,{children:"[이화사거리(01-572) 하차]"}),y.jsx(Kt,{children:"마을버스 종로 08번"}),y.jsxs(Kt,{children:[y.jsx("br",{}),"[현대그룹빌딩(01-218) 하차]"]}),y.jsx(Kt,{children:"102, 107, 108, 109, 162, 301, 7025"}),y.jsxs(Kt,{children:[y.jsx("br",{}),"[이화장(01-223) 하차]"]}),y.jsx(Kt,{children:"109, 273, 601, 2112, 7025"})]})]})]})})}A.div`
  @media (max-width: 640px) {
...
`;function S5({to:n,from:t,message:i}){return y.jsxs(v5,{$w:yo,$h:es,children:[y.jsx(_5,{}),y.jsxs(E5,{$w:yo,$h:es,children:[y.jsx(w5,{children:`To. ${n}`}),y.jsx(b5,{children:i}),y.jsx(T5,{children:`From. ${t}`})]})]})}const A5=A.div`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
  overflow: hidden;
...
`,R5=A.img`
  ...
  object-fit: cover;
  display: block;
`;function I5({src:n}){return y.jsx(A5,{$w:yo,$h:es,children:y.jsx(R5,{src:n,alt:"포토 카드"})})}const j5=A.button`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
...
`;function V5({onClick:n}){return y.jsxs(j5,{onClick:n,"aria-label":"방명록 작성",$w:yo,$h:es,children:[y.jsx(C5,{$w:yo,$h:es}),y.jsx(D5,{children:y.jsxs(N5,{children:[y.jsx(M5,{}),y.jsx(O5,{})]})})]})}const yo=270,es=337,k5=30,bw=20,P5=210,U5=60,Tw=173,Sw=216,z5=16,L5=16,Nm=16,$5=A.div`
  padding: 0 0 12px 0;
  @media (max-width: 640px) {
    display: none;
  }
...
`;function jN(){const[n,t]=St.useState(!1),[i,a]=St.useState([]);St.useEffect(()=>{let d=!0;return(async()=>{try{const m=s_(gh(zp,"guest"),o_("time","desc")),p=await Cm(m);if(!d)return;const g=[];p.forEach(v=>{const w=v.data();g.push({id:v.id,to:w.to||"",from:w.from||"",message:w.message||"",type:"text"})}),a(g)}catch(m){console.error("Failed to load guestbook items:",m)}})(),()=>{d=!1}},[]);const o=async({to:d,from:m,message:p})=>{try{const g=String(Date.now());await Fg(Xl(gh(zp,"guest"),g),{to:d||"",from:m||"",message:p||"",time:g});try{const v=s_(gh(zp,"guest"),o_("time","desc")),w=await Cm(v),T=[];w.forEach(R=>{const M=R.data();T.push({id:R.id,to:M.to||"",from:M.from||"",message:M.message||"",type:"text"})}),a(T)}catch(v){console.error("Failed to reload guestbook items after submit:",v)}t(!1)}catch(g){console.error("Failed to submit guest message:",g)}};return y.jsxs(TN,{children:[y.jsxs(SN,{children:[y.jsx(AN,{children:"Guest Book"}),y.jsx(RN,{children:y.jsxs(IN,{className:"gb-wrap",children:[y.jsx("style",{children:`
  ...
  `}),y.jsx(Z5,{onOpenModal:()=>t(!0),items:i})]})})]}),y.jsx(_N,{open:n,onClose:()=>t(!1),onSubmit:o})]})}const Mm="/",CN=A.div`
  display: flex;
  position: sticky;
  top: 80px;
  bottom: 0px;
...
`;function Om({titleKor:n,titleEng:t,context:i,isOpen:a=!0,onClose:o,src:u,docId:d,collection:m="works"}){const[p,g]=B.useState(0),[v,w]=B.useState(!1);B.useEffect(()=>{let M=!0;return(async()=>{if(d!=null)try{const z=Xl(Wl,m,String(d)),U=await xh(z);if(!M)return;if(U.exists()){const H=U.data();g(typeof H.like=="number"?H.like:0)}else g(0)}catch(z){console.error("Firestore getDoc error:",z),M&&g(0)}})(),()=>{M=!1}},[d,m]);const T=async()=>{try{const M=Xl(Wl,m,String(d)),z=await xh(M);if(z.exists()){const U=z.data();g(typeof U.like=="number"?U.like:0)}}catch(M){console.error("Firestore refresh error:",M)}},R=async()=>{if(v)return;if(d==null){console.warn("handleLike called without a valid docId");return}w(!0);const M=Xl(Wl,m,String(d));try{await kh(M,{like:Ph(1)}),g(z=>z+1),await T()}catch(z){if(z.code==="not-found"||/No document/i.test(String(z)))try{(await xh(M)).exists()?await kh(M,{like:Ph(1)}):await Fg(M,{like:1},{merge:!0}),await T()}catch(U){console.error("Firestore like fallback error:",U)}else console.error("Firestore like error:",z)}finally{w(!1)}};return y.jsx(CN,{$open:!!a,children:y.jsxs(DN,{children:[y.jsxs(NN,{children:[y.jsx(MN,{onClick:()=>{typeof o=="function"&&o()},children:y.jsx("img",{src:`${Mm}icons/closeIcon.svg`,alt:"Close Icon"})}),y.jsxs(ON,{children:[y.jsx(PN,{$src:u}),y.jsx(VN,{children:n}),y.jsx(kN,{children:i})]})]}),y.jsxs(UN,{children:[y.jsx(zN,{onClick:R,"aria-disabled":v,title:v?"처리 중":"좋아요",children:y.jsxs(LN,{children:[y.jsx($N,{$src:`${Mm}icons/likeIcon(white).svg`,"aria-label":"Like icon"}),y.jsx(BN,{children:p})]})}),y.jsxs(FN,{onClick:()=>{const z=Math.max(document.documentElement?.scrollHeight||0,document.body?.scrollHeight||0)-window.innerHeight,H=Math.max(0,z-269);window.scrollTo({top:H,behavior:"smooth"})},children:[y.jsx(qN,{children:"Designer Info"}),y.jsx(KN,{})]})]})]})})}Om.propTypes={titleKor:J.string.isRequired,titleEng:J.string.isRequired,context:J.string.isRequired,isOpen:J.bool,onClose:J.func,docId:J.oneOfType([J.string,J.number]).isRequired,collection:J.string};const HN=A.div`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  letter-spacing: 0.24px;
  color: #202020;
  text-decoration: none;
...
`;function Gg({nameKor:n,nameEng:t,part:i,sns:a,eMail:o,imgUrl:u,imgAlt:d}){return y.jsxs(HN,{children:[y.jsx(GN,{children:y.jsx(YN,{src:u,alt:d})}),y.jsxs(QN,{children:[y.jsxs(XN,{children:[y.jsx(WN,{children:n}),y.jsx(ZN,{children:t})]}),y.jsxs(JN,{children:[y.jsxs(t9,{children:[y.jsx(Lp,{children:"Part"}),y.jsx(Lp,{children:"SNS"}),y.jsx(Lp,{children:"E-mail"})]}),y.jsxs(e9,{children:[y.jsx($p,{children:i}),y.jsx($p,{children:a}),y.jsx($p,{children:o})]})]})]})]})}Gg.propTypes={nameKor:J.string.isRequired,nameEng:J.string.isRequired,part:J.string,sns:J.string,eMail:J.string,imgUrl:J.string.isRequired,imgAlt:J.string.isRequired};Gg.defaultProps={sns:"N/A",eMail:"N/A"};const n9=A.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  width: 775px;
...
`;function __({designers:n}){return y.jsxs(n9,{children:[y.jsx(r9,{children:"Designer"}),y.jsx(i9,{children:n.map((t,i)=>y.jsx(Gg,{nameKor:t.nameKor,nameEng:t.nameEng,part:t.role,sns:t.sns,eMail:t.eMail,imgUrl:t.imgUrl},i))})]})}const a9=A.div`
    width: 100%; // 임시값
    margin-top: 50px;
...
`,h9=A.div`
    ...
    width: 40px;
    height: 40px;
`;function d9({isOpen:n=!1,onClick:t}){const[i,a]=B.useState(!1);return B.useEffect(()=>{let o;return n?a(!1):(a(!1),o=setTimeout(()=>{a(!0)},500)),()=>clearTimeout(o)},[n]),y.jsx(c9,{$visible:!n,$active:i,onClick:()=>{typeof t=="function"&&t()},children:y.jsx(h9,{children:y.jsx("img",{src:`${u9}icons/infoOpenIcon.svg`,alt:"작품 정보 열기"})})})}function eh(n){if(!n)return n;const t="/";if(/^https?:\/\//i.test(n))return n;const i=String(n).replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const f9=A.img`
  width: 100%;
  /* max-width: 1800px; */
  /* padding: 0px 100px; */
  /* padding-right: 100px; */
...
`,Bp=n=>y.jsx(f9,{loading:"lazy",...n}),p9=A.div`
  display: flex;
  position: relative;
  background: #fff;
  width: 100%;
...
`,y9=A.div`
  ...
  height: auto;
  /* max-width: 1800px; */
`,x9={A:"c0",E:"c1",H:"c2",I:"c3",L:"c4",M:"c5"};function v9(){const{pid:n}=VT(),t=(n||"").toUpperCase().match(/^([A-Z])(\d{3})$/),[i,a]=B.useState(!0),[o,u]=B.useState(!0),d=()=>{a(!1),setTimeout(()=>{u(!1)},500)},m=()=>{u(!0),setTimeout(()=>{a(!0)},0)};let p=null;if(t){const[,H,F]=t,Z=x9[H]||null,ot=Math.max(0,parseInt(F,10)-1);p=eu.find(W=>W.projectNum===ot&&(!Z||W.category===Z)),p||(p=eu.find(W=>W.projectNum==ot))}if(!p)return y.jsx(E_,{children:y.jsxs(PageContainer,{children:[y.jsx(Om,{titleKor:"작품 제목(한글)",titleEng:"Work Title (English)",context:"이곳은 작품 설명이 들어가는 영역입니다. 작품에 대한 상세한 설명이나 배경, 제작 과정 등을 기술할 수 있습니다. 이 텍스트는 예시로 작성된 내용이며, 실제 작품 설명으로 대체되어야 합니다.",isOpen:i,onClose:()=>a(!1),docId:0}),y.jsx(Bp,{src:"https://placehold.co/1530x4000",alt:"featured"}),y.jsx(__,{children:"  "})]})});const g=(p.members||[]).map(H=>{const F=eg.find(Z=>Z.num===H);return F?{nameKor:F.nameKor,nameEng:F.nameEng,role:F.role||"Designer",sns:F.sns||"-",eMail:F.eMail||"",imgUrl:eh(F.imgUrl||"/김예준.jpg")}:null}).filter(Boolean),w={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"}[p.category]||"A",T=p.projectNum??p.num,R=String(T).padStart(3,"0"),M=`/projects/${T}`,[z,U]=B.useState([]);return B.useEffect(()=>{let H=!1;const F=["jpg"],Z=30,ot=2,W=I=>!I||!I.ok?!1:(I.headers.get("content-type")||"").startsWith("image/"),ut=async I=>{try{const j=await fetch(I,{method:"GET",cache:"no-store"});return W(j)}catch{return!1}};return(async()=>{const I=[];let j=0;for(let C=0;C<Z;C++){let O=!1;for(const V of F){const L=eh(`${M}/gallery/${C}.${V}`);if(await ut(L)){I.push(L),O=!0,j=0;break}}if(!O&&(I.length===0||(j+=1,j>=ot)))break}H||U(I)})(),()=>{H=!0}},[M]),B.useEffect(()=>{const H=p?.projectNum??p?.num;if(H==null)return;const Z=Xl(Wl,"works",String(H));(async()=>{try{await kh(Z,{view:Ph(1)})}catch(ot){if(ot.code==="not-found"||/No document/i.test(String(ot)))try{(await xh(Z)).exists()?await kh(Z,{view:Ph(1)}):await Fg(Z,{view:1},{merge:!0})}catch(W){console.error("Firestore view fallback error:",W)}else console.error("Firestore view error:",ot)}})()},[p?.projectNum,p?.num]),y.jsx(E_,{children:y.jsxs(p9,{children:[y.jsx(d9,{isOpen:i,onClick:m}),y.jsx(g9,{$visible:o,children:y.jsx(Om,{titleKor:p.titleKor,titleEng:p.titleEng,context:p.description||"null",isOpen:i,onClose:d,src:eh(`/projects/${T}/thumb.jpg`),docId:T})}),y.jsxs(m9,{$isInfoOpen:i,children:[z.length>0?z.map((H,F)=>y.jsx(Bp,{src:H,alt:`project-${w}${R}-img-${F+1}`},F)):y.jsx(Bp,{src:eh("/thumbnailExample.png"),alt:`project-${w}${R}-placeholder`}),y.jsx(l9,{videoId:p.videoId,isInfoOpen:i}),y.jsx(y9,{children:y.jsx(__,{designers:g})})]})]})})}const w_="/",_9=k4`
...
`,w9=A.div`
    animation: ${({$visible:n,$floatDur:t})=>n?Ym`${_9} ${t??1800}ms ease-in-out infinite alternate`:"none"};
...
`,b_=A.div`
    ...
    background-repeat: no-repeat;
    background-position: center;
`;function b9({visible:n=!0,fadeMs:t=800,floatDur:i=1800,amp:a=6}={}){return y.jsxs(E9,{$visible:n,$fadeMs:t,"aria-hidden":!n,children:[y.jsx(b_,{src:`${w_}icons/showIndicatorMouse.svg`}),y.jsx(w9,{$visible:n,$floatDur:i,style:{"--amp":`${a}px`},children:y.jsx(b_,{src:`${w_}icons/showIndicatorDown.svg`})})]})}const Fp=A.div`
    z-index: 5;
    display: flex;
    position: absolute;
    flex-direction: row;
...
`,S9=A.p`
    ...
    text-align: justify;
    margin: 0;
`;function qp({children:n,textWidth:t,textHeight:i,shown:a,tDur:o,tDelay:u,ease:d}){return y.jsx(T9,{$textWidth:t,$textHeight:i,$shown:a,$tDur:o,$tDelay:u,$ease:d,children:y.jsx(S9,{children:n})})}function A9({top:n,left:t,right:i="auto",bottom:a,lineWidth:o,textWidth:u,textHeight:d,children:m,position:p="left",isActive:g,section:v,currentSection:w,anim:T={circle:{duration:250,delay:120,easing:"cubic-bezier(0.22,1,0.36,1)"},line:{duration:500,delay:120,easing:"cubic-bezier(0.22,1,0.36,1)"},text:{duration:280,delay:80,easing:"cubic-bezier(0.22,1,0.36,1)"}}}){const[R,M]=B.useState(!1),z=T?.circle?.easing||T?.line?.easing||T?.text?.easing||"cubic-bezier(0.22,1,0.36,1)",U=T?.circle?.duration??250,H=T?.circle?.delay??120,F=T?.line?.duration??500,Z=H+U+(T?.line?.delay??120),ot=T?.text?.duration??280,W=Z+F+(T?.text?.delay??80),I=g||R&&w===v;if(B.useEffect(()=>{g&&!R&&M(!0)},[g,R]),p==="right")return y.jsxs(Fp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsx(qp,{textWidth:u,textHeight:d,shown:I,tDur:ot,tDelay:W,ease:z,children:m}),y.jsxs(R_,{children:[y.jsx(A_,{$lineWidth:o,$shown:I,$lDur:F,$lDelay:Z,$ease:z}),y.jsx(T_,{$shown:I,$cDur:U,$cDelay:H,$ease:z,children:y.jsx(S_,{$shown:I,$cDur:U,$cDelay:H,$ease:z})})]})]});if(p==="left")return y.jsxs(Fp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsxs(R_,{children:[y.jsx(T_,{$shown:I,$cDur:U,$cDelay:H,$ease:z,children:y.jsx(S_,{$shown:I,$cDur:U,$cDelay:H,$ease:z})}),y.jsx(A_,{$lineWidth:o,$shown:I,$lDur:F,$lDelay:Z,$ease:z})]}),y.jsx(qp,{textWidth:u,textHeight:d,shown:I,tDur:ot,tDelay:W,ease:z,children:m})]});if(p==="no-line")return y.jsx(Fp,{$top:n,$left:t,$right:i,$bottom:a,children:y.jsx(qp,{textWidth:u,textHeight:d,shown:I,tDur:ot,tDelay:W,ease:z,children:m})})}const Kp="/",R9=A.div`
    display: flex;
    position: relative;
    margin-top: 80px;
    width: 100vw;
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var I_;function D9(){return I_||(I_=1,(function(n){function t(tt,dt){var yt=tt.length;tt.push(dt);t:for(;0<yt;){var jt=yt-1>>>1,k=tt[jt];if(0<o(k,dt))tt[jt]=dt,tt[yt]=k,yt=jt;else break t}}function i(tt){return tt.length===0?null:tt[0]}function a(tt){if(tt.length===0)return null;var dt=tt[0],yt=tt.pop();if(yt!==dt){tt[0]=yt;t:for(var jt=0,k=tt.length,at=k>>>1;jt<at;){var ct=2*(jt+1)-1,ht=tt[ct],gt=ct+1,Ct=tt[gt];if(0>o(ht,yt))gt<k&&0>o(Ct,ht)?(tt[jt]=Ct,tt[gt]=yt,jt=gt):(tt[jt]=ht,tt[ct]=yt,jt=ct);else if(gt<k&&0>o(Ct,yt))tt[jt]=Ct,tt[gt]=yt,jt=gt;else break t}}return dt}function o(tt,dt){var yt=tt.sortIndex-dt.sortIndex;return yt!==0?yt:tt.id-dt.id}if(n.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;n.unstable_now=function(){return u.now()}}else{var d=Date,m=d.now();n.unstable_now=function(){return d.now()-m}}var p=[],g=[],v=1,w=null,T=3,R=!1,M=!1,z=!1,U=!1,H=typeof setTimeout=="function"?setTimeout:null,F=typeof clearTimeout=="function"?clearTimeout:null,Z=typeof setImmediate<"u"?setImmediate:null;function ot(tt){for(var dt=i(g);dt!==null;){if(dt.callback===null)a(g);else if(dt.startTime<=tt)a(g),dt.sortIndex=dt.expirationTime,t(p,dt);else break;dt=i(g)}}function W(tt){if(z=!1,ot(tt),!M)if(i(p)!==null)M=!0,ut||(ut=!0,L());else{var dt=i(g);dt!==null&&ne(W,dt.startTime-tt)}}var ut=!1,I=-1,j=5,C=-1;function O(){return U?!0:!(n.unstable_now()-C<j)}function V(){if(U=!1,ut){var tt=n.unstable_now();C=tt;var dt=!0;try{t:{M=!1,z&&(z=!1,F(I),I=-1),R=!0;var yt=T;try{e:{for(ot(tt),w=i(p);w!==null&&!(w.expirationTime>tt&&O());){var jt=w.callback;if(typeof jt=="function"){w.callback=null,T=w.priorityLevel;var k=jt(w.expirationTime<=tt);if(tt=n.unstable_now(),typeof k=="function"){w.callback=k,ot(tt),dt=!0;break e}w===i(p)&&a(p),ot(tt)}else a(p);w=i(p)}if(w!==null)dt=!0;else{var at=i(g);at!==null&&ne(W,at.startTime-tt),dt=!1}}break t}finally{w=null,T=yt,R=!1}dt=void 0}}finally{dt?L():ut=!1}}}var L;if(typeof Z=="function")L=function(){Z(V)};else if(typeof MessageChannel<"u"){var N=new MessageChannel,ue=N.port2;N.port1.onmessage=V,L=function(){ue.postMessage(null)}}else L=function(){H(V,0)};function ne(tt,dt){I=H(function(){tt(n.unstable_now())},dt)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(tt){tt.callback=null},n.unstable_forceFrameRate=function(tt){0>tt||125<tt?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<tt?Math.floor(1e3/tt):5},n.unstable_getCurrentPriorityLevel=function(){return T},n.unstable_next=function(tt){switch(T){case 1:case 2:case 3:var dt=3;break;default:dt=T}var yt=T;T=dt;try{return tt()}finally{T=yt}},n.unstable_requestPaint=function(){U=!0},n.unstable_runWithPriority=function(tt,dt){switch(tt){case 1:case 2:case 3:case 4:case 5:break;default:tt=3}var yt=T;T=tt;try{return dt()}finally{T=yt}},n.unstable_scheduleCallback=function(tt,dt,yt){var jt=n.unstable_now();switch(typeof yt=="object"&&yt!==null?(yt=yt.delay,yt=typeof yt=="number"&&0<yt?jt+yt:jt):yt=jt,tt){case 1:var k=-1;break;case 2:k=250;break;case 5:k=1073741823;break;case 4:k=1e4;break;default:k=5e3}return k=yt+k,tt={id:v++,callback:dt,priorityLevel:tt,startTime:yt,expirationTime:k,sortIndex:-1},yt>jt?(tt.sortIndex=yt,t(g,tt),i(p)===null&&tt===i(g)&&(z?(F(I),I=-1):z=!0,ne(W,yt-jt))):(tt.sortIndex=k,t(p,tt),M||R||(M=!0,ut||(ut=!0,L()))),tt},n.unstable_shouldYield=O,n.unstable_wrapCallback=function(tt){var dt=T;return function(){var yt=T;T=dt;try{return tt.apply(this,arguments)}finally{T=yt}}}})(Qp)),Qp}var j_;function N9(){return j_||(j_=1,Yp.exports=D9()),Yp.exports}/**
 * @license React
