 ...
 */var ox;function eT(){if(ox)return Ml;ox=1;var n=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(a,o,u){var d=null;if(u!==void 0&&(d=""+u),o.key!==void 0&&(d=""+o.key),"key"in o){u={};for(var m in o)m!=="key"&&(u[m]=o[m])}else u=o;return o=u.ref,{$$typeof:n,type:a,key:d,ref:o!==void 0?o:null,props:u}}return Ml.Fragment=t,Ml.jsx=i,Ml.jsxs=i,Ml}var lx;function nT(){return lx||(lx=1,cp.exports=eT()),cp.exports}var y=nT(),hp={exports:{}},Dt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`;function E2({items:n=[],activeKey:t,mode:i,onModeChange:a,autoOnScroll:o=!1,scrollThreshold:u=8,sticky:d=!0,maxWidth:m,overlay:p=!1}){const[g,v]=B.useState(!1),[w,T]=B.useState(he.GRADIENT),R=typeof i=="string",M=R?i:w,L=B.useRef(R?i:w);B.useEffect(()=>{L.current=R?i:w},[i,w,R]),B.useEffect(()=>{if(!o)return;const O=()=>{const k=window.scrollY||document.documentElement.scrollTop||0,z=R?i:L.current||he.GRADIENT_DARK,D=k>u?he.DARK:z;R||T(D),a&&a(D)};return O(),window.addEventListener("scroll",O,{passive:!0}),()=>window.removeEventListener("scroll",O)},[o,R,a,u,i]);const{baseColor:U,gradient:K,textColor:X,boxShadow:tt,showGradient:lt}=B.useMemo(()=>{switch(M){case he.LIGHT:return{baseColor:"linear-gradient(180deg, rgba(255,255,255,0.8) 60%, rgba(255,255,255,0) 100%)",gradient:"rgba(255,255,255,1)",textColor:"#000",showGradient:!0};case he.DARK:return{baseColor:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,0) 100%)",gradient:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,1) 100%)",textColor:"#fff",showGradient:!0};case he.GRADIENT_DARK:return{baseColor:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,0) 100%)",gradient:"linear-gradient(180deg, rgba(18,18,18,1) 0%, rgba(18,18,18,1) 100%)",textColor:"#fff",showGradient:!1};default:return{baseColor:"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0) 100%)",gradient:"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0) 100%)",textColor:"#000",showGradient:!1}}},[M]),j=M===he.DARK||M===he.GRADIENT_DARK||g,I=j?"/icons/logoLight.svg":"/icons/logoDark.svg",C=n.filter(O=>O.label!=="SHOWROOM");return B.useEffect(()=>(g?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[g]),y.jsxs(U4,{role:"banner",$sticky:d,$overlay:p,$baseColor:U,$gradient:K,$showGradient:lt,$textColor:X,$boxShadow:tt,children:[y.jsx(L4,{$maxWidth:m,children:y.jsxs(z4,{children:[y.jsxs($4,{children:[y.jsx(es,{to:"/","aria-label":"홈으로",style:{color:"inherit",textDecoration:"none"},children:y.jsx(G4,{"aria-hidden":!0,children:y.jsx(Y4,{children:y.jsx("div",{style:{backgroundImage:`url(${I})`,width:"100%",height:"100%",backgroundSize:"contain",backgroundRepeat:"no-repeat"}})})})}),y.jsx(B4,{"aria-label":"주 메뉴",children:n.map(O=>y.jsx(Xm,{label:O.label,href:O.href,active:O.key===t},O.key))})]}),y.jsx(F4,{"aria-label":g?"메뉴 닫기":"메뉴 열기",onClick:()=>v(O=>!O),children:y.jsx(P4,{isOpen:g,size:24,color:j?"#fff":"#000"})})]})}),y.jsx(q4,{$open:g,onClick:()=>v(!1),children:y.jsx(K4,{onClick:O=>O.stopPropagation(),children:C.map(O=>y.jsx(H4,{label:O.label,href:O.href,active:O.key===t,style:{fontSize:18,fontWeight:500,color:"#fff",textAlign:"center"},onClick:()=>v(!1)},O.key))})})]})}E2.propTypes={items:Z.arrayOf(Z.shape({key:Z.string.isRequired,label:Z.string.isRequired,href:Z.string})),activeKey:Z.string,mode:Z.oneOf([he.GRADIENT,he.LIGHT,he.DARK,he.GRADIENT_DARK]),onModeChange:Z.func,autoOnScroll:Z.bool,scrollThreshold:Z.number,sticky:Z.bool,overlay:Z.bool,maxWidth:Z.oneOfType([Z.string,Z.number])};const Wm="Pretendard, system-ui, -apple-system, Segoe UI, Roboto, 'Noto Sans KR', Arial, sans-serif",Q4=S.footer`
  width: 100vw;
  background: #0E0E0E;
...
`,nA=S.div`
  ...
  width: 100%;
  align-items: center;
`;function Px({children:n}){return y.jsx(eA,{children:y.jsx(nA,{children:n})})}const iA=S.div`
...
`;function hA({text:n}){return y.jsxs(oA,{children:[y.jsx(b2,{}),y.jsx(lA,{}),y.jsx(sA,{dangerouslySetInnerHTML:{__html:n}})]})}const dA=S.div`
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  gap: 46px;
...
`;function _A({blocks:n}){return y.jsxs(gA,{children:[y.jsx(b2,{}),n.map(t=>y.jsxs(yA,{children:[y.jsx(xA,{children:t.title}),y.jsx(vA,{dangerouslySetInnerHTML:{__html:t.body}})]},t.title))]})}const EA=S.div`
...
`;function om({path:n="student",isActive:t=!1,onClick:i}){return y.jsxs(BA,{onClick:i,children:[y.jsx(T2,{$active:t,children:"교수"}),y.jsx(qA,{$active:t,children:"학생"}),y.jsx(FA,{$active:t})]})}om.propTypes={path:Z.oneOf(["student","professor"]),isActive:Z.bool,onClick:Z.func};const Lx=S.a`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  font-size: 24px;
  line-height: 28.8px;
  letter-spacing: 0.24px;
...
`;function R2({options:n,onSelect:t,style:i,isOpen:a,position:o,selected:u}){return y.jsx(GA,{style:i,$open:a,children:n.map((d,m)=>y.jsx(YA,{onClick:()=>t(d),children:y.jsx(QA,{$selected:d===u,children:d})},m))})}R2.propTypes={options:Z.arrayOf(Z.string).isRequired,onSelect:Z.func.isRequired,style:Z.object,isOpen:Z.bool,position:Z.any,selected:Z.string};const XA=S.div`
  position: relative;
`;function tg({label:n,options:t,onSelect:i,style:a,filter:o,mode:u}){const[d,m]=St.useState(!1),[p,g]=St.useState({top:0,left:0}),v=St.useRef(null),w=()=>{if(v.current){const R=v.current.getBoundingClientRect();g({top:R.bottom+window.scrollY,left:R.left+window.scrollX})}m(R=>!R)},T=R=>{i&&i(R),m(!1)};return y.jsxs(XA,{ref:v,style:a,children:[y.jsx("div",{onClick:w,children:y.jsx(Jm,{label:n,options:t,onSelect:i,style:{},filter:o,mode:u})}),y.jsx(R2,{options:t,onSelect:T,style:{},isOpen:d,position:p,selected:n})]})}tg.propTypes={label:Z.string.isRequired,options:Z.arrayOf(Z.string).isRequired,onSelect:Z.func.isRequired,style:Z.object,filter:Z.string};tg.defaultProps={style:{},filter:""};const WA=S.div`
    /* display: ${n=>n.$open?"flex":"none"}; */
    display: flex;
    flex-direction: column;
    justify-content: flex-start;
...
`;function I2({options:n,isOpen:t,onSelect:i,selected:a}){return y.jsx(WA,{$open:t,children:y.jsx(ZA,{$open:t,children:n.map((o,u)=>y.jsx(JA,{$selected:a===o,onClick:()=>i(o),children:o},u))})})}I2.propTypes={options:Z.arrayOf(Z.string).isRequired,isOpen:Z.bool.isRequired,onSelect:Z.func.isRequired,selected:Z.oneOfType([Z.string,Z.number])};const tR=S.div`
    position: relative;
    // 안에 들어가는 요소들 왼쪽 정렬
    display: flex;
    flex-direction: row;
    justify-content: flex-start;
`;function Fl({label:n,options:t,onSelect:i,style:a,mode:o}){const[u,d]=St.useState(!1),m=St.useRef(null),p=()=>{d(v=>!v)},g=v=>{i&&i(v),d(!1)};return y.jsxs(tR,{ref:m,style:a,children:[y.jsx("div",{onClick:p,children:y.jsx(Jm,{label:n,mode:o})}),y.jsx(I2,{options:t,onSelect:g,isOpen:u,selected:n})]})}Fl.propTypes={label:Z.string.isRequired,options:Z.arrayOf(Z.string).isRequired,onSelect:Z.func.isRequired,style:Z.object,mode:Z.string};Fl.defaultProps={style:{},mode:"category"};const bp=S.div`
  display: flex;
  justify-content: space-between;
  width: auto;
  padding-left: 40px;
...
`,mR=S.div`position: relative;`;function gR({people:n}){const t=zh();return y.jsx(dR,{children:n.map((i,a)=>{const o=i.id??i.studentId??`${i.nameKor}-${a}`,u=typeof i.projectNum=="number"&&i.category,d=u?i.projectNum+1:null,m=u?`${oR[i.category]||"A"}${String(d).padStart(3,"0")}`:null,p=y.jsx(Zm,{nameKor:i.nameKor,nameEng:i.nameEng,role:i.role,sns:i.sns||"-",eMail:i.eMail,imgSrc:C2(i.imgUrl),imgAlt:`${i.nameKor} profile`},o);return u?y.jsx(pR,{role:"link",tabIndex:0,onClick:()=>t(`/work/${m}`),onKeyDown:g=>{(g.key==="Enter"||g.key===" ")&&t(`/work/${m}`)},"aria-label":`${i.nameKor} 작품 보기 (${m})`,children:p},`link-${o}`):p})})}function yR(){const[n,t]=St.useState(!1),[i,a]=St.useState(qx[0]),o=St.useMemo(()=>{const m=new Map;return(tu||[]).forEach(p=>{(p.members||[]).forEach(g=>{m.has(g)||m.set(g,p)})}),m},[]);St.useEffect(()=>{a(n?Vl[0]?.id||"":qx[0])},[n]);const u=St.useMemo(()=>{if(!n){if(i==="전체")return Rp;let p=lR[i];return p===void 0&&(p=Kx(i)),Rp.filter(g=>Kx(g.department)===p)}const m=Vl.some(p=>p.id===i)?i:Vl.find(p=>p.nameKor===i)?.id||"";return Rp.filter(p=>p.professorId===m).map(p=>{let g=o.get(p.num);g||(g=(tu||[]).find(w=>w.category===p.category&&w.projectNum===p.projectNum)||null);const v=g?`/projects/${g.projectNum}/thumb.jpg`:"/thumbnailExample.png";return{...p,imgUrl:v}})},[i,n,o]),d=St.useMemo(()=>n&&(Vl.find(p=>p.id===i)||Vl.find(p=>p.nameKor===i))||null,[n,i]);return y.jsxs(mR,{children:[y.jsx(fR,{children:"Peoples"}),y.jsx(j2,{type:"people",onCategoryChange:a,onToggleChange:t}),y.jsxs(hR,{children:[n&&d&&y.jsx(eg,{nameKor:d.nameKor,rank:d.rank||"교수",eMail:d.email,education:d.education,field:d.field,imgSrc:C2(d.imgUrl),imgAlt:`${d.nameKor} profile`}),y.jsx(gR,{people:u})]})]})}const Hx=S.div`
  @media (max-width: 393px) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PR=()=>kR().__FIREBASE_DEFAULTS__,UR=()=>{if(typeof process>"u"||typeof Zx>"u")return;const n=Zx.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},LR=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=n&&VR(n[1]);return t&&JSON.parse(t)},rg=()=>{try{return DR()||PR()||UR()||LR()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},zR=n=>rg()?.emulatorHosts?.[n],$R=n=>{const t=zR(n);if(!t)return;const i=t.lastIndexOf(":");if(i<=0||i+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const a=parseInt(t.substring(i+1),10);return t[0]==="["?[t.substring(1,i-1),a]:[t.substring(0,i),a]},M2=()=>rg()?.config;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JR="FirebaseError";class wo extends Error{constructor(t,i,a){super(i),this.code=t,this.customData=a,this.name=JR,Object.setPrototypeOf(this,wo.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,O2.prototype.create)}}class O2{constructor(t,i,a){this.service=t,this.serviceName=i,this.errors=a}create(t,...i){const a=i[0]||{},o=`${this.service}/${t}`,u=this.errors[t],d=u?t6(u,a):"Error",m=`${this.serviceName}: ${d} (${o}).`;return new wo(o,m,a)}}function t6(n,t){return n.replace(e6,(i,a)=>{const o=t[a];return o!=null?String(o):`<${a}?>`})}const e6=/\{\$([^}]+)}/g;function Sh(n,t){if(n===t)return!0;const i=Object.keys(n),a=Object.keys(t);for(const o of i){if(!a.includes(o))return!1;const u=n[o],d=t[o];if(tv(u)&&tv(d)){if(!Sh(u,d))return!1}else if(u!==d)return!1}for(const o of a)if(!i.includes(o))return!1;return!0}function tv(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(n){return n&&n._delegate?n._delegate:n}class eu{constructor(t,i,a){this.name=t,this.instanceFactory=i,this.type=a,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class E6{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(i=>{if(w6(i)){const a=i.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(i=>i).join(" ")}}function w6(n){return n.getComponent()?.type==="VERSION"}const cm="@firebase/app",rv="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hm="[DEFAULT]",X6={[cm]:"fire-core",[b6]:"fire-core-compat",[S6]:"fire-analytics",[T6]:"fire-analytics-compat",[R6]:"fire-app-check",[A6]:"fire-app-check-compat",[I6]:"fire-auth",[j6]:"fire-auth-compat",[C6]:"fire-rtdb",[D6]:"fire-data-connect",[N6]:"fire-rtdb-compat",[M6]:"fire-fn",[O6]:"fire-fn-compat",[V6]:"fire-iid",[k6]:"fire-iid-compat",[P6]:"fire-fcm",[U6]:"fire-fcm-compat",[L6]:"fire-perf",[z6]:"fire-perf-compat",[$6]:"fire-rc",[B6]:"fire-rc-compat",[F6]:"fire-gcs",[q6]:"fire-gcs-compat",[K6]:"fire-fst",[G6]:"fire-fst-compat",[H6]:"fire-vertex","fire-js":"fire-js",[Y6]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nI=Q6;function og(n,t={}){let i=n;typeof t!="object"&&(t={name:t});const a={name:hm,automaticDataCollectionEnabled:!0,...t},o=a.name;if(typeof o!="string"||!o)throw Zr.create("bad-app-name",{appName:String(o)});if(i||(i=M2()),!i)throw Zr.create("no-options");const u=nu.get(o);if(u){if(Sh(i,u.options)&&Sh(a,u.config))return u;throw Zr.create("duplicate-app",{appName:o})}const d=new a6(o);for(const p of dm.values())d.addComponent(p);const m=new eI(i,a,d);return nu.set(o,m),m}function iI(n=hm){const t=nu.get(n);if(!t&&n===hm&&M2())return og();if(!t)throw Zr.create("no-app",{appName:n});return t}function sv(){return Array.from(nu.values())}function no(n,t,i){let a=X6[n]??n;i&&(a+=`-${i}`);const o=a.match(/\s|\//),u=t.match(/\s|\//);if(o||u){const d=[`Unable to register library "${a}" with version "${t}":`];o&&d.push(`library name "${a}" contains illegal characters (whitespace or "/")`),o&&u&&d.push("and"),u&&d.push(`version name "${t}" contains illegal characters (whitespace or "/")`),or.warn(d.join(" "));return}Ah(new eu(`${a}-version`,()=>({library:a,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rI="firebase-heartbeat-database",aI=1,iu="firebase-heartbeat-store";let Dp=null;function U2(){return Dp||(Dp=x6(rI,aI,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(iu)}catch(i){console.warn(i)}}}}).catch(n=>{throw Zr.create("idb-open",{originalErrorMessage:n.message})})),Dp}async function sI(n){try{const i=(await U2()).transaction(iu),a=await i.objectStore(iu).get(L2(n));return await i.done,a}catch(t){if(t instanceof wo)or.warn(t.message);else{const i=Zr.create("idb-get",{originalErrorMessage:t?.message});or.warn(i.message)}}}async function ov(n,t){try{const a=(await U2()).transaction(iu,"readwrite");await a.objectStore(iu).put(t,L2(n)),await a.done}catch(i){if(i instanceof wo)or.warn(i.message);else{const a=Zr.create("idb-set",{originalErrorMessage:i?.message});or.warn(a.message)}}}function L2(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oI=1024,lI=30;class uI{constructor(t){this.container=t,this._heartbeatsCache=null;const i=this.container.getProvider("app").getImmediate();this._storage=new hI(i),this._heartbeatsCachePromise=this._storage.read().then(a=>(this._heartbeatsCache=a,a))}async triggerHeartbeat(){try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),a=lv();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===a||this._heartbeatsCache.heartbeats.some(o=>o.date===a))return;if(this._heartbeatsCache.heartbeats.push({date:a,agent:i}),this._heartbeatsCache.heartbeats.length>lI){const o=dI(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(t){or.warn(t)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=lv(),{heartbeatsToSend:i,unsentEntries:a}=cI(this._heartbeatsCache.heartbeats),o=Th(JSON.stringify({version:2,heartbeats:i}));return this._heartbeatsCache.lastSentHeartbeatDate=t,a.length>0?(this._heartbeatsCache.heartbeats=a,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(t){return or.warn(t),""}}}function lv(){return new Date().toISOString().substring(0,10)}function cI(n,t=oI){const i=[];let a=n.slice();for(const o of n){const u=i.find(d=>d.agent===o.agent);if(u){if(u.dates.push(o.date),uv(i)>t){u.dates.pop();break}}else if(i.push({agent:o.agent,dates:[o.date]}),uv(i)>t){i.pop();break}a=a.slice(1)}return{heartbeatsToSend:i,unsentEntries:a}}class hI{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return WR()?ZR().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const i=await sI(this.app);return i?.heartbeats?i:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){if(await this._canUseIndexedDBPromise){const a=await this.read();return ov(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??a.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){if(await this._canUseIndexedDBPromise){const a=await this.read();return ov(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??a.lastSentHeartbeatDate,heartbeats:[...a.heartbeats,...t.heartbeats]})}else return}}function uv(n){return Th(JSON.stringify({version:2,heartbeats:n})).length}function dI(n){if(n.length===0)return-1;let t=0,i=n[0].date;for(let a=1;a<n.length;a++)n[a].date<i&&(i=n[a].date,t=a);return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fI(n){Ah(new eu("platform-logger",t=>new E6(t),"PRIVATE")),Ah(new eu("heartbeat",t=>new uI(t),"PRIVATE")),no(cm,rv,n),no(cm,rv,"esm2020"),no("fire-js","")}fI("");var pI="firebase",mI="12.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */no(pI,mI,"app");var cv=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Za=new V2("@firebase/firestore");function Ws(){return Za.logLevel}function pt(n,...t){if(Za.logLevel<=Bt.DEBUG){const i=t.map(lg);Za.debug(`Firestore (${bo}): ${n}`,...i)}}function lr(n,...t){if(Za.logLevel<=Bt.ERROR){const i=t.map(lg);Za.error(`Firestore (${bo}): ${n}`,...i)}}function co(n,...t){if(Za.logLevel<=Bt.WARN){const i=t.map(lg);Za.warn(`Firestore (${bo}): ${n}`,...i)}}function lg(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const it={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class ft extends wo{constructor(t,i){super(t,i),this.code=t,this.message=i,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ru=-1;function RI(n,t){const i=n.toTimestamp().seconds,a=n.toTimestamp().nanoseconds+1,o=At.fromTimestamp(a===1e9?new ue(i+1,0):new ue(i,a));return new ea(o,vt.empty(),t)}function II(n){return new ea(n.readTime,n.key,ru)}class ea{constructor(t,i,a){this.readTime=t,this.documentKey=i,this.largestBatchId=a}static min(){return new ea(At.min(),vt.empty(),ru)}static max(){return new ea(At.max(),vt.empty(),ru)}}function jI(n,t){let i=n.readTime.compareTo(t.readTime);return i!==0?i:(i=vt.comparator(n.documentKey,t.documentKey),i!==0?i:Pt(n.largestBatchId,t.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function To(n){if(n.code!==it.FAILED_PRECONDITION||n.message!==CI)throw n;pt("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cg=-1;function Xh(n){return n==null}function Rh(n){return n===0&&1/n==-1/0}function MI(n){return typeof n=="number"&&Number.isInteger(n)&&!Rh(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X2="";function OI(n){let t="";for(let i=0;i<n.length;i++)t.length>0&&(t=vv(t)),t=VI(n.get(i),t);return vv(t)}function VI(n,t){let i=t;const a=n.length;for(let o=0;o<a;o++){const u=n.charAt(o);switch(u){case"\0":i+="";break;case X2:i+="";break;default:i+=u}}return i}function vv(n){return n+X2+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const J2="server_timestamp",tE="__type__",eE="__previous_value__",nE="__local_write_time__";function hg(n){return(n?.mapValue?.fields||{})[tE]?.stringValue===J2}function Wh(n){const t=n.mapValue.fields[eE];return hg(t)?Wh(t):t}function au(n){const t=na(n.mapValue.fields[nE].timestampValue);return new ue(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PI{constructor(t,i,a,o,u,d,m,p,g,v){this.databaseId=t,this.appId=i,this.persistenceKey=a,this.host=o,this.ssl=u,this.forceLongPolling=d,this.autoDetectLongPolling=m,this.longPollingOptions=p,this.useFetchStreams=g,this.isUsingEmulator=v}}const Ih="(default)";class su{constructor(t,i){this.projectId=t,this.database=i||Ih}static empty(){return new su("","")}get isDefaultDatabase(){return this.database===Ih}isEqual(t){return t instanceof su&&t.projectId===this.projectId&&t.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn{constructor(t){this.value=t}static empty(){return new vn({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let i=this.value;for(let a=0;a<t.length-1;++a)if(i=(i.mapValue.fields||{})[t.get(a)],!ph(i))return null;return i=(i.mapValue.fields||{})[t.lastSegment()],i||null}}set(t,i){this.getFieldsMap(t.popLast())[t.lastSegment()]=Kl(i)}setAll(t){let i=Ze.emptyPath(),a={},o=[];t.forEach(((d,m)=>{if(!i.isImmediateParentOf(m)){const p=this.getFieldsMap(i);this.applyChanges(p,a,o),a={},o=[],i=m.popLast()}d?a[m.lastSegment()]=Kl(d):o.push(m.lastSegment())}));const u=this.getFieldsMap(i);this.applyChanges(u,a,o)}delete(t){const i=this.field(t.popLast());ph(i)&&i.mapValue.fields&&delete i.mapValue.fields[t.lastSegment()]}isEqual(t){return ji(this.value,t.value)}getFieldsMap(t){let i=this.value;i.mapValue.fields||(i.mapValue={fields:{}});for(let a=0;a<t.length;++a){let o=i.mapValue.fields[t.get(a)];ph(o)&&o.mapValue.fields||(o={mapValue:{fields:{}}},i.mapValue.fields[t.get(a)]=o),i=o}return i.mapValue.fields}applyChanges(t,i,a){oa(i,((o,u)=>t[o]=u));for(const o of a)delete t[o]}clone(){return new vn(Kl(this.value))}}function aE(n){const t=[];return oa(n.fields,((i,a)=>{const o=new Ze([i]);if(ph(a)){const u=aE(a.mapValue).fields;if(u.length===0)t.push(o);else for(const d of u)t.push(o.child(d))}else t.push(o)})),new Cn(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lu{constructor(t,i="asc"){this.field=t,this.dir=i}}function $I(n,t){return n.dir===t.dir&&n.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const e3=new me(vt.comparator);function cr(){return e3}const mE=new me(vt.comparator);function Ll(...n){let t=mE;for(const i of n)t=t.insert(i.key,i);return t}function gE(n){let t=mE;return n.forEach(((i,a)=>t=t.insert(i,a.overlayedDocument))),t}function Ya(){return Gl()}function yE(){return Gl()}function Gl(){return new ns((n=>n.toString()),((n,t)=>n.isEqual(t)))}const n3=new me(vt.comparator),i3=new Ue(vt.comparator);function Ut(...n){let t=i3;for(const i of n)t=t.add(i);return t}const r3=new Ue(Pt);function a3(){return r3}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gg(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Rh(t)?"-0":t}}function xE(n){return{integerValue:""+n}}function vE(n,t){return MI(t)?xE(t):gg(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class td{constructor(){this._=void 0}}function s3(n,t,i){return n instanceof Dh?(function(o,u){const d={fields:{[tE]:{stringValue:J2},[nE]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return u&&hg(u)&&(u=Wh(u)),u&&(d.fields[eE]=u),{mapValue:d}})(i,t):n instanceof uu?EE(n,t):n instanceof cu?wE(n,t):(function(o,u){const d=_E(o,u),m=Dv(d)+Dv(o.Ae);return gm(d)&&gm(o.Ae)?xE(m):gg(o.serializer,m)})(n,t)}function o3(n,t,i){return n instanceof uu?EE(n,t):n instanceof cu?wE(n,t):i}function _E(n,t){return n instanceof hu?(function(a){return gm(a)||(function(u){return!!u&&"doubleValue"in u})(a)})(t)?t:{integerValue:0}:null}class Dh extends td{}class uu extends td{constructor(t){super(),this.elements=t}}function EE(n,t){const i=bE(t);for(const a of n.elements)i.some((o=>ji(o,a)))||i.push(a);return{arrayValue:{values:i}}}class cu extends td{constructor(t){super(),this.elements=t}}function wE(n,t){let i=bE(t);for(const a of n.elements)i=i.filter((o=>!ji(o,a)));return{arrayValue:{values:i}}}class hu extends td{constructor(t,i){super(),this.serializer=t,this.Ae=i}}function Dv(n){return Se(n.integerValue||n.doubleValue)}function bE(n){return dg(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v3=new Jr([4294967295,4294967295],0);function Vv(n){const t=x3().encode(n),i=new z2;return i.update(t),new Uint8Array(i.digest())}function kv(n){const t=new DataView(n.buffer),i=t.getUint32(0,!0),a=t.getUint32(4,!0),o=t.getUint32(8,!0),u=t.getUint32(12,!0);return[new Jr([i,a],0),new Jr([o,u],0)]}class xg{constructor(t,i,a){if(this.bitmap=t,this.padding=i,this.hashCount=a,i<0||i>=8)throw new zl(`Invalid padding: ${i}`);if(a<0)throw new zl(`Invalid hash count: ${a}`);if(t.length>0&&this.hashCount===0)throw new zl(`Invalid hash count: ${a}`);if(t.length===0&&i!==0)throw new zl(`Invalid padding when bitmap length is 0: ${i}`);this.ge=8*t.length-i,this.pe=Jr.fromNumber(this.ge)}ye(t,i,a){let o=t.add(i.multiply(Jr.fromNumber(a)));return o.compare(v3)===1&&(o=new Jr([o.getBits(0),o.getBits(1)],0)),o.modulo(this.pe).toNumber()}we(t){return!!(this.bitmap[Math.floor(t/8)]&1<<t%8)}mightContain(t){if(this.ge===0)return!1;const i=Vv(t),[a,o]=kv(i);for(let u=0;u<this.hashCount;u++){const d=this.ye(a,o,u);if(!this.we(d))return!1}return!0}static create(t,i,a){const o=t%8==0?0:8-t%8,u=new Uint8Array(Math.ceil(t/8)),d=new xg(u,o,i);return a.forEach((m=>d.insert(m))),d}insert(t){if(this.ge===0)return;const i=Vv(t),[a,o]=kv(i);for(let u=0;u<this.hashCount;u++){const d=this.ye(a,o,u);this.Se(d)}}Se(t){const i=Math.floor(t/8),a=t%8;this.bitmap[i]|=1<<a}}class zl extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U3{constructor(t){this.yt=t}}function L3(n){const t=N3({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?_m(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class G3{constructor(){this.changes=new ns((t=>t.toString()),((t,i)=>t.isEqual(i))),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,i){this.assertNotApplied(),this.changes.set(t,on.newInvalidDocument(t).setReadTime(i))}getEntry(t,i){this.assertNotApplied();const a=this.changes.get(i);return a!==void 0?st.resolve(a):this.getFromCache(t,i)}getEntries(t,i){return this.getAllFromCache(t,i)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q3{constructor(t,i,a,o){this.remoteDocumentCache=t,this.mutationQueue=i,this.documentOverlayCache=a,this.indexManager=o}getDocument(t,i){let a=null;return this.documentOverlayCache.getOverlay(t,i).next((o=>(a=o,this.remoteDocumentCache.getEntry(t,i)))).next((o=>(a!==null&&Yl(a.mutation,o,Cn.empty(),ue.now()),o)))}getDocuments(t,i){return this.remoteDocumentCache.getEntries(t,i).next((a=>this.getLocalViewOfDocuments(t,a,Ut()).next((()=>a))))}getLocalViewOfDocuments(t,i,a=Ut()){const o=Ya();return this.populateOverlays(t,o,i).next((()=>this.computeViews(t,i,o,a).next((u=>{let d=Ll();return u.forEach(((m,p)=>{d=d.insert(m,p.overlayedDocument)})),d}))))}getOverlayedDocuments(t,i){const a=Ya();return this.populateOverlays(t,a,i).next((()=>this.computeViews(t,i,a,Ut())))}populateOverlays(t,i,a){const o=[];return a.forEach((u=>{i.has(u)||o.push(u)})),this.documentOverlayCache.getOverlays(t,o).next((u=>{u.forEach(((d,m)=>{i.set(d,m)}))}))}computeViews(t,i,a,o){let u=cr();const d=Gl(),m=(function(){return Gl()})();return i.forEach(((p,g)=>{const v=a.get(g.key);o.has(g.key)&&(v===void 0||v.mutation instanceof la)?u=u.insert(g.key,g):v!==void 0?(d.set(g.key,v.mutation.getFieldMask()),Yl(v.mutation,g,v.mutation.getFieldMask(),ue.now())):d.set(g.key,Cn.empty())})),this.recalculateAndSaveOverlays(t,u).next((p=>(p.forEach(((g,v)=>d.set(g,v))),i.forEach(((g,v)=>m.set(g,new Y3(v,d.get(g)??null)))),m)))}recalculateAndSaveOverlays(t,i){const a=Gl();let o=new me(((d,m)=>d-m)),u=Ut();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,i).next((d=>{for(const m of d)m.keys().forEach((p=>{const g=i.get(p);if(g===null)return;let v=a.get(p)||Cn.empty();v=m.applyToLocalView(g,v),a.set(p,v);const w=(o.get(m.batchId)||Ut()).add(p);o=o.insert(m.batchId,w)}))})).next((()=>{const d=[],m=o.getReverseIterator();for(;m.hasNext();){const p=m.getNext(),g=p.key,v=p.value,w=yE();v.forEach((T=>{if(!u.has(T)){const R=TE(i.get(T),a.get(T));R!==null&&w.set(T,R),u=u.add(T)}})),d.push(this.documentOverlayCache.saveOverlays(t,g,w))}return st.waitFor(d)})).next((()=>a))}recalculateAndSaveOverlaysForDocumentKeys(t,i){return this.remoteDocumentCache.getEntries(t,i).next((a=>this.recalculateAndSaveOverlays(t,a)))}getDocumentsMatchingQuery(t,i,a,o){return(function(d){return vt.isDocumentKey(d.path)&&d.collectionGroup===null&&d.filters.length===0})(i)?this.getDocumentsMatchingDocumentQuery(t,i.path):dE(i)?this.getDocumentsMatchingCollectionGroupQuery(t,i,a,o):this.getDocumentsMatchingCollectionQuery(t,i,a,o)}getNextDocuments(t,i,a,o){return this.remoteDocumentCache.getAllFromCollectionGroup(t,i,a,o).next((u=>{const d=o-u.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,i,a.largestBatchId,o-u.size):st.resolve(Ya());let m=ru,p=u;return d.next((g=>st.forEach(g,((v,w)=>(m<w.largestBatchId&&(m=w.largestBatchId),u.get(v)?st.resolve():this.remoteDocumentCache.getEntry(t,v).next((T=>{p=p.insert(v,T)}))))).next((()=>this.populateOverlays(t,g,u))).next((()=>this.computeViews(t,p,g,Ut()))).next((v=>({batchId:m,changes:gE(v)})))))}))}getDocumentsMatchingDocumentQuery(t,i){return this.getDocument(t,new vt(i)).next((a=>{let o=Ll();return a.isFoundDocument()&&(o=o.insert(a.key,a)),o}))}getDocumentsMatchingCollectionGroupQuery(t,i,a,o){const u=i.collectionGroup;let d=Ll();return this.indexManager.getCollectionParents(t,u).next((m=>st.forEach(m,(p=>{const g=(function(w,T){return new Ao(T,null,w.explicitOrderBy.slice(),w.filters.slice(),w.limit,w.limitType,w.startAt,w.endAt)})(i,p.child(u));return this.getDocumentsMatchingCollectionQuery(t,g,a,o).next((v=>{v.forEach(((w,T)=>{d=d.insert(w,T)}))}))})).next((()=>d))))}getDocumentsMatchingCollectionQuery(t,i,a,o){let u;return this.documentOverlayCache.getOverlaysForCollection(t,i.path,a.largestBatchId).next((d=>(u=d,this.remoteDocumentCache.getDocumentsMatchingQuery(t,i,a,u,o)))).next((d=>{u.forEach(((p,g)=>{const v=g.getKey();d.get(v)===null&&(d=d.insert(v,on.newInvalidDocument(v)))}));let m=Ll();return d.forEach(((p,g)=>{const v=u.get(p);v!==void 0&&Yl(v.mutation,g,Cn.empty(),ue.now()),Jh(i,g)&&(m=m.insert(p,g))})),m}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z3{constructor(){this.sessionToken=Je.EMPTY_BYTE_STRING}getSessionToken(t){return st.resolve(this.sessionToken)}setSessionToken(t,i){return this.sessionToken=i,st.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function id(n){return new T3(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ja="RemoteStore";class Aj{constructor(t,i,a,o,u){this.localStore=t,this.datastore=i,this.asyncQueue=a,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=u,this.Aa.Oo((d=>{a.enqueueAndForget((async()=>{is(this)&&(pt(Ja,"Restarting streams for network reachability change."),await(async function(p){const g=It(p);g.Ea.add(4),await xu(g),g.Ra.set("Unknown"),g.Ea.delete(4),await rd(g)})(this))}))})),this.Ra=new Sj(a,o)}}async function rd(n){if(is(n))for(const t of n.da)await t(!0)}async function xu(n){for(const t of n.da)await t(!1)}function FE(n,t){const i=It(n);i.Ia.has(t.targetId)||(i.Ia.set(t.targetId,t),Rg(i)?Ag(i):Ro(i).O_()&&Sg(i,t))}function Tg(n,t){const i=It(n),a=Ro(i);i.Ia.delete(t),a.O_()&&qE(i,t),i.Ia.size===0&&(a.O_()?a.L_():is(i)&&i.Ra.set("Unknown"))}function Sg(n,t){if(n.Va.Ue(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(At.min())>0){const i=n.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(i)}Ro(n).Y_(t)}function qE(n,t){n.Va.Ue(t),Ro(n).Z_(t)}function Ag(n){n.Va=new _3({getRemoteKeysForTarget:t=>n.remoteSyncer.getRemoteKeysForTarget(t),At:t=>n.Ia.get(t)||null,ht:()=>n.datastore.serializer.databaseId}),Ro(n).start(),n.Ra.ua()}function Rg(n){return is(n)&&!Ro(n).x_()&&n.Ia.size>0}function is(n){return It(n).Ea.size===0}function KE(n){n.Va=void 0}async function Rj(n){n.Ra.set("Online")}async function Ij(n){n.Ia.forEach(((t,i)=>{Sg(n,t)}))}async function jj(n,t){KE(n),Rg(n)?(n.Ra.ha(t),Ag(n)):n.Ra.set("Unknown")}async function Cj(n,t,i){if(n.Ra.set("Online"),t instanceof jE&&t.state===2&&t.cause)try{await(async function(o,u){const d=u.cause;for(const m of u.targetIds)o.Ia.has(m)&&(await o.remoteSyncer.rejectListen(m,d),o.Ia.delete(m),o.Va.removeTarget(m))})(n,t)}catch(a){pt(Ja,"Failed to remove targets %s: %s ",t.targetIds.join(","),a),await Oh(n,a)}else if(t instanceof gh?n.Va.Ze(t):t instanceof IE?n.Va.st(t):n.Va.tt(t),!i.isEqual(At.min()))try{const a=await zE(n.localStore);i.compareTo(a)>=0&&await(function(u,d){const m=u.Va.Tt(d);return m.targetChanges.forEach(((p,g)=>{if(p.resumeToken.approximateByteSize()>0){const v=u.Ia.get(g);v&&u.Ia.set(g,v.withResumeToken(p.resumeToken,d))}})),m.targetMismatches.forEach(((p,g)=>{const v=u.Ia.get(p);if(!v)return;u.Ia.set(p,v.withResumeToken(Je.EMPTY_BYTE_STRING,v.snapshotVersion)),qE(u,p);const w=new Xr(v.target,p,g,v.sequenceNumber);Sg(u,w)})),u.remoteSyncer.applyRemoteEvent(m)})(n,i)}catch(a){pt(Ja,"Failed to raise snapshot:",a),await Oh(n,a)}}async function Oh(n,t,i){if(!So(t))throw t;n.Ea.add(1),await xu(n),n.Ra.set("Offline"),i||(i=()=>zE(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{pt(Ja,"Retrying IndexedDB access"),await i(),n.Ea.delete(1),await rd(n)}))}function HE(n,t){return t().catch((i=>Oh(n,i,t)))}async function ad(n){const t=It(n),i=aa(t);let a=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:cg;for(;Dj(t);)try{const o=await dj(t.localStore,a);if(o===null){t.Ta.length===0&&i.L_();break}a=o.batchId,Nj(t,o)}catch(o){await Oh(t,o)}GE(t)&&YE(t)}function Dj(n){return is(n)&&n.Ta.length<10}function Nj(n,t){n.Ta.push(t);const i=aa(n);i.O_()&&i.X_&&i.ea(t.mutations)}function GE(n){return is(n)&&!aa(n).x_()&&n.Ta.length>0}function YE(n){aa(n).start()}async function Mj(n){aa(n).ra()}async function Oj(n){const t=aa(n);for(const i of n.Ta)t.ea(i.mutations)}async function Vj(n,t,i){const a=n.Ta.shift(),o=yg.from(a,t,i);await HE(n,(()=>n.remoteSyncer.applySuccessfulWrite(o))),await ad(n)}async function kj(n,t){t&&aa(n).X_&&await(async function(a,o){if((function(d){return y3(d)&&d!==it.ABORTED})(o.code)){const u=a.Ta.shift();aa(a).B_(),await HE(a,(()=>a.remoteSyncer.rejectFailedWrite(u.batchId,o))),await ad(a)}})(n,t),GE(n)&&YE(n)}async function Yv(n,t){const i=It(n);i.asyncQueue.verifyOperationInProgress(),pt(Ja,"RemoteStore received new credentials");const a=is(i);i.Ea.add(3),await xu(i),a&&i.Ra.set("Unknown"),await i.remoteSyncer.handleCredentialChange(t),i.Ea.delete(3),await rd(i)}async function Pj(n,t){const i=It(n);t?(i.Ea.delete(2),await rd(i)):t||(i.Ea.add(2),await xu(i),i.Ra.set("Unknown"))}function Ro(n){return n.ma||(n.ma=(function(i,a,o){const u=It(i);return u.sa(),new Ej(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:Rj.bind(null,n),t_:Ij.bind(null,n),r_:jj.bind(null,n),H_:Cj.bind(null,n)}),n.da.push((async t=>{t?(n.ma.B_(),Rg(n)?Ag(n):n.Ra.set("Unknown")):(await n.ma.stop(),KE(n))}))),n.ma}function aa(n){return n.fa||(n.fa=(function(i,a,o){const u=It(i);return u.sa(),new wj(a,u.connection,u.authCredentials,u.appCheckCredentials,u.serializer,o)})(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:Mj.bind(null,n),r_:kj.bind(null,n),ta:Oj.bind(null,n),na:Vj.bind(null,n)}),n.da.push((async t=>{t?(n.fa.B_(),await ad(n)):(await n.fa.stop(),n.Ta.length>0&&(pt(Ja,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vh(n){n=ur(n,Ae);const t=ur(n.firestore,_u);return uC(Mg(t),n._key).then((i=>AC(t,n,i)))}ro._jsonSchemaVersion="firestore/querySnapshot/1.0",ro._jsonSchema={type:Ne("string",ro._jsonSchemaVersion),bundleSource:Ne("string","QuerySnapshot"),bundleName:Ne("string"),bundle:Ne("string")};class _w extends bC{constructor(t){super(),this.firestore=t}convertBytes(t){return new Fn(t)}convertReference(t){const i=this.convertDocumentKey(t,this.firestore._databaseId);return new Ae(this.firestore,null,i)}}function Dm(n){n=ur(n,rs);const t=ur(n.firestore,_u),i=Mg(t),a=new _w(t);return wC(n._query),cC(i,n._query).then((o=>new ro(t,a,n,o)))}function qg(n,t,i){n=ur(n,Ae);const a=ur(n.firestore,_u),o=TC(n.converter,t,i);return Ew(a,[gC(Vg(a),"setDoc",n._key,o,n.converter!==null,i).toMutation(n._key,Si.none())])}function Ph(n,t,i,...a){n=ur(n,Ae);const o=ur(n.firestore,_u),u=Vg(o);let d;return d=typeof(t=sr(t))=="string"||t instanceof od?xC(u,"updateDoc",n._key,t,i,a):yC(u,"updateDoc",n._key,t),Ew(o,[d.toMutation(n._key,Si.exists(!0))])}function Ew(n,t){return(function(a,o){const u=new ir;return a.asyncQueue.enqueueAndForget((async()=>Wj(await lC(a),o,u))),u.promise})(Mg(n),t)}function AC(n,t,i){const a=i.docs.get(t._key),o=new _w(n);return new Wa(n,o,t._key,a,new $l(i.hasPendingWrites,i.fromCache),t.converter)}function Uh(n){return new kg("increment",n)}(function(t,i=!0){(function(o){bo=o})(nI),Ah(new eu("firestore",((a,{instanceIdentifier:o,options:u})=>{const d=a.getProvider("app").getImmediate(),m=new _u(new xI(a.getProvider("auth-internal")),new EI(d,a.getProvider("app-check-internal")),(function(g,v){if(!Object.prototype.hasOwnProperty.apply(g.options,["projectId"]))throw new ft(it.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new su(g.options.projectId,v)})(d,o),d);return u={useFetchStreams:i,...u},m._setSettings(u),m}),"PUBLIC").setMultipleInstances(!0)),no(hv,dv,t),no(hv,dv,"esm2020")})();const RC={apiKey:"AIzaSyAEFzPwTADLzuxWuyk889Jz1cHPsEgLOkQ",authDomain:"tu2025grad.firebaseapp.com",projectId:"tu2025grad",storageBucket:"tu2025grad.firebasestorage.app",messagingSenderId:"553768466639",appId:"1:553768466639:web:7c16f5d6432da7ebc05fba"},IC=sv().length?sv()[0]:og(RC),Xl=hw(IC),h_=40;function ww(n){if(!n)return n;const t="/";if(/^https?:\/\//i.test(n))return n;const i=n.replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const jC=S.div`
  position: relative; background: #fff;
`,CC=S.div`
...
`,d_=tu,bw=ng,VC={"All Projects":null,"AI & Robot":"c0","Edu & Kids":"c1","Health Care":"c2","IT & Tech":"c3",Living:"c4",Mobility:"c5"};function Nm(n){return n.members.map(t=>{const i=bw.find(a=>a.num===t);return i?i.nameKor:""}).filter(Boolean).join(", ")}function kC(n){return n.members.map(t=>{const i=bw.find(a=>a.num===t);return i?ww(i.imgUrl):""}).filter(Boolean)}function PC({list:n,statsById:t}){const i={c0:"A",c1:"E",c2:"H",c3:"I",c4:"L",c5:"M"};return y.jsx(MC,{children:n.map((a,o)=>{const u=Nm(a),d=kC(a),m=String(a.projectNum+1).padStart(3,"0"),g=`${i[a.category]||"A"}${m}`,v=a.projectNum??a.num;return y.jsx(ig,{titleKor:a.titleKor,titleEng:a.titleEng,src:ww(`/projects/${a.projectNum}/thumb.jpg`||`/projects/${a.projectNum}/thumb.png`),nameKor:u,profileImgs:d,docId:v,href:`/work/${g}`,like:t[String(v)]?.like??0,view:t[String(v)]?.view??0},o)})})}function UC(){const[n,t]=St.useState("All Projects"),[i,a]=St.useState("이름순"),[o,u]=St.useState({});St.useEffect(()=>{let p=!0;return(async()=>{try{const g=await Dm(yh(Xl,"works"));if(!p)return;const v={};g.forEach(w=>{const T=w.data()||{};v[String(w.id)]={like:typeof T.like=="number"?T.like:0,view:typeof T.view=="number"?T.view:0}}),u(v)}catch(g){console.error("Failed to load works stats:",g)}})(),()=>{p=!1}},[]);const d=St.useMemo(()=>{const p=VC[n]||null;return p?d_.filter(g=>g.category===p):d_},[n]),m=St.useMemo(()=>{const p=[...d];switch(i){case"이름순":p.sort((g,v)=>Nm(g).localeCompare(Nm(v),"ko"));break;case"좋아요순":p.sort((g,v)=>{const w=String(g.projectNum??g.num),T=String(v.projectNum??v.num),R=o[w]?.like??0;return(o[T]?.like??0)-R});break;case"조회수순":p.sort((g,v)=>{const w=String(g.projectNum??g.num),T=String(v.projectNum??v.num),R=o[w]?.view??0;return(o[T]?.view??0)-R});break;case"팀작우선":p.sort((g,v)=>(v.members.length>1)-(g.members.length>1));break;case"개인작우선":p.sort((g,v)=>(g.members.length>1)-(v.members.length>1));break}return p},[d,i,o]);return y.jsxs(NC,{children:[y.jsx(OC,{children:"Projects"}),y.jsx(j2,{type:"project",onCategoryChange:t,onSortChange:a,sortLabel:i}),y.jsx(DC,{children:y.jsx(PC,{list:m,statsById:o})})]})}const LC=S.div(({height:n,from:t,to:i,position:a,z:o})=>({position:"absolute",left:0,right:0,[a]:-1,height:n,pointerEvents:"none",zIndex:o??0,background:`linear-gradient(180deg, ${t} 0%, ${i} 100%)`}));function Kg({position:n="bottom",from:t,to:i,height:a=240,z:o=0,style:u}){return y.jsx(LC,{position:n,from:t,to:i,height:a,z:o,style:u})}const rr={heroToWhite:{from:"rgba(18,18,18,0)",to:"#FFFFFF",h:80},whiteToBlack:{from:"rgba(255,255,255,0)",to:"#121212",h:160},blackToBlackSoft:{from:"rgba(18,18,18,0)",to:"#121212",h:180}},zC=S.section`
...
`;function XC(){const[n,t]=St.useState(!1),i=St.useRef(null),a="/",o=zh();St.useEffect(()=>()=>{i.current&&clearTimeout(i.current)},[]);const u=()=>{const m=`${typeof window<"u"&&window.innerWidth<640?"projects":"showroom"}`;o(m)};return y.jsxs(zC,{"aria-label":"Hero",children:[y.jsxs($C,{children:[y.jsx(BC,{"aria-hidden":!0,children:y.jsx(FC,{autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata",children:y.jsx("source",{src:`${a}video/hero11.mp4`,type:"video/mp4"})})}),y.jsx(qC,{"aria-label":"Hero background video",children:y.jsxs(KC,{autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"metadata",onLoadedData:()=>{i.current&&clearTimeout(i.current),i.current=setTimeout(()=>t(!0),13900)},children:[y.jsx("source",{src:`${a}video/hero11.mp4`,type:"video/mp4"}),"Your browser does not support the video tag."]})}),y.jsx(HC,{})]}),y.jsxs(GC,{$visible:n,children:[y.jsxs(f_,{children:["25. 10. 24. FRI~26. SUN",y.jsx("br",{}),"Hongdae Art Center B2"]}),y.jsx(f_,{children:"Department of Design Engineering"}),y.jsxs(YC,{children:["Tech University of Korea",y.jsx("br",{}),"20th Grad Exhibition"]})]}),y.jsxs(QC,{type:"button",onClick:u,"aria-label":"View More",children:[y.jsx("span",{className:"desktop",children:"View More"}),y.jsx("span",{className:"mobile",children:"View Work"})]}),y.jsx(Kg,{position:"bottom",from:rr.heroToWhite.from,to:rr.heroToWhite.to,height:rr.heroToWhite.h,z:0})]})}const p_="/",WC=S.section`
  position: relative;
  z-index: 1;
  background: #FFFFFF;
  padding-top: 120px;
...
`,m_=S.div`
  ...
  aspect-ratio: 1 / 1;
  max-height: 200px;
`;function yD(){const n=[{src:`${qe}video/sub1.mp4`,cap:""},{src:`${qe}sq5.png`,cap:""},{src:`${qe}sq2.png`,cap:""},{src:`${qe}video/category.mp4`,cap:""},{src:`${qe}sq6.png`,cap:""},{src:`${qe}sq4.png`,cap:""},{src:"https://placehold.co/987x555",cap:""},{src:`${qe}sq3.png`,cap:""},{src:`${qe}sq1.png`,cap:""}];return y.jsxs(uD,{"aria-label":"Gallery",children:[y.jsx(Kg,{position:"top",from:rr.blackToBlackSoft.from,to:rr.blackToBlackSoft.to,height:rr.blackToBlackSoft.h,z:0}),y.jsxs(cD,{children:[y.jsx(hD,{children:y.jsx(th,{src:`${qe}video/main.mp4`,alt:"featured",muted:!0,autoPlay:!0,playsInline:!0,loop:!0})}),y.jsxs(dD,{className:"gallery-desktop",children:[y.jsxs(Pp,{children:[y.jsx(tr,{$w:910,$h:445,children:y.jsx(th,{src:`${qe}video/sub1.mp4`,alt:"",muted:!0,autoPlay:!0,playsInline:!0,loop:!0})}),y.jsx(tr,{$w:445,$h:445,children:y.jsx(Qs,{src:`${qe}sq5.png`,alt:""})}),y.jsx(tr,{$w:445,$h:445,children:y.jsx(Qs,{src:`${qe}sq6.png`,alt:""})})]}),y.jsxs(Pp,{children:[y.jsx(tr,{$w:445,$h:445,children:y.jsx(Qs,{src:`${qe}sq4.png`,alt:""})}),y.jsx(tr,{$w:445,$h:445,children:y.jsx(Qs,{src:`${qe}sq2.png`,alt:""})}),y.jsx(tr,{$w:910,$h:445,children:y.jsx(th,{src:`${qe}video/category.mp4`,alt:"",muted:!0,autoPlay:!0,playsInline:!0,loop:!0})})]}),y.jsxs(Pp,{children:[y.jsx(tr,{$w:910,$h:445,children:y.jsx(th,{src:`${qe}video/category.mp4`,alt:"",muted:!0,autoPlay:!0,playsInline:!0,loop:!0})}),y.jsx(tr,{$w:445,$h:445,children:y.jsx(Qs,{src:`${qe}sq3.png`,alt:""})}),y.jsx(tr,{$w:445,$h:445,children:y.jsx(Qs,{src:`${qe}sq1.png`,alt:""})})]})]}),y.jsx(fD,{children:y.jsx("div",{style:{marginTop:12,display:"flex",flexDirection:"column",gap:12},children:Array.from({length:3}).map((t,i)=>{const a=i*3,o=n[a],u=n[a+1],d=n[a+2];return y.jsxs(pD,{children:[o&&y.jsxs(mD,{children:[y.jsx("img",{src:o.src,alt:"",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}),o.cap&&y.jsx(Up,{style:{opacity:1},children:o.cap})]}),y.jsxs(gD,{children:[u&&y.jsxs(m_,{children:[y.jsx("img",{src:u.src,alt:"",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}),u.cap&&y.jsx(Up,{style:{opacity:1},children:u.cap})]}),d&&y.jsxs(m_,{children:[y.jsx("img",{src:d.src,alt:"",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}),d.cap&&y.jsx(Up,{style:{opacity:1},children:d.cap})]})]})]},i)})})}),y.jsx("div",{style:{paddingTop:40,display:"flex",justifyContent:"center"},children:y.jsx(Hg,{label:"View More"})})]})]})}const xD=S.section`
  position: relative;
...
`;function ED({durationVh:n=300,center:t=!0,centerOffsetPx:i=0,children:a,style:o}){const u=St.useRef(null),[d,m]=St.useState(0);return St.useEffect(()=>{const p=u.current;if(!p)return;let g=0,v=!0;const w=()=>{if(!v)return;const T=p.getBoundingClientRect(),R=window.innerHeight,M=n/100*R-R,L=Math.min(Math.max(-T.top,0),M);m(M>0?L/M:0),g=requestAnimationFrame(w)};return g=requestAnimationFrame(w),()=>{v=!1,cancelAnimationFrame(g)}},[n]),y.jsx(xD,{ref:u,style:o,$durationVh:n,children:y.jsx(vD,{$center:t,children:y.jsx(_D,{$offset:i,children:typeof a=="function"?a(d):a})})})}const g_=[{id:"w1",index:"A010",artistKr:"송지원, 허지유",dept:"Industrial Design Engineering",titleSmall:"한국산업기술진흥원장상 수상",titleStrong:"BIND",rightMeta1:"Precision and efficency beyond human limits.",rightMeta2:"BIND, 흩어진 시간을 하나로 잇다.",image:"1127032149"},{id:"w2",index:"A017",artistKr:"이채연",dept:"Media Design Engineering",titleSmall:"총동문회장상 수상",titleStrong:"MUSE",rightMeta1:"디자인 논문을 쉽게 활용할 수 있도록 돕는",rightMeta2:"AI 인사이트 제공 서비스",image:"1127403683"},{id:"w3",index:"A011",artistKr:"정혜원, 신주혜",dept:"Industrial Design Engineering",titleSmall:"한국공학대학교총장상 수상",titleStrong:"ENDY",rightMeta1:"감정을 이해하고 반응하는 학습 파트너,",rightMeta2:"자기주도학습의 새로운 동반자 ENDY",image:"1126889031"}],wD=S.div`
  position: relative;
  background: #121212;
  @media (max-width: 640px) {
    background: #121212;
...
`,kD=S.iframe`
  ...
  display: block;
  margin-top: 16px;
`,PD=(n,t=0,i=1)=>Math.max(t,Math.min(i,n)),Xs=(n,t,i)=>n+(t-n)*i,UD=n=>n<.5?2*n*n:1-Math.pow(-2*n+2,2)/2;function LD({work:n,progress:t,videoId:i}){String(i||"").trim();const a=`https://player.vimeo.com/video/${n.image}?muted=1&autoplay=1&loop=1&badge=0&controls=0&autopause=0&title=0&byline=0&portrait=0&app_id=58479`,o=UD(PD(t,0,1)),u=Xs(0,-120,o),d=Xs(0,-360,o),m=Xs(0,-280,o),p=Xs(0,-220,o),g=Xs(0,-260,o),v=Xs(0,-180,o),w=.55,R=o<w?1:1-Math.max(0,Math.min(1,(o-w)/(.9-w))),M={transform:`translate3d(0, ${u}px, 0)`,willChange:"transform"},L=K=>({transform:`translate3d(0, ${K}px, 0)`,opacity:R,willChange:"transform, opacity"}),U={transform:`translate3d(0, ${v}px, 0)`,opacity:R,willChange:"transform, opacity"};return y.jsx(y.Fragment,{children:y.jsx(wD,{children:y.jsxs(AD,{children:[y.jsx(RD,{style:M,children:y.jsx(VD,{src:a,frameBorder:"0"})}),y.jsx(ID,{style:L(d),children:n.artistKr}),y.jsx(jD,{style:L(m),children:n.dept}),y.jsx(CD,{style:L(p),children:n.rightMeta1}),y.jsx(DD,{style:L(g),children:n.rightMeta2}),y.jsxs(ND,{style:U,children:[y.jsx(MD,{children:n.titleSmall}),y.jsx(OD,{children:n.titleStrong})]})]})})})}function zD(){return y.jsxs(y.Fragment,{children:[y.jsx("style",{children:`
        @media (max-width: 640px) {
      ...
      `}),y.jsx("div",{className:"expo-works-desktop",children:g_.slice(0,3).map(n=>y.jsx(ED,{durationVh:320,center:!0,centerOffsetPx:-40,children:t=>y.jsx(LD,{work:n,progress:t})},n.id))}),y.jsx(bD,{className:"expo-works-mobile",children:g_.map(n=>y.jsxs(TD,{to:`work/${n.index}`,children:[y.jsx(kD,{src:`https://player.vimeo.com/video/${n.image}?badge=0&controls=0&autopause=0&title=0&byline=0&portrait=0&app_id=58479`}),y.jsxs(SD,{children:[y.jsx("div",{style:{fontWeight:700,fontSize:16},children:n.titleStrong}),y.jsxs("div",{style:{fontSize:13,color:"#D9D9D9"},children:[n.artistKr," | ",n.dept]}),y.jsx("div",{style:{fontSize:12,color:"#A1A1A1",marginTop:2},children:n.rightMeta1}),y.jsx("div",{style:{fontSize:12,color:"#A1A1A1"},children:n.rightMeta2})]})]},n.id))})]})}const $D="/",BD=S.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: flex-start;
...
`;function QD(){return y.jsx(BD,{"aria-labelledby":"insta-title",children:y.jsx(FD,{children:y.jsxs(qD,{children:[y.jsx(KD,{children:y.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"#FFFFFF",children:[y.jsx("path",{d:"M12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 8.2A3.2 3.2 0 1 1 12 8a3.2 3.2 0 0 1 0 6.4z"}),y.jsx("circle",{cx:"17.5",cy:"6.5",r:"1.2"}),y.jsx("path",{d:"M17.8 2H6.2A4.2 4.2 0 0 0 2 6.2v11.6A4.2 4.2 0 0 0 6.2 22h11.6A4.2 4.2 0 0 0 22 17.8V6.2A4.2 4.2 0 0 0 17.8 2zm2.6 15.8a2.6 2.6 0 0 1-2.6 2.6H6.2a2.6 2.6 0 0 1-2.6-2.6V6.2A2.6 2.6 0 0 1 6.2 3.6h11.6a2.6 2.6 0 0 1 2.6 2.6v11.6z"})]})}),y.jsx(HD,{id:"insta-title",children:"@tukd_grad"}),y.jsxs(GD,{children:[y.jsx(YD,{children:y.jsx("img",{src:`${$D}insta-qr.png`,alt:"Instagram preview"})}),y.jsx(Hg,{as:"a",href:"https://www.instagram.com/tukd_grad?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",label:"View Instagram",size:"sm"})]})]})})})}const bu=`'Pretendard', system-ui, -apple-system, Segoe UI, Roboto, "Noto Sans KR", Arial, sans-serif`,y_=350,XD=S.section`
...
`,JD=({children:n})=>y.jsx(WD,{children:y.jsx(ZD,{children:n})}),t5=S.div`
...
`;function n5({title:n}){return y.jsx(t5,{children:y.jsx(e5,{children:n})})}const i5=S.div`
...
`;function Yr({k:n,children:t,divider:i=!0}){return y.jsxs(r5,{$divider:i,children:[y.jsx(a5,{children:y.jsx(s5,{children:n})}),y.jsx(o5,{children:t})]})}const l5=S.div`
...
`;function x_({title:n,children:t,last:i=!1}){return y.jsxs(i5,{$last:i,children:[y.jsx(n5,{title:n}),y.jsx(l5,{children:t})]})}const u5=S.div`
...
`;function m5(){const n=[y.jsx(XC,{},"hero"),y.jsx(aD,{},"brand"),y.jsx(yD,{},"gallery"),y.jsx(p5,{children:"TU-EXPO Works"},"works-title"),y.jsx(zD,{},"works"),y.jsx(QD,{},"insta"),y.jsx(f5,{},"venue")];return y.jsx("div",{style:{background:"#121212",minHeight:"100vh"},children:n})}const g5="/",Gg="Pretendard, system-ui",y5=S.div`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  position: relative;
  border-radius: 8px;
...
`,x5=`${g5}guestbook-card.svg`,v5=S.div`
  width: 181px;
  height: 147px;
  position: absolute;
  left: 6px;
...
`;function T5({to:n,from:t,message:i}){return y.jsxs(y5,{$w:yo,$h:ts,children:[y.jsx(v5,{}),y.jsxs(_5,{$w:yo,$h:ts,children:[y.jsx(E5,{children:`To. ${n}`}),y.jsx(w5,{children:i}),y.jsx(b5,{children:`From. ${t}`})]})]})}const S5=S.div`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
  overflow: hidden;
...
`,A5=S.img`
  ...
  object-fit: cover;
  display: block;
`;function R5({src:n}){return y.jsx(S5,{$w:yo,$h:ts,children:y.jsx(A5,{src:n,alt:"포토 카드"})})}const I5=S.button`
  width: ${n=>n.$w}px;
  height: ${n=>n.$h}px;
  border-radius: 8px;
...
`;function O5({onClick:n}){return y.jsxs(I5,{onClick:n,"aria-label":"방명록 작성",$w:yo,$h:ts,children:[y.jsx(j5,{$w:yo,$h:ts}),y.jsx(C5,{children:y.jsxs(D5,{children:[y.jsx(N5,{}),y.jsx(M5,{})]})})]})}const yo=270,ts=337,V5=30,Tw=20,k5=210,P5=60,Sw=173,Aw=216,U5=16,L5=16,Mm=16,z5=S.div`
  padding: 0 0 12px 0;
  @media (max-width: 640px) {
    display: none;
  }
...
`,rN=S.div`
  ...
  width: 302px;
  height: 246px;
  background-image: url(${Z5}/gestbook-card.svg);
  background-size: cover;
  background-repeat: no-repeat;
  @media (max-width: 640px) {
    left: 4px;
...
`;function vN({open:n,onClose:t,onSubmit:i,defaultTo:a="",defaultFrom:o=""}){const[u,d]=B.useState(a),[m,p]=B.useState(o),[g,v]=B.useState(""),w=B.useRef(null);if(B.useEffect(()=>{const M=L=>{L.key==="Escape"&&t?.()};return n&&document.addEventListener("keydown",M),()=>document.removeEventListener("keydown",M)},[n,t]),!n)return null;const T=M=>{M.target===w.current&&t?.()},R=()=>{const M={to:(u||"").trim(),from:(m||"").trim(),message:(g||"").trim()};M.message&&i?.(M)};return y.jsx(J5,{ref:w,onMouseDown:T,children:y.jsxs(tN,{onMouseDown:M=>M.stopPropagation(),children:[y.jsx(eN,{children:y.jsxs(nN,{children:[y.jsxs(iN,{children:[y.jsx(rN,{}),y.jsxs(aN,{children:[y.jsx(sN,{children:"To."}),y.jsx(oN,{value:u,onChange:M=>d(M.target.value),placeholder:"받는 사람"})]}),y.jsx(lN,{children:y.jsx(uN,{placeholder:"내용을 입력해 주세요.",value:g,onChange:M=>v(M.target.value)})}),y.jsxs(cN,{children:[y.jsx(hN,{children:"From."}),y.jsx(dN,{value:m,onChange:M=>p(M.target.value),placeholder:"보내는 사람"})]})]}),y.jsx(fN,{children:y.jsx(pN,{type:"button",onClick:R,"aria-label":"send",children:y.jsx(mN,{})})})]})}),y.jsx(gN,{children:y.jsx(yN,{type:"button",onClick:t,"aria-label":"close",children:y.jsxs(xN,{children:[y.jsx(__,{$deg:45}),y.jsx(__,{$deg:-45})]})})})]})})}const _N={apiKey:"AIzaSyAEFzPwTADLzuxWuyk889Jz1cHPsEgLOkQ",authDomain:"tu2025grad.firebaseapp.com",projectId:"tu2025grad",storageBucket:"tu2025grad.firebasestorage.app",messagingSenderId:"553768466639",appId:"1:553768466639:web:7c16f5d6432da7ebc05fba"},EN=og(_N),zp=hw(EN),wN='Pretendard, system-ui, -apple-system, Segoe UI, Roboto, "Noto Sans KR", Arial, sans-serif',bN=S.div`
...
`,SN=S.h1`
  font-family: ${wN}; font-weight: 700; font-size: 32px; color: #FFFFFF; text-align: center; margin: 20px 0 40px;
  @media (max-width: 640px) {
...
`;function IN(){const[n,t]=St.useState(!1),[i,a]=St.useState([]);St.useEffect(()=>{let d=!0;return(async()=>{try{const m=o_(yh(zp,"guest"),l_("time","desc")),p=await Dm(m);if(!d)return;const g=[];p.forEach(v=>{const w=v.data();g.push({id:v.id,to:w.to||"",from:w.from||"",message:w.message||"",type:"text"})}),a(g)}catch(m){console.error("Failed to load guestbook items:",m)}})(),()=>{d=!1}},[]);const o=async({to:d,from:m,message:p})=>{try{const g=String(Date.now());await qg(Ql(yh(zp,"guest"),g),{to:d||"",from:m||"",message:p||"",time:g});try{const v=o_(yh(zp,"guest"),l_("time","desc")),w=await Dm(v),T=[];w.forEach(R=>{const M=R.data();T.push({id:R.id,to:M.to||"",from:M.from||"",message:M.message||"",type:"text"})}),a(T)}catch(v){console.error("Failed to reload guestbook items after submit:",v)}t(!1)}catch(g){console.error("Failed to submit guest message:",g)}};return y.jsxs(bN,{children:[y.jsxs(TN,{children:[y.jsx(SN,{children:"Guest Book"}),y.jsx(AN,{children:y.jsxs(RN,{className:"gb-wrap",children:[y.jsx("style",{children:`
  ...
  `}),y.jsx(W5,{onOpenModal:()=>t(!0),items:i})]})})]}),y.jsx(vN,{open:n,onClose:()=>t(!1),onSubmit:o})]})}const Om="/",jN=S.div`
  display: flex;
  position: sticky;
  top: 80px;
  bottom: 0px;
...
`;function Vm({titleKor:n,titleEng:t,context:i,isOpen:a=!0,onClose:o,src:u,docId:d,collection:m="works"}){const[p,g]=B.useState(0),[v,w]=B.useState(!1);B.useEffect(()=>{let M=!0;return(async()=>{if(d!=null)try{const L=Ql(Xl,m,String(d)),U=await vh(L);if(!M)return;if(U.exists()){const K=U.data();g(typeof K.like=="number"?K.like:0)}else g(0)}catch(L){console.error("Firestore getDoc error:",L),M&&g(0)}})(),()=>{M=!1}},[d,m]);const T=async()=>{try{const M=Ql(Xl,m,String(d)),L=await vh(M);if(L.exists()){const U=L.data();g(typeof U.like=="number"?U.like:0)}}catch(M){console.error("Firestore refresh error:",M)}},R=async()=>{if(v)return;if(d==null){console.warn("handleLike called without a valid docId");return}w(!0);const M=Ql(Xl,m,String(d));try{await Ph(M,{like:Uh(1)}),g(L=>L+1),await T()}catch(L){if(L.code==="not-found"||/No document/i.test(String(L)))try{(await vh(M)).exists()?await Ph(M,{like:Uh(1)}):await qg(M,{like:1},{merge:!0}),await T()}catch(U){console.error("Firestore like fallback error:",U)}else console.error("Firestore like error:",L)}finally{w(!1)}};return y.jsx(jN,{$open:!!a,children:y.jsxs(CN,{children:[y.jsxs(DN,{children:[y.jsx(NN,{onClick:()=>{typeof o=="function"&&o()},children:y.jsx("img",{src:`${Om}icons/closeIcon.svg`,alt:"Close Icon"})}),y.jsxs(MN,{children:[y.jsx(kN,{$src:u}),y.jsx(ON,{children:n}),y.jsx(VN,{children:i})]})]}),y.jsxs(PN,{children:[y.jsx(UN,{onClick:R,"aria-disabled":v,title:v?"처리 중":"좋아요",children:y.jsxs(LN,{children:[y.jsx(zN,{$src:`${Om}icons/likeIcon(white).svg`,"aria-label":"Like icon"}),y.jsx($N,{children:p||0})]})}),y.jsxs(BN,{onClick:()=>{const L=Math.max(document.documentElement?.scrollHeight||0,document.body?.scrollHeight||0)-window.innerHeight,K=Math.max(0,L-269);window.scrollTo({top:K,behavior:"smooth"})},children:[y.jsx(FN,{children:"Designer Info"}),y.jsx(qN,{})]})]})]})})}Vm.propTypes={titleKor:Z.string.isRequired,titleEng:Z.string.isRequired,context:Z.string.isRequired,isOpen:Z.bool,onClose:Z.func,docId:Z.oneOfType([Z.string,Z.number]).isRequired,collection:Z.string};const KN=S.div`
  font-family: Pretendard, system-ui, -apple-system, Segoe UI, Roboto, Noto Sans KR, Arial, sans-serif;
  letter-spacing: 0.24px;
  color: #202020;
  text-decoration: none;
...
`;function Yg({nameKor:n,nameEng:t,part:i,sns:a,eMail:o,imgUrl:u,imgAlt:d}){return y.jsxs(KN,{children:[y.jsx(HN,{children:y.jsx(GN,{src:u,alt:d})}),y.jsxs(YN,{children:[y.jsxs(QN,{children:[y.jsx(XN,{children:n}),y.jsx(WN,{children:t})]}),y.jsxs(ZN,{children:[y.jsxs(JN,{children:[y.jsx($p,{children:"Part"}),y.jsx($p,{children:"SNS"}),y.jsx($p,{children:"E-mail"})]}),y.jsxs(t9,{children:[y.jsx(Bp,{children:i}),y.jsx(Bp,{children:a}),y.jsx(Bp,{children:o})]})]})]})]})}Yg.propTypes={nameKor:Z.string.isRequired,nameEng:Z.string.isRequired,part:Z.string,sns:Z.string,eMail:Z.string,imgUrl:Z.string.isRequired,imgAlt:Z.string.isRequired};Yg.defaultProps={sns:"N/A",eMail:"N/A"};const e9=S.div`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  width: 775px;
...
`;function E_({designers:n}){return y.jsxs(e9,{children:[y.jsx(i9,{children:"Designer"}),y.jsx(n9,{children:n.map((t,i)=>y.jsx(Yg,{nameKor:t.nameKor,nameEng:t.nameEng,part:t.role,sns:t.sns,eMail:t.eMail,imgUrl:t.imgUrl},i))})]})}const r9=S.div`
    width: 100%; // 임시값
    margin-top: 50px;
...
`,s9=S.iframe`
    ...
    padding: 0;
    overflow: hidden;
`;function o9({videoId:n,isInfoOpen:t}){const a=`https://player.vimeo.com/video/${String(n||"").trim()}?badge=0&autopause=0&title=0&byline=0&portrait=0&app_id=58479`;return y.jsx(r9,{$isInfoOpen:t,children:y.jsx(a9,{children:y.jsx(s9,{src:a,frameBorder:"0",allow:"autoplay; fullscreen; picture-in-picture",allowFullScreen:!0,title:"Embedded Vimeo"})})})}const l9="/",u9=S.div`
...
`,c9=S.div`
    ...
    width: 40px;
    height: 40px;
`;function h9({isOpen:n=!1,onClick:t}){const[i,a]=B.useState(!1);return B.useEffect(()=>{let o;return n?a(!1):(a(!1),o=setTimeout(()=>{a(!0)},500)),()=>clearTimeout(o)},[n]),y.jsx(u9,{$visible:!n,$active:i,onClick:()=>{typeof t=="function"&&t()},children:y.jsx(c9,{children:y.jsx("img",{src:`${l9}icons/infoOpenIcon.svg`,alt:"작품 정보 열기"})})})}function nh(n){if(!n)return n;const t="/";if(/^https?:\/\//i.test(n))return n;const i=String(n).replace(/^\.\.\//,"").replace(/^\//,"");return t+i}const d9=S.img`
  width: 100%;
  /* max-width: 1800px; */
  /* padding: 0px 100px; */
  /* padding-right: 100px; */
...
`,Fp=n=>y.jsx(d9,{loading:"lazy",...n}),f9=S.div`
  display: flex;
  position: relative;
  background: #fff;
  width: 100%;
...
`,E9=S.div`
    animation: ${({$visible:n,$floatDur:t})=>n?Qm`${v9} ${t??1800}ms ease-in-out infinite alternate`:"none"};
...
`,T_=S.div`
    ...
    background-repeat: no-repeat;
    background-position: center;
`;function w9({visible:n=!0,fadeMs:t=800,floatDur:i=1800,amp:a=6}={}){return y.jsxs(_9,{$visible:n,$fadeMs:t,"aria-hidden":!n,children:[y.jsx(T_,{src:`${b_}icons/showIndicatorMouse.svg`}),y.jsx(E9,{$visible:n,$floatDur:i,style:{"--amp":`${a}px`},children:y.jsx(T_,{src:`${b_}icons/showIndicatorDown.svg`})})]})}const qp=S.div`
    z-index: 5;
    display: flex;
    position: absolute;
    flex-direction: row;
...
`,T9=S.p`
    ...
    text-align: justify;
    margin: 0;
`;function Kp({children:n,textWidth:t,textHeight:i,shown:a,tDur:o,tDelay:u,ease:d}){return y.jsx(b9,{$textWidth:t,$textHeight:i,$shown:a,$tDur:o,$tDelay:u,$ease:d,children:y.jsx(T9,{children:n})})}function S9({top:n,left:t,right:i="auto",bottom:a,lineWidth:o,textWidth:u,textHeight:d,children:m,position:p="left",isActive:g,section:v,currentSection:w,anim:T}){const[R,M]=B.useState(!1),L=T?.circle?.easing||T?.line?.easing||T?.text?.easing||"cubic-bezier(0.22,1,0.36,1)",U=T?.circle?.duration??250,K=T?.circle?.delay??120,X=T?.line?.duration??500,tt=K+U+(T?.line?.delay??120),lt=T?.text?.duration??280,Y=tt+X+(T?.text?.delay??80),j=g||R&&w===v;if(B.useEffect(()=>{g&&!R&&M(!0)},[g,R]),p==="right")return y.jsxs(qp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsx(Kp,{textWidth:u,textHeight:d,shown:j,tDur:lt,tDelay:Y,ease:L,children:m}),y.jsxs(I_,{children:[y.jsx(R_,{$lineWidth:o,$shown:j,$lDur:X,$lDelay:tt,$ease:L}),y.jsx(S_,{$shown:j,$cDur:U,$cDelay:K,$ease:L,children:y.jsx(A_,{$shown:j,$cDur:U,$cDelay:K,$ease:L})})]})]});if(p==="left")return y.jsxs(qp,{$top:n,$left:t,$right:i,$bottom:a,children:[y.jsxs(I_,{children:[y.jsx(S_,{$shown:j,$cDur:U,$cDelay:K,$ease:L,children:y.jsx(A_,{$shown:j,$cDur:U,$cDelay:K,$ease:L})}),y.jsx(R_,{$lineWidth:o,$shown:j,$lDur:X,$lDelay:tt,$ease:L})]}),y.jsx(Kp,{textWidth:u,textHeight:d,shown:j,tDur:lt,tDelay:Y,ease:L,children:m})]});if(p==="no-line")return y.jsx(qp,{$top:n,$left:t,$right:i,$bottom:a,children:y.jsx(Kp,{textWidth:u,textHeight:d,shown:j,tDur:lt,tDelay:Y,ease:L,children:m})})}const Hp="/",A9=S.div`
    display: flex;
    position: relative;
    margin-top: 80px;
    width: 100vw;
